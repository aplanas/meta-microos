...
RPROVIDES:${PN} += "python3.11dist(qtawesome) python311-QtAwesome python3dist(qtawesome)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-QtPy update-alternatives"
