...
RPROVIDES:${PN} += "config(oddjob-gpupdate) oddjob-gpupdate oddjob-gpupdate(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdbus-1.so.3()(64bit) libdbus-1.so.3(LIBDBUS_1_3)(64bit) libpam.so.0()(64bit) libpam.so.0(LIBPAM_1.0)(64bit) oddjob"
