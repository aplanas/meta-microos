...
RPROVIDES:${PN} += "tex(cooking-units.sty) texlive-cooking-units"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(expl3.sty) tex(fmtcount.sty) tex(l3keys2e.sty) tex(translations.sty) tex(xfrac.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
