...
RPROVIDES:${PN} += "libqtchartsqml2plugin.so()(64bit) libqtchartsqml2plugin.so(Qt_6)(64bit) libqtchartsqml2plugin.so(Qt_6.0)(64bit) libqtchartsqml2plugin.so(Qt_6.1)(64bit) libqtchartsqml2plugin.so(Qt_6.2)(64bit) libqtchartsqml2plugin.so(Qt_6.3)(64bit) libqtchartsqml2plugin.so(Qt_6.4)(64bit) libqtchartsqml2plugin.so(Qt_6.5)(64bit) libqtchartsqml2plugin.so(Qt_6.5.1_PRIVATE_API)(64bit) qt6-charts-imports qt6-charts-imports(aarch-64)"
