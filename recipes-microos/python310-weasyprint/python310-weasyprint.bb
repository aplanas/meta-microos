...
RPROVIDES:${PN} += "python3-WeasyPrint python3-weasyprint python3.10dist(weasyprint) python310-WeasyPrint python310-weasyprint python3dist(weasyprint)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 libgobject-2_0-0 pango python(abi) python310-Brotli python310-FontTools python310-Pillow python310-Pyphen python310-base python310-cffi python310-cssselect2 python310-html5lib python310-pydyf python310-tinycss2 python310-zopfli update-alternatives"
