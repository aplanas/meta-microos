...
RPROVIDES:${PN} += "ghc-memory-prof ghc-memory-prof(aarch-64) ghc-prof(memory-0.18.0-2DG6nqjfLMK4MSR77XYQqL)"
RDEPENDS:${PN} += "ghc-memory-devel ghc-prof(base-4.17.1.0) ghc-prof(basement-0.0.15-6OmKTVi2kFpCWMoKDlsO4S) ghc-prof(bytestring-0.11.4.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(ghc-prim-0.9.0)"
