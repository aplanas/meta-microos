...
RPROVIDES:${PN} += "ruby3.2-rubygem-orm_adapter ruby3.2-rubygem-orm_adapter(aarch-64) rubygem(orm_adapter) rubygem(ruby:3.2.0:orm_adapter) rubygem(ruby:3.2.0:orm_adapter:0) rubygem(ruby:3.2.0:orm_adapter:0.5) rubygem(ruby:3.2.0:orm_adapter:0.5.0)"
