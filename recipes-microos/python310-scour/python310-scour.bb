...
RPROVIDES:${PN} += "python3-scour python3.10dist(scour) python310-scour python3dist(scour) scour"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-setuptools python310-six update-alternatives"
