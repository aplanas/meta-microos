...
RPROVIDES:${PN} += "stoken stoken(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libstoken.so.1()(64bit) libstoken.so.1(STOKEN_1.3)(64bit) libstoken.so.1(STOKEN_PRIVATE)(64bit)"
