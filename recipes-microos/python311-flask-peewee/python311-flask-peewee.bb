...
RPROVIDES:${PN} += "python3.11dist(flask-peewee) python311-flask-peewee python3dist(flask-peewee)"
RDEPENDS:${PN} += "python(abi) python311-Flask python311-Jinja2 python311-WTForms python311-Werkzeug python311-peewee python311-wtf-peewee"
