...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-devel-mono-devel_mono patterns-devel-mono-devel_mono(aarch-64)"
RDEPENDS:${PN} += ""
