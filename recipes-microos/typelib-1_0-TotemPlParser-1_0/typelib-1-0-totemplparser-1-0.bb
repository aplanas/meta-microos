...
RPROVIDES:${PN} += "typelib(TotemPlParser) typelib-1_0-TotemPlParser-1_0 typelib-1_0-TotemPlParser-1_0(aarch-64)"
RDEPENDS:${PN} += "libtotem-plparser.so.18()(64bit) totem-pl-parser typelib(GLib) typelib(GObject) typelib(Gio)"
