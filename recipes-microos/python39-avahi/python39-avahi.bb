...
RPROVIDES:${PN} += "python39-avahi python39-avahi(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 avahi python(abi) python39-Twisted python39-dbm python39-dbus-python"
