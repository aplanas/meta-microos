...
RPROVIDES:${PN} += "typelib(GMime) typelib-1_0-GMime-3_0 typelib-1_0-GMime-3_0(aarch-64)"
RDEPENDS:${PN} += "libgmime-3.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
