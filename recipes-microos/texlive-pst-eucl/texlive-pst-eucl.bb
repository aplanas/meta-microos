...
RPROVIDES:${PN} += "tex(pst-eucl.sty) tex(pst-eucl.tex) texlive-pst-eucl"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(pst-calculate.sty) tex(pst-node.sty) tex(pst-tools.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
