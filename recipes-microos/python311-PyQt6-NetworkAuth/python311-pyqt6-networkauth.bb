...
RPROVIDES:${PN} += "python3.11dist(pyqt6-networkauth) python311-PyQt6-NetworkAuth python311-PyQt6-NetworkAuth(aarch-64) python311-qtnetworkauth-qt6 python3dist(pyqt6-networkauth)"
