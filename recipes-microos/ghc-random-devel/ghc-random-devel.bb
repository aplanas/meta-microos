...
RPROVIDES:${PN} += "ghc-devel(random-1.2.1.1-I0wUgAAbf0g3qHR3e8uT0o) ghc-random-devel ghc-random-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(mtl-2.2.2) ghc-devel(splitmix-0.1.0.4-7e8CibdlMRLAGh7KO5VlFe) ghc-random"
