...
RPROVIDES:${PN} += "pkgconfig(totem-plparser) pkgconfig(totem-plparser-mini) totem-pl-parser-devel totem-pl-parser-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libtotem-plparser-mini18 libtotem-plparser18 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(gthread-2.0) pkgconfig(libarchive) pkgconfig(libxml-2.0) typelib-1_0-TotemPlParser-1_0"
