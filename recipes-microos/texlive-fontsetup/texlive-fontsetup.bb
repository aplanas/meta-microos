...
RPROVIDES:${PN} += "tex(fontsetup.sty) tex(fspconcrete.sty) tex(fspdefault.sty) tex(fspebgaramondot.sty) tex(fspfiraot.sty) tex(fspgfsartemisiaot.sty) tex(fspgfsdidotclassicot.sty) tex(fspgfsdidotot.sty) tex(fspgfsneohellenicot.sty) tex(fspkerkisot.sty) tex(fspneoeulerot.sty) tex(fspolddefault.sty) tex(fspoldstandard.sty) tex(fspstixtwoot.sty) tex(fsptalos.sty) tex(fsptimesot.sty) tex(fspxcharter.sty) texlive-fontsetup"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontspec.sty) tex(iftex.sty) tex(ifthen.sty) tex(libertinus-otf.sty) tex(ucharclasses.sty) tex(unicode-math.sty) tex(xcharter-otf.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
