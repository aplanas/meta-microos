...
RPROVIDES:${PN} += "pkgconfig(telepathy-glib) telepathy-glib-devel telepathy-glib-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libtelepathy-glib0 pkgconfig(dbus-1) pkgconfig(dbus-glib-1) pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) typelib-1_0-TelepathyGlib-0_12"
