...
RPROVIDES:${PN} += "python3.11dist(nbclassic) python311-nbclassic python3dist(nbclassic)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 alts jupyter-nbclassic python(abi) python311-Jinja2 python311-Send2Trash python311-argon2-cffi python311-ipykernel python311-ipython_genutils python311-jupyter-client python311-jupyter-core python311-nbconvert python311-nbformat python311-nest-asyncio python311-notebook-shim python311-prometheus-client python311-pyzmq python311-terminado python311-tornado python311-traitlets"
