...
RPROVIDES:${PN} += "perl(Plack::Middleware::FixMissingBodyInRedirect) perl-Plack-Middleware-FixMissingBodyInRedirect"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(HTML::Entities) perl(Plack::Middleware) perl(Plack::Util) perl(parent)"
