...
RPROVIDES:${PN} += "python3-flexx python3.10dist(flexx) python310-flexx python3dist(flexx)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-dialite python310-pscript python310-tornado python310-webruntime update-alternatives"
