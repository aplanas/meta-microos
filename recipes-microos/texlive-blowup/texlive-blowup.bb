...
RPROVIDES:${PN} += "tex(blowup.sty) texlive-blowup"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atbegshi.sty) tex(graphics.sty) tex(iftex.sty) tex(keyval.sty) tex(typearea.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
