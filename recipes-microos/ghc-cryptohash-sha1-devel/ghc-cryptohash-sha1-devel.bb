...
RPROVIDES:${PN} += "ghc-cryptohash-sha1-devel ghc-cryptohash-sha1-devel(aarch-64) ghc-devel(cryptohash-sha1-0.11.101.0-5MfQC56IvYq9IpSDMpmdHb)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-cryptohash-sha1 ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0)"
