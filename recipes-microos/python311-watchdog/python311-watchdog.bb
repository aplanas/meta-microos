...
RPROVIDES:${PN} += "python3.11dist(watchdog) python311-watchdog python3dist(watchdog)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyYAML python311-pathtools update-alternatives"
