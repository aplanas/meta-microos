...
RPROVIDES:${PN} += "tex(unified.bbx) tex(unified.cbx) texlive-biblatex-unified"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(authoryear-comp.cbx) tex(authoryear.bbx) tex(xpatch.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
