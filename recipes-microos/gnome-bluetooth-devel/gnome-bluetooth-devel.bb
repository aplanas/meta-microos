...
RPROVIDES:${PN} += "gnome-bluetooth-devel gnome-bluetooth-devel(aarch-64) pkgconfig(gnome-bluetooth-3.0) pkgconfig(gnome-bluetooth-ui-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gnome-bluetooth libgnome-bluetooth-3_0-13 libgnome-bluetooth-ui-3_0-13 pkgconfig(gio-2.0) pkgconfig(gtk4) pkgconfig(libadwaita-1) typelib-1_0-GnomeBluetooth-3_0"
