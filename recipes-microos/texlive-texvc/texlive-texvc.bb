...
RPROVIDES:${PN} += "tex(texvc.sty) texlive-texvc"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsfonts.sty) tex(amsmath.sty) tex(amssymb.sty) tex(babel.sty) tex(cancel.sty) tex(color.sty) tex(eurosym.sty) tex(teubner.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
