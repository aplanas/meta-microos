...
RPROVIDES:${PN} += "python3.11dist(audiomate) python311-audiomate python3dist(audiomate)"
RDEPENDS:${PN} += "python(abi) python311-PGet python311-audioread python311-h5py python311-intervaltree python311-librosa python311-networkx python311-numba python311-numpy python311-requests python311-scipy python311-sox"
