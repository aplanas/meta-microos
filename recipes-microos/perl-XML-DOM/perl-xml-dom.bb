...
RPROVIDES:${PN} += "perl(XML::DOM) perl(XML::DOM::AttDef) perl(XML::DOM::AttlistDecl) perl(XML::DOM::Attr) perl(XML::DOM::CDATASection) perl(XML::DOM::CharacterData) perl(XML::DOM::Comment) perl(XML::DOM::DOMException) perl(XML::DOM::DOMImplementation) perl(XML::DOM::Document) perl(XML::DOM::DocumentFragment) perl(XML::DOM::DocumentType) perl(XML::DOM::Element) perl(XML::DOM::ElementDecl) perl(XML::DOM::Entity) perl(XML::DOM::EntityReference) perl(XML::DOM::NamedNodeMap) perl(XML::DOM::Node) perl(XML::DOM::NodeList) perl(XML::DOM::Notation) perl(XML::DOM::Parser) perl(XML::DOM::PerlSAX) perl(XML::DOM::PrintToFileHandle) perl(XML::DOM::PrintToString) perl(XML::DOM::ProcessingInstruction) perl(XML::DOM::Text) perl(XML::DOM::XMLDecl) perl(XML::Handler::BuildDOM) perl(XML::Parser::Dom) perl(XML::XQL::Node) perl-XML-DOM"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(LWP::UserAgent) perl(XML::Parser) perl(XML::Parser::PerlSAX) perl(XML::RegExp)"
