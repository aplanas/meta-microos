...
RPROVIDES:${PN} += "tex(lps.cls) texlive-lps"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(geometry.sty) tex(lastpage.sty) tex(mathptmx.sty) tex(titlesec.sty) tex(titletoc.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
