...
RPROVIDES:${PN} += "python3.11dist(python-gitlab) python311-python-gitlab python3dist(python-gitlab)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyYAML python311-argcomplete python311-requests python311-requests-toolbelt python311-setuptools update-alternatives"
