...
RPROVIDES:${PN} += "python3-material-color-utilities-python python3.10dist(material-color-utilities-python) python310-material-color-utilities-python python3dist(material-color-utilities-python)"
