...
RPROVIDES:${PN} += "python3-kiwi-keg python3.10dist(kiwi-keg) python3dist(kiwi-keg)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Cerberus python3-Jinja2 python3-PyYAML python3-docopt python3-kiwi python3-schema python3-setuptools"
