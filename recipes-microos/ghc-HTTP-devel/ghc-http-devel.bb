...
RPROVIDES:${PN} += "ghc-HTTP-devel ghc-HTTP-devel(aarch-64) ghc-devel(HTTP-4000.4.1-BsHtin5O4EoLpElKRODQk3)"
RDEPENDS:${PN} += "/bin/sh ghc-HTTP ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(mtl-2.2.2) ghc-devel(network-3.1.2.8-HNDBp0HF6t0D1fzE2MDtPd) ghc-devel(network-uri-2.6.4.2-4kNQnaE9heqEL1mH8FE5xH) ghc-devel(parsec-3.1.16.1) ghc-devel(time-1.12.2) ghc-devel(transformers-0.5.6.2)"
