...
RPROVIDES:${PN} += "python3.9dist(transip) python39-transip python3dist(transip)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-cryptography python39-requests python39-setuptools python39-suds update-alternatives"
