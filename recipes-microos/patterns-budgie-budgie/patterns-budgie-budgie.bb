...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-budgie-budgie patterns-budgie-budgie(aarch-64)"
RDEPENDS:${PN} += "budgie-desktop lightdm pattern()"
