...
RPROVIDES:${PN} += "libXxf86vm-devel libXxf86vm-devel(aarch-64) pkgconfig(xxf86vm)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXxf86vm1 pkgconfig(x11) pkgconfig(xext) pkgconfig(xf86vidmodeproto)"
