...
RPROVIDES:${PN} += "tex(ccicons-u.enc) tex(ccicons.map) tex(ccicons.sty) tex(ccicons.tfm) texlive-ccicons"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) tex(xkeyval.sty) texlive texlive-ccicons-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
