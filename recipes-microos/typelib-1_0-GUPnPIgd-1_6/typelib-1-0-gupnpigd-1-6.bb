...
RPROVIDES:${PN} += "typelib(GUPnPIgd) typelib-1_0-GUPnPIgd-1_6 typelib-1_0-GUPnPIgd-1_6(aarch-64)"
RDEPENDS:${PN} += "libgupnp-igd-1.6.so.0()(64bit) typelib(GLib) typelib(GObject)"
