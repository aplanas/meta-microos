...
RPROVIDES:${PN} += "python3.11dist(fontparts) python311-fontParts python3dist(fontparts)"
RDEPENDS:${PN} += "python(abi) python311-FontTools python311-booleanOperations python311-defcon python311-fontMath python311-fs python311-lxml"
