...
RPROVIDES:${PN} += "pkgconfig(xplayer) xplayer-devel xplayer-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig(gio-2.0) pkgconfig(gtk+-3.0) pkgconfig(xplayer-plparser) xplayer"
