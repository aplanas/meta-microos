...
RPROVIDES:${PN} += "pkg-config pkg-config(aarch-64) pkgconf-pkg-config pkgconf-pkg-config(aarch-64) pkgconfig pkgconfig(aarch-64) pkgconfig(pkg-config)"
RDEPENDS:${PN} += "/bin/sh pkgconf(aarch-64) pkgconf-m4"
