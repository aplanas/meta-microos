...
RPROVIDES:${PN} += "ghc-code-page-devel ghc-code-page-devel(aarch-64) ghc-devel(code-page-0.2.1-DXkPgctk3OAKMpgAjUBS3D)"
RDEPENDS:${PN} += "/bin/sh ghc-code-page ghc-compiler ghc-devel(base-4.17.1.0)"
