...
RPROVIDES:${PN} += "libhackrf.so.0()(64bit) libhackrf0 libhackrf0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig hackrf-udev ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libusb-1.0.so.0()(64bit)"
