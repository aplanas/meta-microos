...
RPROVIDES:${PN} += "python3-azure-mgmt-servicefabricmanagedclusters python3.10dist(azure-mgmt-servicefabricmanagedclusters) python310-azure-mgmt-servicefabricmanagedclusters python3dist(azure-mgmt-servicefabricmanagedclusters)"
