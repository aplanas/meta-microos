...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.Mail.desktop) metainfo() metainfo(org.opensuse.yast.Mail.metainfo.xml) perl(MasterCFParser) yast2-mail"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/perl /usr/bin/touch fillup yast2 yast2-ldap yast2-ruby-bindings yast2-users"
