...
RPROVIDES:${PN} += "dnf-command(offline-distrosync) dnf-command(offline-upgrade) dnf-command(system-upgrade) dnf-plugin-system-upgrade dnf-plugins-extras-system-upgrade python3-dnf-plugin-system-upgrade python3-dnf-plugins-extras-system-upgrade system-upgrade"
RDEPENDS:${PN} += "python(abi) python3-dnf-plugins-extras-common python3-systemd systemd"
