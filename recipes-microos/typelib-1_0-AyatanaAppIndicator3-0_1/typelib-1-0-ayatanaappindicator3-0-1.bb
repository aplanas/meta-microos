...
RPROVIDES:${PN} += "typelib(AyatanaAppIndicator3) typelib-1_0-AyatanaAppIndicator3-0_1 typelib-1_0-AyatanaAppIndicator3-0_1(aarch-64)"
RDEPENDS:${PN} += "libayatana-appindicator3.so.1()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
