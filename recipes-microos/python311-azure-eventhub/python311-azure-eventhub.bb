...
RPROVIDES:${PN} += "python3.11dist(azure-eventhub) python311-azure-eventhub python3dist(azure-eventhub)"
RDEPENDS:${PN} += "python(abi) python311-azure-core python311-azure-nspkg python311-typing_extensions"
