...
RPROVIDES:${PN} += "agenda agenda(aarch-64) agenda-tasks application() application(com.github.dahenson.agenda.desktop) metainfo() metainfo(com.github.dahenson.agenda.appdata.xml)"
