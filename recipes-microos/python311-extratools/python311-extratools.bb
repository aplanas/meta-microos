...
RPROVIDES:${PN} += "python3.11dist(extratools) python311-extratools python3dist(extratools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-RegexOrder python311-TagStats python311-sh python311-sortedcontainers python311-toolz update-alternatives"
