...
RPROVIDES:${PN} += "typelib(Geoclue) typelib-1_0-Geoclue-2_0 typelib-1_0-Geoclue-2_0(aarch-64)"
RDEPENDS:${PN} += "libgeoclue-2.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
