...
RPROVIDES:${PN} += "tesseract-ocr-traineddata-chi_sim_vert \
tesseract-ocr-traineddata-chinese_simplified_vertical \
tesseract-traineddata-chinese_simplified_vertical"
