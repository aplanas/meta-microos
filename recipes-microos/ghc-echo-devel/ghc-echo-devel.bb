...
RPROVIDES:${PN} += "ghc-devel(echo-0.1.4-GGh6ZLKme4z6jywDiYhFOL) ghc-echo-devel ghc-echo-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(process-1.6.16.0) ghc-echo"
