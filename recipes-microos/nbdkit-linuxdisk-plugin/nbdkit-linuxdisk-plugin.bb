...
RPROVIDES:${PN} += "nbdkit-linuxdisk-plugin nbdkit-linuxdisk-plugin(aarch-64)"
RDEPENDS:${PN} += "e2fsprogs ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) nbdkit-server"
