...
RPROVIDES:${PN} += "config(pptpd) pptpd pptpd(aarch-64)"
RDEPENDS:${PN} += "(kmod(ppp_mppe.ko) if kernel) /bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) ppp"
