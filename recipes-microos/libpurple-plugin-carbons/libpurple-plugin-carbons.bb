...
RPROVIDES:${PN} += "libpurple-plugin-carbons libpurple-plugin-carbons(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libjabber.so.0()(64bit)"
