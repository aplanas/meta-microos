...
RPROVIDES:${PN} += "python3.9dist(khal) python39-khal python3dist(khal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-atomicwrites python39-click python39-click-log python39-configobj python39-dateutil python39-icalendar python39-pytz python39-pyxdg python39-tzlocal python39-urwid update-alternatives"
