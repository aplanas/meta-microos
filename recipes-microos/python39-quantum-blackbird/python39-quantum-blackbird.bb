...
RPROVIDES:${PN} += "python3.9dist(quantum-blackbird) python39-quantum-blackbird python3dist(quantum-blackbird)"
RDEPENDS:${PN} += "python(abi) python39-antlr4-python3-runtime python39-networkx python39-numpy python39-sympy"
