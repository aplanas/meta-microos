...
RPROVIDES:${PN} += "jupyter-nbval python3-jupyter_nbval python3-nbval python3.10dist(nbval) python310-jupyter_nbval python310-nbval python3dist(nbval)"
RDEPENDS:${PN} += "python(abi) python310-coverage python310-ipykernel python310-jupyter-client python310-nbformat python310-pytest"
