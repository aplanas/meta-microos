...
RPROVIDES:${PN} += "ghc-clock-devel ghc-clock-devel(aarch-64) ghc-devel(clock-0.8.3-Bn4LVnP2KGzGGqLjq4BuLV)"
RDEPENDS:${PN} += "/bin/sh ghc-clock ghc-compiler ghc-devel(base-4.17.1.0)"
