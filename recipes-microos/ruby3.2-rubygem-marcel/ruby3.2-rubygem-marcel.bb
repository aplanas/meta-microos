...
RPROVIDES:${PN} += "ruby3.2-rubygem-marcel ruby3.2-rubygem-marcel(aarch-64) rubygem(marcel) rubygem(ruby:3.2.0:marcel) rubygem(ruby:3.2.0:marcel:1) rubygem(ruby:3.2.0:marcel:1.0) rubygem(ruby:3.2.0:marcel:1.0.2)"
