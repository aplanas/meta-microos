...
RPROVIDES:${PN} += "jackson-dataformat-cbor mvn(com.fasterxml.jackson.dataformat:jackson-dataformat-cbor) mvn(com.fasterxml.jackson.dataformat:jackson-dataformat-cbor:pom:) osgi(com.fasterxml.jackson.dataformat.jackson-dataformat-cbor)"
