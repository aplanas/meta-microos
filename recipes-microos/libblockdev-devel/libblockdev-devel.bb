...
RPROVIDES:${PN} += "libblockdev-devel libblockdev-devel(aarch-64) pkgconfig(blockdev)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glib2-devel libblockdev2 pkgconfig(glib-2.0)"
