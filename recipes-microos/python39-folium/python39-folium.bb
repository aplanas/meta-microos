...
RPROVIDES:${PN} += "python3.9dist(folium) python39-folium python3dist(folium)"
RDEPENDS:${PN} += "python(abi) python39-Jinja2 python39-branca python39-numpy python39-requests"
