...
RPROVIDES:${PN} += "tex(T1-WGL4.enc) tex(ttf2pk.cfg) texlive-ttfutils"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-ttfutils-bin"
