...
RPROVIDES:${PN} += "python3.9dist(social-auth-core) python39-social-auth-core python3dist(social-auth-core)"
RDEPENDS:${PN} += "python(abi) python39-PyJWT python39-cryptography python39-defusedxml python39-oauthlib python39-python3-openid python39-requests python39-requests-oauthlib"
