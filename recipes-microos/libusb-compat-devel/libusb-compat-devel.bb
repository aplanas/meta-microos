...
RPROVIDES:${PN} += "libusb-compat-devel libusb-compat-devel(aarch-64) libusb-devel pkgconfig(libusb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config glibc-devel libusb-0_1-4 libusb-1_0-devel libusb-1_0-features-in-0_1-api pkgconfig(libusb-1.0)"
