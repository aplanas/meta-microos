...
RPROVIDES:${PN} += "typelib(GeocodeGlib) typelib-1_0-GeocodeGlib-1_0 typelib-1_0-GeocodeGlib-1_0(aarch-64)"
RDEPENDS:${PN} += "libgeocode-glib.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Json) typelib(Soup)"
