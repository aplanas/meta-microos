...
locale(libgweather4:en_CA) \
locale(libgweather4:en_GB) \
locale(libgweather4:eo) \
locale(libgweather4:es) \
locale(libgweather4:es_AR) \
locale(libgweather4:es_CL) \
locale(libgweather4:es_CO) \
locale(libgweather4:es_CR) \
locale(libgweather4:es_DO) \
locale(libgweather4:es_EC) \
locale(libgweather4:es_ES) \
locale(libgweather4:es_GT) \
locale(libgweather4:es_HN) \
locale(libgweather4:es_MX) \
locale(libgweather4:es_NI) \
locale(libgweather4:es_PA) \
locale(libgweather4:es_PE) \
locale(libgweather4:es_PR) \
locale(libgweather4:es_SV) \
locale(libgweather4:es_UY) \
locale(libgweather4:es_VE) \
