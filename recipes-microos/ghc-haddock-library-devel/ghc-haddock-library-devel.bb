...
RPROVIDES:${PN} += "ghc-devel(haddock-library-1.11.0-3IU1wl1Mct8946s210c9Hs) ghc-haddock-library-devel ghc-haddock-library-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(parsec-3.1.16.1) ghc-devel(text-2.0.2) ghc-haddock-library"
