...
RPROVIDES:${PN} += "tex(spath3.sty) tex(tikzlibrarycalligraphy.code.tex) tex(tikzlibraryknots.code.tex) tex(tikzlibraryspath3.code.tex) texlive-spath3"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(expl3.sty) tex(pgf.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
