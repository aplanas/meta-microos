...
RPROVIDES:${PN} += "python3.10dist(trytond-account-product) python3dist(trytond-account-product) trytond_account_product"
RDEPENDS:${PN} += "python(abi) trytond trytond_account trytond_company trytond_product"
