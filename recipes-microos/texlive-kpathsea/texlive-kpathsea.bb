...
RPROVIDES:${PN} += "config(texlive-kpathsea) tex(fmtutil.cnf) tex(mktex.cnf) tex(texmf.cnf) texlive-kpathsea"
RDEPENDS:${PN} += "/bin/sh coreutils diffutils ed findutils grep sed texlive-filesystem texlive-gsftopk texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-updmap-map"
