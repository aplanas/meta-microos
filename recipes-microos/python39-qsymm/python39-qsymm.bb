...
RPROVIDES:${PN} += "python3.9dist(qsymm) python39-qsymm python3dist(qsymm)"
RDEPENDS:${PN} += "python(abi) python39-numpy python39-scipy python39-sympy python39-tinyarray"
