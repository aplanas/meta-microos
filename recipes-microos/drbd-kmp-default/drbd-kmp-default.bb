...
RPROVIDES:${PN} += "drbd-kmp drbd-kmp-default drbd-kmp-default(aarch-64) drbd-kmp-default-k6.3.4_1 kmod(drbd.ko) kmod(drbd_transport_tcp.ko) multiversion(kernel)"
