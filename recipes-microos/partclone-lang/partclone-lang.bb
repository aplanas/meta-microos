...
RPROVIDES:${PN} += "locale(partclone:fr_FR) locale(partclone:pt_BR) locale(partclone:vi) locale(partclone:zh_CN) locale(partclone:zh_TW) partclone-lang partclone-lang-all"
