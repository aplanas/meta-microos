...
RPROVIDES:${PN} += "libportal-gtk3-1 libportal-gtk3-1(aarch-64) libportal-gtk3.so.1()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig libgdk-3.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit)"
