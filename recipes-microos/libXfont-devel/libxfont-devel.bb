...
RPROVIDES:${PN} += "libXfont-devel libXfont-devel(aarch-64) pkgconfig(xfont)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXfont1 pkgconfig(fontenc) pkgconfig(fontsproto) pkgconfig(freetype2) pkgconfig(xproto)"
