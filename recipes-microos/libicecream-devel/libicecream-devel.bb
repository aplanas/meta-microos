...
RPROVIDES:${PN} += "libicecream-devel libicecream-devel(aarch-64) pkgconfig(icecc)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libarchive-devel libcap-ng-devel libstdc++-devel libzstd-devel lzo-devel"
