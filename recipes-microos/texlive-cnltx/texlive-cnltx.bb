...
RPROVIDES:${PN} += "tex(cnltx-base.sty) tex(cnltx-doc.cls) tex(cnltx-example.sty) tex(cnltx-listings.sty) tex(cnltx-names.sty) tex(cnltx-tools.sty) tex(cnltx-translations.sty) tex(cnltx.bbx) tex(cnltx.cbx) tex(cnltx.sty) texlive-cnltx"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(accsupp.sty) tex(adjustbox.sty) tex(alphabetic.bbx) tex(alphabetic.cbx) tex(beramono.sty) tex(catchfile.sty) tex(etoolbox.sty) tex(fnpct.sty) tex(fontenc.sty) tex(fontspec.sty) tex(hyperref.sty) tex(idxcmds.sty) tex(ifluatex.sty) tex(ifxetex.sty) tex(imakeidx.sty) tex(libertine.sty) tex(listings.sty) tex(ltxcmds.sty) tex(marginnote.sty) tex(mdframed.sty) tex(microtype.sty) tex(multicol.sty) tex(pdftexcmds.sty) tex(pgfopts.sty) tex(ragged2e.sty) tex(scrartcl.cls) tex(scrlayer-scrpage.sty) tex(textcomp.sty) tex(translations.sty) tex(trimspaces.sty) tex(ulem.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
