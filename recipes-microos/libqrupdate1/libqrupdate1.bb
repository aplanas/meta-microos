...
RPROVIDES:${PN} += "libqrupdate.so.1()(64bit) libqrupdate1 libqrupdate1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libblas.so.3()(64bit) libgfortran.so.5()(64bit) libgfortran.so.5(GFORTRAN_8)(64bit) liblapack.so.3()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit)"
