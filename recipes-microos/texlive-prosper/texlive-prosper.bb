...
RPROVIDES:${PN} += "tex(PPRalcatel.sty) tex(PPRalienglow.sty) tex(PPRautumn.sty) tex(PPRazure.sty) tex(PPRblends.sty) tex(PPRcapsules.sty) tex(PPRcontemporain.sty) tex(PPRcorners.sty) tex(PPRdarkblue.sty) tex(PPRdefault.sty) tex(PPRframes.sty) tex(PPRfyma.sty) tex(PPRgyom.sty) tex(PPRlignesbleues.sty) tex(PPRmancini.sty) tex(PPRnuancegris.sty) tex(PPRprettybox.sty) tex(PPRrico.sty) tex(PPRserpaggi.sty) tex(PPRthomasd.sty) tex(PPRtroispoints.sty) tex(PPRwhitecross.sty) tex(PPRwinter.sty) tex(PPRwj.sty) tex(prosper.cls) texlive-prosper"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(fp.sty) tex(graphicx.sty) tex(ifthen.sty) tex(mathpazo.sty) tex(multido.sty) tex(palatino.sty) tex(pst-grad.sty) tex(pst-slpe.sty) tex(semhelv.sty) tex(seminar.cls) tex(times.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
