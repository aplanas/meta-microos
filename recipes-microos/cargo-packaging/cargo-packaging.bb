...
RPROVIDES:${PN} += "cargo-packaging cargo-packaging(aarch-64) rpm_macro(cargo_build) rpm_macro(cargo_install) rpm_macro(cargo_test) rpm_macro(rust_arches) rpm_macro(rust_tier1_arches)"
RDEPENDS:${PN} += "cargo cargo-auditable libc.so.6(GLIBC_2.34)(64bit) libgcc_s.so.1()(64bit) libgcc_s.so.1(GCC_3.0)(64bit) libgcc_s.so.1(GCC_3.3)(64bit) libgcc_s.so.1(GCC_4.2.0)(64bit) zstd"
