...
RPROVIDES:${PN} += "python3-radexreader python3.10dist(radexreader) python310-radexreader python3dist(radexreader)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-pyserial python310-pyusb update-alternatives"
