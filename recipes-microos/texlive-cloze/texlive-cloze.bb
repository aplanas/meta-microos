...
RPROVIDES:${PN} += "tex(cloze.sty) tex(cloze.tex) texlive-cloze"
RDEPENDS:${PN} += "/bin/sh /usr/bin/luatex coreutils ed findutils grep sed tex(fontspec.sty) tex(kvoptions.sty) tex(luatexbase-mcb.sty) tex(setspace.sty) tex(stackengine.sty) tex(transparent.sty) tex(ulem.sty) tex(xcolor.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
