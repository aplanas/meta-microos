...
RPROVIDES:${PN} += "libcmis-devel libcmis-devel(aarch-64) pkgconfig(libcmis-0.5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libcmis-0_5-5 pkgconfig(libcurl) pkgconfig(libxml-2.0)"
