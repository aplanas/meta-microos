...
RPROVIDES:${PN} += "tex(elbioimp.cls) texlive-elbioimp"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(ifthen.sty) tex(mathptmx.sty) tex(type1cm.sty) tex(type1ec.sty) tex(url.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
