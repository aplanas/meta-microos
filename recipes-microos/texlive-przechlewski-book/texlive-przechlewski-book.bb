...
RPROVIDES:${PN} += "tex(upmgr.cls) tex(wkmgr.cls) texlive-przechlewski-book"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(caption.sty) tex(graphicx.sty) tex(polski.sty) tex(prelim2e.sty) tex(report.cls) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
