...
RPROVIDES:${PN} += "perl(Devel::LexAlias) perl-Devel-LexAlias perl-Devel-LexAlias(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) perl(:MODULE_COMPAT_5.36.0) perl(Devel::Caller)"
