...
RPROVIDES:${PN} += "python3.9dist(czifile) python39-czifile python3dist(czifile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-imagecodecs python39-numpy python39-scipy python39-tifffile update-alternatives"
