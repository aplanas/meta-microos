...
RPROVIDES:${PN} += "ant-javamail config(ant-javamail) mvn(org.apache.ant:ant-javamail) mvn(org.apache.ant:ant-javamail:pom:)"
RDEPENDS:${PN} += "ant java-headless javamail javapackages-filesystem mvn(com.sun.mail:javax.mail) mvn(org.apache.ant:ant)"
