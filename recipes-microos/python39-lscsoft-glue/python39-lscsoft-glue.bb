...
RPROVIDES:${PN} += "python-glue python3.9dist(lscsoft-glue) python39-glue python39-lscsoft-glue python39-lscsoft-glue(aarch-64) python3dist(lscsoft-glue)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) lscsoft-glue-data python(abi) python39-ligo-segments python39-numpy python39-pyRXP update-alternatives"
