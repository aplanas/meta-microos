...
RPROVIDES:${PN} += "libcaja-python.so()(64bit) python-caja python-caja(aarch-64) python-mate-file-manager"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcaja-extension.so.1()(64bit) libglib-2.0.so.0()(64bit) libgmodule-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libpython3.10.so.1.0()(64bit) python3-gobject typelib(Caja)"
