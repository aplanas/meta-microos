...
RPROVIDES:${PN} += "ruby3.2-rubygem-pry-doc ruby3.2-rubygem-pry-doc(aarch-64) rubygem(pry-doc) rubygem(ruby:3.2.0:pry-doc) rubygem(ruby:3.2.0:pry-doc:1) rubygem(ruby:3.2.0:pry-doc:1.3) rubygem(ruby:3.2.0:pry-doc:1.3.0)"
RDEPENDS:${PN} += "etags ruby(abi) rubygem(ruby:3.2.0:pry:0) rubygem(ruby:3.2.0:yard:0.9)"
