...
RPROVIDES:${PN} += "pkgconfig(pstoedit) pstoedit-devel pstoedit-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ImageMagick-devel libMagick++-devel libpng-devel libzip-devel pstoedit"
