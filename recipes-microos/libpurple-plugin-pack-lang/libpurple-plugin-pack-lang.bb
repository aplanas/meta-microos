...
RPROVIDES:${PN} += "libpurple-plugin-pack-lang libpurple-plugin-pack-lang-all locale(libpurple-plugin-pack:de) locale(libpurple-plugin-pack:en_AU) locale(libpurple-plugin-pack:es_ES) locale(libpurple-plugin-pack:fr) locale(libpurple-plugin-pack:vi)"
