...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-cinnamon-cinnamon patterns-cinnamon-cinnamon(aarch-64) patterns-openSUSE-cinnamon"
RDEPENDS:${PN} += "pattern()"
