...
RPROVIDES:${PN} += "ghc-devel(emojis-0.1.2-Gz9J6Rv977iEZp4TYp7wAm) ghc-emojis-devel ghc-emojis-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(text-2.0.2) ghc-emojis"
