...
RPROVIDES:${PN} += "newt-devel newt-devel(aarch-64) pkgconfig(libnewt)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnewt0_52 pkgconfig(slang) popt-devel python3-devel slang-devel"
