...
RPROVIDES:${PN} += "libQt5Sensors-private-headers-devel libqt5-qtsensors-private-headers-devel"
RDEPENDS:${PN} += "libQt5Core-private-headers-devel libqt5-qtsensors-devel"
