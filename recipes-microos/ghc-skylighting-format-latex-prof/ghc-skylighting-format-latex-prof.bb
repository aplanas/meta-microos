...
RPROVIDES:${PN} += "ghc-prof(skylighting-format-latex-0.1-BfMH5Wq0cc5AFSMLgsgxu) ghc-skylighting-format-latex-prof ghc-skylighting-format-latex-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(skylighting-core-0.13.2.1-6o4V0mA5OWyEHmMDE2dJ63) ghc-prof(text-2.0.2) ghc-skylighting-format-latex-devel"
