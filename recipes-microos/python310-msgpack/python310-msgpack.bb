...
RPROVIDES:${PN} += "python3-msgpack python3-msgpack-python python3.10dist(msgpack) python310-msgpack python310-msgpack(aarch-64) python310-msgpack-python python3dist(msgpack)"
