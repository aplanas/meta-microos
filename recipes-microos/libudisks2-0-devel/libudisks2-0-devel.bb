...
RPROVIDES:${PN} += "libudisks2-0-devel libudisks2-0-devel(aarch-64) pkgconfig(udisks2) pkgconfig(udisks2-bcache) pkgconfig(udisks2-btrfs) pkgconfig(udisks2-lsm) pkgconfig(udisks2-lvm2) pkgconfig(udisks2-zram)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libudisks2-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(udisks2)"
