...
RPROVIDES:${PN} += "python3-copr python3.10dist(copr) python310-copr python3dist(copr)"
RDEPENDS:${PN} += "python(abi) python310-marshmallow python310-munch python310-requests python310-requests-toolbelt"
