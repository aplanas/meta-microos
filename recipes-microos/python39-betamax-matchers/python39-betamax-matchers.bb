...
RPROVIDES:${PN} += "python3.9dist(betamax-matchers) python39-betamax-matchers python3dist(betamax-matchers)"
RDEPENDS:${PN} += "python(abi) python39-betamax python39-requests-toolbelt"
