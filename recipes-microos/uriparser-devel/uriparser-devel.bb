...
RPROVIDES:${PN} += "cmake(uriparser) liburiparser-devel pkgconfig(liburiparser) uriparser-devel uriparser-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel liburiparser1"
