...
RPROVIDES:${PN} += "python3.9dist(brotlicffi) python39-brotlicffi python39-brotlicffi(aarch-64) python3dist(brotlicffi)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-cffi"
