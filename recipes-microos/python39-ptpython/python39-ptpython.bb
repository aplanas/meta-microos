...
RPROVIDES:${PN} += "python3.9dist(ptpython) python39-ptpython python3dist(ptpython)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Pygments python39-appdirs python39-docopt python39-jedi python39-prompt_toolkit"
