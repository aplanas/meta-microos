...
RPROVIDES:${PN} += "python3.11dist(subgrab) python311-subgrab python3dist(subgrab)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-beautifulsoup4 python311-lxml python311-requests update-alternatives"
