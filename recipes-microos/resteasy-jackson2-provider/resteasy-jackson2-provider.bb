...
RPROVIDES:${PN} += "mvn(org.jboss.resteasy:resteasy-jackson2-provider) mvn(org.jboss.resteasy:resteasy-jackson2-provider:pom:) resteasy-jackson2-provider"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.fasterxml.jackson.core:jackson-annotations) mvn(com.fasterxml.jackson.core:jackson-core) mvn(com.fasterxml.jackson.core:jackson-databind) mvn(com.fasterxml.jackson.jaxrs:jackson-jaxrs-json-provider) mvn(org.apache.tomcat:tomcat-servlet-api)"
