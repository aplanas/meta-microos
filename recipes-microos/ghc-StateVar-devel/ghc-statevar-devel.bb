...
RPROVIDES:${PN} += "ghc-StateVar-devel ghc-StateVar-devel(aarch-64) ghc-devel(StateVar-1.2.2-GlWluWgK8kgE7IUHzo2idN)"
RDEPENDS:${PN} += "/bin/sh ghc-StateVar ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(stm-2.5.1.0) ghc-devel(transformers-0.5.6.2)"
