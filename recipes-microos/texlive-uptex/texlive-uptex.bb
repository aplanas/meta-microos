...
RPROVIDES:${PN} += "man(euptex.1) man(upbibtex.1) man(uppltotf.1) man(uptex.1) man(uptftopl.1) texlive-uptex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(language.dat) tex(language.dat.lua) tex(language.def) tex(updmap.cfg) texlive texlive-cm texlive-etex texlive-filesystem texlive-hyphen-base texlive-knuth-lib texlive-kpathsea texlive-kpathsea-bin texlive-plain texlive-ptex-base texlive-scripts texlive-scripts-bin texlive-uptex-base texlive-uptex-bin texlive-uptex-fonts"
