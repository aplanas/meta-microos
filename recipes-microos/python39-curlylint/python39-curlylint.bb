...
RPROVIDES:${PN} += "python3.9dist(curlylint) python39-curlylint python3dist(curlylint)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-attrs python39-click python39-parsy python39-pathspec python39-toml"
