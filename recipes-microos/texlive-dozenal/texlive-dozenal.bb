...
RPROVIDES:${PN} += "tex(dozchars10.tfm) tex(dozchars12.tfm) tex(dozchars17.tfm) tex(dozchars6.tfm) tex(dozchars7.tfm) tex(dozchars8.tfm) tex(dozchars9.tfm) tex(dozchb10.tfm) tex(dozchbx10.tfm) tex(dozchbx12.tfm) tex(dozchbx5.tfm) tex(dozchbx6.tfm) tex(dozchbx7.tfm) tex(dozchbx8.tfm) tex(dozchbx9.tfm) tex(dozchbxi10.tfm) tex(dozchbxsl10.tfm) tex(dozchit10.tfm) tex(dozchit12.tfm) tex(dozchit7.tfm) tex(dozchit8.tfm) tex(dozchit9.tfm) tex(dozchsl10.tfm) tex(dozchsl12.tfm) tex(dozchsl8.tfm) tex(dozchsl9.tfm) tex(dozenal.map) tex(dozenal.sty) tex(gray.tfm) texlive-dozenal"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fixltx2e.sty) tex(ifluatex.sty) tex(ifpdf.sty) tex(mfirstuc.sty) tex(xstring.sty) texlive texlive-dozenal-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
