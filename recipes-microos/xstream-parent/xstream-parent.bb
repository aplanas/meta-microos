...
RPROVIDES:${PN} += "mvn(com.thoughtworks.xstream:xstream-parent:pom:) xstream-parent"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.codehaus.mojo:build-helper-maven-plugin) xstream"
