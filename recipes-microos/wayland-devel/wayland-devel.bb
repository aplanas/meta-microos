...
RPROVIDES:${PN} += "libwayland-egl-devel pkgconfig(wayland-client) pkgconfig(wayland-cursor) pkgconfig(wayland-egl) pkgconfig(wayland-egl-backend) pkgconfig(wayland-scanner) pkgconfig(wayland-server) wayland-devel wayland-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libexpat.so.1()(64bit) libwayland-client0 libwayland-cursor0 libwayland-egl1 libwayland-server0 libxml2.so.2()(64bit) libxml2.so.2(LIBXML2_2.4.30)(64bit) libxml2.so.2(LIBXML2_2.5.8)(64bit) libxml2.so.2(LIBXML2_2.6.0)(64bit) pkgconfig(libffi) pkgconfig(wayland-client)"
