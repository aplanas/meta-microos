...
RPROVIDES:${PN} += "tex(tikz-among-us-fancyhdr.sty) tex(tikz-among-us-watermark-eso-pic.sty) tex(tikz-among-us.sty) texlive-tikz-among-us"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(eso-pic.sty) tex(fancyhdr.sty) tex(kvoptions.sty) tex(tikz.sty) tex(xifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
