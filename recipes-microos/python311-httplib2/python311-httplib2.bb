...
RPROVIDES:${PN} += "python3.11dist(httplib2) python311-httplib2 python3dist(httplib2)"
RDEPENDS:${PN} += "ca-certificates python(abi) python311-certifi python311-pyparsing"
