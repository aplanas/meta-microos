...
RPROVIDES:${PN} += "libcomps-devel libcomps-devel(aarch-64) pkgconfig(libcomps)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libcomps0(aarch-64) pkgconfig pkgconfig(expat) pkgconfig(libxml-2.0)"
