...
RPROVIDES:${PN} += "libdict-devel libdict-devel(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdict.so.1.0()(64bit) libdict1_0"
