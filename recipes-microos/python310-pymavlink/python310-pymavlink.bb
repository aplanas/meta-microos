...
RPROVIDES:${PN} += "python3-pymavlink python3.10dist(pymavlink) python310-pymavlink python310-pymavlink(aarch-64) python3dist(pymavlink)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-future python310-lxml update-alternatives"
