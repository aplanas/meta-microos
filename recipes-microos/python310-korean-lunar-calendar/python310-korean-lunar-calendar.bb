...
RPROVIDES:${PN} += "python3-korean-lunar-calendar python3-korean_lunar_calendar python3.10dist(korean-lunar-calendar) python310-korean-lunar-calendar python310-korean_lunar_calendar python3dist(korean-lunar-calendar)"
