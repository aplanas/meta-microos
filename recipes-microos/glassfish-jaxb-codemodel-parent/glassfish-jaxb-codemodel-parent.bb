...
RPROVIDES:${PN} += "glassfish-jaxb-codemodel-parent mvn(com.sun.xml.bind.mvn:jaxb-codemodel-parent:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.sun.xml.bind.mvn:jaxb-parent:pom:)"
