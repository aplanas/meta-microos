...
RPROVIDES:${PN} += "tex(returntogrid.sty) texlive-returntogrid"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(eso-pic.sty) tex(xparse.sty) tex(zref-abspage.sty) tex(zref-savepos.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
