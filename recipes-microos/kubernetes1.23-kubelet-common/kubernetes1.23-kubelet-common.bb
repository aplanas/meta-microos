...
RPROVIDES:${PN} += "kubernetes-kubelet-common kubernetes1.23-kubelet-common kubernetes1.23-kubelet-common(aarch-64)"
RDEPENDS:${PN} += "/bin/sh cri-runtime kubernetes-kubelet1.23"
