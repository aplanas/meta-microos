...
RPROVIDES:${PN} += "python3.9dist(pyinstaller) python39-PyInstaller python39-PyInstaller(aarch-64) python3dist(pyinstaller)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libz.so.1()(64bit) python(abi) python39-devel python39-macholib python39-pefile python39-setuptools update-alternatives"
