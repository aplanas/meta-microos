...
RPROVIDES:${PN} += "perl(Task::Kensho::ModuleDev) perl-Task-Kensho-ModuleDev"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(CPAN::Uploader) perl(Code::TidyAll) perl(Data::Printer) perl(Devel::Confess) perl(Devel::Dwarn) perl(Devel::NYTProf) perl(Dist::Zilla) perl(Modern::Perl) perl(Module::Build::Tiny) perl(Perl::Critic) perl(Perl::Tidy) perl(Pod::Readme) perl(Software::License)"
