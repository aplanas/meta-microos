...
RPROVIDES:${PN} += "tex(tikz-lake-fig.sty) texlive-tikz-lake-fig"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(colortbl.sty) tex(multirow.sty) tex(pbox.sty) tex(relsize.sty) tex(subfiles.sty) tex(tabularx.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
