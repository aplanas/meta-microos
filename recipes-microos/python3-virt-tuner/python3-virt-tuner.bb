...
RPROVIDES:${PN} += "python3-virt-tuner python3.10dist(virt-tuner) python3dist(virt-tuner)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 python(abi) python3-libvirt-python update-alternatives"
