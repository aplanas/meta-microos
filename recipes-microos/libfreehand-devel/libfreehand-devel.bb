...
RPROVIDES:${PN} += "libfreehand-devel libfreehand-devel(aarch-64) pkgconfig(libfreehand-0.1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libfreehand-0_1-1 pkgconfig(librevenge-0.0) pkgconfig(zlib)"
