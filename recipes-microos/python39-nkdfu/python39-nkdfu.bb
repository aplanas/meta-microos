...
RPROVIDES:${PN} += "python3.9dist(nkdfu) python39-nkdfu python3dist(nkdfu)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 intelhex python(abi) python39-fire python39-libusb1 python39-tqdm update-alternatives"
