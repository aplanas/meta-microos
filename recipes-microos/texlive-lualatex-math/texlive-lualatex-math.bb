...
RPROVIDES:${PN} += "tex(lualatex-math.sty) texlive-lualatex-math"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(expl3.sty) tex(filehook.sty) tex(luatexbase.sty) texlive texlive-etoolbox texlive-filehook texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
