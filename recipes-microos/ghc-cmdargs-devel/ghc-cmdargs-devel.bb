...
RPROVIDES:${PN} += "ghc-cmdargs-devel ghc-cmdargs-devel(aarch-64) ghc-devel(cmdargs-0.10.22-JxALoPeruUH3tSM40P8Mx)"
RDEPENDS:${PN} += "/bin/sh ghc-cmdargs ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(filepath-1.4.2.2) ghc-devel(process-1.6.16.0) ghc-devel(template-haskell-2.19.0.0) ghc-devel(transformers-0.5.6.2)"
