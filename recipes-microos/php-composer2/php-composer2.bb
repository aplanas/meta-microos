...
RPROVIDES:${PN} += "composer php-composer php-composer2 php7-composer"
RDEPENDS:${PN} += "/bin/sh php php-curl php-json php-mbstring php-openssl php-phar php-zip php-zlib update-alternatives"
