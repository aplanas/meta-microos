...
RPROVIDES:${PN} += "tex(cachepic.sty) tex(prcachepic.def) texlive-cachepic"
RDEPENDS:${PN} += "/bin/sh /usr/bin/texlua coreutils ed findutils grep sed tex(graphicx.sty) tex(verbatim.sty) texlive texlive-cachepic-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
