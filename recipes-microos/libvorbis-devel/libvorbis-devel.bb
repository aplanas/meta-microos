...
RPROVIDES:${PN} += "libvorbis-devel libvorbis-devel(aarch-64) pkgconfig(vorbis) pkgconfig(vorbisenc) pkgconfig(vorbisfile)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libogg-devel libvorbis0 libvorbisenc2 libvorbisfile3 pkgconfig(ogg) pkgconfig(vorbis)"
