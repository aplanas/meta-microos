...
RPROVIDES:${PN} += "caja-rename python3.10dist(cajarename) python3dist(cajarename)"
RDEPENDS:${PN} += "/usr/bin/python3 caja python(abi) python-caja python3-gobject python3-gobject-Gdk typelib(Caja) typelib(GObject) typelib(Gio) typelib(Gtk)"
