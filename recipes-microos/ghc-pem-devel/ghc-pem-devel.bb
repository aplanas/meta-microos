...
RPROVIDES:${PN} += "ghc-devel(pem-0.2.4-GVwv4fsQYoEEDbQiUNwxns) ghc-pem-devel ghc-pem-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(basement-0.0.15-6OmKTVi2kFpCWMoKDlsO4S) ghc-devel(bytestring-0.11.4.0) ghc-devel(memory-0.18.0-2DG6nqjfLMK4MSR77XYQqL) ghc-pem"
