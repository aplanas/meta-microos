...
RPROVIDES:${PN} += "ghc-csv-devel ghc-csv-devel(aarch-64) ghc-devel(csv-0.1.2-LKioaw43aTAAAKpIk04xxN)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-csv ghc-devel(base-4.17.1.0) ghc-devel(filepath-1.4.2.2) ghc-devel(parsec-3.1.16.1)"
