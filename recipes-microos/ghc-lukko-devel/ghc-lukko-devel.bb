...
RPROVIDES:${PN} += "ghc-devel(lukko-0.1.1.3-7Ko9x6wnjxCV3NuL9k89V) ghc-lukko-devel ghc-lukko-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-lukko"
