...
RPROVIDES:${PN} += "application() application(vkeybd.desktop) vkeybd vkeybd(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libasound.so.2()(64bit) libasound.so.2(ALSA_0.9)(64bit) libc.so.6(GLIBC_2.34)(64bit) libtcl8.6.so()(64bit) libtk8.6.so()(64bit)"
