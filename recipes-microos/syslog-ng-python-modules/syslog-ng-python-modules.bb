...
RPROVIDES:${PN} += "syslog-ng-python-modules syslog-ng-python-modules(aarch-64)"
RDEPENDS:${PN} += "python3-PyYAML python3-cachetools python3-certifi python3-charset-normalizer python3-google-auth python3-idna python3-kubernetes python3-pip python3-pyasn1 python3-pyasn1-modules python3-python-dateutil python3-requests python3-rsa python3-six python3-websocket-client syslog-ng syslog-ng-python"
