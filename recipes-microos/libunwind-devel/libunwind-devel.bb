...
RPROVIDES:${PN} += "libunwind-devel libunwind-devel(aarch-64) pkgconfig(libunwind) pkgconfig(libunwind-coredump) pkgconfig(libunwind-generic) pkgconfig(libunwind-ptrace) pkgconfig(libunwind-setjmp)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libunwind-coredump0 libunwind-ptrace0 libunwind-setjmp0 libunwind8 pkgconfig(libunwind) pkgconfig(libunwind-generic)"
