...
RPROVIDES:${PN} += "python3-Delorean python3.10dist(delorean) python310-Delorean python3dist(delorean)"
RDEPENDS:${PN} += "python(abi) python310-Babel python310-humanize python310-python-dateutil python310-pytz python310-tzlocal"
