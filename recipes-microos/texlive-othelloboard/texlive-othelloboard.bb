...
RPROVIDES:${PN} += "tex(othelloboard.sty) texlive-othelloboard"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(graphicx.sty) tex(ifthen.sty) tex(pict2e.sty) tex(stringstrings.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
