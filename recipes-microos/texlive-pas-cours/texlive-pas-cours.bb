...
RPROVIDES:${PN} += "tex(macro-calculs.tex) tex(macro-patrons.tex) tex(macro-solides.tex) tex(macro-styles.tex) tex(pas-cours.sty) texlive-pas-cours"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(auto-pst-pdf.sty) tex(enumitem.sty) tex(fancyvrb.sty) tex(ifplatform.sty) tex(numprint.sty) tex(pst-plot.sty) tex(tikz.sty) tex(xkeyval.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
