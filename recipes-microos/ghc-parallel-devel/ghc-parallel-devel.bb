...
RPROVIDES:${PN} += "ghc-devel(parallel-3.2.2.0-36KAHtmQlbB59K6tPbQ0Jr) ghc-parallel-devel ghc-parallel-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(deepseq-1.4.8.0) ghc-devel(ghc-prim-0.9.0) ghc-parallel"
