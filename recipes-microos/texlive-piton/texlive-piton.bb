...
RPROVIDES:${PN} += "tex(piton.sty) texlive-piton"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(footnote.sty) tex(footnotehyper.sty) tex(l3keys2e.sty) tex(luacode.sty) tex(luatexbase.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
