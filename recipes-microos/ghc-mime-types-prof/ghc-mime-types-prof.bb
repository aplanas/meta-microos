...
RPROVIDES:${PN} += "ghc-mime-types-prof ghc-mime-types-prof(aarch-64) ghc-prof(mime-types-0.1.1.0-IrWGRRDe33Y1D55h7nh7fm)"
RDEPENDS:${PN} += "ghc-mime-types-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(containers-0.6.7) ghc-prof(text-2.0.2)"
