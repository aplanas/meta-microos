...
RPROVIDES:${PN} += "python3.9dist(pipreqs) python39-pipreqs python3dist(pipreqs)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-docopt python39-setuptools python39-yarg update-alternatives"
