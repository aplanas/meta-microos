...
RPROVIDES:${PN} += "ghc-devel(isocline-1.0.9-7x8dFWbXh69GJxYhigSqXG) ghc-isocline-devel ghc-isocline-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(text-2.0.2) ghc-isocline"
