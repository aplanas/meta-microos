...
RPROVIDES:${PN} += "gtk2-engine-hcengine gtk2-engine-hcengine(aarch-64) libhcengine.so()(64bit)"
RDEPENDS:${PN} += "gtk2 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcairo.so.2()(64bit) libgdk-x11-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit)"
