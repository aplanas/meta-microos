...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-gnome-gnome_office patterns-gnome-gnome_office(aarch-64) patterns-openSUSE-gnome_office"
RDEPENDS:${PN} += "pattern()"
