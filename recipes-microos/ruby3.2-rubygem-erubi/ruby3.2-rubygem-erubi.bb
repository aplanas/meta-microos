...
RPROVIDES:${PN} += "ruby3.2-rubygem-erubi ruby3.2-rubygem-erubi(aarch-64) rubygem(erubi) rubygem(ruby:3.2.0:erubi) rubygem(ruby:3.2.0:erubi:1) rubygem(ruby:3.2.0:erubi:1.11) rubygem(ruby:3.2.0:erubi:1.11.0)"
