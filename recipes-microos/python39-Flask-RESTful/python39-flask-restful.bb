...
RPROVIDES:${PN} += "python3.9dist(flask-restful) python39-Flask-RESTful python3dist(flask-restful)"
RDEPENDS:${PN} += "python(abi) python39-Flask python39-aniso8601 python39-pytz python39-six"
