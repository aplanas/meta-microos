...
RPROVIDES:${PN} += "python3.9dist(blockdiag) python39-blockdiag python3dist(blockdiag)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Pillow python39-funcparserlib python39-setuptools python39-webcolors update-alternatives"
