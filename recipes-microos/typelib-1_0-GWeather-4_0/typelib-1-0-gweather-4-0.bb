...
RPROVIDES:${PN} += "typelib(GWeather) typelib-1_0-GWeather-4_0 typelib-1_0-GWeather-4_0(aarch-64)"
RDEPENDS:${PN} += "libgweather-4.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
