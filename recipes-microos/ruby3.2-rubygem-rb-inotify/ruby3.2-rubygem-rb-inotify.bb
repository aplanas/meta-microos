...
RPROVIDES:${PN} += "ruby3.2-rubygem-rb-inotify ruby3.2-rubygem-rb-inotify(aarch-64) rubygem(rb-inotify) rubygem(ruby:3.2.0:rb-inotify) rubygem(ruby:3.2.0:rb-inotify:0) rubygem(ruby:3.2.0:rb-inotify:0.10) rubygem(ruby:3.2.0:rb-inotify:0.10.1)"
