...
RPROVIDES:${PN} += "python3.11dist(pytest-git) python311-pytest-git python3dist(pytest-git)"
RDEPENDS:${PN} += "python(abi) python311-GitPython python311-pytest python311-pytest-shutil"
