...
RPROVIDES:${PN} += "dumb dumb(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libSDL2-2.0.so.0()(64bit) libargtable2.so.0()(64bit) libc.so.6(GLIBC_2.34)(64bit) libdumb.so.2()(64bit)"
