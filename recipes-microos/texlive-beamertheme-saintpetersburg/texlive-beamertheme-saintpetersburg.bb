...
RPROVIDES:${PN} += "tex(beamercolorthemeSaintPetersburg.sty) tex(beamerfontthemeSaintPetersburg.sty) tex(beamerthemeSaintPetersburg.sty) texlive-beamertheme-saintpetersburg"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(FiraMono.sty) tex(fontspec.sty) tex(graphicx.sty) tex(ifxetex.sty) tex(opensans.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
