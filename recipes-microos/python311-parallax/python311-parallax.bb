...
RPROVIDES:${PN} += "python3.11dist(parallax) python311-parallax python3dist(parallax)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 openssh python(abi) update-alternatives"
