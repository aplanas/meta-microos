...
RPROVIDES:${PN} += "tex(tikzscale.sty) texlive-tikzscale"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(graphicx.sty) tex(letltxmacro.sty) tex(pgfkeys.sty) tex(xparse.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
