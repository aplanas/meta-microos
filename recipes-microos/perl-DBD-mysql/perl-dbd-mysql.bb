...
RPROVIDES:${PN} += "perl(Bundle::DBD::mysql) perl(DBD::mysql) perl(DBD::mysql::GetInfo) perl(DBD::mysql::db) perl(DBD::mysql::dr) perl(DBD::mysql::st) perl-DBD-mysql perl-DBD-mysql(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libmariadb.so.3()(64bit) libmariadb.so.3(libmysqlclient_18)(64bit) perl(:MODULE_COMPAT_5.36.0) perl(DBI)"
