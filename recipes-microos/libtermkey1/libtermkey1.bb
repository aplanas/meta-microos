...
RPROVIDES:${PN} += "libtermkey.so.1()(64bit) libtermkey1 libtermkey1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libunibilium.so.4()(64bit)"
