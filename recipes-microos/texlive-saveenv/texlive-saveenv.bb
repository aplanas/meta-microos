...
RPROVIDES:${PN} += "tex(saveenv.sty) texlive-saveenv"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(precattl.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-precattl texlive-scripts texlive-scripts-bin"
