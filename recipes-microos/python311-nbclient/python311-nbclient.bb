...
RPROVIDES:${PN} += "python3.11dist(nbclient) python311-nbclient python3dist(nbclient)"
RDEPENDS:${PN} += "((python311-jupyter-core >= 4.12 with python311-jupyter-core < 5) or python311-jupyter-core >= 5.1) /bin/sh /usr/bin/python3.11 alts python(abi) python311-jupyter-client python311-nbformat python311-traitlets"
