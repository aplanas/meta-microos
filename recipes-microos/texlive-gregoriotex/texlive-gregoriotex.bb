...
RPROVIDES:${PN} += "tex(gregorio-vowels.dat) tex(gregoriosyms.sty) tex(gregoriotex-chars.tex) tex(gregoriotex-common.tex) tex(gregoriotex-gsp-default.tex) tex(gregoriotex-main.tex) tex(gregoriotex-nabc.tex) tex(gregoriotex-signs.tex) tex(gregoriotex-spaces.tex) tex(gregoriotex-syllable.tex) tex(gregoriotex-symbols.tex) tex(gregoriotex.sty) tex(gregoriotex.tex) texlive-gregoriotex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(iftex.sty) tex(kvoptions.sty) tex(luacolor.sty) tex(luamplib.sty) tex(luaotfload.sty) tex(luatexbase.sty) tex(xcolor.sty) tex(xstring.sty) texlive texlive-filesystem texlive-gregoriotex-bin texlive-gregoriotex-fonts texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
