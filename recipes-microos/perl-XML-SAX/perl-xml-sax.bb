...
RPROVIDES:${PN} += "perl(XML::SAX) perl(XML::SAX::DocumentLocator) perl(XML::SAX::ParserFactory) perl(XML::SAX::PurePerl) perl(XML::SAX::PurePerl::DebugHandler) perl(XML::SAX::PurePerl::Exception) perl(XML::SAX::PurePerl::Productions) perl(XML::SAX::PurePerl::Reader) perl(XML::SAX::PurePerl::Reader::Stream) perl(XML::SAX::PurePerl::Reader::String) perl(XML::SAX::PurePerl::Reader::URI) perl-XML-SAX"
RDEPENDS:${PN} += "/bin/sh perl(:MODULE_COMPAT_5.36.0) perl(XML::NamespaceSupport) perl(XML::SAX::Base)"
