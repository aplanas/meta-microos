...
RPROVIDES:${PN} += "libdbusmenu-gtk2-devel libdbusmenu-gtk2-devel(aarch-64) pkgconfig(dbusmenu-gtk-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdbusmenu-gtk4 pkgconfig(dbus-glib-1) pkgconfig(dbusmenu-glib-0.4) pkgconfig(gdk-pixbuf-2.0) pkgconfig(gtk+-2.0) typelib-1_0-DbusmenuGtk-0_4"
