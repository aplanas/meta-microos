...
RPROVIDES:${PN} += "typelib(RygelCore) typelib-1_0-RygelCore-2_8 typelib-1_0-RygelCore-2_8(aarch-64)"
RDEPENDS:${PN} += "typelib(GLib) typelib(GObject) typelib(GSSDP) typelib(GUPnP) typelib(Gee) typelib(Gio) typelib(Soup) typelib(libxml2)"
