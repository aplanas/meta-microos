...
RPROVIDES:${PN} += "ghc-primes-prof ghc-primes-prof(aarch-64) ghc-prof(primes-0.2.1.0-EDehUtw1pOPPL7EktYCRg)"
RDEPENDS:${PN} += "ghc-primes-devel ghc-prof(base-4.17.1.0)"
