...
RPROVIDES:${PN} += "fence-sanlock fence-sanlock(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libsanlock.so.1()(64bit) libwdmd.so.1()(64bit) sanlock"
