...
RPROVIDES:${PN} += "libeuvccam_cpi.so()(64bit) libunicap.so.2()(64bit) libunicap2 libunicap2(aarch-64) libv4l2cpi.so()(64bit) unicap"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libraw1394.so.11()(64bit)"
