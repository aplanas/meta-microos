...
RPROVIDES:${PN} += "ghc-polyparse-prof ghc-polyparse-prof(aarch-64) ghc-prof(polyparse-1.13-E8FdqtcSqxM3P2njDFrYm8)"
RDEPENDS:${PN} += "ghc-polyparse-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(text-2.0.2)"
