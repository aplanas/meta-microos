...
RPROVIDES:${PN} += "tex(href-ul.sty) texlive-href-ul"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(hyperref.sty) tex(ulem.sty) texlive texlive-filesystem texlive-hyperref texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-ulem"
