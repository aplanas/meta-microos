...
RPROVIDES:${PN} += "python3.9dist(genshi) python39-Genshi python39-Genshi(aarch-64) python3dist(genshi)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-Babel python39-six python39-xml"
