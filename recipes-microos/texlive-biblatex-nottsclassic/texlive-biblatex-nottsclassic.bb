...
RPROVIDES:${PN} += "tex(nottsclassic-english.lbx) tex(nottsclassic.bbx) tex(nottsclassic.cbx) texlive-biblatex-nottsclassic"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(authoryear.bbx) tex(british.sty) tex(csquotes.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
