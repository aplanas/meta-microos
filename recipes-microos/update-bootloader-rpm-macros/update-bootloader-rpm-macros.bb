...
RPROVIDES:${PN} += "rpm_macro(update_bootloader_check_type_refresh_post) rpm_macro(update_bootloader_check_type_reinit_post) rpm_macro(update_bootloader_posttrans) rpm_macro(update_bootloader_refresh_post) rpm_macro(update_bootloader_reinit_post) rpm_macro(update_bootloader_requires) update-bootloader-rpm-macros"
RDEPENDS:${PN} += ""
