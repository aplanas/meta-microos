...
RPROVIDES:${PN} += "tex(multibibliography.sty) texlive-multibibliography"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl coreutils ed findutils grep perl(strict) sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-multibibliography-bin texlive-scripts texlive-scripts-bin"
