...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-desktop-mobile patterns-desktop-mobile(aarch-64) patterns-openSUSE-laptop patterns-openSUSE-mobile"
RDEPENDS:${PN} += "pattern()"
