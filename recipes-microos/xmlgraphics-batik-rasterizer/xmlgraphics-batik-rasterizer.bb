...
RPROVIDES:${PN} += "batik-rasterizer config(xmlgraphics-batik-rasterizer) mvn(org.apache.xmlgraphics:batik-rasterizer) mvn(org.apache.xmlgraphics:batik-rasterizer-ext) mvn(org.apache.xmlgraphics:batik-rasterizer-ext:pom:) mvn(org.apache.xmlgraphics:batik-rasterizer:pom:) osgi(org.apache.batik.rasterizer) osgi(org.apache.batik.rasterizer-ext) xmlgraphics-batik-rasterizer"
