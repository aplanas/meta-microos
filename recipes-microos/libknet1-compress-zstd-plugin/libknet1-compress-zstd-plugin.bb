...
RPROVIDES:${PN} += "libknet1-compress-zstd-plugin libknet1-compress-zstd-plugin(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) libknet1(aarch-64) libzstd.so.1()(64bit)"
