...
RPROVIDES:${PN} += "mvn(org.fedoraproject.xmvn:xmvn-mojo) mvn(org.fedoraproject.xmvn:xmvn-mojo:pom:) xmvn-mojo"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven.resolver:maven-resolver-util) mvn(org.fedoraproject.xmvn:xmvn-api) mvn(org.fedoraproject.xmvn:xmvn-core) mvn(org.ow2.asm:asm)"
