...
RPROVIDES:${PN} += "tex(g-brief.cls) tex(g-brief.sty) tex(g-brief2.cls) tex(g-brief2.sty) texlive-g-brief"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(babel.sty) tex(eurosym.sty) tex(ifthen.sty) tex(inputenc.sty) tex(letter.cls) tex(marvosym.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
