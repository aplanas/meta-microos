...
RPROVIDES:${PN} += "man(mag.1) man(pfb2pfa.1) man(pk2bm.1) man(ps2pk.1) texlive-ps2pk"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-ps2pk-bin texlive-scripts texlive-scripts-bin"
