...
RPROVIDES:${PN} += "gegl-devel gegl-devel(aarch-64) pkgconfig(gegl-0.4) pkgconfig(gegl-sc-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgegl-0_4-0 pkgconfig(babl-0.1) pkgconfig(gegl-0.4) pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gmodule-2.0) pkgconfig(gobject-2.0) pkgconfig(json-glib-1.0) typelib-1_0-Gegl-0_4"
