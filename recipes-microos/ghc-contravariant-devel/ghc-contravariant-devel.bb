...
RPROVIDES:${PN} += "ghc-contravariant-devel ghc-contravariant-devel(aarch-64) ghc-devel(contravariant-1.5.5-K71YSUvfKnA5wfNaE05Lao)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-contravariant ghc-devel(StateVar-1.2.2-GlWluWgK8kgE7IUHzo2idN) ghc-devel(base-4.17.1.0) ghc-devel(transformers-0.5.6.2)"
