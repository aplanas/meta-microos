...
RPROVIDES:${PN} += "python3.9dist(django-mailer) python39-django-mailer python3dist(django-mailer)"
RDEPENDS:${PN} += "python(abi) python39-Django python39-lockfile python39-six"
