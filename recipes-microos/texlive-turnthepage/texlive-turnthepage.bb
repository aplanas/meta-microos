...
RPROVIDES:${PN} += "tex(turnpageetex.sty) tex(turnpagewoetex.sty) tex(turnthepage.sty) texlive-turnthepage"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(alphalph.sty) tex(atbegshi.sty) tex(pageslts.sty) tex(picture.sty) tex(zref-abspage.sty) tex(zref-lastpage.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
