...
RPROVIDES:${PN} += "sensord sensord(aarch-64) sensors:/usr/sbin/sensord"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/touch fillup ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) librrd.so.8()(64bit) libsensors.so.4()(64bit)"
