...
RPROVIDES:${PN} += "p11-kit-devel p11-kit-devel(aarch-64) pkgconfig(p11-kit-1) rpm_macro(pkidir_cfg) rpm_macro(pkidir_static) rpm_macro(trustdir_cfg) rpm_macro(trustdir_static)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libp11-kit0"
