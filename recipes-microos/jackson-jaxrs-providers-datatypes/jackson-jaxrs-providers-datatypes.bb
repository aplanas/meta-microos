...
RPROVIDES:${PN} += "jackson-jaxrs-providers-datatypes mvn(com.fasterxml.jackson.datatype:jackson-datatype-jaxrs) mvn(com.fasterxml.jackson.datatype:jackson-datatype-jaxrs:pom:) osgi(com.fasterxml.jackson.datatype.jackson-datatype-jaxrs)"
