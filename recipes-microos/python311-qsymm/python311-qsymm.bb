...
RPROVIDES:${PN} += "python3.11dist(qsymm) python311-qsymm python3dist(qsymm)"
RDEPENDS:${PN} += "python(abi) python311-numpy python311-scipy python311-sympy python311-tinyarray"
