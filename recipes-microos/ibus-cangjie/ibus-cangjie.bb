...
RPROVIDES:${PN} += "application() application(ibus-setup-cangjie.desktop) application(ibus-setup-quick.desktop) ibus-cangjie metainfo() metainfo(cangjie.appdata.xml) metainfo(quick.appdata.xml)"
RDEPENDS:${PN} += "/usr/bin/python3 ibus python(abi) python3 python3-cangjie python3-gobject"
