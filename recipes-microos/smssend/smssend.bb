...
RPROVIDES:${PN} += "smssend smssend(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /usr/bin/perl ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpcre.so.1()(64bit)"
