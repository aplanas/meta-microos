...
RPROVIDES:${PN} += "perl(Apache::Session) perl(Apache::Session::DB_File) perl(Apache::Session::File) perl(Apache::Session::Flex) perl(Apache::Session::Generate::MD5) perl(Apache::Session::Generate::ModUniqueId) perl(Apache::Session::Generate::ModUsertrack) perl(Apache::Session::Informix) perl(Apache::Session::Lock::File) perl(Apache::Session::Lock::MySQL) perl(Apache::Session::Lock::Null) perl(Apache::Session::Lock::Semaphore) perl(Apache::Session::Lock::Sybase) perl(Apache::Session::MySQL) perl(Apache::Session::MySQL::NoLock) perl(Apache::Session::Oracle) perl(Apache::Session::Postgres) perl(Apache::Session::Serialize::Base64) perl(Apache::Session::Serialize::Storable) perl(Apache::Session::Serialize::Sybase) perl(Apache::Session::Serialize::UUEncode) perl(Apache::Session::Store::DBI) perl(Apache::Session::Store::DB_File) perl(Apache::Session::Store::File) perl(Apache::Session::Store::Informix) perl(Apache::Session::Store::MySQL) perl(Apache::Session::Store::Oracle) perl(Apache::Session::Store::Postgres) perl(Apache::Session::Store::Sybase) perl(Apache::Session::Sybase) perl-Apache-Session"
