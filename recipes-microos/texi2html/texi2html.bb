...
RPROVIDES:${PN} += "texi2html texinfo:/usr/bin/texi2html"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl perl(Unicode::EastAsianWidth) perl-Text-Unidecode perl-gettext perl-libintl-perl"
