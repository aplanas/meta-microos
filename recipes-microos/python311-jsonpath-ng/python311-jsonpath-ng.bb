...
RPROVIDES:${PN} += "python3.11dist(jsonpath-ng) python311-jsonpath-ng python3dist(jsonpath-ng)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-decorator python311-ply python311-six"
