...
RPROVIDES:${PN} += "ghc-HUnit-prof ghc-HUnit-prof(aarch-64) ghc-prof(HUnit-1.6.2.0-iqxwhcxJRu7EJOd1Mnwmb)"
RDEPENDS:${PN} += "ghc-HUnit-devel ghc-prof(base-4.17.1.0) ghc-prof(call-stack-0.4.0-K9VxYWjBEvtITBfD6bL7Dk) ghc-prof(deepseq-1.4.8.0)"
