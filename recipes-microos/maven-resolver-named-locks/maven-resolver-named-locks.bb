...
RPROVIDES:${PN} += "maven-resolver-named-locks mvn(org.apache.maven.resolver:maven-resolver-named-locks) mvn(org.apache.maven.resolver:maven-resolver-named-locks:pom:) mvn(org.eclipse.aether:aether-named-locks) mvn(org.eclipse.aether:aether-named-locks:pom:) osgi(org.apache.maven.resolver.named.locks)"
