...
RPROVIDES:${PN} += "obexftp-devel obexftp-devel(aarch-64) pkgconfig(obexftp)"
RDEPENDS:${PN} += "/usr/bin/pkg-config obexftp openobex-devel pkgconfig(bluez) pkgconfig(openobex)"
