...
RPROVIDES:${PN} += "tex(realhats.sty) texlive-realhats"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(calc.sty) tex(graphicx.sty) tex(ifthen.sty) tex(lcg.sty) tex(stackengine.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
