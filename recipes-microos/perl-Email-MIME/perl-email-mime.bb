...
RPROVIDES:${PN} += "perl(Email::MIME) perl(Email::MIME::Creator) perl(Email::MIME::Encode) perl(Email::MIME::Header) perl(Email::MIME::Header::AddressList) perl(Email::MIME::Modifier) perl-Email-MIME"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Email::Address::XS) perl(Email::MIME::ContentType) perl(Email::MIME::Encodings) perl(Email::MessageID) perl(Email::Simple) perl(Email::Simple::Creator) perl(Email::Simple::Header) perl(MIME::Types) perl(Module::Runtime) perl(parent)"
