...
RPROVIDES:${PN} += "chealpix-devel chealpix-devel(aarch-64) pkgconfig(chealpix)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libchealpix0 pkgconfig(cfitsio) pkgconfig(libsharp)"
