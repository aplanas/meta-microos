...
RPROVIDES:${PN} += "perl(Mail::Transport) perl(Mail::Transport::Exim) perl(Mail::Transport::Mailx) perl(Mail::Transport::Qmail) perl(Mail::Transport::Receive) perl(Mail::Transport::SMTP) perl(Mail::Transport::Send) perl(Mail::Transport::Sendmail) perl-Mail-Transport"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Mail::Reporter)"
