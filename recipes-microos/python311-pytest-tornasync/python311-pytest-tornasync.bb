...
RPROVIDES:${PN} += "python3.11dist(pytest-tornasync) python311-pytest-tornasync python3dist(pytest-tornasync)"
RDEPENDS:${PN} += "python(abi) python311-base python311-pytest python311-tornado"
