...
RPROVIDES:${PN} += "libzrtpcpp-devel libzrtpcpp-devel(aarch-64) pkgconfig(libzrtpcpp)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ccrtp-devel libzrtpcpp4 pkgconfig(libcrypto)"
