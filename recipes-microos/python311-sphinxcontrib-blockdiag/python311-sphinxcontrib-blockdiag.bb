...
RPROVIDES:${PN} += "python3.11dist(sphinxcontrib-blockdiag) python311-sphinxcontrib-blockdiag python3dist(sphinxcontrib-blockdiag)"
RDEPENDS:${PN} += "python(abi) python311-Sphinx python311-blockdiag"
