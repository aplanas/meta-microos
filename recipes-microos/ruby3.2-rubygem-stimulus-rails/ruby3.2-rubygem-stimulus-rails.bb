...
RPROVIDES:${PN} += "ruby3.2-rubygem-stimulus-rails ruby3.2-rubygem-stimulus-rails(aarch-64) rubygem(ruby:3.2.0:stimulus-rails) rubygem(ruby:3.2.0:stimulus-rails:1) rubygem(ruby:3.2.0:stimulus-rails:1.2) rubygem(ruby:3.2.0:stimulus-rails:1.2.1) rubygem(stimulus-rails)"
