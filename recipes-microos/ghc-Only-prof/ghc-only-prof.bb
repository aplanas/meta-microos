...
RPROVIDES:${PN} += "ghc-Only-prof ghc-Only-prof(aarch-64) ghc-prof(Only-0.1-ETd5YCT0TwGLbN8rgpgTS8)"
RDEPENDS:${PN} += "ghc-Only-devel ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0)"
