...
RPROVIDES:${PN} += "tex(beamercolorthemepureminimalistic.sty) tex(beamerfontthemepureminimalistic.sty) tex(beamerinnerthemepureminimalistic.sty) tex(beamerouterthemepureminimalistic.sty) tex(beamerthemepureminimalistic.sty) texlive-beamertheme-pure-minimalistic"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(FiraMono.sty) tex(FiraSans.sty) tex(calc.sty) tex(etoolbox.sty) tex(fontenc.sty) tex(iftex.sty) tex(ifthen.sty) tex(noto.sty) tex(silence.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
