...
RPROVIDES:${PN} += "tex(hyph-sh-cyrl.t2a.tex) tex(hyph-sh-cyrl.tex) tex(hyph-sh-latn.ec.tex) tex(hyph-sh-latn.tex) tex(hyph-sr-cyrl.tex) tex(loadhyph-sr-cyrl.tex) tex(loadhyph-sr-latn.tex) texlive-hyphen-serbian"
