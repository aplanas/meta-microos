...
RPROVIDES:${PN} += "python3.11dist(weasyprint) python311-WeasyPrint python311-weasyprint python3dist(weasyprint)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 libgobject-2_0-0 pango python(abi) python311-Brotli python311-FontTools python311-Pillow python311-Pyphen python311-base python311-cffi python311-cssselect2 python311-html5lib python311-pydyf python311-tinycss2 python311-zopfli update-alternatives"
