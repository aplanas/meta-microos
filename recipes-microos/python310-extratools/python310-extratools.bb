...
RPROVIDES:${PN} += "python3-extratools python3.10dist(extratools) python310-extratools python3dist(extratools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-RegexOrder python310-TagStats python310-sh python310-sortedcontainers python310-toolz update-alternatives"
