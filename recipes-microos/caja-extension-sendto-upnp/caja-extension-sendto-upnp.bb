...
RPROVIDES:${PN} += "caja-extension-sendto-upnp caja-extension-sendto-upnp(aarch-64) caja-sendto-upnp libnstupnp.so()(64bit) mate-file-manager-sendto-upnp"
RDEPENDS:${PN} += "caja-extension-sendto ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgssdp-1.6.so.0()(64bit) libgtk-3.so.0()(64bit) libgupnp-1.6.so.0()(64bit)"
