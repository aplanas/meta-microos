...
RPROVIDES:${PN} += "ghc-prof(unicode-transforms-0.4.0.1-EKt5KzAvdneBwqiDZWg9HO) ghc-unicode-transforms-prof ghc-unicode-transforms-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(ghc-prim-0.9.0) ghc-prof(text-2.0.2) ghc-prof(unicode-data-0.4.0.1-IPznodd4J0BGoSZPR6u4lO) ghc-unicode-transforms-devel"
