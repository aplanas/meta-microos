...
RPROVIDES:${PN} += "tex(proof-at-the-end.sty) texlive-proof-at-the-end"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(catchfile.sty) tex(etoolbox.sty) tex(hyperref.sty) tex(kvoptions.sty) tex(pgfkeys.sty) tex(thm-restate.sty) tex(thmtools.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
