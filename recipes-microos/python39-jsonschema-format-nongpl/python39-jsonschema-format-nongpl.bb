...
RDEPENDS:${PN} += "python39-fqdn python39-idna python39-isoduration python39-jsonpointer python39-jsonschema python39-rfc3339-validator python39-rfc3986-validator python39-uri_template python39-webcolors"
