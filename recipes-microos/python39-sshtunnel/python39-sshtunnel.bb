...
RPROVIDES:${PN} += "python3.9dist(sshtunnel) python39-sshtunnel python3dist(sshtunnel)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 openssh python(abi) python39-paramiko"
