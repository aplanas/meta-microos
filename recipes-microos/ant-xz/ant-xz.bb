...
RPROVIDES:${PN} += "ant-xz config(ant-xz) mvn(org.apache.ant:ant-xz) mvn(org.apache.ant:ant-xz:pom:)"
RDEPENDS:${PN} += "ant java-headless javapackages-filesystem mvn(org.apache.ant:ant) mvn(org.tukaani:xz) xz-java"
