...
RPROVIDES:${PN} += "cacti cacti-PA cacti-system config(cacti)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/env /usr/bin/perl /usr/bin/php httpd logrotate mod_php_any net-snmp php-ctype php-gd php-gmp php-json php-ldap php-mbstring php-mysql php-openssl php-posix php-snmp php-sockets php-zlib rrdtool systemd"
