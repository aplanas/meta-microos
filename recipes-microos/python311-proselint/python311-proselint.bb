...
RPROVIDES:${PN} += "python3.11dist(proselint) python311-proselint python3dist(proselint)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-click python311-dbm python311-future update-alternatives"
