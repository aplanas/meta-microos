...
RPROVIDES:${PN} += "python3.9dist(zope.testrunner) python39-zope.testrunner python3dist(zope.testrunner)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-zope.exceptions python39-zope.interface update-alternatives"
