...
RPROVIDES:${PN} += "tex(keyval.tex) tex(pst-xkey.sty) tex(pst-xkey.tex) tex(xkeyval.sty) tex(xkeyval.tex) tex(xkvltxp.sty) tex(xkvtxhdr.tex) tex(xkvutils.tex) tex(xkvview.sty) texlive-xkeyval"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(longtable.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
