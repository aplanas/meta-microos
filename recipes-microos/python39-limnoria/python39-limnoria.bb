...
RPROVIDES:${PN} += "Supybot python3.9dist(limnoria) python39-limnoria python3dist(limnoria)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 procps python(abi) python39 python39-PySocks python39-chardet python39-cryptography python39-ecdsa python39-feedparser python39-python-dateutil python39-python-gnupg python39-pytzdata update-alternatives"
