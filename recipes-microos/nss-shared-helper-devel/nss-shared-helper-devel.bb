...
RPROVIDES:${PN} += "nss-shared-helper-devel nss-shared-helper-devel(aarch-64) pkgconfig(nss-shared-helper)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnsssharedhelper0 mozilla-nss-devel pkgconfig(nss)"
