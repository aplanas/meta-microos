...
RPROVIDES:${PN} += "locale(slrn:be) locale(slrn:da) locale(slrn:de) locale(slrn:es) locale(slrn:fi) locale(slrn:fr) locale(slrn:it) locale(slrn:ko) locale(slrn:nl) locale(slrn:pl) locale(slrn:ru) locale(slrn:sv) locale(slrn:tr) slrn-lang slrn-lang-all"
RDEPENDS:${PN} += "slrn"
