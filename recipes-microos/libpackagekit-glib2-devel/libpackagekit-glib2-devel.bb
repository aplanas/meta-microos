...
RPROVIDES:${PN} += "libpackagekit-glib12-devel libpackagekit-glib2-devel libpackagekit-glib2-devel(aarch-64) pkgconfig(packagekit-glib2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libpackagekit-glib2-18 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) typelib-1_0-PackageKitGlib-1_0"
