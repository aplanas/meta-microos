...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-yast-yast2_desktop patterns-yast-yast2_desktop(aarch-64)"
RDEPENDS:${PN} += "yast2-country yast2-installation yast2-services-manager yast2-sysconfig yast2-users"
