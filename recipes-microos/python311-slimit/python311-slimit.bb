...
RPROVIDES:${PN} += "python3.11dist(slimit) python311-slimit python3dist(slimit)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-ply python311-setuptools update-alternatives"
