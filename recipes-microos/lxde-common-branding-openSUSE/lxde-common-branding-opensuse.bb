...
RPROVIDES:${PN} += "config(lxde-common-branding-openSUSE) lxde-common-branding lxde-common-branding-openSUSE"
RDEPENDS:${PN} += "/bin/sh desktop-data-openSUSE gtk2-metatheme-adwaita gtk3-metatheme-adwaita openbox-adwaita-ob-theme wallpaper-branding-openSUSE xkill"
