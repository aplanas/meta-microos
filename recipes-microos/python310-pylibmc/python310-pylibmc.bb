...
RPROVIDES:${PN} += "python3-pylibmc python3.10dist(pylibmc) python310-pylibmc python310-pylibmc(aarch-64) python3dist(pylibmc)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libmemcached.so.11()(64bit) libz.so.1()(64bit) python(abi)"
