...
RPROVIDES:${PN} += "python3.11dist(pyfxa) python311-PyFxA python3dist(pyfxa)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyBrowserID python311-cryptography python311-requests python311-six update-alternatives"
