...
RPROVIDES:${PN} += "python3.11dist(openapi-core) python311-openapi-core python3dist(openapi-core)"
RDEPENDS:${PN} += "python(abi) python311-Werkzeug python311-isodate python311-jsonschema-spec python311-more-itertools python311-openapi-schema-validator python311-openapi-spec-validator python311-parse python311-pathable python311-typing-extensions"
