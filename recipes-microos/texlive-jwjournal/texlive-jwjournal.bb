...
RPROVIDES:${PN} += "tex(jwjournal.cls) texlive-jwjournal"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ProjLib.sty) tex(enumitem.sty) tex(needspace.sty) tex(tcolorbox.sty) texlive texlive-einfart texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
