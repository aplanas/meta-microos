...
locale(xfce4-cpufreq-plugin:en_AU) \
locale(xfce4-cpufreq-plugin:en_GB) \
...
locale(xfce4-cpufreq-plugin:pt_BR) \
...
locale(xfce4-cpufreq-plugin:zh_CN) \
locale(xfce4-cpufreq-plugin:zh_TW) \
