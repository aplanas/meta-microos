...
RPROVIDES:${PN} += "python3.9dist(premailer) python39-premailer python3dist(premailer)"
RDEPENDS:${PN} += "python(abi) python39-cachetools python39-cssselect python39-cssutils python39-lxml python39-requests"
