...
RPROVIDES:${PN} += "python3-libfwnt python310-libfwnt python310-libfwnt(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcerror.so.1()(64bit) libcerror.so.1(V_20220101)(64bit) libfwnt.so.1()(64bit) libfwnt.so.1(V_20220922)(64bit) python(abi)"
