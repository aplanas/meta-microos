...
RPROVIDES:${PN} += "python3.9dist(dfvfs) python39-dfVFS python3dist(dfvfs)"
RDEPENDS:${PN} += "python(abi) python39-PyYAML python39-construct python39-cryptography python39-dfdatetime python39-dtfabric python39-libbde python39-libcaes python39-libewf python39-libfsapfs python39-libfsext python39-libfsfat python39-libfshfs python39-libfsntfs python39-libfsxfs python39-libfvde python39-libfwnt python39-libluksde python39-libmodi python39-libphdi python39-libqcow python39-libsigscan python39-libsmdev python39-libsmraw python39-libvhdi python39-libvmdk python39-libvsgpt python39-libvshadow python39-libvslvm python39-tsk"
