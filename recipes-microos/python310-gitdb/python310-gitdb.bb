...
RPROVIDES:${PN} += "python3-gitdb python3-gitdb2 python3.10dist(gitdb) python310-gitdb python310-gitdb(aarch-64) python310-gitdb2 python3dist(gitdb)"
RDEPENDS:${PN} += "python(abi) python310-smmap"
