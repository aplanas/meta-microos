...
RPROVIDES:${PN} += "cmake(libjpeg-turbo) libjpeg-devel libjpeg8-devel libjpeg8-devel(aarch-64) pkgconfig(libjpeg) pkgconfig(libturbojpeg)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libjpeg8 libturbojpeg0"
