...
RPROVIDES:${PN} += "python3-curlylint python3.10dist(curlylint) python310-curlylint python3dist(curlylint)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-attrs python310-click python310-parsy python310-pathspec python310-toml"
