...
RPROVIDES:${PN} += "python3.9dist(django-qsessions) python39-django-qsessions python3dist(django-qsessions)"
RDEPENDS:${PN} += "python(abi) python39-Django python39-django-ipware python39-user-agents"
