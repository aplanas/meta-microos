...
RPROVIDES:${PN} += "python3.11dist(jsbeautifier) python311-jsbeautifier python3dist(jsbeautifier)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-EditorConfig python311-setuptools python311-six update-alternatives"
