...
RPROVIDES:${PN} += "python3.9dist(vim-vint) python39-vim-vint python3dist(vim-vint)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-ansicolor python39-chardet update-alternatives"
