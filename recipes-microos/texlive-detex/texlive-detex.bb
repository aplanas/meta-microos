...
RPROVIDES:${PN} += "man(detex.1) texlive-detex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-detex-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
