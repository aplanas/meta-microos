...
RPROVIDES:${PN} += "python3-lalburst python310-lalburst python310-lalburst(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgsl.so.25()(64bit) liblal.so.20()(64bit) liblalburst.so.6()(64bit) liblalsupport.so.14()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.29)(64bit) python(abi) python310-glue python310-lal python310-lalmetaio python310-lalsimulation python310-ligo-lw python310-numpy python310-scipy"
