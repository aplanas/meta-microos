...
RPROVIDES:${PN} += "python3-junos-eznc python3.10dist(junos-eznc) python310-junos-eznc python3dist(junos-eznc)"
RDEPENDS:${PN} += "python(abi) python310-Jinja2 python310-PyYAML python310-lxml python310-ncclient python310-netaddr python310-ntc-templates python310-paramiko python310-pyparsing python310-pyserial python310-scp python310-six python310-transitions"
