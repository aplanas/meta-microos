...
RPROVIDES:${PN} += "oqs-provider oqs-provider(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) liboqs.so.0()(64bit)"
