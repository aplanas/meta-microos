...
RPROVIDES:${PN} += "config(sendfax) fax_daemon sendfax sendfax(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl g3utils group(uucp) ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) mgetty permissions shadow"
