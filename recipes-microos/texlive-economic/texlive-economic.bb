...
RPROVIDES:${PN} += "tex(aer.sty) tex(aertt.sty) tex(agecon.cls) tex(ajae.cls) tex(apecon.cls) tex(cje.sty) tex(ecca.cls) tex(erae.cls) tex(itaxpf.cls) tex(jrurstud.cls) tex(njf.cls) tex(oegatb.cls) tex(pocoec.cls) tex(regstud.cls) tex(worlddev.cls) texlive-economic"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(babel.sty) tex(bm.sty) tex(caption.sty) tex(courier.sty) tex(endfloat.sty) tex(endnotes.sty) tex(fancyhdr.sty) tex(geometry.sty) tex(helvet.sty) tex(ifthen.sty) tex(lmodern.sty) tex(mathptmx.sty) tex(natbib.sty) tex(scrartcl.cls) tex(setspace.sty) tex(soul.sty) tex(stringstrings.sty) tex(textcomp.sty) tex(titlesec.sty) tex(ulem.sty) tex(url.sty) tex(verbatim.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
