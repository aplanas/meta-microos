...
RPROVIDES:${PN} += "libGLC-devel libGLC-devel(aarch-64) pkgconfig(quesoglc)"
RDEPENDS:${PN} += "/usr/bin/pkg-config Mesa-devel libGLC0 pkgconfig(expat) pkgconfig(fontconfig) pkgconfig(freetype2) pkgconfig(fribidi) pkgconfig(zlib)"
