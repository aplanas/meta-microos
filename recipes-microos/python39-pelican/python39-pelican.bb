...
RPROVIDES:${PN} += "python3.9dist(pelican) python39-pelican python3dist(pelican)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Jinja2 python39-Pygments python39-Unidecode python39-blinker python39-docutils python39-feedgenerator python39-python-dateutil python39-pytz python39-rich update-alternatives"
