...
RPROVIDES:${PN} += "itextpdf mvn(com.itextpdf.tool:xmlworker) mvn(com.itextpdf.tool:xmlworker:pom:) mvn(com.itextpdf:itext-pdfa) mvn(com.itextpdf:itext-pdfa:pom:) mvn(com.itextpdf:itext-xtra) mvn(com.itextpdf:itext-xtra:pom:) mvn(com.itextpdf:itextpdf) mvn(com.itextpdf:itextpdf:pom:) mvn(com.itextpdf:root:pom:) osgi(com.itextpdf) osgi(com.itextpdf.tool.xmlworker)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(commons-io:commons-io) mvn(org.apache.commons:commons-imaging)"
