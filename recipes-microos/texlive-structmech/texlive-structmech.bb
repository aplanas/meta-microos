...
RPROVIDES:${PN} += "tex(structmech.sty) texlive-structmech"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifthen.sty) tex(kvoptions.sty) tex(tikz.sty) tex(xkeyval.sty) tex(xparse.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
