...
RPROVIDES:${PN} += "config(dhcp-client) dhcp-client dhcp-client(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /usr/bin/getent /usr/bin/hostname dhcp iproute2 iputils ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.36)(64bit)"
