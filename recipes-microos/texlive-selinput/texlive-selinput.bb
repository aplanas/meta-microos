...
RPROVIDES:${PN} += "tex(selinput.sty) texlive-selinput"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(inputenc.sty) tex(kvoptions.sty) tex(kvsetkeys.sty) tex(stringenc.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
