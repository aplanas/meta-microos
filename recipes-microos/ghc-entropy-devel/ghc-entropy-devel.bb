...
RPROVIDES:${PN} += "ghc-devel(entropy-0.4.1.10-HkaMHQZP8nyRj15panvtP) ghc-entropy-devel ghc-entropy-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(unix-2.7.3) ghc-entropy"
