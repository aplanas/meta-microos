...
RPROVIDES:${PN} += "pkgconfig(xmlsec1-gcrypt) xmlsec1-gcrypt-devel xmlsec1-gcrypt-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxmlsec1-gcrypt1 pkgconfig(libxml-2.0) pkgconfig(libxslt) xmlsec1-devel"
