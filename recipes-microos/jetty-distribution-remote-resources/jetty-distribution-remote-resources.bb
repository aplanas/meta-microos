...
RPROVIDES:${PN} += "jetty-distribution-remote-resources mvn(org.eclipse.jetty.toolchain:jetty-distribution-remote-resources) mvn(org.eclipse.jetty.toolchain:jetty-distribution-remote-resources:pom:)"
