...
RPROVIDES:${PN} += "tex(grmhyph5.tex) tex(grphyph5.tex) tex(hyph-el-monoton.tex) tex(hyph-el-polyton.tex) tex(loadhyph-el-monoton.tex) tex(loadhyph-el-polyton.tex) texlive-hyphen-greek"
