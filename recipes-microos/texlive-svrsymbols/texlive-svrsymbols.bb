...
RPROVIDES:${PN} += "tex(SVRsymbols.tfm) tex(svrsymbols.map) tex(svrsymbols.sty) texlive-svrsymbols"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-svrsymbols-fonts"
