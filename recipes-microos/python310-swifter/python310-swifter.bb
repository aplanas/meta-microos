...
RPROVIDES:${PN} += "python3-swifter python3.10dist(swifter) python310-swifter python3dist(swifter)"
RDEPENDS:${PN} += "python(abi) python310-bleach python310-cloudpickle python310-dask-dataframe python310-ipywidgets python310-pandas python310-parso python310-psutil python310-tqdm"
