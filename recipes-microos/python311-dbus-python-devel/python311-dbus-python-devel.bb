...
RPROVIDES:${PN} += "dbus-1-python311-devel pkgconfig(dbus-python-3.11) python311-dbus-python-devel python311-dbus-python-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config dbus-1 dbus-1-devel pkgconfig(dbus-1) python311-dbus-python python311-dbus-python-common-devel python311-devel"
