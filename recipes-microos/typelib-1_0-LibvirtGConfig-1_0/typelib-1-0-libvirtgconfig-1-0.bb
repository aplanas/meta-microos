...
RPROVIDES:${PN} += "typelib(LibvirtGConfig) typelib-1_0-LibvirtGConfig-1_0 typelib-1_0-LibvirtGConfig-1_0(aarch-64)"
RDEPENDS:${PN} += "libvirt-gconfig-1.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(libxml2)"
