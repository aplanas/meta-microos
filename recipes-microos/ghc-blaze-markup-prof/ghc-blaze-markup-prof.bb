...
RPROVIDES:${PN} += "ghc-blaze-markup-prof ghc-blaze-markup-prof(aarch-64) ghc-prof(blaze-markup-0.8.2.8-1rqnOPcdOmIw0iYwB3Kqc)"
RDEPENDS:${PN} += "ghc-blaze-markup-devel ghc-prof(base-4.17.1.0) ghc-prof(blaze-builder-0.4.2.2-1GcRIc7N7YHId5Q5gRvlvW) ghc-prof(bytestring-0.11.4.0) ghc-prof(text-2.0.2)"
