...
RPROVIDES:${PN} += "ruby3.2-rubygem-gli ruby3.2-rubygem-gli(aarch-64) rubygem(gli) rubygem(ruby:3.2.0:gli) rubygem(ruby:3.2.0:gli:2) rubygem(ruby:3.2.0:gli:2.21) rubygem(ruby:3.2.0:gli:2.21.0)"
