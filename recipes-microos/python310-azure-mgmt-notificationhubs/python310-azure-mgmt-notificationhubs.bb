...
RPROVIDES:${PN} += "python3-azure-mgmt-notificationhubs python3.10dist(azure-mgmt-notificationhubs) python310-azure-mgmt-notificationhubs python3dist(azure-mgmt-notificationhubs)"
