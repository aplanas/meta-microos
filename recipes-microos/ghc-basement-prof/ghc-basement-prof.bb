...
RPROVIDES:${PN} += "ghc-basement-prof ghc-basement-prof(aarch-64) ghc-prof(basement-0.0.15-6OmKTVi2kFpCWMoKDlsO4S)"
RDEPENDS:${PN} += "ghc-basement-devel ghc-prof(base-4.17.1.0) ghc-prof(ghc-prim-0.9.0)"
