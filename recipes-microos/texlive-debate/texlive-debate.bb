...
RPROVIDES:${PN} += "tex(debate.sty) texlive-debate"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(tcolorbox.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-listings texlive-listingsutf8 texlive-pdfcol texlive-scripts texlive-scripts-bin texlive-tcolorbox texlive-xcolor texlive-xkeyval"
