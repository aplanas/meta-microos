...
RPROVIDES:${PN} += "tex(uowthesistitlepage.sty) texlive-uowthesistitlepage"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(geometry.sty) tex(graphicx.sty) tex(ragged2e.sty) tex(setspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
