...
RPROVIDES:${PN} += "python3.11dist(pyramid) python311-pyramid python3dist(pyramid)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PasteDeploy python311-WebOb python311-hupper python311-plaster python311-plaster-pastedeploy python311-setuptools python311-translationstring python311-venusian python311-zope.deprecation python311-zope.interface update-alternatives"
