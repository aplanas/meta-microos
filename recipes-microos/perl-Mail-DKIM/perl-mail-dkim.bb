...
RPROVIDES:${PN} += "perl(Mail::DKIM) perl(Mail::DKIM::ARC::MessageSignature) perl(Mail::DKIM::ARC::Seal) perl(Mail::DKIM::ARC::Signer) perl(Mail::DKIM::ARC::Verifier) perl(Mail::DKIM::Algorithm::Base) perl(Mail::DKIM::Algorithm::dk_rsa_sha1) perl(Mail::DKIM::Algorithm::rsa_sha1) perl(Mail::DKIM::Algorithm::rsa_sha256) perl(Mail::DKIM::AuthorDomainPolicy) perl(Mail::DKIM::Canonicalization::Base) perl(Mail::DKIM::Canonicalization::DkCommon) perl(Mail::DKIM::Canonicalization::DkimCommon) perl(Mail::DKIM::Canonicalization::dk_nofws) perl(Mail::DKIM::Canonicalization::dk_simple) perl(Mail::DKIM::Canonicalization::nowsp) perl(Mail::DKIM::Canonicalization::relaxed) perl(Mail::DKIM::Canonicalization::seal) perl(Mail::DKIM::Canonicalization::simple) perl(Mail::DKIM::Common) perl(Mail::DKIM::DNS) perl(Mail::DKIM::DkPolicy) perl(Mail::DKIM::DkSignature) perl(Mail::DKIM::DkimPolicy) perl(Mail::DKIM::Key) perl(Mail::DKIM::KeyValueList) perl(Mail::DKIM::MessageParser) perl(Mail::DKIM::Policy) perl(Mail::DKIM::PrivateKey) perl(Mail::DKIM::PublicKey) perl(Mail::DKIM::Signature) perl(Mail::DKIM::Signer) perl(Mail::DKIM::SignerPolicy) perl(Mail::DKIM::TextWrap) perl(Mail::DKIM::Verifier) perl-Mail-DKIM"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Crypt::OpenSSL::RSA) perl(Digest::SHA) perl(Mail::Address) perl(Mail::AuthenticationResults::Header::AuthServID) perl(Mail::AuthenticationResults::Parser) perl(Net::DNS)"
