...
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/mkdir /usr/bin/touch fillup yast2 yast2-configuration-management yast2-country yast2-installation yast2-network yast2-ruby-bindings"
