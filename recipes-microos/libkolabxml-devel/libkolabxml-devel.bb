...
RPROVIDES:${PN} += "cmake(Libkolabxml) libkolabxml-devel libkolabxml-devel(aarch-64)"
RDEPENDS:${PN} += "libboost_chrono-devel libboost_date_time-devel libboost_system-devel libboost_thread-devel libcurl-devel libkolabxml1 libxerces-c-devel"
