...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-language-spellcheck) python311-azure-cognitiveservices-language-spellcheck python3dist(azure-cognitiveservices-language-spellcheck)"
RDEPENDS:${PN} += "python(abi) python311-azure-cognitiveservices-language-nspkg python311-azure-cognitiveservices-nspkg python311-azure-common python311-azure-nspkg python311-msrest"
