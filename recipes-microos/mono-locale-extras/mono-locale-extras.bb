...
RPROVIDES:${PN} += "mono(I18N.CJK) mono(I18N.MidEast) mono(I18N.Other) mono(I18N.Rare) mono-locale-extras mono-locale-extras(aarch-64)"
RDEPENDS:${PN} += "mono(I18N) mono(mscorlib) mono-core"
