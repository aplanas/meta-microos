...
RPROVIDES:${PN} += "pqiv-poppler pqiv-poppler(aarch-64)"
RDEPENDS:${PN} += "libcairo.so.2()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libpoppler-glib.so.8()(64bit) pqiv"
