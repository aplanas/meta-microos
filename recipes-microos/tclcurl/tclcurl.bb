...
RPROVIDES:${PN} += "libTclCurl7.22.0.so()(64bit) tclcurl tclcurl(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcurl.so.4()(64bit) tcl"
