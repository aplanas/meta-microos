...
RPROVIDES:${PN} += "libmirage-devel libmirage-devel(aarch-64) pkgconfig(libmirage)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glib2-devel libmirage11 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gmodule-2.0) pkgconfig(gobject-2.0)"
