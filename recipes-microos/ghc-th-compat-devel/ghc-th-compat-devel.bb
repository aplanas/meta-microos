...
RPROVIDES:${PN} += "ghc-devel(th-compat-0.1.4-Bzk38miPOyTJh1KMkOoOkv) ghc-th-compat-devel ghc-th-compat-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(template-haskell-2.19.0.0) ghc-th-compat"
