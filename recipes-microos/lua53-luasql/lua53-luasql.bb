...
RPROVIDES:${PN} += "lua53-luasql lua53-luasql(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libiodbc.so.2()(64bit) libmariadb.so.3()(64bit) libmariadb.so.3(libmysqlclient_18)(64bit) libmariadb3 libpq.so.5()(64bit) libsqlite3.so.0()(64bit) lua53"
