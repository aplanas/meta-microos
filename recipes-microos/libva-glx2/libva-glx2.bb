...
RPROVIDES:${PN} += "libva-glx.so.2()(64bit) libva-glx2 libva-glx2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libGL.so.1()(64bit) libX11.so.6()(64bit) libc.so.6(GLIBC_2.34)(64bit) libva-x11.so.2()(64bit) libva.so.2()(64bit)"
