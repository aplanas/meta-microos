...
RPROVIDES:${PN} += "libxkbui-devel libxkbui-devel(aarch-64) pkgconfig(xkbui)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxkbui1 pkgconfig(kbproto) pkgconfig(x11) pkgconfig(xt)"
