...
RPROVIDES:${PN} += "python3.9dist(fontparts) python39-fontParts python3dist(fontparts)"
RDEPENDS:${PN} += "python(abi) python39-FontTools python39-booleanOperations python39-defcon python39-fontMath python39-fs python39-lxml"
