...
RPROVIDES:${PN} += "gnuhealth-thalamus python3.10dist(thalamus) python3dist(thalamus)"
RDEPENDS:${PN} += "/bin/bash postgresql-server python(abi) python3-Flask python3-Flask-HTTPAuth python3-Flask-RESTful python3-Flask-WTF python3-bcrypt python3-psycopg2"
