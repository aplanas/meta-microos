...
RPROVIDES:${PN} += "python3.11dist(mysqlclient) python311-MySQL-python python311-mysql python311-mysqlclient python311-mysqlclient(aarch-64) python3dist(mysqlclient)"
