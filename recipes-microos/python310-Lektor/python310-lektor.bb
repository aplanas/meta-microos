...
RPROVIDES:${PN} += "python3-Lektor python3.10dist(lektor) python310-Lektor python3dist(lektor)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Babel python310-ExifRead python310-Flask python310-Jinja2 python310-click python310-filetype python310-inifile python310-mistune python310-python-slugify python310-requests python310-setuptools python310-watchdog update-alternatives"
