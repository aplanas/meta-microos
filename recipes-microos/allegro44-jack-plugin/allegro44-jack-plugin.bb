...
RPROVIDES:${PN} += "allegro44-jack-plugin allegro44-jack-plugin(aarch-64)"
RDEPENDS:${PN} += "allegro44 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) liballeg.so.4.4()(64bit) libc.so.6(GLIBC_2.17)(64bit) libjack.so.0()(64bit)"
