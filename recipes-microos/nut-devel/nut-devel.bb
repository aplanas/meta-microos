...
RPROVIDES:${PN} += "nut-devel nut-devel(aarch-64) pkgconfig(libnutclient) pkgconfig(libnutclientstub) pkgconfig(libnutscan) pkgconfig(libupsclient)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnutclient2 libnutclientstub1 libnutscan2 libupsclient6 pkgconfig(openssl)"
