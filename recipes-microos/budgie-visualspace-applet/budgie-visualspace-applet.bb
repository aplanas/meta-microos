...
RPROVIDES:${PN} += "budgie-visualspace-applet budgie-visualspace-applet(aarch-64) libvisualspace.so()(64bit)"
RDEPENDS:${PN} += "budgie-extras-lang ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbudgie-plugin.so.0()(64bit) libc.so.6(GLIBC_2.34)(64bit) libgdk-3.so.0()(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libpeas-1.0.so.0()(64bit) libwnck-3.so.0()(64bit)"
