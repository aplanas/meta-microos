...
RPROVIDES:${PN} += "python3.9dist(radexreader) python39-radexreader python3dist(radexreader)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-pyserial python39-pyusb update-alternatives"
