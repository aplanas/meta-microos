...
RPROVIDES:${PN} += "application() application(vorta.desktop) metainfo() metainfo(com.borgbase.Vorta.appdata.xml) python3.10dist(vorta) python3dist(vorta) vorta"
RDEPENDS:${PN} += "/usr/bin/python3 borgbackup python(abi) python3-APScheduler python3-QDarkStyle python3-keyring python3-peewee python3-platformdirs python3-psutil python3-python-dateutil python3-qt5"
