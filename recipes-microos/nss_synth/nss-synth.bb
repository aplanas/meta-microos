...
RPROVIDES:${PN} += "bundled(rust-crate:lazy_static) bundled(rust-crate:libc) bundled(rust-crate:libnss) bundled(rust-crate:nss_synth) bundled(rust-crate:paste) bundled(rust-crate:paste-impl) bundled(rust-crate:proc-macro-hack) libnss_synth.so.2()(64bit) nss_synth nss_synth(aarch-64)"
