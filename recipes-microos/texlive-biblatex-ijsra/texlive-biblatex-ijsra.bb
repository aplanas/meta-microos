...
RPROVIDES:${PN} += "tex(ijsra.bbx) tex(ijsra.cbx) texlive-biblatex-ijsra"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(authoryear.bbx) tex(authoryear.cbx) tex(xpatch.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
