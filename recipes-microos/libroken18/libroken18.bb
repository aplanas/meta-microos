...
RPROVIDES:${PN} += "libroken.so.18()(64bit) libroken.so.18(HEIMDAL_ROKEN_1.0)(64bit) libroken18 libroken18(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.36)(64bit) libcrypt.so.1()(64bit) libcrypt.so.1(XCRYPT_2.0)(64bit)"
