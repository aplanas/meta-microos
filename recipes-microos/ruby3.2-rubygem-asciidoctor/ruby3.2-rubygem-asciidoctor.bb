...
RPROVIDES:${PN} += "ruby3.2-rubygem-asciidoctor ruby3.2-rubygem-asciidoctor(aarch-64) rubygem(asciidoctor) rubygem(ruby:3.2.0:asciidoctor) rubygem(ruby:3.2.0:asciidoctor:2) rubygem(ruby:3.2.0:asciidoctor:2.0) rubygem(ruby:3.2.0:asciidoctor:2.0.18)"
