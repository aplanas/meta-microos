...
RPROVIDES:${PN} += "typelib(EvinceDocument) typelib-1_0-EvinceDocument-3_0 typelib-1_0-EvinceDocument-3_0(aarch-64)"
RDEPENDS:${PN} += "libevdocument3.so.4()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
