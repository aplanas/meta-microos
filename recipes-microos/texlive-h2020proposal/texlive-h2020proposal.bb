...
RPROVIDES:${PN} += "tex(h2020proposal.cls) texlive-h2020proposal"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(colortbl.sty) tex(coolstr.sty) tex(longtable.sty) tex(memoir.cls) tex(morewrites.sty) tex(rotating.sty) tex(showkeys.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
