...
RPROVIDES:${PN} += "tex(beamercolorthemeCuerna.sty) tex(beamercolorthemebluesimplex.sty) tex(beamercolorthemebrick.sty) tex(beamercolorthemelettuce.sty) tex(beamerinnerthemeCuerna.sty) tex(beamerouterthemeCuerna.sty) tex(beamerthemeCuerna.sty) texlive-beamertheme-cuerna"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(graphicx.sty) tex(lmodern.sty) tex(textpos.sty) tex(tikz.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
