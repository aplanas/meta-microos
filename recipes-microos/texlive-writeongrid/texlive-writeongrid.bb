...
RPROVIDES:${PN} += "tex(WriteOnGrid.sty) texlive-writeongrid"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(simplekv.sty) tex(tikz.sty) tex(xcolor.sty) tex(xparse.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
