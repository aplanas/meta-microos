...
RPROVIDES:${PN} += "aqbanking-devel aqbanking-devel(aarch-64) cmake(aqbanking) pkgconfig(aqbanking)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config aqbanking cmake glibc-devel gwenhywfar-devel ktoblzcheck-devel libltdl-devel libofx-devel xmlsec1-gnutls-devel"
