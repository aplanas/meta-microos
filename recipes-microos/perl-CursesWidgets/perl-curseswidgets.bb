...
RPROVIDES:${PN} += "perl(Curses::Widgets) perl(Curses::Widgets::ButtonSet) perl(Curses::Widgets::Calendar) perl(Curses::Widgets::ComboBox) perl(Curses::Widgets::Label) perl(Curses::Widgets::ListBox) perl(Curses::Widgets::ListBox::MultiColumn) perl(Curses::Widgets::Menu) perl(Curses::Widgets::ProgressBar) perl(Curses::Widgets::TextField) perl(Curses::Widgets::TextMemo) perl-CursesWidgets"
