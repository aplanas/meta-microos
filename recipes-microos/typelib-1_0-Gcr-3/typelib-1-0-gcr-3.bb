...
RPROVIDES:${PN} += "typelib(Gcr) typelib-1_0-Gcr-3 typelib-1_0-Gcr-3(aarch-64)"
RDEPENDS:${PN} += "libgcr-base-3.so.1()(64bit) typelib(GLib) typelib(GObject) typelib(Gck) typelib(Gio) typelib-1_0-Gck-1"
