...
RPROVIDES:${PN} += "ghc-case-insensitive-devel ghc-case-insensitive-devel(aarch-64) ghc-devel(case-insensitive-1.2.1.0-AumZoR4Lds63HJj8OQwHY3)"
RDEPENDS:${PN} += "/bin/sh ghc-case-insensitive ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-devel(text-2.0.2)"
