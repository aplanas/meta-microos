...
RPROVIDES:${PN} += "ghc-alsa-mixer-devel ghc-alsa-mixer-devel(aarch-64) ghc-devel(alsa-mixer-0.3.0-Ff4FVP5Sg8l3sx20Z8BrVj)"
RDEPENDS:${PN} += "/bin/sh alsa-devel ghc-alsa-mixer ghc-compiler ghc-devel(alsa-core-0.5.0.1-JiFJwdvZ0Gx6AeuqXKf7yg) ghc-devel(base-4.17.1.0) ghc-devel(unix-2.7.3)"
