...
RPROVIDES:${PN} += "python3-azure-mgmt-managementgroups python3.10dist(azure-mgmt-managementgroups) python310-azure-mgmt-managementgroups python3dist(azure-mgmt-managementgroups)"
