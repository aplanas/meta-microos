...
RPROVIDES:${PN} += "ghc-deriving-aeson-devel ghc-deriving-aeson-devel(aarch-64) ghc-devel(deriving-aeson-0.2.9-HkCtwpD3IaS9WeJeVKU34M)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-deriving-aeson ghc-devel(aeson-2.1.2.1-D6AdQzPi657L86q5kYUhvP) ghc-devel(base-4.17.1.0)"
