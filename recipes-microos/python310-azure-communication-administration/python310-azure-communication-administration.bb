...
RPROVIDES:${PN} += "python3-azure-communication-administration python3.10dist(azure-communication-administration) python310-azure-communication-administration python3dist(azure-communication-administration)"
