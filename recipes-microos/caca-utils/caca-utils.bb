...
RPROVIDES:${PN} += "caca-utils caca-utils(aarch-64)"
RDEPENDS:${PN} += "imlib2-loaders ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libImlib2.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) libcaca.so.0()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) toilet"
