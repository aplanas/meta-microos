...
RPM_NAME = "python310-healpy-1.16.1-1.5.aarch64.rpm"
RPM_HASH = "542e6e5e576c4dd30b39ffd47f019e3e99bdfc304685642bcef6eb78fbffe4fe99546b425fdf5d1e4ac0ba934360b1800e7a7245fff8c92331e9666c261dc318"

RPROVIDES:${PN} += "python3-healpy python3.10dist(healpy) python310-healpy python310-healpy(aarch-64) python3dist(healpy)"
RDEPENDS:${PN} += "/bin/bash /bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgcc_s.so.1()(64bit) libgcc_s.so.1(GCC_3.0)(64bit) libgcc_s.so.1(GCC_3.3.1)(64bit) libgcc_s.so.1(GCC_4.0.0)(64bit) libhealpix_cxx.so.3()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) libstdc++.so.6()(64bit) libstdc++.so.6(CXXABI_1.3)(64bit) libstdc++.so.6(CXXABI_1.3.8)(64bit) libstdc++.so.6(GLIBCXX_3.4)(64bit) libstdc++.so.6(GLIBCXX_3.4.11)(64bit) libstdc++.so.6(GLIBCXX_3.4.21)(64bit) python(abi) python310-astropy python310-matplotlib python310-numpy python310-scipy update-alternatives"
