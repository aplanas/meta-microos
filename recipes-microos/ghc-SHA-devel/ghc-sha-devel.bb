...
RPROVIDES:${PN} += "ghc-SHA-devel ghc-SHA-devel(aarch-64) ghc-devel(SHA-1.6.4.4-CTRZ9m1gmyY35Z2xnCckJW)"
RDEPENDS:${PN} += "/bin/sh ghc-SHA ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(binary-0.8.9.1) ghc-devel(bytestring-0.11.4.0)"
