...
RPROVIDES:${PN} += "python3.11dist(python-kasa) python311-kasa python3dist(python-kasa)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-anyio python311-asyncclick python311-pydantic python311-setuptools python311-voluptuous python311-xdoctest update-alternatives"
