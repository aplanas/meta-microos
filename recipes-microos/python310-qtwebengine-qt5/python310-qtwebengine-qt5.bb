...
RPROVIDES:${PN} += "python3-PyQtWebEngine python3-qtwebengine-qt5 python3.10dist(pyqtwebengine) python310-PyQtWebEngine python310-qtwebengine-qt5 python310-qtwebengine-qt5(aarch-64) python3dist(pyqtwebengine)"
