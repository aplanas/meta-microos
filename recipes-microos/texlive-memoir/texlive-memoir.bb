...
RPROVIDES:${PN} += "tex(mem10.clo) tex(mem11.clo) tex(mem12.clo) tex(mem14.clo) tex(mem17.clo) tex(mem20.clo) tex(mem25.clo) tex(mem30.clo) tex(mem36.clo) tex(mem48.clo) tex(mem60.clo) tex(mem9.clo) tex(memhfixc.sty) tex(memoir.cls) texlive-memoir"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(dcolumn.sty) tex(delarray.sty) tex(etex.sty) tex(etoolbox.sty) tex(fontenc.sty) tex(hyperref.sty) tex(iftex.sty) tex(mparhack.sty) tex(tabularx.sty) tex(textcase.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
