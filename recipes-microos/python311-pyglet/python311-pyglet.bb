...
RPROVIDES:${PN} += "python3.11dist(pyglet) python311-pyglet python3dist(pyglet)"
RDEPENDS:${PN} += "Mesa-dri libxcb-glx0 python(abi) python311-Pillow python311-future python311-pypng"
