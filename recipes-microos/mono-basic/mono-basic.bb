...
RPROVIDES:${PN} += "mono(Microsoft.VisualBasic) mono(Mono.Cecil.VB) mono(Mono.Cecil.VB.Mdb) mono(Mono.Cecil.VB.Pdb) mono(vbnc) mono-basic"
RDEPENDS:${PN} += "/bin/sh mono(System) mono(System.Core) mono(System.Drawing) mono(System.Windows.Forms) mono(mscorlib)"
