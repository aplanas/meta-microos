...
RPROVIDES:${PN} += "ghc-asn1-encoding-prof ghc-asn1-encoding-prof(aarch-64) ghc-prof(asn1-encoding-0.9.6-Hputs8NTOGr9EmEd7QDXHk)"
RDEPENDS:${PN} += "ghc-asn1-encoding-devel ghc-prof(asn1-types-0.3.4-GYlFjiH4jmgJII5TgUQfXm) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(hourglass-0.2.12-3PFbUFQLMNb8Ad2s9SU5p3)"
