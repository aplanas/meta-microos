...
RPROVIDES:${PN} += "tex(unimath-bb.map) tex(unimath-bbit.map) tex(unimath-bf.map) tex(unimath-bfit.map) tex(unimath-frak.map) tex(unimath-frakbf.map) tex(unimath-it.map) tex(unimath-plain-xetex.tex) tex(unimath-scr.map) tex(unimath-scrbf.map) tex(unimath-sf.map) tex(unimath-sfbf.map) tex(unimath-sfbfit.map) tex(unimath-sfit.map) tex(unimath-tt.map) texlive-unimath-plain-xetex"
