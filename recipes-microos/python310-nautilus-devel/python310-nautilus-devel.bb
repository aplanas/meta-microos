...
RPROVIDES:${PN} += "python3-nautilus-devel python310-nautilus-devel python310-nautilus-devel(aarch-64)"
RDEPENDS:${PN} += "python310-devel python310-nautilus python310-nautilus-common-devel"
