...
RPROVIDES:${PN} += "libqwt5-devel pkgconfig(qwt5-qt5) qwt qwt-devel qwt-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config freetype2-devel gcc-c++ libpng-devel libqwt5-qt5-5 pkgconfig(Qt5Gui) pkgconfig(Qt5PrintSupport) pkgconfig(Qt5Svg) pkgconfig(Qt5Widgets)"
