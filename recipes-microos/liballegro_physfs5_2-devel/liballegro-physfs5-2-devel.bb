...
RPROVIDES:${PN} += "liballegro_physfs5_2-devel liballegro_physfs5_2-devel(aarch-64) pkgconfig(allegro_physfs-5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liballegro_physfs5_2 pkgconfig(allegro-5)"
