...
RPROVIDES:${PN} += "mvn(xerces:dom3-xml-apis) mvn(xerces:dom3-xml-apis:pom:) mvn(xml-apis:xml-apis) mvn(xml-apis:xml-apis-ext) mvn(xml-apis:xml-apis-ext:pom:) mvn(xml-apis:xml-apis:pom:) osgi(javax.xml) osgi(org.w3c.dom.svg) xerces-j2-xml-apis xml-apis xml-commons-apis xml-commons-jaxp-1.1-apis xml-commons-jaxp-1.2-apis xml-commons-jaxp-1.3-apis xml-commons-jaxp-1.4-apis"
