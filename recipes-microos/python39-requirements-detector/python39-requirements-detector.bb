...
RPROVIDES:${PN} += "python3.9dist(requirements-detector) python39-requirements-detector python3dist(requirements-detector)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-astroid update-alternatives"
