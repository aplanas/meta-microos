...
RPROVIDES:${PN} += "tex(hologo.sty) texlive-hologo"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(iftex.sty) tex(infwarerr.sty) tex(kvdefinekeys.sty) tex(kvoptions.sty) tex(kvsetkeys.sty) tex(ltxcmds.sty) tex(pdftexcmds.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
