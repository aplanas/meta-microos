...
RPROVIDES:${PN} += "python3.11dist(pass-git-helper) python311-pass-git-helper python3dist(pass-git-helper)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-pyxdg update-alternatives"
