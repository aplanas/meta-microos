...
RPROVIDES:${PN} += "ghc-parallel-prof ghc-parallel-prof(aarch-64) ghc-prof(parallel-3.2.2.0-36KAHtmQlbB59K6tPbQ0Jr)"
RDEPENDS:${PN} += "ghc-parallel-devel ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(deepseq-1.4.8.0) ghc-prof(ghc-prim-0.9.0)"
