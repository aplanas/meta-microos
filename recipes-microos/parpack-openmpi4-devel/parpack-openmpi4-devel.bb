...
RPROVIDES:${PN} += "parpack-openmpi4-devel parpack-openmpi4-devel(aarch-64)"
RDEPENDS:${PN} += "blas-devel gcc-fortran lapack-devel libparpack2-openmpi4 openmpi4-devel"
