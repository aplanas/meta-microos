...
RPROVIDES:${PN} += "scsi:/sbin/sdparm sdparm sdparm(aarch-64)"
RDEPENDS:${PN} += "/bin/bash ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libsgutils2-1.48.so.2()(64bit)"
