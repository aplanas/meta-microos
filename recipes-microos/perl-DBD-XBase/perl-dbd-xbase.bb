...
RPROVIDES:${PN} += "perl(DBD::XBase) perl(DBD::XBase::db) perl(DBD::XBase::dr) perl(DBD::XBase::st) perl(XBase) perl(XBase::Base) perl(XBase::Cursor) perl(XBase::Index) perl(XBase::IndexCursor) perl(XBase::Memo) perl(XBase::Memo::Apollo) perl(XBase::Memo::Fox) perl(XBase::Memo::dBaseIII) perl(XBase::Memo::dBaseIV) perl(XBase::SDBM) perl(XBase::SQL) perl(XBase::SQL::Expr) perl(XBase::cdx) perl(XBase::cdx::Page) perl(XBase::idx) perl(XBase::idx::Page) perl(XBase::mdx) perl(XBase::mdx::Page) perl(XBase::ndx) perl(XBase::ndx::Page) perl(XBase::ntx) perl(XBase::ntx::Page) perl-DBD-XBase"
