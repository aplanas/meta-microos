...
RPROVIDES:${PN} += "pangomm1_4-devel pangomm1_4-devel(aarch-64) pkgconfig(pangomm-1.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libpangomm-1_4-1 pkgconfig(cairomm-1.0) pkgconfig(glibmm-2.4) pkgconfig(pangocairo)"
