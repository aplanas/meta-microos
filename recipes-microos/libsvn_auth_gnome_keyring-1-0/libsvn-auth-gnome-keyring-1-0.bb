...
RPROVIDES:${PN} += "libsvn_auth_gnome_keyring-1-0 libsvn_auth_gnome_keyring-1-0(aarch-64) libsvn_auth_gnome_keyring-1.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig libapr-1.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libsecret-1.so.0()(64bit) libsvn_subr-1.so.0()(64bit) subversion"
