...
RPROVIDES:${PN} += "tex(nomentbl.sty) texlive-nomentbl"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(calc.sty) tex(ifthen.sty) tex(longtable.sty) tex(nomencl.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
