...
RPROVIDES:${PN} += "python3-azure-mgmt-serialconsole python3.10dist(azure-mgmt-serialconsole) python310-azure-mgmt-serialconsole python3dist(azure-mgmt-serialconsole)"
