...
RPROVIDES:${PN} += "cmake(KQuickImageEditor) kquickimageeditor-devel kquickimageeditor-devel(aarch-64)"
RDEPENDS:${PN} += "cmake(Qt5Core) cmake(Qt5Quick) kquickimageeditor-imports"
