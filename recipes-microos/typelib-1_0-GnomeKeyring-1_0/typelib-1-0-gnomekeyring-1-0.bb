...
RPROVIDES:${PN} += "typelib(GnomeKeyring) typelib-1_0-GnomeKeyring-1_0 typelib-1_0-GnomeKeyring-1_0(aarch-64)"
RDEPENDS:${PN} += "libgnome-keyring.so.0()(64bit) typelib(GLib) typelib(GObject)"
