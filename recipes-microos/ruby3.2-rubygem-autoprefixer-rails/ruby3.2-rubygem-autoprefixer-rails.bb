...
RPROVIDES:${PN} += "ruby3.2-rubygem-autoprefixer-rails ruby3.2-rubygem-autoprefixer-rails(aarch-64) rubygem(autoprefixer-rails) rubygem(ruby:3.2.0:autoprefixer-rails) rubygem(ruby:3.2.0:autoprefixer-rails:10) rubygem(ruby:3.2.0:autoprefixer-rails:10.4) rubygem(ruby:3.2.0:autoprefixer-rails:10.4.7)"
