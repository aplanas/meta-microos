...
RPROVIDES:${PN} += "libwsman-devel libwsman-devel(aarch-64) openwsman-devel pkgconfig(openwsman) pkgconfig(openwsman++) pkgconfig(openwsman-server)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libwsman1 libwsman_client5 libxml2-devel openwsman-server pam-devel sblim-sfcc-devel"
