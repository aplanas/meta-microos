...
RPROVIDES:${PN} += "ibus-devel ibus-devel(aarch-64) pkgconfig(ibus-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config dbus-1-devel glib2-devel gtk-doc ibus libibus-1_0-5 pkgconfig(gio-2.0) pkgconfig(gobject-2.0) typelib-1_0-IBus-1_0"
