...
RPROVIDES:${PN} += "python3-padatious python3.10dist(padatious) python310-padatious python3dist(padatious)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-fann2 python310-padaos python310-setuptools python310-xxhash update-alternatives"
