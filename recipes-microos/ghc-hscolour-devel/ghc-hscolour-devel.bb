...
RPROVIDES:${PN} += "ghc-devel(hscolour-1.24.4-B0NmEhYuPI790UQrsiXLka) ghc-hscolour-devel ghc-hscolour-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-hscolour"
