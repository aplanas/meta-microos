...
RPROVIDES:${PN} += "cmake(socket_wrapper) cmake(socket_wrapper_noop) libsocket_wrapper_noop-devel libsocket_wrapper_noop-devel(aarch-64) pkgconfig(socket_wrapper_noop)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libsocket_wrapper_noop0"
