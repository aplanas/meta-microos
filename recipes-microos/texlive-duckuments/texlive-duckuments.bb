...
RPROVIDES:${PN} += "tex(duckuments.sty) texlive-duckuments"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(l3keys2e.sty) tex(letltxmacro.sty) tex(tikzducks.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
