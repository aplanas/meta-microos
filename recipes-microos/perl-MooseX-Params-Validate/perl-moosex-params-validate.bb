...
RPROVIDES:${PN} += "perl(MooseX::Params::Validate) perl(MooseX::Params::Validate::Exception::ValidationFailedForTypeConstraint) perl-MooseX-Params-Validate"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Devel::Caller) perl(Moose) perl(Moose::Exception) perl(Moose::Util) perl(Moose::Util::TypeConstraints) perl(Params::Validate) perl(Sub::Exporter)"
