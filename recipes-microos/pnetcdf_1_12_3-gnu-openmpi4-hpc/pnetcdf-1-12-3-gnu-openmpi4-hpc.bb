...
RPROVIDES:${PN} += "pnetcdf_1_12_3-gnu-openmpi4-hpc pnetcdf_1_12_3-gnu-openmpi4-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpnetcdf_1_12_3-gnu-openmpi4-hpc"
