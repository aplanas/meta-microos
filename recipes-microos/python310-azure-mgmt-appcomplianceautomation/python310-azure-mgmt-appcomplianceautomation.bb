...
RPROVIDES:${PN} += "python3-azure-mgmt-appcomplianceautomation python3.10dist(azure-mgmt-appcomplianceautomation) python310-azure-mgmt-appcomplianceautomation python3dist(azure-mgmt-appcomplianceautomation)"
