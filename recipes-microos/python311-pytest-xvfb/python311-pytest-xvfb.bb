...
RPROVIDES:${PN} += "python3.11dist(pytest-xvfb) python311-pytest-xvfb python3dist(pytest-xvfb)"
RDEPENDS:${PN} += "python(abi) python311-PyVirtualDisplay python311-pytest xdpyinfo"
