...
RPROVIDES:${PN} += "python3.9dist(versioningit) python39-versioningit python3dist(versioningit)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 alts python(abi) python39-packaging python39-setuptools python39-tomli"
