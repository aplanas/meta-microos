...
RPROVIDES:${PN} += "python3-azure-mgmt-streamanalytics python3.10dist(azure-mgmt-streamanalytics) python310-azure-mgmt-streamanalytics python3dist(azure-mgmt-streamanalytics)"
