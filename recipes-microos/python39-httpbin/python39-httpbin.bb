...
RPROVIDES:${PN} += "python3.9dist(httpbin) python39-httpbin python3dist(httpbin)"
RDEPENDS:${PN} += "python(abi) python39-Brotli python39-Flask python39-MarkupSafe python39-Werkzeug python39-blinker python39-decorator python39-flasgger python39-gevent python39-itsdangerous python39-six"
