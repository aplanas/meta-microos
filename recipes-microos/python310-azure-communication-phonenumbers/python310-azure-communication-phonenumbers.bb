...
RPROVIDES:${PN} += "python3-azure-communication-phonenumbers python3.10dist(azure-communication-phonenumbers) python310-azure-communication-phonenumbers python3dist(azure-communication-phonenumbers)"
