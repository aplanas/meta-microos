...
RPROVIDES:${PN} += "libgdiplus-devel libgdiplus-devel(aarch-64) pkgconfig(libgdiplus)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgdiplus0 pkgconfig(glib-2.0) pkgconfig(gmodule-2.0) pkgconfig(gthread-2.0)"
