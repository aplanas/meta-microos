...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-vision-face) python311-azure-cognitiveservices-vision-face python3dist(azure-cognitiveservices-vision-face)"
