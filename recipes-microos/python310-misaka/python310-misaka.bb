...
RPROVIDES:${PN} += "python3-misaka python3.10dist(misaka) python310-misaka python310-misaka(aarch-64) python3dist(misaka)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-cffi update-alternatives"
