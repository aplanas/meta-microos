...
RPROVIDES:${PN} += "python3.11dist(translate-toolkit) python311-translate-toolkit python3dist(translate-toolkit)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/python3.11 gettext-runtime python(abi) python311 python311-lxml python311-setuptools update-alternatives"
