...
RPROVIDES:${PN} += "libstoken.so.1()(64bit) libstoken.so.1(STOKEN_1.0)(64bit) libstoken.so.1(STOKEN_1.1)(64bit) libstoken.so.1(STOKEN_1.2)(64bit) libstoken.so.1(STOKEN_1.3)(64bit) libstoken.so.1(STOKEN_PRIVATE)(64bit) libstoken1 libstoken1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libtomcrypt.so.1()(64bit) libxml2.so.2()(64bit) libxml2.so.2(LIBXML2_2.4.30)(64bit) libxml2.so.2(LIBXML2_2.6.0)(64bit)"
