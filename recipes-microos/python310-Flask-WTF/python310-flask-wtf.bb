...
RPROVIDES:${PN} += "python3-Flask-WTF python3.10dist(flask-wtf) python310-Flask-WTF python3dist(flask-wtf)"
RDEPENDS:${PN} += "python(abi) python310-Flask python310-WTForms python310-Werkzeug python310-itsdangerous"
