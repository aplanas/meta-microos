...
RPROVIDES:${PN} += "python3-oslo.utils python3.10dist(oslo.utils) python3dist(oslo.utils)"
RDEPENDS:${PN} += "python(abi) python3-debtcollector python3-iso8601 python3-netaddr python3-netifaces python3-oslo.i18n python3-pyparsing python3-pytz"
