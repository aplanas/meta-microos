...
RPROVIDES:${PN} += "python3.9dist(pywbem) python39-pywbem python3dist(pywbem)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-nocasedict python39-nocaselist python39-ply python39-requests python39-six python39-urllib3 python39-yamlloader update-alternatives"
