...
RPROVIDES:${PN} += "python3.9dist(gwdatafind) python39-gwdatafind python3dist(gwdatafind)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-igwn-auth-utils-requests python39-ligo-segments update-alternatives"
