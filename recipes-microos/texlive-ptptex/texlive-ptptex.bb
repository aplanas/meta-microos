...
RPROVIDES:${PN} += "tex(ptp-prep.clo) tex(ptptex.cls) tex(wrapft.sty) texlive-ptptex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(amssymb.sty) tex(overcite.sty) tex(wrapfig.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
