...
RPROVIDES:${PN} += "python3.9dist(azure-synapse-accesscontrol) python39-azure-synapse python39-azure-synapse-accesscontrol python3dist(azure-synapse-accesscontrol)"
