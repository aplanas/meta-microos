...
RPROVIDES:${PN} += "ghc-pem-prof ghc-pem-prof(aarch-64) ghc-prof(pem-0.2.4-GVwv4fsQYoEEDbQiUNwxns)"
RDEPENDS:${PN} += "ghc-pem-devel ghc-prof(base-4.17.1.0) ghc-prof(basement-0.0.15-6OmKTVi2kFpCWMoKDlsO4S) ghc-prof(bytestring-0.11.4.0) ghc-prof(memory-0.18.0-2DG6nqjfLMK4MSR77XYQqL)"
