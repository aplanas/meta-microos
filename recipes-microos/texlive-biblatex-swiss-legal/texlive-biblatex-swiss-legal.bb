...
RPROVIDES:${PN} += "tex(biblatex-swiss-legal-base.bbx) tex(biblatex-swiss-legal-base.cbx) tex(biblatex-swiss-legal-bibliography.bbx) tex(biblatex-swiss-legal-bibliography.cbx) tex(biblatex-swiss-legal-de.lbx) tex(biblatex-swiss-legal-fr.lbx) tex(biblatex-swiss-legal-general.bbx) tex(biblatex-swiss-legal-general.cbx) tex(biblatex-swiss-legal-longarticle.bbx) tex(biblatex-swiss-legal-longarticle.cbx) tex(biblatex-swiss-legal-shortarticle.bbx) tex(biblatex-swiss-legal-shortarticle.cbx) texlive-biblatex-swiss-legal"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(french.lbx) tex(ngerman.lbx) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
