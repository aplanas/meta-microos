...
RPROVIDES:${PN} += "python3-oslo.policy python3.10dist(oslo.policy) python3dist(oslo.policy)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-PyYAML python3-oslo.config python3-oslo.context python3-oslo.i18n python3-oslo.serialization python3-oslo.utils python3-requests python3-stevedore"
