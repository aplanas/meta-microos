...
RPROVIDES:${PN} += "config(texlive-luatex) tex(luatex-unicode-letters.tex) tex(luatexiniconfig.tex) texlive-luatex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(language.dat) tex(language.dat.lua) tex(language.def) tex(load-unicode-data.tex) tex(luatexconfig.tex) tex(null.tex) texlive texlive-cm texlive-etex texlive-filesystem texlive-hyph-utf8 texlive-hyphen-base texlive-knuth-lib texlive-kpathsea texlive-kpathsea-bin texlive-luatex-bin texlive-manfnt texlive-plain texlive-scripts texlive-scripts-bin texlive-tex-ini-files texlive-unicode-data"
