...
RPROVIDES:${PN} += "typelib(Uhm) typelib-1_0-Uhm-1_0 typelib-1_0-Uhm-1_0(aarch-64)"
RDEPENDS:${PN} += "libuhttpmock-1.0.so.1()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Soup)"
