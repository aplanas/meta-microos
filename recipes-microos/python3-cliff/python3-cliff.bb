...
RPROVIDES:${PN} += "python3-cliff python3.10dist(cliff) python3dist(cliff)"
RDEPENDS:${PN} += "python(abi) python3-PrettyTable python3-PyYAML python3-autopage python3-cmd2 python3-pyparsing python3-stevedore"
