...
RPROVIDES:${PN} += "libpmemblk-devel libpmemblk-devel(aarch-64) pkgconfig(libpmemblk)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdaxctl.so.1()(64bit) libdaxctl.so.1(LIBDAXCTL_2)(64bit) libndctl.so.6()(64bit) libndctl.so.6(LIBNDCTL_1)(64bit) libndctl.so.6(LIBNDCTL_15)(64bit) libndctl.so.6(LIBNDCTL_18)(64bit) libndctl.so.6(LIBNDCTL_3)(64bit) libpmem.so.1()(64bit) libpmem.so.1(LIBPMEM_1.0)(64bit) libpmemblk1 pkgconfig(libdaxctl) pkgconfig(libndctl) pkgconfig(libpmem)"
