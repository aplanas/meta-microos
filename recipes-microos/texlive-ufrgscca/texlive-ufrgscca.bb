...
RPROVIDES:${PN} += "tex(ufrgscca-abnt.sty) tex(ufrgscca-coord.sty) tex(ufrgscca-core.sty) tex(ufrgscca-cover.sty) tex(ufrgscca-curr-graph.sty) tex(ufrgscca-curr-tab.sty) tex(ufrgscca-curr.sty) tex(ufrgscca-en-base.def) tex(ufrgscca-en-coord.def) tex(ufrgscca-en-core.def) tex(ufrgscca-en-forms.def) tex(ufrgscca-forms.sty) tex(ufrgscca-gen.sty) tex(ufrgscca-lists.sty) tex(ufrgscca-ppc.sty) tex(ufrgscca-ptBR-base.def) tex(ufrgscca-ptBR-coord.def) tex(ufrgscca-ptBR-core.def) tex(ufrgscca-ptBR-forms.def) tex(ufrgscca.cls) texlive-ufrgscca"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsfonts.sty) tex(amssymb.sty) tex(amsthm.sty) tex(appendix.sty) tex(array.sty) tex(article.cls) tex(babel.sty) tex(biblatex.sty) tex(bigdelim.sty) tex(caption.sty) tex(chngcntr.sty) tex(circuitikz.sty) tex(contour.sty) tex(csquotes.sty) tex(empheq.sty) tex(enumitem.sty) tex(etex.sty) tex(etoolbox.sty) tex(extarrows.sty) tex(fontenc.sty) tex(geometry.sty) tex(graphicx.sty) tex(hyperref.sty) tex(inputenc.sty) tex(keyval.sty) tex(listings.sty) tex(lmodern.sty) tex(longtable.sty) tex(mathfixs.sty) tex(mathptmx.sty) tex(mathrsfs.sty) tex(mathtools.sty) tex(mdframed.sty) tex(microtype.sty) tex(newfloat.sty) tex(nicematrix.sty) tex(pdfcomment.sty) tex(pgfcalendar.sty) tex(relsize.sty) tex(report.cls) tex(showframe.sty) tex(showlabels.sty) tex(silence.sty) tex(soul.sty) tex(steinmetz.sty) tex(titlesec.sty) tex(titletoc.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
