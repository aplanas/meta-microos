...
RPROVIDES:${PN} += "python3.11dist(alembic) python311-alembic python3dist(alembic)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Mako python311-SQLAlchemy python311-python-dateutil python311-typing-extensions update-alternatives"
