...
RPROVIDES:${PN} += "python3-azure-mgmt-redisenterprise python3.10dist(azure-mgmt-redisenterprise) python310-azure-mgmt-redisenterprise python3dist(azure-mgmt-redisenterprise)"
