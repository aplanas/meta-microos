...
RPROVIDES:${PN} += "python3-jupyter-packaging python3-jupyter_packaging python3.10dist(jupyter-packaging) python310-jupyter-packaging python310-jupyter_packaging python3dist(jupyter-packaging)"
RDEPENDS:${PN} += "python(abi) python310-deprecation python310-packaging python310-setuptools python310-tomlkit python310-wheel"
