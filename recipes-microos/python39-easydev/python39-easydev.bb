...
RPROVIDES:${PN} += "python3.9dist(easydev) python39-easydev python3dist(easydev)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-colorama python39-colorlog python39-pexpect python39-setuptools update-alternatives"
