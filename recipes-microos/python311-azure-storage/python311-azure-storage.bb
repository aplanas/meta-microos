...
RPROVIDES:${PN} += "python3.11dist(azure-storage) python311-azure-sdk-storage python311-azure-storage python3dist(azure-storage)"
RDEPENDS:${PN} += "python(abi) python311-azure-common python311-azure-nspkg python311-cryptography python311-python-dateutil python311-requests"
