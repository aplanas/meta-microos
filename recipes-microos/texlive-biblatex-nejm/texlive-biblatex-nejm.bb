...
RPROVIDES:${PN} += "tex(nejm.bbx) tex(nejm.cbx) texlive-biblatex-nejm"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(numeric-comp.cbx) tex(numeric.bbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
