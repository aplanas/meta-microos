...
RPROVIDES:${PN} += "libsigrokdecode.so.4()(64bit) libsigrokdecode4 libsigrokdecode4(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libpython3.10.so.1.0()(64bit) python3-base"
