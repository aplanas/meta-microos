...
RPROVIDES:${PN} += "python3.11dist(azure-mgmt-machinelearningcompute) python311-azure-mgmt-machinelearningcompute python3dist(azure-mgmt-machinelearningcompute)"
