...
RPROVIDES:${PN} += "ghc-alsa-core-devel ghc-alsa-core-devel(aarch-64) ghc-devel(alsa-core-0.5.0.1-JiFJwdvZ0Gx6AeuqXKf7yg)"
RDEPENDS:${PN} += "/bin/sh ghc-alsa-core ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(extensible-exceptions-0.1.1.4-ItoFoaqbPMuGIlsBr6VhGY) pkgconfig pkgconfig(alsa)"
