...
RPROVIDES:${PN} += "python3.9dist(redfish) python39-redfish python3dist(redfish)"
RDEPENDS:${PN} += "python(abi) python39-jsonpatch python39-jsonpath-rw python39-jsonpointer python39-requests python39-requests-toolbelt python39-requests-unixsocket"
