...
RPROVIDES:${PN} += "python3.11dist(pyannotate) python311-pyannotate python3dist(pyannotate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-mypy_extensions python311-six python311-typing update-alternatives"
