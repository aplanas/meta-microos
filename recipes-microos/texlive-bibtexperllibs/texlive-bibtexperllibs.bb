...
RPROVIDES:${PN} += "perl(BibTeX::Parser) perl(BibTeX::Parser::Author) perl(BibTeX::Parser::Entry) perl(LaTeX::ToUnicode) perl(LaTeX::ToUnicode::Tables) texlive-bibtexperllibs"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep perl(BibTeX::Parser) perl(BibTeX::Parser::Author) perl(BibTeX::Parser::Entry) perl(Exporter) perl(LaTeX::ToUnicode) perl(LaTeX::ToUnicode::Tables) perl(strict) perl(utf8) perl(warnings) sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
