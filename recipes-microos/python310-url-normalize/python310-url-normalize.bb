...
RPROVIDES:${PN} += "python3-url-normalize python3-url_normalize python3.10dist(url-normalize) python310-url-normalize python310-url_normalize python3dist(url-normalize)"
