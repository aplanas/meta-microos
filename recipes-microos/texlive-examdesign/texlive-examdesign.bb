...
RPROVIDES:${PN} += "tex(examdesign.cls) texlive-examdesign"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(enumerate.sty) tex(keyval.sty) tex(multicol.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
