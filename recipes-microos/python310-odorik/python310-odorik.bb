...
RPROVIDES:${PN} += "python3-odorik python3.10dist(odorik) python310-odorik python3dist(odorik)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-python-dateutil python310-xdg update-alternatives"
