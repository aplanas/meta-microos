...
RPROVIDES:${PN} += "ghc-devel(tagsoup-0.14.8-KqOLe3dJpuA4KsHZJW2cTn) ghc-tagsoup-devel ghc-tagsoup-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(containers-0.6.7) ghc-devel(text-2.0.2) ghc-tagsoup"
