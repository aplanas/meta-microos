...
RPROVIDES:${PN} += "python3.9dist(jupyter-telemetry) python39-jupyter-telemetry python3dist(jupyter-telemetry)"
RDEPENDS:${PN} += "python(abi) python39-jsonschema python39-python-json-logger python39-ruamel.yaml python39-traitlets"
