...
RPROVIDES:${PN} += "python3-openstacksdk python3.10dist(openstacksdk) python3dist(openstacksdk)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/python3 mkisofs python(abi) python3-PyYAML python3-appdirs python3-cryptography python3-decorator python3-dogpile.cache python3-iso8601 python3-jmespath python3-jsonpatch python3-keystoneauth1 python3-munch python3-netifaces python3-os-service-types python3-requestsexceptions"
