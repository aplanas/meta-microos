...
RPROVIDES:${PN} += "python3.11dist(wptools) python311-wptools python3dist(wptools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-certifi python311-html2text python311-lxml python311-pycurl update-alternatives"
