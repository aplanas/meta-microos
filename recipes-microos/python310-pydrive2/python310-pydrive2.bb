...
RPROVIDES:${PN} += "python3-pydrive2 python3.10dist(pydrive2) python310-pydrive2 python3dist(pydrive2)"
RDEPENDS:${PN} += "python(abi) python310-PyYAML python310-filelock python310-google-api-python-client python310-google-auth python310-google-auth-httplib2 python310-google-auth-oauthlib python310-pyOpenSSL python310-six"
