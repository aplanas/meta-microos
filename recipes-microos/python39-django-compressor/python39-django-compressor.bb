...
RPROVIDES:${PN} += "python3.9dist(django-compressor) python39-django-compressor python39-django_compressor python3dist(django-compressor)"
RDEPENDS:${PN} += "python(abi) python39-Django python39-Jinja2 python39-beautifulsoup4 python39-csscompressor python39-django-appconf python39-rcssmin python39-rjsmin python39-slimit"
