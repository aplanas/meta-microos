...
RPROVIDES:${PN} += "man(dvidvi.1) texlive-dvidvi"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-dvidvi-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
