...
RPROVIDES:${PN} += "libhidapi-hidraw.so.0()(64bit) libhidapi-hidraw0 libhidapi-hidraw0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libudev.so.1()(64bit) libudev.so.1(LIBUDEV_183)(64bit)"
