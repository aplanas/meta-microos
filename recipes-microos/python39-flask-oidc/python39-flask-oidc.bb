...
RPROVIDES:${PN} += "python3.9dist(flask-oidc) python39-flask-oidc python3dist(flask-oidc)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Authlib python39-Flask python39-requests update-alternatives"
