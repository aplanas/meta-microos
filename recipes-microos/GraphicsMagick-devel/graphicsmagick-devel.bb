...
RPROVIDES:${PN} += "GraphicsMagick-devel GraphicsMagick-devel(aarch-64) pkgconfig(GraphicsMagick) pkgconfig(GraphicsMagickWand)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config glibc-devel libGraphicsMagick-Q16-3 libGraphicsMagickWand-Q16-2 pkgconfig(GraphicsMagick)"
