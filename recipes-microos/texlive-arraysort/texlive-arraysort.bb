...
RPROVIDES:${PN} += "tex(arraysort.sty) texlive-arraysort"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(arrayjobx.sty) tex(calc.sty) tex(etoolbox.sty) tex(ifthen.sty) tex(lcg.sty) tex(macroswap.sty) tex(pdftexcmds.sty) tex(xargs.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
