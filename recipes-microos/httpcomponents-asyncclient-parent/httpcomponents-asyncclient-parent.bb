...
RPROVIDES:${PN} += "httpcomponents-asyncclient-parent mvn(org.apache.httpcomponents:httpcomponents-asyncclient:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.httpcomponents:project:pom:) mvn(org.apache.maven.plugins:maven-jar-plugin)"
