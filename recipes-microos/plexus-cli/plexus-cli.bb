...
RPROVIDES:${PN} += "mvn(org.codehaus.plexus:plexus-cli) mvn(org.codehaus.plexus:plexus-cli:pom:) plexus-cli"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(commons-cli:commons-cli) mvn(org.codehaus.plexus:plexus-container-default) mvn(org.codehaus.plexus:plexus-utils)"
