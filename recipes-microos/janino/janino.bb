...
RPROVIDES:${PN} += "janino mvn(org.codehaus.janino:janino) mvn(org.codehaus.janino:janino:pom:) osgi(org.codehaus.janino.janino)"
RDEPENDS:${PN} += "/bin/bash commons-compiler java-headless javapackages-filesystem javapackages-tools mvn(org.codehaus.janino:commons-compiler) osgi(org.codehaus.janino.commons-compiler)"
