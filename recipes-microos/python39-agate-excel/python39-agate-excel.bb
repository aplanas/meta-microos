...
RPROVIDES:${PN} += "python3.9dist(agate-excel) python39-agate-excel python3dist(agate-excel)"
RDEPENDS:${PN} += "python(abi) python39-agate python39-olefile python39-openpyxl python39-six python39-xlrd"
