...
RPROVIDES:${PN} += "collectd-plugin-smart collectd-plugin-smart(aarch-64)"
RDEPENDS:${PN} += "collectd ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libatasmart.so.4()(64bit) libc.so.6(GLIBC_2.17)(64bit) libudev.so.1()(64bit) libudev.so.1(LIBUDEV_183)(64bit)"
