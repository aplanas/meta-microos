...
RPROVIDES:${PN} += "application() application(io.poez.Poezio.desktop) metainfo() metainfo(io.poez.Poezio.appdata.xml) poezio poezio(aarch-64) python3.10dist(poezio) python3dist(poezio)"
RDEPENDS:${PN} += "/usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python3-aiodns python3-curses python3-pyasn1-modules python3-setuptools python3-slixmpp"
