...
RPROVIDES:${PN} += "python3.11dist(sqlite3-to-mysql) python311-sqlite3-to-mysql python3dist(sqlite3-to-mysql)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-click python311-mysql-connector-python python311-packaging python311-pytimeparse python311-simplejson python311-six python311-tabulate python311-tqdm"
