...
RPROVIDES:${PN} += "python3.11dist(azure-search-documents) python311-azure-search-documents python3dist(azure-search-documents)"
RDEPENDS:${PN} += "python(abi) python311-azure-common python311-azure-core python311-azure-nspkg python311-azure-search-nspkg python311-msrest python311-typing_extensions"
