...
RPROVIDES:${PN} += "ruby3.2-rubygem-rake-compiler ruby3.2-rubygem-rake-compiler(aarch-64) rubygem(rake-compiler) rubygem(ruby:3.2.0:rake-compiler) rubygem(ruby:3.2.0:rake-compiler:1) rubygem(ruby:3.2.0:rake-compiler:1.2) rubygem(ruby:3.2.0:rake-compiler:1.2.0)"
