...
RPROVIDES:${PN} += "python3-azure-mgmt-containerregistry python3.10dist(azure-mgmt-containerregistry) python310-azure-mgmt-containerregistry python3dist(azure-mgmt-containerregistry)"
