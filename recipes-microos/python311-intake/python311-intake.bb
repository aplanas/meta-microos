...
RPROVIDES:${PN} += "python3.11dist(intake) python311-intake python3dist(intake)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Jinja2 python311-PyYAML python311-appdirs python311-dask python311-dask-bag python311-entrypoints python311-fsspec python311-msgpack update-alternatives"
