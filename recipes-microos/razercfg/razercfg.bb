...
RPROVIDES:${PN} += "application() application(razercfg.desktop) librazer.so.1()(64bit) python3.10dist(razercfg) python3dist(razercfg) razercfg razercfg(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libusb-1.0.so.0()(64bit) python(abi) python3-qt5"
