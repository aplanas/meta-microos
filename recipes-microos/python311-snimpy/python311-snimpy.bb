...
RPROVIDES:${PN} += "python3.11dist(snimpy) python311-snimpy python311-snimpy(aarch-64) python3dist(snimpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsmi.so.2()(64bit) python(abi) python311-cffi python311-pycryptodomex python311-pysnmp python311-setuptools update-alternatives"
