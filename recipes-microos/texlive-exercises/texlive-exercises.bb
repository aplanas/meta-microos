...
RPROVIDES:${PN} += "tex(exercises.sty) texlive-exercises"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifthen.sty) tex(kvoptions.sty) tex(marginnote.sty) tex(verbatim.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
