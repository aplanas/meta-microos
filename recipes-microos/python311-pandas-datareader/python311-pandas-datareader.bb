...
RPROVIDES:${PN} += "python3.11dist(pandas-datareader) python311-pandas-datareader python3dist(pandas-datareader)"
RDEPENDS:${PN} += "python(abi) python311-lxml python311-pandas python311-requests"
