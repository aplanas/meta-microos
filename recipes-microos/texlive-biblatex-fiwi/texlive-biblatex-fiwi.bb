...
RPROVIDES:${PN} += "tex(fiwi-yearbeginning.bbx) tex(fiwi.bbx) tex(fiwi.cbx) tex(fiwi2.bbx) tex(fiwi2.cbx) texlive-biblatex-fiwi"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ragged2e.sty) tex(standard.bbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
