...
RPROVIDES:${PN} += "libsbdtestbed.so.0()(64bit) sbd-devel sbd-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) sbd"
