...
RPROVIDES:${PN} += "tex(tile-graphic.sty) texlive-tile-graphic"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(multido.sty) tex(shellesc.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
