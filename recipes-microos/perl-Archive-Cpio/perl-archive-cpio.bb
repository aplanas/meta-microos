...
RPROVIDES:${PN} += "perl(Archive::Cpio) perl(Archive::Cpio::Common) perl(Archive::Cpio::File) perl(Archive::Cpio::FileHandle_with_pushback) perl(Archive::Cpio::NewAscii) perl(Archive::Cpio::ODC) perl(Archive::Cpio::OldBinary) perl-Archive-Cpio"
