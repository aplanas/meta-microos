...
RPROVIDES:${PN} += "python3.9dist(azure-communication-email) python39-azure-communication-email python3dist(azure-communication-email)"
RDEPENDS:${PN} += "python(abi) python39-azure-common python39-azure-communication-nspkg python39-azure-core python39-azure-nspkg python39-msrest"
