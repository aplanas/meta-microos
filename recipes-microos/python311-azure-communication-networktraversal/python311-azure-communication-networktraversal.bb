...
RPROVIDES:${PN} += "python3.11dist(azure-communication-networktraversal) python311-azure-communication-networktraversal python3dist(azure-communication-networktraversal)"
