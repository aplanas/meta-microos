...
RPROVIDES:${PN} += "tex(forest-compat.sty) tex(forest-doc.sty) tex(forest-index.sty) tex(forest-lib-edges.sty) tex(forest-lib-linguistics.sty) tex(forest.sty) texlive-forest"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(dingbat.sty) tex(elocalloc.sty) tex(environ.sty) tex(etoolbox.sty) tex(inlinedef.sty) tex(lstdoc.sty) tex(pgfkeys.sty) tex(pgfopts.sty) tex(tikz.sty) tex(xparse.sty) texlive texlive-elocalloc texlive-environ texlive-etoolbox texlive-filesystem texlive-inlinedef texlive-kpathsea texlive-kpathsea-bin texlive-l3packages texlive-pgf texlive-pgfopts texlive-scripts texlive-scripts-bin"
