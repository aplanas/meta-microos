...
RPROVIDES:${PN} += "ruby3.2-rubygem-vagrant-spec ruby3.2-rubygem-vagrant-spec(aarch-64) rubygem(ruby:3.2.0:vagrant-spec) rubygem(ruby:3.2.0:vagrant-spec:0) rubygem(ruby:3.2.0:vagrant-spec:0.0) rubygem(ruby:3.2.0:vagrant-spec:0.0.1) rubygem(vagrant-spec)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/ruby.ruby3.2 ruby(abi) rubygem(ruby:3.2.0:childprocess) rubygem(ruby:3.2.0:log4r:1.1) rubygem(ruby:3.2.0:rspec:3) rubygem(ruby:3.2.0:thor:1) update-alternatives"
