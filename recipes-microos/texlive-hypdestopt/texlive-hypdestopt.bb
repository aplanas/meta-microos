...
RPROVIDES:${PN} += "tex(hypdestopt.sty) texlive-hypdestopt"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(alphalph.sty) tex(auxhook.sty) tex(iftex.sty) tex(pdfescape.sty) tex(pdftexcmds.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
