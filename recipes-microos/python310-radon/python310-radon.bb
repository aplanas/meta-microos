...
RPROVIDES:${PN} += "python3-radon python3.10dist(radon) python310-radon python3dist(radon)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-colorama python310-future python310-mando update-alternatives"
