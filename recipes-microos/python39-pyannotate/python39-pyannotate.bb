...
RPROVIDES:${PN} += "python3.9dist(pyannotate) python39-pyannotate python3dist(pyannotate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-mypy_extensions python39-six python39-typing update-alternatives"
