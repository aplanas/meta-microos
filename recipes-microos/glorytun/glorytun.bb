...
RPROVIDES:${PN} += "glorytun glorytun(aarch-64)"
RDEPENDS:${PN} += "iproute2 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libsodium.so.23()(64bit)"
