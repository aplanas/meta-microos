...
RPROVIDES:${PN} += "tex(shtthesis.cls) texlive-shtthesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsthm.sty) tex(biblatex.sty) tex(calc.sty) tex(caption.sty) tex(ctexbook.cls) tex(datetime.sty) tex(enumitem.sty) tex(etoolbox.sty) tex(expl3.sty) tex(fancyhdr.sty) tex(fontspec.sty) tex(geometry.sty) tex(graphicx.sty) tex(hyperref.sty) tex(iftex.sty) tex(ifthen.sty) tex(indentfirst.sty) tex(kvdefinekeys.sty) tex(kvoptions.sty) tex(kvsetkeys.sty) tex(lastpage.sty) tex(letltxmacro.sty) tex(mathtools.sty) tex(tocvsec2.sty) tex(ulem.sty) tex(unicode-math.sty) tex(verbatim.sty) tex(xcolor.sty) tex(xparse.sty) texlive texlive-alphalph texlive-biber texlive-biblatex texlive-biblatex-gb7714-2015 texlive-booktabs texlive-caption texlive-colortbl texlive-ctex texlive-datetime texlive-enumitem texlive-fancyhdr texlive-filesystem texlive-fmtcount texlive-kpathsea texlive-kpathsea-bin texlive-lastpage texlive-latexmk texlive-listings texlive-lua-alt-getopt texlive-lualatex-math texlive-mathtools texlive-ntheorem texlive-scripts texlive-scripts-bin texlive-tex-gyre texlive-tocvsec2 texlive-transparent texlive-undolabl texlive-unicode-math texlive-xits texlive-xstring"
