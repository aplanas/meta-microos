...
RPROVIDES:${PN} += "tex(checklistings.sty) texlive-checklistings"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(fancyvrb.sty) tex(keyval.sty) tex(kvoptions.sty) tex(listings.sty) texlive texlive-checklistings-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
