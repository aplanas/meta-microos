...
RPROVIDES:${PN} += "python3-passivetotal python3.10dist(passivetotal) python310-passivetotal python3dist(passivetotal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-ez_setup python310-future python310-python-dateutil python310-requests python310-tldextract update-alternatives"
