...
RPROVIDES:${PN} += "perl(Log::Dispatchouli) perl(Log::Dispatchouli::Global) perl(Log::Dispatchouli::Proxy) perl(Log::Fmt) perl-Log-Dispatchouli"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Log::Dispatch) perl(Log::Dispatch::Array) perl(Log::Dispatch::File) perl(Log::Dispatch::Screen) perl(Log::Dispatch::Syslog) perl(Params::Util) perl(String::Flogger) perl(Sub::Exporter) perl(Sub::Exporter::GlobExporter) perl(Sys::Syslog) perl(Try::Tiny) perl(experimental)"
