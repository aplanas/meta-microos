...
RPROVIDES:${PN} += "ghc-contravariant-prof ghc-contravariant-prof(aarch-64) ghc-prof(contravariant-1.5.5-K71YSUvfKnA5wfNaE05Lao)"
RDEPENDS:${PN} += "ghc-contravariant-devel ghc-prof(StateVar-1.2.2-GlWluWgK8kgE7IUHzo2idN) ghc-prof(base-4.17.1.0) ghc-prof(transformers-0.5.6.2)"
