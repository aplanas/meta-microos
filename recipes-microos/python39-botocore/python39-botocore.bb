...
RDEPENDS:${PN} += "(python39-jmespath >= 0.7.1 with python39-jmespath < 2.0.0) (python39-python-dateutil >= 2.1 with python39-python-dateutil < 3.0.0) python(abi) python39-requests"
