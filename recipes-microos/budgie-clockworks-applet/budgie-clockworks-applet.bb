...
RPROVIDES:${PN} += "budgie-clockworks-applet budgie-clockworks-applet(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 python3-CairoSVG python3-Pillow python3-gobject-Gdk python3-svgwrite typelib(Budgie) typelib(GLib) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk)"
