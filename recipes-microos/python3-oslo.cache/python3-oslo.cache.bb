...
RPROVIDES:${PN} += "python3-oslo.cache python3.10dist(oslo.cache) python3dist(oslo.cache)"
RDEPENDS:${PN} += "python(abi) python3-dogpile.cache python3-oslo.config python3-oslo.i18n python3-oslo.log python3-oslo.utils python3-python-memcached"
