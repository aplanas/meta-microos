...
RPROVIDES:${PN} += "libgaminggear.so.0()(64bit) libgaminggear0 libgaminggear0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcanberra.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libnotify.so.4()(64bit) libsqlite3.so.0()(64bit)"
