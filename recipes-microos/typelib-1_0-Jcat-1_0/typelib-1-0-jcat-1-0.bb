...
RPROVIDES:${PN} += "typelib(Jcat) typelib-1_0-Jcat-1_0 typelib-1_0-Jcat-1_0(aarch-64)"
RDEPENDS:${PN} += "libjcat.so.1()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Json)"
