...
RPROVIDES:${PN} += "libavahi-gobject-devel libavahi-gobject-devel(aarch-64) pkgconfig(avahi-gobject)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glib2-devel libavahi-devel libavahi-glib-devel libavahi-gobject0 pkgconfig(avahi-client) pkgconfig(avahi-glib) pkgconfig(glib-2.0) pkgconfig(gobject-2.0)"
