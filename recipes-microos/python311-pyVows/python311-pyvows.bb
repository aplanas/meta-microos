...
RPROVIDES:${PN} += "python3.11dist(pyvows) python311-pyVows python3dist(pyvows)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Unidecode python311-gevent python311-preggy update-alternatives"
