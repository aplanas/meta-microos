...
RPROVIDES:${PN} += "mono(Newtonsoft.Json) newtonsoft-json"
RDEPENDS:${PN} += "mono(System) mono(System.Core) mono(System.Data) mono(System.Numerics) mono(System.Runtime.Serialization) mono(System.Xml) mono(System.Xml.Linq) mono(mscorlib)"
