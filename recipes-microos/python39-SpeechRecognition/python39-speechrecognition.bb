...
RPROVIDES:${PN} += "python3.9dist(speechrecognition) python39-SpeechRecognition python3dist(speechrecognition)"
RDEPENDS:${PN} += "flac python(abi) python-SpeechRecognition-common-en-US python39-PyAudio python39-google-cloud-speech"
