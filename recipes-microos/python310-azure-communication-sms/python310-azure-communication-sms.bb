...
RPROVIDES:${PN} += "python3-azure-communication-sms python3.10dist(azure-communication-sms) python310-azure-communication-sms python3dist(azure-communication-sms)"
