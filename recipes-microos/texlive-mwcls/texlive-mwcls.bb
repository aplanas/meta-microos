...
RPROVIDES:${PN} += "tex(mw10.clo) tex(mw11.clo) tex(mw12.clo) tex(mwart.cls) tex(mwbk.cls) tex(mwbk10.clo) tex(mwbk11.clo) tex(mwbk12.clo) tex(mwrep.cls) texlive-mwcls"
