...
RPROVIDES:${PN} += "python3.11dist(fanficfare) python311-fanficfare python3dist(fanficfare)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-beautifulsoup4 python311-chardet python311-cloudscraper python311-html2text python311-html5lib python311-requests-file python311-setuptools update-alternatives"
