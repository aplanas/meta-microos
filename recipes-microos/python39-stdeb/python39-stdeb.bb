...
RPROVIDES:${PN} += "python3.9dist(stdeb) python39-stdeb python3dist(stdeb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 debhelper dpkg fakeroot python(abi) python39-requests update-alternatives"
