...
RPROVIDES:${PN} += "ocaml(Bigarray_compat) ocaml-bigarray-compat-devel ocaml-bigarray-compat-devel(aarch-64) ocamlfind(bigarray-compat) ocamlx(Bigarray_compat)"
RDEPENDS:${PN} += "ocaml(CamlinternalFormatBasics) ocaml(Stdlib) ocaml(Stdlib__Bigarray) ocaml(Stdlib__Complex) ocaml-bigarray-compat ocamlx(Stdlib__Bigarray)"
