...
RPROVIDES:${PN} += "ghc-devel(lift-type-0.1.1.1-2p47b0Ftg8mEbzaiZ22oeB) ghc-lift-type-devel ghc-lift-type-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(template-haskell-2.19.0.0) ghc-lift-type"
