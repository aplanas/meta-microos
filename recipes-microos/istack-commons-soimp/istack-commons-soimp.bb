...
RPROVIDES:${PN} += "istack-commons-soimp mvn(com.sun.istack:istack-commons-soimp) mvn(com.sun.istack:istack-commons-soimp:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(args4j:args4j) mvn(org.apache.ant:ant)"
