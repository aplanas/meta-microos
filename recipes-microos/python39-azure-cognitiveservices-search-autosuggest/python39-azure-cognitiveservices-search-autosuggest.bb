...
RPROVIDES:${PN} += "python3.9dist(azure-cognitiveservices-search-autosuggest) python39-azure-cognitiveservices-search-autosuggest python3dist(azure-cognitiveservices-search-autosuggest)"
