...
RPROVIDES:${PN} += "tex(listbib.cfg) tex(listbib.sty) tex(listbib.tex) texlive-listbib"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-listbib-bin texlive-scripts texlive-scripts-bin"
