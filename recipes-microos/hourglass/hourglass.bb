...
RPROVIDES:${PN} += "application() application(com.github.sgpthomas.hourglass.desktop) hourglass hourglass(aarch-64) metainfo() metainfo(com.github.sgpthomas.hourglass.appdata.xml)"
