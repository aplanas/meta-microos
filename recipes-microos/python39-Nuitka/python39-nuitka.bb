...
RPROVIDES:${PN} += "python3.9dist(nuitka) python39-Nuitka python3dist(nuitka)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 gcc-c++ python(abi) python39-Jinja2 python39-PyYAML python39-appdirs python39-atomicwrites python39-devel scons update-alternatives"
