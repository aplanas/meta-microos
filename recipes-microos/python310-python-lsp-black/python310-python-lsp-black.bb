...
RPROVIDES:${PN} += "python3-python-lsp-black python3.10dist(python-lsp-black) python310-python-lsp-black python3dist(python-lsp-black)"
RDEPENDS:${PN} += "python(abi) python310-black python310-python-lsp-server python310-toml"
