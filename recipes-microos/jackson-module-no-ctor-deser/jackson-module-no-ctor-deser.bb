...
RPROVIDES:${PN} += "jackson-module-no-ctor-deser mvn(com.fasterxml.jackson.module:jackson-module-no-ctor-deser) mvn(com.fasterxml.jackson.module:jackson-module-no-ctor-deser:pom:) osgi(com.fasterxml.jackson.module.jackson-module-no-ctor-deser)"
