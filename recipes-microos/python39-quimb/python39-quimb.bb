...
RPROVIDES:${PN} += "python3.9dist(quimb) python39-quimb python39-quimb(aarch-64) python3dist(quimb)"
RDEPENDS:${PN} += "/bin/bash /bin/sh python(abi) python39-cytoolz python39-numba python39-numpy python39-opt-einsum python39-psutil python39-scipy python39-tqdm update-alternatives"
