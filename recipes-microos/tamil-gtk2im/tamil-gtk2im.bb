...
RPROVIDES:${PN} += "locale(gtk2:ta) tamil-gtk2im tamil-gtk2im(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/touch gtk2 gtk2-tools ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgdk-x11-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit)"
