...
RPROVIDES:${PN} += "python3.10dist(scdl) python3dist(scdl) scdl"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-clint python3-docopt python3-mutagen python3-requests python3-termcolor"
