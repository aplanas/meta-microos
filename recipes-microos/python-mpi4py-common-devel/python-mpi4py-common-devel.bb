...
RPROVIDES:${PN} += "python-mpi4py-common-devel python-mpi4py-common-devel(aarch-64) python310-mpi4py-common-devel python311-mpi4py-common-devel python39-mpi4py-common-devel"
