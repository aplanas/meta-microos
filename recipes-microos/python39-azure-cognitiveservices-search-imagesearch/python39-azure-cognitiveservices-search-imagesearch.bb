...
RPROVIDES:${PN} += "python3.9dist(azure-cognitiveservices-search-imagesearch) python39-azure-cognitiveservices-search-imagesearch python3dist(azure-cognitiveservices-search-imagesearch)"
