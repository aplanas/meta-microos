...
RPROVIDES:${PN} += "tex(ydoc-code.sty) tex(ydoc-desc.sty) tex(ydoc-doc.sty) tex(ydoc-expl.sty) tex(ydoc.cfg) tex(ydoc.cls) tex(ydoc.sty) tex(ydocincl.tex) tex(ydocstrip.tex) texlive-ydoc"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(etoolbox.sty) tex(float.sty) tex(hyperref.sty) tex(listings.sty) tex(needspace.sty) tex(newverbs.sty) tex(shortvrb.sty) tex(url.sty) tex(xcolor.sty) tex(xspace.sty) texlive texlive-etoolbox texlive-filesystem texlive-float texlive-hyperref texlive-kpathsea texlive-kpathsea-bin texlive-listings texlive-needspace texlive-newverbs texlive-scripts texlive-scripts-bin texlive-showexpl texlive-tools texlive-url texlive-xcolor"
