...
RPROVIDES:${PN} += "config(mpich-ofi_4_0_2-gnu-hpc-macros-devel) mpich-hpc-macros-devel mpich-ofi_4_0_2-gnu-hpc-macros-devel mpich-ofi_4_0_2-gnu-hpc-macros-devel(aarch-64) rpm_macro(hpc_mpich_init) rpm_macro(hpc_mpich_requires) rpm_macro(hpc_mpich_requires_devel) rpm_macro(hpc_setup_mpich)"
