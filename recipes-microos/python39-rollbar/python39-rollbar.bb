...
RPROVIDES:${PN} += "python3.9dist(rollbar) python39-rollbar python3dist(rollbar)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-requests python39-setuptools python39-six update-alternatives"
