...
RPROVIDES:${PN} += "config(libcsync0) libcsync.so.0()(64bit) libcsync0 libcsync0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libsqlite3.so.0()(64bit)"
