...
RPROVIDES:${PN} += "python3.9dist(slimit) python39-slimit python3dist(slimit)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-ply python39-setuptools update-alternatives"
