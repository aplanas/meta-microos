...
RPROVIDES:${PN} += "python3.9dist(nbclassic) python39-nbclassic python3dist(nbclassic)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 alts jupyter-nbclassic python(abi) python39-Jinja2 python39-Send2Trash python39-argon2-cffi python39-ipykernel python39-ipython_genutils python39-jupyter-client python39-jupyter-core python39-nbconvert python39-nbformat python39-nest-asyncio python39-notebook-shim python39-prometheus-client python39-pyzmq python39-terminado python39-tornado python39-traitlets"
