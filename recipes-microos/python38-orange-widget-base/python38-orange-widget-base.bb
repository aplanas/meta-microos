...
RPROVIDES:${PN} += "python3.8dist(orange-widget-base) python38-orange-widget-base python3dist(orange-widget-base)"
RDEPENDS:${PN} += "python(abi) python38-AnyQt python38-matplotlib python38-orange-canvas-core python38-pyqtgraph python38-qt5 python38-qtwebengine-qt5"
