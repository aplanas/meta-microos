...
RPROVIDES:${PN} += "adios_1_13_1-gnu-openmpi3-hpc-devel adios_1_13_1-gnu-openmpi3-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "adios_1_13_1-gnu-openmpi3-hpc adios_1_13_1-gnu-openmpi3-hpc-devel-static gnu-compilers-hpc-devel hdf5-gnu-openmpi3-hpc-devel lua-lmod netcdf-gnu-openmpi3-hpc-devel openmpi3-gnu-hpc-devel"
