...
RPROVIDES:${PN} += "glew-devel glew-devel(aarch-64) pkgconfig(glew)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libGLEW2_2 pkgconfig(egl) pkgconfig(glu) pkgconfig(x11) pkgconfig(xproto)"
