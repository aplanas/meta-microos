...
RPROVIDES:${PN} += "python3-cepces python3.10dist(cepces) python3dist(cepces)"
RDEPENDS:${PN} += "python(abi) python3-cryptography python3-requests python3-requests-gssapi"
