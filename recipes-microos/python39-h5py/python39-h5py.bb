...
RPROVIDES:${PN} += "python3.9dist(h5py) python39-h5py python39-h5py(aarch-64) python3dist(h5py)"
RDEPENDS:${PN} += "hdf5 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libhdf5.so.200()(64bit) libhdf5_hl.so.200()(64bit) python(abi) python39-numpy"
