...
RPROVIDES:${PN} += "python3.9dist(flask-wtf) python39-Flask-WTF python3dist(flask-wtf)"
RDEPENDS:${PN} += "python(abi) python39-Flask python39-WTForms python39-Werkzeug python39-itsdangerous"
