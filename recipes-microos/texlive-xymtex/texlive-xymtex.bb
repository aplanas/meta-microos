...
RPROVIDES:${PN} += "tex(aliphat.sty) tex(assurechemist.sty) tex(assurelatexmode.sty) tex(bondcolor.sty) tex(carom.sty) tex(ccycle.sty) tex(chemist.sty) tex(chemstr.sty) tex(chemtimes.sty) tex(chmst-pdf.sty) tex(chmst-ps.sty) tex(fusering.sty) tex(hcycle.sty) tex(hetarom.sty) tex(hetaromh.sty) tex(lewisstruc.sty) tex(locant.sty) tex(lowcycle.sty) tex(methylen.sty) tex(polymers.sty) tex(sizeredc.sty) tex(steroid.sty) tex(xymtex.sty) tex(xymtexpdf.sty) tex(xymtexps.sty) tex(xymtx-pdf.sty) tex(xymtx-ps.sty) texlive-xymtex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(epic.sty) tex(pgfcore.sty) tex(pst-coil.sty) tex(pstricks.sty) tex(tikz.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
