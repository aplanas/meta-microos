...
RPROVIDES:${PN} += "netcdf-fortran_4_5_3-gnu-mpich-hpc netcdf-fortran_4_5_3-gnu-mpich-hpc-devel netcdf-fortran_4_5_3-gnu-mpich-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh gnu-compilers-hpc-devel ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcurl-devel libgfortran.so.5()(64bit) libgfortran.so.5(GFORTRAN_10)(64bit) libgfortran.so.5(GFORTRAN_8)(64bit) libnetcdf-fortran_4_5_3-gnu-mpich-hpc mpich-gnu-hpc-devel netcdf-gnu-mpich-hpc-devel pkgconfig zlib-devel"
