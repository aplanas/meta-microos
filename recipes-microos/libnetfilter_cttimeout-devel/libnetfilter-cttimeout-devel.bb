...
RPROVIDES:${PN} += "libnetfilter_cttimeout-devel libnetfilter_cttimeout-devel(aarch-64) pkgconfig(libnetfilter_cttimeout)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnetfilter_cttimeout1"
