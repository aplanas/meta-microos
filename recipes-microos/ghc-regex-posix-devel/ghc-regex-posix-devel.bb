...
RPROVIDES:${PN} += "ghc-devel(regex-posix-0.96.0.1-Db56rsDUom23lFxliY5wt1) ghc-regex-posix-devel ghc-regex-posix-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(containers-0.6.7) ghc-devel(regex-base-0.94.0.2-8EhYuxSr6UD5zE7cP6wrkq) ghc-regex-posix"
