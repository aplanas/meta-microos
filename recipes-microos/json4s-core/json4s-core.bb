...
RPROVIDES:${PN} += "json4s-core mvn(org.json4s:json4s-core_2.10) mvn(org.json4s:json4s-core_2.10:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.thoughtworks.paranamer:paranamer) mvn(org.json4s:json4s-ast_2.10) mvn(org.json4s:json4s-scalap_2.10) mvn(org.scala-lang:scala-library)"
