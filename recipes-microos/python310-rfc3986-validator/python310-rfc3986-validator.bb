...
RPROVIDES:${PN} += "python3-rfc3986-validator python3-rfc3986_validator python3.10dist(rfc3986-validator) python310-rfc3986-validator python310-rfc3986_validator python3dist(rfc3986-validator)"
