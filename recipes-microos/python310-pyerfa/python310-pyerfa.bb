...
RPROVIDES:${PN} += "python3-pyerfa python3.10dist(pyerfa) python310-pyerfa python310-pyerfa(aarch-64) python3dist(pyerfa)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) liberfa.so.1()(64bit) python(abi) python310-numpy"
