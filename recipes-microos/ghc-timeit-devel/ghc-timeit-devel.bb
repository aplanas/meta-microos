...
RPROVIDES:${PN} += "ghc-devel(timeit-2.0-8ewEVtFbCiRSME6yb7iQx) ghc-timeit-devel ghc-timeit-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-timeit"
