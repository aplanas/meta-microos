...
RPROVIDES:${PN} += "glade-catalog-gtkhtml glade-catalog-gtkhtml(aarch-64) libglade-gtkhtml-editor.so()(64bit)"
RDEPENDS:${PN} += "glade ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgtkhtml-editor-4_0-0"
