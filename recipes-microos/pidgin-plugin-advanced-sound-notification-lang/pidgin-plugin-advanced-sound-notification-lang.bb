...
RPROVIDES:${PN} += "locale(pidgin-plugin-advanced-sound-notification:de) locale(pidgin-plugin-advanced-sound-notification:es) locale(pidgin-plugin-advanced-sound-notification:fr) locale(pidgin-plugin-advanced-sound-notification:ru) locale(pidgin-plugin-advanced-sound-notification:tr) locale(pidgin-plugin-advanced-sound-notification:zh_CN) pidgin-plugin-advanced-sound-notification-lang pidgin-plugin-advanced-sound-notification-lang-all"
