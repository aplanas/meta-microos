...
RPROVIDES:${PN} += "ruby3.2-rubygem-unicode-display_width ruby3.2-rubygem-unicode-display_width(aarch-64) rubygem(ruby:3.2.0:unicode-display_width) rubygem(ruby:3.2.0:unicode-display_width:2) rubygem(ruby:3.2.0:unicode-display_width:2.3) rubygem(ruby:3.2.0:unicode-display_width:2.3.0) rubygem(unicode-display_width)"
