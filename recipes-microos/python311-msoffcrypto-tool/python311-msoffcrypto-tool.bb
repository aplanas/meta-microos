...
RPROVIDES:${PN} += "python3.11dist(msoffcrypto-tool) python311-msoffcrypto-tool python3dist(msoffcrypto-tool)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-cryptography python311-olefile python311-setuptools update-alternatives"
