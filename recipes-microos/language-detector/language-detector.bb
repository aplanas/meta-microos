...
RPROVIDES:${PN} += "language-detector mvn(com.optimaize.languagedetector:language-detector) mvn(com.optimaize.languagedetector:language-detector:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.google.guava:guava) mvn(com.intellij:annotations) mvn(org.slf4j:slf4j-api)"
