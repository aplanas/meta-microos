...
RPROVIDES:${PN} += "pkgconfig(xcb-image) xcb-util-image-devel xcb-util-image-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxcb-image0 pkgconfig(xcb) pkgconfig(xcb-shm)"
