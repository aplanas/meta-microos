...
RPROVIDES:${PN} += "libreoffice-thesaurus-en-GB locale(libreoffice:en_GB) locale(seamonkey-spellchecker:en_GB) myspell-british myspell-dictionary myspell-en_GB"
RDEPENDS:${PN} += "myspell-dictionaries myspell-en"
