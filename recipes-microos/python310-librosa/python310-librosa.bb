...
RPROVIDES:${PN} += "python3-librosa python3.10dist(librosa) python310-librosa python3dist(librosa)"
RDEPENDS:${PN} += "python(abi) python310-SoundFile python310-audioread python310-decorator python310-joblib python310-numba python310-numpy python310-packaging python310-pooch python310-resampy python310-scikit-learn python310-scipy"
