...
RPROVIDES:${PN} += "libqb-tests libqb-tests(aarch-64) libstat_wrapper.so.0()(64bit)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcheck.so.0()(64bit) libqb.so.100()(64bit)"
