...
RPROVIDES:${PN} += "python3.8dist(azure-cognitiveservices-knowledge-nspkg) python38-azure-cognitiveservices-knowledge-nspkg python3dist(azure-cognitiveservices-knowledge-nspkg)"
