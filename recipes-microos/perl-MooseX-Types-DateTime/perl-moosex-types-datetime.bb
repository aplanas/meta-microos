...
RPROVIDES:${PN} += "perl(MooseX::Types::DateTime) perl-MooseX-Types-DateTime"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DateTime) perl(DateTime::Duration) perl(DateTime::Locale) perl(DateTime::TimeZone) perl(Moose) perl(MooseX::Types) perl(MooseX::Types::Moose) perl(namespace::clean)"
