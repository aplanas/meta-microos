...
RPROVIDES:${PN} += "ruby3.2-rubygem-formatador ruby3.2-rubygem-formatador(aarch-64) rubygem(formatador) rubygem(ruby:3.2.0:formatador) rubygem(ruby:3.2.0:formatador:1) rubygem(ruby:3.2.0:formatador:1.1) rubygem(ruby:3.2.0:formatador:1.1.0)"
