...
RPROVIDES:${PN} += "libXcursor-devel libXcursor-devel(aarch-64) pkgconfig(xcursor)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXcursor1 pkgconfig(x11) pkgconfig(xfixes) pkgconfig(xproto) pkgconfig(xrender)"
