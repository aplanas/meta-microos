...
RPROVIDES:${PN} += "tex(topiclongtable.sty) texlive-topiclongtable"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(expl3.sty) tex(longtable.sty) tex(multirow.sty) tex(xparse.sty) tex(zref-abspage.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
