...
RPROVIDES:${PN} += "python3.11dist(coveralls-check) python311-coveralls-check python3dist(coveralls-check)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-backoff python311-requests python311-setuptools update-alternatives"
