...
RPROVIDES:${PN} += "python3.11dist(jenkinsapi) python311-jenkinsapi python3dist(jenkinsapi)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/python3.11 python(abi) python311-pytz python311-requests python311-six"
