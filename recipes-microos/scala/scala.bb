...
RPROVIDES:${PN} += "mvn(org.scala-lang:scala-compiler) mvn(org.scala-lang:scala-compiler:pom:) mvn(org.scala-lang:scala-library) mvn(org.scala-lang:scala-library:pom:) mvn(org.scala-lang:scala-reflect) mvn(org.scala-lang:scala-reflect:pom:) mvn(org.scala-lang:scalap) mvn(org.scala-lang:scalap:pom:) osgi(org.scala-ide.scala.compiler) osgi(org.scala-ide.scala.library) scala scala(aarch-64) scala-bootstrap"
RDEPENDS:${PN} += "/usr/bin/env jansi java-headless javapackages-filesystem javapackages-tools jline"
