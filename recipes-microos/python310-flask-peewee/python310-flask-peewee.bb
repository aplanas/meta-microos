...
RPROVIDES:${PN} += "python3-flask-peewee python3.10dist(flask-peewee) python310-flask-peewee python3dist(flask-peewee)"
RDEPENDS:${PN} += "python(abi) python310-Flask python310-Jinja2 python310-WTForms python310-Werkzeug python310-peewee python310-wtf-peewee"
