...
RPROVIDES:${PN} += "tex(dspblocks.sty) tex(dspfunctions.sty) tex(dsptricks.sty) texlive-dsptricks"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(fmtcount.sty) tex(fp.sty) tex(ifthen.sty) tex(pst-xkey.sty) tex(pstricks-add.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
