...
RPROVIDES:${PN} += "libcsync-plugin-sftp libcsync-plugin-sftp(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) libcsync.so.0()(64bit) libcsync0 libssh.so.4()(64bit) libssh.so.4(LIBSSH_4_5_0)(64bit)"
