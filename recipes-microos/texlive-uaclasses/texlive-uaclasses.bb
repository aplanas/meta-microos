...
RPROVIDES:${PN} += "tex(my-thesis.cls) tex(my-title.sty) tex(ua-thesis.cls) tex(ua-title.sty) texlive-uaclasses"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsbook.cls) tex(amsfonts.sty) tex(amsmath.sty) tex(amsthm.sty) tex(report.cls) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
