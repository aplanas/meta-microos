...
RPROVIDES:${PN} += "python3.9dist(google-cloud-storage) python39-google-cloud-storage python3dist(google-cloud-storage)"
RDEPENDS:${PN} += "python(abi) python39-google-api-core python39-google-auth python39-google-cloud-core python39-google-resumable-media python39-googleapis-common-protos python39-requests"
