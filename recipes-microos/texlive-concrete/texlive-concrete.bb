...
RPROVIDES:${PN} += "tex(cccsc10.tfm) tex(ccmi10.tfm) tex(ccmic9.tfm) tex(ccr10.tfm) tex(ccr5.tfm) tex(ccr6.tfm) tex(ccr7.tfm) tex(ccr8.tfm) tex(ccr9.tfm) tex(ccsl10.tfm) tex(ccsl9.tfm) tex(ccslc9.tfm) tex(ccti10.tfm) texlive-concrete"
