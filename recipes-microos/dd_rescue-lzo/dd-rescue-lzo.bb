...
RPROVIDES:${PN} += "dd_rescue-lzo dd_rescue-lzo(aarch-64) libddr_lzo.so()(64bit)"
RDEPENDS:${PN} += "dd_rescue ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) liblzo2.so.2()(64bit)"
