...
RPROVIDES:${PN} += "python3-ovsdbapp python3.10dist(ovsdbapp) python3dist(ovsdbapp)"
RDEPENDS:${PN} += "python(abi) python3-fixtures python3-netaddr python3-ovs python3-pbr python3-six"
