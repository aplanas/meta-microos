...
RPROVIDES:${PN} += "python3.11dist(booleanoperations) python311-booleanOperations python3dist(booleanoperations)"
RDEPENDS:${PN} += "python(abi) python311-FontTools python311-pyclipper"
