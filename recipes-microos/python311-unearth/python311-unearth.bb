...
RPROVIDES:${PN} += "python3.11dist(unearth) python311-unearth python3dist(unearth)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-packaging python311-requests update-alternatives"
