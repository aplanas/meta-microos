...
RPROVIDES:${PN} += "libsignon-glib-devel libsignon-glib-devel(aarch-64) pkgconfig(libsignon-glib)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libsignon-glib2 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0)"
