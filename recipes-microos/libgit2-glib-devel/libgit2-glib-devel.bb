...
RPROVIDES:${PN} += "libgit2-glib-devel libgit2-glib-devel(aarch-64) pkgconfig(libgit2-glib-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgit2-glib-1_0-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libgit2) typelib-1_0-Ggit-1_0"
