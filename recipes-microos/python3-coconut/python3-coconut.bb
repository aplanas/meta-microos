...
RPROVIDES:${PN} += "python3-coconut python3.10dist(coconut) python3dist(coconut)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Pygments python3-prompt_toolkit python3-pyparsing"
