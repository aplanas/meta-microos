...
RPROVIDES:${PN} += "perl(Task::Kensho::XML) perl-Task-Kensho-XML"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(XML::Generator::PerlData) perl(XML::LibXML) perl(XML::LibXSLT) perl(XML::SAX) perl(XML::SAX::Writer)"
