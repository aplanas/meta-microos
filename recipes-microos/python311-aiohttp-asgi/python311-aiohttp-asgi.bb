...
RPROVIDES:${PN} += "python3.11dist(aiohttp-asgi) python311-aiohttp-asgi python3dist(aiohttp-asgi)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-aiohttp"
