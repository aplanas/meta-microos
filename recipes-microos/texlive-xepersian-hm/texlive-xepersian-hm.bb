...
RPROVIDES:${PN} += "tex(xepersian-hm-common-kashida.tex) tex(xepersian-hm-kashida.tex) tex(xepersian-hm.sty) texlive-xepersian-hm"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(expl3.sty) tex(graphicx.sty) tex(l3keys2e.sty) tex(xcolor.sty) tex(xepersian.sty) tex(zref-savepos.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
