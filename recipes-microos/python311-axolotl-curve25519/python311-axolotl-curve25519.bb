...
RPROVIDES:${PN} += "python3.11dist(python-axolotl-curve25519) python311-axolotl-curve25519 python311-axolotl-curve25519(aarch-64) python3dist(python-axolotl-curve25519)"
