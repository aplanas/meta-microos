...
RPROVIDES:${PN} += "python3.9dist(unearth) python39-unearth python3dist(unearth)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-packaging python39-requests update-alternatives"
