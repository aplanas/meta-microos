...
RPROVIDES:${PN} += "python3-oslo.service python3.10dist(oslo.service) python3dist(oslo.service)"
RDEPENDS:${PN} += "python(abi) python3-Paste python3-PasteDeploy python3-Routes python3-WebOb python3-debtcollector python3-eventlet python3-fixtures python3-greenlet python3-oslo.concurrency python3-oslo.config python3-oslo.i18n python3-oslo.log python3-oslo.utils python3-yappi"
