...
RPROVIDES:${PN} += "libguestfsmod.cpython-310-aarch64-linux-gnu.so()(64bit) python3-libguestfs python3-libguestfs(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libguestfs libguestfs.so.0()(64bit) python(abi)"
