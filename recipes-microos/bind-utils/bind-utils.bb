...
RPROVIDES:${PN} += "bind-utils bind-utils(aarch-64) bind9-utils bindutil config(bind-utils) dns_utils libbind9-9.18.15.so()(64bit) libdns-9.18.15.so()(64bit) libirs-9.18.15.so()(64bit) libisc-9.18.15.so()(64bit) libisccc-9.18.15.so()(64bit) libisccfg-9.18.15.so()(64bit) libns-9.18.15.so()(64bit)"
