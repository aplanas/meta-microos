...
RPROVIDES:${PN} += "locale(libreoffice:de_DE) locale(seamonkey-spellchecker:de_DE) myspell-de_DE myspell-dictionary myspell-german"
RDEPENDS:${PN} += "myspell-de myspell-dictionaries"
