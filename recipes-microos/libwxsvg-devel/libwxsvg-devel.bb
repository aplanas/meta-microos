...
RPROVIDES:${PN} += "libwxsvg-devel libwxsvg-devel(aarch-64) pkgconfig(libwxsvg)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libwxsvg3 pkgconfig(expat) pkgconfig(libart-2.0) pkgconfig(libexif) pkgconfig(pango) wxGTK3-3_2-devel wxsvg"
