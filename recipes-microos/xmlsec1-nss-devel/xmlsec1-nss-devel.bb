...
RPROVIDES:${PN} += "pkgconfig(xmlsec1-nss) xmlsec1-nss-devel xmlsec1-nss-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxmlsec1-nss1 mozilla-nspr-devel mozilla-nss-devel pkgconfig(libxml-2.0) pkgconfig(libxslt) pkgconfig(nspr) pkgconfig(nss) xmlsec1-devel"
