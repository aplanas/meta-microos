...
RPROVIDES:${PN} += "ghc-hslua-list-prof ghc-hslua-list-prof(aarch-64) ghc-prof(hslua-list-1.1.1-9l63Ku7u96Z6i2wKz0R57A)"
RDEPENDS:${PN} += "ghc-hslua-list-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(hslua-core-2.3.1-S0Tmk0QBS1InOMEfkNHVC)"
