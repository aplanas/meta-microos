...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-search-nspkg) python311-azure-cognitiveservices-search-nspkg python3dist(azure-cognitiveservices-search-nspkg)"
