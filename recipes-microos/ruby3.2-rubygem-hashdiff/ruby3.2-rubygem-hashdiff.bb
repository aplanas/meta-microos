...
RPROVIDES:${PN} += "ruby3.2-rubygem-hashdiff ruby3.2-rubygem-hashdiff(aarch-64) rubygem(hashdiff) rubygem(ruby:3.2.0:hashdiff) rubygem(ruby:3.2.0:hashdiff:1) rubygem(ruby:3.2.0:hashdiff:1.0) rubygem(ruby:3.2.0:hashdiff:1.0.1)"
