...
RPROVIDES:${PN} += "libaccounts-glib-devel libaccounts-glib-devel(aarch-64) pkgconfig(libaccounts-glib)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libaccounts-glib0 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libxml-2.0) pkgconfig(sqlite3) python3-libaccounts typelib-1_0-Accounts-1_0"
