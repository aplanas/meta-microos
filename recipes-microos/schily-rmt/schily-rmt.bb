...
RPROVIDES:${PN} += "config(schily-rmt) rmt schily-rmt schily-rmt(aarch-64) star-rmt:/usr/bin/srmt"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdeflt.so.1.0()(64bit) libdeflt.so.1.0(SCHILY_1.0)(64bit) libschily.so.2.0()(64bit) libschily.so.2.0(SCHILY_1.0)(64bit) update-alternatives"
