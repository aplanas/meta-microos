...
RPROVIDES:${PN} += "libsecret-devel libsecret-devel(aarch-64) pkgconfig(libsecret-1) pkgconfig(libsecret-unstable)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libsecret-1-0 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(libgcrypt) pkgconfig(libsecret-1) typelib-1_0-Secret-1"
