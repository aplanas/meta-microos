...
RPROVIDES:${PN} += "ruby3.2-rubygem-nori ruby3.2-rubygem-nori(aarch-64) rubygem(nori) rubygem(ruby:3.2.0:nori) rubygem(ruby:3.2.0:nori:2) rubygem(ruby:3.2.0:nori:2.6) rubygem(ruby:3.2.0:nori:2.6.0)"
