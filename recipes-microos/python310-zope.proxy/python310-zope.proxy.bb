...
RPROVIDES:${PN} += "python3-zope.proxy python3.10dist(zope.proxy) python310-zope.proxy python310-zope.proxy(aarch-64) python3dist(zope.proxy)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-zope.interface"
