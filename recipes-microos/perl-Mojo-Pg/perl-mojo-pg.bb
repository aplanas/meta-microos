...
RPROVIDES:${PN} += "perl(Mojo::Pg) perl(Mojo::Pg::Database) perl(Mojo::Pg::Migrations) perl(Mojo::Pg::PubSub) perl(Mojo::Pg::Results) perl(Mojo::Pg::Transaction) perl-Mojo-Pg"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DBD::Pg) perl(Mojolicious) perl(SQL::Abstract::Pg)"
