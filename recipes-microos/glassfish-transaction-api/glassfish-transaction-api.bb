...
RPROVIDES:${PN} += "glassfish-transaction-api mvn(javax.transaction:javax.transaction-api) mvn(javax.transaction:javax.transaction-api:pom:) osgi(javax.transaction-api)"
