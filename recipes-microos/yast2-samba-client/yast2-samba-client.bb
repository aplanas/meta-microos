...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.SambaClient.desktop) metainfo() metainfo(org.opensuse.yast.SambaClient.metainfo.xml) perl(SambaAD) perl(SambaConfig) perl(SambaNetJoin) perl(SambaNmbLookup) perl(SambaWinbind) yast2-samba-client"
RDEPENDS:${PN} += "/usr/bin/perl perl-XML-LibXML yast2 yast2-network yast2-pam yast2-python3-bindings yast2-ruby-bindings"
