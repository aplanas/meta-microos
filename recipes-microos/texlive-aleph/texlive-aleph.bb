...
RPROVIDES:${PN} += "man(aleph.1) texlive-aleph"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(language.dat) tex(language.dat.lua) tex(language.def) texlive texlive-aleph-bin texlive-cm texlive-filesystem texlive-hyphen-base texlive-knuth-lib texlive-kpathsea texlive-kpathsea-bin texlive-lambda texlive-latex texlive-plain texlive-scripts texlive-scripts-bin"
