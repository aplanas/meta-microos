...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-gnome-gnome_basic patterns-gnome-gnome_basic(aarch-64)"
RDEPENDS:${PN} += "gsettings-backend-dconf pattern()"
