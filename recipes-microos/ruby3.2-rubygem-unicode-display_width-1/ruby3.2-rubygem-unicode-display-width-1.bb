...
RPROVIDES:${PN} += "ruby3.2-rubygem-unicode-display_width-1 ruby3.2-rubygem-unicode-display_width-1(aarch-64) rubygem(ruby:3.2.0:unicode-display_width) rubygem(ruby:3.2.0:unicode-display_width:1) rubygem(ruby:3.2.0:unicode-display_width:1.8) rubygem(ruby:3.2.0:unicode-display_width:1.8.0) rubygem(unicode-display_width)"
