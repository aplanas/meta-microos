...
RPROVIDES:${PN} += "python3.11dist(img2pdf) python311-img2pdf python3dist(img2pdf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Pillow python311-pdfrw python311-pikepdf python311-setuptools update-alternatives"
