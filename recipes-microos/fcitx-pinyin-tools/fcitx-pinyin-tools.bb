...
RPROVIDES:${PN} += "fcitx-pinyin-tools fcitx-pinyin-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libfcitx-config.so.4()(64bit) libfcitx-utils.so.0()(64bit)"
