...
RPROVIDES:${PN} += "gdk-pixbuf-xlib-devel gdk-pixbuf-xlib-devel(aarch-64) pkgconfig(gdk-pixbuf-xlib-2.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgdk_pixbuf_xlib-2_0-0 pkgconfig(gdk-pixbuf-2.0) pkgconfig(x11)"
