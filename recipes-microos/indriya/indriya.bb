...
RPROVIDES:${PN} += "indriya mvn(tech.units:indriya) mvn(tech.units:indriya:pom:) osgi(tech.units.indriya)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(javax.measure:unit-api) mvn(tech.uom.lib:uom-lib-common)"
