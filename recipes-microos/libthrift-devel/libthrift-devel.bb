...
RPROVIDES:${PN} += "libthrift-devel libthrift-devel(aarch-64) pkgconfig(thrift) pkgconfig(thrift-nb) pkgconfig(thrift-z) pkgconfig(thrift_c_glib)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libthrift-0_17_0 libthrift_c_glib0 libthriftnb-0_17_0 libthriftz-0_17_0 pkgconfig(glib-2.0) pkgconfig(gobject-2.0)"
