...
RPROVIDES:${PN} += "libxtwrapper.cpython-311-aarch64-linux-gnu.so()(64bit) python3.11dist(python-iptables) python311-iptables python311-iptables(aarch-64) python3dist(python-iptables)"
