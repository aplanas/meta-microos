...
RPROVIDES:${PN} += "ant-commons-net config(ant-commons-net) mvn(org.apache.ant:ant-commons-net) mvn(org.apache.ant:ant-commons-net:pom:)"
RDEPENDS:${PN} += "ant apache-commons-net java-headless javapackages-filesystem mvn(commons-net:commons-net) mvn(org.apache.ant:ant)"
