...
RPROVIDES:${PN} += "clucene-core-devel clucene-core-devel(aarch-64) pkgconfig(libclucene-core)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libclucene-contribs-lib1 libclucene-core1 libclucene-shared1 libstdc++-devel"
