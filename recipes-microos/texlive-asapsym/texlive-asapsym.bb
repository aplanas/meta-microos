...
RPROVIDES:${PN} += "tex(asapsym-generic.tex) tex(asapsym.code.tex) tex(asapsym.sty) texlive-asapsym"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontspec.sty) texlive texlive-asapsym-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
