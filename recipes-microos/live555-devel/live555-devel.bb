...
RPROVIDES:${PN} += "live555-devel live555-devel(aarch-64) pkgconfig(live555)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libBasicUsageEnvironment2 libUsageEnvironment3 libgroupsock30 libliveMedia107 pkgconfig pkgconfig(openssl)"
