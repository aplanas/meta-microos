...
RPROVIDES:${PN} += "tex(engpron-tools.sty) tex(engpron.sty) texlive-engpron"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(drac.sty) tex(fancyvrb.sty) tex(ifthen.sty) tex(tipa.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
