...
RPROVIDES:${PN} += "tex(EpiOlmec.tfm) tex(epiolmec.map) tex(epiolmec.sty) texlive-epiolmec"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-epiolmec-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
