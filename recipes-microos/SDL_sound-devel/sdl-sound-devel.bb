...
RPROVIDES:${PN} += "SDL_sound-devel SDL_sound-devel(aarch-64) libSDL_sound-devel"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libSDL-1.2.so.0()(64bit) libSDL_sound-1.0.so.1()(64bit) libSDL_sound-1_0-1 libc.so.6(GLIBC_2.34)(64bit) pkgconfig(sdl)"
