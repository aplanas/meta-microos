...
RPROVIDES:${PN} += "tex(errorbars.tex) tex(latexpicobjs.tex) tex(piccorr.sty) tex(picmore.tex) tex(pictex.sty) tex(pictex.tex) tex(pictexwd.sty) tex(pictexwd.tex) tex(pointers.tex) tex(postpictex.tex) tex(prepictex.tex) tex(texpictex.tex) tex(tree.sty) texlive-pictex"
