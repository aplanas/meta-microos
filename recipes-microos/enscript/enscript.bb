...
RPROVIDES:${PN} += "config(enscript) enscript enscript(aarch-64) genscript nenscrip"
RDEPENDS:${PN} += "/bin/bash /bin/sed /bin/sh /usr/bin/file /usr/bin/iconv /usr/bin/perl ghostscript-fonts-std glibc-locale ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit)"
