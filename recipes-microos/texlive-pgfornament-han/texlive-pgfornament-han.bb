...
RPROVIDES:${PN} += "tex(beamerthemeHeavenlyClouds.sty) tex(beamerthemeXiaoshan.sty) tex(cncolours.sty) tex(pgflibraryhan.code.tex) tex(pgfornament-han.sty) texlive-pgfornament-han"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(needspace.sty) tex(pgfmath.sty) tex(pgfornament.sty) tex(tikz.sty) tex(xcolor.sty) tex(xpatch.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
