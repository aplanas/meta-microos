...
RPROVIDES:${PN} += "tex(easyfloats.sty) texlive-easyfloats"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(booktabs.sty) tex(caption.sty) tex(environ.sty) tex(etoolbox.sty) tex(float.sty) tex(graphbox.sty) tex(graphicx.sty) tex(longtable.sty) tex(pgfkeys.sty) tex(subcaption.sty) texlive texlive-caption texlive-environ texlive-etoolbox texlive-filesystem texlive-float texlive-kpathsea texlive-kpathsea-bin texlive-pgf texlive-scripts texlive-scripts-bin"
