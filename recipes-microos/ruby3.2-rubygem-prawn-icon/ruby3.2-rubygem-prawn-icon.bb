...
RPROVIDES:${PN} += "ruby3.2-rubygem-prawn-icon ruby3.2-rubygem-prawn-icon(aarch-64) rubygem(prawn-icon) rubygem(ruby:3.2.0:prawn-icon) rubygem(ruby:3.2.0:prawn-icon:3) rubygem(ruby:3.2.0:prawn-icon:3.1) rubygem(ruby:3.2.0:prawn-icon:3.1.0)"
