...
RPROVIDES:${PN} += "gtk2-immodule-tigrigna gtk2-immodule-tigrigna(aarch-64) gtk2-immodules-tigrigna locale(gtk2:ti)"
RDEPENDS:${PN} += "/bin/sh gtk2 gtk2-tools libc.so.6(GLIBC_2.17)(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit)"
