...
RPROVIDES:${PN} += "python3.9dist(translation-finder) python39-translation-finder python3dist(translation-finder)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-ruamel.yaml python39-setuptools python39-weblate-language-data update-alternatives"
