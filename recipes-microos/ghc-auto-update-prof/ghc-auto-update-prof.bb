...
RPROVIDES:${PN} += "ghc-auto-update-prof ghc-auto-update-prof(aarch-64) ghc-prof(auto-update-0.1.6-CObek7rRQnGB5D6p02bNzQ)"
RDEPENDS:${PN} += "ghc-auto-update-devel ghc-prof(base-4.17.1.0)"
