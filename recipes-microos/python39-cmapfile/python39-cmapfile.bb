...
RPROVIDES:${PN} += "python3.9dist(cmapfile) python39-cmapfile python3dist(cmapfile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-h5py python39-numpy python39-oiffile python39-scipy python39-tifffile update-alternatives"
