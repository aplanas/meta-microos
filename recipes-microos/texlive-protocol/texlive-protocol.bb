...
RPROVIDES:${PN} += "tex(protocol.cls) texlive-protocol"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(scrartcl.cls) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
