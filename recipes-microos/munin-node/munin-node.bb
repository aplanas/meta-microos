...
RPROVIDES:${PN} += "config(munin-node) munin-node perl(Munin::Common::Config) perl(Munin::Common::Daemon) perl(Munin::Common::Defaults) perl(Munin::Common::DictFile) perl(Munin::Common::SyncDictFile) perl(Munin::Common::TLS) perl(Munin::Common::TLSClient) perl(Munin::Common::TLSServer) perl(Munin::Common::Timeout) perl(Munin::Node::Config) perl(Munin::Node::Configure::Debug) perl(Munin::Node::Configure::History) perl(Munin::Node::Configure::HostEnumeration) perl(Munin::Node::Configure::Plugin) perl(Munin::Node::Configure::PluginList) perl(Munin::Node::Logger) perl(Munin::Node::OS) perl(Munin::Node::SNMPConfig) perl(Munin::Node::Server) perl(Munin::Node::Service) perl(Munin::Node::Session) perl(Munin::Node::SpoolReader) perl(Munin::Node::SpoolWriter) perl(Munin::Node::Utils) perl(Munin::Plugin) perl(Munin::Plugin::Pgsql) perl(Munin::Plugin::SNMP)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/perl /usr/bin/python3 /usr/bin/ruby group(nobody) group(www) perl-HTML-Template perl-Log-Log4perl perl-Net-SNMP perl-Net-SSLeay perl-Net-Server perl-base perl-libwww-perl ps python ruby shadow sysstat user(nobody)"
