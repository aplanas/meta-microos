...
RDEPENDS:${PN} += "(python39-jsonschema >= 4.0.1 with python39-jsonschema < 4.18) /bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-asdf-standard python39-asdf-transform-schemas python39-asdf-unit-schemas python39-importlib-metadata python39-jmespath python39-numpy python39-packaging python39-semantic_version update-alternatives"
