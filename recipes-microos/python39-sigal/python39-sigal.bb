...
RPROVIDES:${PN} += "python3.9dist(sigal) python39-sigal python3dist(sigal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Jinja2 python39-Markdown python39-Pillow python39-blinker python39-click python39-natsort python39-pilkit update-alternatives"
