...
RPROVIDES:${PN} += "libavahi-qt5-devel libavahi-qt5-devel(aarch-64) pkgconfig(avahi-qt5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libavahi-devel libavahi-qt5-1 pkgconfig(Qt5Core)"
