...
RPROVIDES:${PN} += "tex(fixme.sty) tex(fxenvlayoutcolor.sty) tex(fxenvlayoutcolorsig.sty) tex(fxlayoutmarginnote.sty) tex(fxlayoutpdfcmargin.sty) tex(fxlayoutpdfcnote.sty) tex(fxlayoutpdfcsigmargin.sty) tex(fxlayoutpdfcsignote.sty) tex(fxlayoutpdfmargin.sty) tex(fxlayoutpdfnote.sty) tex(fxlayoutpdfsigmargin.sty) tex(fxlayoutpdfsignote.sty) tex(fxtargetlayoutchangebar.sty) tex(fxtargetlayoutcolor.sty) tex(fxtargetlayoutcolorcb.sty) tex(fxthemecolor.sty) tex(fxthemecolorsig.sty) tex(fxthemesignature.sty) texlive-fixme"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(changebar.sty) tex(color.sty) tex(ifthen.sty) tex(marginnote.sty) tex(pdfcomment.sty) tex(verbatim.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
