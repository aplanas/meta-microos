...
RPROVIDES:${PN} += "perl(JSON::DWIW) perl(JSON::DWIW::Boolean) perl(JSON::DWIW::Exporter) perl-JSON-DWIW perl-JSON-DWIW(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) perl(:MODULE_COMPAT_5.36.0)"
