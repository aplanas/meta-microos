...
RPROVIDES:${PN} += "python3.11dist(urwid) python311-urwid python311-urwid(aarch-64) python3dist(urwid)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-curses"
