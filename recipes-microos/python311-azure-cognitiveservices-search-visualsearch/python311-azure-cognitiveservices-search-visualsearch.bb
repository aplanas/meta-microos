...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-search-visualsearch) python311-azure-cognitiveservices-search-visualsearch python3dist(azure-cognitiveservices-search-visualsearch)"
