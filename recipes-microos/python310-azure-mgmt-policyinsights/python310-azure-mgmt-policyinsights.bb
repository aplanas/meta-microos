...
RPROVIDES:${PN} += "python3-azure-mgmt-policyinsights python3.10dist(azure-mgmt-policyinsights) python310-azure-mgmt-policyinsights python3dist(azure-mgmt-policyinsights)"
