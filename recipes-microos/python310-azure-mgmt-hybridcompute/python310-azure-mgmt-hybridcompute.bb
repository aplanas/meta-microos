...
RPROVIDES:${PN} += "python3-azure-mgmt-hybridcompute python3.10dist(azure-mgmt-hybridcompute) python310-azure-mgmt-hybridcompute python3dist(azure-mgmt-hybridcompute)"
