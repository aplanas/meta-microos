...
RPROVIDES:${PN} += "python3-matplotlib-cairo python310-matplotlib-cairo python310-matplotlib-cairo(aarch-64)"
RDEPENDS:${PN} += "python(abi) python310-cairo python310-matplotlib"
