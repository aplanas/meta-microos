...
RPROVIDES:${PN} += "python3-myst-parser python3.10dist(myst-parser) python310-myst-parser python3dist(myst-parser)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Jinja2 python310-PyYAML python310-Sphinx python310-docutils python310-markdown-it-py python310-mdit-py-plugins python310-typing-extensions update-alternatives"
