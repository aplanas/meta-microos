...
RPROVIDES:${PN} += "python3.9dist(micropipenv) python39-micropipenv python3dist(micropipenv)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-pip update-alternatives"
