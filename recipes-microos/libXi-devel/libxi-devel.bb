...
RPROVIDES:${PN} += "libXi-devel libXi-devel(aarch-64) libXi6-devel pkgconfig(xi)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXi6 pkgconfig(inputproto) pkgconfig(x11) pkgconfig(xext) pkgconfig(xfixes)"
