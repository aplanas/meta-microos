...
RDEPENDS:${PN} += "(python311-jsonschema >= 4.0.1 with python311-jsonschema < 4.18) /bin/sh /usr/bin/python3.11 python(abi) python311-PyYAML python311-asdf-standard python311-asdf-transform-schemas python311-asdf-unit-schemas python311-importlib-metadata python311-jmespath python311-numpy python311-packaging python311-semantic_version update-alternatives"
