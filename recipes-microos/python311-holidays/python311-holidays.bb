...
RPROVIDES:${PN} += "python3.11dist(holidays) python311-holidays python3dist(holidays)"
RDEPENDS:${PN} += "python(abi) python311-convertdate python311-hijri-converter python311-korean-lunar-calendar python311-python-dateutil"
