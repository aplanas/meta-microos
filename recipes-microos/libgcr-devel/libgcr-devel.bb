...
RPROVIDES:${PN} += "libgcr-devel libgcr-devel(aarch-64) pkgconfig(gcr-4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgcr-4-4 pkgconfig(gck-2) pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(p11-kit-1) typelib-1_0-Gcr-4"
