...
RPROVIDES:${PN} += "tex(ftnb8z.tfm) tex(ftnbi8z.tfm) tex(ftni8z.tfm) tex(ftnr8z.tfm) tex(norasi-c90.map) texlive-norasi-c90"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-fonts-tlwg texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
