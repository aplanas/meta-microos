...
RPROVIDES:${PN} += "python3.9dist(pytest-xprocess) python39-pytest-xprocess python3dist(pytest-xprocess)"
RDEPENDS:${PN} += "python(abi) python39-psutil python39-py python39-pytest"
