...
RPROVIDES:${PN} += "python3.9dist(meson-python) python39-meson-python python3dist(meson-python)"
RDEPENDS:${PN} += "meson python(abi) python39-pyproject-metadata python39-tomli python39-typing-extensions"
