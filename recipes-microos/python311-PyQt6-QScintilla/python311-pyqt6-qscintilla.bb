...
RPROVIDES:${PN} += "python3.11dist(pyqt6-qscintilla) python311-PyQt6-QScintilla python311-PyQt6-QScintilla(aarch-64) python311-qscintilla-qt6 python3dist(pyqt6-qscintilla)"
