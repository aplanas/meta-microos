...
RPROVIDES:${PN} += "tex(plarray.sty) tex(pldocverb.sty) tex(plextarray.sty) tex(plextcolortbl.sty) tex(plextdelarray.sty) tex(pxatbegshi.sty) tex(pxeverysel.sty) tex(pxeveryshi.sty) tex(pxftnright.sty) tex(pxmulticol.sty) tex(pxxspace.sty) texlive-platex-tools"
