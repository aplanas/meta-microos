...
RPROVIDES:${PN} += "desktop-file-utils desktop-file-utils(aarch-64) rpm_macro(desktop_database_post) rpm_macro(desktop_database_postun)"
RDEPENDS:${PN} += "/bin/sh aaa_base awk coreutils ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit)"
