...
RPROVIDES:${PN} += "pkgconfig(xcb-xrm) xcb-util-xrm-devel xcb-util-xrm-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxcb-xrm0 pkgconfig(xcb) pkgconfig(xcb-aux)"
