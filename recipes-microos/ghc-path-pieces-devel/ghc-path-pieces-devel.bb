...
RPROVIDES:${PN} += "ghc-devel(path-pieces-0.2.1-7L2E0FvnHzn1hGutNz0iw4) ghc-path-pieces-devel ghc-path-pieces-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(text-2.0.2) ghc-devel(time-1.12.2) ghc-path-pieces"
