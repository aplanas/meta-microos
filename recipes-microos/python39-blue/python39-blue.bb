...
RPROVIDES:${PN} += "python3.9dist(blue) python39-blue python3dist(blue)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-black python39-flake8 update-alternatives"
