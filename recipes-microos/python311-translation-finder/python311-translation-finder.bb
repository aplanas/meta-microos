...
RPROVIDES:${PN} += "python3.11dist(translation-finder) python311-translation-finder python3dist(translation-finder)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-ruamel.yaml python311-setuptools python311-weblate-language-data update-alternatives"
