...
RPROVIDES:${PN} += "libwmf-devel libwmf-devel(aarch-64) mswordvd:/usr/lib/libwmf.a pkgconfig(libwmf) wv-devel:/usr/lib/libwmf.a"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libwmf-0_2-7 libwmf-gnome pkgconfig(freetype2) pkgconfig(x11) pkgconfig(xproto) pkgconfig(zlib)"
