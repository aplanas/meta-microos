...
RPROVIDES:${PN} += "libopenblas-pthreads-gnu-hpc-devel libopenblas-pthreads-gnu-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh libopenblas-pthreads_0_3_21-gnu-hpc-devel"
