...
RPROVIDES:${PN} += "config(iwatch) iwatch"
RDEPENDS:${PN} += "/usr/bin/perl perl-Event perl-Linux-Inotify2 perl-Mail-Sendmail perl-XML-LibXML perl-XML-SimpleObject-LibXML"
