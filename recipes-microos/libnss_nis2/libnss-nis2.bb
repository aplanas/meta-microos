...
RPROVIDES:${PN} += "glibc:/lib64/libnss_nis.so.2 libnss_nis.so.2()(64bit) libnss_nis.so.2(NSS_NIS_PRIVATE_2.0)(64bit) libnss_nis2 libnss_nis2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libnsl.so.3()(64bit) libnsl.so.3(LIBNSL_2.0)(64bit)"
