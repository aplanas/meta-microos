...
RPROVIDES:${PN} += "tex(a4.sty) tex(artikel1.cls) tex(artikel2.cls) tex(artikel3.cls) tex(boek.cls) tex(boek3.cls) tex(brief.cls) tex(ntg10.clo) tex(ntg11.clo) tex(ntg12.clo) tex(rapport1.cls) tex(rapport3.cls) texlive-ntgclass"
