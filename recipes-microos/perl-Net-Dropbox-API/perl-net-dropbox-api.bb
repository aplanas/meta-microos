...
RPROVIDES:${PN} += "perl(Net::Dropbox::API) perl-Net-Dropbox-API"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Data::Random) perl(HTTP::Request::Common) perl(JSON) perl(LWP::UserAgent) perl(Mouse) perl(Net::OAuth) perl(URI) perl(common::sense)"
