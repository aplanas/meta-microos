...
RPROVIDES:${PN} += "perl(Test2::Event::Warning) perl(Test2::Plugin::NoWarnings) perl-Test2-Plugin-NoWarnings"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Test2) perl(Test2::API) perl(Test2::Event) perl(Test2::Util::HashBase) perl(parent)"
