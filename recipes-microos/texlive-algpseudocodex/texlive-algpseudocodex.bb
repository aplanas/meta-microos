...
RPROVIDES:${PN} += "tex(algpseudocodex.sty) texlive-algpseudocodex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(algorithmicx.sty) tex(etoolbox.sty) tex(fifo-stack.sty) tex(kvoptions.sty) tex(tabto.sty) tex(tikz.sty) tex(totcount.sty) tex(varwidth.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
