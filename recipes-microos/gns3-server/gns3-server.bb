...
RPROVIDES:${PN} += "gns3-server python3.10dist(gns3-server) python3dist(gns3-server)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 /usr/bin/python3.10 busybox cpulimit docker dynamips iouyap python(abi) python3-Jinja2 python3-aiofiles python3-aiohttp python3-aiohttp_cors python3-async_timeout python3-distro python3-jsonschema python3-psutil python3-py-cpuinfo python3-sentry-sdk qemu shadow ubridge vpcs wireshark"
