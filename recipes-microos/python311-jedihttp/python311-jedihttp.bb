...
RPROVIDES:${PN} += "python3.11dist(jedihttp) python311-jedihttp python3dist(jedihttp)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-bottle python311-jedi python311-waitress update-alternatives"
