...
RPROVIDES:${PN} += "monitoring-plugins-ifoperstatus monitoring-plugins-ifoperstatus(aarch-64) nagios-plugins-ifoperstatus"
RDEPENDS:${PN} += "/usr/bin/perl monitoring-plugins-common perl-Net-SNMP"
