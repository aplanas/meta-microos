...
RPROVIDES:${PN} += "tex(iexec.sty) texlive-iexec"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(expl3.sty) tex(pgfkeys.sty) tex(shellesc.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-tools texlive-xkeyval"
