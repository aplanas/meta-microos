...
RDEPENDS:${PN} += "/bin/bash /usr/bin/env crypto-policies ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libcrypto.so.3(OPENSSL_3.0.3)(64bit) libcrypto.so.3(OPENSSL_3.0.9)(64bit) libopenssl3 libssl.so.3()(64bit) libssl.so.3(OPENSSL_3.0.0)(64bit) openssl"
