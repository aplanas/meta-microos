...
RPROVIDES:${PN} += "ruby3.2-rubygem-cfa_grub2 ruby3.2-rubygem-cfa_grub2(aarch-64) rubygem(cfa_grub2) rubygem(ruby:3.2.0:cfa_grub2) rubygem(ruby:3.2.0:cfa_grub2:2) rubygem(ruby:3.2.0:cfa_grub2:2.0) rubygem(ruby:3.2.0:cfa_grub2:2.0.0)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:cfa:1)"
