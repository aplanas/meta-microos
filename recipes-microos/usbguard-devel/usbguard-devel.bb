...
RPROVIDES:${PN} += "pkgconfig(libusbguard) usbguard-devel usbguard-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libstdc++-devel libusbguard1 pkgconfig pkgconfig(libqb) usbguard"
