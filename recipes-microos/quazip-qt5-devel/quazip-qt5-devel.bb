...
RPROVIDES:${PN} += "cmake(QuaZip-Qt5) libquazip-qt5-devel pkgconfig(quazip1-qt5) quazip-devel quazip-qt5-devel quazip-qt5-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config cmake(Qt5Core) libquazip1-qt5-1_4_0 pkgconfig(Qt5Core) pkgconfig(bzip2) pkgconfig(zlib)"
