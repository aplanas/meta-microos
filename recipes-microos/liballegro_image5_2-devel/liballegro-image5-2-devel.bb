...
RPROVIDES:${PN} += "liballegro_image5_2-devel liballegro_image5_2-devel(aarch-64) pkgconfig(allegro_image-5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liballegro_image5_2 pkgconfig(allegro-5)"
