...
RPROVIDES:${PN} += "python3-morecvutils python3.10dist(morecvutils) python3dist(morecvutils)"
RDEPENDS:${PN} += "/usr/bin/python3 ffmpeg gstreamer-plugins-good python(abi) python3-imageio python3-imageio-ffmpeg python3-numpy python3-opencv"
