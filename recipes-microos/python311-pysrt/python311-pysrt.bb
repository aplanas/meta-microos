...
RPROVIDES:${PN} += "python3.11dist(pysrt) python311-pysrt python3dist(pysrt)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-chardet update-alternatives"
