...
RPROVIDES:${PN} += "config(nfdump) nfdump nfdump(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcurl.so.4()(64bit) libnfdump-1.7.1.so()(64bit) librrd.so.8()(64bit) rrdtool"
