...
RPROVIDES:${PN} += "python3.11dist(requirements-detector) python311-requirements-detector python3dist(requirements-detector)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-astroid update-alternatives"
