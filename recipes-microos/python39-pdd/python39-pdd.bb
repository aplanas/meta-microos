...
RPROVIDES:${PN} += "python3.9dist(pdd) python39-pdd python3dist(pdd)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-python-dateutil python39-setuptools update-alternatives"
