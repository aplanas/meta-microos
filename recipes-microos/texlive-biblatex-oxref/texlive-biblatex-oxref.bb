...
RPROVIDES:${PN} += "tex(american-oxref.lbx) tex(british-oxref.lbx) tex(english-oxref.lbx) tex(oxalph.bbx) tex(oxalph.cbx) tex(oxnotes-ibid.bbx) tex(oxnotes-ibid.cbx) tex(oxnotes-inote.bbx) tex(oxnotes-inote.cbx) tex(oxnotes-note.bbx) tex(oxnotes-note.cbx) tex(oxnotes-trad1.bbx) tex(oxnotes-trad1.cbx) tex(oxnotes-trad2.bbx) tex(oxnotes-trad2.cbx) tex(oxnotes-trad3.bbx) tex(oxnotes-trad3.cbx) tex(oxnotes.bbx) tex(oxnotes.cbx) tex(oxnum.bbx) tex(oxnum.cbx) tex(oxref.bbx) tex(oxyear.bbx) tex(oxyear.cbx) texlive-biblatex-oxref"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(alphabetic.cbx) tex(authoryear-comp.cbx) tex(english.lbx) tex(etoolbox.sty) tex(graphicx.sty) tex(numeric-comp.cbx) tex(standard.bbx) tex(verbose-ibid.cbx) tex(verbose-inote.cbx) tex(verbose-note.cbx) tex(verbose-trad1.cbx) tex(verbose-trad2.cbx) tex(verbose-trad3.cbx) tex(verbose.cbx) tex(xpatch.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
