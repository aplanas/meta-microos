...
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 /usr/bin/sh clang-devel ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) libjson-glib-1.0.so.0()(64bit) libjson-glib-1.0.so.0(libjson-glib-1.0.so.0)(64bit) libxml2.so.2()(64bit) libxml2.so.2(LIBXML2_2.4.30)(64bit) libxml2.so.2(LIBXML2_2.6.0)(64bit) libxml2.so.2(LIBXML2_2.7.3)(64bit) llvm-devel python(abi) python310-PyYAML python310-appdirs python310-cchardet python310-dbus-deviation python310-feedgen python310-lxml python310-networkx python310-pkgconfig python310-schema python310-toposort python310-wheezy.template update-alternatives"
