...
RPROVIDES:${PN} += "collectd-web config(collectd-web)"
RDEPENDS:${PN} += "/usr/bin/perl apache2 perl perl(CGI) perl(Data::Dumper) perl(HTML::Entities) perl(RRDs) perl(URI::Escape) rrdtool"
