...
RPROVIDES:${PN} += "gtksourceview-devel gtksourceview-devel(aarch-64) pkgconfig(gtksourceview-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgtksourceview-3_0-1 libgtksourceview3 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gtk+-3.0) pkgconfig(libxml-2.0) typelib-1_0-GtkSource-3_0"
