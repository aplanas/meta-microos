...
RPROVIDES:${PN} += "libpcap-devel libpcap-devel(aarch-64) pkgconfig(libpcap)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config glibc-devel libpcap1 pkgconfig(dbus-1) pkgconfig(libnl-genl-3.0)"
