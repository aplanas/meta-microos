...
RPROVIDES:${PN} += "pkgconfig(Qt6Qwt6) qwt6-qt6-devel qwt6-qt6-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config freetype2-devel gcc-c++ libqwt6-qt6-6_2 pkgconfig(Qt6Concurrent) pkgconfig(Qt6OpenGL) pkgconfig(Qt6PrintSupport) pkgconfig(Qt6Svg) pkgconfig(Qt6Widgets) pkgconfig(libpng)"
