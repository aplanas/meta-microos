...
RPROVIDES:${PN} += "tex(arsclassica.sty) texlive-arsclassica"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(caption.sty) tex(classicthesis.sty) tex(soul.sty) tex(titlesec.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
