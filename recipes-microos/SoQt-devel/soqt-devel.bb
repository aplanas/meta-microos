...
RPROVIDES:${PN} += "SoQt-devel SoQt-devel(aarch-64) cmake(soqt) pkgconfig(SoQt)"
RDEPENDS:${PN} += "/usr/bin/pkg-config cmake(Qt5Gui) cmake(Qt5OpenGL) cmake(Qt5Widgets) cmake(coin) libSoQt20 libpng-devel pkgconfig(Coin) pkgconfig(Qt5Core) pkgconfig(Qt5Gui) pkgconfig(Qt5OpenGL) pkgconfig(Qt5Widgets)"
