...
RPROVIDES:${PN} += "in-toto python3.10dist(in-toto) python3dist(in-toto)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-attrs python3-iso8601 python3-pathspec python3-python-dateutil python3-securesystemslib"
