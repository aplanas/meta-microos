...
RPROVIDES:${PN} += "tex(pageslts.sty) texlive-pageslts"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(alphalph.sty) tex(atveryend.sty) tex(everyshi.sty) tex(kvoptions.sty) tex(letltxmacro.sty) tex(ltxcmds.sty) tex(rerunfilecheck.sty) tex(undolabl.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
