...
RPROVIDES:${PN} += "typelib(AppStreamGlib) typelib-1_0-AppStreamGlib-1_0 typelib-1_0-AppStreamGlib-1_0(aarch-64)"
RDEPENDS:${PN} += "libappstream-glib.so.8()(64bit) typelib(GLib) typelib(GModule) typelib(GObject) typelib(GdkPixbuf) typelib(Gio)"
