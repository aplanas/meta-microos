...
RPROVIDES:${PN} += "python3.11dist(lazy-object-proxy) python311-lazy-object-proxy python311-lazy-object-proxy(aarch-64) python311-lazy_object_proxy python3dist(lazy-object-proxy)"
