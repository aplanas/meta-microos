...
RPROVIDES:${PN} += "libglib-testing-devel libglib-testing-devel(aarch-64) pkgconfig(glib-testing-0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libglib-testing-0-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0)"
