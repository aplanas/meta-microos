...
RPROVIDES:${PN} += "ruby3.2-rubygem-delayed_job ruby3.2-rubygem-delayed_job(aarch-64) rubygem(delayed_job) rubygem(ruby:3.2.0:delayed_job) rubygem(ruby:3.2.0:delayed_job:4) rubygem(ruby:3.2.0:delayed_job:4.1) rubygem(ruby:3.2.0:delayed_job:4.1.11)"
