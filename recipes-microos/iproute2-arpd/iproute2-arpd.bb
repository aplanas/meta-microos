...
RPROVIDES:${PN} += "iproute2-arpd iproute2-arpd(aarch-64) iproute2:/usr/sbin/arpd"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdb-4.8.so()(64bit)"
