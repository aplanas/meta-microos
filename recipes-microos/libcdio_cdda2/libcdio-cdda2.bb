...
RPROVIDES:${PN} += "libcdio_cdda.so.2()(64bit) libcdio_cdda.so.2(CDIO_CDDA_2)(64bit) libcdio_cdda2 libcdio_cdda2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libcdio.so.19()(64bit) libcdio.so.19(CDIO_19)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit)"
