...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-devel-java-devel_java patterns-devel-java-devel_java(aarch-64)"
RDEPENDS:${PN} += ""
