...
RPROVIDES:${PN} += "libpinyin-devel libpinyin-devel(aarch-64) libzhuyin-devel pkgconfig(libpinyin) pkgconfig(libzhuyin)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libpinyin-tools libpinyin15 libzhuyin15 pkgconfig(glib-2.0)"
