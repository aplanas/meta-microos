...
RPROVIDES:${PN} += "ghc-mountpoints-prof ghc-mountpoints-prof(aarch-64) ghc-prof(mountpoints-1.0.2-1s316lA2PKMJiFY8pZCQYD)"
RDEPENDS:${PN} += "ghc-mountpoints-devel ghc-prof(base-4.17.1.0)"
