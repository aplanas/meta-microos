...
RPROVIDES:${PN} += "libcsironn.so.0()(64bit) libcsironn0 libcsironn0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.35)(64bit) libqhull_r.so.8.0()(64bit)"
