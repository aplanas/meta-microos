...
RPROVIDES:${PN} += "python3.9dist(labels) python39-labels python3dist(labels)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-attrs python39-click python39-pytoml python39-requests update-alternatives"
