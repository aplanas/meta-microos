...
RPROVIDES:${PN} += "tex(frletter.cls) texlive-frletter"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(letter.cls) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
