...
RPROVIDES:${PN} += "python3.11dist(goosempl) python311-GooseMPL python3dist(goosempl)"
RDEPENDS:${PN} += "python(abi) python311-PyYAML python311-deprecation python311-matplotlib python311-matplotlib-latex python311-numpy python311-scipy texlive-amsfonts texlive-amsmath texlive-tools"
