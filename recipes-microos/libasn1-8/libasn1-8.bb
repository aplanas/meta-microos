...
RPROVIDES:${PN} += "libasn1-8 libasn1-8(aarch-64) libasn1.so.8()(64bit) libasn1.so.8(HEIMDAL_ASN1_1.0)(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcom_err.so.2()(64bit) libroken.so.18()(64bit) libroken.so.18(HEIMDAL_ROKEN_1.0)(64bit)"
