...
RPROVIDES:${PN} += "config(gtk2-immodule-multipress) gtk2-immodule-multipress gtk2-immodule-multipress(aarch-64)"
RDEPENDS:${PN} += "/bin/sh gtk2 gtk2-tools libc.so.6(GLIBC_2.17)(64bit) libgdk-x11-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit) libpango-1.0.so.0()(64bit)"
