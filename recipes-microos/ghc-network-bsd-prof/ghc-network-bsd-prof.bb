...
RPROVIDES:${PN} += "ghc-network-bsd-prof ghc-network-bsd-prof(aarch-64) ghc-prof(network-bsd-2.8.1.0-D1RjTzX7Byx4U4fOdbAEll)"
RDEPENDS:${PN} += "ghc-network-bsd-devel ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(network-3.1.2.8-HNDBp0HF6t0D1fzE2MDtPd)"
