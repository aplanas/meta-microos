...
RPROVIDES:${PN} += "libbcmatroska2-0 libbcmatroska2-0(aarch-64) libbcmatroska2.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbctoolbox.so.1()(64bit) libc.so.6(GLIBC_2.33)(64bit)"
