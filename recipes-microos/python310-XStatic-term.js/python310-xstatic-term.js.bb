...
RPROVIDES:${PN} += "python3-XStatic-term.js python3.10dist(xstatic-term.js) python310-XStatic-term.js python310-XStatic-term.js(aarch-64) python3dist(xstatic-term.js)"
