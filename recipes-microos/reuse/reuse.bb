...
RPROVIDES:${PN} += "python3.10dist(reuse) python3dist(reuse) reuse reuse(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3.10 python(abi) python3 python3-Jinja2 python3-binaryornot python3-boolean.py python3-debian python3-license-expression python3-setuptools"
