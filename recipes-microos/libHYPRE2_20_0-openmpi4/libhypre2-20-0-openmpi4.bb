...
RPROVIDES:${PN} += "libHYPRE.so.2.20.0()(64bit) libHYPRE2_20_0-openmpi4 libHYPRE2_20_0-openmpi4(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libmpi.so.40()(64bit)"
