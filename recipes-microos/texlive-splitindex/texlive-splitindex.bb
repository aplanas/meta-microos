...
RPROVIDES:${PN} += "tex(splitidx.sty) tex(splitindex.tex) texlive-splitindex"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl /usr/bin/texlua coreutils ed findutils grep perl(Getopt::Long) perl(strict) sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-splitindex-bin"
