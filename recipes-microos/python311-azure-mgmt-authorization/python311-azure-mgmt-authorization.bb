...
RPROVIDES:${PN} += "python3.11dist(azure-mgmt-authorization) python311-azure-mgmt-authorization python3dist(azure-mgmt-authorization)"
RDEPENDS:${PN} += "python(abi) python311-azure-common python311-azure-mgmt-core python311-azure-nspkg python311-msrest"
