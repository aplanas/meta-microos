...
RPROVIDES:${PN} += "libdmapsharing3-devel libdmapsharing3-devel(aarch-64) pkgconfig(libdmapsharing-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdmapsharing-3_0-2 pkgconfig(glib-2.0) pkgconfig(gstreamer-1.0) pkgconfig(libsoup-2.4)"
