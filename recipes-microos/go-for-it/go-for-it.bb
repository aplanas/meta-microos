...
RPROVIDES:${PN} += "application() application(com.github.jmoerman.go-for-it.desktop) go-for-it go-for-it(aarch-64) metainfo() metainfo(com.github.jmoerman.go-for-it.appdata.xml)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcairo.so.2()(64bit) libgdk-3.so.0()(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libnotify.so.4()(64bit)"
