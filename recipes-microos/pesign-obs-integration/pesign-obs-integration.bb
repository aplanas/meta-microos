...
RPROVIDES:${PN} += "pesign-obs-integration pesign-obs-integration(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /usr/bin/perl fipscheck mozilla-nss-tools openssl pesign suse-module-tools"
