...
RPROVIDES:${PN} += "typelib(BraseroBurn) typelib-1_0-BraseroBurn-3_2_0 typelib-1_0-BraseroBurn-3_2_0(aarch-64)"
RDEPENDS:${PN} += "libbrasero-burn3.so.1()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
