...
RPROVIDES:${PN} += "python3-pass-git-helper python3.10dist(pass-git-helper) python310-pass-git-helper python3dist(pass-git-helper)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-pyxdg update-alternatives"
