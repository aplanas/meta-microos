...
RPROVIDES:${PN} += "python3.11dist(roifile) python311-roifile python3dist(roifile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-matplotlib python311-numpy python311-tifffile update-alternatives"
