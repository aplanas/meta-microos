...
RPROVIDES:${PN} += "ghc-prof(simple-sendfile-0.2.31-701wssQD34oFyvrTLOblUT) ghc-simple-sendfile-prof ghc-simple-sendfile-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(network-3.1.2.8-HNDBp0HF6t0D1fzE2MDtPd) ghc-prof(unix-2.7.3) ghc-simple-sendfile-devel"
