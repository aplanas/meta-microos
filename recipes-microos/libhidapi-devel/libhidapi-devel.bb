...
RPROVIDES:${PN} += "libhidapi-devel libhidapi-devel(aarch-64) pkgconfig(hidapi-hidraw) pkgconfig(hidapi-libusb)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libhidapi-hidraw0 libhidapi-libusb0 libudev-devel libusb-1_0-devel"
