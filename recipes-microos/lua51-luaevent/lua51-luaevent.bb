...
RPROVIDES:${PN} += "lua51-event lua51-luaevent lua51-luaevent(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libevent-2.1.so.7()(64bit) lua51 lua51-luasocket"
