...
RPROVIDES:${PN} += "python3.9dist(orange-widget-base) python39-orange-widget-base python3dist(orange-widget-base)"
RDEPENDS:${PN} += "python(abi) python39-AnyQt python39-matplotlib python39-orange-canvas-core python39-pyqtgraph python39-qt5 python39-qtwebengine-qt5"
