...
RPROVIDES:${PN} += "python3.9dist(librosa) python39-librosa python3dist(librosa)"
RDEPENDS:${PN} += "python(abi) python39-SoundFile python39-audioread python39-decorator python39-joblib python39-numba python39-numpy python39-packaging python39-pooch python39-resampy python39-scikit-learn python39-scipy"
