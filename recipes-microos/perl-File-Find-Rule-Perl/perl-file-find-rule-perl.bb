...
RPROVIDES:${PN} += "perl(File::Find::Rule::Perl) perl-File-Find-Rule-Perl"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(File::Find::Rule) perl(Params::Util) perl(Parse::CPAN::Meta)"
