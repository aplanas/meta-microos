...
RPROVIDES:${PN} += "python3.11dist(avro) python311-avro python3dist(avro)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Twisted python311-zope.interface update-alternatives"
