...
RPROVIDES:${PN} += "python3.9dist(easy-thumbnails) python39-easy-thumbnails python3dist(easy-thumbnails)"
RDEPENDS:${PN} += "python(abi) python39-Django python39-Pillow python39-lxml python39-reportlab python39-svglib"
