...
RPROVIDES:${PN} += "perl(App::MFILE::WWW) perl(App::MFILE::WWW::Dispatch) perl(App::MFILE::WWW::Resource) perl-App-MFILE-WWW"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(App::CELL) perl(File::ShareDir) perl(JSON) perl(LWP::UserAgent) perl(Log::Any::Adapter) perl(Params::Validate) perl(Plack::Builder) perl(Plack::Middleware::Session) perl(Plack::Middleware::StackTrace) perl(Plack::Middleware::Static) perl(Plack::Runner) perl(Try::Tiny) perl(Web::Machine)"
