...
RPROVIDES:${PN} += "ghc-assoc-devel ghc-assoc-devel(aarch-64) ghc-devel(assoc-1.0.2-IAwklVGxRFw6xcadvaWWl7)"
RDEPENDS:${PN} += "/bin/sh ghc-assoc ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bifunctors-5.5.15-7mn3oj93MLM2f6K5DVlnRL) ghc-devel(tagged-0.8.7-CYOhX22Df3PFW5V1S0dOJa)"
