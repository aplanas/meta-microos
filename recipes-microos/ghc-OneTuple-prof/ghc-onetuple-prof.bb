...
RPROVIDES:${PN} += "ghc-OneTuple-prof ghc-OneTuple-prof(aarch-64) ghc-prof(OneTuple-0.3.1-IKxZBiZNgF5H3QnFEzgDrd)"
RDEPENDS:${PN} += "ghc-OneTuple-devel ghc-prof(base-4.17.1.0) ghc-prof(ghc-prim-0.9.0) ghc-prof(template-haskell-2.19.0.0)"
