...
RPROVIDES:${PN} += "ghc-boring-prof ghc-boring-prof(aarch-64) ghc-prof(boring-0.2.1-J8lJX6Vz53r2bssyBwOtpl)"
RDEPENDS:${PN} += "ghc-boring-devel ghc-prof(base-4.17.1.0) ghc-prof(tagged-0.8.7-CYOhX22Df3PFW5V1S0dOJa) ghc-prof(transformers-0.5.6.2)"
