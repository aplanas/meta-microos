...
RPROVIDES:${PN} += "tex(ednmath0.sty) tex(edtable.sty) tex(fnlineno.sty) tex(lineno.sty) tex(vplref.sty) texlive-lineno"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(finstrut.sty) tex(longtable.sty) tex(ltabptch.sty) tex(varioref.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
