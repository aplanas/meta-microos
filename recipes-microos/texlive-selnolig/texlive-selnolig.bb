...
RPROVIDES:${PN} += "tex(selnolig-english-hyphex.sty) tex(selnolig-english-patterns.sty) tex(selnolig-german-hyphex.sty) tex(selnolig-german-patterns.sty) tex(selnolig.sty) texlive-selnolig"
