...
RPROVIDES:${PN} += "liballegro_font.so.5.2()(64bit) liballegro_font5_2 liballegro_font5_2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) liballegro.so.5.2()(64bit) libc.so.6(GLIBC_2.17)(64bit)"
