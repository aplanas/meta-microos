...
RPROVIDES:${PN} += "perl(Perl::Tidy) perl(Perl::Tidy::Debugger) perl(Perl::Tidy::DevNull) perl(Perl::Tidy::Diagnostics) perl(Perl::Tidy::FileWriter) perl(Perl::Tidy::Formatter) perl(Perl::Tidy::HtmlWriter) perl(Perl::Tidy::IOScalar) perl(Perl::Tidy::IOScalarArray) perl(Perl::Tidy::IndentationItem) perl(Perl::Tidy::LineBuffer) perl(Perl::Tidy::LineSink) perl(Perl::Tidy::LineSource) perl(Perl::Tidy::Logger) perl(Perl::Tidy::Tokenizer) perl(Perl::Tidy::VerticalAligner) perl(Perl::Tidy::VerticalAligner::Alignment) perl(Perl::Tidy::VerticalAligner::Line) perl-Perl-Tidy"
