...
RPROVIDES:${PN} += "cmake(Qt53DQuickRender) libQt53DQuickRender-devel libQt53DQuickRender-devel(aarch-64) libQt53DQuickRenderer-devel pkgconfig(Qt53DQuickRender)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libQt53DQuickRender5 pkgconfig(Qt53DCore) pkgconfig(Qt53DQuick) pkgconfig(Qt53DRender) pkgconfig(Qt5Core) pkgconfig(Qt5Gui) pkgconfig(Qt5Qml)"
