...
RPROVIDES:${PN} += "libsundials_sunmatrix4-openmpi2 libsundials_sunmatrix4-openmpi2(aarch-64) libsundials_sunmatrixband.so.4()(64bit) libsundials_sunmatrixdense.so.4()(64bit) libsundials_sunmatrixsparse.so.4()(64bit)"
