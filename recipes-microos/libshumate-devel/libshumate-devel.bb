...
RPROVIDES:${PN} += "libshumate-devel libshumate-devel(aarch-64) pkgconfig(shumate-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libshumate-1_0-1 pkgconfig(cairo) pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(gtk4) pkgconfig(json-glib-1.0) pkgconfig(libprotobuf-c) pkgconfig(libsoup-3.0) pkgconfig(sqlite3) typelib-1_0-Shumate-1_0"
