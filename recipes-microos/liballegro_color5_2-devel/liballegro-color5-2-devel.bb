...
RPROVIDES:${PN} += "liballegro_color5_2-devel liballegro_color5_2-devel(aarch-64) pkgconfig(allegro_color-5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liballegro_color5_2 pkgconfig(allegro-5)"
