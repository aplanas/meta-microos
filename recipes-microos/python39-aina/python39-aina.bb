...
RPROVIDES:${PN} += "python3.9dist(aina) python39-aina python3dist(aina)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-base python39-click update-alternatives"
