...
RPROVIDES:${PN} += "locale(texlive-cjk:ja;ko;zh) texlive-cjk-latex-extras"
RDEPENDS:${PN} += "/bin/mkdir /bin/rm /bin/sh /usr/bin/perl /usr/bin/touch /usr/bin/updmap freetype-tools texlive-cjk texlive-latex"
