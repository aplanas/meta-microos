...
RPROVIDES:${PN} += "tex(birm.sty) tex(burm.tfm) tex(burmese.map) tex(ubirm.fd) texlive-burmese"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(relsize.sty) tex(updmap.cfg) texlive texlive-burmese-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
