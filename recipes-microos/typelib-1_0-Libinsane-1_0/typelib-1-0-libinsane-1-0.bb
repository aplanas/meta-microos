...
RPROVIDES:${PN} += "typelib(Libinsane) typelib-1_0-Libinsane-1_0 typelib-1_0-Libinsane-1_0(aarch-64)"
RDEPENDS:${PN} += "libinsane_gobject.so.1()(64bit) typelib(GLib) typelib(GObject)"
