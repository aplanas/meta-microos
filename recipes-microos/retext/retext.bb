...
RPROVIDES:${PN} += "ReText application() application(me.mitya57.ReText.desktop) metainfo() metainfo(me.mitya57.ReText.appdata.xml) mimehandler(text/markdown) mimehandler(text/x-rst) python3.10dist(retext) python3dist(retext) retext"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Markdown python3-Markups python3-docutils python3-pyenchant python3-qt5"
