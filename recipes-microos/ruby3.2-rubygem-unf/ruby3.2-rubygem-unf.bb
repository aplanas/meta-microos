...
RPROVIDES:${PN} += "ruby3.2-rubygem-unf ruby3.2-rubygem-unf(aarch-64) rubygem(ruby:3.2.0:unf) rubygem(ruby:3.2.0:unf:0) rubygem(ruby:3.2.0:unf:0.1) rubygem(ruby:3.2.0:unf:0.1.4) rubygem(unf)"
RDEPENDS:${PN} += "/usr/bin/env ruby(abi) rubygem(ruby:3.2.0:unf_ext)"
