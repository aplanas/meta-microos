...
RPROVIDES:${PN} += "python3-pelican python3.10dist(pelican) python310-pelican python3dist(pelican)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Jinja2 python310-Pygments python310-Unidecode python310-blinker python310-docutils python310-feedgenerator python310-python-dateutil python310-pytz python310-rich update-alternatives"
