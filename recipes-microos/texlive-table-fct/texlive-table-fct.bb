...
RPROVIDES:${PN} += "tex(table-fct.sty) texlive-table-fct"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(environ.sty) tex(graphicx.sty) tex(pstricks-add.sty) tex(pstricks.sty) tex(xargs.sty) tex(xcolor.sty) tex(xifthen.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
