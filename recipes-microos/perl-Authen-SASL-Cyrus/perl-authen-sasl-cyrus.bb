...
RPROVIDES:${PN} += "perl(Authen::SASL::Cyrus) perl(Authen::SASL::Cyrus::Security) perl-Authen-SASL-Cyrus perl-Authen-SASL-Cyrus(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsasl2.so.3()(64bit) perl(:MODULE_COMPAT_5.36.0) perl-Authen-SASL"
