...
RPROVIDES:${PN} += "ghc-devel(sop-core-0.5.0.2-C2iIEVjE1N8Lg8Q4QDHkLe) ghc-sop-core-devel ghc-sop-core-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-sop-core"
