...
RPROVIDES:${PN} += "ghc-file-embed-prof ghc-file-embed-prof(aarch-64) ghc-prof(file-embed-0.0.15.0-LJLaBgMyS4K2tBVYbzJ0uw)"
RDEPENDS:${PN} += "ghc-file-embed-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(directory-1.3.7.1) ghc-prof(filepath-1.4.2.2) ghc-prof(template-haskell-2.19.0.0)"
