...
RPROVIDES:${PN} += "ruby3.2-rubygem-activemodel-7.0 ruby3.2-rubygem-activemodel-7.0(aarch-64) rubygem(activemodel) rubygem(ruby:3.2.0:activemodel) rubygem(ruby:3.2.0:activemodel:7) rubygem(ruby:3.2.0:activemodel:7.0) rubygem(ruby:3.2.0:activemodel:7.0.4)"
