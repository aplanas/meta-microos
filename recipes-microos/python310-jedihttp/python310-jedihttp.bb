...
RPROVIDES:${PN} += "python3-jedihttp python3.10dist(jedihttp) python310-jedihttp python3dist(jedihttp)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-bottle python310-jedi python310-waitress update-alternatives"
