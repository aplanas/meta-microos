...
RPROVIDES:${PN} += "composer php-composer php5-composer php7-composer php8-composer"
RDEPENDS:${PN} += "php php-intl php-json php-mbstring php-openssl php-phar php-zip php-zlib"
