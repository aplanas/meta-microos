...
RPROVIDES:${PN} += "tex(magicwatermark.sty) texlive-magicwatermark"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(everypage-1x.sty) tex(expl3.sty) tex(tikz.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
