...
RPROVIDES:${PN} += "python3.11dist(termrecord) python311-TermRecord python3dist(termrecord)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Jinja2 update-alternatives"
