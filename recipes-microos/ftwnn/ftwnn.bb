...
RPROVIDES:${PN} += "config(ftwnn) ftwnn ftwnn(aarch-64)"
RDEPENDS:${PN} += "/bin/sh fcwnn fcwnncom ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcrypt.so.1()(64bit) libcrypt.so.1(XCRYPT_2.0)(64bit) libwrap.so.0()(64bit) shadow"
