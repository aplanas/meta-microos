...
RPROVIDES:${PN} += "pkgconfig(sphinxbase) sphinxbase5-devel sphinxbase5-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config alsa-devel lapack-devel libsndfile-devel libsphinxbase3 sphinxbase5"
