...
RPROVIDES:${PN} += "alsa-tools-gui:/usr/bin/rmedigicontrol application() application(rmedigicontrol.desktop) rmedigicontrol rmedigicontrol(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libasound.so.2()(64bit) libasound.so.2(ALSA_0.9)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgtk-x11-2.0.so.0()(64bit)"
