...
RPROVIDES:${PN} += "typelib(Urfkill) typelib-1_0-Urfkill-0_0 typelib-1_0-Urfkill-0_0(aarch-64)"
RDEPENDS:${PN} += "liburfkill-glib.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
