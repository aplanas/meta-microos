...
RPROVIDES:${PN} += "ghc-digest-prof ghc-digest-prof(aarch-64) ghc-prof(digest-0.0.1.7-CCCN8814sFy3HuiyT8t94G)"
RDEPENDS:${PN} += "ghc-digest-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0)"
