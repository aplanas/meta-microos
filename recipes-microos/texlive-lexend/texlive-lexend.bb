...
RPROVIDES:${PN} += "tex(lexend.sty) texlive-lexend"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(expl3.sty) tex(fontspec.sty) tex(kvoptions.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-lexend-fonts texlive-scripts texlive-scripts-bin"
