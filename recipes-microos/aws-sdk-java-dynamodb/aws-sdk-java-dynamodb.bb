...
RPROVIDES:${PN} += "aws-sdk-java-dynamodb mvn(com.amazonaws:aws-java-sdk-dynamodb) mvn(com.amazonaws:aws-java-sdk-dynamodb:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.amazonaws:aws-java-sdk-core) mvn(com.amazonaws:aws-java-sdk-s3)"
