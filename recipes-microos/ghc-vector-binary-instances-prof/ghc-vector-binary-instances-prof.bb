...
RPROVIDES:${PN} += "ghc-prof(vector-binary-instances-0.2.5.2-KcST7aCBDJmuBtN6ufmU8) ghc-vector-binary-instances-prof ghc-vector-binary-instances-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(binary-0.8.9.1) ghc-prof(vector-0.13.0.0-AbjrQrWxuFpAjIHk3G7xsp) ghc-vector-binary-instances-devel"
