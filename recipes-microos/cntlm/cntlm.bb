...
RPROVIDES:${PN} += "cntlm cntlm(aarch-64) config(cntlm)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/touch fillup grep group(nogroup) ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) pwdutils systemd"
