...
RPROVIDES:${PN} += "application() application(keepass.desktop) keepass mono(KeePass) mono(KeePassLib)"
RDEPENDS:${PN} += "mono(System) mono(System.Drawing) mono(System.Security) mono(System.Windows.Forms) mono(System.Xml) mono(mscorlib)"
