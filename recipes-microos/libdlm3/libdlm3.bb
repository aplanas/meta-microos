...
RPROVIDES:${PN} += "libdlm.so.3()(64bit) libdlm.so.3(V_4.1.0)(64bit) libdlm3 libdlm3(aarch-64) libdlm_lt.so.3()(64bit) libdlm_lt.so.3(V_4.1.0)(64bit) libdlmcontrol.so.3()(64bit) libdlmcontrol.so.3(V_4.1.0)(64bit)"
