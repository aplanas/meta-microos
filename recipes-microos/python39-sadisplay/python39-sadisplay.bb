...
RPROVIDES:${PN} += "python3.9dist(sadisplay) python39-sadisplay python3dist(sadisplay)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-SQLAlchemy update-alternatives"
