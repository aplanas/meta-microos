...
RPROVIDES:${PN} += "libavahi-gobject.so.0()(64bit) libavahi-gobject0 libavahi-gobject0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libavahi-client.so.3()(64bit) libavahi-common.so.3()(64bit) libavahi-glib.so.1()(64bit) libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit)"
