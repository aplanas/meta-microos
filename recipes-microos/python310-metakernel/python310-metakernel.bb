...
RPROVIDES:${PN} += "jupyter-metakernel python3-jupyter_metakernel python3-metakernel python3.10dist(metakernel) python310-jupyter_metakernel python310-metakernel python3dist(metakernel)"
RDEPENDS:${PN} += "python(abi) python310-ipykernel python310-jedi python310-jupyter-core python310-pexpect"
