...
RPROVIDES:${PN} += "python3.9dist(cufflinks) python39-cufflinks python3dist(cufflinks)"
RDEPENDS:${PN} += "python(abi) python39-colorlover python39-numpy python39-pandas python39-plotly python39-six"
