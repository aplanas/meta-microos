...
RPROVIDES:${PN} += "python3.11dist(bindep) python311-bindep python3dist(bindep)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Parsley python311-distro python311-packaging python311-pbr"
