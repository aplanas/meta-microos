...
RPROVIDES:${PN} += "monitoring-plugins-dns monitoring-plugins-dns(aarch-64) nagios-plugins-dns"
RDEPENDS:${PN} += "/usr/bin/nslookup ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit)"
