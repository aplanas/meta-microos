...
RPROVIDES:${PN} += "python3.11dist(sadisplay) python311-sadisplay python3dist(sadisplay)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-SQLAlchemy update-alternatives"
