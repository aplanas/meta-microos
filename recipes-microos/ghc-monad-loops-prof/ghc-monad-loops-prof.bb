...
RPROVIDES:${PN} += "ghc-monad-loops-prof ghc-monad-loops-prof(aarch-64) ghc-prof(monad-loops-0.4.3-J6SAcCDTGblA6407vWEwF9)"
RDEPENDS:${PN} += "ghc-monad-loops-devel ghc-prof(base-4.17.1.0)"
