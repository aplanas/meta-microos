...
RPROVIDES:${PN} += "typelib(Malcontent) typelib-1_0-Malcontent-0 typelib-1_0-Malcontent-0(aarch-64)"
RDEPENDS:${PN} += "libmalcontent-0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
