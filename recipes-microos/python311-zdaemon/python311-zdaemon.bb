...
RPROVIDES:${PN} += "python3.11dist(zdaemon) python311-zdaemon python3dist(zdaemon)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-ZConfig update-alternatives"
