...
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl coreutils ed findutils grep perl(Getopt::Long) sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-mkpic-bin texlive-scripts texlive-scripts-bin"
