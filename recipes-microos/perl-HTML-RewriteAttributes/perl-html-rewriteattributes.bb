...
RPROVIDES:${PN} += "perl(HTML::RewriteAttributes) perl(HTML::RewriteAttributes::Links) perl(HTML::RewriteAttributes::Resources) perl-HTML-RewriteAttributes"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(HTML::Entities) perl(HTML::Parser) perl(HTML::Tagset) perl(URI)"
