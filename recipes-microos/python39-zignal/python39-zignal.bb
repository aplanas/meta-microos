...
RPROVIDES:${PN} += "python3.9dist(zignal) python39-zignal python3dist(zignal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-matplotlib python39-numpy python39-samplerate python39-scipy update-alternatives"
