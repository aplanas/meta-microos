...
RPROVIDES:${PN} += "tex(arrow.tex) tex(btxmac.tex) tex(eplain.tex) texlive-eplain"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(language.dat) tex(language.dat.lua) tex(language.def) texlive texlive-atbegshi texlive-atveryend texlive-babel texlive-cm texlive-dehyph texlive-eplain-bin texlive-everyshi texlive-filesystem texlive-firstaid texlive-hyph-utf8 texlive-hyphen-base texlive-knuth-lib texlive-kpathsea texlive-kpathsea-bin texlive-l3backend texlive-l3kernel texlive-l3packages texlive-latex texlive-latex-fonts texlive-pdftex texlive-plain texlive-scripts texlive-scripts-bin texlive-tex-ini-files texlive-unicode-data"
