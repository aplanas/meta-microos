...
RPROVIDES:${PN} += "b4 python3.10dist(b4) python3dist(b4)"
RDEPENDS:${PN} += "/usr/bin/python3 git-core git-filter-repo python(abi) python3-dkimpy python3-dnspython python3-patatt python3-requests"
