...
RPROVIDES:${PN} += "mvn(com.github.relaxng:relaxngDatatype) mvn(com.github.relaxng:relaxngDatatype:pom:) mvn(relaxngDatatype:relaxngDatatype) mvn(relaxngDatatype:relaxngDatatype:pom:) relaxngDatatype"
