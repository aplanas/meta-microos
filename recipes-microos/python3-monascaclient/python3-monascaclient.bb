...
RPROVIDES:${PN} += "python3-monascaclient python3.10dist(python-monascaclient) python3dist(python-monascaclient)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Babel python3-PrettyTable python3-PyYAML python3-iso8601 python3-osc-lib python3-oslo.serialization python3-oslo.utils python3-pbr python3-requests python3-six"
