...
RPROVIDES:${PN} += "ComputeLibrary-devel ComputeLibrary-devel(aarch-64)"
RDEPENDS:${PN} += "ComputeLibrary libarm_compute30 libarm_compute_core30 libarm_compute_graph30 stb-devel"
