...
RPROVIDES:${PN} += "gdm-devel gdm-devel(aarch-64) pkgconfig(gdm) pkgconfig(gdm-pam-extensions)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgdm1 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libselinux) pkgconfig(libsystemd) typelib-1_0-Gdm-1_0"
