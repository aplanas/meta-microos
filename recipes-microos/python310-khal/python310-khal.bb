...
RPROVIDES:${PN} += "python3-khal python3.10dist(khal) python310-khal python3dist(khal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-atomicwrites python310-click python310-click-log python310-configobj python310-dateutil python310-icalendar python310-pytz python310-pyxdg python310-tzlocal python310-urwid update-alternatives"
