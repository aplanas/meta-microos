...
RPROVIDES:${PN} += "python3.9dist(oletools) python39-oletools python3dist(oletools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-colorclass python39-easygui python39-msoffcrypto-tool python39-olefile python39-pyparsing"
