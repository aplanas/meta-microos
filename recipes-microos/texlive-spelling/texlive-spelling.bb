...
RPROVIDES:${PN} += "tex(spelling.sty) texlive-spelling"
RDEPENDS:${PN} += "/bin/sh /usr/bin/luatex coreutils ed findutils grep sed tex(atbegshi.sty) tex(ifluatex.sty) tex(luatexbase-attr.sty) tex(luatexbase-mcb.sty) tex(luatexbase-modutils.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
