...
RPROVIDES:${PN} += "liballegro_font5_2-devel liballegro_font5_2-devel(aarch-64) pkgconfig(allegro_font-5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liballegro_font5_2 pkgconfig(allegro-5)"
