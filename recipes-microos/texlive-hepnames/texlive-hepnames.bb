...
RPROVIDES:${PN} += "tex(hepnames.sty) tex(hepnicenames.sty) tex(heppennames.sty) texlive-hepnames"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(hepparticles.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
