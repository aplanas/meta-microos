...
RPROVIDES:${PN} += "python3-azure-storage-file-share python3.10dist(azure-storage-file-share) python310-azure-storage-file-share python3dist(azure-storage-file-share)"
RDEPENDS:${PN} += "(python310-typing_extensions >= 4.0.1 if python310-base < 3.8) python(abi) python310-azure-core python310-azure-nspkg python310-azure-storage-nspkg python310-cryptography python310-isodate"
