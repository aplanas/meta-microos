...
RPROVIDES:${PN} += "libhts-devel libhts-devel(aarch-64) pkgconfig(htslib)"
RDEPENDS:${PN} += "/sbin/ldconfig /usr/bin/pkg-config libhts3 pkgconfig(bzip2) pkgconfig(libcurl) pkgconfig(liblzma) pkgconfig(zlib)"
