...
RPROVIDES:${PN} += "python3.9dist(watchdog) python39-watchdog python3dist(watchdog)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-pathtools update-alternatives"
