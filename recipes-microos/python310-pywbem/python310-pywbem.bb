...
RPROVIDES:${PN} += "python3-pywbem python3.10dist(pywbem) python310-pywbem python3dist(pywbem)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-PyYAML python310-nocasedict python310-nocaselist python310-ply python310-requests python310-six python310-urllib3 python310-yamlloader update-alternatives"
