...
RPROVIDES:${PN} += "ruby3.2-rubygem-js-routes ruby3.2-rubygem-js-routes(aarch-64) rubygem(js-routes) rubygem(ruby:3.2.0:js-routes) rubygem(ruby:3.2.0:js-routes:2) rubygem(ruby:3.2.0:js-routes:2.2) rubygem(ruby:3.2.0:js-routes:2.2.5)"
