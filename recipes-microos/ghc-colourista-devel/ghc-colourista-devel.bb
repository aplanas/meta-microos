...
RPROVIDES:${PN} += "ghc-colourista-devel ghc-colourista-devel(aarch-64) ghc-devel(colourista-0.1.0.2-5hJOPOBvzIt9IdOCkudaU3)"
RDEPENDS:${PN} += "/bin/sh ghc-colourista ghc-compiler ghc-devel(ansi-terminal-0.11.5-5x0MoHxm5r6DDoyv5djCW3) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(text-2.0.2)"
