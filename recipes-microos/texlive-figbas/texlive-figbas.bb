...
RPROVIDES:${PN} += "tex(cmrj.tfm) tex(cmssj.tfm) tex(figbas.map) tex(plrj.tfm) texlive-figbas"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-figbas-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
