...
RPROVIDES:${PN} += "udev-configure-printer udev-configure-printer(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 dbus-1-python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcups.so.2()(64bit) libglib-2.0.so.0()(64bit) libudev.so.1()(64bit) libudev.so.1(LIBUDEV_183)(64bit) libusb-1.0.so.0()(64bit) python3-cups python3-cupshelpers systemd"
