...
RPROVIDES:${PN} += "mvn(net.sf.supercsv:super-csv) mvn(net.sf.supercsv:super-csv-java8) mvn(net.sf.supercsv:super-csv-java8:pom:) mvn(net.sf.supercsv:super-csv-parent:pom:) mvn(net.sf.supercsv:super-csv:pom:) osgi(net.sf.supercsv.super-csv) osgi(net.sf.supercsv.super-csv-java8) super-csv"
