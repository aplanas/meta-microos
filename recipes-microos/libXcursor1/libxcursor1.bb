...
RPROVIDES:${PN} += "libXcursor.so.1()(64bit) libXcursor1 libXcursor1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libXfixes.so.3()(64bit) libXrender.so.1()(64bit) libc.so.6(GLIBC_2.17)(64bit)"
