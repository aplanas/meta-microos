...
RPROVIDES:${PN} += "python3.9dist(interrogate) python39-interrogate python3dist(interrogate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-attrs python39-click python39-colorama python39-py python39-tabulate python39-toml update-alternatives"
