...
RPROVIDES:${PN} += "libjcat-devel libjcat-devel(aarch-64) pkgconfig(jcat)"
RDEPENDS:${PN} += "/usr/bin/pkg-config jcat-tool libjcat1 pkgconfig(gio-2.0) pkgconfig(gnutls) pkgconfig(hogweed) pkgconfig(json-glib-1.0)"
