...
RPROVIDES:${PN} += "libunbound-devel pkgconfig(libunbound) unbound-devel unbound-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ldns-devel libunbound8 openssl-devel pkgconfig(libevent) pkgconfig(python3)"
