...
RPROVIDES:${PN} += "python3.9dist(glymur) python39-Glymur python3dist(glymur)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-lxml python39-numpy python39-packaging update-alternatives"
