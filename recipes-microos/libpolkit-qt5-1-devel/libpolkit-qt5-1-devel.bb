...
RPROVIDES:${PN} += "cmake(PolkitQt5-1) libpolkit-qt5-1-devel libpolkit-qt5-1-devel(aarch-64) pkgconfig(polkit-qt5-1) pkgconfig(polkit-qt5-agent-1) pkgconfig(polkit-qt5-core-1) pkgconfig(polkit-qt5-gui-1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libpolkit-qt5-1-1 pkgconfig(Qt5Core) pkgconfig(Qt5Gui) pkgconfig(Qt5Widgets) pkgconfig(polkit-qt5-agent-1) pkgconfig(polkit-qt5-core-1) pkgconfig(polkit-qt5-gui-1) polkit-devel"
