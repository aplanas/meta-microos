...
RPROVIDES:${PN} += "libappindicator-devel libappindicator-devel(aarch-64) pkgconfig(appindicator-0.1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libappindicator1 pkgconfig(dbusmenu-glib-0.4) pkgconfig(gtk+-2.0)"
