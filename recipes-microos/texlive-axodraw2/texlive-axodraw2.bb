...
RPROVIDES:${PN} += "tex(axodraw2.sty) texlive-axodraw2"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(graphicx.sty) tex(ifthen.sty) tex(ifxetex.sty) tex(keyval.sty) texlive texlive-axodraw2-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
