...
RPROVIDES:${PN} += "tex(idxmac.tex) texlive-makeindex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-makeindex-bin texlive-scripts texlive-scripts-bin"
