...
RPROVIDES:${PN} += "libgee-devel libgee-devel(aarch-64) pkgconfig(gee-0.8)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgee-0_8-2 pkgconfig(glib-2.0) pkgconfig(gobject-2.0) typelib-1_0-Gee-0_8"
