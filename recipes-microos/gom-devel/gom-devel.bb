...
RPROVIDES:${PN} += "gom-devel gom-devel(aarch-64) pkgconfig(gom-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgom-1_0-0 pkgconfig(gobject-2.0) python3-gom typelib-1_0-Gom-1_0"
