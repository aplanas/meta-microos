...
RPROVIDES:${PN} += "python3-openstack-doc-tools python3.10dist(openstack-doc-tools) python3dist(openstack-doc-tools)"
RDEPENDS:${PN} += "/bin/bash python(abi) python3-PyYAML python3-Sphinx python3-iso8601 python3-lxml python3-openstackdocstheme"
