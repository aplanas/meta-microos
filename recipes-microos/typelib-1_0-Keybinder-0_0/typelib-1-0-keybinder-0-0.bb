...
RPROVIDES:${PN} += "typelib(Keybinder) typelib-1_0-Keybinder-0_0 typelib-1_0-Keybinder-0_0(aarch-64)"
RDEPENDS:${PN} += "libkeybinder.so.0()(64bit) typelib(GLib) typelib(GObject)"
