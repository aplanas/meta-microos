...
RPROVIDES:${PN} += "python3.11dist(datashape) python311-DataShape python3dist(datashape)"
RDEPENDS:${PN} += "python(abi) python311-multipledispatch python311-numpy python311-python-dateutil"
