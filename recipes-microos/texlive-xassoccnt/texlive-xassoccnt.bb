...
RPROVIDES:${PN} += "tex(xassoccnt.sty) texlive-xassoccnt"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(l3keys2e.sty) tex(letltxmacro.sty) tex(xcolor.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
