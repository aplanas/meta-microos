...
RPROVIDES:${PN} += "pkgconfig(telepathy-logger-0.2) pkgconfig(tpl-extensions) telepathy-logger-devel telepathy-logger-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libtelepathy-logger3 libtpl-extensions3 pkgconfig(libxml-2.0) pkgconfig(telepathy-glib) typelib-1_0-TelepathyLogger-0_2"
