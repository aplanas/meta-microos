...
RPROVIDES:${PN} += "perl(YAML::Tidy) perl(YAML::Tidy::Config) perl(YAML::Tidy::Node) perl(YAML::Tidy::Node::Collection) perl(YAML::Tidy::Node::Scalar) perl-YAML-Tidy"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(Getopt::Long::Descriptive) perl(YAML::LibYAML::API) perl(YAML::LibYAML::API::XS) perl(YAML::PP::Common) perl(YAML::PP::Highlight) perl(YAML::PP::Parser) perl(experimental)"
