...
RPROVIDES:${PN} += "libopenCOLLADA-devel libopenCOLLADA-devel(aarch-64) openCOLLADA-devel"
RDEPENDS:${PN} += "libGeneratedSaxParser0_3 libMathMLSolver0_3 libOpenCOLLADABaseUtils0_3 libOpenCOLLADAFramework0_3 libOpenCOLLADASaxFrameworkLoader0_3 libOpenCOLLADAStreamWriter0_3 libUTF0_3 libbuffer0_3 libftoa0_3"
