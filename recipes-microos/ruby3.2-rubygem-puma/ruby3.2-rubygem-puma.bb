...
RPROVIDES:${PN} += "ruby3.2-rubygem-puma ruby3.2-rubygem-puma(aarch-64) rubygem(puma) rubygem(ruby:3.2.0:puma) rubygem(ruby:3.2.0:puma:6) rubygem(ruby:3.2.0:puma:6.0) rubygem(ruby:3.2.0:puma:6.0.0)"
