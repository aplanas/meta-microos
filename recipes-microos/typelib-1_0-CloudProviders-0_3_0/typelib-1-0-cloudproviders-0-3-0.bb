...
RPROVIDES:${PN} += "typelib(CloudProviders) typelib-1_0-CloudProviders-0_3_0 typelib-1_0-CloudProviders-0_3_0(aarch-64)"
RDEPENDS:${PN} += "libcloudproviders.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
