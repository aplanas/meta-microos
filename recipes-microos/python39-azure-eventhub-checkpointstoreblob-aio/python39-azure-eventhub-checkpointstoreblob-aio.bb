...
RPROVIDES:${PN} += "python3.9dist(azure-eventhub-checkpointstoreblob-aio) python39-azure-eventhub-checkpointstoreblob-aio python3dist(azure-eventhub-checkpointstoreblob-aio)"
RDEPENDS:${PN} += "python(abi) python39-aiohttp python39-azure-core python39-azure-eventhub python39-azure-nspkg python39-azure-storage-blob python39-cryptography python39-msrest"
