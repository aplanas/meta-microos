...
RPROVIDES:${PN} += "tex(pdftricks2.sty) texlive-pdftricks2"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(geometry.sty) tex(graphicx.sty) tex(ifpdf.sty) tex(ifplatform.sty) tex(moreverb.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
