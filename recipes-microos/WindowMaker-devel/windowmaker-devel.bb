...
RPROVIDES:${PN} += "WindowMaker-devel WindowMaker-devel(aarch-64) pkgconfig(WINGs) pkgconfig(WUtil) pkgconfig(wmlib) pkgconfig(wrlib)"
RDEPENDS:${PN} += "/usr/bin/pkg-config WindowMaker pkgconfig(WUtil) pkgconfig(wrlib) pkgconfig(x11)"
