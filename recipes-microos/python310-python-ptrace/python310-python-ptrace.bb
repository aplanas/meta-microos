...
RPROVIDES:${PN} += "python3-python-ptrace python3.10dist(cptrace) python3.10dist(python-ptrace) python310-python-ptrace python310-python-ptrace(aarch-64) python3dist(cptrace) python3dist(python-ptrace)"
