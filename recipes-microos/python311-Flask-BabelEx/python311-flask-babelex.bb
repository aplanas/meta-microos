...
RPROVIDES:${PN} += "python3.11dist(flask-babelex) python311-Flask-BabelEx python3dist(flask-babelex)"
RDEPENDS:${PN} += "python(abi) python311-Babel python311-Flask python311-Jinja2 python311-speaklater"
