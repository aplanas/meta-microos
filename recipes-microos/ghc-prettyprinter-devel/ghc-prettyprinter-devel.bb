...
RPROVIDES:${PN} += "ghc-devel(prettyprinter-1.7.1-1jjh6iCiPNl8MgeqtPsio2) ghc-prettyprinter-devel ghc-prettyprinter-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(text-2.0.2) ghc-prettyprinter"
