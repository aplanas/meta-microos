...
RPROVIDES:${PN} += "python3-azure-mgmt-datamigration python3.10dist(azure-mgmt-datamigration) python310-azure-mgmt-datamigration python3dist(azure-mgmt-datamigration)"
