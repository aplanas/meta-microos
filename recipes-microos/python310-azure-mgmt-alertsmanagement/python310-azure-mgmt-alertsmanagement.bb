...
RPROVIDES:${PN} += "python3-azure-mgmt-alertsmanagement python3.10dist(azure-mgmt-alertsmanagement) python310-azure-mgmt-alertsmanagement python3dist(azure-mgmt-alertsmanagement)"
