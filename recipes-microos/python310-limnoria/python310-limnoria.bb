...
RPROVIDES:${PN} += "Supybot python3-limnoria python3.10dist(limnoria) python310-limnoria python3dist(limnoria)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 procps python(abi) python310 python310-PySocks python310-chardet python310-cryptography python310-ecdsa python310-feedparser python310-python-dateutil python310-python-gnupg python310-pytzdata update-alternatives"
