...
RPROVIDES:${PN} += "perl(ExtUtils::Typemap::Basic) perl(ExtUtils::Typemap::Default) perl(ExtUtils::Typemap::ObjectMap) perl(ExtUtils::Typemap::STL) perl(ExtUtils::Typemap::STL::String) perl(ExtUtils::Typemap::STL::Vector) perl(ExtUtils::Typemaps::Basic) perl(ExtUtils::Typemaps::Default) perl(ExtUtils::Typemaps::ObjectMap) perl(ExtUtils::Typemaps::STL) perl(ExtUtils::Typemaps::STL::List) perl(ExtUtils::Typemaps::STL::String) perl(ExtUtils::Typemaps::STL::Vector) perl-ExtUtils-Typemaps-Default"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(ExtUtils::Typemaps)"
