...
RPROVIDES:${PN} += "ghc-cairo-prof ghc-cairo-prof(aarch-64) ghc-prof(cairo-0.13.8.2-84nOBKgVLz3788JDxxB5om)"
RDEPENDS:${PN} += "ghc-cairo-devel ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(mtl-2.2.2) ghc-prof(text-2.0.2) ghc-prof(utf8-string-1.0.2-3yyxPCwARUwDt9ZNWn320Q)"
