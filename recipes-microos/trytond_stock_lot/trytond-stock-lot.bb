...
RPROVIDES:${PN} += "python3.10dist(trytond-stock-lot) python3dist(trytond-stock-lot) trytond_stock_lot"
RDEPENDS:${PN} += "python(abi) trytond trytond_company trytond_currency trytond_party trytond_product trytond_stock"
