...
RPROVIDES:${PN} += "ghc-SafeSemaphore-devel ghc-SafeSemaphore-devel(aarch-64) ghc-devel(SafeSemaphore-0.10.1-4RgR0Mf1NXcDYTDfcuJnia)"
RDEPENDS:${PN} += "/bin/sh ghc-SafeSemaphore ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(stm-2.5.1.0)"
