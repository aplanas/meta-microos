...
RPROVIDES:${PN} += "libdqlite.so.0()(64bit) libdqlite0 libdqlite0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libraft.so.3()(64bit) libsqlite3.so.0()(64bit) libuv.so.1()(64bit)"
