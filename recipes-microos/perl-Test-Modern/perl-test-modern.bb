...
RPROVIDES:${PN} += "perl(Test::Modern) perl-Test-Modern"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Exporter::Tiny) perl(Import::Into) perl(Module::Runtime) perl(Test::API) perl(Test::Deep) perl(Test::Fatal) perl(Test::More) perl(Test::Warnings) perl(Try::Tiny)"
