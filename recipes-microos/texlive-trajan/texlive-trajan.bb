...
RPROVIDES:${PN} += "tex(t1trjn.fd) tex(trajan.map) tex(trajan.sty) tex(trjnr10.tfm) tex(trjnsl10.tfm) texlive-trajan"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-trajan-fonts"
