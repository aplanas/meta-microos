...
locale(cinnamon-screensaver:bn_IN) \
...
locale(cinnamon-screensaver:en_AU) \
locale(cinnamon-screensaver:en_CA) \
locale(cinnamon-screensaver:en_GB) \
...
locale(cinnamon-screensaver:fr_CA) \
...
locale(cinnamon-screensaver:pt_BR) \
