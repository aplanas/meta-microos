...
RPROVIDES:${PN} += "python3.11dist(pipreqs) python311-pipreqs python3dist(pipreqs)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-docopt python311-setuptools python311-yarg update-alternatives"
