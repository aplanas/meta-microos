...
RPROVIDES:${PN} += "python3.11dist(jupyter-server-mathjax) python311-jupyter-server-mathjax python3dist(jupyter-server-mathjax)"
RDEPENDS:${PN} += "jupyter-server-mathjax python(abi) python311-jupyter_server"
