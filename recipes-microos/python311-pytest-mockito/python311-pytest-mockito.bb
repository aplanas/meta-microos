...
RPROVIDES:${PN} += "python3.11dist(pytest-mockito) python311-pytest-mockito python3dist(pytest-mockito)"
RDEPENDS:${PN} += "ca-certificates python(abi) python311 python311-mockito python311-pytest"
