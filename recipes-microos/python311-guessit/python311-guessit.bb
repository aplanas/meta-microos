...
RPROVIDES:${PN} += "python3.11dist(guessit) python311-guessit python3dist(guessit)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-babelfish python311-importlib-resources python311-python-dateutil python311-rebulk update-alternatives"
