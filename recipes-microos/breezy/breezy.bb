...
RPROVIDES:${PN} += "breezy breezy(aarch-64) bzr python3.10dist(breezy) python3dist(breezy)"
RDEPENDS:${PN} += "/usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgcc_s.so.1()(64bit) libgcc_s.so.1(GCC_3.0)(64bit) libgcc_s.so.1(GCC_3.3)(64bit) libgcc_s.so.1(GCC_4.2.0)(64bit) libpython3.10.so.1.0()(64bit) python(abi) python3-PyYAML python3-configobj python3-dulwich python3-fastbencode python3-fastimport python3-merge3 python3-patiencediff"
