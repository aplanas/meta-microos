...
RPROVIDES:${PN} += "perl(DateTime::Format::Flexible) perl(DateTime::Format::Flexible::lang) perl(DateTime::Format::Flexible::lang::de) perl(DateTime::Format::Flexible::lang::en) perl(DateTime::Format::Flexible::lang::es) perl-DateTime-Format-Flexible"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DateTime) perl(DateTime::Format::Builder) perl(DateTime::TimeZone) perl(List::MoreUtils)"
