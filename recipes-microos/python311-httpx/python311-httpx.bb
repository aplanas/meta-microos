...
RPROVIDES:${PN} += "python3.11dist(httpx) python311-httpx python3dist(httpx)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-certifi python311-httpcore python311-idna python311-sniffio update-alternatives"
