...
RPROVIDES:${PN} += "enchant libenchant.so.1()(64bit) libenchant1 libenchant1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig enchant-1-backend ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libglib-2.0.so.0()(64bit) libgmodule-2.0.so.0()(64bit)"
