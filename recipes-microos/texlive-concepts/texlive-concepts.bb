...
RPROVIDES:${PN} += "tex(concepts.sty) texlive-concepts"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etextools.sty) tex(ltxkeys.sty) tex(nth.sty) tex(xparse.sty) tex(xspace.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
