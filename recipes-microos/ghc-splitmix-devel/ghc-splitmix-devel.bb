...
RPROVIDES:${PN} += "ghc-devel(splitmix-0.1.0.4-7e8CibdlMRLAGh7KO5VlFe) ghc-splitmix-devel ghc-splitmix-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-splitmix"
