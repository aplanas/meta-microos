...
RPROVIDES:${PN} += "libva-wayland.so.2()(64bit) libva-wayland2 libva-wayland2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libdrm.so.2()(64bit) libva.so.2()(64bit) libwayland-client.so.0()(64bit)"
