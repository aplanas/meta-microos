...
RPROVIDES:${PN} += "typelib(Gdk) typelib(GdkWayland) typelib(GdkX11) typelib(Gsk) typelib(Gtk) typelib-1_0-Gtk-4_0 typelib-1_0-Gtk-4_0(aarch-64)"
RDEPENDS:${PN} += "(python3-gobject-Gdk if python3-gobject) (python310-gobject-Gdk if python310-gobject) (python38-gobject-Gdk if python38-gobject) (python39-gobject-Gdk if python39-gobject) libgtk-4.so.1()(64bit) typelib(GLib) typelib(GModule) typelib(GObject) typelib(GdkPixbuf) typelib(Gio) typelib(Graphene) typelib(HarfBuzz) typelib(Pango) typelib(PangoCairo) typelib(cairo) typelib(freetype2) typelib(xlib)"
