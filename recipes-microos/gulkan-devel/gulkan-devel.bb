...
RPROVIDES:${PN} += "gulkan-devel gulkan-devel(aarch-64) pkgconfig(gulkan-0.15)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gulkan0_15-0 pkgconfig(cairo) pkgconfig(gdk-pixbuf-2.0) pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(graphene-1.0) pkgconfig(vulkan)"
