...
RPROVIDES:${PN} += "typelib(Qmi) typelib-1_0-Qmi-1_0 typelib-1_0-Qmi-1_0(aarch-64)"
RDEPENDS:${PN} += "libqmi-glib.so.5()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Qrtr)"
