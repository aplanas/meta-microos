...
RPROVIDES:${PN} += "config(openmpi2-macros-devel) openmpi-macros-provider openmpi2-macros-devel openmpi2-macros-devel(aarch-64) rpm_macro(openmpi_devel_requires) rpm_macro(openmpi_prefix) rpm_macro(openmpi_requires) rpm_macro(setup_openmpi)"
