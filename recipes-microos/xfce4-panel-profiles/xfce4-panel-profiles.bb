...
RPROVIDES:${PN} += "application() application(org.xfce.PanelProfiles.desktop) metainfo() metainfo(org.xfce.PanelProfiles.appdata.xml) xfce4-panel-profiles"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 python3 python3-base python3-gobject python3-gobject-Gdk typelib(GLib) typelib(Gio) typelib(Gtk) typelib(Libxfce4ui) xfce4-panel"
