...
RPROVIDES:${PN} += "tex(invoice2.sty) texlive-invoice2"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(booktabs.sty) tex(expl3.sty) tex(l3keys2e.sty) tex(longtable.sty) tex(siunitx.sty) tex(translations.sty) tex(xcolor.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
