...
RPROVIDES:${PN} += "ghc-devel(network-bsd-2.8.1.0-D1RjTzX7Byx4U4fOdbAEll) ghc-network-bsd-devel ghc-network-bsd-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(network-3.1.2.8-HNDBp0HF6t0D1fzE2MDtPd) ghc-network-bsd"
