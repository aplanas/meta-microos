...
RPROVIDES:${PN} += "cmake(deal.II) cmake(deal.IIFeature) deal_II-devel deal_II-devel(aarch-64) dealii-devel pkgconfig(deal.II_release)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdeal_II9_4_2"
