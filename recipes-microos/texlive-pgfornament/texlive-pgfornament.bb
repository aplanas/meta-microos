...
RPROVIDES:${PN} += "tex(pgflibraryam.code.tex) tex(pgflibrarypgfhan.code.tex) tex(pgflibraryvectorian.code.tex) tex(pgfornament.sty) tex(tikzrput.sty) texlive-pgfornament"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(iftex.sty) tex(pgfopts.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
