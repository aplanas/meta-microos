...
RPROVIDES:${PN} += "python3.9dist(automat) python39-Automat python3dist(automat)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-attrs update-alternatives"
