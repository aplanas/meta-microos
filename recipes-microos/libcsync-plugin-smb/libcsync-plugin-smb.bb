...
RPROVIDES:${PN} += "libcsync-plugin-smb libcsync-plugin-smb(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) libcsync.so.0()(64bit) libcsync0 libsmbclient.so.0()(64bit) libsmbclient.so.0(SMBCLIENT_0.1.0)(64bit)"
