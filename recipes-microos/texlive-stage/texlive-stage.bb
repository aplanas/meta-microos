...
RPROVIDES:${PN} += "tex(stage.cls) texlive-stage"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(book.cls) tex(changepage.sty) tex(extramarks.sty) tex(fancyhdr.sty) tex(ifthen.sty) tex(needspace.sty) tex(parskip.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
