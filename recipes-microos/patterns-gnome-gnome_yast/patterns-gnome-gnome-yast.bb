...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-gnome-gnome_yast patterns-gnome-gnome_yast(aarch-64) patterns-openSUSE-gnome_yast"
