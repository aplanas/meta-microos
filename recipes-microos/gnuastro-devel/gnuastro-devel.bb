...
RPROVIDES:${PN} += "gnuastro-devel gnuastro-devel(aarch-64) pkgconfig(gnuastro)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgnuastro17 pkgconfig(cfitsio) pkgconfig(gsl) pkgconfig(libgit2) pkgconfig(libjpeg) pkgconfig(liblzma) pkgconfig(libtiff-4) pkgconfig(wcslib)"
