...
RPROVIDES:${PN} += "python3.9dist(docutils) python39-docutils python3dist(docutils)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-packaging python39-xml update-alternatives"
