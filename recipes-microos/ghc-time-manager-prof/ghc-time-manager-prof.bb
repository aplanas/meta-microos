...
RPROVIDES:${PN} += "ghc-prof(time-manager-0.0.0-49hD2RcPrUEG8anOiBePCj) ghc-time-manager-prof ghc-time-manager-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(auto-update-0.1.6-CObek7rRQnGB5D6p02bNzQ) ghc-prof(base-4.17.1.0) ghc-time-manager-devel"
