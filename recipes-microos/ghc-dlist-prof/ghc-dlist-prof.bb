...
RPROVIDES:${PN} += "ghc-dlist-prof ghc-dlist-prof(aarch-64) ghc-prof(dlist-1.0-BmTLN13CmmLQvuHz7BjP9)"
RDEPENDS:${PN} += "ghc-dlist-devel ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0)"
