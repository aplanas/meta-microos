...
RPROVIDES:${PN} += "ghc-prettyprinter-ansi-terminal-prof ghc-prettyprinter-ansi-terminal-prof(aarch-64) ghc-prof(prettyprinter-ansi-terminal-1.1.3-QQli2Jew8AdEXEsQuhGa)"
RDEPENDS:${PN} += "ghc-prettyprinter-ansi-terminal-devel ghc-prof(ansi-terminal-0.11.5-5x0MoHxm5r6DDoyv5djCW3) ghc-prof(base-4.17.1.0) ghc-prof(prettyprinter-1.7.1-1jjh6iCiPNl8MgeqtPsio2) ghc-prof(text-2.0.2)"
