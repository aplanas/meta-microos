...
RPROVIDES:${PN} += "typelib(RygelRenderer) typelib-1_0-RygelRenderer-2_8 typelib-1_0-RygelRenderer-2_8(aarch-64)"
RDEPENDS:${PN} += "typelib(GLib) typelib(GObject) typelib(GSSDP) typelib(GUPnP) typelib(GUPnPAV) typelib(Gee) typelib(Gio) typelib(RygelCore) typelib(Soup) typelib(libxml2)"
