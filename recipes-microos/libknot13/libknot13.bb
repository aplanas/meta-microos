...
RPROVIDES:${PN} += "libknot.so.13()(64bit) libknot13 libknot13(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libdnssec.so.9()(64bit) liblmdb-0.9.30.so()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.29)(64bit)"
