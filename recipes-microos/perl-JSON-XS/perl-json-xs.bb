...
RPROVIDES:${PN} += "perl(JSON::XS) perl-JSON-XS perl-JSON-XS(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/perl ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) perl(:MODULE_COMPAT_5.36.0) perl(Types::Serialiser) perl(common::sense)"
