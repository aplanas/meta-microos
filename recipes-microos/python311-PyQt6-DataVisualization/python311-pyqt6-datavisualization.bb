...
RPROVIDES:${PN} += "python3.11dist(pyqt6-datavisualization) python311-PyQt6-DataVisualization python311-PyQt6-DataVisualization(aarch-64) python311-qtdatavisualization-qt6 python3dist(pyqt6-datavisualization)"
