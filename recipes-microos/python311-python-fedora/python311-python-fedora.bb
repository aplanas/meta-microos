...
RPROVIDES:${PN} += "python3.11dist(python-fedora) python311-python-fedora python3dist(python-fedora)"
RDEPENDS:${PN} += "python(abi) python311-beautifulsoup4 python311-kitchen python311-lockfile python311-munch python311-openidc-client python311-requests python311-six"
