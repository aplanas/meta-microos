...
RPROVIDES:${PN} += "tex(invoice.sty) tex(invoicelabels.sty) texlive-invoice"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(fp.sty) tex(ifthen.sty) tex(longtable.sty) tex(siunitx.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
