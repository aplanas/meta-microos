...
RPROVIDES:${PN} += "python3.9dist(keyring) python39-keyring python3dist(keyring)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-SecretStorage python39-importlib-metadata python39-importlib-resources python39-jaraco.classes python39-jeepney update-alternatives"
