...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.GPMC.desktop) metainfo() metainfo(org.opensuse.yast.GPMC.metainfo.xml) yast-gpmc yast2-gpmc"
RDEPENDS:${PN} += "krb5-client python3-ldap samba-ad-dc samba-client samba-python3 yast2 yast2-adcommon-python yast2-python3-bindings"
