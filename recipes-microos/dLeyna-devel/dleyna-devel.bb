...
RPROVIDES:${PN} += "dLeyna-devel dLeyna-devel(aarch-64) dleyna-core-devel dleyna-renderer-devel dleyna-server-devel pkgconfig(dleyna-core-1.0) pkgconfig(dleyna-renderer-service-1.0) pkgconfig(dleyna-server-service-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config dLeyna pkgconfig(dleyna-core-1.0) pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gmodule-2.0) pkgconfig(gupnp-1.6) pkgconfig(gupnp-av-1.0) pkgconfig(gupnp-dlna-2.0) pkgconfig(libsoup-3.0) pkgconfig(libxml-2.0)"
