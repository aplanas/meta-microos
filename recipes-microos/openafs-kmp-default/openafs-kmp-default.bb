...
RPROVIDES:${PN} += "kmod(afspag.ko) kmod(libafs.ko) multiversion(kernel) openafs-kmp openafs-kmp-default openafs-kmp-default(aarch-64) openafs-kmp-default-k6.3.4_1"
