...
RPROVIDES:${PN} += "tex(ffcode.sty) texlive-ffcode"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(minted.sty) tex(pgfopts.sty) tex(tcolorbox.sty) texlive texlive-environ texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-microtype texlive-minted texlive-pgf texlive-scripts texlive-scripts-bin texlive-tcolorbox texlive-xkeyval"
