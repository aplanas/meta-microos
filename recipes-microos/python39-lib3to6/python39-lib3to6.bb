...
RPROVIDES:${PN} += "python3.9dist(lib3to6) python39-lib3to6 python3dist(lib3to6)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-astor python39-click python39-typing python39-wheel update-alternatives"
