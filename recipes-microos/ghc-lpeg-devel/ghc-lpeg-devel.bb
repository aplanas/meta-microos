...
RPROVIDES:${PN} += "ghc-devel(lpeg-1.0.4-IadFjeA522fGKCuUXCvVP9) ghc-lpeg-devel ghc-lpeg-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(lua-2.3.1-16mGxirchUh4T3oJJYdFzu) ghc-lpeg"
