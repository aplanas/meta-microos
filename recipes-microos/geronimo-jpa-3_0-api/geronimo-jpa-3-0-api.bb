...
RPROVIDES:${PN} += "geronimo-jpa-3_0-api jpa_3_0_api jpa_api mvn(javax.persistence:persistence-api) mvn(javax.persistence:persistence-api:pom:) mvn(org.apache.geronimo.specs:geronimo-jpa_3.0_spec) mvn(org.apache.geronimo.specs:geronimo-jpa_3.0_spec:pom:)"
