...
RPROVIDES:${PN} += "python3.9dist(sphinx-autobuild) python39-sphinx-autobuild python3dist(sphinx-autobuild)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Sphinx python39-colorama python39-livereload update-alternatives"
