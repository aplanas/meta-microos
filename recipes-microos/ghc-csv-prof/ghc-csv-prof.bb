...
RPROVIDES:${PN} += "ghc-csv-prof ghc-csv-prof(aarch-64) ghc-prof(csv-0.1.2-LKioaw43aTAAAKpIk04xxN)"
RDEPENDS:${PN} += "ghc-csv-devel ghc-prof(base-4.17.1.0) ghc-prof(filepath-1.4.2.2) ghc-prof(parsec-3.1.16.1)"
