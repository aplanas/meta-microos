...
RPROVIDES:${PN} += "pkgconfig(wpebackend-fdo-1.0) wpebackend-fdo-devel wpebackend-fdo-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libWPEBackend-fdo-1_0-1 pkgconfig(wpe-1.0)"
