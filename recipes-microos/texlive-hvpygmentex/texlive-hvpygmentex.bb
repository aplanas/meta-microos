...
RPROVIDES:${PN} += "tex(hvpygmentex.sty) texlive-hvpygmentex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(caption.sty) tex(color.sty) tex(efbox.sty) tex(fancyvrb.sty) tex(ifthen.sty) tex(mdframed.sty) tex(pgfkeys.sty) tex(shellesc.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
