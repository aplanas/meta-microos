...
RPROVIDES:${PN} += "typelib(UMockdev) typelib-1_0-UMockdev-1_0 typelib-1_0-UMockdev-1_0(aarch-64)"
RDEPENDS:${PN} += "libumockdev.so.0()(64bit) typelib(GLib) typelib(GObject)"
