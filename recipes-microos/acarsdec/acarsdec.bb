...
RPROVIDES:${PN} += "acarsdec acarsdec(aarch-64) bundled(cJSON)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libacars-2.so.2()(64bit) libacars-2.so.2(ACARS_2.0)(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libsndfile.so.1()(64bit) libsndfile.so.1(libsndfile.so.1.0)(64bit)"
