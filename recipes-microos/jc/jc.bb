...
RPROVIDES:${PN} += "jc python3.10dist(jc) python3dist(jc)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Pygments python3-ifconfig-parser python3-ruamel.yaml python3-xmltodict"
