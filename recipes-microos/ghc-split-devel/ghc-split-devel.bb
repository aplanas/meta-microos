...
RPROVIDES:${PN} += "ghc-devel(split-0.2.3.5-u3oGLAiW7JJbxIffWSCWf) ghc-split-devel ghc-split-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-split"
