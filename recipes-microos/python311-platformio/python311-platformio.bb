...
RPROVIDES:${PN} += "python3.11dist(platformio) python311-platformio python3dist(platformio)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-aiofiles python311-ajsonrpc python311-bottle python311-click python311-colorama python311-marshmallow python311-pyelftools python311-pyserial python311-requests python311-semantic_version python311-starlette python311-tabulate python311-uvicorn python311-wsproto python311-zeroconf update-alternatives"
