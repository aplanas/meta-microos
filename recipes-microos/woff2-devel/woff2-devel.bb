...
RPROVIDES:${PN} += "pkgconfig(libwoff2common) pkgconfig(libwoff2dec) pkgconfig(libwoff2enc) woff2-devel woff2-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libwoff2common1_0_2 libwoff2dec1_0_2 libwoff2enc1_0_2 pkgconfig(libbrotlidec) pkgconfig(libbrotlienc) pkgconfig(libwoff2common)"
