...
RPROVIDES:${PN} += "ghc-devel(regex-compat-0.95.2.1-9I4JwtnoxVY9Cu5lIL0XLJ) ghc-regex-compat-devel ghc-regex-compat-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(regex-base-0.94.0.2-8EhYuxSr6UD5zE7cP6wrkq) ghc-devel(regex-posix-0.96.0.1-Db56rsDUom23lFxliY5wt1) ghc-regex-compat"
