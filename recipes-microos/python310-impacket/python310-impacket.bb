...
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Flask python310-chardet python310-future python310-ldap3 python310-ldapdomaindump python310-pyOpenSSL python310-pyasn1 python310-pycryptodomex python310-six update-alternatives"
