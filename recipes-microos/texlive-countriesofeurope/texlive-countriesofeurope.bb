...
RPROVIDES:${PN} += "tex(countriesofeurope.enc) tex(countriesofeurope.map) tex(countriesofeurope.sty) tex(countriesofeurope.tfm) texlive-countriesofeurope"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontenc.sty) tex(fontspec.sty) tex(graphicx.sty) tex(ifluatex.sty) tex(ifxetex.sty) tex(textcomp.sty) tex(updmap.cfg) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-countriesofeurope-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
