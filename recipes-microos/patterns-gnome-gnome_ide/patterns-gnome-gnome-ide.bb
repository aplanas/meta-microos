...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() patterns-gnome-gnome_ide patterns-gnome-gnome_ide(aarch-64) patterns-openSUSE-gnome_ide"
RDEPENDS:${PN} += ""
