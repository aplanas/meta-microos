...
RPROVIDES:${PN} += "python3-barbicanclient python3.10dist(python-barbicanclient) python3dist(python-barbicanclient)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-cliff python3-keystoneauth1 python3-oslo.i18n python3-oslo.serialization python3-oslo.utils python3-pbr python3-requests python3-six"
