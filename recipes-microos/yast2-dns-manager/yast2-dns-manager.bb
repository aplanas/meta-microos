...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.DNS-MANAGER.desktop) metainfo() metainfo(org.opensuse.yast.DNS-MANAGER.metainfo.xml) yast2-dns-manager"
RDEPENDS:${PN} += "krb5-client samba-client samba-python3 yast2 yast2-adcommon-python yast2-python3-bindings"
