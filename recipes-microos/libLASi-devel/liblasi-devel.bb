...
RPROVIDES:${PN} += "libLASi-devel libLASi-devel(aarch-64) pkgconfig(lasi)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libLASi2 pkgconfig(freetype2) pkgconfig(pango) pkgconfig(pangoft2)"
