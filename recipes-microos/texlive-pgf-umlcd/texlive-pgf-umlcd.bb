...
RPROVIDES:${PN} += "tex(pgf-umlcd.sty) tex(tikzlibraryumlcd.code.tex) texlive-pgf-umlcd"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-latex texlive-pgf texlive-scripts texlive-scripts-bin"
