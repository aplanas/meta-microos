...
RPROVIDES:${PN} += "python3.9dist(helpdev) python39-helpdev python3dist(helpdev)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-importlib-metadata python39-psutil update-alternatives"
