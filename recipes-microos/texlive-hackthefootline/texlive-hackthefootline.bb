...
RPROVIDES:${PN} += "tex(hackthefootline.sty) texlive-hackthefootline"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(appendixnumberbeamer.sty) tex(calc.sty) tex(etoolbox.sty) tex(ifthen.sty) tex(numprint.sty) tex(pgfkeys.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
