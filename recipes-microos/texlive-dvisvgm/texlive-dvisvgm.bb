...
RPROVIDES:${PN} += "man(dvisvgm.1) texlive-dvisvgm"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-dvisvgm-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
