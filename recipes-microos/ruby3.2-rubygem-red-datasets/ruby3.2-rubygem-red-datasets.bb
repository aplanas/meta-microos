...
RPROVIDES:${PN} += "ruby3.2-rubygem-red-datasets ruby3.2-rubygem-red-datasets(aarch-64) rubygem(red-datasets) rubygem(ruby:3.2.0:red-datasets) rubygem(ruby:3.2.0:red-datasets:0) rubygem(ruby:3.2.0:red-datasets:0.1) rubygem(ruby:3.2.0:red-datasets:0.1.5)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:csv) rubygem(ruby:3.2.0:rexml) rubygem(ruby:3.2.0:rubyzip)"
