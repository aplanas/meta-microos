...
RPROVIDES:${PN} += "tex(cmupint.map) tex(cmupint.sty) tex(cmupint.tfm) tex(ucmupint.fd) texlive-cmupint"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-cmupint-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
