...
RPROVIDES:${PN} += "perl(Bundle::DBD::CSV) perl(DBD::CSV) perl(DBD::CSV::GetInfo) perl(DBD::CSV::Statement) perl(DBD::CSV::Table) perl(DBD::CSV::TypeInfo) perl(DBD::CSV::db) perl(DBD::CSV::dr) perl(DBD::CSV::st) perl-DBD-CSV"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DBD::File) perl(DBI) perl(SQL::Statement) perl(Test::More) perl(Text::CSV_XS)"
