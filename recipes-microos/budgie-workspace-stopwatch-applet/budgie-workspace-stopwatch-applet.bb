...
RPROVIDES:${PN} += "budgie-workspace-stopwatch-applet budgie-workspace-stopwatch-applet(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 python3-gobject-Gdk typelib(Budgie) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Gtk) typelib(Wnck)"
