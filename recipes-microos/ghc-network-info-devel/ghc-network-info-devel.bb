...
RPROVIDES:${PN} += "ghc-devel(network-info-0.2.1-G9nMDkAKQecAEHIupCmq9I) ghc-network-info-devel ghc-network-info-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-network-info"
