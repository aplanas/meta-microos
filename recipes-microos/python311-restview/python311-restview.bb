...
RPROVIDES:${PN} += "python3.11dist(restview) python311-restview python3dist(restview)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-docutils python311-pygments python311-readme_renderer update-alternatives"
