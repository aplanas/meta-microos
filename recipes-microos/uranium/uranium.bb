...
RPROVIDES:${PN} += "qt5qmlimport(UM.1) uranium"
RDEPENDS:${PN} += "python(abi) python3.10dist(arcus) python3.10dist(cryptography) python3.10dist(shapely) qt5qmlimport(QtGraphicalEffects.1) qt5qmlimport(QtQml.2) qt5qmlimport(QtQuick.2) qt5qmlimport(QtQuick.Controls.1) qt5qmlimport(QtQuick.Controls.2) qt5qmlimport(QtQuick.Controls.Private.1) qt5qmlimport(QtQuick.Controls.Styles.1) qt5qmlimport(QtQuick.Dialogs.1) qt5qmlimport(QtQuick.Layouts.1) qt5qmlimport(QtQuick.Window.2) qt5qmlimport(UM.1)"
