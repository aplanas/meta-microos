...
RPROVIDES:${PN} += "python3.9dist(twitter) python39-twitter python3dist(twitter)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python3.9dist(certifi) python3.9dist(setuptools) update-alternatives"
