...
RPROVIDES:${PN} += "libpgeasy libpgeasy.so.3()(64bit) libpgeasy3 libpgeasy3(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libpq.so.5()(64bit)"
