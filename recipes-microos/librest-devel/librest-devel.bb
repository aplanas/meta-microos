...
RPROVIDES:${PN} += "librest-devel librest-devel(aarch-64) pkgconfig(rest-1.0) pkgconfig(rest-extras-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config librest-1_0-0 pkgconfig(glib-2.0) pkgconfig(json-glib-1.0) pkgconfig(libsoup-3.0) pkgconfig(libxml-2.0) pkgconfig(rest-1.0) typelib-1_0-Rest-1_0"
