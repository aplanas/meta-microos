...
RPROVIDES:${PN} += "ghc-devel(indexed-profunctors-0.1.1-8slbuH4IUUg1HsCF6rf8GV) ghc-indexed-profunctors-devel ghc-indexed-profunctors-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-indexed-profunctors"
