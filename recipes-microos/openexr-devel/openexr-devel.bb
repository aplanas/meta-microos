...
RPROVIDES:${PN} += "OpenEXR-devel cmake(OpenEXR) ilmbase-devel libopenexr-devel openexr-devel openexr-devel(aarch-64) pkgconfig(OpenEXR)"
RDEPENDS:${PN} += "/usr/bin/pkg-config Imath-devel libOpenEXR-3_1-30 libOpenEXRCore-3_1-30 libOpenEXRUtil-3_1-30 pkgconfig pkgconfig(Imath) pkgconfig(zlib)"
