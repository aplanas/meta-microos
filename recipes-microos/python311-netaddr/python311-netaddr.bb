...
RPROVIDES:${PN} += "python3.11dist(netaddr) python311-netaddr python3dist(netaddr)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-importlib-metadata python311-importlib_resources update-alternatives"
