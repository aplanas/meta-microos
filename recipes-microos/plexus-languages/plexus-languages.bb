...
RPROVIDES:${PN} += "mvn(org.codehaus.plexus:plexus-java) mvn(org.codehaus.plexus:plexus-java:pom:) mvn(org.codehaus.plexus:plexus-languages:pom:) plexus-languages"
RDEPENDS:${PN} += "java java-headless javapackages-filesystem mvn(com.thoughtworks.qdox:qdox) mvn(org.ow2.asm:asm)"
