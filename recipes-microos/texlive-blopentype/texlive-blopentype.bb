...
RPROVIDES:${PN} += "tex(blot-files.tex) tex(blot-fonts.tex) tex(blot-lua.tex) tex(blot.tex) texlive-blopentype"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-gates texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-texapi texlive-yax"
