...
RPROVIDES:${PN} += "ocr_1_0_1-gnu-openmpi1-hpc-devel ocr_1_0_1-gnu-openmpi1-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "gnu-compilers-hpc-devel ocr_1_0_1-gnu-openmpi1-hpc openmpi1-gnu-hpc-devel"
