...
RPROVIDES:${PN} += "python3.9dist(passivetotal) python39-passivetotal python3dist(passivetotal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-ez_setup python39-future python39-python-dateutil python39-requests python39-tldextract update-alternatives"
