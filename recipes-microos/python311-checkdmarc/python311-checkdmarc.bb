...
RPROVIDES:${PN} += "python3.11dist(checkdmarc) python311-checkdmarc python3dist(checkdmarc)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-dnspython python311-expiringdict python311-publicsuffix2 python311-pyleri python311-requests python311-timeout-decorator"
