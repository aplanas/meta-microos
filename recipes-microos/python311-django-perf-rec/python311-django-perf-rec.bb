...
RPROVIDES:${PN} += "python3.11dist(django-perf-rec) python311-django-perf-rec python3dist(django-perf-rec)"
RDEPENDS:${PN} += "python(abi) python311-Django python311-PyYAML python311-sqlparse"
