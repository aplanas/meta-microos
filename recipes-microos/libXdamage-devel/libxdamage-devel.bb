...
RPROVIDES:${PN} += "libXdamage-devel libXdamage-devel(aarch-64) pkgconfig(xdamage)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXdamage1 pkgconfig(damageproto) pkgconfig(x11) pkgconfig(xfixes) pkgconfig(xproto)"
