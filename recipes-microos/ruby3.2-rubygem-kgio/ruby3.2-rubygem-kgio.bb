...
RPROVIDES:${PN} += "ruby3.2-rubygem-kgio ruby3.2-rubygem-kgio(aarch-64) rubygem(kgio) rubygem(ruby:3.2.0:kgio) rubygem(ruby:3.2.0:kgio:2) rubygem(ruby:3.2.0:kgio:2.11) rubygem(ruby:3.2.0:kgio:2.11.4)"
