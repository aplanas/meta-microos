...
RPROVIDES:${PN} += "font(:lang=bg) font(:lang=kum) font(:lang=os) font(:lang=ru) font(:lang=sel) font(dg) font(dgjhw) font(dm) font(mc) font(mc2) font(mr) font(mr2) texlive-wadalab-fonts"
