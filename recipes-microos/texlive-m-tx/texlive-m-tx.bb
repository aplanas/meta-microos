...
RPROVIDES:${PN} += "tex(mtx.tex) tex(mtxlatex.sty) texlive-m-tx"
RDEPENDS:${PN} += "/bin/sh /usr/bin/texlua coreutils ed findutils grep sed tex(etex.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-m-tx-bin texlive-scripts texlive-scripts-bin"
