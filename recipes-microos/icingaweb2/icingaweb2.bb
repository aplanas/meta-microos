...
RDEPENDS:${PN} += "(mod_php_any >= 7.3.0 or php-fpm) /bin/sh apache2 icinga-l10n icinga-php-library icinga-php-thirdparty icingacli icingaweb2-common icingaweb2-vendor-HTMLPurifier icingaweb2-vendor-JShrink icingaweb2-vendor-Parsedown icingaweb2-vendor-dompdf icingaweb2-vendor-lessphp php php-Icinga php-ldap php-mysql php-pgsql pwdutils"
