...
RPROVIDES:${PN} += "glassfish-annotation-api mvn(javax.annotation:javax.annotation-api) mvn(javax.annotation:javax.annotation-api:pom:) osgi(javax.annotation-api)"
