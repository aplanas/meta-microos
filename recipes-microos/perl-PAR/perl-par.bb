...
RPROVIDES:${PN} += "perl(PAR) perl(PAR::Heavy) perl(PAR::SetupProgname) perl(PAR::SetupTemp) perl-PAR"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Archive::Zip) perl(AutoLoader) perl(Compress::Zlib) perl(Digest::SHA) perl(PAR::Dist)"
