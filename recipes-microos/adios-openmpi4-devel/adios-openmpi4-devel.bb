...
RPROVIDES:${PN} += "adios-openmpi4-devel adios-openmpi4-devel(aarch-64)"
RDEPENDS:${PN} += "adios-openmpi4 adios-openmpi4-devel-static hdf5-openmpi4-devel netcdf-openmpi4-devel"
