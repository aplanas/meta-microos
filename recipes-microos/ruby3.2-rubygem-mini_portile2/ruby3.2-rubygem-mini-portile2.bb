...
RPROVIDES:${PN} += "ruby3.2-rubygem-mini_portile2 ruby3.2-rubygem-mini_portile2(aarch-64) rubygem(mini_portile2) rubygem(ruby:3.2.0:mini_portile2) rubygem(ruby:3.2.0:mini_portile2:2) rubygem(ruby:3.2.0:mini_portile2:2.8) rubygem(ruby:3.2.0:mini_portile2:2.8.0)"
