...
RPROVIDES:${PN} += "tex(ceit.tfm) tex(cerm.tfm) tex(cesl.tfm) tex(eurobf.tfm) tex(eurobfit.tfm) tex(eurobfsl.tfm) tex(euroit.tfm) tex(euroof.tfm) tex(eurorm.tfm) tex(eurosl.tfm) tex(eurosp.tfm) texlive-euro-ce"
