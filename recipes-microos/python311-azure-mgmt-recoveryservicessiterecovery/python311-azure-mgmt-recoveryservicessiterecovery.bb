...
RPROVIDES:${PN} += "python3.11dist(azure-mgmt-recoveryservicessiterecovery) python311-azure-mgmt-recoveryservicessiterecovery python3dist(azure-mgmt-recoveryservicessiterecovery)"
