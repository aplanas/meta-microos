...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.SambaProvision.desktop) metainfo() metainfo(org.opensuse.yast.SambaProvision.metainfo.xml) yast2-samba-provision"
RDEPENDS:${PN} += "yast2 yast2-network yast2-python3-bindings yast2-ruby-bindings"
