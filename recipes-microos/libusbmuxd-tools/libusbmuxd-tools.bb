...
RPROVIDES:${PN} += "iproxy libusbmuxd-tools libusbmuxd-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libusbmuxd-2.0.so.6()(64bit)"
