...
RPROVIDES:${PN} += "locale(spyder:de) locale(spyder:es) locale(spyder:fr) locale(spyder:hu) locale(spyder:ja) locale(spyder:pl) locale(spyder:pt_BR) locale(spyder:ru) locale(spyder:zh_CN) spyder-lang spyder-lang-all spyder3-lang"
RDEPENDS:${PN} += "spyder"
