...
RPROVIDES:${PN} += "libportal-devel libportal-devel(aarch-64) pkgconfig(libportal)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libportal-1 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) typelib-1_0-Xdp-1_0"
