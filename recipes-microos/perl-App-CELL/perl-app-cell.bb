...
RPROVIDES:${PN} += "perl(App::CELL) perl(App::CELL::Config) perl(App::CELL::Guide) perl(App::CELL::Load) perl(App::CELL::Log) perl(App::CELL::Message) perl(App::CELL::Status) perl(App::CELL::Test) perl(App::CELL::Test::LogToFile) perl(App::CELL::Util) perl-App-CELL"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Date::Format) perl(File::HomeDir) perl(File::Next) perl(File::ShareDir) perl(Log::Any) perl(Log::Any::Adapter) perl(Params::Validate) perl(Try::Tiny)"
