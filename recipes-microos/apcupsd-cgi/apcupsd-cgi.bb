...
RPROVIDES:${PN} += "apcupsd-cgi apcupsd-cgi(aarch-64) config(apcupsd-cgi)"
RDEPENDS:${PN} += "apcupsd ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgd.so.3()(64bit)"
