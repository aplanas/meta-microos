...
RPROVIDES:${PN} += "python3.9dist(xkbgroup) python39-xkbgroup python3dist(xkbgroup)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) update-alternatives xorg-x11-server"
