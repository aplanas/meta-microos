...
RPROVIDES:${PN} += "perl(PPIx::QuoteLike) perl(PPIx::QuoteLike::Constant) perl(PPIx::QuoteLike::Dumper) perl(PPIx::QuoteLike::Token) perl(PPIx::QuoteLike::Token::Control) perl(PPIx::QuoteLike::Token::Delimiter) perl(PPIx::QuoteLike::Token::Interpolation) perl(PPIx::QuoteLike::Token::String) perl(PPIx::QuoteLike::Token::Structure) perl(PPIx::QuoteLike::Token::Unknown) perl(PPIx::QuoteLike::Token::Whitespace) perl(PPIx::QuoteLike::Utils) perl-PPIx-QuoteLike"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(PPI::Document) perl(PPI::Dumper) perl(Readonly)"
