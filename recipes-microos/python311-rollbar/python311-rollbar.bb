...
RPROVIDES:${PN} += "python3.11dist(rollbar) python311-rollbar python3dist(rollbar)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-requests python311-setuptools python311-six update-alternatives"
