...
RPROVIDES:${PN} += "libv4l-devel libv4l-devel(aarch-64) pkgconfig(libv4l1) pkgconfig(libv4l2) pkgconfig(libv4l2rds) pkgconfig(libv4lconvert)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libv4l1-0 libv4l2-0 libv4l2rds0 libv4lconvert0 pkgconfig(libv4l2) pkgconfig(libv4lconvert)"
