...
RPROVIDES:${PN} += "perl(Spreadsheet::ParseXLSX) perl(Spreadsheet::ParseXLSX::Decryptor) perl(Spreadsheet::ParseXLSX::Decryptor::Agile) perl(Spreadsheet::ParseXLSX::Decryptor::Standard) perl-Spreadsheet-ParseXLSX"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Archive::Zip) perl(Crypt::Mode::CBC) perl(Crypt::Mode::ECB) perl(Digest::SHA) perl(Graphics::ColorUtils) perl(OLE::Storage_Lite) perl(Spreadsheet::ParseExcel) perl(XML::Twig)"
