...
RPROVIDES:${PN} += "python3.9dist(zeep) python39-zeep python3dist(zeep)"
RDEPENDS:${PN} += "python(abi) python39-attrs python39-cached-property python39-isodate python39-lxml python39-platformdirs python39-pytz python39-requests python39-requests-file python39-requests-toolbelt"
