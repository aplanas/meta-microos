...
RPROVIDES:${PN} += "python3.11dist(send2trash) python311-Send2Trash python3dist(send2trash)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) typelib(GObject) typelib(Gio) update-alternatives"
