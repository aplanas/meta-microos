...
RPROVIDES:${PN} += "pkgconfig(vala-panel) vala-panel-devel vala-panel-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gmodule-2.0) pkgconfig(gtk+-3.0) pkgconfig(libpeas-1.0) pkgconfig(libwnck-3.0) vala-panel"
