...
RPROVIDES:${PN} += "ghc-devel(skylighting-format-latex-0.1-BfMH5Wq0cc5AFSMLgsgxu) ghc-skylighting-format-latex-devel ghc-skylighting-format-latex-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(skylighting-core-0.13.2.1-6o4V0mA5OWyEHmMDE2dJ63) ghc-devel(text-2.0.2) ghc-skylighting-format-latex"
