...
RPROVIDES:${PN} += "python3.9dist(astropy-healpix) python39-astropy-healpix python39-astropy-healpix(aarch-64) python39-astropy_healpix python3dist(astropy-healpix)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-astropy python39-numpy"
