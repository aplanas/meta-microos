...
RPROVIDES:${PN} += "python3.11dist(ase) python311-ase python3dist(ase)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-matplotlib python311-numpy python311-scipy"
