...
RPROVIDES:${PN} += "libweston-12-0 libweston-12-0(aarch-64) libweston-12.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdrm.so.2()(64bit) libpixman-1.so.0()(64bit) libwayland-server.so.0()(64bit) libweston-12 libxkbcommon.so.0()(64bit) libxkbcommon.so.0(V_0.5.0)(64bit)"
