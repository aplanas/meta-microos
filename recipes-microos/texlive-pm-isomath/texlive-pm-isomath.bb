...
RPROVIDES:${PN} += "tex(pm-isomath.sty) texlive-pm-isomath"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(alphabeta.sty) tex(amsmath.sty) tex(etoolbox.sty) tex(iftex.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
