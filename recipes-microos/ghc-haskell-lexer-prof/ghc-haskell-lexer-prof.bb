...
RPROVIDES:${PN} += "ghc-haskell-lexer-prof ghc-haskell-lexer-prof(aarch-64) ghc-prof(haskell-lexer-1.1.1-FBBQnuYVuwZ6NRUVHfUjFR)"
RDEPENDS:${PN} += "ghc-haskell-lexer-devel ghc-prof(base-4.17.1.0)"
