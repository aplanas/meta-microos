...
RPROVIDES:${PN} += "tex(bitart.cls) tex(bitbeamer.cls) tex(bitbook.cls) tex(bitgrad.cls) tex(bithesis.cls) tex(bitreport.cls) texlive-bithesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsfonts.sty) tex(amsmath.sty) tex(amssymb.sty) tex(amsthm.sty) tex(array.sty) tex(biblatex.sty) tex(bm.sty) tex(booktabs.sty) tex(caption.sty) tex(ctexart.cls) tex(ctexbeamer.cls) tex(ctexbook.cls) tex(datetime2.sty) tex(dcolumn.sty) tex(enumitem.sty) tex(etoolbox.sty) tex(expl3.sty) tex(fancyhdr.sty) tex(float.sty) tex(fmtcount.sty) tex(fontspec.sty) tex(geometry.sty) tex(graphicx.sty) tex(hyperref.sty) tex(ifpdf.sty) tex(ifthen.sty) tex(indentfirst.sty) tex(kvoptions.sty) tex(l3keys2e.sty) tex(listings.sty) tex(mathrsfs.sty) tex(mhchem.sty) tex(multirow.sty) tex(pdfpages.sty) tex(pifont.sty) tex(setspace.sty) tex(siunitx.sty) tex(subfigure.sty) tex(threeparttable.sty) tex(tikz.sty) tex(titlesec.sty) tex(titletoc.sty) tex(unicode-math.sty) tex(upgreek.sty) tex(wrapfig.sty) tex(xcolor.sty) tex(xeCJK.sty) tex(xeCJKfntef.sty) tex(xltxtra.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
