...
RPROVIDES:${PN} += "ruby3.2-rubygem-xdg ruby3.2-rubygem-xdg(aarch-64) rubygem(ruby:3.2.0:xdg) rubygem(ruby:3.2.0:xdg:7) rubygem(ruby:3.2.0:xdg:7.0) rubygem(ruby:3.2.0:xdg:7.0.2) rubygem(xdg)"
