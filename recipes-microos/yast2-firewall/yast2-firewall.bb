...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.Firewall.desktop) metainfo() metainfo(org.opensuse.yast.Firewall.metainfo.xml) yast2-config-firewall yast2-firewall yast2-trans-firewall"
