...
RPROVIDES:${PN} += "libinstpatch-devel libinstpatch-devel(aarch-64) pkgconfig(libinstpatch-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libinstpatch-1_0-2 pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(gthread-2.0) pkgconfig(sndfile)"
