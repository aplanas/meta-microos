...
RPROVIDES:${PN} += "python3.9dist(rnc2rng) python39-rnc2rng python3dist(rnc2rng)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-rply update-alternatives"
