...
RPROVIDES:${PN} += "perl(IO::Handle::Iterator) perl(IO::Handle::Iterator::Buffered) perl(IO::Handle::Prototype) perl(IO::Handle::Prototype::Fallback) perl(IO::Handle::Util) perl(IO::Handle::Util::Overloading) perl(IO::Handle::Util::Tie) perl-IO-Handle-Util"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(IO::String) perl(Sub::Exporter) perl(asa) perl(autodie) perl(parent)"
