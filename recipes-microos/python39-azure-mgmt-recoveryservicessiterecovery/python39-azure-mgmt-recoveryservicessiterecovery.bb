...
RPROVIDES:${PN} += "python3.9dist(azure-mgmt-recoveryservicessiterecovery) python39-azure-mgmt-recoveryservicessiterecovery python3dist(azure-mgmt-recoveryservicessiterecovery)"
