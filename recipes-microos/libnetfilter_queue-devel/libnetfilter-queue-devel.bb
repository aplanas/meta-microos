...
RPROVIDES:${PN} += "libnetfilter_queue-devel libnetfilter_queue-devel(aarch-64) pkgconfig(libnetfilter_queue)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnetfilter_queue1 libnfnetlink-devel pkgconfig(libnfnetlink)"
