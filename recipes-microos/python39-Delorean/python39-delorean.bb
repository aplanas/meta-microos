...
RPROVIDES:${PN} += "python3.9dist(delorean) python39-Delorean python3dist(delorean)"
RDEPENDS:${PN} += "python(abi) python39-Babel python39-humanize python39-python-dateutil python39-pytz python39-tzlocal"
