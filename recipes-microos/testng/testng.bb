...
RPROVIDES:${PN} += "mvn(org.testng:testng) mvn(org.testng:testng::jdk15:) mvn(org.testng:testng:pom:) mvn(org.testng:testng:pom:jdk15:) osgi(org.testng) testng"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.beust:jcommander) mvn(org.yaml:snakeyaml)"
