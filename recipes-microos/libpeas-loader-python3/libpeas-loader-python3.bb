...
RPROVIDES:${PN} += "libpeas-loader-python3 libpeas-loader-python3(aarch-64) libpython3loader.so()(64bit)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libpeas-1.0.so.0()(64bit) libpython3.10.so.1.0()(64bit) typelib(GLib) typelib(GObject)"
