...
RPROVIDES:${PN} += "perl(DB) perl(Devel::PartialDump) perl-Devel-PartialDump"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Class::Tiny) perl(Sub::Exporter) perl(namespace::clean)"
