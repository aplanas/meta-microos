...
RPROVIDES:${PN} += "ocr_1_0_1-gnu-openmpi4-hpc ocr_1_0_1-gnu-openmpi4-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh gnu-compilers-hpc libc.so.6(GLIBC_2.34)(64bit) libopenmpi4-gnu-hpc lua-lmod openmpi4-gnu-hpc"
