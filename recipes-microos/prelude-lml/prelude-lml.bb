...
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgnutls.so.30()(64bit) libgnutls.so.30(GNUTLS_3_4)(64bit) libicui18n.so.73()(64bit) libicuuc.so.73()(64bit) libpcre.so.1()(64bit) libprelude.so.28()(64bit)"
