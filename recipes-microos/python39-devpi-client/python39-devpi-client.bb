...
RPROVIDES:${PN} += "python3.9dist(devpi-client) python39-devpi-client python3dist(devpi-client)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-build python39-check-manifest python39-devpi-common python39-pkginfo python39-pluggy python39-py python39-tox python39-wheel update-alternatives"
