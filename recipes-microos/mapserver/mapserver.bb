...
RPROVIDES:${PN} += "mapserver mapserver(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libfcgi.so.0()(64bit) libmapserver.so.2()(64bit) libmapserver2 proj"
