...
RPROVIDES:${PN} += "ghc-devel(stm-chans-3.0.0.9-KwAuYyoo9r3GoiDPqmpN5R) ghc-stm-chans-devel ghc-stm-chans-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(stm-2.5.1.0) ghc-stm-chans"
