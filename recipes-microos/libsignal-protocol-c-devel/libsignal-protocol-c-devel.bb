...
RPROVIDES:${PN} += "libsignal-protocol-c-devel libsignal-protocol-c-devel(aarch-64) pkgconfig(libsignal-protocol-c)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libsignal-protocol-c2"
