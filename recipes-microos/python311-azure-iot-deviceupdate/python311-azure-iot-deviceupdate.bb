...
RPROVIDES:${PN} += "python3.11dist(azure-iot-deviceupdate) python311-azure-iot-deviceupdate python3dist(azure-iot-deviceupdate)"
RDEPENDS:${PN} += "python(abi) python311-azure-core python311-azure-iot-nspkg python311-isodate"
