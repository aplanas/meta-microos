...
RPROVIDES:${PN} += "python3.9dist(pifpaf) python39-pifpaf python3dist(pifpaf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Jinja2 python39-click python39-daiquiri python39-fixtures python39-psutil python39-requests python39-testrepository python39-testtools python39-xattr update-alternatives"
