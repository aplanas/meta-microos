...
RPROVIDES:${PN} += "ghc-devel(mmorph-1.2.0-4Mt4o3YW9h63uaZAnM2RZC) ghc-mmorph-devel ghc-mmorph-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(mtl-2.2.2) ghc-devel(transformers-0.5.6.2) ghc-devel(transformers-compat-0.7.2-7jAnhjvxTABIymoNGHTOwd) ghc-mmorph"
