...
RPROVIDES:${PN} += "libASEKey.so()(64bit) pcsc-asekey pcsc-asekey(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libusb-0.1.so.4()(64bit) pcsc-lite"
