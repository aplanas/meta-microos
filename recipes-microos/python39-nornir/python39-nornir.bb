...
RPROVIDES:${PN} += "python3.9dist(nornir) python39-nornir python3dist(nornir)"
RDEPENDS:${PN} += "python(abi) python39-mypy_extensions python39-ruamel.yaml python39-typing_extensions"
