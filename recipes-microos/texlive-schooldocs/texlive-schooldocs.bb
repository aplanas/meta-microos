...
RPROVIDES:${PN} += "tex(schooldocs.sty) texlive-schooldocs"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fancybox.sty) tex(fancyhdr.sty) tex(geometry.sty) tex(ifthen.sty) tex(lastpage.sty) tex(translations.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
