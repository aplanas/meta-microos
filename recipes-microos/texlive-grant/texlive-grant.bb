...
RPROVIDES:${PN} += "tex(grant-afosr.cls) tex(grant-aro.cls) tex(grant-darpa.cls) tex(grant-doe.cls) tex(grant-nih.cls) tex(grant-nrl.cls) tex(grant-nsf.cls) tex(grant-onr.cls) tex(grant.cls) texlive-grant"
