...
RPROVIDES:${PN} += "python3-quimb python3.10dist(quimb) python310-quimb python310-quimb(aarch-64) python3dist(quimb)"
RDEPENDS:${PN} += "/bin/bash /bin/sh python(abi) python310-cytoolz python310-numba python310-numpy python310-opt-einsum python310-psutil python310-scipy python310-tqdm update-alternatives"
