...
RPROVIDES:${PN} += "perl(MooseX::Types::Set::Object) perl-MooseX-Types-Set-Object"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Moose) perl(MooseX::Types) perl(MooseX::Types::Moose) perl(Set::Object)"
