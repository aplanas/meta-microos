...
RPROVIDES:${PN} += "locale(pulseeffects:cs) locale(pulseeffects:de) locale(pulseeffects:fr_FR) locale(pulseeffects:hr) locale(pulseeffects:it_IT) locale(pulseeffects:pl) locale(pulseeffects:pt_BR) locale(pulseeffects:ru) locale(pulseeffects:sk) locale(pulseeffects:sv) pulseeffects-lang pulseeffects-lang-all"
