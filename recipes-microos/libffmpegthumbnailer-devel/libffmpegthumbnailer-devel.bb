...
RPROVIDES:${PN} += "libffmpegthumbnailer-devel libffmpegthumbnailer-devel(aarch-64) pkgconfig(libffmpegthumbnailer)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libffmpegthumbnailer4"
