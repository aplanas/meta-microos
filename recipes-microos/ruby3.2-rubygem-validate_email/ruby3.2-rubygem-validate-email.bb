...
RPROVIDES:${PN} += "ruby3.2-rubygem-validate_email ruby3.2-rubygem-validate_email(aarch-64) rubygem(ruby:3.2.0:validate_email) rubygem(ruby:3.2.0:validate_email:0) rubygem(ruby:3.2.0:validate_email:0.1) rubygem(ruby:3.2.0:validate_email:0.1.6) rubygem(validate_email)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:activemodel) rubygem(ruby:3.2.0:mail)"
