...
RPROVIDES:${PN} += "python3-pyviz-comms python3-pyviz_comms python3.10dist(pyviz-comms) python310-pyviz-comms python310-pyviz_comms python3dist(pyviz-comms)"
RDEPENDS:${PN} += "python(abi) python310-param"
