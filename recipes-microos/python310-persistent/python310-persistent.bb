...
RPROVIDES:${PN} += "python3-persistent python3.10dist(persistent) python310-persistent python310-persistent(aarch-64) python3dist(persistent)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-cffi python310-zope.interface"
