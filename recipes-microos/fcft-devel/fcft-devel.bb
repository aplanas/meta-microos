...
RPROVIDES:${PN} += "fcft-devel fcft-devel(aarch-64) pkgconfig(fcft)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libfcft4 pkgconfig(fontconfig) pkgconfig(freetype2) pkgconfig(harfbuzz) pkgconfig(libutf8proc) pkgconfig(pixman-1) pkgconfig(tllist)"
