...
RPROVIDES:${PN} += "typelib(GSSDP) typelib-1_0-GSSDP-1_0 typelib-1_0-GSSDP-1_0(aarch-64)"
RDEPENDS:${PN} += "libgssdp-1.6.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Soup)"
