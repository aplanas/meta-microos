...
RPROVIDES:${PN} += "python3-aubio python3.10dist(aubio) python310-aubio python310-aubio(aarch-64) python3dist(aubio)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-numpy update-alternatives"
