...
RPROVIDES:${PN} += "liblo.cpython-310-aarch64-linux-gnu.so()(64bit) python3-pyliblo python3.10dist(pyliblo) python310-pyliblo python310-pyliblo(aarch-64) python3dist(pyliblo)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) liblo.so.7()(64bit) python(abi)"
