...
RPROVIDES:${PN} += "python3.9dist(statsmodels) python39-statsmodels python39-statsmodels(aarch-64) python3dist(statsmodels)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-numpy python39-pandas python39-patsy python39-scipy"
