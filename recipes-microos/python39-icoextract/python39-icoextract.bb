...
RPROVIDES:${PN} += "python3.9dist(icoextract) python39-icoextract python3dist(icoextract)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-pefile update-alternatives"
