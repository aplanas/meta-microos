...
RPROVIDES:${PN} += "python3.9dist(qet-tb-generator) python39-qet_tb_generator python3dist(qet-tb-generator)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-qt5 qelectrotech update-alternatives"
