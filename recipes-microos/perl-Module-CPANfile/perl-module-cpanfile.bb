...
RPROVIDES:${PN} += "perl(Module::CPANfile) perl(Module::CPANfile::Environment) perl(Module::CPANfile::Prereq) perl(Module::CPANfile::Prereqs) perl(Module::CPANfile::Requirement) perl-Module-CPANfile"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(CPAN::Meta) perl(CPAN::Meta::Prereqs) perl(parent)"
