...
RPROVIDES:${PN} += "ghc-devel(unix-compat-0.6-79KxxZMmklx25hsmeEnenN) ghc-unix-compat-devel ghc-unix-compat-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(unix-2.7.3) ghc-unix-compat"
