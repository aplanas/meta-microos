...
RPROVIDES:${PN} += "python3.11dist(pydrive2) python311-pydrive2 python3dist(pydrive2)"
RDEPENDS:${PN} += "python(abi) python311-PyYAML python311-filelock python311-google-api-python-client python311-google-auth python311-google-auth-httplib2 python311-google-auth-oauthlib python311-pyOpenSSL python311-six"
