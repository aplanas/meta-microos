...
RPROVIDES:${PN} += "tex(tikzposter.cls) tex(tikzposterBackgroundstyles.tex) tex(tikzposterBlockstyles.tex) tex(tikzposterColorpalettes.tex) tex(tikzposterColorstyles.tex) tex(tikzposterInnerblockstyles.tex) tex(tikzposterLayoutthemes.tex) tex(tikzposterNotestyles.tex) tex(tikzposterTitlestyles.tex) texlive-tikzposter"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(a0size.sty) tex(ae.sty) tex(calc.sty) tex(etoolbox.sty) tex(extarticle.cls) tex(geometry.sty) tex(ifthen.sty) tex(tikz.sty) tex(xkeyval.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
