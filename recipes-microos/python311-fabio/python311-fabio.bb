...
RPROVIDES:${PN} += "python3.11dist(fabio) python311-fabio python311-fabio(aarch-64) python3dist(fabio)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-Pillow python311-h5py python311-lxml python311-numpy python311-qt5 update-alternatives"
