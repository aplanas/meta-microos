...
RPROVIDES:${PN} += "python3.11dist(nornir) python311-nornir python3dist(nornir)"
RDEPENDS:${PN} += "python(abi) python311-mypy_extensions python311-ruamel.yaml python311-typing_extensions"
