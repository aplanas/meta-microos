...
RPROVIDES:${PN} += "typelib(XdpGtk4) typelib-1_0-XdpGtk4-1_0 typelib-1_0-XdpGtk4-1_0(aarch-64)"
RDEPENDS:${PN} += "libportal-gtk4.so.1()(64bit) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Graphene) typelib(Gsk) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(PangoCairo) typelib(Xdp) typelib(cairo) typelib(freetype2)"
