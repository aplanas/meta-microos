...
RPROVIDES:${PN} += "python3-PyQt6-QScintilla python3-qscintilla-qt6 python3.10dist(pyqt6-qscintilla) python310-PyQt6-QScintilla python310-PyQt6-QScintilla(aarch-64) python310-qscintilla-qt6 python3dist(pyqt6-qscintilla)"
