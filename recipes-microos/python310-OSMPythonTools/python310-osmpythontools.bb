...
RPROVIDES:${PN} += "python3-OSMPythonTools python3.10dist(osmpythontools) python310-OSMPythonTools python3dist(osmpythontools)"
RDEPENDS:${PN} += "python(abi) python310-beautifulsoup4 python310-geojson python310-lxml python310-numpy python310-pandas python310-ujson python310-xarray"
