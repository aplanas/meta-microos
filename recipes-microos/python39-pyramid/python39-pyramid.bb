...
RPROVIDES:${PN} += "python3.9dist(pyramid) python39-pyramid python3dist(pyramid)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PasteDeploy python39-WebOb python39-hupper python39-plaster python39-plaster-pastedeploy python39-setuptools python39-translationstring python39-venusian python39-zope.deprecation python39-zope.interface update-alternatives"
