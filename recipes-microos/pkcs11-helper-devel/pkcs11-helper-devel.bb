...
RPROVIDES:${PN} += "pkcs11-helper-devel pkcs11-helper-devel(aarch-64) pkgconfig(libpkcs11-helper-1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkcs11-helper pkgconfig(openssl)"
