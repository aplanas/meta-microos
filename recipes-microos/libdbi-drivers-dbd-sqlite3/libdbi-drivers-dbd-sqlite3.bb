...
RPROVIDES:${PN} += "libdbdsqlite3.so()(64bit) libdbi-drivers-dbd-sqlite3 libdbi-drivers-dbd-sqlite3(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libdbi.so.3()(64bit) libdbi.so.3(ABI_3)(64bit) libsqlite3.so.0()(64bit)"
