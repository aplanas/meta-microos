...
RPROVIDES:${PN} += "ghc-mmorph-prof ghc-mmorph-prof(aarch-64) ghc-prof(mmorph-1.2.0-4Mt4o3YW9h63uaZAnM2RZC)"
RDEPENDS:${PN} += "ghc-mmorph-devel ghc-prof(base-4.17.1.0) ghc-prof(mtl-2.2.2) ghc-prof(transformers-0.5.6.2) ghc-prof(transformers-compat-0.7.2-7jAnhjvxTABIymoNGHTOwd)"
