...
RPROVIDES:${PN} += "libcgraph.so.6()(64bit) libcgraph6 libcgraph6(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcdt.so.5()(64bit)"
