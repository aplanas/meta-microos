...
RPROVIDES:${PN} += "python3.9dist(msoffcrypto-tool) python39-msoffcrypto-tool python3dist(msoffcrypto-tool)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-cryptography python39-olefile python39-setuptools update-alternatives"
