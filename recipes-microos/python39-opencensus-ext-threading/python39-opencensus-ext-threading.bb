...
RPROVIDES:${PN} += "python3.9dist(opencensus-ext-threading) python39-opencensus-ext-threading python3dist(opencensus-ext-threading)"
RDEPENDS:${PN} += "python(abi) python39-opencensus"
