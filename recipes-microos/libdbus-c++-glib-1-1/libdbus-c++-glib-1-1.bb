...
RPROVIDES:${PN} += "libdbus-c++-glib-1-1 libdbus-c++-glib-1-1(aarch-64) libdbus-c++-glib-1.so.1()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig libgcc_s.so.1()(64bit) libgcc_s.so.1(GCC_3.0)(64bit) libgcc_s.so.1(GCC_3.3.1)(64bit) libglib-2.0.so.0()(64bit) libstdc++.so.6()(64bit) libstdc++.so.6(CXXABI_1.3)(64bit) libstdc++.so.6(GLIBCXX_3.4)(64bit)"
