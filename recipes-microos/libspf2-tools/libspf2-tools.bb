...
RPROVIDES:${PN} += "libspf2-tools libspf2-tools(aarch-64) spf2"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libspf2.so.2()(64bit)"
