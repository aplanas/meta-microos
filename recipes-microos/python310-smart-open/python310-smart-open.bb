...
RPROVIDES:${PN} += "python3-smart-open python3.10dist(smart-open) python310-smart-open python3dist(smart-open)"
RDEPENDS:${PN} += "python(abi) python310-azure-common python310-azure-core python310-azure-storage-blob python310-boto3 python310-google-cloud-storage python310-requests"
