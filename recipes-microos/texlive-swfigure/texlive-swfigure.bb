...
RPROVIDES:${PN} += "tex(swfigure.sty) texlive-swfigure"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(afterpage.sty) tex(etoolbox.sty) tex(graphicx.sty) tex(wrapfig.sty) tex(wrapfig2.sty) tex(xfp.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
