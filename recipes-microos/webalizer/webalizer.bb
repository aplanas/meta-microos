...
RPROVIDES:${PN} += "config(webalizer) webalizer webalizer(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbz2.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) libdb-4.8.so()(64bit) libgd.so.3()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libz.so.1()(64bit) libz.so.1(ZLIB_1.2.3.3)(64bit) webalizer-flags"
