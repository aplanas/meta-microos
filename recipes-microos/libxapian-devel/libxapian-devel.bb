...
RPROVIDES:${PN} += "libxapian-devel libxapian-devel(aarch-64) pkgconfig(xapian-core)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config gcc-c++ libuuid-devel libxapian30 zlib-devel"
