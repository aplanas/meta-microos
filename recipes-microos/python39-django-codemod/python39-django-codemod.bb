...
RPROVIDES:${PN} += "python3.9dist(django-codemod) python39-django-codemod python3dist(django-codemod)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-click python39-libcst python39-pathspec python39-rich-click update-alternatives"
