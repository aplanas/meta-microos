...
RPROVIDES:${PN} += "python3-webruntime python3.10dist(webruntime) python310-webruntime python3dist(webruntime)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-dialite update-alternatives"
