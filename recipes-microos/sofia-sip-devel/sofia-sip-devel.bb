...
RPROVIDES:${PN} += "pkgconfig(sofia-sip-ua) pkgconfig(sofia-sip-ua-glib) sofia-sip-devel sofia-sip-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/awk /usr/bin/pkg-config glib2-devel libsofia-sip-ua-glib3 libsofia-sip-ua0 openssl-devel pkgconfig(glib-2.0) pkgconfig(sofia-sip-ua)"
