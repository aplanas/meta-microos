...
RPROVIDES:${PN} += "python3.9dist(nilearn) python39-nilearn python3dist(nilearn)"
RDEPENDS:${PN} += "/bin/bash python(abi) python39-joblib python39-matplotlib python39-nibabel python39-numpy python39-requests python39-scikit-learn python39-scipy"
