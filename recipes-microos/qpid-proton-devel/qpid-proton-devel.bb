...
RPROVIDES:${PN} += "cmake(Proton) cmake(ProtonCpp) pkgconfig(libqpid-proton) pkgconfig(libqpid-proton-core) pkgconfig(libqpid-proton-cpp) pkgconfig(libqpid-proton-proactor) qpid-proton-devel qpid-proton-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libqpid-proton-core10 libqpid-proton-cpp12 libqpid-proton11 pkgconfig(libqpid-proton-core) pkgconfig(libqpid-proton-proactor)"
