...
RPROVIDES:${PN} += "libskk-devel libskk-devel(aarch-64) pkgconfig(libskk)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libskk0 pkgconfig(gee-0.8) pkgconfig(gio-2.0) pkgconfig(gobject-2.0)"
