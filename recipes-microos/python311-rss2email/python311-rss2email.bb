...
RPROVIDES:${PN} += "python3.11dist(rss2email) python311-rss2email python3dist(rss2email)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python3.11dist(feedparser) python3.11dist(html2text) python311-feedparser python311-html2text python311-setuptools update-alternatives"
