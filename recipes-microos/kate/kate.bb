...
RPROVIDES:${PN} += "application() application(org.kde.kate.desktop) kate kate(aarch-64) kate5 libkateprivate.so.23.04.1()(64bit) metainfo() metainfo(org.kde.kate.appdata.xml) mimehandler(inode/directory) mimehandler(text/plain)"
