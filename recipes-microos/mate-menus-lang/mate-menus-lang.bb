...
locale(mate-menus:en_AU) \
locale(mate-menus:en_CA) \
locale(mate-menus:en_GB) \
locale(mate-menus:en_US) \
locale(mate-menus:eo) \
locale(mate-menus:es) \
locale(mate-menus:es_AR) \
locale(mate-menus:es_CL) \
locale(mate-menus:es_CO) \
locale(mate-menus:es_ES) \
locale(mate-menus:es_MX) \
locale(mate-menus:es_PR) \
locale(mate-menus:et) \
locale(mate-menus:eu) \
locale(mate-menus:fa) \
locale(mate-menus:fi) \
locale(mate-menus:fr) \
locale(mate-menus:fr_CA) \
...
locale(mate-menus:zh_CN) \
locale(mate-menus:zh_HK) \
locale(mate-menus:zh_TW) \
mate-menus-lang \
mate-menus-lang-all"
