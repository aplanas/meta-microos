...
RPROVIDES:${PN} += "ghc-devel(syb-0.7.2.3-J0Qw7O8gTR0DSXObDhEt8i) ghc-syb-devel ghc-syb-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-syb"
