...
RPROVIDES:${PN} += "gtkhtml-devel gtkhtml-devel(aarch-64) gtkhtml2-devel pkgconfig(gtkhtml-editor-4.0) pkgconfig(libgtkhtml-4.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libgtkhtml-4.0.so.0()(64bit) libgtkhtml-4_0-0 libgtkhtml-editor-4.0.so.0()(64bit) libgtkhtml-editor-4_0-0 pkgconfig(cairo) pkgconfig(enchant) pkgconfig(gsettings-desktop-schemas) pkgconfig(gtk+-3.0) pkgconfig(iso-codes) pkgconfig(libgtkhtml-4.0)"
