...
RPROVIDES:${PN} += "budgie-rotation-lock-applet budgie-rotation-lock-applet(aarch-64)"
RDEPENDS:${PN} += "python3-gobject-Gdk typelib(Budgie) typelib(GObject) typelib(Gio) typelib(Gtk)"
