...
RPROVIDES:${PN} += "ruby3.2-rubygem-multi_xml ruby3.2-rubygem-multi_xml(aarch-64) rubygem(multi_xml) rubygem(ruby:3.2.0:multi_xml) rubygem(ruby:3.2.0:multi_xml:0) rubygem(ruby:3.2.0:multi_xml:0.6) rubygem(ruby:3.2.0:multi_xml:0.6.0)"
