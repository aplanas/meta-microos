...
RPROVIDES:${PN} += "tex(ot-tableau.sty) texlive-ot-tableau"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(arydshln.sty) tex(bbding.sty) tex(colortbl.sty) tex(hhline.sty) tex(rotating.sty) tex(suffix.sty) tex(tipa.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
