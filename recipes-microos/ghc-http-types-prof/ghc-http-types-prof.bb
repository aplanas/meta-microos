...
RPROVIDES:${PN} += "ghc-http-types-prof ghc-http-types-prof(aarch-64) ghc-prof(http-types-0.12.3-4BrMFwRucoT4fBt8cCVFS6)"
RDEPENDS:${PN} += "ghc-http-types-devel ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(case-insensitive-1.2.1.0-AumZoR4Lds63HJj8OQwHY3) ghc-prof(text-2.0.2)"
