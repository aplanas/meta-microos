...
RPROVIDES:${PN} += "libcdio-devel libcdio-devel(aarch-64) pkgconfig(libcdio) pkgconfig(libcdio++) pkgconfig(libiso9660) pkgconfig(libiso9660++) pkgconfig(libudf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libcdio++1 libcdio19 libiso9660++0 libiso9660-11 libudf0 pkgconfig(libcdio)"
