...
RPROVIDES:${PN} += "ghc-devel(utility-ht-0.0.16-CDN97AfZiejDC1itvZ2hyN) ghc-utility-ht-devel ghc-utility-ht-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-utility-ht"
