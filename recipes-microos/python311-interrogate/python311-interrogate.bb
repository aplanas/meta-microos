...
RPROVIDES:${PN} += "python3.11dist(interrogate) python311-interrogate python3dist(interrogate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-attrs python311-click python311-colorama python311-py python311-tabulate python311-toml update-alternatives"
