...
RPROVIDES:${PN} += "tex(glossaries-portuges-noenc.ldf) tex(glossaries-portuges-utf8.ldf) tex(glossaries-portuges.ldf) tex(glossaries-pt-BR.ldf) texlive-glossaries-portuges"
