...
RPROVIDES:${PN} += "python3.9dist(pythreejs) python39-pythreejs python3dist(pythreejs)"
RDEPENDS:${PN} += "jupyter-threejs python(abi) python39-ipydatawidgets python39-ipywidgets python39-numpy python39-traitlets"
