...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.ADUC.desktop) yast-aduc yast2-aduc"
RDEPENDS:${PN} += "/usr/bin/env krb5-client samba-client samba-python3 yast2 yast2-adcommon-python yast2-python3-bindings"
