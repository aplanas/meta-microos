...
RPROVIDES:${PN} += "tex(curve2e-v161.sty) tex(curve2e.sty) texlive-curve2e"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(graphicx.sty) tex(pict2e.sty) tex(xfp.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
