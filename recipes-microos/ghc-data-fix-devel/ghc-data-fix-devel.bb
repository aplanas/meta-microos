...
RPROVIDES:${PN} += "ghc-data-fix-devel ghc-data-fix-devel(aarch-64) ghc-devel(data-fix-0.3.2-LdyR2jsAdh33KJZuVTGWPw)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-data-fix ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt)"
