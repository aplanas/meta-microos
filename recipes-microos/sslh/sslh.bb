...
RPROVIDES:${PN} += "config(sslh) sslh sslh(aarch-64)"
RDEPENDS:${PN} += "/bin/sh group(nobody) ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libconfig.so.11()(64bit) libpcre2-8.so.0()(64bit) openssh openssl systemd"
