...
RPROVIDES:${PN} += "python3.11dist(google-cloud-core) python311-google-cloud-core python3dist(google-cloud-core)"
RDEPENDS:${PN} += "python(abi) python311-google-api-core python311-google-auth python311-six"
