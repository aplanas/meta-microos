...
RPROVIDES:${PN} += "cmake(QuaZip-Qt6) pkgconfig(quazip1-qt6) quazip-qt6-devel quazip-qt6-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config cmake(Qt6Core) cmake(Qt6Core5Compat) libquazip1-qt6-1_4_0 pkgconfig(Qt6Core) pkgconfig(bzip2) pkgconfig(zlib)"
