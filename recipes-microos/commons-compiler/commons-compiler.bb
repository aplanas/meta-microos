...
RPROVIDES:${PN} += "commons-compiler mvn(org.codehaus.janino:commons-compiler) mvn(org.codehaus.janino:commons-compiler:pom:) osgi(org.codehaus.janino.commons-compiler)"
