...
RPROVIDES:${PN} += "cmake(pybind11) pkgconfig(pybind11) python-pybind11-common-devel python310-pybind11-common-devel python311-pybind11-common-devel python39-pybind11-common-devel"
