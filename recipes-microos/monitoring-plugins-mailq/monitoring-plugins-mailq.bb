...
RPROVIDES:${PN} += "config(monitoring-plugins-mailq) monitoring-plugins-mailq monitoring-plugins-mailq(aarch-64) nagios-plugins-mailq"
RDEPENDS:${PN} += "/usr/bin/perl monitoring-plugins-common perl smtp_daemon"
