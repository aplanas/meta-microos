...
RPROVIDES:${PN} += "python3-Babel python3-babel python3.10dist(babel) python310-Babel python3dist(babel)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 alts python(abi) python310-pytz"
