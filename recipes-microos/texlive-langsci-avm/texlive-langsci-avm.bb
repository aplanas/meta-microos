...
RPROVIDES:${PN} += "tex(langsci-avm.sty) texlive-langsci-avm"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(etoolbox.sty) tex(tikz.sty) tex(unicode-math.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
