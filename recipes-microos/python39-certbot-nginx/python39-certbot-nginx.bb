...
RPROVIDES:${PN} += "python3.9dist(certbot-nginx) python39-certbot-nginx python3dist(certbot-nginx)"
RDEPENDS:${PN} += "nginx python(abi) python39-acme python39-certbot python39-pyOpenSSL python39-pyparsing"
