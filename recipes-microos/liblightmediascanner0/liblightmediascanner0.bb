...
RPROVIDES:${PN} += "liblightmediascanner.so.0()(64bit) liblightmediascanner0 liblightmediascanner0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libmagic.so.1()(64bit) libsqlite3.so.0()(64bit)"
