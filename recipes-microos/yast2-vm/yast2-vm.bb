...
application(org.opensuse.yast.RelocationServer.desktop) \
application(org.opensuse.yast.VirtualizationConfig.desktop) \
metainfo() \
metainfo(org.opensuse.yast.RelocationServer.metainfo.xml) \
