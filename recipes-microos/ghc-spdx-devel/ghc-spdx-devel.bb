...
RPROVIDES:${PN} += "ghc-devel(spdx-1.0.0.3-JwdNfzEpnM57Bwmw6OiiTp) ghc-spdx-devel ghc-spdx-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(Cabal-3.8.1.0) ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(transformers-0.5.6.2) ghc-spdx"
