...
RPROVIDES:${PN} += "python3.9dist(python-pptx) python39-python-pptx python3dist(python-pptx)"
RDEPENDS:${PN} += "python(abi) python39-Pillow python39-XlsxWriter python39-lxml"
