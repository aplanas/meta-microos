...
RPROVIDES:${PN} += "tex(t1yfrak.fd) tex(tfrak.tfm) tex(tfrak.vf) tex(tfrakls.tfm) tex(tfrakls.vf) tex(tgoth.tfm) tex(tgoth.vf) tex(tswab.tfm) tex(tswab.vf) texlive-blacklettert1"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(cmbsy10.tfm) tex(cmbx10.tfm) tex(cmmi10.tfm) tex(cmmib10.tfm) tex(cmr10.tfm) tex(cmr7.tfm) tex(cmsy10.tfm) tex(cmu10.tfm) tex(ecbx1000.tfm) tex(ecrm0700.tfm) tex(ecrm1000.tfm) tex(yfrak.tfm) tex(ygoth.tfm) tex(yswab.tfm) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
