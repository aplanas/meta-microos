...
RPROVIDES:${PN} += "tex(akkconditional.sty) tex(akkcounterlabelpattern.sty) tex(akkcs.sty) tex(akkdoc.sty) tex(akkgerman.sty) tex(akkgermanabbreviations.sty) tex(akklecture.cls) tex(akklongpage.sty) tex(akkmath.sty) tex(akkmathbasic.sty) tex(akkmathdisc.sty) tex(akkmathfun.sty) tex(akkmathnum.sty) tex(akkmathpaper.sty) tex(akkmathproof.sty) tex(akkmathrel.sty) tex(akkmathset.sty) tex(akkmathtext.sty) tex(akknum.sty) tex(akkparskip.sty) tex(akkscript.cls) tex(akksection.sty) tex(akkstring.sty) tex(akktecdoc.cls) tex(akktex.sty) tex(akkwidepage.sty) texlive-akktex"
