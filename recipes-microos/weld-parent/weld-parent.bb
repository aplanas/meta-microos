...
RPROVIDES:${PN} += "mvn(org.jboss.weld:weld-parent:pom:) weld-parent"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven.plugins:maven-source-plugin) mvn(org.codehaus.mojo:build-helper-maven-plugin)"
