...
RPROVIDES:${PN} += "tex(datetime2-serbian-base-ascii.ldf) tex(datetime2-serbian-base-utf8.ldf) tex(datetime2-serbian-base.ldf) tex(datetime2-serbian.ldf) tex(datetime2-serbianc.ldf) tex(datetime2-sr-Cyrl-BA.ldf) tex(datetime2-sr-Cyrl-ME.ldf) tex(datetime2-sr-Cyrl-RS.ldf) tex(datetime2-sr-Cyrl.ldf) tex(datetime2-sr-Latn-BA.ldf) tex(datetime2-sr-Latn-ME.ldf) tex(datetime2-sr-Latn-RS.ldf) tex(datetime2-sr-Latn.ldf) texlive-datetime2-serbian"
