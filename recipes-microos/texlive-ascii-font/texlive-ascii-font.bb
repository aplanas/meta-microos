...
RPROVIDES:${PN} += "tex(ASCII.tfm) tex(ascii.map) tex(ascii.sty) texlive-ascii texlive-ascii-font"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) tex(xspace.sty) texlive texlive-ascii-font-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
