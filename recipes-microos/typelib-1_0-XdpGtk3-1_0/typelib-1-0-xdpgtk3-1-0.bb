...
RPROVIDES:${PN} += "typelib(XdpGtk3) typelib-1_0-XdpGtk3-1_0 typelib-1_0-XdpGtk3-1_0(aarch-64)"
RDEPENDS:${PN} += "libportal-gtk3.so.1()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(Xdp) typelib(cairo) typelib(freetype2) typelib(xlib)"
