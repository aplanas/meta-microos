...
RPROVIDES:${PN} += "ghc-prof(th-lift-0.8.3-BVnK9vFPlpnBx7d6MzGvJN) ghc-th-lift-prof ghc-th-lift-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(ghc-prim-0.9.0) ghc-prof(template-haskell-2.19.0.0) ghc-prof(th-abstraction-0.4.5.0-8bY5lBPMorfFW3yG6gFNZT) ghc-th-lift-devel"
