...
RPROVIDES:${PN} += "apache-commons-el commons-el jakarta-commons-el mvn(commons-el:commons-el) mvn(commons-el:commons-el:pom:) mvn(org.apache.commons:commons-el) mvn(org.apache.commons:commons-el:pom:) osgi(org.apache.commons.el)"
