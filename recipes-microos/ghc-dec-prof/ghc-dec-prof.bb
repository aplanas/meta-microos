...
RPROVIDES:${PN} += "ghc-dec-prof ghc-dec-prof(aarch-64) ghc-prof(dec-0.0.5-4k85S2UkQTWCpK3j0IuOFm)"
RDEPENDS:${PN} += "ghc-dec-devel ghc-prof(base-4.17.1.0) ghc-prof(boring-0.2.1-J8lJX6Vz53r2bssyBwOtpl)"
