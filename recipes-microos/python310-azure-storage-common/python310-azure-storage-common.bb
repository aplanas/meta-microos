...
RPROVIDES:${PN} += "python3-azure-storage-common python3.10dist(azure-storage-common) python310-azure-storage-common python3dist(azure-storage-common)"
RDEPENDS:${PN} += "python(abi) python310-azure-common python310-azure-nspkg python310-azure-storage-nspkg python310-cryptography python310-python-dateutil python310-requests"
