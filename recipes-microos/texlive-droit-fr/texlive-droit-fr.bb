...
RPROVIDES:${PN} += "tex(droit-fr.bbx) tex(droit-fr.cbx) tex(droit-fr.cls) texlive-droit-fr"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(babel.sty) tex(csquotes.sty) tex(engrec.sty) tex(filecontents.sty) tex(footmisc.sty) tex(ifdraft.sty) tex(ifluatex.sty) tex(inputenc.sty) tex(kvoptions.sty) tex(refcount.sty) tex(verbose-ibid.bbx) tex(verbose-ibid.cbx) tex(xifthen.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
