...
RPROVIDES:${PN} += "kanku-dispatcher perl(Kanku::Daemon::Dispatcher) perl(Kanku::Dispatch::RabbitMQ)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/env kanku-common kanku-common-server perl(Net::AMQP::RabbitMQ) sudo"
