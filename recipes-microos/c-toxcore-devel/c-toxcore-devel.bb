...
RPROVIDES:${PN} += "c-toxcore-devel c-toxcore-devel(aarch-64) pkgconfig(toxcore)"
RDEPENDS:${PN} += "/usr/bin/pkg-config c-toxcore libtoxcore2 pkgconfig(libsodium) pkgconfig(opus) pkgconfig(vpx)"
