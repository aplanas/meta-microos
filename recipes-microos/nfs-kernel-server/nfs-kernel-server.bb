...
RPROVIDES:${PN} += "config(nfs-kernel-server) nfs-kernel-server nfs-kernel-server(aarch-64) nfs-utils"
RDEPENDS:${PN} += "(kmod(nfsd.ko) if kernel) /bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libblkid.so.1()(64bit) libblkid.so.1(BLKID_1.0)(64bit) libc.so.6(GLIBC_2.34)(64bit) libevent_core-2.1.so.7()(64bit) libnss_usrfiles2 libsqlite3.so.0()(64bit) libtirpc.so.3()(64bit) libtirpc.so.3(TIRPC_0.3.0)(64bit) libuuid.so.1()(64bit) libuuid.so.1(UUID_1.0)(64bit) libuuid.so.1(UUID_2.31)(64bit) netcfg nfs-client permissions rpcbind"
