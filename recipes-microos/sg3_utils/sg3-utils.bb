...
RPROVIDES:${PN} += "scsi sg3_utils sg3_utils(aarch-64) sg_utils"
RDEPENDS:${PN} += "/bin/bash /bin/sh coreutils ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libsgutils2-1.48.so.2()(64bit)"
