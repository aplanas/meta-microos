...
RPROVIDES:${PN} += "libXft-devel libXft-devel(aarch-64) pkgconfig(xft)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXft2 pkgconfig(fontconfig) pkgconfig(freetype2) pkgconfig(xproto) pkgconfig(xrender)"
