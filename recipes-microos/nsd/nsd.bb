...
RPROVIDES:${PN} += "config(nsd) nsd nsd(aarch-64)"
RDEPENDS:${PN} += "/bin/sh coreutils findutils ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.36)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libevent-2.1.so.7()(64bit) libssl.so.3()(64bit) libssl.so.3(OPENSSL_3.0.0)(64bit) pwdutils shadow systemd"
