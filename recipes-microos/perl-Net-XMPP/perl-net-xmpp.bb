...
RPROVIDES:${PN} += "perl(Net::XMPP) perl(Net::XMPP::Client) perl(Net::XMPP::Connection) perl(Net::XMPP::Debug) perl(Net::XMPP::IQ) perl(Net::XMPP::JID) perl(Net::XMPP::Message) perl(Net::XMPP::Namespaces) perl(Net::XMPP::Presence) perl(Net::XMPP::PrivacyLists) perl(Net::XMPP::Protocol) perl(Net::XMPP::Roster) perl(Net::XMPP::Stanza) perl-Net-XMPP"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Authen::SASL) perl(Digest::SHA) perl(XML::Stream)"
