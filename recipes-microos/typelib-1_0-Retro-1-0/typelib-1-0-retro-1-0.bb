...
RPROVIDES:${PN} += "typelib(Retro) typelib-1_0-Retro-1-0 typelib-1_0-Retro-1-0(aarch-64)"
RDEPENDS:${PN} += "libretro-gtk-1.so.0()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
