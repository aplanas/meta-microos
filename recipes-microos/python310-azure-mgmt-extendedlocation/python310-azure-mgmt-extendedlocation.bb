...
RPROVIDES:${PN} += "python3-azure-mgmt-extendedlocation python3.10dist(azure-mgmt-extendedlocation) python310-azure-mgmt-extendedlocation python3dist(azure-mgmt-extendedlocation)"
