...
RPROVIDES:${PN} += "python3.11dist(jfscripts) python311-jfscripts python3dist(jfscripts)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyPDF2 python311-sphinx-argparse python311-termcolor update-alternatives"
