...
RPROVIDES:${PN} += "config(docbook-xml-slides) docbook-xml-slides"
RDEPENDS:${PN} += "/bin/sh /usr/bin/edit-xml-catalog /usr/bin/sgml-register-catalog /usr/bin/xmlcatalog awk docbook-xsl-stylesheets docbook_4 grep sed xmlcharent"
