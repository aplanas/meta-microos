...
RPROVIDES:${PN} += "libusbauth-configparser-devel libusbauth-configparser-devel(aarch-64) pkgconfig(libusbauth-configparser)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libusbauth-configparser1"
