...
RPROVIDES:${PN} += "ghc-devel(network-uri-2.6.4.2-4kNQnaE9heqEL1mH8FE5xH) ghc-network-uri-devel ghc-network-uri-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(parsec-3.1.16.1) ghc-devel(template-haskell-2.19.0.0) ghc-devel(th-compat-0.1.4-Bzk38miPOyTJh1KMkOoOkv) ghc-network-uri"
