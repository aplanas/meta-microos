...
RPROVIDES:${PN} += "python3.9dist(py7zr) python39-py7zr python3dist(py7zr)"
RDEPENDS:${PN} += "(python39-pyppmd >= 0.18.1 with python39-pyppmd < 1.1.0) /bin/sh /usr/bin/python3.9 python(abi) python39-Brotli python39-inflate64 python39-multivolumefile python39-psutil python39-pybcj python39-pycryptodomex python39-pyzstd python39-texttable update-alternatives"
