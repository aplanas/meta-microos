...
RPROVIDES:${PN} += "ghc-libyaml-prof ghc-libyaml-prof(aarch-64) ghc-prof(libyaml-0.1.2-HGo47aMnIYAKZUBwKE0axw)"
RDEPENDS:${PN} += "ghc-libyaml-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(conduit-1.3.4.3-dAZVHPSYjL2zQ4RzAuWi2) ghc-prof(resourcet-1.2.6-69eF6Rrz9wX13sOJF59GPv)"
