...
RPROVIDES:${PN} += "ruby3.2-rubygem-commander \
ruby3.2-rubygem-commander(aarch-64) \
rubygem(commander) \
rubygem(ruby:3.2.0:commander) \
rubygem(ruby:3.2.0:commander:4) \
rubygem(ruby:3.2.0:commander:4.6) \
rubygem(ruby:3.2.0:commander:4.6.0)"
RDEPENDS:${PN} += "/bin/sh \
