...
RPROVIDES:${PN} += "libathemecore.so.1()(64bit) libathemecore1 libathemecore1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.36)(64bit) libmowgli-2.so.0()(64bit) libmowgli-2.so.0(V_2.1.3)(64bit) libpcre.so.1()(64bit) libqrencode.so.4()(64bit)"
