...
RPROVIDES:${PN} += "python3.9dist(pyqt6-webengine) python39-PyQt6-WebEngine python39-PyQt6-WebEngine(aarch-64) python39-qtwebengine-qt6 python3dist(pyqt6-webengine)"
