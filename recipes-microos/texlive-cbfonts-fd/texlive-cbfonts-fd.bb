...
RPROVIDES:${PN} += "tex(lgrcmr.fd) tex(lgrcmro.fd) tex(lgrcmss.fd) tex(lgrcmtt.fd) tex(lgrlcmss.fd) tex(lgrlcmtt.fd) tex(lgrlmr.fd) tex(lgrlmro.fd) tex(lgrlmss.fd) tex(lgrlmtt.fd) texlive-cbfonts-fd"
