...
RPROVIDES:${PN} += "gvfs-backend-samba gvfs-backend-samba(aarch-64)"
RDEPENDS:${PN} += "gvfs gvfs-backends ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgvfscommon.so()(64bit) libgvfsdaemon.so()(64bit) libsmbclient.so.0()(64bit) libsmbclient.so.0(SMBCLIENT_0.1.0)(64bit) libsmbclient.so.0(SMBCLIENT_0.5.0)(64bit) libsmbclient.so.0(SMBCLIENT_0.6.0)(64bit)"
