...
RPROVIDES:${PN} += "ruby3.2-rubygem-mini_magick \
ruby3.2-rubygem-mini_magick(aarch-64) \
rubygem(mini_magick) \
rubygem(ruby:3.2.0:mini_magick) \
rubygem(ruby:3.2.0:mini_magick:4) \
rubygem(ruby:3.2.0:mini_magick:4.12) \
rubygem(ruby:3.2.0:mini_magick:4.12.0)"
