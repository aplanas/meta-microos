...
RPROVIDES:${PN} += "tex(german-musuos.lbx) tex(musuos.bbx) tex(musuos.cbx) texlive-biblatex-musuos"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(authortitle.bbx) tex(verbose-ibid.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
