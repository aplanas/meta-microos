...
RPROVIDES:${PN} += "ghc-devel(filepattern-0.1.3-CFBsL0RN2YG3tR2tZTKdgo) ghc-filepattern-devel ghc-filepattern-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(directory-1.3.7.1) ghc-devel(extra-1.7.13-CLIQu72ADU8JHmf7UWoQG4) ghc-devel(filepath-1.4.2.2) ghc-filepattern"
