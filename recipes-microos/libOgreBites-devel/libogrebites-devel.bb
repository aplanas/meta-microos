...
RPROVIDES:${PN} += "libOgreBites-devel libOgreBites-devel(aarch-64) pkgconfig(OGRE-Bites)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libOgreBites13_5 libOgreBitesQt13_5 pkgconfig(OGRE) pkgconfig(sdl2)"
