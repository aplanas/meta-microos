...
RPROVIDES:${PN} += "python3.9dist(pyusid) python39-pyUSID python3dist(pyusid)"
RDEPENDS:${PN} += "python(abi) python39-Pillow python39-cytoolz python39-dask python39-h5py python39-numpy python39-psutil python39-sidpy python39-toolz"
