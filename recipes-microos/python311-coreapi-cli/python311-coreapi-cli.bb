...
RPROVIDES:${PN} += "python3.11dist(coreapi-cli) python311-coreapi-cli python3dist(coreapi-cli)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-click python311-coreapi python311-coreschema python311-itypes python311-requests python311-uritemplate update-alternatives"
