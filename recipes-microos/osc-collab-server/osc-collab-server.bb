...
RPROVIDES:${PN} += "config(osc-collab-server) osc-collab-server"
RDEPENDS:${PN} += "/bin/sh /usr/bin/env /usr/bin/python3 osc python3 python3-feedparser python3-rpm python3-sgmllib3k python3-xml user(osc-collab) withlock"
