...
RPROVIDES:${PN} += "libgxps-devel libgxps-devel(aarch-64) pkgconfig(libgxps)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgxps2 pkgconfig(cairo) pkgconfig(gio-2.0) pkgconfig(gobject-2.0) pkgconfig(libarchive) typelib-1_0-GXPS-0_1"
