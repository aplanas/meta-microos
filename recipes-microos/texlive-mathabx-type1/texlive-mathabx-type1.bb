...
RPROVIDES:${PN} += "tex(mathabx.map) texlive-mathabx-type1"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-mathabx texlive-mathabx-type1-fonts texlive-scripts texlive-scripts-bin"
