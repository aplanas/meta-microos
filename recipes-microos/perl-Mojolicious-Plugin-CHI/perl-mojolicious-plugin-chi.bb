...
RPROVIDES:${PN} += "perl(Mojolicious::Plugin::CHI) perl(Mojolicious::Plugin::CHI::chi) perl-Mojolicious-Plugin-CHI"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(CHI) perl(Digest::JHash) perl(Mojolicious)"
