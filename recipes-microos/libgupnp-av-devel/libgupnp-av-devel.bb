...
RDEPENDS:${PN} += "/usr/bin/pkg-config libgupnp-av-1_0-3 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libxml-2.0) typelib-1_0-GUPnPAV-1_0"
