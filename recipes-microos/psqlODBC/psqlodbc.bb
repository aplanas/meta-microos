...
RPROVIDES:${PN} += "pg_iface:/usr/lib/pgsql/odbcinst.ini pg_odbc postgresql-odbc psqlODBC psqlODBC(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/odbcinst ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libodbcinst.so.2()(64bit) libpq.so.5()(64bit)"
