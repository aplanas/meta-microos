...
RPROVIDES:${PN} += "python3.11dist(flake8-import-order) python311-flake8-import-order python3dist(flake8-import-order)"
RDEPENDS:${PN} += "python(abi) python311-flake8 python311-pycodestyle"
