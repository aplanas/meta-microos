...
RPROVIDES:${PN} += "python3.9dist(misaka) python39-misaka python39-misaka(aarch-64) python3dist(misaka)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-cffi update-alternatives"
