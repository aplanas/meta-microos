...
RPROVIDES:${PN} += "libepc-devel libepc-devel(aarch-64) pkgconfig(libepc-1.0) pkgconfig(libepc-ui-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libepc-1_0-3 pkgconfig(avahi-client) pkgconfig(avahi-glib) pkgconfig(gnutls) pkgconfig(gtk+-3.0) pkgconfig(libepc-1.0) pkgconfig(libsoup-2.4)"
