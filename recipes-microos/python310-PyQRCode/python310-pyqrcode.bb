...
RPROVIDES:${PN} += "python3-PyQRCode python3-PyQRCodeNG python3-pyqrcodeng python3.10dist(pyqrcodeng) python310-PyQRCode python310-PyQRCodeNG python310-pyqrcodeng python3dist(pyqrcodeng)"
