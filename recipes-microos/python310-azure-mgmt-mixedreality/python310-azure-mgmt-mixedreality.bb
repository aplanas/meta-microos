...
RPROVIDES:${PN} += "python3-azure-mgmt-mixedreality python3.10dist(azure-mgmt-mixedreality) python310-azure-mgmt-mixedreality python3dist(azure-mgmt-mixedreality)"
