...
RPROVIDES:${PN} += "ruby3.2-rubygem-ruby-progressbar ruby3.2-rubygem-ruby-progressbar(aarch-64) rubygem(ruby-progressbar) rubygem(ruby:3.2.0:ruby-progressbar) rubygem(ruby:3.2.0:ruby-progressbar:1) rubygem(ruby:3.2.0:ruby-progressbar:1.11) rubygem(ruby:3.2.0:ruby-progressbar:1.11.0)"
RDEPENDS:${PN} += "/usr/bin/env ruby(abi)"
