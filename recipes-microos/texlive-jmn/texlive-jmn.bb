...
RPROVIDES:${PN} += "tex(hans-sh.tfm) tex(hans.enc) tex(hans.map) tex(hans.tfm) texlive-jmn"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-jmn-fonts texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
