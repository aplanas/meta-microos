...
RPROVIDES:${PN} += "python3.11dist(sqlalchemy-migrate) python311-sqlalchemy-migrate python3dist(sqlalchemy-migrate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-SQLAlchemy python311-Tempita python311-decorator python311-six python311-sqlparse update-alternatives"
