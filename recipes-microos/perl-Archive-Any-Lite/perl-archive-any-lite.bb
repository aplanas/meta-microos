...
RPROVIDES:${PN} += "perl(Archive::Any::Lite) perl(Archive::Any::Lite::Tar) perl(Archive::Any::Lite::Zip) perl-Archive-Any-Lite"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Archive::Tar) perl(Archive::Zip) perl(File::Temp) perl(IO::Uncompress::Bunzip2) perl(IO::Zlib)"
