...
RPROVIDES:${PN} += "python3.9dist(geopandas) python39-geopandas python3dist(geopandas)"
RDEPENDS:${PN} += "python(abi) python39-Fiona python39-pandas python39-pyproj python39-shapely"
