...
RPROVIDES:${PN} += "tex(mla.sty) texlive-mla-paper"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(fancyhdr.sty) tex(graphicx.sty) tex(thumbpdf.sty) tex(times.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
