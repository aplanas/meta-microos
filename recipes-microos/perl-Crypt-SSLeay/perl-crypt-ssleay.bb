...
RPROVIDES:${PN} += "perl(Crypt::SSLeay) perl(Crypt::SSLeay::CTX) perl(Crypt::SSLeay::Conn) perl(Crypt::SSLeay::Err) perl(Crypt::SSLeay::MainContext) perl(Crypt::SSLeay::Version) perl(Crypt::SSLeay::X509) perl(DB) perl(Net::SSL) perl-Crypt-SSLeay perl-Crypt-SSLeay(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libssl.so.3()(64bit) libssl.so.3(OPENSSL_3.0.0)(64bit) openssl perl(:MODULE_COMPAT_5.36.0) perl(LWP::Protocol::https)"
