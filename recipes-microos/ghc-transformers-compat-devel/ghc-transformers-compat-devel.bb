...
RPROVIDES:${PN} += "ghc-devel(transformers-compat-0.7.2-7jAnhjvxTABIymoNGHTOwd) ghc-transformers-compat-devel ghc-transformers-compat-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(ghc-prim-0.9.0) ghc-devel(transformers-0.5.6.2) ghc-transformers-compat"
