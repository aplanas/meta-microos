...
RPROVIDES:${PN} += "python39-gobject-Gdk python39-gobject-Gdk(aarch-64)"
RDEPENDS:${PN} += "python(abi) python39-gobject python39-gobject-cairo typelib(GLib) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(GdkX11) typelib(Gio) typelib(Gtk) typelib(Pango) typelib(cairo)"
