...
RPROVIDES:${PN} += "gtkmm2-devel gtkmm2-devel(aarch-64) gtkmm2-doc gtkmm24-devel pkgconfig(gdkmm-2.4) pkgconfig(gtkmm-2.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgtkmm-2_4-1 pkgconfig(atkmm-1.6) pkgconfig(gdkmm-2.4) pkgconfig(giomm-2.4) pkgconfig(gtk+-2.0) pkgconfig(gtk+-unix-print-2.0) pkgconfig(pangomm-1.4)"
