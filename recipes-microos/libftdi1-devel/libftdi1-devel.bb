...
RPROVIDES:${PN} += "cmake(LibFTDI1) libftdi1-devel libftdi1-devel(aarch-64) pkgconfig(libftdi1) pkgconfig(libftdipp1)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libconfuse.so.2()(64bit) libftdi1-2 libftdi1.so.2()(64bit) libusb-1.0.so.0()(64bit) pkgconfig(libftdi1) pkgconfig(libusb-1.0)"
