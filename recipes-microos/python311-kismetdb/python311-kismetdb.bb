...
RPROVIDES:${PN} += "python3.11dist(kismetdb) python311-kismetdb python3dist(kismetdb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-python-dateutil python311-simplekml update-alternatives"
