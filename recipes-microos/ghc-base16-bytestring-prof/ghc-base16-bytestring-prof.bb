...
RPROVIDES:${PN} += "ghc-base16-bytestring-prof ghc-base16-bytestring-prof(aarch-64) ghc-prof(base16-bytestring-1.0.2.0-BWBHxp15W1kvZUUcQHZQU)"
RDEPENDS:${PN} += "ghc-base16-bytestring-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0)"
