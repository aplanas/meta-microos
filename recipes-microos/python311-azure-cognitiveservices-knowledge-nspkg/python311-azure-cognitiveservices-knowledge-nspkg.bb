...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-knowledge-nspkg) python311-azure-cognitiveservices-knowledge-nspkg python3dist(azure-cognitiveservices-knowledge-nspkg)"
RDEPENDS:${PN} += "python311-azure-cognitiveservices-nspkg python311-azure-nspkg"
