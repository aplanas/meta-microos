...
RPROVIDES:${PN} += "python3.9dist(modernize) python39-modernize python3dist(modernize)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-dbm python39-fissix update-alternatives"
