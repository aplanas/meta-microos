...
RPROVIDES:${PN} += "python3.9dist(grab) python39-grab python3dist(grab)"
RDEPENDS:${PN} += "python(abi) python39-defusedxml python39-lxml python39-pycurl python39-selection python39-six python39-user_agent python39-weblib"
