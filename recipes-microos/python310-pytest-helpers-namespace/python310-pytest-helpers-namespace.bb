...
RPROVIDES:${PN} += "python3-pytest-helpers-namespace python3.10dist(pytest-helpers-namespace) python310-pytest-helpers-namespace python3dist(pytest-helpers-namespace)"
