...
RPROVIDES:${PN} += "python3-pytest-shutil python3.10dist(pytest-shutil) python310-pytest-shutil python3dist(pytest-shutil)"
RDEPENDS:${PN} += "python(abi) python310-execnet python310-path python310-pytest python310-six python310-termcolor"
