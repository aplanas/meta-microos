...
RPROVIDES:${PN} += "syslog-ng-redis syslog-ng-redis(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libhiredis.so.1.1.0()(64bit) libsyslog-ng-4.2.so.0()(64bit) syslog-ng"
