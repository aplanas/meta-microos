...
RPROVIDES:${PN} += "python3.9dist(drms) python39-drms python3dist(drms)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-numpy python39-pandas update-alternatives"
