...
RPROVIDES:${PN} += "python3.9dist(azure-mgmt-containerinstance) python39-azure-mgmt-containerinstance python3dist(azure-mgmt-containerinstance)"
RDEPENDS:${PN} += "(python39-typing_extensions >= 4.0.1 if python39-base < 3.8) python(abi) python39-azure-common python39-azure-mgmt-core python39-azure-mgmt-nspkg python39-azure-nspkg python39-isodate"
