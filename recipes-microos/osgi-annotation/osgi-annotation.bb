...
RPROVIDES:${PN} += "mvn(org.osgi:org.osgi.annotation) mvn(org.osgi:org.osgi.annotation:pom:) mvn(org.osgi:osgi.annotation) mvn(org.osgi:osgi.annotation:pom:) osgi(osgi.annotation) osgi-annotation"
