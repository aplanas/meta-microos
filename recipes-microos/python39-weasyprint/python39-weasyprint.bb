...
RPROVIDES:${PN} += "python3.9dist(weasyprint) python39-WeasyPrint python39-weasyprint python3dist(weasyprint)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 libgobject-2_0-0 pango python(abi) python39-Brotli python39-FontTools python39-Pillow python39-Pyphen python39-base python39-cffi python39-cssselect2 python39-html5lib python39-pydyf python39-tinycss2 python39-zopfli update-alternatives"
