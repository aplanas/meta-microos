...
RPROVIDES:${PN} += "python3-Automat python3.10dist(automat) python310-Automat python3dist(automat)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-attrs update-alternatives"
