...
RPROVIDES:${PN} += "libcss-devel libcss-devel(aarch-64) pkgconfig(libcss)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libcss0 pkgconfig(libparserutils) pkgconfig(libwapcaplet)"
