...
RPROVIDES:${PN} += "libgviewaudio-2.0.so.2()(64bit) libgviewaudio-2_0-2 libgviewaudio-2_0-2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) libportaudio.so.2()(64bit) libpulse.so.0()(64bit) libpulse.so.0(PULSE_0)(64bit)"
