...
RPROVIDES:${PN} += "python3-siphashc python3-siphashc3 python3.10dist(siphashc) python310-siphashc python310-siphashc(aarch-64) python310-siphashc3 python3dist(siphashc)"
