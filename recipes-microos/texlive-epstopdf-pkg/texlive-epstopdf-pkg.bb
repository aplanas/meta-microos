...
RPROVIDES:${PN} += "tex(epstopdf-base.sty) tex(epstopdf.sty) texlive-epstopdf-pkg"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(grfext.sty) tex(infwarerr.sty) tex(kvoptions.sty) tex(pdftexcmds.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
