...
RPROVIDES:${PN} += "pocketsphinx5 pocketsphinx5(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpocketsphinx.so.3()(64bit) libsphinxad.so.3()(64bit) libsphinxbase.so.3()(64bit) update-alternatives"
