...
RPROVIDES:${PN} += "python3-matplotlib-gtk-common python310-matplotlib-gtk-common python310-matplotlib-gtk-common(aarch-64)"
RDEPENDS:${PN} += "gdk-pixbuf-loader-rsvg python(abi) python310-gobject-Gdk python310-gobject-cairo python310-matplotlib python310-matplotlib-cairo"
