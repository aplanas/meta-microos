...
RPROVIDES:${PN} += "python3.11dist(oic) python311-oic python3dist(oic)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Beaker python311-Mako python311-cryptography python311-dbm python311-defusedxml python311-pycryptodomex python311-pyjwkest python311-requests python311-typing python311-typing_extensions"
