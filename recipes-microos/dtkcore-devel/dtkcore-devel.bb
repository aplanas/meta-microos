...
RPROVIDES:${PN} += "cmake(DtkCMake) cmake(DtkCore) cmake(DtkTools) dtkcore-devel dtkcore-devel(aarch-64) pkgconfig(dtkcore)"
RDEPENDS:${PN} += "/usr/bin/pkg-config dtkcommon libdtkcore5"
