...
RPROVIDES:${PN} += "config(unixODBC) libnn.so.1()(64bit) libtemplate.so.1()(64bit) unixODBC unixODBC(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libltdl.so.7()(64bit) libodbc.so.2()(64bit) libodbcinst.so.2()(64bit) libreadline.so.8()(64bit)"
