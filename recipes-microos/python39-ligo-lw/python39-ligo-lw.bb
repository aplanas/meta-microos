...
RPROVIDES:${PN} += "python3.9dist(python-ligo-lw) python39-ligo-lw python39-ligo-lw(aarch-64) python3dist(python-ligo-lw)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-PyYAML python39-lal python39-ligo-segments python39-lscsoft-glue python39-python-dateutil python39-tqdm update-alternatives"
