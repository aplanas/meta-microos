...
RPROVIDES:${PN} += "tex(minted.sty) tex(minted1.sty) texlive-minted"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(catchfile.sty) tex(etoolbox.sty) tex(fancyvrb.sty) tex(float.sty) tex(framed.sty) tex(fvextra.sty) tex(ifplatform.sty) tex(ifthen.sty) tex(keyval.sty) tex(kvoptions.sty) tex(lineno.sty) tex(newfloat.sty) tex(pdftexcmds.sty) tex(shellesc.sty) tex(xcolor.sty) tex(xstring.sty) texlive texlive-catchfile texlive-etoolbox texlive-fancyvrb texlive-filesystem texlive-float texlive-framed texlive-fvextra texlive-graphics texlive-ifplatform texlive-kpathsea texlive-kpathsea-bin texlive-kvoptions texlive-lineno texlive-pdftexcmds texlive-scripts texlive-scripts-bin texlive-tools texlive-upquote texlive-xcolor texlive-xstring"
