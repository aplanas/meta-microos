...
RPROVIDES:${PN} += "ghc-devel(old-time-1.1.0.3-6MrxIvEBZcaI0p7TDiYNU1) ghc-old-time-devel ghc-old-time-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(old-locale-1.0.0.7-B5o2Qz0CVVSCB1XGw7OfzR) ghc-old-time"
