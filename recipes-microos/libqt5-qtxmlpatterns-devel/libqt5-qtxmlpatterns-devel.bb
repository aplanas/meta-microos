...
RPROVIDES:${PN} += "cmake(Qt5XmlPatterns) libQt5XmlPatterns-devel libqt5-qtxmlpatterns-devel libqt5-qtxmlpatterns-devel(aarch-64) pkgconfig(Qt5XmlPatterns)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libQt5XmlPatterns5 pkgconfig(Qt5Core) pkgconfig(Qt5Network)"
