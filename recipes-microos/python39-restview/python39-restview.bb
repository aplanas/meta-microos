...
RPROVIDES:${PN} += "python3.9dist(restview) python39-restview python3dist(restview)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-docutils python39-pygments python39-readme_renderer update-alternatives"
