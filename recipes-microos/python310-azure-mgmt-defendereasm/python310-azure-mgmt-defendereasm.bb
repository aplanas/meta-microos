...
RPROVIDES:${PN} += "python3-azure-mgmt-defendereasm python3.10dist(azure-mgmt-defendereasm) python310-azure-mgmt-defendereasm python3dist(azure-mgmt-defendereasm)"
