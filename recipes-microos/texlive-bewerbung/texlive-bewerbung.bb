...
RPROVIDES:${PN} += "tex(argetabelle.cls) tex(bewerbung-cv-casual.sty) tex(bewerbung-cv-classic.sty) tex(bewerbung-cv-oldstyle.sty) tex(bewerbung-cv.sty) tex(bewerbung.cls) tex(bewerbung.sty) texlive-bewerbung"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(booktabs.sty) tex(calc.sty) tex(comment.sty) tex(csquotes.sty) tex(datatool.sty) tex(eurosym.sty) tex(fontspec.sty) tex(geometry.sty) tex(ifthen.sty) tex(kvoptions.sty) tex(lastpage.sty) tex(longtable.sty) tex(marvosym.sty) tex(multicol.sty) tex(pdfpages.sty) tex(ragged2e.sty) tex(scrartcl.cls) tex(xcolor.sty) tex(xparse.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
