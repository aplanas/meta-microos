...
RPROVIDES:${PN} += "libtevent-devel libtevent-devel(aarch-64) pkgconfig(tevent)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libtalloc-devel libtevent0 pkg-config pkgconfig(talloc)"
