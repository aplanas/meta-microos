...
RPROVIDES:${PN} += "python3-inspektor python3.10dist(inspektor) python3dist(inspektor)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 python(abi) python3-astroid python3-cliff python3-cmd2 python3-logutils python3-pbr python3-pycodestyle python3-pylint python3-stevedore python3-typed-ast update-alternatives"
