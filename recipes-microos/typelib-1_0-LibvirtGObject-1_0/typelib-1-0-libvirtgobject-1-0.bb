...
RPROVIDES:${PN} += "typelib(LibvirtGObject) typelib-1_0-LibvirtGObject-1_0 typelib-1_0-LibvirtGObject-1_0(aarch-64)"
RDEPENDS:${PN} += "libvirt-gobject-1.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(LibvirtGConfig) typelib(LibvirtGLib) typelib(libxml2)"
