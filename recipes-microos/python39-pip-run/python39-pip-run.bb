...
RPROVIDES:${PN} += "python3.9dist(pip-run) python39-pip-run python3dist(pip-run)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-autocommand python39-packaging python39-path python39-pip update-alternatives"
