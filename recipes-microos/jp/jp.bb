...
RPROVIDES:${PN} += "golang(github.com/sgreben/jp/cmd/jp) golang(github.com/sgreben/jp/pkg/data) golang(github.com/sgreben/jp/pkg/draw) golang(github.com/sgreben/jp/pkg/jsonpath) golang(github.com/sgreben/jp/pkg/plot) golang(github.com/sgreben/jp/pkg/terminal) jp jp(aarch-64)"
RDEPENDS:${PN} += ""
