...
RPROVIDES:${PN} += "libzapojit-devel libzapojit-devel(aarch-64) pkgconfig(zapojit-0.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libzapojit-0_0-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(goa-1.0) pkgconfig(json-glib-1.0) pkgconfig(libsoup-2.4) pkgconfig(rest-0.7) typelib-1_0-Zpj-0_0"
