...
RPROVIDES:${PN} += "libnetfilter_cthelper.so.0()(64bit) libnetfilter_cthelper.so.0(LIBNETFILTER_CTHELPER_1.0)(64bit) libnetfilter_cthelper0 libnetfilter_cthelper0(aarch-64)"
