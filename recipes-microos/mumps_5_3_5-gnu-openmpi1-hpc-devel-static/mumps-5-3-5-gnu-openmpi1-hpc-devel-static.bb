...
RPROVIDES:${PN} += "mumps_5_3_5-gnu-openmpi1-hpc-devel-static mumps_5_3_5-gnu-openmpi1-hpc-devel-static(aarch-64)"
RDEPENDS:${PN} += "mumps_5_3_5-gnu-openmpi1-hpc-devel"
