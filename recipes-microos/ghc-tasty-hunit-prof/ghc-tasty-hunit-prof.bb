...
RPROVIDES:${PN} += "ghc-prof(tasty-hunit-0.10.0.3-CV9N1Lkn3CAEveU82YsKyL) ghc-tasty-hunit-prof ghc-tasty-hunit-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(call-stack-0.4.0-K9VxYWjBEvtITBfD6bL7Dk) ghc-prof(tasty-1.4.3-FhQLnMluiBU5Fwwb1Rsznz) ghc-tasty-hunit-devel"
