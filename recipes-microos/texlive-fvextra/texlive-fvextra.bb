...
RPROVIDES:${PN} += "tex(fvextra.sty) texlive-fvextra"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(fancyvrb.sty) tex(lineno.sty) tex(textcomp.sty) tex(upquote.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
