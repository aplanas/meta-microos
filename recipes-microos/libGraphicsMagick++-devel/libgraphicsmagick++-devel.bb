...
RPROVIDES:${PN} += "GraphicsMagick-C++-devel libGraphicsMagick++-devel libGraphicsMagick++-devel(aarch-64) pkgconfig(GraphicsMagick++)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config GraphicsMagick-devel c++_compiler libGraphicsMagick++-Q16-12 pkgconfig(GraphicsMagick)"
