...
RPROVIDES:${PN} += "tex(recycle.map) tex(recycle.sty) tex(recycle.tfm) texlive-recycle"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-recycle-fonts texlive-scripts texlive-scripts-bin"
