...
RPROVIDES:${PN} += "libmosquitto-devel libmosquittopp-devel mosquitto-devel mosquitto-devel(aarch-64) pkgconfig(libmosquitto) pkgconfig(libmosquittopp)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmosquitto1 libmosquittopp1"
