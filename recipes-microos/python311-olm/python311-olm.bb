...
RPROVIDES:${PN} += "python3.11dist(python-olm) python311-olm python311-olm(aarch-64) python3dist(python-olm)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libolm.so.3()(64bit) libolm3 python(abi) python311-cffi python311-future"
