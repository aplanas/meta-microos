...
RPROVIDES:${PN} += "gettext-devel gettext-tools gettext-tools(aarch-64) libgettextpo.so.0()(64bit) libgnuintl.so.8()(64bit)"
RDEPENDS:${PN} += "/bin/sh gettext-runtime info ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgettextlib-0.21.1.so()(64bit) libgettextsrc-0.21.1.so()(64bit) libgomp.so.1()(64bit) libgomp.so.1(GOMP_1.0)(64bit) libgomp.so.1(GOMP_4.0)(64bit) libgomp.so.1(GOMP_4.5)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libtextstyle.so.0()(64bit) libxml2.so.2()(64bit) libxml2.so.2(LIBXML2_2.4.30)(64bit) libxml2.so.2(LIBXML2_2.6.0)(64bit) xz"
