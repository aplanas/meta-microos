...
RPROVIDES:${PN} += "libsundials_sunnonlin3_3_0-mvapich2 libsundials_sunnonlin3_3_0-mvapich2(aarch-64) libsundials_sunnonlinsolfixedpoint.so.3.3.0()(64bit) libsundials_sunnonlinsolnewton.so.3.3.0()(64bit)"
