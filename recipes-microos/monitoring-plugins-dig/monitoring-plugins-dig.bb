...
RPROVIDES:${PN} += "monitoring-plugins-dig monitoring-plugins-dig(aarch-64) nagios-plugins-dig"
RDEPENDS:${PN} += "/usr/bin/dig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit)"
