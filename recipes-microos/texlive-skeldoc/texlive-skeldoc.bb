...
RPROVIDES:${PN} += "tex(skeldoc.sty) texlive-skeldoc"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(booktabs.sty) tex(enotez.sty) tex(enumitem.sty) tex(expl3.sty) tex(hyperref.sty) tex(marginnote.sty) tex(tabularx.sty) tex(xcolor.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
