...
RPROVIDES:${PN} += "avahi-python python3-avahi python310-avahi python310-avahi(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 avahi python(abi) python310-Twisted python310-dbm python310-dbus-python"
