...
RPROVIDES:${PN} += "python3.9dist(pyqt6-networkauth) python39-PyQt6-NetworkAuth python39-PyQt6-NetworkAuth(aarch-64) python39-qtnetworkauth-qt6 python3dist(pyqt6-networkauth)"
