...
RPROVIDES:${PN} += "config(texlive-hyphen-base) tex(dumyhyph.tex) tex(hyphen.tex) tex(hypht1.tex) tex(language.dat) tex(language.dat.lua) tex(language.def) tex(language.us.def) tex(zerohyph.tex) texlive-hyphen-base"
