...
RPROVIDES:${PN} += "librest0_7-devel librest0_7-devel(aarch-64) pkgconfig(rest-0.7) pkgconfig(rest-extras-0.7)"
RDEPENDS:${PN} += "/usr/bin/pkg-config librest-0_7-0 pkgconfig(glib-2.0) pkgconfig(libsoup-2.4) pkgconfig(libxml-2.0) typelib-1_0-Rest-0_7"
