...
RPROVIDES:${PN} += "libgee06-devel libgee06-devel(aarch-64) pkgconfig(gee-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgee2 pkgconfig(glib-2.0) pkgconfig(gobject-2.0) typelib-1_0-Gee-1_0"
