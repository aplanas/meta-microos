...
RPROVIDES:${PN} += "python3.11dist(azure-purview-catalog) python311-azure-purview-catalog python3dist(azure-purview-catalog)"
RDEPENDS:${PN} += "python(abi) python311-azure-core python311-azure-nspkg python311-azure-purview-nspkg python311-msrest"
