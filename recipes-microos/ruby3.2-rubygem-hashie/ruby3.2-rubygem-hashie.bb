...
RPROVIDES:${PN} += "ruby3.2-rubygem-hashie ruby3.2-rubygem-hashie(aarch-64) rubygem(hashie) rubygem(ruby:3.2.0:hashie) rubygem(ruby:3.2.0:hashie:5) rubygem(ruby:3.2.0:hashie:5.0) rubygem(ruby:3.2.0:hashie:5.0.0)"
