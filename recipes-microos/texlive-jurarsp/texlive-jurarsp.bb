...
RPROVIDES:${PN} += "tex(jurarsp.cfg) tex(jurarsp.sty) texlive-jurarsp"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(ifthen.sty) tex(keyval.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
