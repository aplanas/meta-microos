...
RPROVIDES:${PN} += "ocr_1_0_1-gnu-openmpi2-hpc-devel ocr_1_0_1-gnu-openmpi2-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "gnu-compilers-hpc-devel ocr_1_0_1-gnu-openmpi2-hpc openmpi2-gnu-hpc-devel"
