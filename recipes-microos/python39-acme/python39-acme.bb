...
RPROVIDES:${PN} += "python3.9dist(acme) python39-acme python3dist(acme)"
RDEPENDS:${PN} += "python(abi) python39-cryptography python39-josepy python39-pyOpenSSL python39-pyRFC3339 python39-pytz python39-requests python39-requests-toolbelt"
