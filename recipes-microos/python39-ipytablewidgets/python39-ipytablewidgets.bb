...
RPROVIDES:${PN} += "python3.9dist(ipytablewidgets) python39-ipytablewidgets python3dist(ipytablewidgets)"
RDEPENDS:${PN} += "python(abi) python39-ipywidgets python39-lz4 python39-numpy python39-pandas python39-traitlets python39-traittypes"
