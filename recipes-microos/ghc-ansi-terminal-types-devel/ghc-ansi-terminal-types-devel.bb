...
RPROVIDES:${PN} += "ghc-ansi-terminal-types-devel ghc-ansi-terminal-types-devel(aarch-64) ghc-devel(ansi-terminal-types-0.11.5-9ffXWswmNhoANlpnF2SnhR)"
RDEPENDS:${PN} += "/bin/sh ghc-ansi-terminal-types ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(colour-2.3.6-7jQe2xj5Lsa5MbX38iH7Ln)"
