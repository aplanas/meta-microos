...
RPROVIDES:${PN} += "tex(hvqrurl.sty) texlive-hvqrurl"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(marginnote.sty) tex(qrcode.sty) tex(url.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
