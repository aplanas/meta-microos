...
RPROVIDES:${PN} += "ruby3.2-rubygem-forwardable-extended ruby3.2-rubygem-forwardable-extended(aarch-64) rubygem(forwardable-extended) rubygem(ruby:3.2.0:forwardable-extended) rubygem(ruby:3.2.0:forwardable-extended:2) rubygem(ruby:3.2.0:forwardable-extended:2.6) rubygem(ruby:3.2.0:forwardable-extended:2.6.0)"
