...
RPROVIDES:${PN} += "python3.9dist(testrepository) python39-testrepository python3dist(testrepository)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-dbm python39-extras python39-fixtures python39-python-subunit python39-testscenarios python39-testtools update-alternatives"
