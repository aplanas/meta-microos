...
RPROVIDES:${PN} += "mvn(org.apache.opennlp:opennlp:pom:) opennlp"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven.plugins:maven-compiler-plugin) mvn(org.apache:apache:pom:)"
