...
RPROVIDES:${PN} += "python3.9dist(django-allauth) python39-django-allauth python3dist(django-allauth)"
RDEPENDS:${PN} += "python(abi) python39-Django python39-python3-openid python39-requests python39-requests-oauthlib"
