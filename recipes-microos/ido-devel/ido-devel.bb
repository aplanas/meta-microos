...
RPROVIDES:${PN} += "ido-devel ido-devel(aarch-64) pkgconfig(libido3-0.1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libido3-0_1-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-introspection-1.0) pkgconfig(gtk+-3.0) typelib-1_0-Ido3-0_1"
