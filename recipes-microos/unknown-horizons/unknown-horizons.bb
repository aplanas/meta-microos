...
RPROVIDES:${PN} += "application() application(unknown-horizons.desktop) metainfo() metainfo(unknown-horizons.appdata.xml) unknown-horizons"
RDEPENDS:${PN} += "/usr/bin/python3 hicolor-icon-theme python(abi) python3-Pillow python3-PyYAML python3-fife"
