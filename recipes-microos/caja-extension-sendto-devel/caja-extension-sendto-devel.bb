...
RPROVIDES:${PN} += "caja-extension-sendto-devel caja-extension-sendto-devel(aarch-64) caja-sendto-devel mate-file-manager-sendto-devel pkgconfig(caja-sendto)"
RDEPENDS:${PN} += "/usr/bin/pkg-config caja-extension-sendto caja-extension-sendto-pidgin caja-extension-sendto-upnp pkgconfig(glib-2.0) pkgconfig(gmodule-2.0) pkgconfig(gtk+-3.0)"
