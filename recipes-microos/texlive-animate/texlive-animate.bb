...
RPROVIDES:${PN} += "tex(animate.sty) texlive-animate"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(graphics.sty) tex(ifdraft.sty) tex(iftex.sty) tex(ifthen.sty) tex(ocgbase.sty) tex(pdfbase.sty) tex(zref-abspage.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
