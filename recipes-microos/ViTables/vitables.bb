...
RPROVIDES:${PN} += "ViTables ViTables2 python3.10dist(vitables) python3dist(vitables)"
RDEPENDS:${PN} += "/usr/bin/python3 hdf5 hicolor-icon-theme python(abi) python3-Cython python3-QtPy python3-numexpr python3-numpy python3-qt5 python3-tables"
