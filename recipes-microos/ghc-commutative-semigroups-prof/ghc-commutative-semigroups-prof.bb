...
RPROVIDES:${PN} += "ghc-commutative-semigroups-prof ghc-commutative-semigroups-prof(aarch-64) ghc-prof(commutative-semigroups-0.1.0.1-EHuCShtv7U46wPCL9foais)"
RDEPENDS:${PN} += "ghc-commutative-semigroups-devel ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7)"
