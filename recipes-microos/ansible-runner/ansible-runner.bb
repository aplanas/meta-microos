...
RDEPENDS:${PN} += "/usr/bin/bash /usr/bin/python3 python(abi) python3-PyYAML python3-packaging python3-pexpect python3-python-daemon python3-setuptools python3-six"
