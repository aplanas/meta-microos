...
RPROVIDES:${PN} += "python3-azure-mgmt-appcontainers python3.10dist(azure-mgmt-appcontainers) python310-azure-mgmt-appcontainers python3dist(azure-mgmt-appcontainers)"
