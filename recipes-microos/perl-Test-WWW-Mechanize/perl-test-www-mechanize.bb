...
RPROVIDES:${PN} += "perl(Test::WWW::Mechanize) perl-Test-WWW-Mechanize"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Carp::Assert::More) perl(HTML::Form) perl(HTML::TokeParser) perl(HTTP::Message) perl(LWP) perl(Test::LongString) perl(WWW::Mechanize) perl(parent)"
