...
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-cairo python3-dbus-python python3-gobject-Gdk python3-pyaml typelib(GLib) typelib(GObject) typelib(Gdk) typelib(GdkX11) typelib(Gio) typelib(Gtk) typelib(Keybinder) typelib(Notify) typelib(Pango) typelib(Vte) typelib(Wnck)"
