...
RPROVIDES:${PN} += "python3.11dist(icoextract) python311-icoextract python3dist(icoextract)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-pefile update-alternatives"
