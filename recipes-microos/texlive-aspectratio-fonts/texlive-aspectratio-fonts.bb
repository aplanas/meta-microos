...
RPROVIDES:${PN} += "font(amar) font(ar10) font(ar12) font(ar5) font(ar6) font(ar7) font(ar8) font(ar9) font(arb10) font(arb12) font(arb5) font(arb6) font(arb7) font(arb8) font(arb9) font(arssbi10) font(arssi10) font(artti10) texlive-aspectratio-fonts"
