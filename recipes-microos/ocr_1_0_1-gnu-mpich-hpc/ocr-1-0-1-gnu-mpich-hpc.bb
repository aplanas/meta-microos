...
RPROVIDES:${PN} += "ocr_1_0_1-gnu-mpich-hpc ocr_1_0_1-gnu-mpich-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh gnu-compilers-hpc libc.so.6(GLIBC_2.34)(64bit) lua-lmod mpich-gnu-hpc"
