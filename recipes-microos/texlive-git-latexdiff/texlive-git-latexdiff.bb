...
RDEPENDS:${PN} += "/bin/bash /bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-git-latexdiff-bin texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
