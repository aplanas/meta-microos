...
RPROVIDES:${PN} += "python3-ftfy python3.10dist(ftfy) python310-ftfy python3dist(ftfy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-wcwidth update-alternatives"
