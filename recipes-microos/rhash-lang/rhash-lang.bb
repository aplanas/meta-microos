...
RPROVIDES:${PN} += "locale(rhash:ca) locale(rhash:de) locale(rhash:en_AU) locale(rhash:es) locale(rhash:fr) locale(rhash:gl) locale(rhash:it) locale(rhash:ro) locale(rhash:ru) locale(rhash:uk) rhash-lang rhash-lang-all"
RDEPENDS:${PN} += "rhash"
