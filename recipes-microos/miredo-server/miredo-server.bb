...
RPROVIDES:${PN} += "config(miredo-server) miredo-server miredo-server(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcap.so.2()(64bit) libteredo.so.5()(64bit) miredo-common systemd"
