...
RPROVIDES:${PN} += "ruby3.2-rubygem-thread_safe ruby3.2-rubygem-thread_safe(aarch-64) rubygem(ruby:3.2.0:thread_safe) rubygem(ruby:3.2.0:thread_safe:0) rubygem(ruby:3.2.0:thread_safe:0.3) rubygem(ruby:3.2.0:thread_safe:0.3.6) rubygem(thread_safe)"
