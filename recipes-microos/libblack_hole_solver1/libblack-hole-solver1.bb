...
RPROVIDES:${PN} += "libblack_hole_solver.so.1()(64bit) libblack_hole_solver1 libblack_hole_solver1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libxxhash.so.0()(64bit)"
