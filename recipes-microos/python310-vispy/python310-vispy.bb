...
RPROVIDES:${PN} += "python3-vispy python3.10dist(vispy) python310-vispy python310-vispy(aarch-64) python3dist(vispy)"
RDEPENDS:${PN} += "fontconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-cassowary python310-decorator python310-freetype-py python310-husl python310-numpy python310-pypng python310-qt5"
