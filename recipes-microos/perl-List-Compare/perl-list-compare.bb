...
RPROVIDES:${PN} += "perl(List::Compare) perl(List::Compare::Accelerated) perl(List::Compare::Base::_Auxiliary) perl(List::Compare::Base::_Engine) perl(List::Compare::Functional) perl(List::Compare::Multiple) perl(List::Compare::Multiple::Accelerated) perl-List-Compare"
