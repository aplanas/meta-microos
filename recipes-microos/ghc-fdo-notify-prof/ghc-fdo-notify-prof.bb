...
RPROVIDES:${PN} += "ghc-fdo-notify-prof ghc-fdo-notify-prof(aarch-64) ghc-prof(fdo-notify-0.3.1-4juugYyFrKwHiJsjcNjTJW)"
RDEPENDS:${PN} += "ghc-fdo-notify-devel ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(dbus-1.2.28-27GbkRPSCRwKgi0yxoNYFh)"
