...
RPROVIDES:${PN} += "ghc-Diff-devel ghc-Diff-devel(aarch-64) ghc-devel(Diff-0.4.1-CiDqeLEcsRQOQjfgZOPVP)"
RDEPENDS:${PN} += "/bin/sh ghc-Diff ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(pretty-1.1.3.6)"
