...
RPROVIDES:${PN} += "tex(tikzlibrarytikzlings.code.tex) tex(tikzlings-addons.sty) tex(tikzlings-anteaters.sty) tex(tikzlings-bats.sty) tex(tikzlings-bears.sty) tex(tikzlings-bees.sty) tex(tikzlings-bugs.sty) tex(tikzlings-cats.sty) tex(tikzlings-chickens.sty) tex(tikzlings-coatis.sty) tex(tikzlings-elephants.sty) tex(tikzlings-hippos.sty) tex(tikzlings-koalas.sty) tex(tikzlings-list.sty) tex(tikzlings-marmots.sty) tex(tikzlings-mice.sty) tex(tikzlings-moles.sty) tex(tikzlings-owls.sty) tex(tikzlings-pandas.sty) tex(tikzlings-penguins.sty) tex(tikzlings-pigs.sty) tex(tikzlings-rhinos.sty) tex(tikzlings-sheep.sty) tex(tikzlings-sloths.sty) tex(tikzlings-snowmen.sty) tex(tikzlings-squirrels.sty) tex(tikzlings-wolves.sty) tex(tikzlings.sty) texlive-tikzlings"
