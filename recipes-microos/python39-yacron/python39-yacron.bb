...
RPROVIDES:${PN} += "python3.9dist(yacron) python39-yacron python3dist(yacron)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Jinja2 python39-aiohttp python39-aiosmtplib python39-crontab python39-pytz python39-ruamel.yaml python39-sentry-sdk python39-strictyaml update-alternatives"
