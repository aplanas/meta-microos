...
RPROVIDES:${PN} += "libdbusmenu-jsonloader-devel libdbusmenu-jsonloader-devel(aarch-64) pkgconfig(dbusmenu-jsonloader-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdbusmenu-jsonloader4 pkgconfig(dbus-glib-1) pkgconfig(dbusmenu-glib-0.4) pkgconfig(json-glib-1.0)"
