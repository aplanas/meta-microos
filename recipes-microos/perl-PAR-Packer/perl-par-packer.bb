...
RPROVIDES:${PN} += "perl(App::Packer::PAR) perl(PAR::Filter) perl(PAR::Filter::Bleach) perl(PAR::Filter::Bytecode) perl(PAR::Filter::Obfuscate) perl(PAR::Filter::PatchContent) perl(PAR::Filter::PodStrip) perl(PAR::Packer) perl(PAR::StrippedPARL::Base) perl(PAR::StrippedPARL::Dynamic) perl(PAR::StrippedPARL::Static) perl(pp) perl-PAR-Packer perl-PAR-Packer(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/perl ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libperl.so()(64bit) perl(:MODULE_COMPAT_5.36.0) perl(Archive::Zip) perl(Compress::Zlib) perl(Digest::SHA) perl(Getopt::ArgvFile) perl(IO::Compress::Gzip) perl(Module::ScanDeps) perl(PAR) perl(PAR::Dist)"
