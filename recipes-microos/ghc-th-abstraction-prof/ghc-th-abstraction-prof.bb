...
RPROVIDES:${PN} += "ghc-prof(th-abstraction-0.4.5.0-8bY5lBPMorfFW3yG6gFNZT) ghc-th-abstraction-prof ghc-th-abstraction-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(ghc-prim-0.9.0) ghc-prof(template-haskell-2.19.0.0) ghc-th-abstraction-devel"
