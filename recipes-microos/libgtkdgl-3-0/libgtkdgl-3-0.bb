...
RPROVIDES:${PN} += "libgtkdgl-3-0 libgtkdgl-3-0(aarch-64) libgtkdgl-3.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig libc.so.6(GLIBC_2.17)(64bit) libdruntime-ldc-shared.so.102()(64bit)"
