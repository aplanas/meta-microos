...
RPROVIDES:${PN} += "typelib(Soup) typelib-1_0-Soup-3_0 typelib-1_0-Soup-3_0(aarch-64)"
RDEPENDS:${PN} += "libsoup-3.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
