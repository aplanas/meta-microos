...
RPROVIDES:${PN} += "python3.11dist(altair) python311-altair python3dist(altair)"
RDEPENDS:${PN} += "python(abi) python311-Jinja2 python311-entrypoints python311-jsonschema python311-numpy python311-pandas python311-toolz python311-typing"
