...
RPROVIDES:${PN} += "python3.9dist(azure-storage-common) python39-azure-storage-common python3dist(azure-storage-common)"
RDEPENDS:${PN} += "python(abi) python39-azure-common python39-azure-nspkg python39-azure-storage-nspkg python39-cryptography python39-python-dateutil python39-requests"
