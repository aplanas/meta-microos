...
RPROVIDES:${PN} += "python3.11dist(certbot-dns-google) python311-certbot-dns-google python3dist(certbot-dns-google)"
RDEPENDS:${PN} += "python(abi) python311-acme python311-certbot python311-google-api-python-client python311-google-auth python311-zope.interface"
