...
RPROVIDES:${PN} += "python3.11dist(glymur) python311-Glymur python3dist(glymur)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-lxml python311-numpy python311-packaging update-alternatives"
