...
RPROVIDES:${PN} += "ghc-devel(digest-0.0.1.7-CCCN8814sFy3HuiyT8t94G) ghc-digest-devel ghc-digest-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-digest pkgconfig pkgconfig(zlib)"
