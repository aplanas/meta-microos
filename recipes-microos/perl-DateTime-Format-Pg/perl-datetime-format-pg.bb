...
RPROVIDES:${PN} += "perl(DateTime::Format::Pg) perl-DateTime-Format-Pg"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DateTime) perl(DateTime::Format::Builder) perl(DateTime::TimeZone)"
