...
RPROVIDES:${PN} += "python3.11dist(python-gvm) python311-python-gvm python3dist(python-gvm)"
RDEPENDS:${PN} += "python(abi) python311-defusedxml python311-lxml python311-paramiko"
