...
RPROVIDES:${PN} += "python3.9dist(msm) python39-msm python3dist(msm)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 patch python(abi) python39-GitPython python39-PyYAML python39-fasteners python39-lazy python39-pako python39-requests python39-setuptools python39-typing update-alternatives"
