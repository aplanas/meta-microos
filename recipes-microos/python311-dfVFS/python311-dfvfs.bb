...
RPROVIDES:${PN} += "python3.11dist(dfvfs) python311-dfVFS python3dist(dfvfs)"
RDEPENDS:${PN} += "python(abi) python311-PyYAML python311-construct python311-cryptography python311-dfdatetime python311-dtfabric python311-libbde python311-libcaes python311-libewf python311-libfsapfs python311-libfsext python311-libfsfat python311-libfshfs python311-libfsntfs python311-libfsxfs python311-libfvde python311-libfwnt python311-libluksde python311-libmodi python311-libphdi python311-libqcow python311-libsigscan python311-libsmdev python311-libsmraw python311-libvhdi python311-libvmdk python311-libvsgpt python311-libvshadow python311-libvslvm python311-tsk"
