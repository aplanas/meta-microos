...
RPROVIDES:${PN} += "cross-epiphany-gcc12 cross-epiphany-gcc12(aarch-64) epiphany-elf-gcc"
RDEPENDS:${PN} += "/bin/sh cross-epiphany-binutils libstdc++6-devel-gcc12 update-alternatives"
