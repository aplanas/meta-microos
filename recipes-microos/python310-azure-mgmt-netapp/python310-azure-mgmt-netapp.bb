...
RPROVIDES:${PN} += "python3-azure-mgmt-netapp python3.10dist(azure-mgmt-netapp) python310-azure-mgmt-netapp python3dist(azure-mgmt-netapp)"
RDEPENDS:${PN} += "(python310-typing_extensions >= 4.3.0 if python310-base < 3.8) python(abi) python310-azure-common python310-azure-core python310-azure-mgmt-nspkg python310-azure-nspkg python310-msrest"
