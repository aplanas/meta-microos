...
RPROVIDES:${PN} += "libfcitx-config.so.4()(64bit) libfcitx-config4 libfcitx-config4(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libfcitx-utils.so.0()(64bit)"
