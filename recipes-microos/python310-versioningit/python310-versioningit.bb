...
RPROVIDES:${PN} += "python3-versioningit python3.10dist(versioningit) python310-versioningit python3dist(versioningit)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 alts python(abi) python310-packaging python310-setuptools python310-tomli"
