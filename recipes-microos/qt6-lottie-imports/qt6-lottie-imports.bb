...
RPROVIDES:${PN} += "liblottieqtplugin.so()(64bit) liblottieqtplugin.so(Qt_6)(64bit) liblottieqtplugin.so(Qt_6.0)(64bit) liblottieqtplugin.so(Qt_6.1)(64bit) liblottieqtplugin.so(Qt_6.2)(64bit) liblottieqtplugin.so(Qt_6.3)(64bit) liblottieqtplugin.so(Qt_6.4)(64bit) liblottieqtplugin.so(Qt_6.5)(64bit) liblottieqtplugin.so(Qt_6.5.1_PRIVATE_API)(64bit) qt6-lottie-imports qt6-lottie-imports(aarch-64)"
