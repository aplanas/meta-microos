...
RPROVIDES:${PN} += "python3.9dist(pygit2) python39-pygit2 python39-pygit2(aarch-64) python3dist(pygit2)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgit2.so.1.6()(64bit) python(abi) python39-cached-property python39-cffi"
