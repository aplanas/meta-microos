...
RPROVIDES:${PN} += "ghc-cpphs-prof ghc-cpphs-prof(aarch-64) ghc-prof(cpphs-1.20.9.1-FT5N79IhkR98KU1k959mgj)"
RDEPENDS:${PN} += "ghc-cpphs-devel ghc-prof(base-4.17.1.0) ghc-prof(directory-1.3.7.1) ghc-prof(polyparse-1.13-E8FdqtcSqxM3P2njDFrYm8) ghc-prof(time-1.12.2)"
