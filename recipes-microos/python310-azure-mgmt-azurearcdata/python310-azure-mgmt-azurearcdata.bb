...
RPROVIDES:${PN} += "python3-azure-mgmt-azurearcdata python3.10dist(azure-mgmt-azurearcdata) python310-azure-mgmt-azurearcdata python3dist(azure-mgmt-azurearcdata)"
