...
RPROVIDES:${PN} += "gtk-sharp-beans gtk-sharp-beans(aarch-64) mono(gtk-sharp-beans)"
RDEPENDS:${PN} += "gio-sharp gtk-sharp2 mono(gdk-sharp) mono(gio-sharp) mono(glib-sharp) mono(gtk-sharp) mono(mscorlib) mono-core"
