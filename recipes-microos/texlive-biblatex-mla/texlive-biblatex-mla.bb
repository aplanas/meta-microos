...
RPROVIDES:${PN} += "tex(american-mla.lbx) tex(english-mla.lbx) tex(italian-mla.lbx) tex(mla-footnotes.cbx) tex(mla-new.bbx) tex(mla-new.cbx) tex(mla-strict.bbx) tex(mla-strict.cbx) tex(mla.bbx) tex(mla.cbx) tex(mla7.bbx) tex(mla7.cbx) tex(portuguese-mla.lbx) tex(spanish-mla.lbx) texlive-biblatex-mla"
