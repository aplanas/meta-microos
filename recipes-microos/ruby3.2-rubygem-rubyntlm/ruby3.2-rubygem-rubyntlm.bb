...
RPROVIDES:${PN} += "ruby3.2-rubygem-rubyntlm ruby3.2-rubygem-rubyntlm(aarch-64) rubygem(ruby:3.2.0:rubyntlm) rubygem(ruby:3.2.0:rubyntlm:0) rubygem(ruby:3.2.0:rubyntlm:0.6) rubygem(ruby:3.2.0:rubyntlm:0.6.3) rubygem(rubyntlm)"
