...
RPROVIDES:${PN} += "ghc-base16-bytestring-devel ghc-base16-bytestring-devel(aarch-64) ghc-devel(base16-bytestring-1.0.2.0-BWBHxp15W1kvZUUcQHZQU)"
RDEPENDS:${PN} += "/bin/sh ghc-base16-bytestring ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0)"
