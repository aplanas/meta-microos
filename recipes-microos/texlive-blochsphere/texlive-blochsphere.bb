...
RPROVIDES:${PN} += "tex(blochsphere.sty) texlive-blochsphere"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(environ.sty) tex(etoolbox.sty) tex(ifthen.sty) tex(kvoptions.sty) tex(kvsetkeys.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
