...
RPROVIDES:${PN} += "ghc-devel(file-embed-0.0.15.0-LJLaBgMyS4K2tBVYbzJ0uw) ghc-file-embed-devel ghc-file-embed-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(directory-1.3.7.1) ghc-devel(filepath-1.4.2.2) ghc-devel(template-haskell-2.19.0.0) ghc-file-embed"
