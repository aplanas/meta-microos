...
RPROVIDES:${PN} += "python3-sanlock python3.10dist(sanlock-python) python310-sanlock python310-sanlock(aarch-64) python3dist(sanlock-python) sanlock-python"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsanlock.so.1()(64bit) python(abi)"
