...
RPROVIDES:${PN} += "grubby grubby(aarch-64)"
RDEPENDS:${PN} += "/bin/bash ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libblkid.so.1()(64bit) libblkid.so.1(BLKID_1.0)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpopt.so.0()(64bit) libpopt.so.0(LIBPOPT_0)(64bit)"
