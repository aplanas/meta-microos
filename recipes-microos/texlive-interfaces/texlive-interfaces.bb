...
RPROVIDES:${PN} += "tex(interfaces-LaTeX.sty) tex(interfaces-appendix.sty) tex(interfaces-base.sty) tex(interfaces-bookmark.sty) tex(interfaces-embedfile.sty) tex(interfaces-enumitem.sty) tex(interfaces-environ.sty) tex(interfaces-etoolbox.sty) tex(interfaces-fancyhdr.sty) tex(interfaces-hypbmsec.sty) tex(interfaces-hyperref.sty) tex(interfaces-makecell.sty) tex(interfaces-marks.sty) tex(interfaces-pgfkeys.sty) tex(interfaces-scrlfile.sty) tex(interfaces-tikz.sty) tex(interfaces-titlesec.sty) tex(interfaces-tocloft.sty) tex(interfaces-truncate.sty) tex(interfaces-umrand.sty) tex(interfaces.sty) texlive-interfaces"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(auxhook.sty) tex(etex.sty) tex(etoolbox.sty) tex(fp.sty) tex(gettitlestring.sty) tex(infwarerr.sty) tex(ltxcmds.sty) tex(pgfkeys.sty) tex(refcount.sty) tex(scrlfile.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
