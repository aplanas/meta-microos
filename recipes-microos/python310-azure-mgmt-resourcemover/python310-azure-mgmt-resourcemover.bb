...
RPROVIDES:${PN} += "python3-azure-mgmt-resourcemover python3.10dist(azure-mgmt-resourcemover) python310-azure-mgmt-resourcemover python3dist(azure-mgmt-resourcemover)"
