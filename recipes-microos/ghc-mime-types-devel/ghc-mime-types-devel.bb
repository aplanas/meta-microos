...
RPROVIDES:${PN} += "ghc-devel(mime-types-0.1.1.0-IrWGRRDe33Y1D55h7nh7fm) ghc-mime-types-devel ghc-mime-types-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(containers-0.6.7) ghc-devel(text-2.0.2) ghc-mime-types"
