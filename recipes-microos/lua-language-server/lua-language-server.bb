...
RPROVIDES:${PN} += "lua-language-server lua-language-server(aarch-64)"
RDEPENDS:${PN} += "/bin/sh libc.so.6(GLIBC_2.36)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit)"
