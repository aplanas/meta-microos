...
RPROVIDES:${PN} += "typelib(Granite) typelib-1_0-Granite-1_0 typelib-1_0-Granite-1_0(aarch-64)"
RDEPENDS:${PN} += "libgranite.so.6()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gee) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
