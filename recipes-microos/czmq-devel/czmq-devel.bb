...
RPROVIDES:${PN} += "czmq-devel czmq-devel(aarch-64) pkgconfig(libczmq)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libczmq4 pkgconfig(libcurl) pkgconfig(liblz4) pkgconfig(libmicrohttpd) pkgconfig(libsystemd) pkgconfig(libzmq) pkgconfig(nss) pkgconfig(uuid) systemd-devel"
