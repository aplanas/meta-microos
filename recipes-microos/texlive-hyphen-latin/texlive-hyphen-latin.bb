...
RPROVIDES:${PN} += "tex(hyph-la-x-classic.ec.tex) tex(hyph-la-x-classic.tex) tex(hyph-la-x-liturgic.ec.tex) tex(hyph-la-x-liturgic.tex) tex(hyph-la.ec.tex) tex(hyph-la.tex) tex(loadhyph-la-x-classic.tex) tex(loadhyph-la-x-liturgic.tex) tex(loadhyph-la.tex) texlive-hyphen-latin"
