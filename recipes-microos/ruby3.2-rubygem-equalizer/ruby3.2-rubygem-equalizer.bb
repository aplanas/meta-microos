...
RPROVIDES:${PN} += "ruby3.2-rubygem-equalizer ruby3.2-rubygem-equalizer(aarch-64) rubygem(equalizer) rubygem(ruby:3.2.0:equalizer) rubygem(ruby:3.2.0:equalizer:0) rubygem(ruby:3.2.0:equalizer:0.0) rubygem(ruby:3.2.0:equalizer:0.0.11)"
