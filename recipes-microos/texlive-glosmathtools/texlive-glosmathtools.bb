...
RPROVIDES:${PN} += "tex(glosmathtools.sty) texlive-glosmathtools"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsfonts.sty) tex(amsmath.sty) tex(etoolbox.sty) tex(glossaries.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
