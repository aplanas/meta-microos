...
RPROVIDES:${PN} += "python3-Nuitka python3.10dist(nuitka) python310-Nuitka python3dist(nuitka)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 gcc-c++ python(abi) python310-Jinja2 python310-PyYAML python310-appdirs python310-atomicwrites python310-devel scons update-alternatives"
