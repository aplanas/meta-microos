...
RPROVIDES:${PN} += "python3.11dist(flask-wtf) python311-Flask-WTF python3dist(flask-wtf)"
RDEPENDS:${PN} += "python(abi) python311-Flask python311-WTForms python311-Werkzeug python311-itsdangerous"
