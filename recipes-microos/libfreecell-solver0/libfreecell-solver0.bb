...
RPROVIDES:${PN} += "libfreecell-solver.so.0()(64bit) libfreecell-solver0 libfreecell-solver0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig freecell-solver-presets ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit)"
