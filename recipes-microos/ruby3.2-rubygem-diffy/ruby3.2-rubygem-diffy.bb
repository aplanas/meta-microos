...
RPROVIDES:${PN} += "ruby3.2-rubygem-diffy ruby3.2-rubygem-diffy(aarch-64) rubygem(diffy) rubygem(ruby:3.2.0:diffy) rubygem(ruby:3.2.0:diffy:3) rubygem(ruby:3.2.0:diffy:3.4) rubygem(ruby:3.2.0:diffy:3.4.2)"
