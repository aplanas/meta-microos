...
RPROVIDES:${PN} += "python3-PyNaCl python3.10dist(pynacl) python310-PyNaCl python310-PyNaCl(aarch-64) python3dist(pynacl)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsodium.so.23()(64bit) python(abi) python310-cffi"
