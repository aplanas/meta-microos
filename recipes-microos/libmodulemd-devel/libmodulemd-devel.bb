...
RPROVIDES:${PN} += "libmodulemd-devel libmodulemd-devel(aarch-64) pkgconfig(modulemd-2.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmodulemd2(aarch-64) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(rpm) pkgconfig(yaml-0.1) typelib-1_0-Modulemd-2_0(aarch-64)"
