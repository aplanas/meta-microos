...
RPROVIDES:${PN} += "python3-PyFxA python3.10dist(pyfxa) python310-PyFxA python3dist(pyfxa)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-PyBrowserID python310-cryptography python310-requests python310-six update-alternatives"
