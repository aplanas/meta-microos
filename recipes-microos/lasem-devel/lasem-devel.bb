...
RPROVIDES:${PN} += "lasem-devel lasem-devel(aarch-64) pkgconfig(lasem-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblasem-0_4-4 pkgconfig(cairo) pkgconfig(gdk-pixbuf-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libxml-2.0) pkgconfig(pangocairo)"
