...
RPROVIDES:${PN} += "python3.9dist(flexx) python39-flexx python3dist(flexx)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-dialite python39-pscript python39-tornado python39-webruntime update-alternatives"
