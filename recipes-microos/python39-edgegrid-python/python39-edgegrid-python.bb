...
RPROVIDES:${PN} += "python3.9dist(edgegrid-python) python39-edgegrid-python python3dist(edgegrid-python)"
RDEPENDS:${PN} += "python(abi) python39-ndg-httpsclient python39-pyOpenSSL python39-pyasn1 python39-requests python39-urllib3"
