...
RPROVIDES:${PN} += "python3.11dist(macholib) python311-macholib python3dist(macholib)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-altgraph python311-setuptools update-alternatives"
