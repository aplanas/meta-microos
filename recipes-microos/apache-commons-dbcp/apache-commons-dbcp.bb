...
RPROVIDES:${PN} += "apache-commons-dbcp commons-dbcp2 hibernate_jdbc_cache jakarta-commons-dbcp2 mvn(org.apache.commons:commons-dbcp2) mvn(org.apache.commons:commons-dbcp2:pom:)"
RDEPENDS:${PN} += "/bin/sh commons-collections commons-pool2 java-headless javapackages-filesystem jta_api mvn(commons-logging:commons-logging) mvn(org.apache.commons:commons-pool2) update-alternatives"
