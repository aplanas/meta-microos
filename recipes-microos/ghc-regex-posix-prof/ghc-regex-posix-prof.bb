...
RPROVIDES:${PN} += "ghc-prof(regex-posix-0.96.0.1-Db56rsDUom23lFxliY5wt1) ghc-regex-posix-prof ghc-regex-posix-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(containers-0.6.7) ghc-prof(regex-base-0.94.0.2-8EhYuxSr6UD5zE7cP6wrkq) ghc-regex-posix-devel"
