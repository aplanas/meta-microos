...
RPROVIDES:${PN} += "python3.9dist(certbot-dns-google) python39-certbot-dns-google python3dist(certbot-dns-google)"
RDEPENDS:${PN} += "python(abi) python39-acme python39-certbot python39-google-api-python-client python39-google-auth python39-zope.interface"
