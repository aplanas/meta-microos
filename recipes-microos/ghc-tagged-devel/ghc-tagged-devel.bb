...
RPROVIDES:${PN} += "ghc-devel(tagged-0.8.7-CYOhX22Df3PFW5V1S0dOJa) ghc-tagged-devel ghc-tagged-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(template-haskell-2.19.0.0) ghc-devel(transformers-0.5.6.2) ghc-tagged"
