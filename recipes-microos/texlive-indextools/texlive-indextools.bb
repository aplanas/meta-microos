...
RPROVIDES:${PN} += "tex(indextools.sty) texlive-indextools"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifluatex.sty) tex(ifxetex.sty) tex(letltxmacro.sty) tex(multicol.sty) tex(pdftexcmds.sty) tex(xkeyval.sty) tex(xpatch.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
