...
RPROVIDES:${PN} += "tex(pst-plot.sty) tex(pst-plot.tex) tex(pst-plot97.tex) texlive-pst-plot"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(multido.sty) tex(pst-xkey.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
