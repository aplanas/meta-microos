...
RPROVIDES:${PN} += "typelib(Gegl) typelib-1_0-Gegl-0_4 typelib-1_0-Gegl-0_4(aarch-64)"
RDEPENDS:${PN} += "libgegl-0.4.so.0()(64bit) typelib(Babl) typelib(GLib) typelib(GObject)"
