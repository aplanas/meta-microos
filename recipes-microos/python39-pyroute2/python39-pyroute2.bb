...
RPROVIDES:${PN} += "python3.9dist(pyroute2) python39-pyroute2 python39-pyroute2.core python39-pyroute2.ethtool python39-pyroute2.ipdb python39-pyroute2.ipset python39-pyroute2.ndb python39-pyroute2.nftables python39-pyroute2.nslink python3dist(pyroute2)"
RDEPENDS:${PN} += "/usr/bin/python3.9 python(abi) update-alternatives"
