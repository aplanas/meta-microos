...
RPROVIDES:${PN} += "python3.9dist(zarr) python39-zarr python3dist(zarr)"
RDEPENDS:${PN} += "python(abi) python39 python39-asciitree python39-dbm python39-fasteners python39-numcodecs python39-numpy"
