...
RPROVIDES:${PN} += "collectd-plugin-ipmi collectd-plugin-ipmi(aarch-64)"
RDEPENDS:${PN} += "collectd ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libOpenIPMI.so.0()(64bit) libOpenIPMIpthread.so.0()(64bit) libc.so.6(GLIBC_2.34)(64bit)"
