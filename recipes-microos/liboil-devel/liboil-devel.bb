...
RPROVIDES:${PN} += "liboil-devel liboil-devel(aarch-64) pkgconfig(liboil-0.3)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libc.so.6(GLIBC_2.34)(64bit) liboil-0.3.so.0()(64bit) liboil-0_3-0"
