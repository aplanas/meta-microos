...
RPROVIDES:${PN} += "libfa.so.1()(64bit) libfa.so.1(FA_1.0.0)(64bit) libfa.so.1(FA_1.2.0)(64bit) libfa.so.1(FA_1.4.0)(64bit) libfa.so.1(FA_1.5.0)(64bit) libfa1 libfa1(aarch-64)"
