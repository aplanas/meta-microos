...
RPROVIDES:${PN} += "geocode-glib-soup2-devel geocode-glib-soup2-devel(aarch-64) pkgconfig(geocode-glib-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgeocode-glib0 pkgconfig(gio-2.0) typelib-1_0-GeocodeGlib-1_0"
