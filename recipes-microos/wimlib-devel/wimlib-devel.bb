...
RPROVIDES:${PN} += "pkgconfig(wimlib) wimlib-devel wimlib-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libwim15 pkgconfig(fuse) pkgconfig(libcrypto) pkgconfig(libntfs-3g) pkgconfig(libxml-2.0)"
