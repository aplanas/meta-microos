...
RPROVIDES:${PN} += "perl(Sort::Key) perl(Sort::Key::Maker) perl(Sort::Key::Multi) perl(Sort::Key::Natural) perl(Sort::Key::Register) perl(Sort::Key::Types) perl-Sort-Key perl-Sort-Key(aarch-64)"
