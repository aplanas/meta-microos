...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-gnome-gnome_imaging patterns-gnome-gnome_imaging(aarch-64) patterns-openSUSE-gnome_imaging"
RDEPENDS:${PN} += "pattern()"
