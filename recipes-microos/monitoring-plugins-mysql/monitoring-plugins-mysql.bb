...
RPROVIDES:${PN} += "config(monitoring-plugins-mysql) monitoring-plugins-mysql monitoring-plugins-mysql(aarch-64) monitoring-plugins-mysql_query nagios-plugins-mysql"
