...
RPROVIDES:${PN} += "ghc-devel(some-1.0.5-3dwCpkSImpx8T8axxRPR3Z) ghc-some-devel ghc-some-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-some"
