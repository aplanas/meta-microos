...
RDEPENDS:${PN} += "python311-fqdn python311-idna python311-isoduration python311-jsonpointer python311-jsonschema python311-rfc3339-validator python311-rfc3987 python311-uri_template python311-webcolors"
