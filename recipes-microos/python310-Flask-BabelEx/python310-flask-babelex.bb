...
RPROVIDES:${PN} += "python3-Flask-BabelEx python3.10dist(flask-babelex) python310-Flask-BabelEx python3dist(flask-babelex)"
RDEPENDS:${PN} += "python(abi) python310-Babel python310-Flask python310-Jinja2 python310-speaklater"
