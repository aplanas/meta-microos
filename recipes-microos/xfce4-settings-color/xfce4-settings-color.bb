...
RPROVIDES:${PN} += "application() application(xfce4-color-settings.desktop) xfce4-color-settings xfce4-settings-color xfce4-settings-color(aarch-64)"
RDEPENDS:${PN} += "colord ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libatk-1.0.so.0()(64bit) libc.so.6(GLIBC_2.34)(64bit) libcolord.so.2()(64bit) libgdk-3.so.0()(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libxfce4ui-2.so.0()(64bit) libxfce4util.so.7()(64bit) sane-backends xfce4-settings xiccd"
