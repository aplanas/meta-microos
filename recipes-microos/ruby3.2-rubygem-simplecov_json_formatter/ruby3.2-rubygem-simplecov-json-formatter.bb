...
RPROVIDES:${PN} += "ruby3.2-rubygem-simplecov_json_formatter \
ruby3.2-rubygem-simplecov_json_formatter(aarch-64) \
rubygem(ruby:3.2.0:simplecov_json_formatter) \
rubygem(ruby:3.2.0:simplecov_json_formatter:0) \
