...
RPROVIDES:${PN} += "python3.9dist(lazy-object-proxy) python39-lazy-object-proxy python39-lazy-object-proxy(aarch-64) python39-lazy_object_proxy python3dist(lazy-object-proxy)"
