...
RPROVIDES:${PN} += "python3-pastream python3.10dist(pastream) python310-pastream python310-pastream(aarch-64) python3dist(pastream)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsndfile portaudio python(abi) python310-SoundFile python310-cffi python310-pa-ringbuffer python310-sounddevice update-alternatives"
