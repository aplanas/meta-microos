...
RPROVIDES:${PN} += "mate-applet-softupd mate-applet-softupd(aarch-64)"
RDEPENDS:${PN} += "PackageKit gnome-packagekit ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libmate-panel-applet-4.so.1()(64bit) libnotify.so.4()(64bit) libpackagekit-glib2.so.18()(64bit)"
