...
RPROVIDES:${PN} += "python3.9dist(pyproj) python39-pyproj python39-pyproj(aarch-64) python3dist(pyproj)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libproj.so.25()(64bit) python(abi) python39-certifi update-alternatives"
