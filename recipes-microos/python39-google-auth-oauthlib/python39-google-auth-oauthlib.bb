...
RPROVIDES:${PN} += "python3.9dist(google-auth-oauthlib) python39-google-auth-oauthlib python3dist(google-auth-oauthlib)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-google-auth python39-requests-oauthlib update-alternatives"
