...
RPROVIDES:${PN} += "python3.11dist(modernize) python311-modernize python3dist(modernize)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-dbm python311-fissix update-alternatives"
