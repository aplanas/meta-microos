...
RPROVIDES:${PN} += "jetbrains-annotations mvn(com.intellij:annotations) mvn(com.intellij:annotations:pom:) mvn(org.jetbrains:annotations) mvn(org.jetbrains:annotations:pom:)"
