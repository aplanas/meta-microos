...
RPROVIDES:${PN} += "python3.9dist(pip-tools) python39-pip-tools python3dist(pip-tools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-build python39-click python39-pip python39-setuptools python39-wheel"
