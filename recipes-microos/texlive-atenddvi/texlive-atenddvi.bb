...
RPROVIDES:${PN} += "tex(atenddvi-2019-12-11.sty) tex(atenddvi.sty) texlive-atenddvi"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atbegshi.sty) tex(zref-abspage.sty) tex(zref-lastpage.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
