...
RPROVIDES:${PN} += "tex(epigraph-keys.sty) texlive-epigraph-keys"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(conditionals.sty) tex(enumitem.sty) tex(microtype.sty) tex(pgfkeys.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
