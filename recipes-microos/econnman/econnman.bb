...
RPROVIDES:${PN} += "application() application(econnman-agent.desktop) application(econnman.desktop) econnman"
RDEPENDS:${PN} += "/usr/bin/python3 connman python3 python3-efl"
