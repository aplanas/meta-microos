...
RPROVIDES:${PN} += "python3.11dist(django-mailer) python311-django-mailer python3dist(django-mailer)"
RDEPENDS:${PN} += "python(abi) python311-Django python311-lockfile python311-six"
