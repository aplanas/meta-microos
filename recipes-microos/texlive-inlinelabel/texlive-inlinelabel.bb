...
RPROVIDES:${PN} += "tex(inlinelabel.sty) texlive-inlinelabel"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(luatexja-otf.sty) tex(otf.sty) tex(refcount.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
