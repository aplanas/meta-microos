...
RPROVIDES:${PN} += "tex(pst-3dplot.sty) tex(pst-3dplot.tex) texlive-pst-3dplot"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(multido.sty) tex(pst-3d.sty) tex(pst-node.sty) tex(pst-plot.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
