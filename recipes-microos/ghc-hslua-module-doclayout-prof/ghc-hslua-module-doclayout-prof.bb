...
RPROVIDES:${PN} += "ghc-hslua-module-doclayout-prof ghc-hslua-module-doclayout-prof(aarch-64) ghc-prof(hslua-module-doclayout-1.1.0-H1N0AwnXIkUJX0H1lSxUWS)"
RDEPENDS:${PN} += "ghc-hslua-module-doclayout-devel ghc-prof(base-4.17.1.0) ghc-prof(doclayout-0.4.0.1-9Y8Rw4EdBjz2IhzjzOiBy0) ghc-prof(hslua-2.3.0-1soYqkTydt2HAPmAXqHREY) ghc-prof(text-2.0.2)"
