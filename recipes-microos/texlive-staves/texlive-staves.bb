...
RPROVIDES:${PN} += "tex(icelandic.map) tex(icelandic.tfm) tex(staves.sty) texlive-staves"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-staves-fonts"
