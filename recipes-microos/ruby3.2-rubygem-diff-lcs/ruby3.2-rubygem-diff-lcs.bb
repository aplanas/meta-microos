...
RPROVIDES:${PN} += "ruby3.2-rubygem-diff-lcs ruby3.2-rubygem-diff-lcs(aarch-64) rubygem(diff-lcs) rubygem(ruby:3.2.0:diff-lcs) rubygem(ruby:3.2.0:diff-lcs:1) rubygem(ruby:3.2.0:diff-lcs:1.5) rubygem(ruby:3.2.0:diff-lcs:1.5.0)"
