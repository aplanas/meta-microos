...
RPROVIDES:${PN} += "config(dita) dita"
RDEPENDS:${PN} += "/bin/sh /usr/bin/edit-xml-catalog /usr/bin/sgml-register-catalog /usr/bin/xmlcatalog awk coreutils grep sed sgml-skel"
