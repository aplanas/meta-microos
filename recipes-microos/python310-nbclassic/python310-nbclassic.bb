...
RPROVIDES:${PN} += "python3-nbclassic python3.10dist(nbclassic) python310-nbclassic python3dist(nbclassic)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 alts jupyter-nbclassic python(abi) python310-Jinja2 python310-Send2Trash python310-argon2-cffi python310-ipykernel python310-ipython_genutils python310-jupyter-client python310-jupyter-core python310-nbconvert python310-nbformat python310-nest-asyncio python310-notebook-shim python310-prometheus-client python310-pyzmq python310-terminado python310-tornado python310-traitlets"
