...
RPROVIDES:${PN} += "obs-service-product_converter perl(BSKiwiXML) perl(BSProductXML) perl(BSUtil) perl(BSXML)"
RDEPENDS:${PN} += "/bin/bash /usr/bin/perl perl(XML::Structured) perl-XML-Parser perl-XML-Structured"
