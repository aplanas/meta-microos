...
RPROVIDES:${PN} += "python3.9dist(python-fedora) python39-python-fedora python3dist(python-fedora)"
RDEPENDS:${PN} += "python(abi) python39-beautifulsoup4 python39-kitchen python39-lockfile python39-munch python39-openidc-client python39-requests python39-six"
