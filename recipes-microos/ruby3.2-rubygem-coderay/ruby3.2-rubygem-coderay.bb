...
RPROVIDES:${PN} += "ruby3.2-rubygem-coderay ruby3.2-rubygem-coderay(aarch-64) rubygem(coderay) rubygem(ruby:3.2.0:coderay) rubygem(ruby:3.2.0:coderay:1) rubygem(ruby:3.2.0:coderay:1.1) rubygem(ruby:3.2.0:coderay:1.1.3)"
