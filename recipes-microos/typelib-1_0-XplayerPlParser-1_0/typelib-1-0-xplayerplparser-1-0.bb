...
RPROVIDES:${PN} += "typelib(XplayerPlParser) typelib-1_0-XplayerPlParser-1_0 typelib-1_0-XplayerPlParser-1_0(aarch-64)"
RDEPENDS:${PN} += "libxplayer-plparser.so.18()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) xplayer-plparser"
