...
RPROVIDES:${PN} += "config(squidGuard) squidGuard squidGuard(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/perl http_proxy ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdb-4.8.so()(64bit) libldap.so.2()(64bit) libldap.so.2(OPENLDAP_2.200)(64bit) libmariadb.so.3()(64bit) libmariadb.so.3(libmysqlclient_18)(64bit)"
