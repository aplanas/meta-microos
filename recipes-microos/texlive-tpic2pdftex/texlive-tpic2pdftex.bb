...
RPROVIDES:${PN} += "man(tpic2pdftex.1) texlive-tpic2pdftex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-tpic2pdftex-bin"
