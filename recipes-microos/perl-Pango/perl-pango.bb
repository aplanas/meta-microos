...
RPROVIDES:${PN} += "perl(Pango) perl(Pango::Install::Files) perl-Pango perl-Pango(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcairo.so.2()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libpango-1.0.so.0()(64bit) libpangocairo-1.0.so.0()(64bit) perl(:MODULE_COMPAT_5.36.0) perl(Cairo) perl(ExtUtils::Depends) perl(ExtUtils::PkgConfig) perl(Glib)"
