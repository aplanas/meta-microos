...
RPROVIDES:${PN} += "python3.11dist(testrepository) python311-testrepository python3dist(testrepository)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-dbm python311-extras python311-fixtures python311-python-subunit python311-testscenarios python311-testtools update-alternatives"
