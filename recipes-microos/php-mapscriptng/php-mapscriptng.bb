...
RPROVIDES:${PN} += "config(php-mapscriptng) php-mapscriptng php-mapscriptng(aarch-64) php-mapserver"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libmapserver.so.2()(64bit) libmapserver2 php php-gd"
