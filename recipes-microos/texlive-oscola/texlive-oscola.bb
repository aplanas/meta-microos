...
RPROVIDES:${PN} += "tex(american-oscola.lbx) tex(british-oscola.lbx) tex(english-oscola.lbx) tex(oscola.bbx) tex(oscola.cbx) texlive-oscola"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(authortitle.bbx) tex(verbose-inote.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
