...
RPROVIDES:${PN} += "typelib(Modulemd) typelib-1_0-Modulemd-2_0 typelib-1_0-Modulemd-2_0(aarch-64)"
RDEPENDS:${PN} += "libmodulemd.so.2()(64bit) libmodulemd2(aarch-64) typelib(GLib) typelib(GObject)"
