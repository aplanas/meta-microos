...
RPROVIDES:${PN} += "python3-azure-cognitiveservices-vision-customvision python3.10dist(azure-cognitiveservices-vision-customvision) python310-azure-cognitiveservices-vision-customvision python3dist(azure-cognitiveservices-vision-customvision)"
