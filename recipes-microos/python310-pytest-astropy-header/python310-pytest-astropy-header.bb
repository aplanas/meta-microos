...
RPROVIDES:${PN} += "python3-pytest-astropy-header python3-pytest_astropy_header python3.10dist(pytest-astropy-header) python310-pytest-astropy-header python310-pytest_astropy_header python3dist(pytest-astropy-header)"
