...
RPROVIDES:${PN} += "python3.11dist(cherrypy) python311-CherryPy python3dist(cherrypy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 alts python(abi) python311-cheroot python311-jaraco.collections python311-more-itertools python311-portend python311-zc.lockfile"
