...
RPROVIDES:${PN} += "ghc-devel(vector-binary-instances-0.2.5.2-KcST7aCBDJmuBtN6ufmU8) ghc-vector-binary-instances-devel ghc-vector-binary-instances-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(binary-0.8.9.1) ghc-devel(vector-0.13.0.0-AbjrQrWxuFpAjIHk3G7xsp) ghc-vector-binary-instances"
