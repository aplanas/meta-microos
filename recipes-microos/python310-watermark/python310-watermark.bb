...
RPROVIDES:${PN} += "jupyter-watermark python3-jupyter_watermark python3-watermark python3.10dist(watermark) python310-jupyter_watermark python310-watermark python3dist(watermark)"
RDEPENDS:${PN} += "python(abi) python310-ipython"
