...
RDEPENDS:${PN} += "/bin/bash /bin/sh icinga2 icingaweb2 icingaweb2-module-incubator icingaweb2-module-ipl icingaweb2-module-reactbundle php php-curl php-iconv php-pcntl php-posix php-sockets systemd"
