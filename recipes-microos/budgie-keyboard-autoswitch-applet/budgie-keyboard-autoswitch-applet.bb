...
RPROVIDES:${PN} += "budgie-keyboard-autoswitch-applet budgie-keyboard-autoswitch-applet(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 python3-gobject-Gdk python3-psutil typelib(Budgie) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Gtk) wmctrl xdpyinfo xev xlsatoms xlsclients xlsfonts xprop xvinfo xwininfo"
