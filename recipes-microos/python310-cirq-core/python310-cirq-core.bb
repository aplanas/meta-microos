...
RPROVIDES:${PN} += "python3-cirq-core python3.10dist(cirq-core) python310-cirq-core python3dist(cirq-core)"
RDEPENDS:${PN} += "python(abi) python310-duet python310-matplotlib python310-networkx python310-numpy python310-pandas python310-scipy python310-sortedcontainers python310-sympy python310-tqdm python310-typing_extensions"
