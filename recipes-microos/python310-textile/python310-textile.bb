...
RPROVIDES:${PN} += "python3-textile python3.10dist(textile) python310-textile python310-textile(aarch-64) python3dist(textile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Pillow python310-html5lib python310-six update-alternatives"
