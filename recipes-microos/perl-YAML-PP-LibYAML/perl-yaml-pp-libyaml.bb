...
RPROVIDES:${PN} += "perl(YAML::PP::LibYAML) perl(YAML::PP::LibYAML::Emitter) perl(YAML::PP::LibYAML::Parser) perl-YAML-PP-LibYAML"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(YAML::LibYAML::API) perl(YAML::LibYAML::API::XS) perl(YAML::PP) perl(YAML::PP::Emitter) perl(YAML::PP::Parser) perl(YAML::PP::Reader) perl(YAML::PP::Writer)"
