...
RPROVIDES:${PN} += "tex(biblatex-juradiss.bbx) tex(biblatex-juradiss.cbx) texlive-biblatex-juradiss"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(authortitle-dw.bbx) tex(authortitle-dw.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
