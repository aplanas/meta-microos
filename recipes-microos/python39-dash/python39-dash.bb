...
RPROVIDES:${PN} += "python3.9dist(dash) python39-dash python3dist(dash)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Flask python39-Flask-Compress python39-beautifulsoup4 python39-dash-core-components python39-dash-html-components python39-dash-table python39-percy python39-plotly update-alternatives"
