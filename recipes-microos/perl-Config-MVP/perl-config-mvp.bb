...
RPROVIDES:${PN} += "perl(Config::MVP) perl(Config::MVP::Assembler) perl(Config::MVP::Assembler::WithBundles) perl(Config::MVP::Error) perl(Config::MVP::Reader) perl(Config::MVP::Reader::Findable) perl(Config::MVP::Reader::Findable::ByExtension) perl(Config::MVP::Reader::Finder) perl(Config::MVP::Reader::Hash) perl(Config::MVP::Section) perl(Config::MVP::Sequence) perl-Config-MVP"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Class::Load) perl(Module::Pluggable::Object) perl(Moose) perl(Moose::Role) perl(Moose::Util::TypeConstraints) perl(MooseX::OneArgNew) perl(Params::Util) perl(Role::HasMessage) perl(Role::Identifiable::HasIdent) perl(StackTrace::Auto) perl(Test::More) perl(Throwable) perl(Tie::IxHash) perl(Try::Tiny)"
