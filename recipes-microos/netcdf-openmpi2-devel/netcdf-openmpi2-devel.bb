...
RPROVIDES:${PN} += "netcdf-openmpi2-devel netcdf-openmpi2-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh hdf5-openmpi2-devel libcurl-devel libnetcdf19-openmpi2 netcdf-devel-data openmpi2-devel pkgconfig zlib-devel"
