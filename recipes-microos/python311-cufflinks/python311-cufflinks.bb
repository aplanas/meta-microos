...
RPROVIDES:${PN} += "python3.11dist(cufflinks) python311-cufflinks python3dist(cufflinks)"
RDEPENDS:${PN} += "python(abi) python311-colorlover python311-numpy python311-pandas python311-plotly python311-six"
