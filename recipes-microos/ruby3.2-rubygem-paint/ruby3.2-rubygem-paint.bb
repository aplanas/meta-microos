...
RPROVIDES:${PN} += "ruby3.2-rubygem-paint ruby3.2-rubygem-paint(aarch-64) rubygem(paint) rubygem(ruby:3.2.0:paint) rubygem(ruby:3.2.0:paint:2) rubygem(ruby:3.2.0:paint:2.3) rubygem(ruby:3.2.0:paint:2.3.0)"
