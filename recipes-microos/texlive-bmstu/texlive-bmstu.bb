...
RPROVIDES:${PN} += "tex(bmstu-appendix.sty) tex(bmstu-biblio.sty) tex(bmstu-defabbr.sty) tex(bmstu-essay.sty) tex(bmstu-figure.sty) tex(bmstu-listing.sty) tex(bmstu-title.sty) tex(bmstu-toc.sty) tex(bmstu.cls) texlive-bmstu"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(afterpage.sty) tex(amsmath.sty) tex(amssymb.sty) tex(assoccnt.sty) tex(babel.sty) tex(booktabs.sty) tex(csquotes.sty) tex(enumitem.sty) tex(etoolbox.sty) tex(extreport.cls) tex(fix-cm.sty) tex(float.sty) tex(fontenc.sty) tex(graphicx.sty) tex(hyperref.sty) tex(indentfirst.sty) tex(inputenc.sty) tex(lastpage.sty) tex(listings.sty) tex(listingsutf8.sty) tex(lscape.sty) tex(microtype.sty) tex(pgffor.sty) tex(pgfplots.sty) tex(setspace.sty) tex(stackengine.sty) tex(tabularx.sty) tex(tikzscale.sty) tex(titlesec.sty) tex(totcount.sty) tex(ulem.sty) tex(wrapfig.sty) tex(xcolor.sty) tex(xifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
