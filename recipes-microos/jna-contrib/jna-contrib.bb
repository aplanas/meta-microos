...
RPROVIDES:${PN} += "jna-contrib mvn(net.java.dev.jna:jna-platform) mvn(net.java.dev.jna:jna-platform:pom:) mvn(net.java.dev.jna:platform) mvn(net.java.dev.jna:platform:pom:) osgi(com.sun.jna.platform)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem jna mvn(net.java.dev.jna:jna) osgi(com.sun.jna)"
