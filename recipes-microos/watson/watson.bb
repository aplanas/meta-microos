...
RPROVIDES:${PN} += "python3.10dist(td-watson) python3dist(td-watson) watson"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-arrow python3-click python3-click-didyoumean python3-requests"
