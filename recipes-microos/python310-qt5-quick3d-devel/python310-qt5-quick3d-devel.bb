...
RPROVIDES:${PN} += "python3-qt5-quick3d-devel python310-qt5-quick3d-devel python310-qt5-quick3d-devel(aarch-64)"
RDEPENDS:${PN} += "pkgconfig(Qt5Quick3D) python(abi) python310-qt5-devel"
