...
RPROVIDES:${PN} += "tex(xunicode.sty) texlive-xunicode"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(t3enc.def) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-tipa"
