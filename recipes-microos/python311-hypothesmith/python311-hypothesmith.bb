...
RPROVIDES:${PN} += "python3.11dist(hypothesmith) python311-hypothesmith python3dist(hypothesmith)"
RDEPENDS:${PN} += "python(abi) python311-base python311-hypothesis python311-lark python311-libcst"
