...
RPROVIDES:${PN} += "ruby3.2-rubygem-sprockets-helpers ruby3.2-rubygem-sprockets-helpers(aarch-64) rubygem(ruby:3.2.0:sprockets-helpers) rubygem(ruby:3.2.0:sprockets-helpers:1) rubygem(ruby:3.2.0:sprockets-helpers:1.4) rubygem(ruby:3.2.0:sprockets-helpers:1.4.0) rubygem(sprockets-helpers)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:sprockets)"
