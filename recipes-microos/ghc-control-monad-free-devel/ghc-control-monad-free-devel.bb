...
RPROVIDES:${PN} += "ghc-control-monad-free-devel ghc-control-monad-free-devel(aarch-64) ghc-devel(control-monad-free-0.6.2-AMlHq80A2qJLNQ8iIcl5z7)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-control-monad-free ghc-devel(base-4.17.1.0) ghc-devel(transformers-0.5.6.2)"
