...
RPROVIDES:${PN} += "gtkmm4-devel gtkmm4-devel(aarch-64) pkgconfig(gtkmm-4.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgtkmm-4_0-0 pkgconfig(cairomm-1.16) pkgconfig(gdk-pixbuf-2.0) pkgconfig(giomm-2.68) pkgconfig(gtk4) pkgconfig(gtk4-unix-print) pkgconfig(pangomm-2.48)"
