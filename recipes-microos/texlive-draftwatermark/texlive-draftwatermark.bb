...
RPROVIDES:${PN} += "tex(draftwatermark-2x.sty) tex(draftwatermark.sty) texlive-draftwatermark"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(everypage.sty) tex(graphicx.sty) tex(kvoptions.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
