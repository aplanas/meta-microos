...
RPROVIDES:${PN} += "python3.11dist(acitoolkit) python311-acitoolkit python3dist(acitoolkit)"
RDEPENDS:${PN} += "python(abi) python311-graphviz python311-jsonschema python311-requests python311-tabulate python311-websocket-client"
