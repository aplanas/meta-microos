...
RPROVIDES:${PN} += "python3-rich-click python3.10dist(rich-click) python310-rich-click python3dist(rich-click)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-click python310-rich"
