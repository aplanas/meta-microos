...
RPROVIDES:${PN} += "ruby3.2-rubygem-gssapi ruby3.2-rubygem-gssapi(aarch-64) rubygem(gssapi) rubygem(ruby:3.2.0:gssapi) rubygem(ruby:3.2.0:gssapi:1) rubygem(ruby:3.2.0:gssapi:1.3) rubygem(ruby:3.2.0:gssapi:1.3.1)"
