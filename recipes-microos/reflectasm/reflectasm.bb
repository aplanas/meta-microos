...
RPROVIDES:${PN} += "mvn(com.esotericsoftware.reflectasm:reflectasm) mvn(com.esotericsoftware.reflectasm:reflectasm:pom:) mvn(com.esotericsoftware:reflectasm) mvn(com.esotericsoftware:reflectasm:pom:) osgi(com.esotericsoftware.reflectasm) reflectasm"
