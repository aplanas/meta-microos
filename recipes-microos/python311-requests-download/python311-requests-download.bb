...
RPROVIDES:${PN} += "python3.11dist(requests-download) python311-requests-download python3dist(requests-download)"
RDEPENDS:${PN} += "python(abi) python311-progressbar python311-requests"
