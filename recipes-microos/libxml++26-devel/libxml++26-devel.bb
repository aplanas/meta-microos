...
RPROVIDES:${PN} += "libxml++26-devel libxml++26-devel(aarch-64) pkgconfig(libxml++-2.6)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxml++-2_6-2 pkgconfig(glibmm-2.4) pkgconfig(libxml-2.0)"
