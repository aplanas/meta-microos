...
RPROVIDES:${PN} += "python3-sushy python3.10dist(sushy) python3dist(sushy)"
RDEPENDS:${PN} += "python(abi) python3-pbr python3-python-dateutil python3-requests python3-stevedore"
