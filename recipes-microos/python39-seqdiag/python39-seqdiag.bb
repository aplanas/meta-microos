...
RPROVIDES:${PN} += "python3.9dist(seqdiag) python39-seqdiag python3dist(seqdiag)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-blockdiag python39-setuptools update-alternatives"
