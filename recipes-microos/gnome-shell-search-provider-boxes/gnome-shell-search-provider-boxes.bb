...
RPROVIDES:${PN} += "gnome-shell-search-provider-boxes gnome-shell-search-provider-boxes(aarch-64)"
RDEPENDS:${PN} += "gnome-boxes gnome-shell ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libarchive.so.13()(64bit) libc.so.6(GLIBC_2.34)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit)"
