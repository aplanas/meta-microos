...
RPROVIDES:${PN} += "python3.9dist(sunpy) python39-sunpy python39-sunpy(aarch-64) python3dist(sunpy)"
RDEPENDS:${PN} += "/usr/bin/python3.9 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) python(abi) python39-aioftp python39-astropy python39-numpy python39-packaging python39-parfive"
