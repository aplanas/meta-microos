...
RPROVIDES:${PN} += "tex(hep-acronym.sty) texlive-hep-acronym"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amstext.sty) tex(everyhook.sty) tex(glossaries-extra.sty) tex(xparse.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
