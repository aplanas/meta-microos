...
RPROVIDES:${PN} += "fmpp mvn(net.sourceforge.fmpp:fmpp) mvn(net.sourceforge.fmpp:fmpp:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.beanshell:bsh) mvn(org.freemarker:freemarker) mvn(xml-resolver:xml-resolver)"
