...
RPROVIDES:${PN} += "ruby3.2-rubygem-csv ruby3.2-rubygem-csv(aarch-64) rubygem(csv) rubygem(ruby:3.2.0:csv) rubygem(ruby:3.2.0:csv:3) rubygem(ruby:3.2.0:csv:3.2) rubygem(ruby:3.2.0:csv:3.2.5)"
