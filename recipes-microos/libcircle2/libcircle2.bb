...
RPROVIDES:${PN} += "libcircle.so.2()(64bit) libcircle2 libcircle2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libmpi.so.40()(64bit) openmpi4-libs"
