...
RPROVIDES:${PN} += "libdazzle-devel libdazzle-devel(aarch-64) pkgconfig(libdazzle-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config dazzle-list-counters libdazzle-1_0-0 pkgconfig(gtk+-3.0) typelib-1_0-libdazzle-1_0"
