...
RPROVIDES:${PN} += "python3.11dist(pywbem) python311-pywbem python3dist(pywbem)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyYAML python311-nocasedict python311-nocaselist python311-ply python311-requests python311-six python311-urllib3 python311-yamlloader update-alternatives"
