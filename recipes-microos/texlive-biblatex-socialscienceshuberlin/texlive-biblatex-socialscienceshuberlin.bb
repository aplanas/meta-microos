...
RPROVIDES:${PN} += "tex(german-socialscienceshuberlin.lbx) tex(socialscienceshuberlin.bbx) tex(socialscienceshuberlin.cbx) texlive-biblatex-socialscienceshuberlin"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ext-authoryear.bbx) tex(ext-authoryear.cbx) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
