...
RPROVIDES:${PN} += "tex(ResolSysteme.sty) texlive-resolsysteme"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifthen.sty) tex(listofitems.sty) tex(nicefrac.sty) tex(nicematrix.sty) tex(siunitx.sty) tex(xintexpr.sty) tex(xinttools.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
