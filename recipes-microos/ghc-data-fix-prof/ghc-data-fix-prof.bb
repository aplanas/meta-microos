...
RPROVIDES:${PN} += "ghc-data-fix-prof ghc-data-fix-prof(aarch-64) ghc-prof(data-fix-0.3.2-LdyR2jsAdh33KJZuVTGWPw)"
RDEPENDS:${PN} += "ghc-data-fix-devel ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt)"
