...
RPROVIDES:${PN} += "python3.11dist(pyro5) python311-Pyro5 python3dist(pyro5)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-serpent update-alternatives"
