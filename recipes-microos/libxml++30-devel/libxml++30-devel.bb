...
RPROVIDES:${PN} += "libxml++30-devel libxml++30-devel(aarch-64) pkgconfig(libxml++-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibmm2-devel libxml++-3_0-1 pkgconfig(glibmm-2.4) pkgconfig(libxml-2.0)"
