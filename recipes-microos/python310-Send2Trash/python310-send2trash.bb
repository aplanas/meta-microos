...
RPROVIDES:${PN} += "python3-Send2Trash python3.10dist(send2trash) python310-Send2Trash python3dist(send2trash)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) typelib(GObject) typelib(Gio) update-alternatives"
