...
RPROVIDES:${PN} += "ruby3.2-rubygem-ast ruby3.2-rubygem-ast(aarch-64) rubygem(ast) rubygem(ruby:3.2.0:ast) rubygem(ruby:3.2.0:ast:2) rubygem(ruby:3.2.0:ast:2.4) rubygem(ruby:3.2.0:ast:2.4.2)"
