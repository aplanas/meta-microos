...
RPROVIDES:${PN} += "libgeocode-glib-2-0 libgeocode-glib-2-0(aarch-64) libgeocode-glib-2.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig geocode-glib ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libjson-glib-1.0.so.0()(64bit) libjson-glib-1.0.so.0(libjson-glib-1.0.so.0)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libsoup-3.0.so.0()(64bit)"
