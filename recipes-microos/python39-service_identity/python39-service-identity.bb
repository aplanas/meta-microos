...
RPROVIDES:${PN} += "python3.9dist(service-identity) python39-service_identity python3dist(service-identity)"
RDEPENDS:${PN} += "python(abi) python39-attrs python39-cryptography python39-pyasn1 python39-pyasn1-modules python39-six"
