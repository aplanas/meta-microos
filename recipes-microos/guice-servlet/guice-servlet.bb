...
RPROVIDES:${PN} += "guice-servlet mvn(com.google.inject.extensions:guice-servlet) mvn(com.google.inject.extensions:guice-servlet:pom:) mvn(org.sonatype.sisu.inject:guice-servlet) mvn(org.sonatype.sisu.inject:guice-servlet:pom:) osgi(com.google.inject.servlet)"
