...
RPROVIDES:${PN} += "ghc-devel(http-date-0.0.11-IfCBGXPFiMuIKzFtOTNgnD) ghc-http-date-devel ghc-http-date-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(attoparsec-0.14.4-21v4nlnPs0qLZ5R1FIK9u3) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(time-1.12.2) ghc-http-date"
