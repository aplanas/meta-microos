...
RPROVIDES:${PN} += "python3-asdf-standard python3-asdf_standard python3.10dist(asdf-standard) python310-asdf-standard python310-asdf_standard python3dist(asdf-standard)"
