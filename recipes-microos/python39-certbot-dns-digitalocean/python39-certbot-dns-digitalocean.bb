...
RPROVIDES:${PN} += "python3.9dist(certbot-dns-digitalocean) python39-certbot-dns-digitalocean python3dist(certbot-dns-digitalocean)"
RDEPENDS:${PN} += "python(abi) python39-acme python39-certbot python39-digitalocean python39-six python39-zope.interface"
