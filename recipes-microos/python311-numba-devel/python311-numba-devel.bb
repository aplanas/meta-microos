...
RPROVIDES:${PN} += "python311-numba-devel python311-numba-devel(aarch-64)"
RDEPENDS:${PN} += "(python311-numpy-devel >= 1.21 with python311-numpy-devel < 1.25) python(abi) python311-devel python311-numba"
