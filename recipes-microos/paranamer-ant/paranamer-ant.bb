...
RPROVIDES:${PN} += "mvn(com.thoughtworks.paranamer:paranamer-ant) mvn(com.thoughtworks.paranamer:paranamer-ant:pom:) paranamer-ant"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.thoughtworks.paranamer:paranamer-generator) mvn(org.apache.ant:ant)"
