...
RPROVIDES:${PN} += "config(jfbterm) jfbterm jfbterm(aarch-64)"
RDEPENDS:${PN} += "/bin/cat /bin/sh /usr/bin/grep ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.29)(64bit) permissions"
