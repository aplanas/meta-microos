...
RPROVIDES:${PN} += "ruby3.2-rubygem-webrick ruby3.2-rubygem-webrick(aarch-64) rubygem(ruby:3.2.0:webrick) rubygem(ruby:3.2.0:webrick:1) rubygem(ruby:3.2.0:webrick:1.7) rubygem(ruby:3.2.0:webrick:1.7.0) rubygem(webrick)"
