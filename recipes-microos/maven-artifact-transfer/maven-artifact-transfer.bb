...
RPROVIDES:${PN} += "maven-artifact-transfer mvn(org.apache.maven.shared:maven-artifact-transfer) mvn(org.apache.maven.shared:maven-artifact-transfer:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven.shared:maven-common-artifact-filters) mvn(org.apache.maven:maven-artifact) mvn(org.apache.maven:maven-core) mvn(org.codehaus.plexus:plexus-component-annotations) mvn(org.codehaus.plexus:plexus-utils) mvn(org.eclipse.aether:aether-util) mvn(org.slf4j:slf4j-api)"
