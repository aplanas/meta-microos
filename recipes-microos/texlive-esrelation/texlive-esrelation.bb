...
RPROVIDES:${PN} += "tex(esrelation.map) tex(esrelation.sty) tex(esrelation10.tfm) tex(uesrelation.fd) texlive-esrelation"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-esrelation-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
