...
RPROVIDES:${PN} += "man(patgen.1) texlive-patgen"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-patgen-bin texlive-scripts texlive-scripts-bin"
