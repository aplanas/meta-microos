...
RPROVIDES:${PN} += "dbus-1-python3-devel dbus-1-python310-devel pkgconfig(dbus-python-3.10) python3-dbus-python-devel python310-dbus-python-devel python310-dbus-python-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config dbus-1 dbus-1-devel pkgconfig(dbus-1) python310-dbus-python python310-dbus-python-common-devel python310-devel"
