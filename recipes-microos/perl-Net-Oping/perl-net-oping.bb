...
RPROVIDES:${PN} += "perl(Net::Oping) perl-Net-Oping perl-Net-Oping(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) perl"
