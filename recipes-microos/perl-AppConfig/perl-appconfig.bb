...
RPROVIDES:${PN} += "perl(AppConfig) perl(AppConfig::Args) perl(AppConfig::CGI) perl(AppConfig::File) perl(AppConfig::Getopt) perl(AppConfig::State) perl(AppConfig::Sys) perl-AppConfig"
