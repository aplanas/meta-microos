...
RPROVIDES:${PN} += "ruby3.2-rubygem-rack-proxy ruby3.2-rubygem-rack-proxy(aarch-64) rubygem(rack-proxy) rubygem(ruby:3.2.0:rack-proxy) rubygem(ruby:3.2.0:rack-proxy:0) rubygem(ruby:3.2.0:rack-proxy:0.7) rubygem(ruby:3.2.0:rack-proxy:0.7.4)"
