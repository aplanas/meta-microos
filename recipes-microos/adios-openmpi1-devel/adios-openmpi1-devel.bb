...
RPROVIDES:${PN} += "adios-openmpi1-devel adios-openmpi1-devel(aarch-64)"
RDEPENDS:${PN} += "adios-openmpi1 adios-openmpi1-devel-static hdf5-openmpi1-devel netcdf-openmpi1-devel"
