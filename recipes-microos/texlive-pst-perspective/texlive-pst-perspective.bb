...
RPROVIDES:${PN} += "tex(pst-perspective.sty) tex(pst-perspective.tex) texlive-pst-perspective"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(pst-grad.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
