...
RPROVIDES:${PN} += "python311-qt5-remoteobjects-devel python311-qt5-remoteobjects-devel(aarch-64)"
RDEPENDS:${PN} += "pkgconfig(Qt5RemoteObjects) python(abi) python311-qt5-devel"
