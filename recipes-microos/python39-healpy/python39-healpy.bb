...
RPM_NAME = "python39-healpy-1.16.1-1.5.aarch64.rpm"
RPM_HASH = "11e8d53cdb24552f9ebecaf821ba505a5a0e4316cec0c1793029cb6878a77f8f47861428a7c187c7d8028b502dc1a23e7e99709f013b0cef4611924d5b09eda1"

RPROVIDES:${PN} += "python3.9dist(healpy) python39-healpy python39-healpy(aarch-64) python3dist(healpy)"
RDEPENDS:${PN} += "/bin/bash /bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgcc_s.so.1()(64bit) libgcc_s.so.1(GCC_3.0)(64bit) libgcc_s.so.1(GCC_3.3.1)(64bit) libgcc_s.so.1(GCC_4.0.0)(64bit) libhealpix_cxx.so.3()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) libstdc++.so.6()(64bit) libstdc++.so.6(CXXABI_1.3)(64bit) libstdc++.so.6(CXXABI_1.3.8)(64bit) libstdc++.so.6(GLIBCXX_3.4)(64bit) libstdc++.so.6(GLIBCXX_3.4.11)(64bit) libstdc++.so.6(GLIBCXX_3.4.21)(64bit) python(abi) python39-astropy python39-matplotlib python39-numpy python39-scipy update-alternatives"
