...
RPROVIDES:${PN} += "tex(bang10.tfm) tex(bangfont.tex) tex(bangsl10.tfm) tex(bangwd10.tfm) tex(barticle.cls) tex(bbk10.clo) tex(bbk11.clo) tex(bbk12.clo) tex(bbook.cls) tex(bletter.cls) tex(bsize10.clo) tex(bsize11.clo) tex(bsize12.clo) texlive-bangtex"
