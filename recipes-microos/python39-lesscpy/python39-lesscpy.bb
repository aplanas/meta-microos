...
RPROVIDES:${PN} += "python3.9dist(lesscpy) python39-lesscpy python3dist(lesscpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-ply python39-setuptools python39-six update-alternatives"
