...
RPROVIDES:${PN} += "ghc-case-insensitive-prof ghc-case-insensitive-prof(aarch-64) ghc-prof(case-insensitive-1.2.1.0-AumZoR4Lds63HJj8OQwHY3)"
RDEPENDS:${PN} += "ghc-case-insensitive-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-prof(text-2.0.2)"
