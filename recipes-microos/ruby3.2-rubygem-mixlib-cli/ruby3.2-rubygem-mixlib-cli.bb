...
RPROVIDES:${PN} += "ruby3.2-rubygem-mixlib-cli ruby3.2-rubygem-mixlib-cli(aarch-64) rubygem(mixlib-cli) rubygem(ruby:3.2.0:mixlib-cli) rubygem(ruby:3.2.0:mixlib-cli:2) rubygem(ruby:3.2.0:mixlib-cli:2.1) rubygem(ruby:3.2.0:mixlib-cli:2.1.8)"
