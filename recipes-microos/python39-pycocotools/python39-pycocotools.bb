...
RPROVIDES:${PN} += "python3.9dist(pycocotools) python39-cocotools python39-pycocotools python39-pycocotools(aarch-64) python3dist(pycocotools)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-Cython python39-matplotlib python39-setuptools"
