...
RPROVIDES:${PN} += "ruby3.2-rubygem-ed25519 ruby3.2-rubygem-ed25519(aarch-64) rubygem(ed25519) rubygem(ruby:3.2.0:ed25519) rubygem(ruby:3.2.0:ed25519:1) rubygem(ruby:3.2.0:ed25519:1.3) rubygem(ruby:3.2.0:ed25519:1.3.0)"
