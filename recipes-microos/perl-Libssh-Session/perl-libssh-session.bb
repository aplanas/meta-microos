...
RPROVIDES:${PN} += "perl(Libssh::Session) perl(Libssh::Sftp) perl-Libssh-Session perl-Libssh-Session(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libssh.so.4()(64bit) libssh.so.4(LIBSSH_4_5_0)(64bit) perl(:MODULE_COMPAT_5.36.0)"
