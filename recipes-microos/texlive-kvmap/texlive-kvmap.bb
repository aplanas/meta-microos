...
RPROVIDES:${PN} += "tex(kvmap.sty) texlive-kvmap"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(expl3.sty) tex(tikz.sty) tex(xparse.sty) texlive texlive-amsmath texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-l3experimental texlive-pgf texlive-scripts texlive-scripts-bin"
