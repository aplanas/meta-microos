...
RPROVIDES:${PN} += "libsearpc-devel libsearpc-devel(aarch-64) pkgconfig(libsearpc)"
RDEPENDS:${PN} += "/usr/bin/pkg-config /usr/bin/python3 libsearpc1 pkgconfig(gio-2.0) pkgconfig(gobject-2.0) pkgconfig(jansson)"
