...
RPROVIDES:${PN} += "libsamba-policy-python3-devel libsamba-policy-python3-devel(aarch-64) pkgconfig(samba-policy.cpython-310-aarch64-linux-gnu)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libsamba-policy0-python3 pkgconfig(ldb) pkgconfig(talloc)"
