...
RPROVIDES:${PN} += "font(emmentaler-11) font(emmentaler-13) font(emmentaler-14) font(emmentaler-16) font(emmentaler-18) font(emmentaler-20) font(emmentaler-23) font(emmentaler-26) font(emmentaler-brace) lilypond-emmentaler-fonts"
RDEPENDS:${PN} += ""
