...
RPROVIDES:${PN} += "python3.9dist(calmjs) python39-calmjs python3dist(calmjs)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-calmjs.parse python39-calmjs.types update-alternatives"
