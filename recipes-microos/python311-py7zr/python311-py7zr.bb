...
RPROVIDES:${PN} += "python3.11dist(py7zr) python311-py7zr python3dist(py7zr)"
RDEPENDS:${PN} += "(python311-pyppmd >= 0.18.1 with python311-pyppmd < 1.1.0) /bin/sh /usr/bin/python3.11 python(abi) python311-Brotli python311-inflate64 python311-multivolumefile python311-psutil python311-pybcj python311-pycryptodomex python311-pyzstd python311-texttable update-alternatives"
