...
RPROVIDES:${PN} += "libpurple-client.so.0()(64bit) libpurple-client0 libpurple-client0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libc.so.6(GLIBC_2.17)(64bit) libdbus-glib-1.so.2()(64bit) libglib-2.0.so.0()(64bit)"
