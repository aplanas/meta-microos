...
RPROVIDES:${PN} += "config(xalan-j2) jaxp_transform_impl mvn(xalan:serializer) mvn(xalan:serializer:pom:) mvn(xalan:xalan) mvn(xalan:xalan:pom:) osgi(org.apache.xalan) osgi(org.apache.xml.serializer) xalan-j2"
RDEPENDS:${PN} += "/bin/sh java-headless javapackages-filesystem jaxp_parser_impl mvn(xml-apis:xml-apis) osgi(org.apache.xerces) update-alternatives"
