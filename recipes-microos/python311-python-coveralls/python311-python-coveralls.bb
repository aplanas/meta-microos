...
RPROVIDES:${PN} += "python3.11dist(python-coveralls) python311-python-coveralls python3dist(python-coveralls)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyYAML python311-coverage python311-requests python311-six update-alternatives"
