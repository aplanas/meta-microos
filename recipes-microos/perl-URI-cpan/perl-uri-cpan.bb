...
RPROVIDES:${PN} += "perl(URI::cpan) perl(URI::cpan::author) perl(URI::cpan::dist) perl(URI::cpan::distfile) perl(URI::cpan::module) perl(URI::cpan::package) perl-URI-cpan"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(CPAN::DistnameInfo) perl(URI) perl(parent)"
