...
RPROVIDES:${PN} += "ruby3.2-rubygem-thor ruby3.2-rubygem-thor(aarch-64) rubygem(ruby:3.2.0:thor) rubygem(ruby:3.2.0:thor:1) rubygem(ruby:3.2.0:thor:1.2) rubygem(ruby:3.2.0:thor:1.2.1) rubygem(thor)"
