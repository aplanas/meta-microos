...
RPROVIDES:${PN} += "python3.11dist(python-dmidecode) python311-dmidecode python311-dmidecode(aarch-64) python3dist(python-dmidecode)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libxml2.so.2()(64bit) libxml2.so.2(LIBXML2_2.4.30)(64bit) libxml2.so.2(LIBXML2_2.6.0)(64bit) libxml2.so.2(LIBXML2_2.6.2)(64bit) libxml2mod.cpython-311-aarch64-linux-gnu.so()(64bit) python(abi) python311 update-alternatives"
