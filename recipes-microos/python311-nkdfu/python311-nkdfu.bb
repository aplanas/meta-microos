...
RPROVIDES:${PN} += "python3.11dist(nkdfu) python311-nkdfu python3dist(nkdfu)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 intelhex python(abi) python311-fire python311-libusb1 python311-tqdm update-alternatives"
