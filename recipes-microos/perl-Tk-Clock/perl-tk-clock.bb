...
RPROVIDES:${PN} += "perl(Tk::Clock) perl-Tk-Clock"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Test::More) perl(Test::NoWarnings) perl(Tk) perl(Tk::Canvas) perl(Tk::Derived) perl(Tk::Widget)"
