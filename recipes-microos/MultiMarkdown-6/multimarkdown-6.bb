...
RPROVIDES:${PN} += "MultiMarkdown-6 MultiMarkdown-6(aarch-64) markdown"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) texlive-filesystem update-alternatives"
