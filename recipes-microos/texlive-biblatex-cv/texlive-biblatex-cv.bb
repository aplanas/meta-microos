...
RPROVIDES:${PN} += "tex(american-cv.lbx) tex(biblatex-cv.bbx) tex(biblatex-cv.cbx) tex(biblatex-cv.sty) texlive-biblatex-cv"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(american.lbx) tex(authoryear.bbx) tex(authoryear.cbx) tex(biblatex.sty) tex(datenumber.sty) tex(expl3.sty) tex(fp.sty) tex(totcount.sty) tex(xparse.sty) tex(xpatch.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
