...
RPROVIDES:${PN} += "ghc-data-default-instances-containers-devel ghc-data-default-instances-containers-devel(aarch-64) ghc-devel(data-default-instances-containers-0.0.1-GsTPO88BTeU5gVKxrRffFz)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-data-default-instances-containers ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(data-default-class-0.1.2.0-2LD1I8dZmn7BW4dkzEwdGZ)"
