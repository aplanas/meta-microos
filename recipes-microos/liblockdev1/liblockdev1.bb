...
RPROVIDES:${PN} += "liblockdev.so.1()(64bit) liblockdev1 liblockdev1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig /usr/sbin/lockdev glibc ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit)"
