...
RPROVIDES:${PN} += "tex(unitn-bimrep.cls) texlive-unitn-bimrep"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(babel.sty) tex(biblatex.sty) tex(fontenc.sty) tex(framed.sty) tex(graphicx.sty) tex(libertine.sty) tex(report.cls) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
