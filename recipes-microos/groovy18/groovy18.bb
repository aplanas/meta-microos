...
RPROVIDES:${PN} += "config(groovy18) groovy18"
RDEPENDS:${PN} += "/bin/sh glassfish-jsp-api glassfish-servlet-api groovy18-lib mvn(bsf:bsf) mvn(com.thoughtworks.xstream:xstream) mvn(commons-cli:commons-cli) mvn(commons-logging:commons-logging) mvn(jline:jline) mvn(junit:junit) mvn(org.apache.ant:ant) mvn(org.apache.ant:ant-antlr) mvn(org.apache.ant:ant-junit) mvn(org.apache.ant:ant-launcher) mvn(org.apache.ivy:ivy) mvn(org.fusesource.jansi:jansi)"
