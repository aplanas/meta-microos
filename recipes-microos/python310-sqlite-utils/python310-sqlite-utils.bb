...
RPROVIDES:${PN} += "python3-sqlite-utils python3.10dist(sqlite-utils) python310-sqlite-utils python3dist(sqlite-utils)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-click python310-click-default-group python310-sqlite-fts4 python310-tabulate update-alternatives"
