...
RPROVIDES:${PN} += "python3.9dist(zodb) python39-ZODB python3dist(zodb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-BTrees python39-ZConfig python39-persistent python39-six python39-transaction python39-zc.lockfile python39-zodbpickle python39-zope.interface update-alternatives"
