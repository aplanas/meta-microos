...
RPROVIDES:${PN} += "python3.9dist(myst-parser) python39-myst-parser python3dist(myst-parser)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Jinja2 python39-PyYAML python39-Sphinx python39-docutils python39-markdown-it-py python39-mdit-py-plugins python39-typing-extensions update-alternatives"
