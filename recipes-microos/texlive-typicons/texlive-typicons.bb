...
RPROVIDES:${PN} += "tex(typicons.sty) texlive-typicons"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontspec.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-typicons-fonts"
