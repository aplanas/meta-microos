...
RPROVIDES:${PN} += "mvn(org.scala-sbt:launcher-implementation) mvn(org.scala-sbt:launcher-implementation:pom:) sbt-launcher"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.ivy:ivy) mvn(org.scala-lang:scala-library) mvn(org.scala-sbt:launcher-interface)"
