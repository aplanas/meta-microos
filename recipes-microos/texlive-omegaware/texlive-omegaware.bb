...
RPROVIDES:${PN} += "man(odvicopy.1) man(odvitype.1) man(ofm2opl.1) man(opl2ofm.1) man(otangle.1) man(otp2ocp.1) man(outocp.1) man(ovf2ovp.1) man(ovp2ovf.1) texlive-omegaware"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-omegaware-bin texlive-scripts texlive-scripts-bin"
