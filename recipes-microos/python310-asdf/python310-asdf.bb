...
RDEPENDS:${PN} += "(python310-jsonschema >= 4.0.1 with python310-jsonschema < 4.18) /bin/sh /usr/bin/python3.10 python(abi) python310-PyYAML python310-asdf-standard python310-asdf-transform-schemas python310-asdf-unit-schemas python310-importlib-metadata python310-jmespath python310-numpy python310-packaging python310-semantic_version update-alternatives"
