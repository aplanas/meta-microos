...
RPROVIDES:${PN} += "libXScrnSaver-devel libXss-devel libXss-devel(aarch-64) pkgconfig(xscrnsaver)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXss1 pkgconfig(scrnsaverproto) pkgconfig(x11) pkgconfig(xext)"
