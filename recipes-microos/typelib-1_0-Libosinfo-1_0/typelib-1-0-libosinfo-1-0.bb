...
RPROVIDES:${PN} += "typelib(Libosinfo) typelib-1_0-Libosinfo-1_0 typelib-1_0-Libosinfo-1_0(aarch-64)"
RDEPENDS:${PN} += "libosinfo-1.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(libxml2)"
