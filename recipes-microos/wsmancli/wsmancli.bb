...
RPROVIDES:${PN} += "wsmancli wsmancli(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libwsman.so.1()(64bit) libwsman_client.so.5()(64bit) libwsman_curl_client_transport.so.1()(64bit)"
