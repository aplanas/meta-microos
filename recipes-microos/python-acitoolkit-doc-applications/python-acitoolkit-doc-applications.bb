...
RDEPENDS:${PN} += "python-acitoolkit-doc python3-Flask python3-Flask-Admin python3-Flask-Bootstrap python3-Flask-Cors python3-Flask-HTTPAuth python3-Flask-SQLAlchemy python3-Flask-WTF python3-GitPython python3-py-radix"
