...
RPROVIDES:${PN} += "genders genders(aarch-64)"
RDEPENDS:${PN} += "genders-base ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgenders.so.0()(64bit)"
