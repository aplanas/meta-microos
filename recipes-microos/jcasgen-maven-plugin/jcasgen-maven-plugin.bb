...
RPROVIDES:${PN} += "jcasgen-maven-plugin mvn(org.apache.uima:jcasgen-maven-plugin) mvn(org.apache.uima:jcasgen-maven-plugin:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven:maven-core) mvn(org.apache.maven:maven-plugin-api) mvn(org.apache.uima:uimaj-tools) mvn(org.sonatype.plexus:plexus-build-api)"
