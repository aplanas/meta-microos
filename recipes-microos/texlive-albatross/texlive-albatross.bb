...
RPROVIDES:${PN} += "tex(albatross.jar) texlive-albatross"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep java sed texlive texlive-albatross-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
