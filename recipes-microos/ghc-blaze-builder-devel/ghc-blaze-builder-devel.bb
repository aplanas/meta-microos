...
RPROVIDES:${PN} += "ghc-blaze-builder-devel ghc-blaze-builder-devel(aarch-64) ghc-devel(blaze-builder-0.4.2.2-1GcRIc7N7YHId5Q5gRvlvW)"
RDEPENDS:${PN} += "/bin/sh ghc-blaze-builder ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(ghc-prim-0.9.0) ghc-devel(text-2.0.2)"
