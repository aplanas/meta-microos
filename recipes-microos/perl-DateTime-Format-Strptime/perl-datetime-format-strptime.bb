...
RPROVIDES:${PN} += "perl(DateTime::Format::Strptime) perl(DateTime::Format::Strptime::Types) perl-DateTime-Format-Strptime"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DateTime) perl(DateTime::Locale) perl(DateTime::Locale::Base) perl(DateTime::Locale::FromData) perl(DateTime::TimeZone) perl(Params::ValidationCompiler) perl(Specio) perl(Specio::Declare) perl(Specio::Exporter) perl(Specio::Library::Builtins) perl(Specio::Library::String) perl(Try::Tiny) perl(parent)"
