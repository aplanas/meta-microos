...
RPROVIDES:${PN} += "appdata-tools appstream-glib-devel appstream-glib-devel(aarch-64) pkgconfig(appstream-glib)"
RDEPENDS:${PN} += "/usr/bin/pkg-config appstream-glib libappstream-glib8 pkgconfig(gdk-pixbuf-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libarchive) pkgconfig(uuid) typelib-1_0-AppStreamGlib-1_0"
