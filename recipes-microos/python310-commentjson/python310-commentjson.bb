...
RPROVIDES:${PN} += "python3-commentjson python3.10dist(commentjson) python310-commentjson python3dist(commentjson)"
RDEPENDS:${PN} += "python(abi) python310-lark python310-six"
