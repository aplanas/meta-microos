...
RPROVIDES:${PN} += "ghc-prof(utility-ht-0.0.16-CDN97AfZiejDC1itvZ2hyN) ghc-utility-ht-prof ghc-utility-ht-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-utility-ht-devel"
