...
RPROVIDES:${PN} += "libportal-gtk3-devel libportal-gtk3-devel(aarch-64) pkgconfig(libportal-gtk3)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libportal-gtk3-1 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(gtk+-3.0) pkgconfig(libportal) typelib-1_0-XdpGtk3-1_0"
