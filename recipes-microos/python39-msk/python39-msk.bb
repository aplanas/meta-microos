...
RPROVIDES:${PN} += "python3.9dist(msk) python39-msk python3dist(msk)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-GitPython python39-PyGithub python39-msm update-alternatives"
