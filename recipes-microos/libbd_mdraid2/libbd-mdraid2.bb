...
RPROVIDES:${PN} += "libbd_mdraid.so.2()(64bit) libbd_mdraid2 libbd_mdraid2(aarch-64) libblockdev-mdraid"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbd_utils.so.2()(64bit) libbd_utils2 libbytesize.so.1()(64bit) libc.so.6(GLIBC_2.27)(64bit) libglib-2.0.so.0()(64bit) mdadm"
