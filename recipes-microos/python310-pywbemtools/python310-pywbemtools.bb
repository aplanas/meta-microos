...
RPROVIDES:${PN} += "python3-pywbemtools python3.10dist(pywbemtools) python310-pywbemtools python3dist(pywbemtools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-PyYAML python310-asciitree python310-click python310-click-repl python310-click-spinner python310-nocasedict python310-nocaselist python310-packaging python310-prompt_toolkit python310-psutil python310-pyparsing python310-pywbem python310-six python310-tabulate python310-toposort python310-yamlloader update-alternatives"
