...
RPROVIDES:${PN} += "python3.11dist(svneverever) python311-svneverever python3dist(svneverever)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) subversion update-alternatives"
