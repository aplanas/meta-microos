...
RPROVIDES:${PN} += "python3-azure-cognitiveservices-search-nspkg python3.10dist(azure-cognitiveservices-search-nspkg) python310-azure-cognitiveservices-search-nspkg python3dist(azure-cognitiveservices-search-nspkg)"
