...
RPROVIDES:${PN} += "typelib(GXPS) typelib-1_0-GXPS-0_1 typelib-1_0-GXPS-0_1(aarch-64)"
RDEPENDS:${PN} += "libgxps.so.2()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(cairo)"
