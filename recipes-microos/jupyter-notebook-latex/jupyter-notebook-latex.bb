...
RPROVIDES:${PN} += "jupyter-notebook-latex python310-jupyter_notebook-latex python310-notebook-latex python311-jupyter_notebook-latex python311-notebook-latex python39-jupyter_notebook-latex python39-notebook-latex"
RDEPENDS:${PN} += "jupyter-nbconvert-latex jupyter-notebook"
