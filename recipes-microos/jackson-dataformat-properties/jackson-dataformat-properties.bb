...
RPROVIDES:${PN} += "jackson-dataformat-properties mvn(com.fasterxml.jackson.dataformat:jackson-dataformat-properties) mvn(com.fasterxml.jackson.dataformat:jackson-dataformat-properties:pom:) osgi(com.fasterxml.jackson.dataformat.jackson-dataformat-properties)"
