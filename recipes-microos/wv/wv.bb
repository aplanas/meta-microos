...
RPROVIDES:${PN} += "wv wv(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgsf-1.so.114()(64bit) libwmf-0.2.so.7()(64bit) libwmflite-0.2.so.7()(64bit) libwv-1.2.so.4()(64bit) w3m"
