...
RPROVIDES:${PN} += "ruby3.2-rubygem-multipart-post ruby3.2-rubygem-multipart-post(aarch-64) rubygem(multipart-post) rubygem(ruby:3.2.0:multipart-post) rubygem(ruby:3.2.0:multipart-post:2) rubygem(ruby:3.2.0:multipart-post:2.2) rubygem(ruby:3.2.0:multipart-post:2.2.3)"
