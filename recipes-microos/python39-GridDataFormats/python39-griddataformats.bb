...
RPROVIDES:${PN} += "python3.9dist(griddataformats) python39-GridDataFormats python3dist(griddataformats)"
RDEPENDS:${PN} += "python(abi) python39-mrcfile python39-numpy python39-scipy"
