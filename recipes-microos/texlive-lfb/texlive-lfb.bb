...
RPROVIDES:${PN} += "tex(lfb10.tfm) tex(lfb11.tfm) tex(lfb12.tfm) tex(lfb5.tfm) tex(lfb6.tfm) tex(lfb7.tfm) tex(lfb8.tfm) tex(lfb9.tfm) tex(lfbb10.tfm) tex(lfbb11.tfm) tex(lfbb12.tfm) tex(lfbb5.tfm) tex(lfbb6.tfm) tex(lfbb7.tfm) tex(lfbb8.tfm) tex(lfbb9.tfm) texlive-lfb"
