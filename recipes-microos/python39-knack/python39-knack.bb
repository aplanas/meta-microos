...
RPROVIDES:${PN} += "python3.9dist(knack) python39-knack python3dist(knack)"
RDEPENDS:${PN} += "python(abi) python39-PyYAML python39-argcomplete python39-jmespath python39-pygments python39-tabulate"
