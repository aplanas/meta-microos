...
RPROVIDES:${PN} += "gvfs gvfs(aarch-64) libgioremote-volume-monitor.so()(64bit) libgvfscommon.so()(64bit) libgvfsdaemon.so()(64bit) libgvfsdbus.so()(64bit)"
RDEPENDS:${PN} += "/bin/sh glib2-tools ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgcr-base-3.so.1()(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgudev-1.0.so.0()(64bit) libsecret-1.so.0()(64bit) systemd"
