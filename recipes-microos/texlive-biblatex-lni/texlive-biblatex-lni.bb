...
RPROVIDES:${PN} += "tex(LNI-english.lbx) tex(LNI-ngerman.lbx) tex(LNI.bbx) tex(LNI.cbx) texlive-biblatex-lni"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(alphabetic.bbx) tex(alphabetic.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
