...
RPROVIDES:${PN} += "tex(beamercolorthemeArguelles.sty) tex(beamerfontthemeArguelles.sty) tex(beamerinnerthemeArguelles.sty) tex(beamerouterthemeArguelles.sty) tex(beamerthemeArguelles.sty) texlive-beamertheme-arguelles"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(Alegreya.sty) tex(AlegreyaSans.sty) tex(booktabs.sty) tex(cancel.sty) tex(colortbl.sty) tex(csvsimple.sty) tex(dcolumn.sty) tex(enumitem.sty) tex(eulervm.sty) tex(fontawesome5.sty) tex(fontenc.sty) tex(inputenc.sty) tex(makecell.sty) tex(mathalpha.sty) tex(microtype.sty) tex(opencolor.sty) tex(parskip.sty) tex(pgfplots.sty) tex(tikz.sty) tex(ulem.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
