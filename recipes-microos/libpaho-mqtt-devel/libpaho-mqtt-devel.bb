...
RPROVIDES:${PN} += "cmake(eclipse-paho-mqtt-c) libpaho-mqtt-devel libpaho-mqtt-devel(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpaho-mqtt1"
