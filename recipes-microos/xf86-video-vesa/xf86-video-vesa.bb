...
RPROVIDES:${PN} += "xf86-video-vesa xf86-video-vesa(aarch-64)"
RDEPENDS:${PN} += "X11_ABI_HAS_DPMS_GET_CAPABILITIES X11_ABI_VIDEODRV ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit)"
