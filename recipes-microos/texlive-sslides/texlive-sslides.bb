...
RPROVIDES:${PN} += "tex(sslides.cls) texlive-sslides"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(slides.cls) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
