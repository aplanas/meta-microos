...
RPROVIDES:${PN} += "tex(citation-style-language.sty) texlive-citation-style-language"
RDEPENDS:${PN} += "/bin/sh /usr/bin/luatex /usr/bin/texlua coreutils ed findutils grep sed tex(expl3.sty) tex(filehook.sty) tex(l3keys2e.sty) tex(url.sty) tex(xparse.sty) texlive texlive-citation-style-language-bin texlive-filehook texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-l3kernel texlive-l3packages texlive-lua-uca texlive-lualibs texlive-luatex texlive-luaxml texlive-scripts texlive-scripts-bin texlive-url"
