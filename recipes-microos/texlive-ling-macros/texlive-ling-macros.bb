...
RPROVIDES:${PN} += "tex(ling-macros.sty) texlive-ling-macros"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(gb4e.sty) tex(pbox.sty) tex(relsize.sty) tex(stmaryrd.sty) tex(ulem.sty) tex(upgreek.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
