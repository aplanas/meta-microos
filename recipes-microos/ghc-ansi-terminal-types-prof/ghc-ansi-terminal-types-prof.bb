...
RPROVIDES:${PN} += "ghc-ansi-terminal-types-prof ghc-ansi-terminal-types-prof(aarch-64) ghc-prof(ansi-terminal-types-0.11.5-9ffXWswmNhoANlpnF2SnhR)"
RDEPENDS:${PN} += "ghc-ansi-terminal-types-devel ghc-prof(base-4.17.1.0) ghc-prof(colour-2.3.6-7jQe2xj5Lsa5MbX38iH7Ln)"
