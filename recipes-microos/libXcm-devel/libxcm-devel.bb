...
RPROVIDES:${PN} += "libXcm-devel libXcm-devel(aarch-64) pkgconfig(xcm) pkgconfig(xcm-ddc) pkgconfig(xcm-edid) pkgconfig(xcm-x11)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXcm0 libXcmDDC0 libXcmEDID0 libXcmX11-0 pkgconfig(x11) pkgconfig(xcm-ddc) pkgconfig(xcm-edid) pkgconfig(xcm-x11) pkgconfig(xproto)"
