...
RPROVIDES:${PN} += "libXevie-devel libXevie-devel(aarch-64) pkgconfig(xevie)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXevie1 pkgconfig(x11) pkgconfig(xext) pkgconfig(xproto)"
