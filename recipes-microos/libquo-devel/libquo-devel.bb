...
RPROVIDES:${PN} += "libquo-devel libquo-devel(aarch-64) pkgconfig(libquo)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libquo7"
