...
RPROVIDES:${PN} += "mvn(com.io7m.xom:xom) mvn(com.io7m.xom:xom:pom:) mvn(xom:xom) mvn(xom:xom:pom:) xom"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(xalan:xalan) mvn(xerces:xercesImpl) mvn(xml-apis:xml-apis)"
