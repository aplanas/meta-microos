...
RPROVIDES:${PN} += "ruby3.2-rubygem-tzinfo-1.2 \
ruby3.2-rubygem-tzinfo-1.2(aarch-64) \
rubygem(ruby:3.2.0:tzinfo) \
rubygem(ruby:3.2.0:tzinfo:1) \
rubygem(ruby:3.2.0:tzinfo:1.2) \
rubygem(ruby:3.2.0:tzinfo:1.2.10) \
rubygem(tzinfo)"
