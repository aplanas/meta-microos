...
RPROVIDES:${PN} += "python3.9dist(zdaemon) python39-zdaemon python3dist(zdaemon)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-ZConfig update-alternatives"
