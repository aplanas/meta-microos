...
RPROVIDES:${PN} += "mono(mock-assembly) mono(nunit.framework) mono(nunit.framework.tests) mono(nunit.testdata) mono(nunitlite) mono(nunitlite-runner) mono(nunitlite.tests) mono(slow-nunit-tests) nunit3"
RDEPENDS:${PN} += "/bin/sh mono(System) mono(System.Core) mono(System.Web) mono(System.Windows.Forms) mono(System.Xml) mono(mscorlib)"
