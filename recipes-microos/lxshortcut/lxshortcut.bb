...
RPROVIDES:${PN} += "application() application(lxshortcut.desktop) lxshortcut lxshortcut(aarch-64) mimehandler(application/x-desktop)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libfm-gtk.so.4()(64bit) libfm.so.4()(64bit) libglib-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit)"
