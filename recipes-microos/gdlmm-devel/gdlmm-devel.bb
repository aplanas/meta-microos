...
RPROVIDES:${PN} += "gdlmm-devel gdlmm-devel(aarch-64) pkgconfig(gdlmm-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgdlmm-3_0-2 pkgconfig(gdl-3.0) pkgconfig(glibmm-2.4) pkgconfig(gtkmm-3.0)"
