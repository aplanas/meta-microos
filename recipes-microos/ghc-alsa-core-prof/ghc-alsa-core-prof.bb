...
RPROVIDES:${PN} += "ghc-alsa-core-prof ghc-alsa-core-prof(aarch-64) ghc-prof(alsa-core-0.5.0.1-JiFJwdvZ0Gx6AeuqXKf7yg)"
RDEPENDS:${PN} += "ghc-alsa-core-devel ghc-prof(base-4.17.1.0) ghc-prof(extensible-exceptions-0.1.1.4-ItoFoaqbPMuGIlsBr6VhGY)"
