...
RPROVIDES:${PN} += "metainfo() metainfo(surgescript.appdata.xml) surgescript surgescript(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libsurgescript.so.0.5.6()(64bit)"
