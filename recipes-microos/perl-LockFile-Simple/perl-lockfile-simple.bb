...
RPROVIDES:${PN} += "perl(LockFile::Lock) perl(LockFile::Lock::Simple) perl(LockFile::Manager) perl(LockFile::Simple) perl-LockFile-Simple perl-LockFile-Simple(aarch-64)"
