...
RPROVIDES:${PN} += "python311-gobject-cairo python311-gobject-cairo(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcairo-gobject.so.2()(64bit) libcairo.so.2()(64bit) libgobject-2.0.so.0()(64bit) python(abi) python311-cairo python311-gobject"
