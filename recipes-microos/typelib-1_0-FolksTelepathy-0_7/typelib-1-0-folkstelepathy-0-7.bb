...
RPROVIDES:${PN} += "typelib(FolksTelepathy) typelib-1_0-FolksTelepathy-0_7 typelib-1_0-FolksTelepathy-0_7(aarch-64)"
RDEPENDS:${PN} += "typelib(Folks) typelib(GLib) typelib(GObject) typelib(Gee) typelib(Gio) typelib(TelepathyGLib)"
