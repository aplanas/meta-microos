...
RPROVIDES:${PN} += "python3-azure-mgmt-subscription python3.10dist(azure-mgmt-subscription) python310-azure-mgmt-subscription python3dist(azure-mgmt-subscription)"
