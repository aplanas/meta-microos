...
RPROVIDES:${PN} += "python3-python-lzo python3.10dist(python-lzo) python310-python-lzo python310-python-lzo(aarch-64) python3dist(python-lzo)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) liblzo2.so.2()(64bit) python(abi)"
