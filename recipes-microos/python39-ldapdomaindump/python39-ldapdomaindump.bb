...
RPROVIDES:${PN} += "python3.9dist(ldapdomaindump) python39-ldapdomaindump python3dist(ldapdomaindump)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-dnspython python39-future python39-ldap3"
