...
RPROVIDES:${PN} += "python3.9dist(wsme) python39-WSME python3dist(wsme)"
RDEPENDS:${PN} += "python(abi) python39-WebOb python39-netaddr python39-pytz python39-simplegeneric"
