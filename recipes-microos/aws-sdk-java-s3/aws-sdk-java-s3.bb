...
RPROVIDES:${PN} += "aws-sdk-java-s3 mvn(com.amazonaws:aws-java-sdk-s3) mvn(com.amazonaws:aws-java-sdk-s3:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.amazonaws:aws-java-sdk-core) mvn(com.amazonaws:aws-java-sdk-kms)"
