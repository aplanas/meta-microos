...
RPROVIDES:${PN} += "jctools-experimental mvn(org.jctools:jctools-experimental) mvn(org.jctools:jctools-experimental:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.jctools:jctools-channels) mvn(org.jctools:jctools-core) mvn(org.ow2.asm:asm-all)"
