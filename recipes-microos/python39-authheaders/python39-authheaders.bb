...
RPROVIDES:${PN} += "python3.9dist(authheaders) python39-authheaders python3dist(authheaders)"
RDEPENDS:${PN} += "python(abi) python39-authres python39-dkimpy python39-dnspython python39-publicsuffix2"
