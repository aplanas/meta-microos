...
RPROVIDES:${PN} += "librcc.so.0()(64bit) librcc0 librcc0(aarch-64) librccui.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libaspell.so.15()(64bit) libc.so.6(GLIBC_2.34)(64bit) libdb-4.8.so()(64bit) libenca.so.0()(64bit) librcd.so.0()(64bit) libxml2.so.2()(64bit) libxml2.so.2(LIBXML2_2.4.30)(64bit) libxml2.so.2(LIBXML2_2.6.0)(64bit) rcc-runtime"
