...
RPROVIDES:${PN} += "locale(radeontop:cs) locale(radeontop:de) locale(radeontop:el) locale(radeontop:es) locale(radeontop:fi) locale(radeontop:fr) locale(radeontop:ru) locale(radeontop:sl) locale(radeontop:tr) locale(radeontop:zh_CN) radeontop-lang radeontop-lang-all"
