...
RPROVIDES:${PN} += "mvn(org.apache.xbean:xbean-asm-util) mvn(org.apache.xbean:xbean-asm-util:pom:) mvn(org.apache.xbean:xbean-finder) mvn(org.apache.xbean:xbean-finder:pom:) mvn(org.apache.xbean:xbean-reflect) mvn(org.apache.xbean:xbean-reflect:pom:) osgi(org.apache.xbean.asm-util) osgi(org.apache.xbean.finder) osgi(org.apache.xbean.reflect) xbean"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.slf4j:slf4j-api) objectweb-asm slf4j"
