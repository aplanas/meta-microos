...
RPROVIDES:${PN} += "typelib(DbusmenuGtk) typelib-1_0-DbusmenuGtk-0_4 typelib-1_0-DbusmenuGtk-0_4(aarch-64)"
RDEPENDS:${PN} += "libdbusmenu-glib.so.4()(64bit) libdbusmenu-gtk.so.4()(64bit) typelib(Atk) typelib(Dbusmenu) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2)"
