...
RPROVIDES:${PN} += "python3.11dist(certbot-nginx) python311-certbot-nginx python3dist(certbot-nginx)"
RDEPENDS:${PN} += "nginx python(abi) python311-acme python311-certbot python311-pyOpenSSL python311-pyparsing"
