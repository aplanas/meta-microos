...
RPROVIDES:${PN} += "application() application(com.github.hugolabe.Wike.desktop) metainfo() metainfo(com.github.hugolabe.Wike.metainfo.xml) wike"
RDEPENDS:${PN} += "/usr/bin/python3 python3-gobject-Gdk typelib(Adw) typelib(GLib) typelib(GObject) typelib(Gdk) typelib(Gio) typelib(Gtk) typelib(Pango) typelib(WebKit)"
