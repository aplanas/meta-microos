...
RPROVIDES:${PN} += "ghc-devel(resource-pool-0.4.0.0-CALzen0PV047R0s78YnQuW) ghc-resource-pool-devel ghc-resource-pool-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-devel(primitive-0.7.4.0-AeB0oysC3TAJw9tDpuX8hq) ghc-devel(time-1.12.2) ghc-resource-pool"
