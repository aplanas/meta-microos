...
RPROVIDES:${PN} += "tex(fplmb.tfm) tex(fplmbb.tfm) tex(fplmbi.tfm) tex(fplmr.tfm) tex(fplmri.tfm) tex(zplmb7m.tfm) tex(zplmb7m.vf) tex(zplmb7t.tfm) tex(zplmb7t.vf) tex(zplmb7y.tfm) tex(zplmb7y.vf) tex(zplmr7m.tfm) tex(zplmr7m.vf) tex(zplmr7t.tfm) tex(zplmr7t.vf) tex(zplmr7v.tfm) tex(zplmr7v.vf) tex(zplmr7y.tfm) tex(zplmr7y.vf) texlive-mathpazo"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(cmbsy10.tfm) tex(cmbx10.tfm) tex(cmex10.tfm) tex(cmmi10.tfm) tex(cmmib10.tfm) tex(cmr10.tfm) tex(cmsy10.tfm) tex(pplb8r.tfm) tex(pplbi8r.tfm) tex(pplr8r.tfm) tex(pplri8r.tfm) texlive texlive-filesystem texlive-fpl texlive-kpathsea texlive-kpathsea-bin texlive-mathpazo-fonts texlive-palatino texlive-scripts texlive-scripts-bin"
