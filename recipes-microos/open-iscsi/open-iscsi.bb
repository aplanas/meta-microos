...
RPROVIDES:${PN} += "config(open-iscsi) open-iscsi open-iscsi(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh coreutils ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libisns.so.0()(64bit) libisns.so.0(LIBISNS_0.96)(64bit) libkmod.so.2()(64bit) libkmod.so.2(LIBKMOD_5)(64bit) libmount.so.1()(64bit) libmount.so.1(MOUNT_2.19)(64bit) libmount.so.1(MOUNT_2.22)(64bit) libopeniscsiusr.so.0()(64bit) libopeniscsiusr0 libsystemd.so.0()(64bit) libsystemd.so.0(LIBSYSTEMD_209)(64bit) systemd"
