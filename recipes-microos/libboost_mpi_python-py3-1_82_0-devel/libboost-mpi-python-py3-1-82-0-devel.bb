...
RPROVIDES:${PN} += "libboost_mpi_python-py3-1_82_0-devel libboost_mpi_python-py3-1_82_0-devel(aarch-64) libboost_mpi_python3-devel-impl"
RDEPENDS:${PN} += "libboost_mpi1_82_0-devel libboost_mpi_python-py3-1_82_0 libboost_python-py3-1_82_0"
