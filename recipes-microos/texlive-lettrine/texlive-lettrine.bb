...
RPROVIDES:${PN} += "tex(lettrine-2006-03-17.sty) tex(lettrine-2015-08-31.sty) tex(lettrine-2018-08-18.sty) tex(lettrine.cfg) tex(lettrine.sty) texlive-lettrine"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(keyval.sty) tex(minifp.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
