...
RPROVIDES:${PN} += "mumps-ptscotch-openmpi4-devel mumps-ptscotch-openmpi4-devel(aarch-64)"
RDEPENDS:${PN} += "libmumps-ptscotch5_3_5-openmpi4 mumps-devel mumps-scotch-devel openmpi4-devel ptscotch-openmpi4-devel scalapack-openmpi4-devel"
