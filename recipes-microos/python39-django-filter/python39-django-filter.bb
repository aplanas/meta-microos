...
RPROVIDES:${PN} += "python3.9dist(django-filter) python39-django-filter python3dist(django-filter)"
RDEPENDS:${PN} += "python(abi) python39-Django python39-djangorestframework"
