...
RPROVIDES:${PN} += "libayatana-appindicator3-devel libayatana-appindicator3-devel(aarch-64) pkgconfig(ayatana-appindicator3-0.1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libayatana-appindicator3-1 pkgconfig(ayatana-indicator3-0.4) pkgconfig(dbusmenu-glib-0.4) pkgconfig(glib-2.0) pkgconfig(gtk+-3.0)"
