...
RPROVIDES:${PN} += "python3.9dist(pycha) python39-pycha python3dist(pycha)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-cairocffi update-alternatives"
