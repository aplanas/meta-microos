...
RPROVIDES:${PN} += "ghc-prettyprinter-prof ghc-prettyprinter-prof(aarch-64) ghc-prof(prettyprinter-1.7.1-1jjh6iCiPNl8MgeqtPsio2)"
RDEPENDS:${PN} += "ghc-prettyprinter-devel ghc-prof(base-4.17.1.0) ghc-prof(text-2.0.2)"
