...
RPROVIDES:${PN} += "alsa-tools-gui application() application(hwmixvolume.desktop) hwmixvolume hwmixvolume(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python pyalsa typelib(GLib) typelib(Gtk)"
