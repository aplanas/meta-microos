...
RPROVIDES:${PN} += "tex(mismath.sty) texlive-mismath"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(esvect.sty) tex(fontenc.sty) tex(ibrackets.sty) tex(iftex.sty) tex(ifthen.sty) tex(mathtools.sty) tex(xparse.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
