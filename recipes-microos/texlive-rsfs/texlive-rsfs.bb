...
RPROVIDES:${PN} += "tex(rsfs.map) tex(rsfs10.tfm) tex(rsfs5.tfm) tex(rsfs7.tfm) tex(scrload.tex) texlive-rsfs"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-rsfs-fonts texlive-scripts texlive-scripts-bin"
