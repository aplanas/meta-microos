...
RPROVIDES:${PN} += "kuberlr kuberlr(aarch-64) kubernetes-client-provider"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/touch fillup libc.so.6(GLIBC_2.34)(64bit) update-alternatives"
