...
RPROVIDES:${PN} += "python3.11dist(pymisp) python311-pymisp python3dist(pymisp)"
RDEPENDS:${PN} += "python(abi) python311-Deprecated python311-jsonschema python311-oletools python311-python-dateutil python311-requests"
