...
RPROVIDES:${PN} += "python3.11dist(padatious) python311-padatious python3dist(padatious)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-fann2 python311-padaos python311-setuptools python311-xxhash update-alternatives"
