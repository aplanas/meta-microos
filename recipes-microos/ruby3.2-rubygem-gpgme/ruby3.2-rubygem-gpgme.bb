...
RPROVIDES:${PN} += "ruby3.2-rubygem-gpgme ruby3.2-rubygem-gpgme(aarch-64) rubygem(gpgme) rubygem(ruby:3.2.0:gpgme) rubygem(ruby:3.2.0:gpgme:2) rubygem(ruby:3.2.0:gpgme:2.0) rubygem(ruby:3.2.0:gpgme:2.0.22)"
RDEPENDS:${PN} += "/usr/bin/ruby.ruby3.2 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgpgme.so.11()(64bit) libgpgme.so.11(GPGME_1.0)(64bit) libgpgme.so.11(GPGME_1.1)(64bit) libm.so.6()(64bit) libruby3.2.so.3.2()(64bit) ruby(abi) rubygem(ruby:3.2.0:mini_portile2:2)"
