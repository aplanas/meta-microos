...
RPROVIDES:${PN} += "tex(sdapsarray.sty) tex(sdapsbase.sty) tex(sdapsclassic.cls) tex(sdapscode128.tex) tex(sdapslayout.sty) tex(sdapspdf.sty) texlive-sdaps"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(babel.sty) tex(color.sty) tex(environ.sty) tex(expl3.sty) tex(fontenc.sty) tex(geometry.sty) tex(graphicx.sty) tex(hyperref.sty) tex(ifthen.sty) tex(lastpage.sty) tex(qrcode.sty) tex(refcount.sty) tex(scrartcl.cls) tex(scrkbase.sty) tex(scrlayer-scrpage.sty) tex(sectsty.sty) tex(tabularx.sty) tex(tikz.sty) tex(translator.sty) tex(url.sty) tex(verbatim.sty) tex(xparse.sty) texlive texlive-environ texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-lastpage texlive-pgf texlive-qrcode texlive-scripts texlive-scripts-bin texlive-sectsty texlive-translator"
