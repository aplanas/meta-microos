...
RPROVIDES:${PN} += "typelib(Lfb) typelib-1_0-Lfb-0_0 typelib-1_0-Lfb-0_0(aarch-64)"
RDEPENDS:${PN} += "libfeedback-0.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
