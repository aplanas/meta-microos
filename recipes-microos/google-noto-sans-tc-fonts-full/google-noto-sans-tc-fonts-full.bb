...
RPROVIDES:${PN} += "google-noto-sans-tc-fonts-full noto-sans-tc-fonts-full"
RDEPENDS:${PN} += "google-noto-sans-tc-black-fonts google-noto-sans-tc-demilight-fonts google-noto-sans-tc-fonts google-noto-sans-tc-light-fonts google-noto-sans-tc-medium-fonts google-noto-sans-tc-thin-fonts"
