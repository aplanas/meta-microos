...
RPROVIDES:${PN} += "deepin-network-utils-devel deepin-network-utils-devel(aarch-64) pkgconfig(dde-network-utils)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdde-network-utils1"
