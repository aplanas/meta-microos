...
RPROVIDES:${PN} += "perl(RRDp) perl(RRDs) perl-rrdtool perl-rrdtool(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) librrd.so.8()(64bit) perl rrdtool"
