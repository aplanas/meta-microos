...
RPROVIDES:${PN} += "budgie-dropby-applet budgie-dropby-applet(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 python3-gobject-Gdk python3-psutil python3-pyudev typelib(Budgie) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Gtk) typelib(Wnck) util-linux wmctrl zenity"
