...
RPROVIDES:${PN} += "python3.11dist(acme) python311-acme python3dist(acme)"
RDEPENDS:${PN} += "python(abi) python311-cryptography python311-josepy python311-pyOpenSSL python311-pyRFC3339 python311-pytz python311-requests python311-requests-toolbelt"
