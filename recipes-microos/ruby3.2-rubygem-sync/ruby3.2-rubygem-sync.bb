...
RPROVIDES:${PN} += "ruby3.2-rubygem-sync ruby3.2-rubygem-sync(aarch-64) rubygem(ruby:3.2.0:sync) rubygem(ruby:3.2.0:sync:0) rubygem(ruby:3.2.0:sync:0.5) rubygem(ruby:3.2.0:sync:0.5.0) rubygem(sync)"
