...
RPROVIDES:${PN} += "python3-acme python3.10dist(acme) python310-acme python3dist(acme)"
RDEPENDS:${PN} += "python(abi) python310-cryptography python310-josepy python310-pyOpenSSL python310-pyRFC3339 python310-pytz python310-requests python310-requests-toolbelt"
