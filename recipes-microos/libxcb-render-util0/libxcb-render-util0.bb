...
RPROVIDES:${PN} += "libxcb-render-util.so.0()(64bit) libxcb-render-util0 libxcb-render-util0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libxcb-render.so.0()(64bit) libxcb.so.1()(64bit)"
