...
RPROVIDES:${PN} += "ruby3.2-rubygem-log4r ruby3.2-rubygem-log4r(aarch-64) rubygem(log4r) rubygem(ruby:3.2.0:log4r) rubygem(ruby:3.2.0:log4r:1) rubygem(ruby:3.2.0:log4r:1.1) rubygem(ruby:3.2.0:log4r:1.1.10)"
