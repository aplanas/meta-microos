...
RPROVIDES:${PN} += "guice-jndi mvn(com.google.inject.extensions:guice-jndi) mvn(com.google.inject.extensions:guice-jndi:pom:) mvn(org.sonatype.sisu.inject:guice-jndi) mvn(org.sonatype.sisu.inject:guice-jndi:pom:) osgi(com.google.inject.jndi)"
