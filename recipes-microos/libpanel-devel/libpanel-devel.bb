...
RPROVIDES:${PN} += "libpanel-devel libpanel-devel(aarch-64) pkgconfig(libpanel-1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libpanel1-1 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(gtk4) typelib-1_0-Panel-1"
