...
RPROVIDES:${PN} += "ghc-devel(timezone-series-0.1.13-52HOboQTQ6c9WNazbzYdiK) ghc-timezone-series-devel ghc-timezone-series-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(time-1.12.2) ghc-timezone-series"
