...
RPROVIDES:${PN} += "python3.9dist(tempora) python39-tempora python3dist(tempora)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 alts python(abi) python39-jaraco.functools python39-pytz"
