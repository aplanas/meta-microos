...
RPROVIDES:${PN} += "python3.9dist(python-digitalocean) python39-digitalocean python3dist(python-digitalocean)"
RDEPENDS:${PN} += "python(abi) python39-jsonpickle python39-pytest python39-requests python39-responses"
