...
RPROVIDES:${PN} += "gyp python3.9dist(gyp) python39-gyp python3dist(gyp)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 ninja python(abi) python39-setuptools update-alternatives"
