...
RPROVIDES:${PN} += "trilinos-openmpi4-devel trilinos-openmpi4-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/bash /usr/bin/python3 blacs-devel-headers glpk-devel hdf5-openmpi4-devel hypre-openmpi4-devel libtrilinos14-openmpi4 mumps-openmpi4-devel netcdf-openmpi4-devel ptscotch-openmpi4-devel scalapack-openmpi4-devel swig"
