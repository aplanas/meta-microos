...
RPROVIDES:${PN} += "tex(pdfwin.cfg) tex(pdfwin.sty) texlive-pdfwin"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(color.sty) tex(graphicx.sty) tex(keyval.sty) tex(truncate.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
