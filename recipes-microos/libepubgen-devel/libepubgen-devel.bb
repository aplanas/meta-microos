...
RPROVIDES:${PN} += "libepubgen-devel libepubgen-devel(aarch-64) pkgconfig(libepubgen-0.1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libepubgen-0_1-1 pkgconfig(librevenge-0.0)"
