...
RPROVIDES:${PN} += "istack-commons-test mvn(com.sun.istack:istack-commons-test) mvn(com.sun.istack:istack-commons-test:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(dom4j:dom4j) mvn(junit:junit) mvn(org.apache.ant:ant-junit)"
