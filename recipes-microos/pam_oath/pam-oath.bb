...
RPROVIDES:${PN} += "pam_oath pam_oath(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) liboath.so.0()(64bit) liboath.so.0(LIBOATH_1.2.0)(64bit) liboath.so.0(LIBOATH_1.8.0)(64bit) libpam.so.0()(64bit) libpam.so.0(LIBPAM_1.0)(64bit) libpam.so.0(LIBPAM_MODUTIL_1.0)(64bit)"
