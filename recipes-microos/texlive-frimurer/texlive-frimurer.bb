...
RPROVIDES:${PN} += "tex(frimurer.enc) tex(frimurer.sty) tex(frimurer.tfm) texlive-frimurer"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-frimurer-fonts texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
