...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.Docker.desktop) metainfo() metainfo(org.opensuse.yast.Docker.metainfo.xml) yast2-docker"
RDEPENDS:${PN} += "docker rubygem(ruby:3.2.0:docker-api) yast2 yast2-ruby-bindings yast2-storage-ng"
