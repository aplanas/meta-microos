...
RPROVIDES:${PN} += "tex(umich-thesis.cls) texlive-umich-thesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(book.cls) tex(geometry.sty) tex(placeins.sty) tex(setspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
