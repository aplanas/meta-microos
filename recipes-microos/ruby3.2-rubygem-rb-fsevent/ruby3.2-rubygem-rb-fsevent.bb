...
RPROVIDES:${PN} += "ruby3.2-rubygem-rb-fsevent ruby3.2-rubygem-rb-fsevent(aarch-64) rubygem(rb-fsevent) rubygem(ruby:3.2.0:rb-fsevent) rubygem(ruby:3.2.0:rb-fsevent:0) rubygem(ruby:3.2.0:rb-fsevent:0.11) rubygem(ruby:3.2.0:rb-fsevent:0.11.2)"
