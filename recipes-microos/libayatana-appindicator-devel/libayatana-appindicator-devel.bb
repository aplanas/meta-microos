...
RPROVIDES:${PN} += "libayatana-appindicator-devel libayatana-appindicator-devel(aarch-64) pkgconfig(ayatana-appindicator-0.1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libayatana-appindicator1 pkgconfig(ayatana-indicator-0.4) pkgconfig(dbusmenu-glib-0.4) pkgconfig(glib-2.0) pkgconfig(gtk+-2.0)"
