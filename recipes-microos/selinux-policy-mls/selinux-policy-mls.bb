...
RPROVIDES:${PN} += "config(selinux-policy-mls) selinux-policy-base selinux-policy-mls"
RDEPENDS:${PN} += "/bin/sh coreutils policycoreutils policycoreutils-newrole selinux-policy setransd"
