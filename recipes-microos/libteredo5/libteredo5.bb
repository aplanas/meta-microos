...
RPROVIDES:${PN} += "libteredo.so.5()(64bit) libteredo5 libteredo5(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libJudy.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit)"
