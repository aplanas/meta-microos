...
RPROVIDES:${PN} += "config(stix-integrals-fonts) font(stixintegralsd) font(stixintegralssm) font(stixintegralsup) font(stixintegralsupd) font(stixintegralsupsm) stix-integrals-fonts"
