...
RPROVIDES:${PN} += "perl(MooseX::Object::Pluggable) perl-MooseX-Object-Pluggable"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Module::Pluggable::Object) perl(Module::Runtime) perl(Moose::Role) perl(Moose::Util) perl(Try::Tiny) perl(namespace::autoclean)"
