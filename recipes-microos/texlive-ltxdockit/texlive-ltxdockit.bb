...
RPROVIDES:${PN} += "tex(btxdockit.sty) tex(ltxdockit.cfg) tex(ltxdockit.cls) tex(ltxdockit.def) tex(ltxdockit.sty) texlive-ltxdockit"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(etoolbox.sty) tex(fontenc.sty) tex(hypcap.sty) tex(hyperref.sty) tex(ifpdf.sty) tex(keyval.sty) tex(listings.sty) tex(multicol.sty) tex(scrartcl.cls) tex(textcomp.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
