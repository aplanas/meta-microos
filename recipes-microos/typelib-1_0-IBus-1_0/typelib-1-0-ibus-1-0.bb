...
RPROVIDES:${PN} += "typelib(IBus) typelib-1_0-IBus-1_0 typelib-1_0-IBus-1_0(aarch-64)"
RDEPENDS:${PN} += "libibus-1.0.so.5()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
