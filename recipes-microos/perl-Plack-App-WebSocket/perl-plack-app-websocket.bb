...
RPROVIDES:${PN} += "perl(Plack::App::WebSocket) perl(Plack::App::WebSocket::Connection) perl-Plack-App-WebSocket"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(AnyEvent) perl(AnyEvent::WebSocket::Server) perl(Devel::GlobalDestruction) perl(Plack::Component) perl(Plack::Response) perl(Try::Tiny) perl(parent)"
