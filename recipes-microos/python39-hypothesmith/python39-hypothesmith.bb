...
RPROVIDES:${PN} += "python3.9dist(hypothesmith) python39-hypothesmith python3dist(hypothesmith)"
RDEPENDS:${PN} += "python(abi) python39-base python39-hypothesis python39-lark python39-libcst"
