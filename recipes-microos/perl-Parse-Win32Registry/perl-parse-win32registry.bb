...
RPROVIDES:${PN} += "perl(Parse::Win32Registry) perl(Parse::Win32Registry::ACE) perl(Parse::Win32Registry::ACL) perl(Parse::Win32Registry::Base) perl(Parse::Win32Registry::Entry) perl(Parse::Win32Registry::File) perl(Parse::Win32Registry::GUID) perl(Parse::Win32Registry::Iterator) perl(Parse::Win32Registry::Key) perl(Parse::Win32Registry::SID) perl(Parse::Win32Registry::SecurityDescriptor) perl(Parse::Win32Registry::Value) perl(Parse::Win32Registry::Win95::File) perl(Parse::Win32Registry::Win95::Key) perl(Parse::Win32Registry::Win95::RGDB) perl(Parse::Win32Registry::Win95::RGDBKey) perl(Parse::Win32Registry::Win95::RGKN) perl(Parse::Win32Registry::Win95::Value) perl(Parse::Win32Registry::WinNT::Entry) perl(Parse::Win32Registry::WinNT::File) perl(Parse::Win32Registry::WinNT::Hbin) perl(Parse::Win32Registry::WinNT::Key) perl(Parse::Win32Registry::WinNT::Security) perl(Parse::Win32Registry::WinNT::Value) perl-Parse-Win32Registry"
