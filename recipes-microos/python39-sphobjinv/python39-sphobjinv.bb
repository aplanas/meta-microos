...
RPROVIDES:${PN} += "python3.9dist(sphobjinv) python39-sphobjinv python3dist(sphobjinv)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-attrs python39-certifi python39-jsonschema update-alternatives"
