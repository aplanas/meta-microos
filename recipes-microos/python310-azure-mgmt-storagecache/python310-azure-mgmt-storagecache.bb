...
RPROVIDES:${PN} += "python3-azure-mgmt-storagecache python3.10dist(azure-mgmt-storagecache) python310-azure-mgmt-storagecache python3dist(azure-mgmt-storagecache)"
