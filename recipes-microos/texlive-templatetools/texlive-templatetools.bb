...
RPROVIDES:${PN} += "tex(templatetools.sty) texlive-templatetools"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(etoolbox.sty) tex(ifdraft.sty) tex(ifpdf.sty) tex(ltxcmds.sty) tex(scrlfile.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
