...
RPROVIDES:${PN} += "python3-ZODB python3.10dist(zodb) python310-ZODB python3dist(zodb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-BTrees python310-ZConfig python310-persistent python310-six python310-transaction python310-zc.lockfile python310-zodbpickle python310-zope.interface update-alternatives"
