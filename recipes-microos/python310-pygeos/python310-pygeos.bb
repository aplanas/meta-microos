...
RPROVIDES:${PN} += "lib.cpython-310-aarch64-linux-gnu.so()(64bit) python3-pygeos python3.10dist(pygeos) python310-pygeos python310-pygeos(aarch-64) python3dist(pygeos)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgeos_c.so.1()(64bit) python(abi) python310-numpy"
