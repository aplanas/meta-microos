...
RPROVIDES:${PN} += "python3-dfVFS python3.10dist(dfvfs) python310-dfVFS python3dist(dfvfs)"
RDEPENDS:${PN} += "python(abi) python310-PyYAML python310-construct python310-cryptography python310-dfdatetime python310-dtfabric python310-libbde python310-libcaes python310-libewf python310-libfsapfs python310-libfsext python310-libfsfat python310-libfshfs python310-libfsntfs python310-libfsxfs python310-libfvde python310-libfwnt python310-libluksde python310-libmodi python310-libphdi python310-libqcow python310-libsigscan python310-libsmdev python310-libsmraw python310-libvhdi python310-libvmdk python310-libvsgpt python310-libvshadow python310-libvslvm python310-tsk"
