...
RPROVIDES:${PN} += "python3.11dist(screenplain) python311-screenplain python3dist(screenplain)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-reportlab update-alternatives"
