...
RPROVIDES:${PN} += "python3-cirq-google python3.10dist(cirq-google) python310-cirq-google python3dist(cirq-google)"
RDEPENDS:${PN} += "python(abi) python310-cirq-core python310-google-api-core python310-grpcio python310-protobuf"
