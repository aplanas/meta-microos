...
RPROVIDES:${PN} += "python3.11dist(edk2-pytool-extensions) python311-edk2toolext python3dist(edk2-pytool-extensions)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyYAML python311-edk2toollib python311-pefile python311-pyOpenSSL update-alternatives"
