...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-search-websearch) python311-azure-cognitiveservices-search-websearch python3dist(azure-cognitiveservices-search-websearch)"
