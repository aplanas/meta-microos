...
RPROVIDES:${PN} += "ddccontrol-db-lang ddccontrol-db-lang-all locale(ddccontrol-db:es) locale(ddccontrol-db:fr) locale(ddccontrol-db:pl) locale(ddccontrol-db:ru) locale(ddccontrol-db:zh_CN)"
