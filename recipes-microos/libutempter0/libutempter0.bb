...
RPROVIDES:${PN} += "libutempter.so.0()(64bit) libutempter.so.0(UTEMPTER_1.1)(64bit) libutempter0 libutempter0(aarch-64) utempter"
RDEPENDS:${PN} += "/bin/sh /sbin/ldconfig group(utmp) ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) permissions"
