...
RPROVIDES:${PN} += "ghc-devel(indexed-traversable-0.1.2.1-1XiSi5jKFt6BqKufaNXxBs) ghc-indexed-traversable-devel ghc-indexed-traversable-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(transformers-0.5.6.2) ghc-indexed-traversable"
