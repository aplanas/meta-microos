...
RPROVIDES:${PN} += "python3.9dist(arviz) python39-arviz python3dist(arviz)"
RDEPENDS:${PN} += "python(abi) python39-h5netcdf python39-matplotlib python39-numpy python39-packaging python39-pandas python39-scipy python39-setuptools python39-typing_extensions python39-xarray python39-xarray-einstats"
