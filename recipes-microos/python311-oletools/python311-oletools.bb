...
RPROVIDES:${PN} += "python3.11dist(oletools) python311-oletools python3dist(oletools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-colorclass python311-easygui python311-msoffcrypto-tool python311-olefile python311-pyparsing"
