...
RPROVIDES:${PN} += "ocr_1_0_1-gnu-openmpi4-hpc-devel ocr_1_0_1-gnu-openmpi4-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "gnu-compilers-hpc-devel ocr_1_0_1-gnu-openmpi4-hpc openmpi4-gnu-hpc-devel"
