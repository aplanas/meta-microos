...
RPROVIDES:${PN} += "tex(msu-thesis.cls) texlive-msu-thesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etex.sty) tex(etoolbox.sty) tex(memoir.cls) tex(pdflscape.sty) tex(textpos.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
