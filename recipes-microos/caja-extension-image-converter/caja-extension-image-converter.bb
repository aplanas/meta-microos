...
RPROVIDES:${PN} += "caja-extension-image-converter caja-extension-image-converter(aarch-64) caja-image-converter libcaja-image-converter.so()(64bit) mate-file-manager-image-converter"
