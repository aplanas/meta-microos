...
RPROVIDES:${PN} += "python3-cocotools python3-pycocotools python3.10dist(pycocotools) python310-cocotools python310-pycocotools python310-pycocotools(aarch-64) python3dist(pycocotools)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-Cython python310-matplotlib python310-setuptools"
