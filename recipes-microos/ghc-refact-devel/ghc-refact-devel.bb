...
RPROVIDES:${PN} += "ghc-devel(refact-0.3.0.2-4ZnrxSKFCNFLIgjtpZGW26) ghc-refact-devel ghc-refact-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-refact"
