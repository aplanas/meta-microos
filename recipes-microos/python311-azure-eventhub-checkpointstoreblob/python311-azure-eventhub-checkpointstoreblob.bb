...
RPROVIDES:${PN} += "python3.11dist(azure-eventhub-checkpointstoreblob) python311-azure-eventhub-checkpointstoreblob python3dist(azure-eventhub-checkpointstoreblob)"
RDEPENDS:${PN} += "python(abi) python311-azure-core python311-azure-eventhub python311-azure-nspkg python311-cryptography python311-msrest"
