...
RPROVIDES:${PN} += "ghc-devel(hslua-list-1.1.1-9l63Ku7u96Z6i2wKz0R57A) ghc-hslua-list-devel ghc-hslua-list-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(hslua-core-2.3.1-S0Tmk0QBS1InOMEfkNHVC) ghc-hslua-list"
