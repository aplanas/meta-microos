...
RPROVIDES:${PN} += "python3.9dist(azure-keyvault) python39-azure-keyvault python3dist(azure-keyvault)"
RDEPENDS:${PN} += "python39-azure-keyvault-certificates python39-azure-keyvault-keys python39-azure-keyvault-nspkg python39-azure-keyvault-secrets python39-azure-nspkg"
