...
RPROVIDES:${PN} += "ghc-prof(safe-exceptions-0.1.7.3-4ydW60ruqZ4IdMpKf3b6BD) ghc-safe-exceptions-prof ghc-safe-exceptions-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(exceptions-0.10.5) ghc-prof(transformers-0.5.6.2) ghc-safe-exceptions-devel"
