...
RPROVIDES:${PN} += "ruby3.2-rubygem-pry ruby3.2-rubygem-pry(aarch-64) rubygem(pry) rubygem(ruby:3.2.0:pry) rubygem(ruby:3.2.0:pry:0) rubygem(ruby:3.2.0:pry:0.14) rubygem(ruby:3.2.0:pry:0.14.1)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/ruby.ruby3.2 ruby(abi) rubygem(ruby:3.2.0:coderay:1) rubygem(ruby:3.2.0:method_source:1) update-alternatives"
