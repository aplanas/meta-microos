...
RPROVIDES:${PN} += "python3-azure-mgmt-timeseriesinsights python3.10dist(azure-mgmt-timeseriesinsights) python310-azure-mgmt-timeseriesinsights python3dist(azure-mgmt-timeseriesinsights)"
