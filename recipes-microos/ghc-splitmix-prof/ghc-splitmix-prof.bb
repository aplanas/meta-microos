...
RPROVIDES:${PN} += "ghc-prof(splitmix-0.1.0.4-7e8CibdlMRLAGh7KO5VlFe) ghc-splitmix-prof ghc-splitmix-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-splitmix-devel"
