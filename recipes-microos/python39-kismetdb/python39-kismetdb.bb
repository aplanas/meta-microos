...
RPROVIDES:${PN} += "python3.9dist(kismetdb) python39-kismetdb python3dist(kismetdb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-python-dateutil python39-simplekml update-alternatives"
