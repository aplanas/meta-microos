...
RPROVIDES:${PN} += "tex(longbox.sty) tex(longfbox.sty) texlive-longfbox"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ellipse.sty) tex(footnote.sty) tex(options.sty) tex(pict2e.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
