...
RPROVIDES:${PN} += "ruby3.2-rubygem-debase-ruby_core_source ruby3.2-rubygem-debase-ruby_core_source(aarch-64) rubygem(debase-ruby_core_source) rubygem(ruby:3.2.0:debase-ruby_core_source) rubygem(ruby:3.2.0:debase-ruby_core_source:0) rubygem(ruby:3.2.0:debase-ruby_core_source:0.10) rubygem(ruby:3.2.0:debase-ruby_core_source:0.10.18)"
