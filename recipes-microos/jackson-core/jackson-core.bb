...
RPROVIDES:${PN} += "jackson-core mvn(com.fasterxml.jackson.core:jackson-core) mvn(com.fasterxml.jackson.core:jackson-core:pom:) osgi(com.fasterxml.jackson.core.jackson-core)"
