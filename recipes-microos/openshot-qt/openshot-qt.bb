...
RPROVIDES:${PN} += "application() application(org.openshot.OpenShot.desktop) metainfo() metainfo(org.openshot.OpenShot.appdata.xml) mimehandler(application/vnd.openshot-qt-project) openshot openshot-qt python3.10dist(openshot-qt) python3dist(openshot-qt)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-openshot python3-pyxdg python3-pyzmq python3-qt5 python3-qtwebengine-qt5 python3-requests"
