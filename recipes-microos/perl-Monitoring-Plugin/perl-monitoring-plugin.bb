...
RPROVIDES:${PN} += "perl(Monitoring::Plugin) perl(Monitoring::Plugin::Config) perl(Monitoring::Plugin::ExitResult) perl(Monitoring::Plugin::Functions) perl(Monitoring::Plugin::Getopt) perl(Monitoring::Plugin::Performance) perl(Monitoring::Plugin::Range) perl(Monitoring::Plugin::Threshold) perl-Monitoring-Plugin"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Class::Accessor) perl(Config::Tiny) perl(Math::Calc::Units) perl(Params::Validate) perl-base"
