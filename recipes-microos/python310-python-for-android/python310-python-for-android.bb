...
RDEPENDS:${PN} += "/bin/sh /usr/bin/bash /usr/bin/python3.10 python(abi) python310-Jinja2 python310-appdirs python310-build python310-colorama python310-toml update-alternatives"
