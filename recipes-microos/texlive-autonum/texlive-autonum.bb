...
RPROVIDES:${PN} += "tex(autonum.sty) texlive-autonum"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(etextools.sty) tex(etoolbox.sty) tex(letltxmacro.sty) tex(textpos.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
