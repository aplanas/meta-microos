...
RPROVIDES:${PN} += "perl(HTML::FormatText::WithLinks) perl-HTML-FormatText-WithLinks"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(HTML::FormatText) perl(HTML::TreeBuilder) perl(URI::WithBase)"
