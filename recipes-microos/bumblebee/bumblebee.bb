...
RPROVIDES:${PN} += "bumblebee bumblebee(aarch-64) config(bumblebee)"
RDEPENDS:${PN} += "/bin/bash /bin/sh VirtualGL kmod-compat ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) pciutils primus shadow sudo systemd xorg-x11-libX11"
