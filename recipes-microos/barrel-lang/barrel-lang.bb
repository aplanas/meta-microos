...
RPROVIDES:${PN} += "barrel-lang barrel-lang-all locale(barrel:ca) locale(barrel:cs) locale(barrel:da) locale(barrel:de) locale(barrel:es) locale(barrel:fr) locale(barrel:it) locale(barrel:ja) locale(barrel:mk) locale(barrel:pt_BR) locale(barrel:zh_CN) locale(barrel:zh_TW)"
RDEPENDS:${PN} += ""
