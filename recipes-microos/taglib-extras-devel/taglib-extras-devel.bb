...
RPROVIDES:${PN} += "pkgconfig(taglib-extras) taglib-extras-devel taglib-extras-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libstdc++-devel libtag-extras1"
