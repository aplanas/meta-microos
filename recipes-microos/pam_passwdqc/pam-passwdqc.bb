...
RPROVIDES:${PN} += "pam-modules:/usr/lib64/security/pam_passwdqc.so pam_passwdqc pam_passwdqc(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcrypt.so.1()(64bit) libcrypt.so.1(XCRYPT_2.0)(64bit) libpam.so.0()(64bit) libpam.so.0(LIBPAM_1.0)(64bit) libpasswdqc.so.0()(64bit) pam"
