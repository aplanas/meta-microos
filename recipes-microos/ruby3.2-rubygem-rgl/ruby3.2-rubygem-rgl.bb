...
RPROVIDES:${PN} += "ruby3.2-rubygem-rgl ruby3.2-rubygem-rgl(aarch-64) rubygem(rgl) rubygem(ruby:3.2.0:rgl) rubygem(ruby:3.2.0:rgl:0) rubygem(ruby:3.2.0:rgl:0.5) rubygem(ruby:3.2.0:rgl:0.5.10)"
