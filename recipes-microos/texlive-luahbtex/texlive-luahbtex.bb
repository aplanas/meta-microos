...
RPROVIDES:${PN} += "man(luahbtex.1) texlive-luahbtex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(language.dat) tex(language.dat.lua) tex(language.def) texlive texlive-cm texlive-etex texlive-filesystem texlive-hyph-utf8 texlive-hyphen-base texlive-knuth-lib texlive-kpathsea texlive-kpathsea-bin texlive-luahbtex-bin texlive-luatex texlive-plain texlive-scripts texlive-scripts-bin texlive-tex-ini-files texlive-unicode-data"
