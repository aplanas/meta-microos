...
RPROVIDES:${PN} += "libparted-fs-resize.so.0()(64bit) libparted-fs-resize.so.0(LIBPARTED_FS_RESIZE_0.0.0)(64bit) libparted-fs-resize0 libparted-fs-resize0(aarch-64)"
