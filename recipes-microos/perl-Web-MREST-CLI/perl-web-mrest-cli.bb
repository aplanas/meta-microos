...
RPROVIDES:${PN} += "perl(Web::MREST::CLI) perl(Web::MREST::CLI::Parser) perl-Web-MREST-CLI"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(App::CELL) perl(File::HomeDir) perl(File::ShareDir) perl(HTTP::Request::Common) perl(JSON) perl(LWP::Protocol::https) perl(LWP::UserAgent) perl(Log::Any::Adapter) perl(Params::Validate) perl(Test::Deep) perl(Try::Tiny) perl(URI::Escape)"
