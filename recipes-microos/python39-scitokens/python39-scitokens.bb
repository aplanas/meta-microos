...
RPROVIDES:${PN} += "python3.9dist(scitokens) python39-scitokens python3dist(scitokens)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyJWT update-alternatives"
