...
RPROVIDES:${PN} += "ghc-devel(lifted-base-0.2.3.12-2PslaVNAATq3HzvkpdIGSo) ghc-lifted-base-devel ghc-lifted-base-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(monad-control-1.0.3.1-YXA6op7GEFFtfFxLr4pzX) ghc-devel(transformers-base-0.4.6-AlF1op8b8qY6wTtsY0MGEp) ghc-lifted-base"
