...
RPROVIDES:${PN} += "libgaminggear-devel libgaminggear-devel(aarch-64) pkgconfig(gaminggear-0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgaminggear0 libgaminggearfx0 libgaminggearwidget0 pkgconfig(gdk-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(gtk+-2.0) pkgconfig(libcanberra) pkgconfig(libnotify) pkgconfig(sqlite3)"
