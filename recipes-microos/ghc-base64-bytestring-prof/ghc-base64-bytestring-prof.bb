...
RPROVIDES:${PN} += "ghc-base64-bytestring-prof ghc-base64-bytestring-prof(aarch-64) ghc-prof(base64-bytestring-1.2.1.0-8KbzJpmSQbYKTeew1rv0hh)"
RDEPENDS:${PN} += "ghc-base64-bytestring-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0)"
