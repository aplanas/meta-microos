...
RPROVIDES:${PN} += "ant-apache-xalan2 config(ant-apache-xalan2) mvn(org.apache.ant:ant-apache-xalan2) mvn(org.apache.ant:ant-apache-xalan2:pom:)"
RDEPENDS:${PN} += "ant java-headless javapackages-filesystem mvn(org.apache.ant:ant) mvn(xalan:xalan) regexp"
