...
RPROVIDES:${PN} += "tex(luatextra.sty) texlive-luatextra"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fixltx2e.sty) tex(fontspec.sty) tex(ifluatex.sty) tex(luacode.sty) tex(luatexbase.sty) tex(metalogo.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
