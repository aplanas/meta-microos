...
RPROVIDES:${PN} += "libQt5SerialPort-private-headers-devel libqt5-qtserialport-private-headers-devel"
RDEPENDS:${PN} += "libQt5Core-private-headers-devel libqt5-qtserialport-devel"
