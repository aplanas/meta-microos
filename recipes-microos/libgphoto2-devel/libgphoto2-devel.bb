...
RPROVIDES:${PN} += "libgphoto2-devel libgphoto2-devel(aarch-64) pkgconfig(libgphoto2) pkgconfig(libgphoto2_port)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libexif-devel libgphoto2-6 libgphoto2_port12 libusb-1_0-devel pkgconfig(libexif) pkgconfig(libgphoto2_port)"
