...
RPROVIDES:${PN} += "tex(csvsimple-l3.sty) tex(csvsimple-legacy.sty) tex(csvsimple.sty) texlive-csvsimple"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(ifthen.sty) tex(l3keys2e.sty) tex(pgfkeys.sty) tex(pgfrcs.sty) tex(shellesc.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
