...
RPROVIDES:${PN} += "ghc-bloomfilter-devel ghc-bloomfilter-devel(aarch-64) ghc-devel(bloomfilter-2.0.1.0-3hF1ySDPbPQA7KQQeHgCqI)"
RDEPENDS:${PN} += "/bin/sh ghc-bloomfilter ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(deepseq-1.4.8.0)"
