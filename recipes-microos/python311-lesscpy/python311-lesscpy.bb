...
RPROVIDES:${PN} += "python3.11dist(lesscpy) python311-lesscpy python3dist(lesscpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-ply python311-setuptools python311-six update-alternatives"
