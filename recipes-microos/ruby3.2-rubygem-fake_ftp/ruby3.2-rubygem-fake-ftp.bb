...
RPROVIDES:${PN} += "ruby3.2-rubygem-fake_ftp ruby3.2-rubygem-fake_ftp(aarch-64) rubygem(fake_ftp) rubygem(ruby:3.2.0:fake_ftp) rubygem(ruby:3.2.0:fake_ftp:0) rubygem(ruby:3.2.0:fake_ftp:0.3) rubygem(ruby:3.2.0:fake_ftp:0.3.0)"
