...
RPROVIDES:${PN} += "cmake(libmemcached) libmemcached-devel libmemcached-devel(aarch-64) pkgconfig(libmemcached)"
RDEPENDS:${PN} += "/usr/bin/pkg-config cyrus-sasl-devel glibc-devel libmemcached libmemcached11 libmemcachedprotocol0 libmemcachedutil2 pkgconfig(libsasl2)"
