...
RPROVIDES:${PN} += "python3.11dist(azure-core-tracing-opentelemetry) python311-azure-core-tracing-opentelemetry python3dist(azure-core-tracing-opentelemetry)"
RDEPENDS:${PN} += "python(abi) python311-azure-core python311-azure-nspkg python311-opentelemetry-api"
