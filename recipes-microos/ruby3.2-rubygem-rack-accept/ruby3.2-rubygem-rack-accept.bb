...
RPROVIDES:${PN} += "ruby3.2-rubygem-rack-accept ruby3.2-rubygem-rack-accept(aarch-64) rubygem(rack-accept) rubygem(ruby:3.2.0:rack-accept) rubygem(ruby:3.2.0:rack-accept:0) rubygem(ruby:3.2.0:rack-accept:0.4) rubygem(ruby:3.2.0:rack-accept:0.4.5)"
