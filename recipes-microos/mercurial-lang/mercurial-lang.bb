...
RPROVIDES:${PN} += "locale(mercurial:da) locale(mercurial:de) locale(mercurial:el) locale(mercurial:fr) locale(mercurial:it) locale(mercurial:ja) locale(mercurial:pt_BR) locale(mercurial:ro) locale(mercurial:ru) locale(mercurial:sv) locale(mercurial:zh_CN) locale(mercurial:zh_TW) mercurial-lang mercurial-lang-all"
