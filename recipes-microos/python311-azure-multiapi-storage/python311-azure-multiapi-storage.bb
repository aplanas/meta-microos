...
RPROVIDES:${PN} += "python3.11dist(azure-multiapi-storage) python311-azure-multiapi-storage python3dist(azure-multiapi-storage)"
RDEPENDS:${PN} += "python(abi) python311-azure-common python311-azure-core python311-azure-nspkg python311-cryptography python311-msrest python311-python-dateutil python311-requests"
