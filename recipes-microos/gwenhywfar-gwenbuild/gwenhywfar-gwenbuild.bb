...
RPROVIDES:${PN} += "gwenhywfar-gwenbuild gwenhywfar-gwenbuild(aarch-64)"
RDEPENDS:${PN} += "gwenhywfar-devel ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgwenhywfar.so.79()(64bit)"
