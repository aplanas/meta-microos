...
RPROVIDES:${PN} += "tex(jura2.bbx) tex(jura2.cbx) texlive-biblatex-jura2"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ext-authortitle-ibid.bbx) tex(ext-authortitle-ibid.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
