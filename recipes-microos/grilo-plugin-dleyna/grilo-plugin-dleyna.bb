...
RPROVIDES:${PN} += "grilo-plugin-dleyna grilo-plugin-dleyna(aarch-64) grilo-plugin-upnp libgrldleyna.so()(64bit)"
RDEPENDS:${PN} += "dbus(com.intel.dleyna-server) ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgrilo-0.3.so.0()(64bit)"
