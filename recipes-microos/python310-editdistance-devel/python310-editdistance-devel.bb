...
RPROVIDES:${PN} += "python3-editdistance-devel python310-editdistance-devel python310-editdistance-devel(aarch-64)"
RDEPENDS:${PN} += "python310-base python310-editdistance"
