...
RPROVIDES:${PN} += "python3-poppler-qt5-devel python310-poppler-qt5-devel python310-poppler-qt5-devel(aarch-64)"
RDEPENDS:${PN} += "libpoppler-qt5-devel python310-qt5-devel python310-sip-devel"
