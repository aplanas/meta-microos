...
RPROVIDES:${PN} += "python3-azure-mgmt-mobilenetwork python3.10dist(azure-mgmt-mobilenetwork) python310-azure-mgmt-mobilenetwork python3dist(azure-mgmt-mobilenetwork)"
