...
RPROVIDES:${PN} += "tex(currency.sty) texlive-currency"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(eurosym.sty) tex(expl3.sty) tex(pgfkeys.sty) tex(siunitx.sty) tex(textcomp.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
