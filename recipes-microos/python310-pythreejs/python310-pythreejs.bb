...
RPROVIDES:${PN} += "python3-pythreejs python3.10dist(pythreejs) python310-pythreejs python3dist(pythreejs)"
RDEPENDS:${PN} += "jupyter-threejs python(abi) python310-ipydatawidgets python310-ipywidgets python310-numpy python310-traitlets"
