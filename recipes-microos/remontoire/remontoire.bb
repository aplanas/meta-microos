...
RPROVIDES:${PN} += "application() application(org.regolith-linux.remontoire.desktop) metainfo() metainfo(org.regolith-linux.remontoire.appdata.xml) remontoire remontoire(aarch-64)"
