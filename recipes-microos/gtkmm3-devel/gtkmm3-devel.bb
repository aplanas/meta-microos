...
RPROVIDES:${PN} += "gtkmm3-devel gtkmm3-devel(aarch-64) pkgconfig(gdkmm-3.0) pkgconfig(gtkmm-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgtkmm-3_0-1 pkgconfig(atkmm-1.6) pkgconfig(cairomm-1.0) pkgconfig(gdk-pixbuf-2.0) pkgconfig(gdkmm-3.0) pkgconfig(giomm-2.4) pkgconfig(gtk+-3.0) pkgconfig(gtk+-unix-print-3.0) pkgconfig(pangomm-1.4)"
