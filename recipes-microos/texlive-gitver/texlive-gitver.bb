...
RPROVIDES:${PN} += "tex(gitver.sty) texlive-gitver"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(catchfile.sty) tex(datetime2.sty) tex(hyperref.sty) tex(ifluatex.sty) tex(ifthen.sty) tex(pdftexcmds.sty) tex(shellesc.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
