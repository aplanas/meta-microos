...
RPROVIDES:${PN} += "python3.9dist(pyfxa) python39-PyFxA python3dist(pyfxa)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyBrowserID python39-cryptography python39-requests python39-six update-alternatives"
