...
RPROVIDES:${PN} += "ptscotch_6_1_0-gnu-mvapich2-hpc-devel-static ptscotch_6_1_0-gnu-mvapich2-hpc-devel-static(aarch-64)"
RDEPENDS:${PN} += "ptscotch_6_1_0-gnu-mvapich2-hpc-devel"
