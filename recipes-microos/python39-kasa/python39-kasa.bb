...
RPROVIDES:${PN} += "python3.9dist(python-kasa) python39-kasa python3dist(python-kasa)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-anyio python39-asyncclick python39-pydantic python39-setuptools python39-voluptuous python39-xdoctest update-alternatives"
