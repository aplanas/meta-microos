...
RPROVIDES:${PN} += "ghc-base-unicode-symbols-devel ghc-base-unicode-symbols-devel(aarch-64) ghc-devel(base-unicode-symbols-0.2.4.2-2uW4hd16ZmNBkWsH22htOC)"
RDEPENDS:${PN} += "/bin/sh ghc-base-unicode-symbols ghc-compiler ghc-devel(base-4.17.1.0)"
