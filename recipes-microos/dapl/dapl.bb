...
RPROVIDES:${PN} += "config(dapl) dapl dapl(aarch-64) libdaplofa.so.2()(64bit) libdaplofa.so.2(DAPL_CMA_2.0)(64bit) libdaploscm.so.2()(64bit) libdaploscm.so.2(DAPL_SCM_2.0)(64bit) libdaploucm.so.2()(64bit) libdaploucm.so.2(DAPL_OCM_2.0)(64bit)"
