...
RPROVIDES:${PN} += "tex(flipbook.sty) texlive-flipbook"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(everypage.sty) tex(fancyhdr.sty) tex(graphicx.sty) tex(ifthen.sty) tex(scalefnt.sty) tex(verbatim.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
