...
RPROVIDES:${PN} += "lightmediascanner-devel lightmediascanner-devel(aarch-64) pkgconfig(lightmediascanner)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblightmediascanner0 pkgconfig(sqlite3)"
