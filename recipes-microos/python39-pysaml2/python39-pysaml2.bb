...
RPROVIDES:${PN} += "python3.9dist(pysaml2) python39-pysaml2 python39-pysaml2(aarch-64) python3dist(pysaml2)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Paste python39-cryptography python39-defusedxml python39-importlib-resources python39-pyOpenSSL python39-python-dateutil python39-pytz python39-repoze.who python39-requests python39-six python39-xmlschema python39-zope.interface update-alternatives"
