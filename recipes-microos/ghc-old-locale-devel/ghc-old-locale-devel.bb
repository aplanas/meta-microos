...
RPROVIDES:${PN} += "ghc-devel(old-locale-1.0.0.7-B5o2Qz0CVVSCB1XGw7OfzR) ghc-old-locale-devel ghc-old-locale-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-old-locale"
