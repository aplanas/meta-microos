...
RPROVIDES:${PN} += "tex(fancyvrb-ex.sty) tex(fancyvrb.sty) tex(hbaw.sty) tex(hcolor.sty) texlive-fancyvrb"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(keyval.sty) tex(pstricks.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
