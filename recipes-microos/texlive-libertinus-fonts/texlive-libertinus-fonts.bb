...
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-libertinus-fonts-fonts texlive-scripts texlive-scripts-bin"
