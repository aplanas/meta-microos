...
RPROVIDES:${PN} += "tex(beamerthemeAmurmaple.sty) texlive-beamerthemeamurmaple"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(expl3.sty) tex(iftex.sty) tex(luamesh.sty) tex(multicol.sty) tex(pgfpages.sty) tex(tcolorbox.sty) tex(xfp.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
