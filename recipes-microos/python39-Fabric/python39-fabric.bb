...
RPROVIDES:${PN} += "python3.9dist(fabric) python39-Fabric python39-Fabric2 python39-Fabric3 python39-fabric python39-fabric2 python3dist(fabric)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-cryptography python39-decorator python39-invoke python39-paramiko python39-setuptools python39-six update-alternatives"
