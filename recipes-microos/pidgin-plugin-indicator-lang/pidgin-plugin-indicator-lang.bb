...
RPROVIDES:${PN} += "locale(pidgin-plugin-indicator:de) locale(pidgin-plugin-indicator:es) locale(pidgin-plugin-indicator:hu) locale(pidgin-plugin-indicator:ru) locale(pidgin-plugin-indicator:zh_CN) pidgin-plugin-indicator-lang pidgin-plugin-indicator-lang-all"
