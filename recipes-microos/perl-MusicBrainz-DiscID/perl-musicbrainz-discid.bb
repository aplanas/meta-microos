...
RPROVIDES:${PN} += "perl(MusicBrainz::DiscID) perl-MusicBrainz-DiscID perl-MusicBrainz-DiscID(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libdiscid.so.0()(64bit) perl(:MODULE_COMPAT_5.36.0) perl(Carp) perl(XSLoader)"
