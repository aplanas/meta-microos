...
RPROVIDES:${PN} += "python3.11dist(calmjs) python311-calmjs python3dist(calmjs)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-calmjs.parse python311-calmjs.types update-alternatives"
