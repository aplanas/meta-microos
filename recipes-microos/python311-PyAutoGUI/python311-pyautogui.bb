...
RPROVIDES:${PN} += "python3.11dist(pyautogui) python311-PyAutoGUI python3dist(pyautogui)"
RDEPENDS:${PN} += "python(abi) python311-Pillow python311-PyMsgBox python311-PyScreeze python311-PyTweening python311-python-xlib"
