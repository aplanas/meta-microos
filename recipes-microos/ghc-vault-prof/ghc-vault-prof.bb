...
RPROVIDES:${PN} += "ghc-prof(vault-0.3.1.5-1nJxIV9kR8e5L3ZIpYZHc) ghc-vault-prof ghc-vault-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-prof(unordered-containers-0.2.19.1-KblUXVJ0SvRCcK89PoBx7E) ghc-vault-devel"
