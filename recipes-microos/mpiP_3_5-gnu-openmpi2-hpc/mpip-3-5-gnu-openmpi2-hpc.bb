...
RPROVIDES:${PN} += "mpiP_3_5-gnu-openmpi2-hpc mpiP_3_5-gnu-openmpi2-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/perl gnu-compilers-hpc libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) libopenmpi2-gnu-hpc libunwind.so.8()(64bit) lua-lmod"
