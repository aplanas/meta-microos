...
RPROVIDES:${PN} += "ant-commons-logging config(ant-commons-logging) mvn(org.apache.ant:ant-commons-logging) mvn(org.apache.ant:ant-commons-logging:pom:)"
RDEPENDS:${PN} += "ant apache-commons-logging java-headless javapackages-filesystem mvn(commons-logging:commons-logging-api) mvn(org.apache.ant:ant)"
