...
RPROVIDES:${PN} += "ghc-devel(utf8-string-1.0.2-3yyxPCwARUwDt9ZNWn320Q) ghc-utf8-string-devel ghc-utf8-string-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-utf8-string"
