...
RPROVIDES:${PN} += "ruby3.2-rubygem-mixlib-authentication \
ruby3.2-rubygem-mixlib-authentication(aarch-64) \
rubygem(mixlib-authentication) \
rubygem(ruby:3.2.0:mixlib-authentication) \
rubygem(ruby:3.2.0:mixlib-authentication:3) \
rubygem(ruby:3.2.0:mixlib-authentication:3.0) \
rubygem(ruby:3.2.0:mixlib-authentication:3.0.10)"
