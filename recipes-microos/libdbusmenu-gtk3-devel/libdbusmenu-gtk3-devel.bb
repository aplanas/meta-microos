...
RPROVIDES:${PN} += "libdbusmenu-gtk3-devel libdbusmenu-gtk3-devel(aarch-64) pkgconfig(dbusmenu-gtk3-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdbusmenu-gtk3-4 pkgconfig(dbus-glib-1) pkgconfig(dbusmenu-glib-0.4) pkgconfig(gdk-pixbuf-2.0) pkgconfig(gtk+-3.0) typelib-1_0-DbusmenuGtk3-0_4"
