...
RPROVIDES:${PN} += "python-smbc python3-pysmbc python3-smbc python3.10dist(pysmbc) python310-pysmbc python310-pysmbc(aarch-64) python310-smbc python3dist(pysmbc)"
