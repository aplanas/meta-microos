...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-hpc-development_node patterns-hpc-development_node(aarch-64)"
RDEPENDS:${PN} += "gnu-compilers-hpc-devel iputils lua-lmod mpich-gnu-hpc-devel mpich-ofi-gnu-hpc-devel mvapich2-gnu-hpc-devel pattern()"
