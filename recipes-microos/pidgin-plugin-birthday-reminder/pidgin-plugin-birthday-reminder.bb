...
RPROVIDES:${PN} += "metainfo() metainfo(pidgin-birthday-reminder.metainfo.xml) pidgin-birthday-reminder pidgin-plugin-birthday-reminder pidgin-plugin-birthday-reminder(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgdk_pixbuf-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit) libpurple.so.0()(64bit) pidgin"
