...
RPROVIDES:${PN} += "mono(System.Web.DynamicData) mono(System.Web.Extensions) mono(System.Web.Extensions.Design) mono(System.Web.Mvc) mono-mvc mono-mvc(aarch-64) pkgconfig(system.web.extensions.design_1.0) pkgconfig(system.web.extensions_1.0) pkgconfig(system.web.mvc) pkgconfig(system.web.mvc2) pkgconfig(system.web.mvc3)"
RDEPENDS:${PN} += "/usr/bin/pkg-config mono(Microsoft.Web.Infrastructure) mono(System) mono(System.ComponentModel.DataAnnotations) mono(System.Configuration) mono(System.Core) mono(System.Data.Linq) mono(System.Design) mono(System.Drawing) mono(System.Runtime.Caching) mono(System.ServiceModel) mono(System.Web) mono(System.Web.ApplicationServices) mono(System.Web.Razor) mono(System.Web.Services) mono(System.Web.WebPages) mono(System.Web.WebPages.Razor) mono(System.Xml) mono(mscorlib) mono-core"
