...
RPROVIDES:${PN} += "python3-HepMC python3.10dist(pyhepmc3) python3.10dist(pyhepmc3.search) python310-HepMC python310-HepMC(aarch-64) python3dist(pyhepmc3) python3dist(pyhepmc3.search)"
