...
RPROVIDES:${PN} += "config(mlocate) findutils-locate findutils:/usr/bin/locate mlocate mlocate(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/touch apparmor-abstractions fillup ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) user(nobody)"
