...
RPROVIDES:${PN} += "antlr4-maven-plugin mvn(org.antlr:antlr4-maven-plugin) mvn(org.antlr:antlr4-maven-plugin:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.antlr:antlr4) mvn(org.apache.maven:maven-plugin-api) mvn(org.apache.maven:maven-project) mvn(org.codehaus.plexus:plexus-compiler-api) mvn(org.sonatype.plexus:plexus-build-api)"
