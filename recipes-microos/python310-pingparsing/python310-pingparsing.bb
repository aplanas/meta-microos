...
RPROVIDES:${PN} += "python3-pingparsing python3.10dist(pingparsing) python310-pingparsing python3dist(pingparsing)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-humanreadable python310-loguru python310-pyparsing python310-pytz python310-setuptools python310-simplejson python310-subprocrunner python310-typepy update-alternatives"
