...
RPROVIDES:${PN} += "python3.9dist(streamz) python39-streamz python3dist(streamz)"
RDEPENDS:${PN} += "python(abi) python39-setuptools python39-six python39-toolz python39-tornado python39-zict"
