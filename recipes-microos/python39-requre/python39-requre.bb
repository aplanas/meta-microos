...
RPROVIDES:${PN} += "python3.9dist(requre) python39-requre python3dist(requre)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-GitPython python39-PyYAML python39-click python39-requests"
