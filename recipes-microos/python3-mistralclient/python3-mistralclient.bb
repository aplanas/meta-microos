...
RPROVIDES:${PN} += "python3-mistralclient python3.10dist(python-mistralclient) python3dist(python-mistralclient)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-PyYAML python3-cliff python3-keystoneclient python3-os-client-config python3-osc-lib python3-oslo.i18n python3-oslo.utils python3-osprofiler python3-requests python3-stevedore"
