...
RPROVIDES:${PN} += "tex(bibcop.sty) texlive-bibcop"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl coreutils ed findutils grep perl(strict) perl(warnings) sed tex(iexec.sty) tex(pgfopts.sty) texlive texlive-bibcop-bin texlive-filesystem texlive-iexec texlive-kpathsea texlive-kpathsea-bin texlive-pgfopts texlive-scripts texlive-scripts-bin"
