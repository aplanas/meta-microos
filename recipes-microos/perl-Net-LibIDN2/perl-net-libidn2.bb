...
RPROVIDES:${PN} += "perl(Net::LibIDN2) perl-Net-LibIDN2 perl-Net-LibIDN2(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libidn2.so.0()(64bit) libidn2.so.0(IDN2_0.0.0)(64bit) perl(:MODULE_COMPAT_5.36.0)"
