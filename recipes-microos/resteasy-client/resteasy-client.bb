...
RPROVIDES:${PN} += "mvn(org.jboss.resteasy:resteasy-client) mvn(org.jboss.resteasy:resteasy-client:pom:) resteasy-client"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.jboss.logging:jboss-logging) mvn(org.jboss.logging:jboss-logging-annotations) mvn(org.jboss.logging:jboss-logging-processor) mvn(org.jboss.resteasy:resteasy-jaxrs)"
