...
RPROVIDES:${PN} += "tex(pst-fun.sty) tex(pst-fun.tex) texlive-pst-fun"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(multido.sty) tex(pst-grad.sty) tex(pst-slpe.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
