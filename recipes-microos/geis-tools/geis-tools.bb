...
RPROVIDES:${PN} += "application() application(geisview.desktop) geis-tools geis-tools(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgeis.so.1()(64bit) libgeis.so.1(GEIS_1.0)(64bit) libxcb.so.1()(64bit) python3-geis"
