...
RPROVIDES:${PN} += "locale(pidgin-plugin-privacy-please:de) locale(pidgin-plugin-privacy-please:pl) locale(pidgin-plugin-privacy-please:ru) pidgin-plugin-privacy-please-lang pidgin-plugin-privacy-please-lang-all"
