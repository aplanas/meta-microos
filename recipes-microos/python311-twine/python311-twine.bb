...
RPROVIDES:${PN} += "python3.11dist(twine) python311-twine python3dist(twine)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-importlib-metadata python311-keyring python311-pkginfo python311-readme_renderer python311-requests python311-requests-toolbelt python311-rfc3986 python311-rich update-alternatives"
