...
RPROVIDES:${PN} += "mraa mraa(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libjson-c.so.5()(64bit) libjson-c.so.5(JSONC_0.14)(64bit) libmraa.so.2()(64bit) libudev.so.1()(64bit) libudev.so.1(LIBUDEV_183)(64bit)"
