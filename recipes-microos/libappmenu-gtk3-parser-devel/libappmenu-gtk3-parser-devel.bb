...
RPROVIDES:${PN} += "libappmenu-gtk3-parser-devel libappmenu-gtk3-parser-devel(aarch-64) pkgconfig(appmenu-gtk3-parser)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libappmenu-gtk-parser-devel libappmenu-gtk3-parser0 pkgconfig(gtk+-3.0)"
