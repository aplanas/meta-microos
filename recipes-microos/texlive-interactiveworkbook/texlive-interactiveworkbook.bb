...
RPROVIDES:${PN} += "tex(interactiveworkbook-web.sty) tex(interactiveworkbook.sty) texlive-interactiveworkbook"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(epsfig.sty) tex(ifthen.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
