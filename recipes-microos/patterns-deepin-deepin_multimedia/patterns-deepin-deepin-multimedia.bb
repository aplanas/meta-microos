...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-deepin-deepin_multimedia patterns-deepin-deepin_multimedia(aarch-64)"
RDEPENDS:${PN} += "pattern() vlc"
