...
RPROVIDES:${PN} += "application() application(byobu.desktop) byobu config(byobu)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/perl /usr/bin/python3 coreutils gawk gettext-runtime net-tools perl(:MODULE_COMPAT_5.36.0) python3-newt snack"
