...
RPROVIDES:${PN} += "python3.9dist(azure-mgmt-authorization) python39-azure-mgmt-authorization python3dist(azure-mgmt-authorization)"
RDEPENDS:${PN} += "python(abi) python39-azure-common python39-azure-mgmt-core python39-azure-nspkg python39-msrest"
