...
RPROVIDES:${PN} += "python3.9dist(aiohttp-asgi) python39-aiohttp-asgi python3dist(aiohttp-asgi)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-aiohttp"
