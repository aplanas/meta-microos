...
RPROVIDES:${PN} += "suse-module-tools suse-module-tools(aarch-64) system-tuning-common-SUSE udev-extra-rules"
RDEPENDS:${PN} += "(kmod(sg.ko) if kernel) /bin/bash /bin/sh /usr/bin/grep /usr/bin/gzip /usr/bin/perl /usr/bin/sed coreutils findutils rpm systemd-rpm-macros"
