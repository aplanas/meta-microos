...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.OnlineUpdate.desktop) metainfo() metainfo(org.opensuse.yast.OnlineUpdate.metainfo.xml) yast2-online-update-frontend"
