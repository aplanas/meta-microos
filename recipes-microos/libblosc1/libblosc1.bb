...
RPROVIDES:${PN} += "libblosc.so.1()(64bit) libblosc1 libblosc1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) liblz4.so.1()(64bit) libsnappy.so.1()(64bit) libz.so.1()(64bit) libzstd.so.1()(64bit)"
