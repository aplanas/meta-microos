...
RPROVIDES:${PN} += "ghc-devel(jira-wiki-markup-1.5.1-7ePG3tP2CY82wODfjMZ5nH) ghc-jira-wiki-markup-devel ghc-jira-wiki-markup-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(mtl-2.2.2) ghc-devel(parsec-3.1.16.1) ghc-devel(text-2.0.2) ghc-jira-wiki-markup"
