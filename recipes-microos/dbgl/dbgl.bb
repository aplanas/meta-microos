...
RPROVIDES:${PN} += "application() application(dbgl.desktop) dbgl metainfo() metainfo(dbgl.appdata.xml)"
RDEPENDS:${PN} += "/bin/bash apache-commons-io apache-commons-lang3 apache-commons-text dosbox eclipse-swt java javapackages-tools"
