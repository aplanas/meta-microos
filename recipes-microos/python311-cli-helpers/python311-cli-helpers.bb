...
RPROVIDES:${PN} += "python3.11dist(cli-helpers) python311-cli-helpers python3dist(cli-helpers)"
RDEPENDS:${PN} += "python(abi) python311-Pygments python311-configobj python311-tabulate python311-terminaltables python311-wcwidth"
