...
RPROVIDES:${PN} += "ruby3.2-rubygem-ice_nine ruby3.2-rubygem-ice_nine(aarch-64) rubygem(ice_nine) rubygem(ruby:3.2.0:ice_nine) rubygem(ruby:3.2.0:ice_nine:0) rubygem(ruby:3.2.0:ice_nine:0.11) rubygem(ruby:3.2.0:ice_nine:0.11.2)"
