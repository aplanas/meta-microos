...
RPROVIDES:${PN} += "obby-devel obby-devel(aarch-64) pkgconfig(obby-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libavahi-devel libsigc++2-devel net6-devel obby pkgconfig(avahi-client) pkgconfig(net6-1.3) pkgconfig(sigc++-2.0)"
