...
RPROVIDES:${PN} += "python3-lalapps python310-lalapps python310-lalapps(aarch-64)"
RDEPENDS:${PN} += "python(abi) python310-h5py python310-lal python310-lalburst python310-lalframe python310-lalinference python310-lalinspiral python310-lalmetaio python310-lalpulsar python310-lalsimulation python310-ligo-lw python310-ligo-segments python310-matplotlib python310-numpy python310-scipy"
