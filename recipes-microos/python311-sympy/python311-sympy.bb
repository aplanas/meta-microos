...
RPROVIDES:${PN} += "python3.11dist(sympy) python311-sympy python3dist(sympy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-mpmath python311-setuptools update-alternatives"
