...
RPROVIDES:${PN} += "log4j-bom mvn(org.apache.logging.log4j:log4j-bom:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.logging:logging-parent:pom:)"
