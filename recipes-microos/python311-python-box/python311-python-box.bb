...
RPROVIDES:${PN} += "python3.11dist(python-box) python311-python-box python3dist(python-box)"
RDEPENDS:${PN} += "python(abi) python311-msgpack python311-ruamel.yaml python311-toml"
