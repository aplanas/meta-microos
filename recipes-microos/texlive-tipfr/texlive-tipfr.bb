...
RPROVIDES:${PN} += "tex(tipfr.sty) texlive-tipfr"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(ifthen.sty) tex(mathtools.sty) tex(multido.sty) tex(newtxtt.sty) tex(tikz.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
