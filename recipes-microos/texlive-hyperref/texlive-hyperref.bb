...
RPROVIDES:${PN} += "tex(backref.sty) tex(hdvipdfm.def) tex(hdvips.def) tex(hdvipson.def) tex(hdviwind.def) tex(hluatex.def) tex(hpdftex.def) tex(htex4ht.cfg) tex(htex4ht.def) tex(htexture.def) tex(hvtex.def) tex(hvtexhtm.def) tex(hvtexmrk.def) tex(hxetex.def) tex(hyperref-patches.sty) tex(hyperref.sty) tex(hypertex.def) tex(minitoc-hyper.sty) tex(nameref.sty) tex(nohyperref.sty) tex(ntheorem-hyper.sty) tex(pd1enc.def) tex(pdfmark.def) tex(psdextra.def) tex(puarenc.def) tex(puenc-extra.def) tex(puenc-greekbasic.def) tex(puenc.def) tex(puvnenc.def) tex(xr-hyper.sty) texlive-hyperref"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atbegshi.sty) tex(atveryend.sty) tex(auxhook.sty) tex(bitset.sty) tex(color.sty) tex(etexcmds.sty) tex(expl3.sty) tex(gettitlestring.sty) tex(hycolor.sty) tex(iftex.sty) tex(infwarerr.sty) tex(intcalc.sty) tex(keyval.sty) tex(kvdefinekeys.sty) tex(kvoptions.sty) tex(kvsetkeys.sty) tex(letltxmacro.sty) tex(ltxcmds.sty) tex(minitoc.sty) tex(ntheorem.sty) tex(pdf14.sty) tex(pdfescape.sty) tex(pdftexcmds.sty) tex(refcount.sty) tex(rerunfilecheck.sty) tex(stringenc.sty) tex(tex4ht.sty) tex(url.sty) texlive texlive-atbegshi texlive-auxhook texlive-bitset texlive-etexcmds texlive-filesystem texlive-gettitlestring texlive-hycolor texlive-intcalc texlive-kpathsea texlive-kpathsea-bin texlive-kvdefinekeys texlive-kvsetkeys texlive-letltxmacro texlive-ltxcmds texlive-pdfescape texlive-refcount texlive-rerunfilecheck texlive-scripts texlive-scripts-bin texlive-stringenc texlive-url texlive-zapfding"
