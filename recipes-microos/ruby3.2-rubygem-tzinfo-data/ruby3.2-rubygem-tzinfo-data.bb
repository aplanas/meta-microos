...
RPROVIDES:${PN} += "ruby3.2-rubygem-tzinfo-data ruby3.2-rubygem-tzinfo-data(aarch-64) rubygem(ruby:3.2.0:tzinfo-data) rubygem(ruby:3.2.0:tzinfo-data:1) rubygem(ruby:3.2.0:tzinfo-data:1.2022) rubygem(ruby:3.2.0:tzinfo-data:1.2022.7) rubygem(tzinfo-data)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:tzinfo)"
