...
RPROVIDES:${PN} += "efivar-devel efivar-devel(aarch-64) pkgconfig(efiboot) pkgconfig(efisec) pkgconfig(efivar)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libefivar1 pkgconfig(efivar)"
