...
RPROVIDES:${PN} += "libykclient.so.3()(64bit) libykclient.so.3(Base)(64bit) libykclient.so.3(YKCLIENT_2.12)(64bit) libykclient.so.3(YKCLIENT_2.15)(64bit) libykclient3 libykclient3(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcurl.so.4()(64bit)"
