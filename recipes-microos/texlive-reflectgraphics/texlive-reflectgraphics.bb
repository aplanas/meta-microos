...
RPROVIDES:${PN} += "tex(reflectgraphics.sty) texlive-reflectgraphics"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(color.cfg) tex(graphicx.sty) tex(keyval.sty) tex(kvoptions.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
