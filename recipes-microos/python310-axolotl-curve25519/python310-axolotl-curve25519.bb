...
RPROVIDES:${PN} += "python3-axolotl-curve25519 python3.10dist(python-axolotl-curve25519) python310-axolotl-curve25519 python310-axolotl-curve25519(aarch-64) python3dist(python-axolotl-curve25519)"
