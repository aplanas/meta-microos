...
RPROVIDES:${PN} += "libqrtr-glib-devel libqrtr-glib-devel(aarch-64) pkgconfig(qrtr-glib)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libqrtr-glib0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) typelib-1_0-Qrtr-1_0"
