...
RPROVIDES:${PN} += "python3-azure-communication-email python3.10dist(azure-communication-email) python310-azure-communication-email python3dist(azure-communication-email)"
RDEPENDS:${PN} += "python(abi) python310-azure-common python310-azure-communication-nspkg python310-azure-core python310-azure-nspkg python310-msrest"
