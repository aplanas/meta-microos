...
RPROVIDES:${PN} += "python3.11dist(fabric) python311-Fabric python311-Fabric2 python311-Fabric3 python311-fabric python311-fabric2 python3dist(fabric)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-cryptography python311-decorator python311-invoke python311-paramiko python311-setuptools python311-six update-alternatives"
