...
RPROVIDES:${PN} += "python3-statsmodels python3.10dist(statsmodels) python310-statsmodels python310-statsmodels(aarch-64) python3dist(statsmodels)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-numpy python310-pandas python310-patsy python310-scipy"
