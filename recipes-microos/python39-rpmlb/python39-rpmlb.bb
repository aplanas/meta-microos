...
RPROVIDES:${PN} += "python3.9dist(rpmlb) python39-rpmlb python3dist(rpmlb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-click python39-retry"
