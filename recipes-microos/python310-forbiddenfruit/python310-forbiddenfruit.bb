...
RPROVIDES:${PN} += "python3-forbiddenfruit python3.10dist(forbiddenfruit) python310-forbiddenfruit python310-forbiddenfruit(aarch-64) python3dist(forbiddenfruit)"
