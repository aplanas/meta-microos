...
RPROVIDES:${PN} += "tex(svninfo.cfg) tex(svninfo.sty) texlive-svninfo"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(eso-pic.sty) tex(fancyhdr.sty) tex(fancyheadings.sty) tex(ifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
