...
RPROVIDES:${PN} += "slurm-hdf5 slurm-hdf5(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libhdf5.so.200()(64bit) libhdf5_hl.so.200()(64bit) libslurmfull.so()(64bit) slurm-plugins"
