...
RPROVIDES:${PN} += "libdatovka-devel libdatovka-devel(aarch-64) pkgconfig(libdatovka)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdatovka4 pkgconfig(libcurl) pkgconfig(libxml-2.0)"
