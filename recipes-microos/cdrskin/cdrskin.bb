...
RPROVIDES:${PN} += "cdrskin cdrskin(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libburn.so.4()(64bit) libburn.so.4(LIBBURN4)(64bit) libc.so.6(GLIBC_2.34)(64bit)"
