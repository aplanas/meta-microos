...
RPROVIDES:${PN} += "python3.11dist(osmpythontools) python311-OSMPythonTools python3dist(osmpythontools)"
RDEPENDS:${PN} += "python(abi) python311-beautifulsoup4 python311-geojson python311-lxml python311-numpy python311-pandas python311-ujson python311-xarray"
