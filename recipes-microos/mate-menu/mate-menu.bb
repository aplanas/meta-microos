...
RPROVIDES:${PN} += "mate-menu python3.10dist(mate-menu) python3dist(mate-menu)"
RDEPENDS:${PN} += "/usr/bin/python3 glib2-tools gvfs mate-menus mozo python(abi) python3-Unidecode python3-configobj python3-gobject python3-gobject-Gdk python3-pyxdg python3-setproctitle python3-xlib typelib(GLib) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(GdkX11) typelib(Gio) typelib(Gtk) typelib(MateMenu) typelib(MatePanelApplet) typelib(Pango) xdg-utils"
