...
RPROVIDES:${PN} += "ghc-cryptohash-sha1-prof ghc-cryptohash-sha1-prof(aarch-64) ghc-prof(cryptohash-sha1-0.11.101.0-5MfQC56IvYq9IpSDMpmdHb)"
RDEPENDS:${PN} += "ghc-cryptohash-sha1-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0)"
