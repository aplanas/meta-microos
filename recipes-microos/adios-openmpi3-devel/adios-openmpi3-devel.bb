...
RPROVIDES:${PN} += "adios-openmpi3-devel adios-openmpi3-devel(aarch-64)"
RDEPENDS:${PN} += "adios-openmpi3 adios-openmpi3-devel-static hdf5-openmpi3-devel netcdf-openmpi3-devel"
