...
RPROVIDES:${PN} += "jsch-agent-proxy-usocket-nc mvn(com.jcraft:jsch.agentproxy.usocket-nc) mvn(com.jcraft:jsch.agentproxy.usocket-nc:pom:) osgi(com.jcraft.jsch.agentproxy.usocket-nc)"
