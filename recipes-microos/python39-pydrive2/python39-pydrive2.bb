...
RPROVIDES:${PN} += "python3.9dist(pydrive2) python39-pydrive2 python3dist(pydrive2)"
RDEPENDS:${PN} += "python(abi) python39-PyYAML python39-filelock python39-google-api-python-client python39-google-auth python39-google-auth-httplib2 python39-google-auth-oauthlib python39-pyOpenSSL python39-six"
