...
RPROVIDES:${PN} += "ghc-devel(string-conversions-0.4.0.1-B4OFWvpC4GeAVPq9bBfwkx) ghc-string-conversions-devel ghc-string-conversions-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(text-2.0.2) ghc-devel(utf8-string-1.0.2-3yyxPCwARUwDt9ZNWn320Q) ghc-string-conversions"
