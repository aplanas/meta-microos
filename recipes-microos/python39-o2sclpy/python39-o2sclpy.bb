...
RPROVIDES:${PN} += "python3.9dist(o2sclpy) python39-o2sclpy python3dist(o2sclpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 o2scl-devel python(abi) python39-h5py python39-matplotlib python39-numpy python39-requests texlive-latex update-alternatives"
