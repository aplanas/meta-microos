...
RPROVIDES:${PN} += "python3.11dist(signedjson) python311-signedjson python3dist(signedjson)"
RDEPENDS:${PN} += "python(abi) python311-PyNaCl python311-canonicaljson python311-importlib-metadata python311-typing_extensions python311-unpaddedbase64"
