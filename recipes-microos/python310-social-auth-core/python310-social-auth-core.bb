...
RPROVIDES:${PN} += "python3-social-auth-core python3.10dist(social-auth-core) python310-social-auth-core python3dist(social-auth-core)"
RDEPENDS:${PN} += "python(abi) python310-PyJWT python310-cryptography python310-defusedxml python310-oauthlib python310-python3-openid python310-requests python310-requests-oauthlib"
