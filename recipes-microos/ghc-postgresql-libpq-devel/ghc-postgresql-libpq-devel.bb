...
RPROVIDES:${PN} += "ghc-devel(postgresql-libpq-0.9.5.0-EniLDQI99PgI2VDyTYHGox) ghc-postgresql-libpq-devel ghc-postgresql-libpq-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(unix-2.7.3) ghc-postgresql-libpq postgresql-server-devel"
