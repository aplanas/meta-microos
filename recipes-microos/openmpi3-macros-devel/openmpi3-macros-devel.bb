...
RPROVIDES:${PN} += "config(openmpi3-macros-devel) openmpi-macros-provider openmpi3-macros-devel openmpi3-macros-devel(aarch-64) rpm_macro(openmpi_devel_requires) rpm_macro(openmpi_prefix) rpm_macro(openmpi_requires) rpm_macro(setup_openmpi)"
