...
RPROVIDES:${PN} += "python3-msm python3.10dist(msm) python310-msm python3dist(msm)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 patch python(abi) python310-GitPython python310-PyYAML python310-fasteners python310-lazy python310-pako python310-requests python310-setuptools python310-typing update-alternatives"
