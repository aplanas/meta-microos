...
RPROVIDES:${PN} += "freeipmi-devel freeipmi-devel(aarch-64) pkgconfig(libfreeipmi) pkgconfig(libipmiconsole) pkgconfig(libipmidetect) pkgconfig(libipmimonitoring)"
RDEPENDS:${PN} += "/usr/bin/pkg-config freeipmi libfreeipmi17 libipmiconsole2 libipmidetect0 libipmimonitoring6"
