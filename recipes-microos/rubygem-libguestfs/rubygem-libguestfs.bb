...
RPROVIDES:${PN} += "rubygem-libguestfs rubygem-libguestfs(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libguestfs libguestfs.so.0()(64bit) libm.so.6()(64bit) libruby3.2.so.3.2()(64bit) ruby"
