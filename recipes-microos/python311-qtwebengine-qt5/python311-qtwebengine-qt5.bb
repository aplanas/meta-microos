...
RPROVIDES:${PN} += "python3.11dist(pyqtwebengine) python311-PyQtWebEngine python311-qtwebengine-qt5 python311-qtwebengine-qt5(aarch-64) python3dist(pyqtwebengine)"
