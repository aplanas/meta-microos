...
RPROVIDES:${PN} += "tex(expex-acro.sty) texlive-expex-acro"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(acro.sty) tex(enumitem.sty) tex(etoolbox.sty) tex(expex.sty) tex(l3keys2e.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
