...
RPROVIDES:${PN} += "python3.9dist(gpstime) python39-gpstime python3dist(gpstime)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-appdirs python39-python-dateutil python39-requests timezone update-alternatives"
