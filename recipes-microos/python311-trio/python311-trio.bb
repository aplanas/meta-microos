...
RPROVIDES:${PN} += "python3.11dist(trio) python311-trio python3dist(trio)"
RDEPENDS:${PN} += "python(abi) python311-async_generator python311-attrs python311-idna python311-outcome python311-sniffio python311-sortedcontainers"
