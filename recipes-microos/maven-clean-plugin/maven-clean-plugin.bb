...
RPROVIDES:${PN} += "maven-clean-plugin mvn(org.apache.maven.plugins:maven-clean-plugin) mvn(org.apache.maven.plugins:maven-clean-plugin:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven.shared:maven-shared-utils) mvn(org.apache.maven:maven-plugin-api)"
