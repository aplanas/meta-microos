...
RPROVIDES:${PN} += "tex(dummyels.sty) tex(fotex.sty) tex(mlnames.sty) tex(teixml.sty) tex(teixmlslides.sty) tex(ucharacters.sty) tex(unicode.sty) texlive-passivetex"
