...
RPROVIDES:${PN} += "ghc-devel(unicode-data-0.4.0.1-IPznodd4J0BGoSZPR6u4lO) ghc-unicode-data-devel ghc-unicode-data-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-unicode-data"
