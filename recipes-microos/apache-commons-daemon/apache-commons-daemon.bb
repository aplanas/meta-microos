...
RPROVIDES:${PN} += "apache-commons-daemon apache-commons-daemon(aarch-64) jakarta-commons-daemon jakarta-commons-daemon-java mvn(commons-daemon:commons-daemon) mvn(commons-daemon:commons-daemon:pom:) mvn(org.apache.commons:commons-daemon) mvn(org.apache.commons:commons-daemon:pom:) osgi(org.apache.commons.commons-daemon)"
