...
RPROVIDES:${PN} += "typelib(Flatpak) typelib-1_0-Flatpak-1_0 typelib-1_0-Flatpak-1_0(aarch-64)"
RDEPENDS:${PN} += "libflatpak.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
