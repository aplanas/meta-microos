...
RPROVIDES:${PN} += "amtk-devel amtk-devel(aarch-64) pkgconfig(amtk-5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libamtk-5-0 pkgconfig(gio-2.0) pkgconfig(gtk+-3.0) typelib-1_0-Amtk-5"
