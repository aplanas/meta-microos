...
RPROVIDES:${PN} += "tex(bxcjkjatype.sty) texlive-bxcjkjatype"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(CJK.sty) tex(CJKpunct.sty) tex(CJKspace.sty) tex(CJKutf8.sty) tex(CJKvert.sty) tex(atbegshi.sty) tex(etoolbox.sty) tex(keyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
