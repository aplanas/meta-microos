...
RPROVIDES:${PN} += "ghc-base-compat-devel ghc-base-compat-devel(aarch-64) ghc-devel(base-compat-0.12.2-L1DEOlMQJOdFOKsjHoWYov)"
RDEPENDS:${PN} += "/bin/sh ghc-base-compat ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(ghc-prim-0.9.0) ghc-devel(unix-2.7.3)"
