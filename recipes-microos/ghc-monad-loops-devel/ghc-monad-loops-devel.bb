...
RPROVIDES:${PN} += "ghc-devel(monad-loops-0.4.3-J6SAcCDTGblA6407vWEwF9) ghc-monad-loops-devel ghc-monad-loops-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-monad-loops"
