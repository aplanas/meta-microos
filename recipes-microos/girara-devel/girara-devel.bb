...
RPROVIDES:${PN} += "girara-devel girara-devel(aarch-64) pkgconfig(girara-gtk3)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgirara-gtk3-3 pkgconfig(glib-2.0) pkgconfig(gtk+-3.0) pkgconfig(json-glib-1.0) pkgconfig(pango)"
