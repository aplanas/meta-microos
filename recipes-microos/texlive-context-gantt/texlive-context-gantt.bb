...
RPROVIDES:${PN} += "tex(gantt-s-mp.tex) tex(gantt-s-tikz.tex) tex(t-gantt.tex) texlive-context-gantt"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-context texlive-filesystem texlive-hatching texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
