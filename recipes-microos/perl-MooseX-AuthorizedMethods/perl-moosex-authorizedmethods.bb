...
RPROVIDES:${PN} += "perl(MooseX::AuthorizedMethods) perl(MooseX::Meta::Method::Authorized) perl(MooseX::Meta::Method::Authorized::Application::ToClass) perl(MooseX::Meta::Method::Authorized::Application::ToComposite) perl(MooseX::Meta::Method::Authorized::Application::ToInstance) perl(MooseX::Meta::Method::Authorized::CheckRoles) perl(MooseX::Meta::Method::Authorized::Meta::Role) perl-MooseX-AuthorizedMethods"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Moose) perl(aliased)"
