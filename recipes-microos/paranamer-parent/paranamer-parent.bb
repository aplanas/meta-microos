...
RPROVIDES:${PN} += "mvn(com.thoughtworks.paranamer:paranamer-parent:pom:) paranamer-parent"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven.plugins:maven-compiler-plugin) mvn(org.apache.maven.plugins:maven-surefire-plugin)"
