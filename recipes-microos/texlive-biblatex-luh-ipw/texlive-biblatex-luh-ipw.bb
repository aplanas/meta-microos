...
RPROVIDES:${PN} += "tex(authoryear-luh-ipw.bbx) tex(authoryear-luh-ipw.cbx) tex(english-luh-ipw.lbx) tex(german-luh-ipw.lbx) tex(standard-luh-ipw.bbx) tex(standard-luh-ipw.cbx) tex(verbose-inote-luh-ipw.bbx) tex(verbose-inote-luh-ipw.cbx) texlive-biblatex-luh-ipw"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(authoryear-icomp.bbx) tex(authoryear-icomp.cbx) tex(verbose-inote.bbx) tex(verbose-inote.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
