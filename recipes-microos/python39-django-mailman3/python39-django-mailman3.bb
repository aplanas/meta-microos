...
RPROVIDES:${PN} += "python3.9dist(django-mailman3) python39-django-mailman3 python3dist(django-mailman3)"
RDEPENDS:${PN} += "python(abi) python39-Django python39-django-allauth python39-django-gravatar2 python39-mailmanclient python39-pytz"
