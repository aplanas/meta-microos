...
RPROVIDES:${PN} += "python3.11dist(service-identity) python311-service_identity python3dist(service-identity)"
RDEPENDS:${PN} += "python(abi) python311-attrs python311-cryptography python311-pyasn1 python311-pyasn1-modules python311-six"
