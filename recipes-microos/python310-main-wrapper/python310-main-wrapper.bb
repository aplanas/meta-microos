...
RPROVIDES:${PN} += "python3-main-wrapper python3.10dist(main-wrapper) python310-main-wrapper python3dist(main-wrapper)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-base python310-six update-alternatives"
