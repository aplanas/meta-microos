...
RPROVIDES:${PN} += "libnative-platform-curses.so()(64bit) libnative-platform.so()(64bit) mvn(net.rubygrapefruit:native-platform) native-platform native-platform(aarch-64)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libtinfo.so.6()(64bit) libtinfo.so.6(NCURSES6_TINFO_5.0.19991023)(64bit)"
