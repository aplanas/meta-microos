...
RPROVIDES:${PN} += "python3.11dist(xkbgroup) python311-xkbgroup python3dist(xkbgroup)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) update-alternatives xorg-x11-server"
