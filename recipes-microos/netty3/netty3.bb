...
RPROVIDES:${PN} += "mvn(io.netty:netty) mvn(io.netty:netty:pom:) mvn(org.jboss.netty:netty) mvn(org.jboss.netty:netty:pom:) netty3 osgi(org.jboss.netty)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.jcraft:jzlib) mvn(org.bouncycastle:bcprov-jdk16)"
