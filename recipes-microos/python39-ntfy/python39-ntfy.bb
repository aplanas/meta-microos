...
RPROVIDES:${PN} += "python3.9dist(ntfy) python39-ntfy python3dist(ntfy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-appdirs python39-requests python39-ruamel.yaml update-alternatives"
