...
RPROVIDES:${PN} += "tex(catchfilebetweentags.sty) texlive-catchfilebetweentags"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(catchfile.sty) tex(etex.sty) tex(etoolbox.sty) tex(ltxcmds.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
