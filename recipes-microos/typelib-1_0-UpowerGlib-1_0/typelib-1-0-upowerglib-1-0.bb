...
RPROVIDES:${PN} += "typelib(UPowerGlib) typelib-1_0-UpowerGlib-1_0 typelib-1_0-UpowerGlib-1_0(aarch-64)"
RDEPENDS:${PN} += "libupower-glib.so.3()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
