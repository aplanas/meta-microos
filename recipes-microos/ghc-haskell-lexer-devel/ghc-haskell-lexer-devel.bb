...
RPROVIDES:${PN} += "ghc-devel(haskell-lexer-1.1.1-FBBQnuYVuwZ6NRUVHfUjFR) ghc-haskell-lexer-devel ghc-haskell-lexer-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-haskell-lexer"
