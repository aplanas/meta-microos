...
RPROVIDES:${PN} += "avalon-logkit mvn(avalon-logkit:avalon-logkit) mvn(avalon-logkit:avalon-logkit:pom:) mvn(logkit:logkit) mvn(logkit:logkit:pom:) mvn(org.apache.avalon.logkit:avalon-logkit) mvn(org.apache.avalon.logkit:avalon-logkit:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(javax.jms:jms) mvn(javax.mail:mail) mvn(javax.servlet:servlet-api) mvn(log4j:log4j)"
