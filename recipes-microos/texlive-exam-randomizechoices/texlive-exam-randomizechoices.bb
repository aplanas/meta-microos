...
RPROVIDES:${PN} += "tex(exam-randomizechoices.sty) texlive-exam-randomizechoices"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(environ.sty) tex(etoolbox.sty) tex(pgffor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
