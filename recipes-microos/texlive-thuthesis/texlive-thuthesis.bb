...
RPROVIDES:${PN} += "tex(thuthesis-author-year.bbx) tex(thuthesis-author-year.cbx) tex(thuthesis-bachelor.bbx) tex(thuthesis-bachelor.cbx) tex(thuthesis-inline.cbx) tex(thuthesis-numeric.bbx) tex(thuthesis-numeric.cbx) tex(thuthesis.cls) texlive-thuthesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(array.sty) tex(bibunits.sty) tex(bm.sty) tex(booktabs.sty) tex(ctexbook.cls) tex(enumitem.sty) tex(environ.sty) tex(etoolbox.sty) tex(fancyhdr.sty) tex(filehook.sty) tex(fontenc.sty) tex(footmisc.sty) tex(gb7714-2015.bbx) tex(gb7714-2015.cbx) tex(gb7714-2015ay.bbx) tex(gb7714-2015ay.cbx) tex(geometry.sty) tex(graphicx.sty) tex(iftex.sty) tex(kvdefinekeys.sty) tex(kvoptions.sty) tex(kvsetkeys.sty) tex(natbib.sty) tex(newtxmath.sty) tex(newtxtext.sty) tex(notoccite.sty) tex(pdfpages.sty) tex(subcaption.sty) tex(titletoc.sty) tex(ulem.sty) tex(unicode-math.sty) tex(url.sty) tex(xeCJKfntef.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
