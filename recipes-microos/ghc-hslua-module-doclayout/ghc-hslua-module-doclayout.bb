...
RPM_NAME = "ghc-hslua-module-doclayout-1.1.0-1.2.aarch64.rpm"
RPM_HASH = "8028852a4a1ee673b66cf03dcc940c4c795b35fd869975d383432fff4d6753987dbd765367d4d69772e136beb6a6f53de934a32e54186da7b3161226531b0f29"

RPROVIDES:${PN} += "ghc-hslua-module-doclayout \
ghc-hslua-module-doclayout(aarch-64) \
libHShslua-module-doclayout-1.1.0-H1N0AwnXIkUJX0H1lSxUWS-ghc9.4.5.so()(64bit)"
...
libHShslua-2.3.0-1soYqkTydt2HAPmAXqHREY-ghc9.4.5.so()(64bit) \
libHShslua-aeson-2.3.0.1-E4tasg1dFJ86CDrMHWRi4i-ghc9.4.5.so()(64bit) \
libHShslua-classes-2.3.0-FmFATpNcre9GneTlejjsY7-ghc9.4.5.so()(64bit) \
