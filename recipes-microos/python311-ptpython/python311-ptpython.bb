...
RPROVIDES:${PN} += "python3.11dist(ptpython) python311-ptpython python3dist(ptpython)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Pygments python311-appdirs python311-docopt python311-jedi python311-prompt_toolkit"
