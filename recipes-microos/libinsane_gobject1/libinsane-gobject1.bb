...
RPROVIDES:${PN} += "libinsane_gobject.so.1()(64bit) libinsane_gobject1 libinsane_gobject1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libinsane.so.1()(64bit) libinsane1"
