...
RPROVIDES:${PN} += "ghc-iwlib ghc-iwlib(aarch-64) libHSiwlib-0.1.2-1s738Tb3Wf2CvjJviNtWBD-ghc9.4.5.so()(64bit)"
RDEPENDS:${PN} += "libHSbase-4.17.1.0-ghc9.4.5.so()(64bit) libHSghc-bignum-1.3-ghc9.4.5.so()(64bit) libHSghc-prim-0.9.0-ghc9.4.5.so()(64bit) libc.so.6(GLIBC_2.17)(64bit) libgmp.so.10()(64bit) libiw.so.30()(64bit) libm.so.6()(64bit)"
