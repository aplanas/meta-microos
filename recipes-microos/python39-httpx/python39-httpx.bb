...
RPROVIDES:${PN} += "python3.9dist(httpx) python39-httpx python3dist(httpx)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-certifi python39-httpcore python39-idna python39-sniffio update-alternatives"
