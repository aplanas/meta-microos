...
RPROVIDES:${PN} += "pkgconfig(signon-oauth2plugin) signon-plugin-oauth2-devel signon-plugin-oauth2-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig(signon-plugins) signon-plugin-oauth2"
