...
RPROVIDES:${PN} += "ghc-byteable-prof ghc-byteable-prof(aarch-64) ghc-prof(byteable-0.1.1-KSaZugJOm4ALb4WyX9cufg)"
RDEPENDS:${PN} += "ghc-byteable-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0)"
