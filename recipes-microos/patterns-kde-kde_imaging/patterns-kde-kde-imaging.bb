...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-kde-kde_imaging patterns-openSUSE-kde4_imaging patterns-openSUSE-kde_imaging"
RDEPENDS:${PN} += "pattern()"
