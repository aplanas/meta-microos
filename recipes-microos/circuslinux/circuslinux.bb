...
RPROVIDES:${PN} += "application() application(circuslinux.desktop) circuslinux circuslinux(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libSDL-1.2.so.0()(64bit) libSDL_image-1.2.so.0()(64bit) libSDL_mixer-1.2.so.0()(64bit) libc.so.6(GLIBC_2.34)(64bit)"
