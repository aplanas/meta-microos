...
RPROVIDES:${PN} += "python3.9dist(cherrypy) python39-CherryPy python3dist(cherrypy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 alts python(abi) python39-cheroot python39-jaraco.collections python39-more-itertools python39-portend python39-zc.lockfile"
