...
RPROVIDES:${PN} += "python3-openapi-spec-validator python3-openapi_spec_validator python3.10dist(openapi-spec-validator) python310-openapi-spec-validator python310-openapi_spec_validator python3dist(openapi-spec-validator)"
RDEPENDS:${PN} += "(python310-jsonschema >= 4.0.0 with python310-jsonschema < 4.18) /bin/sh /usr/bin/python3.10 python(abi) python310-importlib-resources python310-jsonschema-spec python310-lazy-object-proxy python310-openapi-schema-validator update-alternatives"
