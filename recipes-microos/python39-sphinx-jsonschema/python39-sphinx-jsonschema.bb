...
RPROVIDES:${PN} += "python3.9dist(sphinx-jsonschema) python39-sphinx-jsonschema python3dist(sphinx-jsonschema)"
RDEPENDS:${PN} += "python(abi) python39-PyYAML python39-docutils python39-jsonpointer python39-requests"
