...
RPROVIDES:${PN} += "ghc-SafeSemaphore-prof ghc-SafeSemaphore-prof(aarch-64) ghc-prof(SafeSemaphore-0.10.1-4RgR0Mf1NXcDYTDfcuJnia)"
RDEPENDS:${PN} += "ghc-SafeSemaphore-devel ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(stm-2.5.1.0)"
