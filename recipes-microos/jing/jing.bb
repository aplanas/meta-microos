...
RPROVIDES:${PN} += "jing mvn(com.thaiopensource:jing) mvn(org.relaxng:jing) mvn(org.relaxng:jing:pom:)"
RDEPENDS:${PN} += "/bin/bash java-headless javapackages-filesystem jpackage-utils mvn(com.github.relaxng:relaxngDatatype) mvn(isorelax:isorelax) mvn(net.sf.saxon:saxon) mvn(xerces:xercesImpl) mvn(xml-apis:xml-apis) mvn(xml-resolver:xml-resolver)"
