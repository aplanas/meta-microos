...
RPROVIDES:${PN} += "python3-e-antic python3-pyeantic python3.10dist(pyeantic) python310-e-antic python310-e-antic(aarch-64) python310-pyeantic python3dist(pyeantic)"
