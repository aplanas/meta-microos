...
RPROVIDES:${PN} += "tex(dataref.sty) texlive-dataref"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(booktabs.sty) tex(etoolbox.sty) tex(iftex.sty) tex(import.sty) tex(kvoptions.sty) tex(pdfcomment.sty) tex(pgf.sty) tex(xfp.sty) tex(xtab.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
