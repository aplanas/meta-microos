...
RPROVIDES:${PN} += "Printrun-common Printrun-common(aarch-64) python3.10dist(printrun) python3dist(printrun)"
RDEPENDS:${PN} += "/usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python3-numpy python3-pyglet python3-pyserial"
