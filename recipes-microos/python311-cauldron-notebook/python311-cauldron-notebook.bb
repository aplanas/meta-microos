...
RPROVIDES:${PN} += "python3.11dist(cauldron-notebook) python311-cauldron-notebook python3dist(cauldron-notebook)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Flask python311-Jinja2 python311-Markdown python311-beautifulsoup4 python311-numpy python311-pandas python311-pygments python311-requests update-alternatives"
