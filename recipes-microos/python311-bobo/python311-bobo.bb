...
RPROVIDES:${PN} += "python3.11dist(bobo) python311-bobo python3dist(bobo)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-WebOb python311-six update-alternatives"
