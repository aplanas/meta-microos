...
RPROVIDES:${PN} += "libmbedx509-1 libmbedx509-1(aarch-64) libmbedx509.so.1()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libmbedcrypto.so.7()(64bit)"
