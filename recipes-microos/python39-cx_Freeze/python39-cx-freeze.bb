...
RPROVIDES:${PN} += "python3.9dist(cx-freeze) python39-cx_Freeze python39-cx_Freeze(aarch-64) python3dist(cx-freeze)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/python3.9 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpython3.9.so.1.0()(64bit) python(abi) update-alternatives"
