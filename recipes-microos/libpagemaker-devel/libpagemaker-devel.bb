...
RPROVIDES:${PN} += "libpagemaker-devel libpagemaker-devel(aarch-64) pkgconfig(libpagemaker-0.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libpagemaker-0_0-0 pkgconfig(librevenge-0.0) pkgconfig(librevenge-stream-0.0)"
