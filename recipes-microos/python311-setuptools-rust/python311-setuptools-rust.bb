...
RPROVIDES:${PN} += "python3.11dist(setuptools-rust) python311-setuptools-rust python3dist(setuptools-rust)"
RDEPENDS:${PN} += "cargo python(abi) python311-semantic_version python311-setuptools python311-typing_extensions rust"
