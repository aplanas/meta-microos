...
RPROVIDES:${PN} += "tex(autoref.rtx) tex(bachelor.rtx) tex(candidate.rtx) tex(disser.cls) tex(doctor.rtx) tex(gost732.cls) tex(master.rtx) tex(specialist.rtx) tex(titledefs.rtx) texlive-disser"
