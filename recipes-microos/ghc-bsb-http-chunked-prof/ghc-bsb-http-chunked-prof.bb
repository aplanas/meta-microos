...
RPROVIDES:${PN} += "ghc-bsb-http-chunked-prof ghc-bsb-http-chunked-prof(aarch-64) ghc-prof(bsb-http-chunked-0.0.0.4-7TdDxnBU7De3tUquWdckvl)"
RDEPENDS:${PN} += "ghc-bsb-http-chunked-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0)"
