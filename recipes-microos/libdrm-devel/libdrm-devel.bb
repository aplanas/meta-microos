...
RPROVIDES:${PN} += "libdrm-devel libdrm-devel(aarch-64) pkgconfig(libdrm) pkgconfig(libdrm_amdgpu) pkgconfig(libdrm_etnaviv) pkgconfig(libdrm_exynos) pkgconfig(libdrm_freedreno) pkgconfig(libdrm_intel) pkgconfig(libdrm_nouveau) pkgconfig(libdrm_radeon) pkgconfig(libdrm_tegra) pkgconfig(libdrm_vc4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdrm2 libdrm_amdgpu1 libdrm_etnaviv1 libdrm_exynos1 libdrm_freedreno1 libdrm_intel1 libdrm_nouveau2 libdrm_radeon1 libdrm_tegra0 pkgconfig(libdrm) pkgconfig(pciaccess)"
