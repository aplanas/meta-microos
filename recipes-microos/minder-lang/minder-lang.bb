...
RPROVIDES:${PN} += "locale(minder:cs) locale(minder:de) locale(minder:es) locale(minder:fr) locale(minder:it) locale(minder:nl) locale(minder:pl) locale(minder:pt) locale(minder:pt_BR) locale(minder:ru) minder-lang minder-lang-all"
RDEPENDS:${PN} += "minder"
