...
RPROVIDES:${PN} += "perl(Metrics::Any) perl(Metrics::Any::Adapter) perl(Metrics::Any::Adapter::File) perl(Metrics::Any::Adapter::Null) perl(Metrics::Any::Adapter::Stderr) perl(Metrics::Any::Adapter::Tee) perl(Metrics::Any::Adapter::Test) perl(Metrics::Any::AdapterBase::Stored) perl(Metrics::Any::Collector) perl-Metrics-Any"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(List::Util)"
