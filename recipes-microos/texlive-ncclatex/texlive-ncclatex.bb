...
RPROVIDES:${PN} += "tex(cp1251-light.def) tex(ncc.cls) tex(ncc10.clo) tex(ncc11.clo) tex(ncc12.clo) tex(ncc14.clo) tex(nccart.clo) tex(nccbiblist.sty) tex(nccbook.clo) tex(nccdefaults.sty) tex(nccfit.clo) tex(ncchdr.sty) tex(nccheadings.sty) tex(nccindex.sty) tex(ncclatex.sty) tex(nccltrus.sty) tex(nccold.sty) tex(nccproc.cls) tex(nccsections.sty) tex(ncctheorems.sty) tex(ncctitle.clo) tex(ncctitle.sty) tex(ncctitlepage.sty) tex(sibjnm.cls) texlive-ncclatex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(afterpackage.sty) tex(amstext.sty) tex(babel.sty) tex(cp1251.def) tex(dcounter.sty) tex(desclist.sty) tex(extdash.sty) tex(fontenc.sty) tex(inputenc.sty) tex(makeidx.sty) tex(multicol.sty) tex(nccboxes.sty) tex(nccfancyhdr.sty) tex(nccfloats.sty) tex(nccfoots.sty) tex(nccmath.sty) tex(nccpic.sty) tex(nccsect.sty) tex(nccthm.sty) tex(textarea.sty) tex(tocenter.sty) tex(topsection.sty) tex(watermark.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
