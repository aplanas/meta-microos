...
RPROVIDES:${PN} += "tex(oabsy10.tfm) tex(oabsy5.tfm) tex(oabsy6.tfm) tex(oabsy7.tfm) tex(oabsy8.tfm) tex(oabsy9.tfm) tex(oasy.enc) tex(oasy.map) tex(oasy10.tfm) tex(oasy5.tfm) tex(oasy6.tfm) tex(oasy7.tfm) tex(oasy8.tfm) tex(oasy9.tfm) tex(old-arrows.sty) texlive-old-arrows"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-old-arrows-fonts texlive-scripts texlive-scripts-bin"
