...
RPROVIDES:${PN} += "ruby3.2-rubygem-rspec-core-3_5 ruby3.2-rubygem-rspec-core-3_5(aarch-64) rubygem(rspec-core) rubygem(ruby:3.2.0:rspec-core) rubygem(ruby:3.2.0:rspec-core:3) rubygem(ruby:3.2.0:rspec-core:3.5) rubygem(ruby:3.2.0:rspec-core:3.5.4)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/ruby.ruby3.2 ruby(abi) rubygem(ruby:3.2.0:rspec-support:3.5) update-alternatives"
