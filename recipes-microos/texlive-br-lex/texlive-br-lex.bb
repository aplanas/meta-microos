...
RPROVIDES:${PN} += "tex(br-lex.cls) texlive-br-lex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(babel.sty) tex(fontspec.sty) tex(ifxetex.sty) tex(inputenc.sty) tex(polyglossia.sty) tex(textcase.sty) tex(ulem.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
