...
RPROVIDES:${PN} += "jdom mvn(jdom:jdom) mvn(jdom:jdom:pom:) mvn(org.jdom:jdom) mvn(org.jdom:jdom:pom:) osgi(org.jdom)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(jaxen:jaxen) mvn(xerces:xercesImpl)"
