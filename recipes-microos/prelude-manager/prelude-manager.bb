...
RPROVIDES:${PN} += "config(prelude-manager) prelude-manager prelude-manager(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgnutls.so.30()(64bit) libgnutls.so.30(GNUTLS_3_4)(64bit) libmaxminddb.so.0()(64bit) libprelude.so.28()(64bit) libwrap.so.0()(64bit)"
