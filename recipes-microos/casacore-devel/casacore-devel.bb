...
RPROVIDES:${PN} += "casacore-devel casacore-devel(aarch-64) pkgconfig(casacore)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gsl-devel hdf5-devel lapack-devel libboost_python3-devel libcasacore7 pkgconfig(cfitsio) pkgconfig(fftw3) pkgconfig(ncurses) pkgconfig(wcslib) readline-devel"
