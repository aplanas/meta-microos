...
RPROVIDES:${PN} += "microos-devel-tools microos-devel-tools(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) librpm.so.9()(64bit)"
