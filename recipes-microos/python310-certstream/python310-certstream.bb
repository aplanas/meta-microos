...
RPROVIDES:${PN} += "python3-certstream python3.10dist(certstream) python310-certstream python3dist(certstream)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python3-termcolor python3-websocket-client update-alternatives"
