...
RPROVIDES:${PN} += "tex(skrapport-colortheme-cruelwater.sty) tex(skrapport-colortheme-default.sty) tex(skrapport-colortheme-skdoc.sty) tex(skrapport-colortheme-unscathed.sty) tex(skrapport-colortheme-violet.sty) tex(skrapport-size-common.sty) tex(skrapport-size10pt.clo) tex(skrapport-size11pt.clo) tex(skrapport-size12pt.clo) tex(skrapport.cls) texlive-skrapport"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(MnSymbol.sty) tex(PTSerif.sty) tex(amsmath.sty) tex(amssymb.sty) tex(arev.sty) tex(babel.sty) tex(calc.sty) tex(etoolbox.sty) tex(expl3.sty) tex(fontenc.sty) tex(fontspec.sty) tex(isodate.sty) tex(isomath.sty) tex(kpfonts.sty) tex(l3keys2e.sty) tex(lmodern.sty) tex(mathpazo.sty) tex(microtype.sty) tex(multicol.sty) tex(opensans.sty) tex(polyglossia.sty) tex(pxfonts.sty) tex(skmath.sty) tex(sourcecodepro.sty) tex(textcomp.sty) tex(tgpagella.sty) tex(typearea.sty) tex(unicode-math.sty) tex(xcolor.sty) tex(xkeyval.sty) tex(xparse.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
