...
RPROVIDES:${PN} += "python3.11dist(httpolice) python311-HTTPolice python3dist(httpolice)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Brotli python311-bitstring python311-defusedxml python311-dominate python311-lxml update-alternatives"
