...
RPROVIDES:${PN} += "ghc-path-pieces-prof ghc-path-pieces-prof(aarch-64) ghc-prof(path-pieces-0.2.1-7L2E0FvnHzn1hGutNz0iw4)"
RDEPENDS:${PN} += "ghc-path-pieces-devel ghc-prof(base-4.17.1.0) ghc-prof(text-2.0.2) ghc-prof(time-1.12.2)"
