...
RPROVIDES:${PN} += "python3.9dist(hvplot) python39-hvplot python3dist(hvplot)"
RDEPENDS:${PN} += "(python39-bokeh >= 1.0.0 with python39-bokeh < 2.5) python(abi) python39-colorcet python39-holoviews python39-numpy python39-packaging python39-pandas python39-panel python39-param update-alternatives"
