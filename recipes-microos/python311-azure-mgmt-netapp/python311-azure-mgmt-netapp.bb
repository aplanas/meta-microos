...
RPROVIDES:${PN} += "python3.11dist(azure-mgmt-netapp) python311-azure-mgmt-netapp python3dist(azure-mgmt-netapp)"
RDEPENDS:${PN} += "(python311-typing_extensions >= 4.3.0 if python311-base < 3.8) python(abi) python311-azure-common python311-azure-core python311-azure-mgmt-nspkg python311-azure-nspkg python311-msrest"
