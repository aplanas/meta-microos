...
RPROVIDES:${PN} += "python3-service_identity python3.10dist(service-identity) python310-service_identity python3dist(service-identity)"
RDEPENDS:${PN} += "python(abi) python310-attrs python310-cryptography python310-pyasn1 python310-pyasn1-modules python310-six"
