...
RPROVIDES:${PN} += "ospd-openvas python3.9dist(ospd-openvas) python39-ospd python39-ospd-openvas python3dist(ospd-openvas)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-defusedxml python39-gnupg python39-lxml python39-packaging python39-paho-mqtt python39-psutil python39-redis"
