...
RPROVIDES:${PN} += "config(dehydrated) dehydrated letsencrypt.sh"
RDEPENDS:${PN} += "/bin/sh /usr/bin/bash /usr/bin/getent /usr/sbin/groupadd /usr/sbin/useradd coreutils curl openssl sudo systemd"
