...
RPROVIDES:${PN} += "python3.11dist(pypyp) python311-pyp python3dist(pypyp)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-astunparse update-alternatives"
