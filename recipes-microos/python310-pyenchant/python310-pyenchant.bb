...
RPROVIDES:${PN} += "python3-enchant python3-pyenchant python3.10dist(pyenchant) python310-enchant python310-pyenchant python3dist(pyenchant)"
RDEPENDS:${PN} += "enchant-2-backend-hunspell python(abi)"
