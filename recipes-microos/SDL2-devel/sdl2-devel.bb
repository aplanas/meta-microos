...
RPROVIDES:${PN} += "SDL2-devel SDL2-devel(aarch-64) cmake(sdl2) libSDL2-devel pkgconfig(sdl2)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config c_compiler libSDL2-2_0-0 pkgconfig pkgconfig(gl) pkgconfig(glesv1_cm) pkgconfig(glesv2) pkgconfig(glu) pkgconfig(x11) pkgconfig(xproto)"
