...
RPROVIDES:${PN} += "config(docbook-xml-website) docbook-xml-website"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/edit-xml-catalog /usr/bin/sgml-register-catalog /usr/bin/xmlcatalog awk docbook-xsl-stylesheets docbook_4 grep sed sgml-skel xmlcharent"
