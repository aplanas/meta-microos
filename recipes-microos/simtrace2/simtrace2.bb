...
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libosmo-simtrace2.so.1()(64bit) libosmocore.so.20()(64bit) libosmosim.so.2()(64bit) libosmousb.so.0()(64bit) libusb-1.0.so.0()(64bit)"
