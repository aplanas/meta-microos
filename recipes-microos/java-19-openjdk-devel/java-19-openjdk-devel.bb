...
RPROVIDES:${PN} += "java-19-devel java-19-openjdk-devel java-19-openjdk-devel(aarch-64) java-devel java-devel-openjdk java-sdk java-sdk-19 java-sdk-19-openjdk java-sdk-openjdk libattach.so()(64bit) libsaproc.so()(64bit)"
RDEPENDS:${PN} += "/bin/sh java-19-openjdk ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgcc_s.so.1()(64bit) libgcc_s.so.1(GCC_3.0)(64bit) libjava.so()(64bit) libjli.so()(64bit) libstdc++.so.6()(64bit) libstdc++.so.6(CXXABI_1.3)(64bit) libstdc++.so.6(CXXABI_1.3.9)(64bit) libstdc++.so.6(GLIBCXX_3.4)(64bit) update-alternatives"
