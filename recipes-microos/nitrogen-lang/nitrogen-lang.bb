...
RPROVIDES:${PN} += "locale(nitrogen:bs) locale(nitrogen:fi) locale(nitrogen:hr) locale(nitrogen:pl) locale(nitrogen:ru) locale(nitrogen:sr) nitrogen-lang nitrogen-lang-all"
