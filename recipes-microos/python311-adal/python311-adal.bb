...
RPROVIDES:${PN} += "python3.11dist(adal) python311-adal python3dist(adal)"
RDEPENDS:${PN} += "python(abi) python311-PyJWT python311-cryptography python311-python-dateutil python311-requests"
