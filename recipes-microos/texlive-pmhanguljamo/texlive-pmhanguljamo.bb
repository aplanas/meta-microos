...
RPROVIDES:${PN} += "tex(frkjamofull.data.tex) tex(pmhanguljamo-frkim.code.tex) tex(pmhanguljamo-frkim.sty) tex(pmhanguljamo-rrk.sty) tex(pmhanguljamo.sty) texlive-pmhanguljamo"
