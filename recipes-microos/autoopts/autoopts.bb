...
RPROVIDES:${PN} += "autogen:/usr/bin/autoopts-config autoopts autoopts(aarch-64) libopts-devel perl(Mdoc) pkgconfig(autoopts)"
RDEPENDS:${PN} += "/usr/bin/bash /usr/bin/perl /usr/bin/pkg-config autogen libopts25"
