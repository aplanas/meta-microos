...
RPROVIDES:${PN} += "tex(jpneduenumerate.sty) texlive-jpneduenumerate"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(enumitem.sty) tex(luatexja-otf.sty) tex(otf.sty) tex(refcount.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
