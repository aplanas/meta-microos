...
RPROVIDES:${PN} += "liballegro5_2-devel liballegro5_2-devel(aarch-64) pkgconfig(allegro-5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liballegro5_2 pkgconfig(gl) pkgconfig(x11)"
