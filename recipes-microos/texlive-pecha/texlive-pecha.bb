...
RPROVIDES:${PN} += "tex(ctibmantra.sty) tex(pecha.cls) texlive-pecha"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(ctib.sty) tex(relsize.sty) tex(rotating.sty) tex(times.sty) tex(twoopt.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
