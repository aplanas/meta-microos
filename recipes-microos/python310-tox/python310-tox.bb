...
RPROVIDES:${PN} += "python3-detox python3-tox python3.10dist(tox) python310-detox python310-tox python3dist(tox) tox"
RDEPENDS:${PN} += "(python310-importlib-metadata >= 0.12 if python3-base < 3.8) /bin/sh /usr/bin/python3.10 python(abi) python310-cachetools python310-chardet python310-colorama python310-filelock python310-packaging python310-platformdirs python310-pluggy python310-pyproject-api python310-tomli python310-virtualenv update-alternatives"
