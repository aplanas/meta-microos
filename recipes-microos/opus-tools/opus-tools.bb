...
RPROVIDES:${PN} += "opus-tools opus-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libFLAC.so.12()(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) libogg.so.0()(64bit) libopus.so.0()(64bit) libopusenc.so.0()(64bit) libopusfile.so.0()(64bit) libopusurl.so.0()(64bit)"
