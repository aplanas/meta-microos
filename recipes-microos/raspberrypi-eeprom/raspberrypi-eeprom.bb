...
RPROVIDES:${PN} += "config(raspberrypi-eeprom) raspberrypi-eeprom rpi-eeprom rpi-eeprom-config"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 pciutils raspberrypi-eeprom-firmware raspberrypi-firmware raspberrypi-firmware-dt"
