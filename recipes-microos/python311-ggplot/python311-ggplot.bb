...
RPROVIDES:${PN} += "python3.11dist(ggplot) python311-ggplot python3dist(ggplot)"
RDEPENDS:${PN} += "python(abi) python311-Cycler python311-brewer2mpl python311-matplotlib python311-numpy python311-pandas python311-patsy python311-scipy python311-six python311-statsmodels"
