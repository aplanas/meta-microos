...
RPROVIDES:${PN} += "ghc-devel(filepath-bytestring-1.4.2.1.12-j7n9rVANDcF3su3QaU7xU) ghc-filepath-bytestring-devel ghc-filepath-bytestring-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(unix-2.7.3) ghc-filepath-bytestring"
