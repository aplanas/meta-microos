...
RPROVIDES:${PN} += "python3.9dist(azure-cognitiveservices-search-customsearch) python39-azure-cognitiveservices-search-customsearch python3dist(azure-cognitiveservices-search-customsearch)"
