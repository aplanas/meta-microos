...
RPROVIDES:${PN} += "libini_config-devel libini_config-devel(aarch-64) pkgconfig(ini_config)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libini_config5 pkgconfig(basicobjects) pkgconfig(collection) pkgconfig(ref_array)"
