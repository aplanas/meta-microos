...
RPROVIDES:${PN} += "libjose-devel libjose-devel(aarch-64) pkgconfig(jose)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libjose0 pkgconfig(jansson) pkgconfig(libcrypto) pkgconfig(zlib)"
