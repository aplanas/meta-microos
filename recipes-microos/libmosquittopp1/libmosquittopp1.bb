...
RPROVIDES:${PN} += "libmosquittopp.so.1()(64bit) libmosquittopp1 libmosquittopp1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libmosquitto.so.1()(64bit) libstdc++.so.6()(64bit) libstdc++.so.6(CXXABI_1.3)(64bit) libstdc++.so.6(CXXABI_1.3.9)(64bit)"
