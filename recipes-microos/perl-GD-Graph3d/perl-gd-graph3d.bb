...
RPROVIDES:${PN} += "perl(GD::Graph3d) perl(GD::Graph::axestype3d) perl(GD::Graph::bars3d) perl(GD::Graph::cylinder) perl(GD::Graph::cylinder3d) perl(GD::Graph::lines3d) perl(GD::Graph::pie3d) perl-GD-Graph3d perl-GD-Graph3d(aarch-64) perl-GDGraph3d"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl-GD perl-GDGraph perl-GDTextUtil"
