...
RPROVIDES:${PN} += "tex(luainputenc.sty) tex(lutf8.def) tex(lutf8x.def) texlive-luainputenc"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifluatex.sty) tex(ifxetex.sty) tex(inputenc.sty) tex(luatexbase.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
