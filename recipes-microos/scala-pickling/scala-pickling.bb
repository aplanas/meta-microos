...
RPROVIDES:${PN} += "mvn(org.scala-lang.modules:scala-pickling_2.10) mvn(org.scala-lang.modules:scala-pickling_2.10:pom:) scala-pickling scala-pickling(aarch-64)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.scala-lang:scala-compiler) mvn(org.scala-lang:scala-library) mvn(org.scala-lang:scala-reflect) mvn(org.scalamacros:quasiquotes_2.10)"
