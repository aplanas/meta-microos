...
RPROVIDES:${PN} += "ruby3.2-rubygem-spring ruby3.2-rubygem-spring(aarch-64) rubygem(ruby:3.2.0:spring) rubygem(ruby:3.2.0:spring:4) rubygem(ruby:3.2.0:spring:4.1) rubygem(ruby:3.2.0:spring:4.1.0) rubygem(spring)"
