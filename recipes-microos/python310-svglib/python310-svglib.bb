...
RPROVIDES:${PN} += "python3-svglib python3.10dist(svglib) python310-svglib python3dist(svglib)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-cssselect2 python310-lxml python310-reportlab python310-tinycss2 update-alternatives"
