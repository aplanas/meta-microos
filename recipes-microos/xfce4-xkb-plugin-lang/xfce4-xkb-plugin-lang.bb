...
locale(xfce4-xkb-plugin:en_AU) \
locale(xfce4-xkb-plugin:en_CA) \
locale(xfce4-xkb-plugin:en_GB) \
...
locale(xfce4-xkb-plugin:zh_CN) \
locale(xfce4-xkb-plugin:zh_TW) \
