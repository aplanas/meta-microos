...
RPROVIDES:${PN} += "python3.8dist(cirq) python38-cirq python3dist(cirq)"
RDEPENDS:${PN} += "python(abi) python38-cirq-aqt python38-cirq-core python38-cirq-google python38-cirq-ionq python38-cirq-pasqal python38-cirq-web"
