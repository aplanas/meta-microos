...
RPROVIDES:${PN} += "libtbbmalloc.so.2()(64bit) libtbbmalloc2 libtbbmalloc2(aarch-64) libtbbmalloc_proxy.so.2()(64bit) tbb"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libstdc++.so.6()(64bit) libstdc++.so.6(CXXABI_1.3)(64bit) libstdc++.so.6(GLIBCXX_3.4)(64bit) libstdc++.so.6(GLIBCXX_3.4.20)(64bit)"
