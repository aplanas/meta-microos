...
RPROVIDES:${PN} += "budgie-desktop-branding budgie-desktop-branding-openSUSE"
RDEPENDS:${PN} += "adwaita-icon-theme branding-openSUSE budgie-desktop gio-branding-openSUSE gtk3-metatheme-greybird-geeko papirus-icon-theme systemd-icon-branding wallpaper-branding-openSUSE"
