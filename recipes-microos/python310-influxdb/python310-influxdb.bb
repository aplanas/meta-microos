...
RPROVIDES:${PN} += "python3-influxdb python3.10dist(influxdb) python310-influxdb python310-influxdb(aarch-64) python3dist(influxdb)"
RDEPENDS:${PN} += "python(abi) python310-msgpack python310-python-dateutil python310-pytz python310-requests python310-six"
