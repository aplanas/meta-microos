...
RPROVIDES:${PN} += "avahi-devel libavahi-devel libavahi-devel(aarch-64) pkgconfig(avahi-client) pkgconfig(avahi-core) pkgconfig(avahi-libevent)"
RDEPENDS:${PN} += "/usr/bin/pkg-config dbus-1-devel glibc-devel libavahi-client3 libavahi-common3 libavahi-core7 libavahi-libevent1 pkgconfig(libevent)"
