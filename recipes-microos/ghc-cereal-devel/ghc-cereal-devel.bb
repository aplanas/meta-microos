...
RPROVIDES:${PN} += "ghc-cereal-devel ghc-cereal-devel(aarch-64) ghc-devel(cereal-0.5.8.3-LNsxCTyOF85AKtb4iLTs8f)"
RDEPENDS:${PN} += "/bin/sh ghc-cereal ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(containers-0.6.7) ghc-devel(ghc-prim-0.9.0)"
