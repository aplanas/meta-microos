...
RPROVIDES:${PN} += "tex(esint.map) tex(esint.tex) texlive-esint-type1"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-esint texlive-esint-type1-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
