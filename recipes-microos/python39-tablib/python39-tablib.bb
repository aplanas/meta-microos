...
RPROVIDES:${PN} += "python3.9dist(tablib) python39-tablib python3dist(tablib)"
RDEPENDS:${PN} += "python(abi) python39-MarkupPy python39-PyYAML python39-odfpy python39-openpyxl python39-tabulate python39-xlrd python39-xlwt"
