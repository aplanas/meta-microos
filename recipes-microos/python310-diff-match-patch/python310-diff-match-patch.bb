...
RPROVIDES:${PN} += "python3-diff-match-patch python3-diff_match_patch python3.10dist(diff-match-patch) python310-diff-match-patch python310-diff_match_patch python3dist(diff-match-patch)"
