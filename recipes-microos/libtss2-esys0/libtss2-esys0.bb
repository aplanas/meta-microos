...
RPROVIDES:${PN} += "libtss2-esys.so.0()(64bit) libtss2-esys0 libtss2-esys0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libtss2-mu.so.0()(64bit) libtss2-sys.so.1()(64bit)"
