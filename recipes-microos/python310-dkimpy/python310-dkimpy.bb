...
RPROVIDES:${PN} += "python3-dkimpy python3.10dist(dkimpy) python310-dkimpy python3dist(dkimpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-PyNaCl python310-authres python310-dnspython python310-setuptools update-alternatives"
