...
RPROVIDES:${PN} += "libsemigroups-devel libsemigroups-devel(aarch-64) pkgconfig(libsemigroups)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libsemigroups2 pkgconfig(eigen3) pkgconfig(fmt)"
