...
RPROVIDES:${PN} += "tex(onrannual.cls) texlive-onrannual"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(authblk.sty) tex(caption.sty) tex(geometry.sty) tex(hyperref.sty) tex(mathptmx.sty) tex(parskip.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
