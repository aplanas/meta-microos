...
RPROVIDES:${PN} += "ghc-devel(parsec-numbers-0.1.0-EpxP3vMK5SifJrb3FqKTJ) ghc-parsec-numbers-devel ghc-parsec-numbers-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(parsec-3.1.16.1) ghc-parsec-numbers"
