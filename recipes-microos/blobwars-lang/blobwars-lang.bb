...
RPROVIDES:${PN} += "blobwars-lang blobwars-lang-all locale(blobwars:ca) locale(blobwars:da) locale(blobwars:de) locale(blobwars:es) locale(blobwars:fr) locale(blobwars:nl) locale(blobwars:pl) locale(blobwars:sv)"
