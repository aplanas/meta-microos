...
RPROVIDES:${PN} += "tex(kerntest.cls) tex(ly1mtx.clo) tex(ot1mtx.clo) tex(t1cmr-1200.fd) tex(t1mtx.clo) tex(t2amtx.clo) tex(t2bmtx.clo) tex(ts1mtx.clo) texlive-kerntest"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(article.cls) tex(calc.sty) tex(color.sty) tex(fontenc.sty) tex(geometry.sty) tex(helvet.sty) tex(ifthen.sty) tex(keyval.sty) tex(longtable.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
