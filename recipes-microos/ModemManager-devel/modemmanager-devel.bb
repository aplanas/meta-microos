...
RPROVIDES:${PN} += "ModemManager-devel ModemManager-devel(aarch-64) pkgconfig(ModemManager) pkgconfig(mm-glib)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ModemManager libmm-glib0 pkgconfig(ModemManager) pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) typelib-1_0-ModemManager-1_0"
