...
RPROVIDES:${PN} += "tex(american-apa.lbx) tex(apa.bbx) tex(apa.cbx) tex(austrian-apa.lbx) tex(brazilian-apa.lbx) tex(british-apa.lbx) tex(catalan-apa.lbx) tex(danish-apa.lbx) tex(dutch-apa.lbx) tex(english-apa.lbx) tex(finnish-apa.lbx) tex(french-apa.lbx) tex(galician-apa.lbx) tex(german-apa.lbx) tex(greek-apa.lbx) tex(italian-apa.lbx) tex(naustrian-apa.lbx) tex(ngerman-apa.lbx) tex(norsk-apa.lbx) tex(norwegian-apa.lbx) tex(nswissgerman-apa.lbx) tex(nynorsk-apa.lbx) tex(portuguese-apa.lbx) tex(russian-apa.lbx) tex(slovene-apa.lbx) tex(spanish-apa.lbx) tex(swedish-apa.lbx) tex(swissgerman-apa.lbx) tex(turkish-apa.lbx) texlive-biblatex-apa"
