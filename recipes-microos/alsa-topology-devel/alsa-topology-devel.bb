...
RPROVIDES:${PN} += "alsa-topology-devel alsa-topology-devel(aarch-64) pkgconfig(alsa-topology)"
RDEPENDS:${PN} += "/usr/bin/pkg-config alsa-devel libatopology2 pkgconfig(alsa)"
