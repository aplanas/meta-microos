...
RPROVIDES:${PN} += "python3-azure-mgmt-networkfunction python3.10dist(azure-mgmt-networkfunction) python310-azure-mgmt-networkfunction python3dist(azure-mgmt-networkfunction)"
