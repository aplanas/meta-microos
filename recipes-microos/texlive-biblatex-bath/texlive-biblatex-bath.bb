...
RPROVIDES:${PN} += "tex(bath.bbx) tex(bath.cbx) tex(british-bath.lbx) tex(english-bath.lbx) texlive-biblatex-bath"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(authoryear-comp.cbx) tex(etoolbox.sty) tex(xpatch.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
