...
RPROVIDES:${PN} += "cyrus-sasl-sqlauxprop-bdb cyrus-sasl-sqlauxprop-bdb(aarch-64) libsql.so.3()(64bit)"
RDEPENDS:${PN} += "cyrus-sasl-bdb ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libmariadb.so.3()(64bit) libmariadb.so.3(libmysqlclient_18)(64bit) libpq.so.5()(64bit)"
