...
RPROVIDES:${PN} += "bundled(rust-crate:bitflags) bundled(rust-crate:clap) bundled(rust-crate:crc32c) bundled(rust-crate:crc32csum) bundled(rust-crate:heck) bundled(rust-crate:lazy_static) bundled(rust-crate:proc-macro-error) bundled(rust-crate:proc-macro-error-attr) bundled(rust-crate:proc-macro2) bundled(rust-crate:quote) bundled(rust-crate:rustc_version) bundled(rust-crate:semver) bundled(rust-crate:structopt) bundled(rust-crate:structopt-derive) bundled(rust-crate:syn) bundled(rust-crate:textwrap) bundled(rust-crate:unicode-segmentation) bundled(rust-crate:unicode-width) bundled(rust-crate:unicode-xid) bundled(rust-crate:version_check) crc32csum crc32csum(aarch-64)"
