...
RPROVIDES:${PN} += "tex(lilyglyphs.sty) texlive-lilyglyphs"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 coreutils ed findutils grep sed tex(adjustbox.sty) tex(keyval.sty) tex(pgf.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-lilyglyphs-bin texlive-lilyglyphs-fonts texlive-scripts texlive-scripts-bin"
