...
RPROVIDES:${PN} += "virglrenderer-test-server virglrenderer-test-server(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libvirglrenderer.so.1()(64bit) libvirglrenderer1"
