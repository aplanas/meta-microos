...
RPROVIDES:${PN} += "bspwm bspwm(aarch-64) config(bspwm)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libxcb-ewmh.so.2()(64bit) libxcb-icccm.so.4()(64bit) libxcb-keysyms.so.1()(64bit) libxcb-randr.so.0()(64bit) libxcb-shape.so.0()(64bit) libxcb-util.so.1()(64bit) libxcb-xinerama.so.0()(64bit) libxcb.so.1()(64bit)"
