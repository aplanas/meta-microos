...
RPROVIDES:${PN} += "python3.11dist(pyopengl-accelerate) python311-PyOpenGL_accelerate python311-opengl-accelerate python311-opengl-accelerate(aarch-64) python3dist(pyopengl-accelerate)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-opengl"
