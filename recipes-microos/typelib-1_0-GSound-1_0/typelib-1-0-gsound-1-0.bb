...
RPROVIDES:${PN} += "typelib(GSound) typelib-1_0-GSound-1_0 typelib-1_0-GSound-1_0(aarch-64)"
RDEPENDS:${PN} += "libgsound.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
