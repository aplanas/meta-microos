...
RPROVIDES:${PN} += "jdom2 mvn(org.jdom:jdom2) mvn(org.jdom:jdom2-contrib) mvn(org.jdom:jdom2-contrib:pom:) mvn(org.jdom:jdom2-junit) mvn(org.jdom:jdom2-junit:pom:) mvn(org.jdom:jdom2:pom:)"
