...
RPROVIDES:${PN} += "slurm-torque slurm-torque(aarch-64) torque-client"
RDEPENDS:${PN} += "/usr/bin/perl ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) perl-Switch perl-slurm"
