...
RPROVIDES:${PN} += "python3-azure-mgmt-managementpartner python3.10dist(azure-mgmt-managementpartner) python310-azure-mgmt-managementpartner python3dist(azure-mgmt-managementpartner)"
