...
RPROVIDES:${PN} += "tex(a5toa4.tex) tex(pfarrei.sty) texlive-pfarrei"
RDEPENDS:${PN} += "/bin/sh /usr/bin/texlua coreutils ed findutils grep sed tex(ifpdf.sty) tex(keyval.sty) tex(pdfpages.sty) tex(x.tex) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-pfarrei-bin texlive-scripts texlive-scripts-bin"
