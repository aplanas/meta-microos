...
RPROVIDES:${PN} += "python3.9dist(convertdate) python39-convertdate python3dist(convertdate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyMeeus update-alternatives"
