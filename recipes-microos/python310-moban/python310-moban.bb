...
RPROVIDES:${PN} += "python3-moban python3.10dist(moban) python310-moban python3dist(moban)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 git-core python(abi) python310-Jinja2 python310-appdirs python310-crayons python310-fs python310-jinja2-fsloader python310-lml python310-ruamel.yaml update-alternatives"
