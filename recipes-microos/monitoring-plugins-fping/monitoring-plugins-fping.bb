...
RPROVIDES:${PN} += "monitoring-plugins-fping monitoring-plugins-fping(aarch-64) nagios-plugins-fping"
RDEPENDS:${PN} += "fping ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit)"
