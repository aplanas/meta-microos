...
RPROVIDES:${PN} += "python3.9dist(azure-cognitiveservices-language-luis) python39-azure-cognitiveservices-language-luis python3dist(azure-cognitiveservices-language-luis)"
RDEPENDS:${PN} += "python(abi) python39-azure-cognitiveservices-language-nspkg python39-azure-cognitiveservices-nspkg python39-azure-common python39-azure-nspkg python39-msrest python39-msrestazure"
