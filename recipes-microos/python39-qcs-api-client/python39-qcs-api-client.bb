...
RPROVIDES:${PN} += "python3.9dist(qcs-api-client) python39-qcs-api-client python3dist(qcs-api-client)"
RDEPENDS:${PN} += "python(abi) python39-PyJWT python39-attrs python39-dateutil python39-httpx python39-iso8601 python39-pyRFC3339 python39-pydantic python39-retrying python39-toml"
