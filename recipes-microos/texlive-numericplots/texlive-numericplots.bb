...
RPROVIDES:${PN} += "tex(NumericPlots.sty) tex(NumericPlots_TickLabels.tex) tex(NumericPlots_labels.tex) tex(NumericPlots_legend.tex) tex(NumericPlots_macros.tex) tex(NumericPlots_styles.tex) texlive-numericplots"
