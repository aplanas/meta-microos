...
RPROVIDES:${PN} += "cmark-python python3-CommonMark python3-commonmark python3.10dist(commonmark) python310-CommonMark python310-commonmark python3dist(commonmark)"
