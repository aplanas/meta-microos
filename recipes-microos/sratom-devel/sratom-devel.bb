...
RPROVIDES:${PN} += "libsratom-0-devel pkgconfig(sratom-0) sratom-devel sratom-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libsratom-0-0 pkgconfig(lv2) pkgconfig(serd-0) pkgconfig(sord-0)"
