...
RPROVIDES:${PN} += "python3-azure-synapse python3-azure-synapse-monitoring python3.10dist(azure-synapse-monitoring) python310-azure-synapse python310-azure-synapse-monitoring python3dist(azure-synapse-monitoring)"
