...
RPROVIDES:${PN} += "ghc-easy-file-prof ghc-easy-file-prof(aarch-64) ghc-prof(easy-file-0.2.3-Bwh7vXkS9r2GpL1fsuKjo4)"
RDEPENDS:${PN} += "ghc-easy-file-devel ghc-prof(base-4.17.1.0) ghc-prof(directory-1.3.7.1) ghc-prof(filepath-1.4.2.2) ghc-prof(time-1.12.2) ghc-prof(unix-2.7.3)"
