...
locale(xfce4-mpc-plugin:en_AU) \
locale(xfce4-mpc-plugin:en_CA) \
locale(xfce4-mpc-plugin:en_GB) \
...
locale(xfce4-mpc-plugin:zh_CN) \
locale(xfce4-mpc-plugin:zh_TW) \
