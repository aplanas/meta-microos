...
RPROVIDES:${PN} += "ghc-entropy-prof ghc-entropy-prof(aarch-64) ghc-prof(entropy-0.4.1.10-HkaMHQZP8nyRj15panvtP)"
RDEPENDS:${PN} += "ghc-entropy-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(unix-2.7.3)"
