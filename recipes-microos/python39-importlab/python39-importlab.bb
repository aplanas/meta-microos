...
RPROVIDES:${PN} += "python3.9dist(importlab) python39-importlab python3dist(importlab)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-networkx update-alternatives"
