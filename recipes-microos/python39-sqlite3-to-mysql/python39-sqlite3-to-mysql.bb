...
RPROVIDES:${PN} += "python3.9dist(sqlite3-to-mysql) python39-sqlite3-to-mysql python3dist(sqlite3-to-mysql)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-click python39-mysql-connector-python python39-packaging python39-pytimeparse python39-simplejson python39-six python39-tabulate python39-tqdm"
