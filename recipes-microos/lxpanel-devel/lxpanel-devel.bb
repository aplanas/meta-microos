...
RPROVIDES:${PN} += "lxpanel-devel lxpanel-devel(aarch-64) pkgconfig(lxpanel)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glib2-devel liblxpanel0 lxpanel menu-cache-devel pkgconfig pkgconfig(gtk+-2.0) pkgconfig(libfm)"
