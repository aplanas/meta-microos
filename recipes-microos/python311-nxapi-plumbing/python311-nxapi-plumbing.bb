...
RPROVIDES:${PN} += "python3.11dist(nxapi-plumbing) python311-nxapi-plumbing python3dist(nxapi-plumbing)"
RDEPENDS:${PN} += "python(abi) python311-future python311-lxml python311-requests python311-scp python311-six"
