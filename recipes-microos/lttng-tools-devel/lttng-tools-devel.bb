...
RPROVIDES:${PN} += "lttng-tools-devel lttng-tools-devel(aarch-64) pkgconfig(lttng-ctl)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblttng-ctl0 pkgconfig(liburcu) pkgconfig(liburcu-cds)"
