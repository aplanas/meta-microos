...
RPROVIDES:${PN} += "python3.9dist(img2pdf) python39-img2pdf python3dist(img2pdf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Pillow python39-pdfrw python39-pikepdf python39-setuptools update-alternatives"
