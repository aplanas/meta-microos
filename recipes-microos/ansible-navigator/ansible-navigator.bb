...
RPROVIDES:${PN} += "ansible-navigator python3.10dist(ansible-navigator) python3dist(ansible-navigator)"
RDEPENDS:${PN} += "(podman or docker) /usr/bin/python3.10 ansible-builder ansible-core ansible-runner python(abi) python3-Jinja2 python3-PyYAML python3-curses python3-jsonschema python3-onigurumacffi python3-pytzdata"
