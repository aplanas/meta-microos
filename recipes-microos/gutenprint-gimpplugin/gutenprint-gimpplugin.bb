...
RPROVIDES:${PN} += "gutenprint-gimpplugin gutenprint-gimpplugin(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgimp-2.0.so.0()(64bit) libgimpbase-2.0.so.0()(64bit) libgimpui-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit) libgutenprint.so.9()(64bit) libgutenprintui2.so.2()(64bit)"
