...
RPROVIDES:${PN} += "tex(phaistos.map) tex(phaistos.sty) tex(phaistos.tfm) texlive-phaistos"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-phaistos-fonts texlive-scripts texlive-scripts-bin"
