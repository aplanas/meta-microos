...
RPROVIDES:${PN} += "python3-vdirsyncer python3.10dist(vdirsyncer) python310-vdirsyncer python3dist(vdirsyncer) vdirsyncer"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-aiostream python310-atomicwrites python310-click python310-click-log python310-click-threading python310-requests python310-requests-toolbelt update-alternatives"
