...
RPROVIDES:${PN} += "perl(Math::NumSeq::OEIS::Catalogue::Plugin::PlanePath) perl(Math::NumSeq::PlanePathCoord) perl(Math::NumSeq::PlanePathDelta) perl(Math::NumSeq::PlanePathN) perl(Math::NumSeq::PlanePathTurn) perl(Math::PlanePath) perl(Math::PlanePath::AR2W2Curve) perl(Math::PlanePath::AlternatePaper) perl(Math::PlanePath::AlternatePaperMidpoint) perl(Math::PlanePath::AlternateTerdragon) perl(Math::PlanePath::AnvilSpiral) perl(Math::PlanePath::ArchimedeanChords) perl(Math::PlanePath::AztecDiamondRings) perl(Math::PlanePath::Base::Digits) perl(Math::PlanePath::Base::Generic) perl(Math::PlanePath::Base::NSEW) perl(Math::PlanePath::BetaOmega) perl(Math::PlanePath::CCurve) perl(Math::PlanePath::CellularRule) perl(Math::PlanePath::CellularRule190) perl(Math::PlanePath::CellularRule54) perl(Math::PlanePath::CellularRule57) perl(Math::PlanePath::CellularRule::Line) perl(Math::PlanePath::CellularRule::OddSolid) perl(Math::PlanePath::CellularRule::OneTwo) perl(Math::PlanePath::CellularRule::Two) perl(Math::PlanePath::CfracDigits) perl(Math::PlanePath::ChanTree) perl(Math::PlanePath::CincoCurve) perl(Math::PlanePath::Columns) perl(Math::PlanePath::ComplexMinus) perl(Math::PlanePath::ComplexPlus) perl(Math::PlanePath::ComplexRevolving) perl(Math::PlanePath::CoprimeColumns) perl(Math::PlanePath::Corner) perl(Math::PlanePath::CornerAlternating) perl(Math::PlanePath::CornerReplicate) perl(Math::PlanePath::CretanLabyrinth) perl(Math::PlanePath::CubicBase) perl(Math::PlanePath::DekkingCentres) perl(Math::PlanePath::DekkingCurve) perl(Math::PlanePath::DiagonalRationals) perl(Math::PlanePath::Diagonals) perl(Math::PlanePath::DiagonalsAlternating) perl(Math::PlanePath::DiagonalsOctant) perl(Math::PlanePath::DiamondArms) perl(Math::PlanePath::DiamondSpiral) perl(Math::PlanePath::DigitGroups) perl(Math::PlanePath::DivisibleColumns) perl(Math::PlanePath::DragonCurve) perl(Math::PlanePath::DragonMidpoint) perl(Math::PlanePath::DragonRounded) perl(Math::PlanePath::FactorRationals) perl(Math::PlanePath::FibonacciWordFractal) perl(Math::PlanePath::File) perl(Math::PlanePath::FilledRings) perl(Math::PlanePath::Flowsnake) perl(Math::PlanePath::FlowsnakeCentres) perl(Math::PlanePath::FractionsTree) perl(Math::PlanePath::GcdRationals) perl(Math::PlanePath::GosperIslands) perl(Math::PlanePath::GosperReplicate) perl(Math::PlanePath::GosperSide) perl(Math::PlanePath::GrayCode) perl(Math::PlanePath::GreekKeySpiral) perl(Math::PlanePath::HIndexing) perl(Math::PlanePath::HeptSpiralSkewed) perl(Math::PlanePath::HexArms) perl(Math::PlanePath::HexSpiral) perl(Math::PlanePath::HexSpiralSkewed) perl(Math::PlanePath::HilbertCurve) perl(Math::PlanePath::HilbertSides) perl(Math::PlanePath::HilbertSpiral) perl(Math::PlanePath::Hypot) perl(Math::PlanePath::HypotOctant) perl(Math::PlanePath::ImaginaryBase) perl(Math::PlanePath::ImaginaryHalf) perl(Math::PlanePath::KnightSpiral) perl(Math::PlanePath::KochCurve) perl(Math::PlanePath::KochPeaks) perl(Math::PlanePath::KochSnowflakes) perl(Math::PlanePath::KochSquareflakes) perl(Math::PlanePath::KochelCurve) perl(Math::PlanePath::LTiling) perl(Math::PlanePath::MPeaks) perl(Math::PlanePath::MultipleRings) perl(Math::PlanePath::OctagramSpiral) perl(Math::PlanePath::PeanoCurve) perl(Math::PlanePath::PeanoDiagonals) perl(Math::PlanePath::PentSpiral) perl(Math::PlanePath::PentSpiralSkewed) perl(Math::PlanePath::PixelRings) perl(Math::PlanePath::PowerArray) perl(Math::PlanePath::PyramidRows) perl(Math::PlanePath::PyramidSides) perl(Math::PlanePath::PyramidSpiral) perl(Math::PlanePath::PythagoreanTree) perl(Math::PlanePath::QuadricCurve) perl(Math::PlanePath::QuadricIslands) perl(Math::PlanePath::QuintetCentres) perl(Math::PlanePath::QuintetCurve) perl(Math::PlanePath::QuintetReplicate) perl(Math::PlanePath::R5DragonCurve) perl(Math::PlanePath::R5DragonMidpoint) perl(Math::PlanePath::RationalsTree) perl(Math::PlanePath::Rows) perl(Math::PlanePath::SacksSpiral) perl(Math::PlanePath::SierpinskiArrowhead) perl(Math::PlanePath::SierpinskiArrowheadCentres) perl(Math::PlanePath::SierpinskiCurve) perl(Math::PlanePath::SierpinskiCurveStair) perl(Math::PlanePath::SierpinskiTriangle) perl(Math::PlanePath::SquareArms) perl(Math::PlanePath::SquareReplicate) perl(Math::PlanePath::SquareSpiral) perl(Math::PlanePath::Staircase) perl(Math::PlanePath::StaircaseAlternating) perl(Math::PlanePath::TerdragonCurve) perl(Math::PlanePath::TerdragonMidpoint) perl(Math::PlanePath::TerdragonRounded) perl(Math::PlanePath::TheodorusSpiral) perl(Math::PlanePath::TriangleSpiral) perl(Math::PlanePath::TriangleSpiralSkewed) perl(Math::PlanePath::TriangularHypot) perl(Math::PlanePath::UlamWarburton) perl(Math::PlanePath::UlamWarburtonQuarter) perl(Math::PlanePath::VogelFloret) perl(Math::PlanePath::WunderlichMeander) perl(Math::PlanePath::WunderlichSerpentine) perl(Math::PlanePath::WythoffArray) perl(Math::PlanePath::WythoffPreliminaryTriangle) perl(Math::PlanePath::ZOrderCurve) perl-Math-PlanePath perl-Math-PlanePath(aarch-64)"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Math::Libm) perl(constant::defer)"
