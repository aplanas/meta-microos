...
RPROVIDES:${PN} += "syslog-ng-sql syslog-ng-sql(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libdbi.so.3()(64bit) libdbi.so.3(ABI_3)(64bit) libsyslog-ng-4.2.so.0()(64bit) syslog-ng"
