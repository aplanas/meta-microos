...
RPROVIDES:${PN} += "bzip bzip2 bzip2(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbz2-1 libbz2.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit)"
