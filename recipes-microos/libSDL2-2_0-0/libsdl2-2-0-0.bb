...
RPROVIDES:${PN} += "SDL2 libSDL2-2.0.so.0()(64bit) libSDL2-2.0.so.0(SUSE_2.0.10)(64bit) libSDL2-2.0.so.0(SUSE_2.0.12)(64bit) libSDL2-2.0.so.0(SUSE_2.0.14)(64bit) libSDL2-2.0.so.0(SUSE_2.0.16)(64bit) libSDL2-2.0.so.0(SUSE_2.0.18)(64bit) libSDL2-2.0.so.0(SUSE_2.0.22)(64bit) libSDL2-2.0.so.0(SUSE_2.0.5)(64bit) libSDL2-2.0.so.0(SUSE_2.0.6)(64bit) libSDL2-2.0.so.0(SUSE_2.0.7)(64bit) libSDL2-2.0.so.0(SUSE_2.0.8)(64bit) libSDL2-2.0.so.0(SUSE_2.0.9)(64bit) libSDL2-2.0.so.0(SUSE_2.24.0)(64bit) libSDL2-2.0.so.0(SUSE_2.26.0)(64bit) libSDL2-2_0-0 libSDL2-2_0-0(aarch-64)"
