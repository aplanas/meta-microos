...
RPROVIDES:${PN} += "python3.9dist(ase) python39-ase python3dist(ase)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-matplotlib python39-numpy python39-scipy"
