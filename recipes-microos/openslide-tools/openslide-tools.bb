...
RPROVIDES:${PN} += "openslide-tools openslide-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) libopenslide.so.0()(64bit) libopenslide0 libpng16.so.16()(64bit) libpng16.so.16(PNG16_0)(64bit)"
