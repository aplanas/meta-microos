...
RPROVIDES:${PN} += "ruby3.2-rubygem-attr_required ruby3.2-rubygem-attr_required(aarch-64) rubygem(attr_required) rubygem(ruby:3.2.0:attr_required) rubygem(ruby:3.2.0:attr_required:1) rubygem(ruby:3.2.0:attr_required:1.0) rubygem(ruby:3.2.0:attr_required:1.0.1)"
