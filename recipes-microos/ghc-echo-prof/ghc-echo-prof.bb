...
RPROVIDES:${PN} += "ghc-echo-prof ghc-echo-prof(aarch-64) ghc-prof(echo-0.1.4-GGh6ZLKme4z6jywDiYhFOL)"
RDEPENDS:${PN} += "ghc-echo-devel ghc-prof(base-4.17.1.0) ghc-prof(process-1.6.16.0)"
