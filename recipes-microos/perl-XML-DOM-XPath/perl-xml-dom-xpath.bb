...
RPROVIDES:${PN} += "perl(XML::DOM::Attr) perl(XML::DOM::Comment) perl(XML::DOM::Document) perl(XML::DOM::Element) perl(XML::DOM::Namespace) perl(XML::DOM::Node) perl(XML::DOM::ProcessingInstruction) perl(XML::DOM::Text) perl(XML::DOM::XPath) perl-XML-DOM-XPath"
RDEPENDS:${PN} += "perl perl(XML::DOM) perl(XML::XPathEngine)"
