...
RPROVIDES:${PN} += "python3-pypi-search python3.10dist(pypi-search) python310-pypi-search python3dist(pypi-search)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-beautifulsoup4 python310-html2text python310-requests update-alternatives"
