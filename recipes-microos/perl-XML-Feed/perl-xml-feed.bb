...
RPROVIDES:${PN} += "perl(XML::Feed) perl(XML::Feed::Content) perl(XML::Feed::Enclosure) perl(XML::Feed::Entry) perl(XML::Feed::Entry::Format::Atom) perl(XML::Feed::Entry::Format::RSS) perl(XML::Feed::Format::Atom) perl(XML::Feed::Format::RSS) perl(XML::Feed::Util) perl-XML-Feed"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Class::ErrorHandler) perl(DateTime) perl(DateTime::Format::Flexible) perl(DateTime::Format::ISO8601) perl(DateTime::Format::Mail) perl(DateTime::Format::Natural) perl(DateTime::Format::W3CDTF) perl(Feed::Find) perl(HTML::Entities) perl(HTML::TokeParser) perl(LWP::UserAgent) perl(Module::Pluggable) perl(URI::Fetch) perl(XML::Atom) perl(XML::LibXML) perl(XML::RSS)"
