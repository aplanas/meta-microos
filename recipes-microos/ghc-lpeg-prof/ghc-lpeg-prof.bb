...
RPROVIDES:${PN} += "ghc-lpeg-prof ghc-lpeg-prof(aarch-64) ghc-prof(lpeg-1.0.4-IadFjeA522fGKCuUXCvVP9)"
RDEPENDS:${PN} += "ghc-lpeg-devel ghc-prof(base-4.17.1.0) ghc-prof(lua-2.3.1-16mGxirchUh4T3oJJYdFzu)"
