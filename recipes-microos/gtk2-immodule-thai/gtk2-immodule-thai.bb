...
RPROVIDES:${PN} += "gtk2-immodule-thai gtk2-immodule-thai(aarch-64) locale(gtk2:lo) locale(gtk2:th)"
RDEPENDS:${PN} += "/bin/sh gtk2 gtk2-tools libc.so.6(GLIBC_2.17)(64bit) libgdk-x11-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit)"
