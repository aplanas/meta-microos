...
RPROVIDES:${PN} += "adios_1_13_1-gnu-openmpi2-hpc-devel adios_1_13_1-gnu-openmpi2-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "adios_1_13_1-gnu-openmpi2-hpc adios_1_13_1-gnu-openmpi2-hpc-devel-static gnu-compilers-hpc-devel hdf5-gnu-openmpi2-hpc-devel lua-lmod netcdf-gnu-openmpi2-hpc-devel openmpi2-gnu-hpc-devel"
