...
RPROVIDES:${PN} += "mvn(xmlunit:xmlunit) mvn(xmlunit:xmlunit:pom:) xmlunit"
RDEPENDS:${PN} += "java-headless javapackages-filesystem junit xalan-j2 xerces-j2 xml-commons-apis"
