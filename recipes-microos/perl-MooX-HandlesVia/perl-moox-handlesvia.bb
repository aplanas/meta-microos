...
RPROVIDES:${PN} += "perl(Data::Perl::Bool::MooseLike) perl(Data::Perl::Collection::Array::MooseLike) perl(Data::Perl::Collection::Hash::MooseLike) perl(Data::Perl::Number::MooseLike) perl(Data::Perl::String::MooseLike) perl(MooX::HandlesVia) perl-MooX-HandlesVia"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Class::Method::Modifiers) perl(Data::Perl) perl(Module::Runtime) perl(Moo) perl(Role::Tiny)"
