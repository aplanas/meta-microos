...
RPROVIDES:${PN} += "config(mvapich2_2_3_7-gnu-hpc-macros-devel) mvapich2-hpc-macros-devel mvapich2_2_3_7-gnu-hpc-macros-devel mvapich2_2_3_7-gnu-hpc-macros-devel(aarch-64) rpm_macro(hpc_mvapich2_init) rpm_macro(hpc_mvapich2_requires) rpm_macro(hpc_mvapich2_requires_devel) rpm_macro(hpc_setup_mvapich2)"
