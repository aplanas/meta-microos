...
RPROVIDES:${PN} += "perl(Role::HasMessage) perl(Role::HasMessage::Errf) perl-Role-HasMessage"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Moose::Role) perl(MooseX::Role::Parameterized) perl(String::Errf) perl(Try::Tiny) perl(namespace::clean)"
