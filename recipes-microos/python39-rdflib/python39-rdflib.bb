...
RPROVIDES:${PN} += "python3.9dist(rdflib) python39-rdflib python3dist(rdflib)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-html5lib python39-isodate python39-pyparsing update-alternatives"
