...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.AuthClient.desktop) metainfo() metainfo(org.opensuse.yast.AuthClient.metainfo.xml) yast2-auth-client"
RDEPENDS:${PN} += "/usr/bin/mkdir /usr/bin/touch fillup net-tools yast2 yast2-pam yast2-ruby-bindings"
