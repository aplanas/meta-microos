...
RPROVIDES:${PN} += "libwebrtc_audio_processing-devel libwebrtc_audio_processing-devel(aarch-64) pkgconfig(webrtc-audio-processing)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libwebrtc_audio_processing1"
