...
RPROVIDES:${PN} += "ruby3.2-rubygem-google-protobuf ruby3.2-rubygem-google-protobuf(aarch-64) rubygem(google-protobuf) rubygem(ruby:3.2.0:google-protobuf) rubygem(ruby:3.2.0:google-protobuf:3) rubygem(ruby:3.2.0:google-protobuf:3.23) rubygem(ruby:3.2.0:google-protobuf:3.23.1)"
