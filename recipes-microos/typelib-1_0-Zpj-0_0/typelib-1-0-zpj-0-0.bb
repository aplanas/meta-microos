...
RPROVIDES:${PN} += "typelib(Zpj) typelib-1_0-Zpj-0_0 typelib-1_0-Zpj-0_0(aarch-64)"
RDEPENDS:${PN} += "libzapojit-0.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Json) typelib(Rest) typelib(Soup)"
