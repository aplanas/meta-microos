...
RPROVIDES:${PN} += "tex(pst-am.sty) texlive-pst-am"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(multido.sty) tex(numprint.sty) tex(pst-node.sty) tex(pst-plot.sty) tex(pst-xkey.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
