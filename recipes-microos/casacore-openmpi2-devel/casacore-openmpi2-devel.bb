...
RPROVIDES:${PN} += "casacore-openmpi2-devel casacore-openmpi2-devel(aarch-64)"
RDEPENDS:${PN} += "gsl-devel hdf5-devel lapack-devel libboost_python3-devel libcasacore7-openmpi2 pkgconfig(cfitsio) pkgconfig(fftw3) pkgconfig(ncurses) pkgconfig(wcslib) readline-devel"
