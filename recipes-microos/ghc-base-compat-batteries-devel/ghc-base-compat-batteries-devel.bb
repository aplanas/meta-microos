...
RPROVIDES:${PN} += "ghc-base-compat-batteries-devel ghc-base-compat-batteries-devel(aarch-64) ghc-devel(base-compat-batteries-0.12.2-2nfbI7WkA2cAAItUqSu6Dy)"
RDEPENDS:${PN} += "/bin/sh ghc-base-compat-batteries ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(base-compat-0.12.2-L1DEOlMQJOdFOKsjHoWYov) ghc-devel(ghc-prim-0.9.0)"
