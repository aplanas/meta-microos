...
RPROVIDES:${PN} += "python3.11dist(magic-wormhole) python311-magic-wormhole python3dist(magic-wormhole)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Automat python311-PyNaCl python311-click python311-hkdf python311-humanize python311-magic-wormhole-mailbox-server python311-service_identity python311-spake2 python311-tqdm python311-txtorcon update-alternatives"
