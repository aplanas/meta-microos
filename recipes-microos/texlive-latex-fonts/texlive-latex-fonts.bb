...
RPROVIDES:${PN} += "tex(icmcsc10.tfm) tex(icmex10.tfm) tex(icmmi8.tfm) tex(icmsy8.tfm) tex(icmtt8.tfm) tex(ilasy8.tfm) tex(ilcmss8.tfm) tex(ilcmssb8.tfm) tex(ilcmssi8.tfm) tex(lasy10.tfm) tex(lasy5.tfm) tex(lasy6.tfm) tex(lasy7.tfm) tex(lasy8.tfm) tex(lasy9.tfm) tex(lasyb10.tfm) tex(lcircle10.tfm) tex(lcirclew10.tfm) tex(lcmss8.tfm) tex(lcmssb8.tfm) tex(lcmssi8.tfm) tex(line10.tfm) tex(linew10.tfm) texlive-latex-fonts"
