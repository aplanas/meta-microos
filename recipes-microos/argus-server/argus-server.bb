...
RPROVIDES:${PN} += "argus-server argus-server(aarch-64) argus:/usr/sbin/argus config(argus-server)"
RDEPENDS:${PN} += "/bin/sh argus ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) libpcap.so.1()(64bit) libwrap.so.0()(64bit)"
