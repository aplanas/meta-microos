...
RPROVIDES:${PN} += "config(freeradius-server-perl) freeradius-server-perl freeradius-server-perl(aarch-64)"
RDEPENDS:${PN} += "freeradius-server ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libperl.so()(64bit) perl"
