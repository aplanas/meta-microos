...
RPROVIDES:${PN} += "ghc-alsa-mixer-prof ghc-alsa-mixer-prof(aarch-64) ghc-prof(alsa-mixer-0.3.0-Ff4FVP5Sg8l3sx20Z8BrVj)"
RDEPENDS:${PN} += "ghc-alsa-mixer-devel ghc-prof(alsa-core-0.5.0.1-JiFJwdvZ0Gx6AeuqXKf7yg) ghc-prof(base-4.17.1.0) ghc-prof(unix-2.7.3)"
