...
RPROVIDES:${PN} += "ruby3.2-rubygem-jaro_winkler ruby3.2-rubygem-jaro_winkler(aarch-64) rubygem(jaro_winkler) rubygem(ruby:3.2.0:jaro_winkler) rubygem(ruby:3.2.0:jaro_winkler:1) rubygem(ruby:3.2.0:jaro_winkler:1.5) rubygem(ruby:3.2.0:jaro_winkler:1.5.4)"
