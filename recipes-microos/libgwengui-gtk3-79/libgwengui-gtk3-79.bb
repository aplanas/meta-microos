...
RPROVIDES:${PN} += "libgwengui-gtk3-79 libgwengui-gtk3-79(aarch-64) libgwengui-gtk3.so.79()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libgwenhywfar.so.79()(64bit)"
