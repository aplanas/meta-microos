...
RDEPENDS:${PN} += "libQt5Core-private-headers-devel libQt5Gui-private-headers-devel libQt5OpenGLExtensions-devel-static libqt5-qt3d-devel libqt5-qtdeclarative-private-headers-devel"
