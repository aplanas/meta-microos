...
RPROVIDES:${PN} += "libbrotli-devel libbrotli-devel(aarch-64) libbrotlicommon-devel libbrotlidec-devel libbrotlienc-devel pkgconfig(libbrotlicommon) pkgconfig(libbrotlidec) pkgconfig(libbrotlienc)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libbrotlicommon1 libbrotlidec1 libbrotlienc1 pkgconfig(libbrotlicommon)"
