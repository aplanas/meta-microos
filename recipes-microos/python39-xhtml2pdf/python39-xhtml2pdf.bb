...
RPROVIDES:${PN} += "python3.9dist(xhtml2pdf) python39-xhtml2pdf python3dist(xhtml2pdf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Pillow python39-PyPDF3 python39-arabic-reshaper python39-html5lib python39-python-bidi python39-reportlab python39-setuptools update-alternatives"
