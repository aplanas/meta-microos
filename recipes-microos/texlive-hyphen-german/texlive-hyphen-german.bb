...
RPROVIDES:${PN} += "tex(hyph-de-1901.ec.tex) tex(hyph-de-1901.tex) tex(hyph-de-1996.ec.tex) tex(hyph-de-1996.tex) tex(hyph-de-ch-1901.ec.tex) tex(hyph-de-ch-1901.tex) tex(loadhyph-de-1901.tex) tex(loadhyph-de-1996.tex) tex(loadhyph-de-ch-1901.tex) texlive-hyphen-german"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(language.dat) tex(language.dat.lua) tex(language.def) texlive texlive-dehyph texlive-filesystem texlive-hyph-utf8 texlive-hyphen-base texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
