...
RPROVIDES:${PN} += "tex(clicks.sty) texlive-clicks"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(xkeyval.sty) texlive texlive-etoolbox texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-xkeyval"
