...
RPROVIDES:${PN} += "pkgconfig(rhythmbox) rhythmbox-devel rhythmbox-devel(aarch-64) rhythmbox-doc"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(gstreamer-1.0) pkgconfig(gtk+-3.0) pkgconfig(libsoup-3.0) pkgconfig(libxml-2.0) pkgconfig(totem-plparser) rhythmbox"
