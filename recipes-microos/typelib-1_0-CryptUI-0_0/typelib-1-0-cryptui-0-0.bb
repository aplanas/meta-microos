...
RPROVIDES:${PN} += "typelib(CryptUI) typelib-1_0-CryptUI-0_0 typelib-1_0-CryptUI-0_0(aarch-64)"
RDEPENDS:${PN} += "libcryptui.so.0()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
