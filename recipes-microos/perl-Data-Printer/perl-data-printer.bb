...
RPROVIDES:${PN} += "perl(DDP) perl(Data::Printer) perl(Data::Printer::Common) perl(Data::Printer::Config) perl(Data::Printer::Filter) perl(Data::Printer::Filter::ARRAY) perl(Data::Printer::Filter::CODE) perl(Data::Printer::Filter::ContentType) perl(Data::Printer::Filter::DB) perl(Data::Printer::Filter::DateTime) perl(Data::Printer::Filter::Digest) perl(Data::Printer::Filter::FORMAT) perl(Data::Printer::Filter::GLOB) perl(Data::Printer::Filter::GenericClass) perl(Data::Printer::Filter::HASH) perl(Data::Printer::Filter::REF) perl(Data::Printer::Filter::Regexp) perl(Data::Printer::Filter::SCALAR) perl(Data::Printer::Filter::VSTRING) perl(Data::Printer::Filter::Web) perl(Data::Printer::Object) perl(Data::Printer::Profile) perl(Data::Printer::Profile::Dumper) perl(Data::Printer::Profile::JSON) perl(Data::Printer::Theme) perl(Data::Printer::Theme::Classic) perl(Data::Printer::Theme::Material) perl(Data::Printer::Theme::Monokai) perl(Data::Printer::Theme::Solarized) perl-Data-Printer"
