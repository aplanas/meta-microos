...
RPROVIDES:${PN} += "python3-calmjs python3.10dist(calmjs) python310-calmjs python3dist(calmjs)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-calmjs.parse python310-calmjs.types update-alternatives"
