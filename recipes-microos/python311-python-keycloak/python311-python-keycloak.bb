...
RPROVIDES:${PN} += "python3.11dist(python-keycloak) python311-python-keycloak python3dist(python-keycloak)"
RDEPENDS:${PN} += "python(abi) python311-python-jose python311-requests python311-setuptools"
