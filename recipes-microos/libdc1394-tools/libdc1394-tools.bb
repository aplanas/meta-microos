...
RPROVIDES:${PN} += "libdc1394 libdc1394-tools libdc1394-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdc1394.so.25()(64bit)"
