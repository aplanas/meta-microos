...
RPROVIDES:${PN} += "caja-devel caja-devel(aarch-64) mate-file-manager-devel pkgconfig(libcaja-extension)"
RDEPENDS:${PN} += "/usr/bin/pkg-config caja libcaja-extension1 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gtk+-3.0)"
