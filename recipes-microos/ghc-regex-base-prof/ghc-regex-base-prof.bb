...
RPROVIDES:${PN} += "ghc-prof(regex-base-0.94.0.2-8EhYuxSr6UD5zE7cP6wrkq) ghc-regex-base-prof ghc-regex-base-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(containers-0.6.7) ghc-prof(text-2.0.2) ghc-regex-base-devel"
