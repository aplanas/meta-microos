...
RPROVIDES:${PN} += "backintime backintime-doc"
RDEPENDS:${PN} += "/bin/sh cron dbus-1-python3 libnotify-tools openssh pkexec python3 python3-keyring python3-packaging rsync"
