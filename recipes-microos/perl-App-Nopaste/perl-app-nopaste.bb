...
RPROVIDES:${PN} += "perl(App::Nopaste) perl(App::Nopaste::Command) perl(App::Nopaste::Service) perl(App::Nopaste::Service::Codepeek) perl(App::Nopaste::Service::Debian) perl(App::Nopaste::Service::Gist) perl(App::Nopaste::Service::GitLab) perl(App::Nopaste::Service::Mojopaste) perl(App::Nopaste::Service::PastebinCom) perl(App::Nopaste::Service::Pastie) perl(App::Nopaste::Service::Shadowcat) perl(App::Nopaste::Service::Snitch) perl(App::Nopaste::Service::SusePaste) perl(App::Nopaste::Service::Ubuntu) perl(App::Nopaste::Service::ssh) perl-App-Nopaste"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(Browser::Open) perl(Class::Load) perl(Getopt::Long::Descriptive) perl(JSON::MaybeXS) perl(LWP::UserAgent) perl(Module::Pluggable) perl(Module::Runtime) perl(Path::Tiny) perl(URI::Escape) perl(WWW::Mechanize) perl(namespace::clean) perl(parent)"
