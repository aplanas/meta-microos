...
RPROVIDES:${PN} += "libsemanage-devel libsemanage-devel(aarch-64) pkgconfig(libsemanage)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libsemanage2 pkgconfig(libselinux) pkgconfig(libsepol)"
