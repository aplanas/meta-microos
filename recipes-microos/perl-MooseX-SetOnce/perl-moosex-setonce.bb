...
RPROVIDES:${PN} += "perl(Moose::Meta::Attribute::Custom::Trait::SetOnce) perl(MooseX::SetOnce) perl(MooseX::SetOnce::Accessor) perl(MooseX::SetOnce::Attribute) perl-MooseX-SetOnce"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Moose::Role)"
