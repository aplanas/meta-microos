...
RPROVIDES:${PN} += "typelib(GUPnPDLNA) typelib-1_0-GUPnPDLNA-2_0 typelib-1_0-GUPnPDLNA-2_0(aarch-64)"
RDEPENDS:${PN} += "libgupnp-dlna-2.0.so.4()(64bit) typelib(GLib) typelib(GObject)"
