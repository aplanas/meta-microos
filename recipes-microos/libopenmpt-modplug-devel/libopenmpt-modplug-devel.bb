...
RPROVIDES:${PN} += "libopenmpt-modplug-devel libopenmpt-modplug-devel(aarch-64) pkgconfig(libopenmpt_modplug)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libopenmpt_modplug1 pkgconfig(libopenmpt)"
