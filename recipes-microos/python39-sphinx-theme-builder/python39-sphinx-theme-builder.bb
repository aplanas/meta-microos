...
RPROVIDES:${PN} += "python3.9dist(sphinx-theme-builder) python39-sphinx-theme-builder python3dist(sphinx-theme-builder)"
RDEPENDS:${PN} += "(python39-tomli if python39-base < 3.11) /bin/sh /usr/bin/python3.9 python(abi) python39-click python39-nodeenv python39-packaging python39-pyproject-metadata python39-rich python39-setuptools update-alternatives"
