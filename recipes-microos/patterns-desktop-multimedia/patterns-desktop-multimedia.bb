...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-desktop-multimedia patterns-desktop-multimedia(aarch-64) patterns-openSUSE-multimedia"
RDEPENDS:${PN} += ""
