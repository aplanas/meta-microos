...
RPROVIDES:${PN} += "cfgdiff python3.11dist(cfgdiff) python311-cfgdiff python3dist(cfgdiff)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyYAML python311-configobj python311-dnspython python311-lxml"
