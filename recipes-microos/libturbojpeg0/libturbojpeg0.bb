...
RPROVIDES:${PN} += "libturbojpeg.so.0()(64bit) libturbojpeg.so.0(TURBOJPEG_1.0)(64bit) libturbojpeg.so.0(TURBOJPEG_1.1)(64bit) libturbojpeg.so.0(TURBOJPEG_1.2)(64bit) libturbojpeg.so.0(TURBOJPEG_1.4)(64bit) libturbojpeg.so.0(TURBOJPEG_2.0)(64bit) libturbojpeg0 libturbojpeg0(aarch-64)"
