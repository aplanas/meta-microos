...
RPROVIDES:${PN} += "config(gnu-compilers-hpc-macros-devel) gnu-compilers-hpc-macros-devel gnu-hpc-macros-devel gnu13-compilers-hpc-macros-devel rpm_macro(hpc_gnu_init) rpm_macro(hpc_gnu_requires) rpm_macro(hpc_gnu_requires_devel) rpm_macro(hpc_setup_gnu)"
