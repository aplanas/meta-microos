...
RPROVIDES:${PN} += "libverto-libev-devel libverto-libev-devel(aarch-64) pkgconfig(libverto-libev)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libverto-devel(aarch-64) libverto-libev1(aarch-64) pkgconfig(libverto)"
