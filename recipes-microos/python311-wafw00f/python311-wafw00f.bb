...
RPROVIDES:${PN} += "python3.11dist(wafw00f) python311-wafw00f python3dist(wafw00f)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-pluginbase python311-requests"
