...
RPROVIDES:${PN} += "rasdaemon rasdaemon(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/perl /usr/bin/touch dmidecode fillup ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libsqlite3.so.0()(64bit) libtraceevent.so.1()(64bit) perl-DBD-SQLite"
