...
RPROVIDES:${PN} += "python3-pyghmi python3.10dist(pyghmi) python3dist(pyghmi)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-cryptography python3-python-dateutil python3-six"
