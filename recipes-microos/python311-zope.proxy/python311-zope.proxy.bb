...
RPROVIDES:${PN} += "python3.11dist(zope.proxy) python311-zope.proxy python311-zope.proxy(aarch-64) python3dist(zope.proxy)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-zope.interface"
