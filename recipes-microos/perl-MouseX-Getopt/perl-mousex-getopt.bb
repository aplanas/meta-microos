...
RPROVIDES:${PN} += "perl(MouseX::Getopt) perl(MouseX::Getopt::Basic) perl(MouseX::Getopt::Dashes) perl(MouseX::Getopt::GLD) perl(MouseX::Getopt::Meta::Attribute) perl(MouseX::Getopt::Meta::Attribute::NoGetopt) perl(MouseX::Getopt::Meta::Attribute::Trait) perl(MouseX::Getopt::Meta::Attribute::Trait::NoGetopt) perl(MouseX::Getopt::OptionTypeMap) perl(MouseX::Getopt::Strict) perl-MouseX-Getopt perl-mousex-getopt"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Getopt::Long) perl(Getopt::Long::Descriptive) perl(Mouse) perl(Mouse::Meta::Attribute) perl(Mouse::Role) perl(Mouse::Util::TypeConstraints)"
