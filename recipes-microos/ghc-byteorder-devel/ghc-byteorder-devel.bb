...
RPROVIDES:${PN} += "ghc-byteorder-devel ghc-byteorder-devel(aarch-64) ghc-devel(byteorder-1.0.4-3C2mbNH4DNU4EJIfEbmhBl)"
RDEPENDS:${PN} += "/bin/sh ghc-byteorder ghc-compiler ghc-devel(base-4.17.1.0)"
