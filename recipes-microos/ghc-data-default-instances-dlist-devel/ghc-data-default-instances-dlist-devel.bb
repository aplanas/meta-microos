...
RPROVIDES:${PN} += "ghc-data-default-instances-dlist-devel ghc-data-default-instances-dlist-devel(aarch-64) ghc-devel(data-default-instances-dlist-0.0.1-Bmo6e1Lr8bt987tygJ1EBf)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-data-default-instances-dlist ghc-devel(base-4.17.1.0) ghc-devel(data-default-class-0.1.2.0-2LD1I8dZmn7BW4dkzEwdGZ) ghc-devel(dlist-1.0-BmTLN13CmmLQvuHz7BjP9)"
