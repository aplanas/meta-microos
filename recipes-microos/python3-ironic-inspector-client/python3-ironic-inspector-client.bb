...
RPROVIDES:${PN} += "python3-ironic-inspector-client python3.10dist(python-ironic-inspector-client) python3dist(python-ironic-inspector-client)"
RDEPENDS:${PN} += "python(abi) python3-PyYAML python3-keystoneauth1 python3-openstackclient python3-osc-lib python3-oslo.i18n python3-oslo.utils python3-requests"
