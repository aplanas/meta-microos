...
RPROVIDES:${PN} += "python3.9dist(bowler) python39-bowler python3dist(bowler)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-attrs python39-click python39-fissix python39-moreorless python39-setuptools python39-volatile update-alternatives"
