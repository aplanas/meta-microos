...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-devel-vulkan-devel_vulkan patterns-devel-vulkan-devel_vulkan(aarch-64)"
RDEPENDS:${PN} += ""
