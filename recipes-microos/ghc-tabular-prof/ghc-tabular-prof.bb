...
RPROVIDES:${PN} += "ghc-prof(tabular-0.2.2.8-5oBUDJP9F9qUMGPeotGAp) ghc-tabular-prof ghc-tabular-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(csv-0.1.2-LKioaw43aTAAAKpIk04xxN) ghc-prof(html-1.0.1.2-U7qWIp0bJwCnAFPlj3UZy) ghc-prof(mtl-2.2.2) ghc-tabular-devel"
