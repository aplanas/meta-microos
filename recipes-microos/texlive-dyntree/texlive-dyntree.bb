...
RPROVIDES:${PN} += "tex(dyntree.sty) texlive-dyntree"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(amssymb.sty) tex(calc.sty) tex(coollist.sty) tex(eepic.sty) tex(epic.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
