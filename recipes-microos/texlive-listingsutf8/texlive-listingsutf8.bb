...
RPROVIDES:${PN} += "tex(listingsutf8.sty) texlive-listingsutf8"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(inputenc.sty) tex(listings.sty) tex(pdftexcmds.sty) tex(stringenc.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
