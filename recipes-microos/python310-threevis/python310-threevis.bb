...
RPROVIDES:${PN} += "python3-threevis python3.10dist(threevis) python310-threevis python3dist(threevis)"
RDEPENDS:${PN} += "python(abi) python310-numpy python310-openmesh python310-pythreejs"
