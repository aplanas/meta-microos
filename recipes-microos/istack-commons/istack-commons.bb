...
RPROVIDES:${PN} += "istack-commons mvn(com.sun.istack:istack-commons:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(net.java:jvnet-parent:pom:) mvn(org.apache.felix:maven-bundle-plugin)"
