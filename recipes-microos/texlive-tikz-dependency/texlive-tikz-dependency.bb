...
RPROVIDES:${PN} += "tex(pgfmanual.code.tex) tex(pgfmanual.pdflinks.code.tex) tex(pgfmanual.prettyprinter.code.tex) tex(tikz-dependency.sty) texlive-tikz-dependency"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(environ.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
