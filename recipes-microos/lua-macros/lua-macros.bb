...
rpm_macro(ifluadefault) \
rpm_macro(lua_archdir) \
rpm_macro(lua_incdir) \
rpm_macro(lua_noarchdir) \
rpm_macro(lua_provides) \
rpm_macro(lua_version) \
rpm_macro(lua_version_default) \
rpm_macro(lua_version_default_nodots) \
rpm_macro(lua_version_nodots) \
