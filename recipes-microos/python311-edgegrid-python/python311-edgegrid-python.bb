...
RPROVIDES:${PN} += "python3.11dist(edgegrid-python) python311-edgegrid-python python3dist(edgegrid-python)"
RDEPENDS:${PN} += "python(abi) python311-ndg-httpsclient python311-pyOpenSSL python311-pyasn1 python311-requests python311-urllib3"
