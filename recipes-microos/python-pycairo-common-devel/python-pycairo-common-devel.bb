...
RPROVIDES:${PN} += "pkgconfig(py3cairo) python-cairo-common-devel python-pycairo-common-devel python-pycairo-common-devel(aarch-64) python310-cairo-common-devel python310-cairo-devel python310-pycairo-common-devel python311-cairo-common-devel python311-cairo-devel python311-pycairo-common-devel python39-cairo-common-devel python39-cairo-devel python39-pycairo-common-devel"
RDEPENDS:${PN} += "/usr/bin/pkg-config cairo-devel pkgconfig(cairo)"
