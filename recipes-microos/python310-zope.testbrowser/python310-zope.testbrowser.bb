...
RPROVIDES:${PN} += "python3-zope.testbrowser python3.10dist(zope.testbrowser) python310-zope.testbrowser python3dist(zope.testbrowser)"
RDEPENDS:${PN} += "python(abi) python310-WSGIProxy2 python310-WebTest python310-beautifulsoup4 python310-pytz python310-setuptools python310-soupsieve python310-zope.cachedescriptors python310-zope.interface python310-zope.schema"
