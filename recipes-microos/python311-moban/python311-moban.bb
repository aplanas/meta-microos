...
RPROVIDES:${PN} += "python3.11dist(moban) python311-moban python3dist(moban)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 git-core python(abi) python311-Jinja2 python311-appdirs python311-crayons python311-fs python311-jinja2-fsloader python311-lml python311-ruamel.yaml update-alternatives"
