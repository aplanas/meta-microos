...
RPROVIDES:${PN} += "libnetcdf-devel:/usr/lib64/libnetcdf_c++.so libnetcdf_c++4-devel libnetcdf_c++4-devel(aarch-64) netcdf-cxx4-tools pkgconfig(netcdf-cxx4)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libnetcdf_c++4-1 pkgconfig(netcdf)"
