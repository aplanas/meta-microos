...
RPROVIDES:${PN} += "config(libattr1) libattr libattr.so.1()(64bit) libattr.so.1(ATTR_1.0)(64bit) libattr.so.1(ATTR_1.1)(64bit) libattr.so.1(ATTR_1.2)(64bit) libattr.so.1(ATTR_1.3)(64bit) libattr1 libattr1(aarch-64)"
