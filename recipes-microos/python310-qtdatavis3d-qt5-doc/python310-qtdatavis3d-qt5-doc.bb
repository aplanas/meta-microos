...
RPROVIDES:${PN} += "python3-qtdatavis3d-qt5-doc python310-qtdatavis3d-qt5-doc python310-qtdatavis3d-qt5-examples python311-qtdatavis3d-qt5-examples python39-qtdatavis3d-qt5-examples"
RDEPENDS:${PN} += ""
