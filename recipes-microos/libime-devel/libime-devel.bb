...
RPROVIDES:${PN} += "cmake(LibIMECore) cmake(LibIMEPinyin) cmake(LibIMETable) libime-devel libime-devel(aarch-64)"
RDEPENDS:${PN} += "libIMECore0 libIMEPinyin0 libIMETable0"
