...
RPROVIDES:${PN} += "atinject mvn(jakarta.inject:jakarta.inject-api) mvn(jakarta.inject:jakarta.inject-api:pom:) mvn(javax.inject:javax.inject) mvn(javax.inject:javax.inject:pom:) osgi(javax.inject)"
