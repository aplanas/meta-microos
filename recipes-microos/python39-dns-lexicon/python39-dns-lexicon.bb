...
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-beautifulsoup4 python39-cryptography python39-importlib-metadata python39-requests python39-tldextract update-alternatives"
