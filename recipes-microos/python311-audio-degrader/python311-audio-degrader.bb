...
RPROVIDES:${PN} += "python3.11dist(audio-degrader) python311-audio-degrader python3dist(audio-degrader)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-SoundFile python311-scipy python311-sox update-alternatives"
