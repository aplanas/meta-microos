...
RPROVIDES:${PN} += "libayatana-indicator3-devel libayatana-indicator3-devel(aarch-64) pkgconfig(ayatana-indicator3-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libayatana-indicator3-7 pkgconfig(gtk+-3.0) pkgconfig(libayatana-ido3-0.4)"
