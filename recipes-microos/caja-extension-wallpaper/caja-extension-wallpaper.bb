...
RPROVIDES:${PN} += "caja-extension-wallpaper caja-extension-wallpaper(aarch-64) caja-wallpaper libcaja-wallpaper.so()(64bit)"
RDEPENDS:${PN} += "caja libc.so.6(GLIBC_2.17)(64bit) libcaja-extension.so.1()(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit)"
