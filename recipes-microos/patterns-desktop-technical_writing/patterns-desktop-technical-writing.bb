...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-desktop-technical_writing patterns-desktop-technical_writing(aarch-64) patterns-openSUSE-technical_writing"
RDEPENDS:${PN} += ""
