...
RPROVIDES:${PN} += "ghc-http-client-restricted-prof ghc-http-client-restricted-prof(aarch-64) ghc-prof(http-client-restricted-0.0.5-H9uptV4si451SzytuhF5eP)"
RDEPENDS:${PN} += "ghc-http-client-restricted-devel ghc-prof(base-4.17.1.0) ghc-prof(connection-0.3.1-IDyFh0K8hgZvp3uiDVm7m) ghc-prof(data-default-0.7.1.1-5iNQUD7GKkTDiLEyJaqXSy) ghc-prof(http-client-0.7.13.1-zzcC5JvmJYD0Lc0D9h215) ghc-prof(http-client-tls-0.3.6.1-1pQpHwWyWRWKJTeRlrZZA0) ghc-prof(network-3.1.2.8-HNDBp0HF6t0D1fzE2MDtPd) ghc-prof(network-bsd-2.8.1.0-D1RjTzX7Byx4U4fOdbAEll) ghc-prof(utf8-string-1.0.2-3yyxPCwARUwDt9ZNWn320Q)"
