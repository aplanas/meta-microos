...
RPROVIDES:${PN} += "tex(TangramTikz.sty) texlive-tangramtikz"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(listofitems.sty) tex(simplekv.sty) tex(tikz.sty) tex(xparse.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
