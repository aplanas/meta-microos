...
RPROVIDES:${PN} += "python3-azure-mgmt-servermanager python3.10dist(azure-mgmt-servermanager) python310-azure-mgmt-servermanager python3dist(azure-mgmt-servermanager)"
