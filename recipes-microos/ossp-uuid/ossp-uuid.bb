...
RPROVIDES:${PN} += "ossp-uuid ossp-uuid(aarch-64) uuid"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libossp-uuid.so.16()(64bit)"
