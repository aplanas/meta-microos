...
RPROVIDES:${PN} += "apache-rex rpm_macro(apache_rex_check) rpm_macro(apache_rex_deps)"
RDEPENDS:${PN} += "/bin/bash apache2-devel apache2-utils curl lsof openssl openssl-devel"
