...
RPROVIDES:${PN} += "python3-lazy-object-proxy python3-lazy_object_proxy python3.10dist(lazy-object-proxy) python310-lazy-object-proxy python310-lazy-object-proxy(aarch-64) python310-lazy_object_proxy python3dist(lazy-object-proxy)"
