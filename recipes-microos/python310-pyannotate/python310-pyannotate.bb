...
RPROVIDES:${PN} += "python3-pyannotate python3.10dist(pyannotate) python310-pyannotate python3dist(pyannotate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-mypy_extensions python310-six python310-typing update-alternatives"
