...
RPROVIDES:${PN} += "ruby3.2-rubygem-bundler ruby3.2-rubygem-bundler(aarch-64) rubygem(bundler) rubygem(ruby:3.2.0:bundler) rubygem(ruby:3.2.0:bundler:2) rubygem(ruby:3.2.0:bundler:2.3) rubygem(ruby:3.2.0:bundler:2.3.26)"
