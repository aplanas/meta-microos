...
RPROVIDES:${PN} += "ghc-boring-devel ghc-boring-devel(aarch-64) ghc-devel(boring-0.2.1-J8lJX6Vz53r2bssyBwOtpl)"
RDEPENDS:${PN} += "/bin/sh ghc-boring ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(tagged-0.8.7-CYOhX22Df3PFW5V1S0dOJa) ghc-devel(transformers-0.5.6.2)"
