...
RPROVIDES:${PN} += "irman-utils irman-utils(aarch-64) libirman-utils"
RDEPENDS:${PN} += "irman-common ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libirman.so.0()(64bit)"
