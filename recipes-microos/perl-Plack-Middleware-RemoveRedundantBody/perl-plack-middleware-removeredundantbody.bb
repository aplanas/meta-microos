...
RPROVIDES:${PN} += "perl(Plack::Middleware::RemoveRedundantBody) perl-Plack-Middleware-RemoveRedundantBody"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Plack::Middleware) perl(Plack::Util) perl(parent)"
