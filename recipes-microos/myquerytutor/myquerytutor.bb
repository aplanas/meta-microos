...
RPROVIDES:${PN} += "application() application(myquerytutor.desktop) myquerytutor python3.10dist(myquerytutor) python3dist(myquerytutor)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-PyQt5 python3-beautifulsoup4 python3-qtwebengine-qt5 python3-requests"
