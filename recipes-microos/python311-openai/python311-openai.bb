...
RPROVIDES:${PN} += "python3.11dist(openai) python311-openai python3dist(openai)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-aiohttp python311-requests python311-tqdm update-alternatives"
