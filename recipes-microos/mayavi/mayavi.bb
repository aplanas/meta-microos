...
RPROVIDES:${PN} += "application() application(mayavi.desktop) mayavi mayavi(aarch-64) python3-mayavi python3.10dist(mayavi) python3dist(mayavi)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Pygments python3-apptools python3-envisage python3-qt5 python3-tvtk"
