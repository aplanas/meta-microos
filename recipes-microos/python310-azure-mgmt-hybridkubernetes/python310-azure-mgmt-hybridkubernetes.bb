...
RPROVIDES:${PN} += "python3-azure-mgmt-hybridkubernetes python3.10dist(azure-mgmt-hybridkubernetes) python310-azure-mgmt-hybridkubernetes python3dist(azure-mgmt-hybridkubernetes)"
