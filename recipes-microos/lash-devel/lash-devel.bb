...
RPROVIDES:${PN} += "lash-devel lash-devel(aarch-64) pkgconfig(lash-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel liblash1 libuuid-devel pkgconfig(alsa) pkgconfig(jack) readline-devel"
