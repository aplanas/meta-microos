...
RPROVIDES:${PN} += "python3.9dist(pyroma) python39-pyroma python3dist(pyroma)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Pygments python39-docutils python39-setuptools update-alternatives"
