...
RPROVIDES:${PN} += "pkgconfig(playerctl) playerctl-devel playerctl-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libplayerctl2 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(gobject-2.0)"
