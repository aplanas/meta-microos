...
RPROVIDES:${PN} += "tex(sffdumb.sty) tex(sffms.cls) tex(sffsmart.sty) texlive-sffms"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fancyhdr.sty) tex(fontenc.sty) tex(geometry.sty) tex(report.cls) tex(setspace.sty) tex(ulem.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
