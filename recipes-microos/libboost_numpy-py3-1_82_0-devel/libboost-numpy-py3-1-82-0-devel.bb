...
RPROVIDES:${PN} += "libboost_numpy-py3-1_82_0-devel libboost_numpy-py3-1_82_0-devel(aarch-64) libboost_numpy3-devel-impl"
RDEPENDS:${PN} += "libboost_headers1_82_0-devel libboost_numpy-py3-1_82_0"
