...
RPROVIDES:${PN} += "python3.11dist(opencensus-ext-azure) python311-opencensus-ext-azure python3dist(opencensus-ext-azure)"
RDEPENDS:${PN} += "python(abi) python311-azure-core python311-azure-identity python311-opencensus python311-psutil python311-requests"
