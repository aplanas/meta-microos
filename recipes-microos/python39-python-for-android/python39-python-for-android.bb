...
RDEPENDS:${PN} += "/bin/sh /usr/bin/bash /usr/bin/python3.9 python(abi) python39-Jinja2 python39-appdirs python39-build python39-colorama python39-toml update-alternatives"
