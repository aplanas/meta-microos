...
RPROVIDES:${PN} += "python3.9dist(xarray-einstats) python39-xarray-einstats python3dist(xarray-einstats)"
RDEPENDS:${PN} += "python(abi) python39-numpy python39-scipy python39-xarray"
