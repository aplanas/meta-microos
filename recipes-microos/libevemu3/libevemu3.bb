...
RPROVIDES:${PN} += "libevemu.so.3()(64bit) libevemu.so.3(EVEMU_2.0)(64bit) libevemu3 libevemu3(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libevdev.so.2()(64bit) libevdev.so.2(LIBEVDEV_1)(64bit)"
