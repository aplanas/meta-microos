...
RPROVIDES:${PN} += "python3.11dist(azure-cosmos) python311-azure-cosmos python3dist(azure-cosmos)"
RDEPENDS:${PN} += "python(abi) python311-azure-core python311-azure-nspkg"
