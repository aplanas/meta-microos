...
RPROVIDES:${PN} += "python3.9dist(booleanoperations) python39-booleanOperations python3dist(booleanoperations)"
RDEPENDS:${PN} += "python(abi) python39-FontTools python39-pyclipper"
