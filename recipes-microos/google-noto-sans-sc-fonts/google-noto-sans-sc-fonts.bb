...
RPROVIDES:${PN} += "google-noto-sans-sc-fonts locale(zh_CN;zh_SG) noto-sans-cjksc noto-sans-cjksc-fonts noto-sans-sc-fonts scalable-font-zh-CN scalable-font-zh-SG"
RDEPENDS:${PN} += "google-noto-sans-sc-bold-fonts google-noto-sans-sc-regular-fonts"
