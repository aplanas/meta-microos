...
RPROVIDES:${PN} += "python3.11dist(rich-click) python311-rich-click python3dist(rich-click)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-click python311-rich"
