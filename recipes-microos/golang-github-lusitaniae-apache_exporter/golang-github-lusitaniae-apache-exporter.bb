...
RPROVIDES:${PN} += "config(golang-github-lusitaniae-apache_exporter) golang-github-lusitaniae-apache_exporter golang-github-lusitaniae-apache_exporter(aarch-64)"
RDEPENDS:${PN} += "/bin/sh libc.so.6(GLIBC_2.34)(64bit) shadow systemd"
