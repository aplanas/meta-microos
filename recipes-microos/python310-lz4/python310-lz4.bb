...
RPROVIDES:${PN} += "python3-lz4 python3.10dist(lz4) python310-lz4 python310-lz4(aarch-64) python3dist(lz4)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) liblz4.so.1()(64bit) python(abi)"
