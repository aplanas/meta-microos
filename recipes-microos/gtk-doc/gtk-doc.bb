...
RPROVIDES:${PN} += "gtk-doc gtk-doc(aarch-64) gtkdoc pkgconfig(gtk-doc)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config /usr/bin/python3 docbook-xsl-stylesheets docbook_4 glib2-devel libxml2-tools python3-pygments xsltproc"
