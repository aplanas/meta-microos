...
RPROVIDES:${PN} += "python3-psutil python3.10dist(psutil) python310-psutil python310-psutil(aarch-64) python3dist(psutil)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) procps python(abi)"
