...
RPROVIDES:${PN} += "ghc-prof(skylighting-format-context-0.1.0.2-KUO5o5IaP468SqsY1Sf1SB) ghc-skylighting-format-context-prof ghc-skylighting-format-context-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(skylighting-core-0.13.2.1-6o4V0mA5OWyEHmMDE2dJ63) ghc-prof(text-2.0.2) ghc-skylighting-format-context-devel"
