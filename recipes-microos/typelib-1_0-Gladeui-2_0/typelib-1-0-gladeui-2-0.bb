...
RPROVIDES:${PN} += "typelib(Gladeui) typelib-1_0-Gladeui-2_0 typelib-1_0-Gladeui-2_0(aarch-64)"
RDEPENDS:${PN} += "libgladeui-2.so.13()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
