...
RPROVIDES:${PN} += "libcanberra-gtk-devel libcanberra-gtk-devel(aarch-64) pkgconfig(libcanberra-gtk)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libcanberra-devel libcanberra-gtk0 libcanberra0 pkgconfig(gdk-2.0) pkgconfig(gtk+-2.0) pkgconfig(libcanberra)"
