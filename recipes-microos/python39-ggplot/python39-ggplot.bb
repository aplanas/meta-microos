...
RPROVIDES:${PN} += "python3.9dist(ggplot) python39-ggplot python3dist(ggplot)"
RDEPENDS:${PN} += "python(abi) python39-Cycler python39-brewer2mpl python39-matplotlib python39-numpy python39-pandas python39-patsy python39-scipy python39-six python39-statsmodels"
