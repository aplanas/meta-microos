...
RPROVIDES:${PN} += "tex(cicero.ltd.tex) tex(lipsum-cs.ltd.tex) tex(lipsum.ltd.tex) tex(lipsum.sty) texlive-lipsum"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(babel.sty) tex(l3keys2e.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
