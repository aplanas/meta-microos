...
RPROVIDES:${PN} += "python3.9dist(cloudflare) python39-cloudflare python3dist(cloudflare)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-beautifulsoup4 python39-future python39-jsonlines python39-requests update-alternatives"
