...
RPROVIDES:${PN} += "pkgconfig(recastnavigation) recastnavigation-devel recastnavigation-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libDebugUtils1 libDetour1 libDetourCrowd1 libDetourTileCache1 libRecast1"
