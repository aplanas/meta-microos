...
RPROVIDES:${PN} += "ghc-primitive-prof ghc-primitive-prof(aarch-64) ghc-prof(primitive-0.7.4.0-AeB0oysC3TAJw9tDpuX8hq)"
RDEPENDS:${PN} += "ghc-primitive-devel ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(template-haskell-2.19.0.0) ghc-prof(transformers-0.5.6.2)"
