...
RPROVIDES:${PN} += "python3.9dist(dqsegdb2) python39-dqsegdb2 python3dist(dqsegdb2)"
RDEPENDS:${PN} += "python(abi) python39-gwdatafind python39-igwn-auth-utils python39-ligo-segments"
