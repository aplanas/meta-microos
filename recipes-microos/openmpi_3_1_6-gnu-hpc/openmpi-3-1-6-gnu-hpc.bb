...
RPROVIDES:${PN} += "mpi openmpi_3_1_6-gnu-hpc openmpi_3_1_6-gnu-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/sh gnu-compilers-hpc ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libevent-2.1.so.7()(64bit) libopenmpi_3_1_6-gnu-hpc lua-lmod openmpi-runtime-config openssh"
