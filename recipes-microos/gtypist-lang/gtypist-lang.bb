...
RPROVIDES:${PN} += "gtypist-lang gtypist-lang(aarch-64) locale(gtypist:cs) locale(gtypist:de) locale(gtypist:es) locale(gtypist:eu) locale(gtypist:fi) locale(gtypist:fr) locale(gtypist:nl) locale(gtypist:pl) locale(gtypist:ru) locale(gtypist:tr) locale(gtypist:zh_CN) locale(gtypist:zh_TW)"
RDEPENDS:${PN} += "gtypist"
