...
RPROVIDES:${PN} += "libindicator3-devel libindicator3-devel(aarch-64) pkgconfig(indicator3-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libido3-0.1.so.0()(64bit) libindicator3-7 libindicator3.so.7()(64bit) pkgconfig(gtk+-3.0)"
