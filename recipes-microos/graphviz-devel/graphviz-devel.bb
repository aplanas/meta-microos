...
RPROVIDES:${PN} += "graphviz-devel graphviz-devel(aarch-64) pkgconfig(libcdt) pkgconfig(libcgraph) pkgconfig(libgvc) pkgconfig(libgvpr) pkgconfig(liblab_gamut) pkgconfig(libpathplan) pkgconfig(libxdot)"
RDEPENDS:${PN} += "/usr/bin/pkg-config graphviz libcdt5 libcgraph6 libgvc6 libgvpr2 liblab_gamut1 libpathplan4 libxdot4"
