...
RPROVIDES:${PN} += "ruby3.2-rubygem-mini_mime ruby3.2-rubygem-mini_mime(aarch-64) rubygem(mini_mime) rubygem(ruby:3.2.0:mini_mime) rubygem(ruby:3.2.0:mini_mime:1) rubygem(ruby:3.2.0:mini_mime:1.1) rubygem(ruby:3.2.0:mini_mime:1.1.2)"
