...
RPROVIDES:${PN} += "perl(HTML::Entities) perl(HTML::Filter) perl(HTML::HeadParser) perl(HTML::LinkExtor) perl(HTML::Parser) perl(HTML::PullParser) perl(HTML::TokeParser) perl-HTML-Parser perl-HTML-Parser(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) perl(:MODULE_COMPAT_5.36.0) perl(HTML::Tagset) perl(HTTP::Headers) perl(URI) perl(URI::URL)"
