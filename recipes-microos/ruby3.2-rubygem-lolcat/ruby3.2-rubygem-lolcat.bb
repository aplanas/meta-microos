...
RPROVIDES:${PN} += "ruby3.2-rubygem-lolcat ruby3.2-rubygem-lolcat(aarch-64) rubygem(lolcat) rubygem(ruby:3.2.0:lolcat) rubygem(ruby:3.2.0:lolcat:100) rubygem(ruby:3.2.0:lolcat:100.0) rubygem(ruby:3.2.0:lolcat:100.0.1)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/ruby.ruby3.2 ruby(abi) rubygem(ruby:3.2.0:manpages:0.6) rubygem(ruby:3.2.0:optimist:3.0) rubygem(ruby:3.2.0:paint:2) update-alternatives"
