...
RPROVIDES:${PN} += "ghc-blaze-builder-prof ghc-blaze-builder-prof(aarch-64) ghc-prof(blaze-builder-0.4.2.2-1GcRIc7N7YHId5Q5gRvlvW)"
RDEPENDS:${PN} += "ghc-blaze-builder-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(ghc-prim-0.9.0) ghc-prof(text-2.0.2)"
