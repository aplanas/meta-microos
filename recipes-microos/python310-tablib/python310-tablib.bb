...
RPROVIDES:${PN} += "python3-tablib python3.10dist(tablib) python310-tablib python3dist(tablib)"
RDEPENDS:${PN} += "python(abi) python310-MarkupPy python310-PyYAML python310-odfpy python310-openpyxl python310-tabulate python310-xlrd python310-xlwt"
