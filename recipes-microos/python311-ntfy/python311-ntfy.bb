...
RPROVIDES:${PN} += "python3.11dist(ntfy) python311-ntfy python3dist(ntfy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-appdirs python311-requests python311-ruamel.yaml update-alternatives"
