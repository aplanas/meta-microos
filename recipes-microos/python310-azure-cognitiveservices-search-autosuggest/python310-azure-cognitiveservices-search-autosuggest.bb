...
RPROVIDES:${PN} += "python3-azure-cognitiveservices-search-autosuggest python3.10dist(azure-cognitiveservices-search-autosuggest) python310-azure-cognitiveservices-search-autosuggest python3dist(azure-cognitiveservices-search-autosuggest)"
