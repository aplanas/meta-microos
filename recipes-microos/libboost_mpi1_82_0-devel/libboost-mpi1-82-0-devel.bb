...
RPROVIDES:${PN} += "libboost_mpi-devel-impl libboost_mpi1_82_0-devel libboost_mpi1_82_0-devel(aarch-64)"
RDEPENDS:${PN} += "libboost_graph1_82_0-devel libboost_headers1_82_0-devel libboost_mpi1_82_0 libboost_python-py3-1_82_0-devel libboost_serialization1_82_0-devel openmpi4-devel"
