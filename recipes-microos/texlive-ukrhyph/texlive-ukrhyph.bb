...
RPROVIDES:${PN} += "tex(catlcy.tex) tex(lcy2koi.tex) tex(lcy2lcy.tex) tex(lcy2ot2.tex) tex(lcy2t2a.tex) tex(lcy2ucy.tex) tex(rules60.tex) tex(rules90.tex) tex(rules_ph.tex) tex(ukrenhyp.tex) tex(ukrhypfa.tex) tex(ukrhyph.tex) tex(ukrhypmp.tex) tex(ukrhypmt.tex) tex(ukrhypsm.tex) tex(ukrhypst.tex) texlive-ukrhyph"
