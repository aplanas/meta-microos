...
RPROVIDES:${PN} += "python3.9dist(shijian) python39-shijian python3dist(shijian)"
RDEPENDS:${PN} += "python39-matplotlib python39-numpy python39-pandas python39-python-dateutil python39-scikit-learn python39-scipy python39-seaborn python39-technicolor"
