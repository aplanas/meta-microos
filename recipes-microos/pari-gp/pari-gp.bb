...
RPROVIDES:${PN} += "config(pari-gp) pari-gp pari-gp(aarch-64) perl(PARI::822)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libc.so.6(GLIBC_2.34)(64bit) libpari-gmp-tls.so.8()(64bit) libreadline.so.8()(64bit)"
