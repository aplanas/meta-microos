...
RPROVIDES:${PN} += "apr-util-devel apr-util-devel(aarch-64) libapr-util1-devel pkgconfig(apr-util-1)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config apr-devel gdbm-devel libapr-util1-0 libexpat-devel openldap2-devel pkgconfig(apr-1)"
