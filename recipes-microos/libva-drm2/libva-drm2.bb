...
RPROVIDES:${PN} += "libva-drm.so.2()(64bit) libva-drm2 libva-drm2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdrm.so.2()(64bit) libva.so.2()(64bit)"
