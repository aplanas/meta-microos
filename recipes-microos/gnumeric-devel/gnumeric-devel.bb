...
RPROVIDES:${PN} += "gnumeric-devel gnumeric-devel(aarch-64) pkgconfig(libspreadsheet-1.12)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gnumeric pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(gtk+-3.0) pkgconfig(libgoffice-0.10) pkgconfig(libgsf-1) pkgconfig(libxml-2.0)"
