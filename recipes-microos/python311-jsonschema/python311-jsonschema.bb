...
RPROVIDES:${PN} += "python3.11dist(jsonschema) python311-jsonschema python3dist(jsonschema)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 alts python(abi) python311-attrs python311-pyrsistent"
