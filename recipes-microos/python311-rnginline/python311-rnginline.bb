...
RPROVIDES:${PN} += "python3.11dist(rnginline) python311-rnginline python3dist(rnginline)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-docopt python311-lxml python311-six update-alternatives"
