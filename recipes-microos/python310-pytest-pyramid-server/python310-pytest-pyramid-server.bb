...
RPROVIDES:${PN} += "python3-pytest-pyramid-server python3.10dist(pytest-pyramid-server) python310-pytest-pyramid-server python3dist(pytest-pyramid-server)"
RDEPENDS:${PN} += "python(abi) python310-pyramid python310-pytest-server-fixtures python310-six python310-waitress"
