...
RPROVIDES:${PN} += "ghc-vector-binary-instances ghc-vector-binary-instances(aarch-64) libHSvector-binary-instances-0.2.5.2-KcST7aCBDJmuBtN6ufmU8-ghc9.4.5.so()(64bit)"
