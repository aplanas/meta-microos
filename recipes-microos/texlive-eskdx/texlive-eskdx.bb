...
RPROVIDES:${PN} += "tex(eskdafterpkg.sty) tex(eskdappsheet.sty) tex(eskdbiblist.sty) tex(eskdcap.sty) tex(eskdchngsheet.sty) tex(eskddstu.sty) tex(eskdexplan.sty) tex(eskdfont.sty) tex(eskdfootnote.sty) tex(eskdfreesize.sty) tex(eskdgraph.cls) tex(eskdhash.sty) tex(eskdindent.sty) tex(eskdinfo.sty) tex(eskdlang.sty) tex(eskdlist.sty) tex(eskdpara.sty) tex(eskdplain.sty) tex(eskdrussian.def) tex(eskdsect.sty) tex(eskdspec.sty) tex(eskdspecii.sty) tex(eskdstamp.sty) tex(eskdtab.cls) tex(eskdtext.cls) tex(eskdtitle.sty) tex(eskdtitlebase.sty) tex(eskdtotal.sty) tex(eskdukrainian.def) texlive-eskdx"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(array.sty) tex(article.cls) tex(babel.sty) tex(calc.sty) tex(caption.sty) tex(chngpage.sty) tex(everyshi.sty) tex(extarticle.cls) tex(ifpdf.sty) tex(indentfirst.sty) tex(inputenc.sty) tex(keyval.sty) tex(lastpage.sty) tex(longtable.sty) tex(lscape.sty) tex(rotating.sty) tex(zref-perpage.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
