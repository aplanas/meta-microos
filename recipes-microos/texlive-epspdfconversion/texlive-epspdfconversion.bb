...
RPROVIDES:${PN} += "tex(epspdfconversion.sty) texlive-epspdfconversion"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(epstopdf-base.sty) tex(graphics.sty) tex(kvoptions.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
