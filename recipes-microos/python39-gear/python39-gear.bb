...
RPROVIDES:${PN} += "python3.9dist(gear) python39-gear python3dist(gear)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-extras python39-pbr python39-python-daemon python39-six update-alternatives"
