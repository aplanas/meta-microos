...
RPROVIDES:${PN} += "ghc-indexed-profunctors-prof ghc-indexed-profunctors-prof(aarch-64) ghc-prof(indexed-profunctors-0.1.1-8slbuH4IUUg1HsCF6rf8GV)"
RDEPENDS:${PN} += "ghc-indexed-profunctors-devel ghc-prof(base-4.17.1.0)"
