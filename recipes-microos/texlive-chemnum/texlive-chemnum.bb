...
RPROVIDES:${PN} += "tex(chemnum.sty) texlive-chemnum"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(chemgreek.sty) tex(expl3.sty) tex(l3keys2e.sty) tex(psfrag.sty) tex(translations.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
