...
RPROVIDES:${PN} += "aws-sdk-java-marketplacemeteringservice mvn(com.amazonaws:aws-java-sdk-marketplacemeteringservice) mvn(com.amazonaws:aws-java-sdk-marketplacemeteringservice:pom:)"
