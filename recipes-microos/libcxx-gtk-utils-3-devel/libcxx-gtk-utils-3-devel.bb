...
RPROVIDES:${PN} += "libcxx-gtk-utils-3-devel libcxx-gtk-utils-3-devel(aarch-64) pkgconfig(c++-gtk-utils-3-2.2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libcxx-gtk-utils-3-2_2-0 pkgconfig(glib-2.0) pkgconfig(gthread-2.0)"
