...
RPROVIDES:${PN} += "ghostscript-x11 ghostscript-x11(aarch-64) ghostscript_x11"
RDEPENDS:${PN} += "ghostscript ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libICE.so.6()(64bit) libSM.so.6()(64bit) libX11.so.6()(64bit) libXext.so.6()(64bit) libXt.so.6()(64bit) libc.so.6(GLIBC_2.17)(64bit)"
