...
RPROVIDES:${PN} += "tex(tikz-page.sty) texlive-tikz-page"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(fancyhdr.sty) tex(graphicx.sty) tex(textpos.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
