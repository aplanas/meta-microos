...
RPROVIDES:${PN} += "libnvme-devel libnvme-devel(aarch-64) pkgconfig(libnvme) pkgconfig(libnvme-mi)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnvme-mi1 libnvme1 pkgconfig(json-c) pkgconfig(libkeyutils) pkgconfig(openssl)"
