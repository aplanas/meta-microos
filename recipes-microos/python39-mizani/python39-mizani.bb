...
RPROVIDES:${PN} += "python3.9dist(mizani) python39-mizani python3dist(mizani)"
RDEPENDS:${PN} += "python(abi) python39-matplotlib python39-numpy python39-palettable python39-pandas python39-scipy"
