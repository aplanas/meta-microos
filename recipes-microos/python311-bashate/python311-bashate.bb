...
RPROVIDES:${PN} += "python3.11dist(bashate) python311-bashate python3dist(bashate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Babel python311-pbr update-alternatives"
