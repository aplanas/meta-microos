...
RPROVIDES:${PN} += "python3.9dist(screenplain) python39-screenplain python3dist(screenplain)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-reportlab update-alternatives"
