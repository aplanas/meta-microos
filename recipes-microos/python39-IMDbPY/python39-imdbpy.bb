...
RPROVIDES:${PN} += "python3.9dist(imdbpy) python39-IMDbPY python3dist(imdbpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-SQLAlchemy python39-lxml update-alternatives"
