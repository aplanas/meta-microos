...
RPROVIDES:${PN} += "python3-avocado-plugins-result-upload python3.10dist(avocado-framework-plugin-result-upload) python3dist(avocado-framework-plugin-result-upload)"
