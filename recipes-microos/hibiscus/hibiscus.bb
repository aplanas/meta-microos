...
RPROVIDES:${PN} += "application() application(hibiscus.desktop) hibiscus hibiscus(aarch-64) metainfo() metainfo(hibiscus.appdata.xml)"
RDEPENDS:${PN} += "eclipse-swtchart hbci4java itextpdf jameica pcsc-towitoko-devel super-csv"
