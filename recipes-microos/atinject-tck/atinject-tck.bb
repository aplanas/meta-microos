...
RPROVIDES:${PN} += "atinject-tck mvn(javax.inject:javax.inject-tck) mvn(javax.inject:javax.inject-tck:pom:) osgi(com.google.code.atinject.tck)"
RDEPENDS:${PN} += "atinject java-headless javapackages-filesystem junit mvn(javax.inject:javax.inject) mvn(junit:junit) osgi(org.junit)"
