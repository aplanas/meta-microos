...
RPROVIDES:${PN} += "tex(witharrows.sty) texlive-witharrows"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(footnote.sty) tex(footnotehyper.sty) tex(l3keys2e.sty) tex(tikz.sty) tex(varwidth.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
