...
RPROVIDES:${PN} += "ghc-prof(tagged-0.8.7-CYOhX22Df3PFW5V1S0dOJa) ghc-tagged-prof ghc-tagged-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(template-haskell-2.19.0.0) ghc-prof(transformers-0.5.6.2) ghc-tagged-devel"
