...
RPROVIDES:${PN} += "tex(figput.sty) texlive-figput"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(tikz.sty) tex(verbatim.sty) tex(xsim.sty) tex(zref-abspage.sty) tex(zref-pagelayout.sty) tex(zref-savepos.sty) tex(zref-thepage.sty) tex(zref-user.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
