...
RPROVIDES:${PN} += "perl(Perl::PrereqScanner) perl(Perl::PrereqScanner::Scanner) perl(Perl::PrereqScanner::Scanner::Aliased) perl(Perl::PrereqScanner::Scanner::Moose) perl(Perl::PrereqScanner::Scanner::POE) perl(Perl::PrereqScanner::Scanner::Perl5) perl(Perl::PrereqScanner::Scanner::Superclass) perl(Perl::PrereqScanner::Scanner::TestMore) perl-Perl-PrereqScanner"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(CPAN::Meta::Requirements) perl(Getopt::Long::Descriptive) perl(List::Util) perl(Module::Path) perl(Moo) perl(Moo::Role) perl(PPI) perl(Params::Util) perl(String::RewritePrefix) perl(Types::Standard) perl(namespace::autoclean)"
