...
RPROVIDES:${PN} += "python3.9dist(padatious) python39-padatious python3dist(padatious)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-fann2 python39-padaos python39-setuptools python39-xxhash update-alternatives"
