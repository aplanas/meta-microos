...
RPROVIDES:${PN} += "python3.9dist(pykwalify) python39-pykwalify python3dist(pykwalify)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-docopt python39-python-dateutil python39-ruamel.yaml update-alternatives"
