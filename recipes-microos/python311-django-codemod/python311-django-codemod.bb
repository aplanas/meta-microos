...
RPROVIDES:${PN} += "python3.11dist(django-codemod) python311-django-codemod python3dist(django-codemod)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-click python311-libcst python311-pathspec python311-rich-click update-alternatives"
