...
RPROVIDES:${PN} += "python3-py7zr python3.10dist(py7zr) python310-py7zr python3dist(py7zr)"
RDEPENDS:${PN} += "(python310-pyppmd >= 0.18.1 with python310-pyppmd < 1.1.0) /bin/sh /usr/bin/python3.10 python(abi) python310-Brotli python310-inflate64 python310-multivolumefile python310-psutil python310-pybcj python310-pycryptodomex python310-pyzstd python310-texttable update-alternatives"
