...
RPROVIDES:${PN} += "librdf_storage_postgresql.so()(64bit) redland-storage-postgresql redland-storage-postgresql(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libpq.so.5()(64bit) librdf.so.0()(64bit) redland"
