...
RPROVIDES:${PN} += "python3-aioquic python3.10dist(aioquic) python310-aioquic python310-aioquic(aarch-64) python3dist(aioquic)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) python(abi) python310-certifi python310-cryptography python310-pyOpenSSL python310-pylsqpack"
