...
RPROVIDES:${PN} += "python3.9dist(macholib) python39-macholib python3dist(macholib)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-altgraph python39-setuptools update-alternatives"
