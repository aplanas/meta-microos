...
RPROVIDES:${PN} += "python3-sphinxbase5 python3-sphinxbase5(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsphinxbase.so.3()(64bit) python(abi) sphinxbase5"
