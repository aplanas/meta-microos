...
RPROVIDES:${PN} += "python3.11dist(gtts) python311-gTTS python3dist(gtts)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-beautifulsoup4 python311-click python311-gTTS-token python311-requests python311-setuptools python311-six update-alternatives"
