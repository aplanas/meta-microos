...
RPROVIDES:${PN} += "python3.9dist(testtools) python39-testtools python3dist(testtools)"
RDEPENDS:${PN} += "python(abi) python39-pbr python39-python-mimeparse python39-traceback2"
