...
RPROVIDES:${PN} += "ruby3.2-rubygem-zeitwerk \
ruby3.2-rubygem-zeitwerk(aarch-64) \
rubygem(ruby:3.2.0:zeitwerk) \
rubygem(ruby:3.2.0:zeitwerk:2) \
rubygem(ruby:3.2.0:zeitwerk:2.6) \
rubygem(ruby:3.2.0:zeitwerk:2.6.6) \
rubygem(zeitwerk)"
