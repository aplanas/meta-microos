...
RPROVIDES:${PN} += "dazzle-list-counters dazzle-list-counters(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdazzle-1.0.so.0()(64bit) libglib-2.0.so.0()(64bit)"
