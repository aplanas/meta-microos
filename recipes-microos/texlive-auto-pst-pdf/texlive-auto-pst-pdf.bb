...
RPROVIDES:${PN} += "tex(auto-pst-pdf.sty) texlive-auto-pst-pdf"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifpdf.sty) tex(ifplatform.sty) tex(pst-pdf.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-ifplatform texlive-iftex texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-xkeyval"
