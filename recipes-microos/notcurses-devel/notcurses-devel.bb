...
RPROVIDES:${PN} += "cmake(Notcurses) notcurses-devel notcurses-devel(aarch-64) pkgconfig(notcurses) pkgconfig(notcurses-ffi)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnotcurses3 pkgconfig(notcurses-core) pkgconfig(notcurses-ffi)"
