...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-enlightenment-enlightenment patterns-enlightenment-enlightenment(aarch-64)"
RDEPENDS:${PN} += "enlightenment lightdm pattern()"
