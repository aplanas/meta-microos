...
RPROVIDES:${PN} += "python39-cairo-devel python39-pycairo-devel python39-pycairo-devel(aarch-64)"
RDEPENDS:${PN} += "python39-devel python39-pycairo python39-pycairo-common-devel"
