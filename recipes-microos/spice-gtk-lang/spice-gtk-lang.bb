...
RPROVIDES:${PN} += "locale(spice-gtk:cs) locale(spice-gtk:de) locale(spice-gtk:fr) locale(spice-gtk:it) locale(spice-gtk:ka) locale(spice-gtk:ru) spice-gtk-lang spice-gtk-lang-all"
