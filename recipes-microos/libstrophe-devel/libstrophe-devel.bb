...
RPROVIDES:${PN} += "libstrophe-devel libstrophe-devel(aarch-64) pkgconfig(libstrophe)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libstrophe0 pkgconfig(libxml-2.0) pkgconfig(openssl)"
