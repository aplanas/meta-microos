...
RPROVIDES:${PN} += "python3.9dist(pykmip) python39-PyKMIP python3dist(pykmip)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-SQLAlchemy python39-cryptography python39-requests python39-six update-alternatives"
