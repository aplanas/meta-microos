...
RPROVIDES:${PN} += "glade-catalog-gtkdatabox glade-catalog-gtkdatabox(aarch-64) libgladedatabox.so()(64bit)"
RDEPENDS:${PN} += "libgladeui-2.so.13()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libgtkdatabox.so.1()(64bit)"
