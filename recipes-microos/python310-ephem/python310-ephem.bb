...
RPROVIDES:${PN} += "python3-ephem python3.10dist(ephem) python310-ephem python310-ephem(aarch-64) python3dist(ephem)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) python(abi) python310-pytzdata"
