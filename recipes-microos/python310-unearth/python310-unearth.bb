...
RPROVIDES:${PN} += "python3-unearth python3.10dist(unearth) python310-unearth python3dist(unearth)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-packaging python310-requests update-alternatives"
