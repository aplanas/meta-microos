...
RPROVIDES:${PN} += "tex(impnattypo.sty) texlive-impnattypo"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifluatex.sty) tex(kvoptions.sty) tex(luacode.sty) tex(luatexbase.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
