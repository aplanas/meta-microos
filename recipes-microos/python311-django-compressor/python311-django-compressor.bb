...
RPROVIDES:${PN} += "python3.11dist(django-compressor) python311-django-compressor python311-django_compressor python3dist(django-compressor)"
RDEPENDS:${PN} += "python(abi) python311-Django python311-Jinja2 python311-beautifulsoup4 python311-csscompressor python311-django-appconf python311-rcssmin python311-rjsmin python311-slimit"
