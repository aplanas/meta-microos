...
RPROVIDES:${PN} += "plotutils-devel plotutils-devel(aarch-64)"
RDEPENDS:${PN} += "bison flex fontpackages-devel gcc-c++ libplot2 libplotter2 libpng-devel libstdc++-devel libtool libxmi0 pkgconfig pkgconfig(x11) pkgconfig(xaw7) pkgconfig(xext) pkgconfig(xt) plotutils"
