...
RPROVIDES:${PN} += "python3.11dist(gwcs) python311-gwcs python3dist(gwcs)"
RDEPENDS:${PN} += "python(abi) python311-asdf python311-asdf-astropy python311-asdf_wcs_schemas python311-astropy python311-numpy python311-scipy"
