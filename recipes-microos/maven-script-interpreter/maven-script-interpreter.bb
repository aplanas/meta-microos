...
RPROVIDES:${PN} += "maven-script-interpreter mvn(org.apache.maven.shared:maven-script-interpreter) mvn(org.apache.maven.shared:maven-script-interpreter:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(commons-io:commons-io) mvn(org.apache-extras.beanshell:bsh) mvn(org.slf4j:slf4j-api)"
