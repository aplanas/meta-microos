...
RPROVIDES:${PN} += "tex(auto-pst-pdf-lua.sty) texlive-auto-pst-pdf-lua"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifluatex.sty) tex(ifpdf.sty) tex(ifplatform.sty) tex(pst-pdf.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-iftex texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
