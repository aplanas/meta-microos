...
RPROVIDES:${PN} += "buildstream python3.10dist(buildstream) python3dist(buildstream)"
RDEPENDS:${PN} += "/usr/bin/python3 bubblewrap python(abi) python3-base python3-click python3-gobject python3-grpcio python3-psutil python3-ruamel.yaml typelib-1_0-OSTree-1_0"
