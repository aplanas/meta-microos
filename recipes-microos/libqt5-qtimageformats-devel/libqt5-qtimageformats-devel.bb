...
RPROVIDES:${PN} += "libqt5-qtimageformats-devel libqt5-qtimageformats-devel(aarch-64)"
RDEPENDS:${PN} += "libmng-devel libqt5-qtimageformats libtiff-devel pkgconfig(Qt5Gui) pkgconfig(libwebp)"
