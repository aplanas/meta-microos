...
RPROVIDES:${PN} += "tex(embedall.sty) texlive-embedall"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(currfile.sty) tex(embedfile.sty) tex(etoolbox.sty) tex(filehook.sty) tex(letltxmacro.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
