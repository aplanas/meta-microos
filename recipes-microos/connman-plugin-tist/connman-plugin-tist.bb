...
RPROVIDES:${PN} += "connman-plugin-tist connman-plugin-tist(aarch-64)"
RDEPENDS:${PN} += "connman ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit)"
