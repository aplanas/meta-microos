...
RPROVIDES:${PN} += "foliate-lang foliate-lang-all locale(foliate:cs) locale(foliate:de) locale(foliate:es) locale(foliate:eu) locale(foliate:fr) locale(foliate:id) locale(foliate:it) locale(foliate:ko) locale(foliate:nb) locale(foliate:nl) locale(foliate:nn) locale(foliate:pt_BR) locale(foliate:ru) locale(foliate:sv) locale(foliate:uk) locale(foliate:zh_CN) locale(foliate:zh_TW)"
RDEPENDS:${PN} += "foliate"
