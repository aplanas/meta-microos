...
RPROVIDES:${PN} += "ant-jakartamail config(ant-jakartamail) mvn(org.apache.ant:ant-jakartamail) mvn(org.apache.ant:ant-jakartamail:pom:)"
RDEPENDS:${PN} += "ant jakarta-mail java-headless javapackages-filesystem mvn(com.sun.mail:jakarta.mail) mvn(org.apache.ant:ant)"
