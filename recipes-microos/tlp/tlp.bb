...
RPROVIDES:${PN} += "config(tlp) metainfo() metainfo(de.linrunner.tlp.metainfo.xml) tlp"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl hdparm iw pciutils rfkill systemd usbutils util-linux"
