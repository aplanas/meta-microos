...
RPROVIDES:${PN} += "config(grommunio-web) grommunio-web"
RDEPENDS:${PN} += "/bin/sh /usr/bin/env gromox mapi-header-php php8-bcmath php8-ctype php8-curl php8-gd php8-gettext php8-iconv php8-mbstring php8-openssl php8-sodium php8-sqlite php8-sysvshm php8-zip php8-zlib user(groweb)"
