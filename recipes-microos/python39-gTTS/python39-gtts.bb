...
RPROVIDES:${PN} += "python3.9dist(gtts) python39-gTTS python3dist(gtts)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-beautifulsoup4 python39-click python39-gTTS-token python39-requests python39-setuptools python39-six update-alternatives"
