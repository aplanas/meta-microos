...
RPROVIDES:${PN} += "vtk-openmpi2-devel:/usr/lib64/mpi/gcc/openmpi2/lib64//libvtkJava.so vtk-openmpi2-java-devel vtk-openmpi2-java-devel(aarch-64)"
RDEPENDS:${PN} += "java-devel vtk-openmpi2-devel vtk-openmpi2-java"
