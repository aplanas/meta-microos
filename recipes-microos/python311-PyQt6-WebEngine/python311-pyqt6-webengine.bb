...
RPROVIDES:${PN} += "python3.11dist(pyqt6-webengine) python311-PyQt6-WebEngine python311-PyQt6-WebEngine(aarch-64) python311-qtwebengine-qt6 python3dist(pyqt6-webengine)"
