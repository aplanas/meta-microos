...
RPROVIDES:${PN} += "tex(autopdf.sty) texlive-autopdf"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(ifpdf.sty) tex(ifplatform.sty) tex(ifthen.sty) tex(keyval.sty) tex(psfrag.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
