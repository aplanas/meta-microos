...
RPROVIDES:${PN} += "perl(MooseX::ConfigFromFile) perl-MooseX-ConfigFromFile"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Moose::Role) perl(MooseX::Types::Moose) perl(MooseX::Types::Path::Tiny) perl(namespace::autoclean)"
