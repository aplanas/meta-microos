...
RPROVIDES:${PN} += "python3.9dist(pweave) python39-Pweave python3dist(pweave)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Markdown python39-Pygments python39-certifi python39-jupyter_client python39-jupyter_ipykernel python39-jupyter_ipython python39-jupyter_nbconvert python39-jupyter_nbformat"
