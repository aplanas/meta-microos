...
RPROVIDES:${PN} += "pkgconfig(umockdev-1.0) umockdev-devel umockdev-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libumockdev-preload0 libumockdev0 pkgconfig(glib-2.0) pkgconfig(gobject-2.0) typelib-1_0-UMockdev-1_0 umockdev"
