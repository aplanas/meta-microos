...
RPROVIDES:${PN} += "calcurse-lang calcurse-lang-all locale(calcurse:de) locale(calcurse:en_US) locale(calcurse:es) locale(calcurse:fr) locale(calcurse:nl) locale(calcurse:pt_BR) locale(calcurse:ru)"
