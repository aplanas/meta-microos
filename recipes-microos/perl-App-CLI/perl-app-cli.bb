...
RPROVIDES:${PN} += "perl(App::CLI) perl(App::CLI::Command) perl(App::CLI::Command::Commands) perl(App::CLI::Command::Help) perl(App::CLI::Command::Version) perl(App::CLI::Helper) perl-App-CLI"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Capture::Tiny) perl(Class::Load) perl(Locale::Maketext::Simple) perl(Pod::Simple::Text)"
