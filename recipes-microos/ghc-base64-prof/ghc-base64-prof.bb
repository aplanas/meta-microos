...
RPROVIDES:${PN} += "ghc-base64-prof ghc-base64-prof(aarch-64) ghc-prof(base64-0.4.2.4-A6ZHULO0U6jEqaRLwqb1vV)"
RDEPENDS:${PN} += "ghc-base64-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(text-2.0.2) ghc-prof(text-short-0.1.5-82jy4M6AvoMDwlCMY2Ykx2)"
