...
RPROVIDES:${PN} += "python39-matplotlib-qt-shared python39-matplotlib-qt5 python39-matplotlib-qt5(aarch-64)"
RDEPENDS:${PN} += "python(abi) python39-matplotlib python39-qt5"
