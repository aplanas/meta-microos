...
RPROVIDES:${PN} += "libnma-gtk4-devel libnma-gtk4-devel(aarch-64) pkgconfig(libnma-gtk4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnma-devel libnma-gtk4-0 pkgconfig(libnm) typelib-1_0-NMA4-1_0"
