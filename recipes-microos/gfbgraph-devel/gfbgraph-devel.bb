...
RPROVIDES:${PN} += "gfbgraph-devel gfbgraph-devel(aarch-64) pkgconfig(libgfbgraph-0.2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgfbgraph-0_2-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(goa-1.0) pkgconfig(json-glib-1.0) pkgconfig(libsoup-2.4) pkgconfig(rest-0.7) typelib-1_0-GFBGraph-0_2"
