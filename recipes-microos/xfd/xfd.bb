...
RPROVIDES:${PN} += "xfd xfd(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libXaw.so.7()(64bit) libXft.so.2()(64bit) libXmu.so.6()(64bit) libXrender.so.1()(64bit) libXt.so.6()(64bit) libc.so.6(GLIBC_2.34)(64bit) libfontconfig.so.1()(64bit) libxkbfile.so.1()(64bit)"
