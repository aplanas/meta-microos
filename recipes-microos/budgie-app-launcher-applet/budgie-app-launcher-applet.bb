...
RPROVIDES:${PN} += "budgie-app-launcher-applet budgie-app-launcher-applet(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 python3-gobject-Gdk typelib(Budgie) typelib(GMenu) typelib(GObject) typelib(Gdk) typelib(Gtk)"
