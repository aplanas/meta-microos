...
RPROVIDES:${PN} += "python3.9dist(sphinx-tabs) python39-sphinx-tabs python3dist(sphinx-tabs)"
RDEPENDS:${PN} += "python(abi) python39-Pygments python39-Sphinx python39-docutils"
