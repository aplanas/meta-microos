...
RPROVIDES:${PN} += "tex(tikz-bagua.sty) texlive-tikz-bagua"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(bitset.sty) tex(tikz.sty) tex(xintexpr.sty) tex(xparse.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
