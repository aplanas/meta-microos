...
RPROVIDES:${PN} += "python3.11dist(jupyter-contrib-core) python311-jupyter-contrib-core python311-jupyter_contrib_core python3dist(jupyter-contrib-core)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-jupyter-core python311-notebook python311-setuptools python311-tornado python311-traitlets update-alternatives"
