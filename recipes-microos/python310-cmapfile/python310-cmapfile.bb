...
RPROVIDES:${PN} += "python3-cmapfile python3.10dist(cmapfile) python310-cmapfile python3dist(cmapfile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-h5py python310-numpy python310-oiffile python310-scipy python310-tifffile update-alternatives"
