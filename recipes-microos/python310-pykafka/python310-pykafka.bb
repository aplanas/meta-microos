...
RPROVIDES:${PN} += "python3-pykafka python3.10dist(pykafka) python310-pykafka python310-pykafka(aarch-64) python3dist(pykafka)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-gevent python310-kazoo python310-setuptools python310-six python310-tabulate"
