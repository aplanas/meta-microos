...
RPROVIDES:${PN} += "python3.9dist(setuptools-rust) python39-setuptools-rust python3dist(setuptools-rust)"
RDEPENDS:${PN} += "cargo python(abi) python39-semantic_version python39-setuptools python39-typing_extensions rust"
