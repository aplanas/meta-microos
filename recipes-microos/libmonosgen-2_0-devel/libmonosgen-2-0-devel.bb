...
RPROVIDES:${PN} += "libmonosgen-2_0-devel libmonosgen-2_0-devel(aarch-64) pkgconfig(monosgen-2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmono-2_0-devel libmonosgen-2_0-1 mono-core"
