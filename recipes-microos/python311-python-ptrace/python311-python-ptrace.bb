...
RPROVIDES:${PN} += "python3.11dist(cptrace) python3.11dist(python-ptrace) python311-python-ptrace python311-python-ptrace(aarch-64) python3dist(cptrace) python3dist(python-ptrace)"
