...
RPROVIDES:${PN} += "perl(DBIx::Simple) perl(DBIx::Simple::DeadObject) perl(DBIx::Simple::Dummy) perl(DBIx::Simple::Result) perl(DBIx::Simple::Result::RowObject) perl(DBIx::Simple::Statement) perl-DBIx-Simple"
