...
RPROVIDES:${PN} += "tex(calctab.sty) texlive-calctab"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(alphalph.sty) tex(booktabs.sty) tex(eurosym.sty) tex(fltpoint.sty) tex(ifthen.sty) tex(numprint.sty) tex(xcolor.sty) tex(xkeyval.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
