...
RPROVIDES:${PN} += "python3.11dist(helpdev) python311-helpdev python3dist(helpdev)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-importlib-metadata python311-psutil update-alternatives"
