...
RPROVIDES:${PN} += "libgepub-devel libgepub-devel(aarch-64) pkgconfig(libgepub-0.7)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgepub-0_7-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libarchive) pkgconfig(libsoup-3.0) pkgconfig(libxml-2.0) pkgconfig(webkit2gtk-4.1) typelib-1_0-Gepub-0_7"
