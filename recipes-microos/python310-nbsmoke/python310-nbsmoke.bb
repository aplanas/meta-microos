...
RPROVIDES:${PN} += "jupyter-nbsmoke python3-jupyter_nbsmoke python3-nbsmoke python3.10dist(nbsmoke) python310-jupyter_nbsmoke python310-nbsmoke python3dist(nbsmoke)"
RDEPENDS:${PN} += "python(abi) python310-ipykernel python310-jupyter-client python310-nbconvert python310-nbformat python310-param python310-pyflakes python310-pytest"
