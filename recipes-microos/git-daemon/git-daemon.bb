...
RPROVIDES:${PN} += "git-daemon git-daemon(aarch-64) group(git-daemon) user(git-daemon)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/touch bash fillup git-core ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpcre2-8.so.0()(64bit) libsha1detectcoll.so.1()(64bit) libz.so.1()(64bit) systemd sysuser-shadow"
