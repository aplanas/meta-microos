...
RPROVIDES:${PN} += "mvn(ml.dmlc:xgboost-jvm:pom:) mvn(ml.dmlc:xgboost4j) mvn(ml.dmlc:xgboost4j:pom:) xgboost xgboost(aarch-64)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.esotericsoftware.kryo:kryo) mvn(com.typesafe.akka:akka-actor_2.10) mvn(commons-logging:commons-logging) mvn(org.scala-lang:scala-compiler) mvn(org.scala-lang:scala-library) mvn(org.scala-lang:scala-reflect)"
