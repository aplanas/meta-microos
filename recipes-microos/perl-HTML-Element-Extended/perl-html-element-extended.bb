...
RPROVIDES:${PN} += "perl(HTML::ElementGlob) perl(HTML::ElementRaw) perl(HTML::ElementSuper) perl(HTML::ElementSuper::ContentWatchdog) perl(HTML::ElementTable) perl(HTML::ElementTable::DataElement) perl(HTML::ElementTable::Element) perl(HTML::ElementTable::HeaderElement) perl(HTML::ElementTable::RowElement) perl(HTML::ElementTable::RowGlob) perl-HTML-Element-Extended"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Data::Dumper) perl(HTML::Element)"
