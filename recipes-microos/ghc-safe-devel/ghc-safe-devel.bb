...
RPROVIDES:${PN} += "ghc-devel(safe-0.3.19-3Ab0OpSRliCKMhc0t4Nhds) ghc-safe-devel ghc-safe-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-safe"
