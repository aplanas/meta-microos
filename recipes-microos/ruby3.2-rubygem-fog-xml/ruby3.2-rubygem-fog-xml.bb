...
RPROVIDES:${PN} += "ruby3.2-rubygem-fog-xml ruby3.2-rubygem-fog-xml(aarch-64) rubygem(fog-xml) rubygem(ruby:3.2.0:fog-xml) rubygem(ruby:3.2.0:fog-xml:0) rubygem(ruby:3.2.0:fog-xml:0.1) rubygem(ruby:3.2.0:fog-xml:0.1.4)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:fog-core) rubygem(ruby:3.2.0:nokogiri)"
