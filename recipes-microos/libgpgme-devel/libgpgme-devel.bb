...
RPROVIDES:${PN} += "gpgme-devel libgpgme-devel libgpgme-devel(aarch-64) pkgconfig(gpgme) pkgconfig(gpgme-glib)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config glibc-devel libassuan-devel libgpg-error-devel libgpgme11 pkgconfig(glib-2.0) pkgconfig(gpg-error) pkgconfig(libassuan)"
