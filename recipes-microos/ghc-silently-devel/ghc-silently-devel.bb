...
RPROVIDES:${PN} += "ghc-devel(silently-1.2.5.3-HiTtkArMijI9DvRcUmgkYR) ghc-silently-devel ghc-silently-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(directory-1.3.7.1) ghc-silently"
