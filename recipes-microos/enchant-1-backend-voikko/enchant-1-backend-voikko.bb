...
RPROVIDES:${PN} += "enchant-1-backend enchant-1-backend-voikko enchant-1-backend-voikko(aarch-64) libenchant_voikko.so()(64bit) locale(enchant-1:fi)"
RDEPENDS:${PN} += "enchant-1-backends ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libenchant.so.1()(64bit) libglib-2.0.so.0()(64bit) libvoikko.so.1()(64bit)"
