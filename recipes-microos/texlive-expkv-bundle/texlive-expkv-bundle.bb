...
RPROVIDES:${PN} += "tex(expkv-cs.sty) tex(expkv-cs.tex) tex(expkv-def.sty) tex(expkv-def.tex) tex(expkv-opt-2020-10-10.sty) tex(expkv-opt.sty) tex(expkv-pop.sty) tex(expkv-pop.tex) tex(expkv.sty) tex(expkv.tex) tex(t-expkv-cs.tex) tex(t-expkv-def.tex) tex(t-expkv-pop.tex) tex(t-expkv.tex) texlive-expkv-bundle"
