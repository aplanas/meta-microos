...
RPROVIDES:${PN} += "pkgconfig(libpragha) pragha-plugins-devel pragha-plugins-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig(gio-2.0) pkgconfig(gstreamer-1.0) pkgconfig(gstreamer-base-1.0) pkgconfig(gtk+-3.0) pkgconfig(libpeas-1.0) pkgconfig(libpeas-gtk-1.0) pkgconfig(taglib_c)"
