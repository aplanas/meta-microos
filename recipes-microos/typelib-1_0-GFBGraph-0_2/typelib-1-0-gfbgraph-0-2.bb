...
RPROVIDES:${PN} += "typelib(GFBGraph) typelib-1_0-GFBGraph-0_2 typelib-1_0-GFBGraph-0_2(aarch-64)"
RDEPENDS:${PN} += "libgfbgraph-0.2.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Json) typelib(Rest) typelib(Soup)"
