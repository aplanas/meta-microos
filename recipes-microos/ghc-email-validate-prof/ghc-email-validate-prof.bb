...
RPROVIDES:${PN} += "ghc-email-validate-prof ghc-email-validate-prof(aarch-64) ghc-prof(email-validate-2.3.2.18-8MZFHS3GPuQLNTYP4EPLHD)"
RDEPENDS:${PN} += "ghc-email-validate-devel ghc-prof(attoparsec-0.14.4-21v4nlnPs0qLZ5R1FIK9u3) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(template-haskell-2.19.0.0)"
