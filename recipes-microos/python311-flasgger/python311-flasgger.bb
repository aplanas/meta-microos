...
RPROVIDES:${PN} += "python3.11dist(flasgger) python311-flasgger python3dist(flasgger)"
RDEPENDS:${PN} += "python(abi) python311-Flask python311-PyYAML python311-jsonschema python311-mistune python311-six"
