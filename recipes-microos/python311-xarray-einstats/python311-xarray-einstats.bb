...
RPROVIDES:${PN} += "python3.11dist(xarray-einstats) python311-xarray-einstats python3dist(xarray-einstats)"
RDEPENDS:${PN} += "python(abi) python311-numpy python311-scipy python311-xarray"
