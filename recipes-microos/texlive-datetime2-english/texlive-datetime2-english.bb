...
RPROVIDES:${PN} += "tex(datetime2-en-AU.ldf) tex(datetime2-en-CA.ldf) tex(datetime2-en-GB.ldf) tex(datetime2-en-GG.ldf) tex(datetime2-en-IE.ldf) tex(datetime2-en-IM.ldf) tex(datetime2-en-JE.ldf) tex(datetime2-en-MT.ldf) tex(datetime2-en-NZ.ldf) tex(datetime2-en-US.ldf) tex(datetime2-english-base.ldf) tex(datetime2-english.ldf) texlive-datetime2-english"
