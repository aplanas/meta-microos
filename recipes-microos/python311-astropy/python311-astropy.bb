...
RPROVIDES:${PN} += "python3.11dist(astropy) python311-astropy python311-astropy(aarch-64) python3dist(astropy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcfitsio.so.10()(64bit) libexpat.so.1()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libwcs.so.7()(64bit) python(abi) python311-PyYAML python311-dbm python311-numpy python311-packaging python311-pyerfa update-alternatives"
