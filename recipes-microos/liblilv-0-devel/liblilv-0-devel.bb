...
RPROVIDES:${PN} += "liblilv-0-devel liblilv-0-devel(aarch-64) pkgconfig(lilv-0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblilv-0-0 pkgconfig(lv2) pkgconfig(serd-0) pkgconfig(sord-0) pkgconfig(sratom-0)"
