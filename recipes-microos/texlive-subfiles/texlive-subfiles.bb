...
RPROVIDES:${PN} += "tex(subfiles.cls) tex(subfiles.sty) texlive-subfiles"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(import.sty) tex(xpatch.sty) texlive texlive-filesystem texlive-import texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
