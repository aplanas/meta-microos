...
RPROVIDES:${PN} += "tex(getfiledate.sty) texlive-getfiledate"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(boxedminipage.sty) tex(etextools.sty) tex(ltxnew.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
