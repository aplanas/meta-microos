...
RPROVIDES:${PN} += "python3.9dist(mysql-to-sqlite3) python39-mysql-to-sqlite3 python3dist(mysql-to-sqlite3)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-click python39-mysql-connector-python python39-python-slugify python39-pytimeparse python39-simplejson python39-six python39-tabulate python39-tqdm"
