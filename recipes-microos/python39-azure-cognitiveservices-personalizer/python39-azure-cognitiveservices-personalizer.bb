...
RPROVIDES:${PN} += "python3.9dist(azure-cognitiveservices-personalizer) python39-azure-cognitiveservices-personalizer python3dist(azure-cognitiveservices-personalizer)"
