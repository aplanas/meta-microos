...
RPROVIDES:${PN} += "auto-value mvn(com.google.auto.value:auto-value) mvn(com.google.auto.value:auto-value:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.google.auto:auto-common) mvn(com.google.guava:guava) mvn(com.squareup:javapoet)"
