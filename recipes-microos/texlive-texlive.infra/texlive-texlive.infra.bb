...
RPROVIDES:${PN} += "perl(TeXLive::TLConfFile) perl(TeXLive::TLConfig) perl(TeXLive::TLCrypto) perl(TeXLive::TLPDB) perl(TeXLive::TLPOBJ) perl(TeXLive::TLPSRC) perl(TeXLive::TLPaper) perl(TeXLive::TLTREE) perl(TeXLive::TLUtils) perl(TeXLive::TLWinGoo) perl(TeXLive::TeXCatalogue) perl(TeXLive::TeXCatalogue::Entry) tex(fmtutil-hdr.cnf) tex(updmap-hdr.cfg) texlive-texlive.infra"
