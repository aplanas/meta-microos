...
RPROVIDES:${PN} += "python3-libmodulemd python3-libmodulemd(aarch-64)"
RDEPENDS:${PN} += "python(abi) python3-gobject python3-six typelib(GLib) typelib(Modulemd) typelib-1_0-Modulemd-2_0(aarch-64)"
