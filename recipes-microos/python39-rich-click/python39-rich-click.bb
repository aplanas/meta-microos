...
RPROVIDES:${PN} += "python3.9dist(rich-click) python39-rich-click python3dist(rich-click)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-click python39-rich"
