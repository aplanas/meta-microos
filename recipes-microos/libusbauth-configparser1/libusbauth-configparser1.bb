...
RPROVIDES:${PN} += "libusbauth-configparser.so.1()(64bit) libusbauth-configparser1 libusbauth-configparser1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libudev.so.1()(64bit) libudev.so.1(LIBUDEV_183)(64bit)"
