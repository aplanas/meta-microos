...
RPROVIDES:${PN} += "tex(scsnowman-normal.def) tex(scsnowman.sty) tex(sctkzsym-base.sty) texlive-scsnowman"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(keyval.sty) tex(pxeveryshi.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
