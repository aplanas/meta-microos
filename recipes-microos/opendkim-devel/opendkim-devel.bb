...
RPROVIDES:${PN} += "opendkim-devel opendkim-devel(aarch-64) pkgconfig(opendkim) pkgconfig(rbl) pkgconfig(repute) pkgconfig(ut) pkgconfig(vbr)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libopendkim11 librbl1 librepute1 libut1 libvbr2 opendkim"
