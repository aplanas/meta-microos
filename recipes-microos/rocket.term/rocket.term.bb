...
RPROVIDES:${PN} += "python3.10dist(rocket.term) python3dist(rocket.term) rocket.term"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-requests python3-urwid python3-websocket-client"
