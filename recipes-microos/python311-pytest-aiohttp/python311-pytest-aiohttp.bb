...
RPROVIDES:${PN} += "python3.11dist(pytest-aiohttp) python311-pytest-aiohttp python3dist(pytest-aiohttp)"
RDEPENDS:${PN} += "python(abi) python311-aiohttp python311-pytest python311-pytest-asyncio"
