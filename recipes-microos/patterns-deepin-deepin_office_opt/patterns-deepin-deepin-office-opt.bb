...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-deepin-deepin_office_opt patterns-deepin-deepin_office_opt(aarch-64)"
RDEPENDS:${PN} += "pattern()"
