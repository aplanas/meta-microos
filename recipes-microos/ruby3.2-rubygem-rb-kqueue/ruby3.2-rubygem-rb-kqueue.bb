...
RPROVIDES:${PN} += "ruby3.2-rubygem-rb-kqueue ruby3.2-rubygem-rb-kqueue(aarch-64) rubygem(rb-kqueue) rubygem(ruby:3.2.0:rb-kqueue) rubygem(ruby:3.2.0:rb-kqueue:0) rubygem(ruby:3.2.0:rb-kqueue:0.2) rubygem(ruby:3.2.0:rb-kqueue:0.2.8)"
