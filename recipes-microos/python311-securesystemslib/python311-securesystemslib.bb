...
RPROVIDES:${PN} += "python3.11dist(securesystemslib) python311-securesystemslib python3dist(securesystemslib)"
RDEPENDS:${PN} += "python(abi) python311-PyNaCl python311-asn1crypto python311-colorama python311-cryptography"
