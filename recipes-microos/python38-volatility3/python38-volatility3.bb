...
RPROVIDES:${PN} += "python3.10dist(volatility3) python38-volatility python38-volatility3 python3dist(volatility3) volatility volatility3"
RDEPENDS:${PN} += "/usr/bin/python3 capstone python(abi) python3-distorm3 python3-pefile python3-pycryptodome python3-yara"
