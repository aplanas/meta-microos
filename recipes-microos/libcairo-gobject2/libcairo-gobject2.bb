...
RPROVIDES:${PN} += "libcairo-gobject.so.2()(64bit) libcairo-gobject2 libcairo-gobject2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libcairo.so.2()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit)"
