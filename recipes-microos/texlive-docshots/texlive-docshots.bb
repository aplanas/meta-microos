...
RPROVIDES:${PN} += "tex(docshots.sty) texlive-docshots"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fancyvrb.sty) tex(graphicx.sty) tex(iexec.sty) tex(ifluatex.sty) tex(ifxetex.sty) tex(pdftexcmds.sty) tex(pgfopts.sty) tex(tikz.sty) tex(xcolor.sty) texlive texlive-fancyvrb texlive-filesystem texlive-iexec texlive-kpathsea texlive-kpathsea-bin texlive-pdfcrop texlive-pgf texlive-pgf-blur texlive-scripts texlive-scripts-bin"
