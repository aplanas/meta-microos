...
RPROVIDES:${PN} += "python3.11dist(aiosmtpd) python311-aiosmtpd python3dist(aiosmtpd)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-atpublic python311-attrs update-alternatives user(nobody)"
