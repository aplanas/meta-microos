...
RPROVIDES:${PN} += "libOgreProperty-devel libOgreProperty-devel(aarch-64) pkgconfig(OGRE-Property)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libOgreProperty13_5 pkgconfig(OGRE)"
