...
RPROVIDES:${PN} += "python3.9dist(imageio) python39-imageio python3dist(imageio)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Pillow python39-numpy update-alternatives"
