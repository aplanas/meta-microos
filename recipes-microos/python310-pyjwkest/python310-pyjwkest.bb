...
RPROVIDES:${PN} += "python3-pyjwkest python3.10dist(pyjwkest) python310-pyjwkest python3dist(pyjwkest)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-future python310-pycryptodomex python310-requests python310-six update-alternatives"
