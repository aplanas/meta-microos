...
RPROVIDES:${PN} += "librasqal-devel librasqal-devel(aarch-64) pkgconfig(rasqal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libraptor-devel librasqal3 pkgconfig(raptor2)"
