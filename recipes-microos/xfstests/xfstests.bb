...
RPROVIDES:${PN} += "xfstests xfstests(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/perl acl attr bash bc bind-utils btrfsprogs coreutils device-mapper duperemove e2fsprogs keyutils ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libacl.so.1()(64bit) libacl.so.1(ACL_1.0)(64bit) libaio.so.1()(64bit) libaio.so.1(LIBAIO_0.1)(64bit) libaio.so.1(LIBAIO_0.4)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcap-progs libgdbm_compat.so.4()(64bit) libhandle.so.1()(64bit) libhandle.so.1(LIBHANDLE_1.0.3)(64bit) libuuid.so.1()(64bit) libuuid.so.1(UUID_1.0)(64bit) lvm perl quota xfsdump xfsprogs xz"
