...
RPROVIDES:${PN} += "python3.11dist(orange-canvas-core) python311-orange-canvas-core python3dist(orange-canvas-core)"
RDEPENDS:${PN} += "python(abi) python311-AnyQt python311-CacheControl python311-commonmark python311-dictdiffer python311-docutils python311-qt5 python311-requests"
