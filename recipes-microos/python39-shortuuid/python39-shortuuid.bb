...
RPROVIDES:${PN} += "python3.9dist(shortuuid) python39-shortuuid python3dist(shortuuid)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-base update-alternatives"
