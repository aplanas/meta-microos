...
RPROVIDES:${PN} += "gasket-driver-kmp gasket-driver-kmp-default gasket-driver-kmp-default(aarch-64) gasket-driver-kmp-default-k6.3.4_1 kmod(apex.ko) kmod(gasket.ko) multiversion(kernel)"
RDEPENDS:${PN} += "/bin/sh coreutils gasket-driver-ueficert grep kernel-default kernel-uname-r suse-kernel-rpm-scriptlets"
