...
RPROVIDES:${PN} += "python3-azure-mgmt-sqlvirtualmachine python3.10dist(azure-mgmt-sqlvirtualmachine) python310-azure-mgmt-sqlvirtualmachine python3dist(azure-mgmt-sqlvirtualmachine)"
