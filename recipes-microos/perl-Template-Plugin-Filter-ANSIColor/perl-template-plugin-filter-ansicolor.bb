...
RPROVIDES:${PN} += "perl(Template::Plugin::Filter::ANSIColor) perl-Template-Plugin-Filter-ANSIColor"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Template) perl(Term::ANSIColor) perl(Term::Terminfo)"
