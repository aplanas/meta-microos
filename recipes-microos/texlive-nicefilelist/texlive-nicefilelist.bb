...
RPROVIDES:${PN} += "tex(nicefilelist.sty) texlive-nicefilelist"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(hardwrap.sty) tex(monofill.sty) tex(myfilist.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
