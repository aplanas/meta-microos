...
RPROVIDES:${PN} += "tex(skt.map) texlive-sanskrit-t1"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-sanskrit-t1-fonts texlive-scripts texlive-scripts-bin"
