...
RPROVIDES:${PN} += "tex(avery5371.cfg) tex(avery5388.cfg) tex(flashcards.cls) texlive-flashcards"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(geometry.sty) tex(ifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
