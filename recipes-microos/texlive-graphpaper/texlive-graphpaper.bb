...
RPROVIDES:${PN} += "tex(graphpaper.cls) texlive-graphpaper"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(euclideangeometry.sty) tex(geometry.sty) tex(graphicx.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
