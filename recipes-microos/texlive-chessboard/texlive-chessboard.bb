...
RPROVIDES:${PN} += "tex(UF-chessboard-documentation.sty) tex(chessboard-keys-main.sty) tex(chessboard-keys-pgf.sty) tex(chessboard-pgf.sty) tex(chessboard.sty) texlive-chessboard"
