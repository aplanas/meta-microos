...
RPROVIDES:${PN} += "ghc-distributive-prof ghc-distributive-prof(aarch-64) ghc-prof(distributive-0.6.2.1-GisXwtVaDTaDcC79Nunm79)"
RDEPENDS:${PN} += "ghc-distributive-devel ghc-prof(base-4.17.1.0) ghc-prof(base-orphans-0.8.8.2-Hl8yFKsRlc4HPNXP65SlX8) ghc-prof(tagged-0.8.7-CYOhX22Df3PFW5V1S0dOJa) ghc-prof(transformers-0.5.6.2)"
