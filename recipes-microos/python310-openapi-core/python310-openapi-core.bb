...
RPROVIDES:${PN} += "python3-openapi-core python3.10dist(openapi-core) python310-openapi-core python3dist(openapi-core)"
RDEPENDS:${PN} += "python(abi) python310-Werkzeug python310-isodate python310-jsonschema-spec python310-more-itertools python310-openapi-schema-validator python310-openapi-spec-validator python310-parse python310-pathable python310-typing-extensions"
