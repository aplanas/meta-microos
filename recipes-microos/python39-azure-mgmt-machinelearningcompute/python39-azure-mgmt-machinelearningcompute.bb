...
RPROVIDES:${PN} += "python3.9dist(azure-mgmt-machinelearningcompute) python39-azure-mgmt-machinelearningcompute python3dist(azure-mgmt-machinelearningcompute)"
RDEPENDS:${PN} += "python(abi) python39-azure-common python39-azure-mgmt-nspkg python39-azure-nspkg python39-msrestazure"
