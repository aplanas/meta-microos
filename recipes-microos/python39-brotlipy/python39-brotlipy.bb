...
RPROVIDES:${PN} += "python3.9dist(brotlipy) python39-brotlipy python39-brotlipy(aarch-64) python3dist(brotlipy)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbrotlidec.so.1()(64bit) libbrotlienc.so.1()(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-cffi"
