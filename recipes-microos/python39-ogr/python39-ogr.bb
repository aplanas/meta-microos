...
RPROVIDES:${PN} += "python3.9dist(ogr) python39-ogr python3dist(ogr)"
RDEPENDS:${PN} += "python(abi) python39-Deprecated python39-GitPython python39-PyGithub python39-PyYAML python39-cryptography python39-python-gitlab python39-requests"
