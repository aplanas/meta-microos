...
RPROVIDES:${PN} += "tex(chem-acs.bbx) tex(chem-acs.cbx) tex(chem-angew.bbx) tex(chem-angew.cbx) tex(chem-biochem.bbx) tex(chem-biochem.cbx) tex(chem-rsc.bbx) tex(chem-rsc.cbx) texlive-biblatex-chem"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(numeric-comp.bbx) tex(numeric-comp.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
