...
RPROVIDES:${PN} += "python3-azure-mgmt-deviceupdate python3.10dist(azure-mgmt-deviceupdate) python310-azure-mgmt-deviceupdate python3dist(azure-mgmt-deviceupdate)"
