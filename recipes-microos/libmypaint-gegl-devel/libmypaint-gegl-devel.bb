...
RPROVIDES:${PN} += "libmypaint-gegl-devel libmypaint-gegl-devel(aarch-64) pkgconfig(libmypaint-gegl)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmypaint-gegl0 libmypaint0 pkgconfig(gegl-0.4) pkgconfig(libmypaint)"
