...
RPROVIDES:${PN} += "config(git-buildpackage-common) git-buildpackage-common python3.10dist(gbp) python3dist(gbp)"
RDEPENDS:${PN} += "/usr/bin/python3 git-core man python(abi) python3-base python3-dateutil python3-setuptools"
