...
RPROVIDES:${PN} += "mvn(io.prometheus:simpleclient_jetty) mvn(io.prometheus:simpleclient_jetty:pom:) osgi(io.prometheus.simpleclient_jetty) prometheus-simpleclient-java-jetty"
