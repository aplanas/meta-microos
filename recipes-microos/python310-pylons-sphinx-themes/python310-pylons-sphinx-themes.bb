...
RPROVIDES:${PN} += "python3-pylons-sphinx-themes python3-pylons_sphinx_theme python3-pylons_theme_support python3.10dist(pylons-sphinx-themes) python310-pylons-sphinx-themes python310-pylons_sphinx_theme python310-pylons_theme_support python3dist(pylons-sphinx-themes)"
RDEPENDS:${PN} += "python(abi) python310-Pygments"
