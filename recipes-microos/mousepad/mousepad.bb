...
RPROVIDES:${PN} += "application() application(org.xfce.mousepad-settings.desktop) application(org.xfce.mousepad.desktop) libmousepad-plugin-gspell.so()(64bit) metainfo() metainfo(org.xfce.mousepad.appdata.xml) mimehandler(application/x-zerosize) mimehandler(text/plain) mousepad mousepad(aarch-64)"
