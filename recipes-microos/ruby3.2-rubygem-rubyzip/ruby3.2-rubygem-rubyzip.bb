...
RPROVIDES:${PN} += "ruby3.2-rubygem-rubyzip ruby3.2-rubygem-rubyzip(aarch-64) rubygem(ruby:3.2.0:rubyzip) rubygem(ruby:3.2.0:rubyzip:2) rubygem(ruby:3.2.0:rubyzip:2.3) rubygem(ruby:3.2.0:rubyzip:2.3.2) rubygem(rubyzip)"
