...
RPROVIDES:${PN} += "python3.9dist(pypi-search) python39-pypi-search python3dist(pypi-search)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-beautifulsoup4 python39-html2text python39-requests update-alternatives"
