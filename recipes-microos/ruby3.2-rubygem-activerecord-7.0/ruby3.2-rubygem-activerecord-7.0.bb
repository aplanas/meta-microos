...
RPROVIDES:${PN} += "ruby3.2-rubygem-activerecord-7.0 ruby3.2-rubygem-activerecord-7.0(aarch-64) rubygem(activerecord) rubygem(ruby:3.2.0:activerecord) rubygem(ruby:3.2.0:activerecord:7) rubygem(ruby:3.2.0:activerecord:7.0) rubygem(ruby:3.2.0:activerecord:7.0.4)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:activemodel) rubygem(ruby:3.2.0:activesupport)"
