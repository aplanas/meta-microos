...
RPROVIDES:${PN} += "python3.9dist(pypyp) python39-pyp python3dist(pypyp)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-astunparse update-alternatives"
