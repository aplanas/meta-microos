...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-desktop-imaging patterns-desktop-imaging(aarch-64) patterns-openSUSE-imaging"
RDEPENDS:${PN} += "pattern()"
