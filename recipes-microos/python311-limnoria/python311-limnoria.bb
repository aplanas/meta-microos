...
RPROVIDES:${PN} += "Supybot python3.11dist(limnoria) python311-limnoria python3dist(limnoria)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 procps python(abi) python311 python311-PySocks python311-chardet python311-cryptography python311-ecdsa python311-feedparser python311-python-dateutil python311-python-gnupg python311-pytzdata update-alternatives"
