...
RPROVIDES:${PN} += "python3.9dist(platformio) python39-platformio python3dist(platformio)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-aiofiles python39-ajsonrpc python39-bottle python39-click python39-colorama python39-marshmallow python39-pyelftools python39-pyserial python39-requests python39-semantic_version python39-starlette python39-tabulate python39-uvicorn python39-wsproto python39-zeroconf update-alternatives"
