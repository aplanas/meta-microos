...
RPROVIDES:${PN} += "python3.9dist(sphinxcontrib-seqdiag) python39-sphinxcontrib-seqdiag python3dist(sphinxcontrib-seqdiag)"
RDEPENDS:${PN} += "python(abi) python39-Sphinx python39-blockdiag python39-seqdiag"
