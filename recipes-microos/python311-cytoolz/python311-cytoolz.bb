...
RPROVIDES:${PN} += "python3.11dist(cytoolz) python311-cytoolz python311-cytoolz(aarch-64) python3dist(cytoolz)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-toolz"
