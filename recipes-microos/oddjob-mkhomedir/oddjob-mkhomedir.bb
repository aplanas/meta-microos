...
RPROVIDES:${PN} += "config(oddjob-mkhomedir) oddjob-mkhomedir oddjob-mkhomedir(aarch-64)"
RDEPENDS:${PN} += "/bin/sh dbus-1 grep ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdbus-1.so.3()(64bit) libdbus-1.so.3(LIBDBUS_1_3)(64bit) libpam.so.0()(64bit) libpam.so.0(LIBPAM_1.0)(64bit) libselinux.so.1()(64bit) libselinux.so.1(LIBSELINUX_1.0)(64bit) oddjob psmisc sed"
