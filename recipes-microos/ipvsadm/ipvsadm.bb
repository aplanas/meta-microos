...
RPROVIDES:${PN} += "config(ipvsadm) ipvsadm ipvsadm(aarch-64) ipvsadm-1.31"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/mkdir /usr/bin/touch fillup grep ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libnl-3.so.200()(64bit) libnl-3.so.200(libnl_3)(64bit) libnl-genl-3.so.200()(64bit) libnl-genl-3.so.200(libnl_3)(64bit) libpopt.so.0()(64bit) libpopt.so.0(LIBPOPT_0)(64bit) systemd"
