...
RPROVIDES:${PN} += "tex(bxjsarticle.cls) tex(bxjsbook.cls) tex(bxjscjkcat.sty) tex(bxjscompat.sty) tex(bxjsja-minimal.def) tex(bxjsja-modern.def) tex(bxjsja-pandoc.def) tex(bxjsja-standard.def) tex(bxjspandoc.sty) tex(bxjsreport.cls) tex(bxjsslide.cls) texlive-bxjscls"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(babel.sty) tex(bxcalc.sty) tex(bxcjkjatype.sty) tex(bxghost.sty) tex(bxorigcapt.sty) tex(bxwareki.sty) tex(calc.sty) tex(etoolbox.sty) tex(filehook.sty) tex(fixltx2e.sty) tex(geometry.sty) tex(ifpdf.sty) tex(iftex.sty) tex(inputenc.sty) tex(jslogo.sty) tex(keyval.sty) tex(luatexja-fontspec.sty) tex(luatexja-preset.sty) tex(luatexja.sty) tex(pdftexcmds.sty) tex(plautopatch.sty) tex(polyglossia.sty) tex(pxbabel.sty) tex(pxchfon.sty) tex(pxjahyper-enc.sty) tex(t1enc.def) tex(type1cm.sty) tex(zxjafont.sty) tex(zxjatype.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
