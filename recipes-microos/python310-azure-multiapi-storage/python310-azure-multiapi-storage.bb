...
RPROVIDES:${PN} += "python3-azure-multiapi-storage python3.10dist(azure-multiapi-storage) python310-azure-multiapi-storage python3dist(azure-multiapi-storage)"
RDEPENDS:${PN} += "python(abi) python310-azure-common python310-azure-core python310-azure-nspkg python310-cryptography python310-msrest python310-python-dateutil python310-requests"
