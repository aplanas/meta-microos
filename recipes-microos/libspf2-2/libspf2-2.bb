...
RPROVIDES:${PN} += "libspf2-2 libspf2-2(aarch-64) libspf2.so.2()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libresolv.so.2()(64bit) libresolv.so.2(GLIBC_2.17)(64bit)"
