...
RPROVIDES:${PN} += "ghc-devel(magic-1.1-FZjtT3pxmlr6oRrs4QNuLe) ghc-magic-devel ghc-magic-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh file-devel ghc-compiler ghc-devel(base-4.17.1.0) ghc-magic"
