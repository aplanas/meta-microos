...
RPROVIDES:${PN} += "libgarcon-1-0 libgarcon-1-0(aarch-64) libgarcon-1.so.0()(64bit) libgarcon-gtk3-1.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig exo-tools ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgarcon-data libgdk-3.so.0()(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libxfce4ui-2.so.0()(64bit) libxfce4util.so.7()(64bit)"
