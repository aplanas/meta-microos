...
RPROVIDES:${PN} += "tex(parsa.sty) texlive-parsa"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(adjustbox.sty) tex(fancyhdr.sty) tex(float.sty) tex(graphicx.sty) tex(multirow.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
