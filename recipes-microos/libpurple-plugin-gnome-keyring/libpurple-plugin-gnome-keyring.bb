...
RPROVIDES:${PN} += "libpurple-plugin-gnome-keyring libpurple-plugin-gnome-keyring(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libsecret-1.so.0()(64bit)"
