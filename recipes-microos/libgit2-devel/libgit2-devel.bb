...
RPROVIDES:${PN} += "libgit2-devel libgit2-devel(aarch-64) pkgconfig(libgit2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgit2-1_6 pkgconfig(libpcre2-8) pkgconfig(openssl) pkgconfig(zlib)"
