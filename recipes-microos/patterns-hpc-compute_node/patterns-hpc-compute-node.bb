...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-visible() patterns-hpc-compute_node patterns-hpc-compute_node(aarch-64)"
RDEPENDS:${PN} += "iputils nfs-client openssh sudo"
