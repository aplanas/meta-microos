...
RPROVIDES:${PN} += "typelib(Farstream) typelib-1_0-Farstream-0_2 typelib-1_0-Farstream-0_2(aarch-64)"
RDEPENDS:${PN} += "libfarstream-0.2.so.5()(64bit) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gst)"
