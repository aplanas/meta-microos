...
RPROVIDES:${PN} += "python3.9dist(pandas-datareader) python39-pandas-datareader python3dist(pandas-datareader)"
RDEPENDS:${PN} += "python(abi) python39-lxml python39-pandas python39-requests"
