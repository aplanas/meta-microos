...
RPROVIDES:${PN} += "totem-plugin-gnome-dvb-daemon totem-plugin-gnome-dvb-daemon(aarch-64)"
RDEPENDS:${PN} += "python-gnome-dvb-daemon totem typelib(GLib) typelib(GObject) typelib(Gdk) typelib(Gio) typelib(Gtk) typelib(Peas) typelib(Totem)"
