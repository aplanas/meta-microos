...
RPROVIDES:${PN} += "config(shorewall6) shoreline_firewall shorewall6"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/touch /usr/sbin/service bc fillup iproute2 iptables logrotate perl-base shorewall-core systemd"
