...
RPROVIDES:${PN} += "python3.9dist(azure-ai-translation-nspkg) python39-azure-ai-translation-nspkg python3dist(azure-ai-translation-nspkg)"
RDEPENDS:${PN} += "python39-azure-ai-nspkg python39-azure-nspkg"
