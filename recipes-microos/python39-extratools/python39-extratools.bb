...
RPROVIDES:${PN} += "python3.9dist(extratools) python39-extratools python3dist(extratools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-RegexOrder python39-TagStats python39-sh python39-sortedcontainers python39-toolz update-alternatives"
