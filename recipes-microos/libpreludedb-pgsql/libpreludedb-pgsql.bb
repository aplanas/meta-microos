...
RPROVIDES:${PN} += "libpreludedb-pgsql libpreludedb-pgsql(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libpq.so.5()(64bit) libprelude.so.28()(64bit) libpreludedb-plugins libpreludedb.so.7()(64bit) postgresql-server"
