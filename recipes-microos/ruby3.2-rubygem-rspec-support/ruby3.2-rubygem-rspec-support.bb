...
RPROVIDES:${PN} += "ruby3.2-rubygem-rspec-support ruby3.2-rubygem-rspec-support(aarch-64) rubygem(rspec-support) rubygem(ruby:3.2.0:rspec-support) rubygem(ruby:3.2.0:rspec-support:3) rubygem(ruby:3.2.0:rspec-support:3.12) rubygem(ruby:3.2.0:rspec-support:3.12.0)"
