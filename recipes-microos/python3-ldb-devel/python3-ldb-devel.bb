...
RPROVIDES:${PN} += "pkgconfig(pyldb-util.cpython-310-aarch64-linux-gnu) python3-ldb-devel python3-ldb-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconf-pkg-config pkgconfig(ldb) python3-ldb"
