...
RPROVIDES:${PN} += "python3.11dist(language-check) python311-language-check python3dist(language-check)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/perl /usr/bin/python3 /usr/bin/python3.11 java python(abi) update-alternatives"
