...
RPROVIDES:${PN} += "tex(phfthm.sty) texlive-phfthm"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(aliascnt.sty) tex(amsmath.sty) tex(amssymb.sty) tex(amsthm.sty) tex(etoolbox.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
