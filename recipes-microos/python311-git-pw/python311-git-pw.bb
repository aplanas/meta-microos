...
RPROVIDES:${PN} += "git-pw python3.11dist(git-pw) python311-git-pw python3dist(git-pw)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 git-core python(abi) python311-arrow python311-click python311-pyaml python311-requests python311-tabulate update-alternatives"
