...
RPROVIDES:${PN} += "python3-azure-mgmt-azurestackhci python3.10dist(azure-mgmt-azurestackhci) python310-azure-mgmt-azurestackhci python3dist(azure-mgmt-azurestackhci)"
