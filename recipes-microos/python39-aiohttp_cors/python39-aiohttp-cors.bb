...
RPROVIDES:${PN} += "python3.9dist(aiohttp-cors) python39-aiohttp_cors python3dist(aiohttp-cors)"
RDEPENDS:${PN} += "python(abi) python39 python39-async_timeout python39-chardet python39-multidict python39-yarl"
