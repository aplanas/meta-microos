...
RPROVIDES:${PN} += "cunit-devel cunit-devel(aarch-64) pkgconfig(cunit)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcunit.so.1()(64bit) libcunit1 ncurses-devel pkgconf-pkg-config"
