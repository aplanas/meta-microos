...
RPROVIDES:${PN} += "python3.11dist(streamz) python311-streamz python3dist(streamz)"
RDEPENDS:${PN} += "python(abi) python311-setuptools python311-six python311-toolz python311-tornado python311-zict"
