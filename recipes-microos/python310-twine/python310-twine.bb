...
RPROVIDES:${PN} += "python3-twine python3.10dist(twine) python310-twine python3dist(twine)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-importlib-metadata python310-keyring python310-pkginfo python310-readme_renderer python310-requests python310-requests-toolbelt python310-rfc3986 python310-rich update-alternatives"
