...
RPROVIDES:${PN} += "tex(gaceta.cls) texlive-gaceta"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(amssymb.sty) tex(amsthm.sty) tex(article.cls) tex(babel.sty) tex(geometry.sty) tex(graphicx.sty) tex(url.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
