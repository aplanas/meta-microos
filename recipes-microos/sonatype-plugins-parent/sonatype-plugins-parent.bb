...
RPROVIDES:${PN} += "mvn(org.sonatype.plugins:plugins-parent:pom:) sonatype-plugins-parent"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.sonatype.forge:forge-parent:pom:)"
