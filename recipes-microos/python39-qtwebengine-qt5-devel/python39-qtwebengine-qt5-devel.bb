...
RPROVIDES:${PN} += "python-qtwebengine-qt5-sip python39-qtwebengine-qt5-api python39-qtwebengine-qt5-devel python39-qtwebengine-qt5-devel(aarch-64) python39-qtwebengine-qt5-sip"
