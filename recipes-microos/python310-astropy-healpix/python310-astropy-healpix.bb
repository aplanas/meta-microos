...
RPROVIDES:${PN} += "python3-astropy-healpix python3-astropy_healpix python3.10dist(astropy-healpix) python310-astropy-healpix python310-astropy-healpix(aarch-64) python310-astropy_healpix python3dist(astropy-healpix)"
