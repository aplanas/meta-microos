...
RPROVIDES:${PN} += "python3.9dist(httpolice) python39-HTTPolice python3dist(httpolice)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Brotli python39-bitstring python39-defusedxml python39-dominate python39-lxml update-alternatives"
