...
RPROVIDES:${PN} += "typelib(GnomeRR) typelib-1_0-GnomeRR-4_0 typelib-1_0-GnomeRR-4_0(aarch-64)"
RDEPENDS:${PN} += "libgnome-rr-4.so.2()(64bit) typelib(GDesktopEnums) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(GnomeDesktop) typelib(HarfBuzz) typelib(Pango) typelib(PangoCairo) typelib(cairo) typelib(freetype2)"
