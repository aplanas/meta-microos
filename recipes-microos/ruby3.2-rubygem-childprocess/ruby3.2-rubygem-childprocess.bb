...
RPROVIDES:${PN} += "ruby3.2-rubygem-childprocess ruby3.2-rubygem-childprocess(aarch-64) rubygem(childprocess) rubygem(ruby:3.2.0:childprocess) rubygem(ruby:3.2.0:childprocess:4) rubygem(ruby:3.2.0:childprocess:4.1) rubygem(ruby:3.2.0:childprocess:4.1.0)"
