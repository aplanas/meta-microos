...
RPROVIDES:${PN} += "libXcomposite-devel libXcomposite-devel(aarch-64) pkgconfig(xcomposite)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXcomposite1 pkgconfig(compositeproto) pkgconfig(x11) pkgconfig(xfixes) pkgconfig(xproto)"
