...
RPROVIDES:${PN} += "tex(ajc2020unofficial.bbx) tex(ajc2020unofficial.cbx) texlive-biblatex-ajc2020unofficial"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(numeric.bbx) tex(numeric.cbx) tex(shortmathj.sty) tex(standard.bbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
