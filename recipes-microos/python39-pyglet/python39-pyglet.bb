...
RPROVIDES:${PN} += "python3.9dist(pyglet) python39-pyglet python3dist(pyglet)"
RDEPENDS:${PN} += "Mesa-dri libxcb-glx0 python(abi) python39-Pillow python39-future python39-pypng"
