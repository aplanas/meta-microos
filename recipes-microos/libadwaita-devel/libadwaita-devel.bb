...
RPROVIDES:${PN} += "libadwaita-devel libadwaita-devel(aarch-64) pkgconfig(libadwaita-1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libadwaita-1-0 pkgconfig(fribidi) pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gtk4) typelib-1_0-Adw-1"
