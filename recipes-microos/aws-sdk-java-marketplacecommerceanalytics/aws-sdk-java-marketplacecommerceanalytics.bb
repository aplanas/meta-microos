...
RPROVIDES:${PN} += "aws-sdk-java-marketplacecommerceanalytics mvn(com.amazonaws:aws-java-sdk-marketplacecommerceanalytics) mvn(com.amazonaws:aws-java-sdk-marketplacecommerceanalytics:pom:)"
