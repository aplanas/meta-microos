...
RPROVIDES:${PN} += "config(python3-azurectl) python-azurectl python3-azurectl python3.10dist(azurectl) python3dist(azurectl)"
RDEPENDS:${PN} += "/usr/bin/python3 man openssl python(abi) python3-APScheduler python3-azure-servicemanagement-legacy python3-azure-storage python3-cryptography python3-docopt python3-pyOpenSSL python3-python-dateutil python3-setuptools"
