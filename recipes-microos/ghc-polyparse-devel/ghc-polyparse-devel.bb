...
RPROVIDES:${PN} += "ghc-devel(polyparse-1.13-E8FdqtcSqxM3P2njDFrYm8) ghc-polyparse-devel ghc-polyparse-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(text-2.0.2) ghc-polyparse"
