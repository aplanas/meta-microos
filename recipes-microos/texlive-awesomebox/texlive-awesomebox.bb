...
RPROVIDES:${PN} += "tex(awesomebox.sty) texlive-awesomebox"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(fontawesome5.sty) tex(ifthen.sty) tex(xcolor.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
