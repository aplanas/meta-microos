...
RPROVIDES:${PN} += "samba-gplv3-krb-printing samba-krb-printing samba-krb-printing(aarch-64)"
RDEPENDS:${PN} += "/bin/sh coreutils cups libc.so.6(GLIBC_2.34)(64bit) samba-client"
