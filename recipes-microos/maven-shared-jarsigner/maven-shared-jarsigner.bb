...
RPROVIDES:${PN} += "maven-shared-jarsigner mvn(org.apache.maven.shared:maven-jarsigner) mvn(org.apache.maven.shared:maven-jarsigner:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven.shared:maven-shared-utils) mvn(org.apache.maven:maven-core) mvn(org.codehaus.plexus:plexus-component-annotations)"
