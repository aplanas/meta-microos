...
RPROVIDES:${PN} += "ghc-hjsmin-prof ghc-hjsmin-prof(aarch-64) ghc-prof(hjsmin-0.2.1-G11T0ofJtyz5gQQf6GRgL1)"
RDEPENDS:${PN} += "ghc-hjsmin-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(language-javascript-0.7.1.0-3FqnIQtG3956Mxug7EpqjM) ghc-prof(text-2.0.2)"
