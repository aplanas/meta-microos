...
RPROVIDES:${PN} += "tex(luaprogtable.sty) texlive-luaprogtable"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(expl3.sty) tex(iftex.sty) tex(luatexbase.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
