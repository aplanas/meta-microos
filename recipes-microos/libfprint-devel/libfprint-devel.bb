...
RPROVIDES:${PN} += "libfprint-devel libfprint-devel(aarch-64) pkgconfig(libfprint-2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libfprint libfprint-2-2 pkgconfig(gio-unix-2.0) pkgconfig(gobject-2.0)"
