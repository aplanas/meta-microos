...
RPROVIDES:${PN} += "python3.11dist(delorean) python311-Delorean python3dist(delorean)"
RDEPENDS:${PN} += "python(abi) python311-Babel python311-humanize python311-python-dateutil python311-pytz python311-tzlocal"
