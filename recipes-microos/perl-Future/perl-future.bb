...
RPROVIDES:${PN} += "perl(Future) perl(Future::Exception) perl(Future::Mutex) perl(Future::PP) perl(Future::Utils) perl(Test::Future) perl(Test::Future::Deferred) perl-Future"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Carp)"
