...
RPROVIDES:${PN} += "python3.9dist(ssdeep) python39-ssdeep python39-ssdeep(aarch-64) python3dist(ssdeep)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libfuzzy.so.2()(64bit) python(abi) python39-cffi ssdeep"
