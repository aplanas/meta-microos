...
RPROVIDES:${PN} += "libcthreads.so.1()(64bit) libcthreads.so.1(V_20220102)(64bit) libcthreads1 libcthreads1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcerror.so.1()(64bit) libcerror.so.1(V_20220101)(64bit)"
