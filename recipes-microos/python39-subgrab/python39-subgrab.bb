...
RPROVIDES:${PN} += "python3.9dist(subgrab) python39-subgrab python3dist(subgrab)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-beautifulsoup4 python39-lxml python39-requests update-alternatives"
