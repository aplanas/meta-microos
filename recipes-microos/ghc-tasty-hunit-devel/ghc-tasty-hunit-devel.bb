...
RPROVIDES:${PN} += "ghc-devel(tasty-hunit-0.10.0.3-CV9N1Lkn3CAEveU82YsKyL) ghc-tasty-hunit-devel ghc-tasty-hunit-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(call-stack-0.4.0-K9VxYWjBEvtITBfD6bL7Dk) ghc-devel(tasty-1.4.3-FhQLnMluiBU5Fwwb1Rsznz) ghc-tasty-hunit"
