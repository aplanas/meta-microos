...
RPROVIDES:${PN} += "ghc-postgresql-libpq-prof ghc-postgresql-libpq-prof(aarch-64) ghc-prof(postgresql-libpq-0.9.5.0-EniLDQI99PgI2VDyTYHGox)"
RDEPENDS:${PN} += "ghc-postgresql-libpq-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(unix-2.7.3)"
