...
RPROVIDES:${PN} += "config(gpm) gpm gpm(aarch-64) select"
RDEPENDS:${PN} += "/bin/sed /bin/sh /usr/bin/mkdir /usr/bin/touch fillup ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgpm.so.2()(64bit) systemd"
