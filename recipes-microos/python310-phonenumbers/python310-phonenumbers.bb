...
RPROVIDES:${PN} += "python3-phonenumbers python3-phonenumberslite python3.10dist(phonenumbers) python310-phonenumbers python310-phonenumberslite python3dist(phonenumbers)"
