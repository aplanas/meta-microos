...
RPROVIDES:${PN} += "locale(wget:af) locale(wget:be) locale(wget:bg) locale(wget:ca) locale(wget:cs) locale(wget:da) locale(wget:de) locale(wget:el) locale(wget:en_GB) locale(wget:eo) locale(wget:es) locale(wget:et) locale(wget:eu) locale(wget:fi) locale(wget:fr) locale(wget:ga) locale(wget:gl) locale(wget:he) locale(wget:hr) locale(wget:hu) locale(wget:id) locale(wget:it) locale(wget:ja) locale(wget:ka) locale(wget:ko) locale(wget:lt) locale(wget:ms) locale(wget:nb) locale(wget:nl) locale(wget:pl) locale(wget:pt) locale(wget:pt_BR) locale(wget:ro) locale(wget:ru) locale(wget:sk) locale(wget:sl) locale(wget:sr) locale(wget:sv) locale(wget:tr) locale(wget:uk) locale(wget:vi) locale(wget:zh_CN) locale(wget:zh_TW) wget-lang wget-lang-all"
RDEPENDS:${PN} += "wget"
