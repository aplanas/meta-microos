...
RPROVIDES:${PN} += "ruby3.2-rubygem-ruby-rc4 ruby3.2-rubygem-ruby-rc4(aarch-64) rubygem(ruby-rc4) rubygem(ruby:3.2.0:ruby-rc4) rubygem(ruby:3.2.0:ruby-rc4:0) rubygem(ruby:3.2.0:ruby-rc4:0.1) rubygem(ruby:3.2.0:ruby-rc4:0.1.5)"
