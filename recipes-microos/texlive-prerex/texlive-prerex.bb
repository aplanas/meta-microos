...
RPROVIDES:${PN} += "tex(prerex.sty) texlive-prerex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(hyperref.sty) tex(pgf.sty) tex(relsize.sty) tex(textcomp.sty) tex(tikz.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
