...
RPROVIDES:${PN} += "python3.11dist(azure-synapse-managedprivateendpoints) python311-azure-synapse python311-azure-synapse-managedprivateendpoints python3dist(azure-synapse-managedprivateendpoints)"
