...
RPROVIDES:${PN} += "libgupnp-devel libgupnp-devel(aarch-64) pkgconfig(gupnp-1.6)"
RDEPENDS:${PN} += "/usr/bin/pkg-config /usr/bin/python3 libgupnp-1_6-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gmodule-2.0) pkgconfig(gobject-2.0) pkgconfig(gssdp-1.6) pkgconfig(libsoup-3.0) pkgconfig(libxml-2.0) typelib-1_0-GUPnP-1_0"
