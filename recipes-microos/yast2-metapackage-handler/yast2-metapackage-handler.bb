...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.MetapackageHandler.desktop) mimehandler(text/x-suse-ymp) mimehandler(text/x-suse-ymu) yast2-metapackage-handler"
RDEPENDS:${PN} += "/bin/sh /usr/bin/xdg-su yast2 yast2-country-data yast2-packager yast2-ruby-bindings yast2-transfer"
