...
RPROVIDES:${PN} += "python3.9dist(audiogrep) python39-audiogrep python3dist(audiogrep)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 ffmpeg pocketsphinx python(abi) python39-pydub update-alternatives"
