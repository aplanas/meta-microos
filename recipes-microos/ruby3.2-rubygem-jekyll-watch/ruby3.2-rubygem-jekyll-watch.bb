...
RPROVIDES:${PN} += "ruby3.2-rubygem-jekyll-watch ruby3.2-rubygem-jekyll-watch(aarch-64) rubygem(jekyll-watch) rubygem(ruby:3.2.0:jekyll-watch) rubygem(ruby:3.2.0:jekyll-watch:2) rubygem(ruby:3.2.0:jekyll-watch:2.2) rubygem(ruby:3.2.0:jekyll-watch:2.2.1)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:listen:3)"
