...
RPROVIDES:${PN} += "tex(boldtensors.sty) texlive-boldtensors"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils font(bbold) grep sed tex(bbold.map) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
