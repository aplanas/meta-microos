...
RPROVIDES:${PN} += "config(linux-atm) firmware(pca200e.bin) firmware(pca200e_ecd.bin2) firmware(sba200e_ecd.bin2) linux-atm linux-atm(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libatm.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) libfl.so.2()(64bit)"
