...
RPROVIDES:${PN} += "libknet1-crypto-plugins-all libknet1-crypto-plugins-all(aarch-64)"
RDEPENDS:${PN} += "libknet1-crypto-nss-plugin(aarch-64) libknet1-crypto-openssl-plugin(aarch-64)"
