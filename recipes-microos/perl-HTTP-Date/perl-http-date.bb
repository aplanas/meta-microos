...
RPM_NAME = "perl-HTTP-Date-6.05-1.14.noarch.rpm"
...
RPROVIDES:${PN} += "perl(HTTP::Date) perl-HTTP-Date"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Time::Local) perl(Time::Zone)"
