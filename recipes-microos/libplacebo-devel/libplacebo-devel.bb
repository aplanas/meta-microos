...
RPROVIDES:${PN} += "libplacebo-devel libplacebo-devel(aarch-64) pkgconfig(libplacebo)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libplacebo264 pkgconfig(dovi) pkgconfig(lcms2) pkgconfig(libunwind) pkgconfig(shaderc) pkgconfig(vulkan)"
