...
RPROVIDES:${PN} += "libompiintercept.so()(64bit) \
libprint_ldso_audit.so()(64bit) \
libspindle.so.0()(64bit) \
libspindle_audit_pipe.so()(64bit) \
libspindle_subaudit_pipe.so()(64bit) \
libspindlebe.so.2()(64bit) \
libspindlefe.so.2()(64bit) \
libspindleint.so()(64bit) \
spindle \
spindle(aarch-64)"
