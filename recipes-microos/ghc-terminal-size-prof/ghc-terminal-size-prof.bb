...
RPROVIDES:${PN} += "ghc-prof(terminal-size-0.3.4-1tPFLsRvnmSGNryq4PMCAd) ghc-terminal-size-prof ghc-terminal-size-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-terminal-size-devel"
