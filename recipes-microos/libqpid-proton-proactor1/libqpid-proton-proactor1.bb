...
RPROVIDES:${PN} += "libqpid-proton-proactor.so.1()(64bit) libqpid-proton-proactor1 libqpid-proton-proactor1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libc.so.6(GLIBC_2.34)(64bit) libqpid-proton-core.so.10()(64bit)"
