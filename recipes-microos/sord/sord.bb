...
RPROVIDES:${PN} += "sord sord(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpcre2-8.so.0()(64bit) libserd-0.so.0()(64bit) libsord-0.so.0()(64bit)"
