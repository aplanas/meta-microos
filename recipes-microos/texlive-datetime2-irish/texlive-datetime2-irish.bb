...
RPROVIDES:${PN} += "tex(datetime2-ga-GB.ldf) tex(datetime2-ga-IE.ldf) tex(datetime2-irish-ascii.ldf) tex(datetime2-irish-utf8.ldf) tex(datetime2-irish.ldf) texlive-datetime2-irish"
