...
RPROVIDES:${PN} += "python3-nautilus python310-nautilus python310-nautilus(aarch-64)"
RDEPENDS:${PN} += "python310-gobject python310-nautilus-common-files typelib(Nautilus)"
