...
RPROVIDES:${PN} += "libdbus-c++-glib-devel libdbus-c++-glib-devel(aarch-64) pkgconfig(dbus-c++-glib-1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdbus-c++-glib-1-1 pkgconfig(dbus-c++-1)"
