...
RPROVIDES:${PN} += "typelib(GPaste) typelib-1_0-GPaste-2 typelib-1_0-GPaste-2(aarch-64)"
RDEPENDS:${PN} += "libgpaste-2.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
