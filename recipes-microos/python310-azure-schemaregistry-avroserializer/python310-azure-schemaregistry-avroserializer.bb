...
RPROVIDES:${PN} += "python3-azure-schemaregistry-avroserializer python3.10dist(azure-schemaregistry-avroserializer) python310-azure-schemaregistry-avroserializer python3dist(azure-schemaregistry-avroserializer)"
RDEPENDS:${PN} += "python(abi) python310-avro python310-azure-core python310-azure-nspkg python310-azure-schemaregistry python310-msrest"
