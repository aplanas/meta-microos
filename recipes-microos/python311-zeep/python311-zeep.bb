...
RPROVIDES:${PN} += "python3.11dist(zeep) python311-zeep python3dist(zeep)"
RDEPENDS:${PN} += "python(abi) python311-attrs python311-cached-property python311-isodate python311-lxml python311-platformdirs python311-pytz python311-requests python311-requests-file python311-requests-toolbelt"
