...
RPROVIDES:${PN} += "python3-Levenshtein python3.10dist(python-levenshtein) python310-Levenshtein python310-Levenshtein(aarch-64) python3dist(python-levenshtein)"
