...
RPROVIDES:${PN} += "libraqm-devel libraqm-devel(aarch-64) pkgconfig(raqm)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libraqm0 pkgconfig(freetype2) pkgconfig(fribidi) pkgconfig(harfbuzz)"
