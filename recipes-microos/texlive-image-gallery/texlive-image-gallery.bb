...
RPROVIDES:${PN} += "tex(image-gallery.cls) texlive-image-gallery"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(color.sty) tex(geometry.sty) tex(graphicx.sty) tex(keyval.sty) tex(url.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
