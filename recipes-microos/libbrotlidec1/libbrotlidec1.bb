...
RPROVIDES:${PN} += "libbrotlidec.so.1()(64bit) libbrotlidec1 libbrotlidec1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libbrotlicommon.so.1()(64bit) libc.so.6(GLIBC_2.17)(64bit)"
