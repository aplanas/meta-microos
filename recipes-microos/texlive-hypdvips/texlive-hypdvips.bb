...
RPROVIDES:${PN} += "tex(hypdvips.sty) texlive-hypdvips"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atveryend.sty) tex(bookmark.sty) tex(hypcap.sty) tex(hyperref.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
