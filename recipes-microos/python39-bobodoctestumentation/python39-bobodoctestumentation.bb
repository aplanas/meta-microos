...
RPROVIDES:${PN} += "python3.9dist(bobodoctestumentation) python39-bobodoctestumentation python3dist(bobodoctestumentation)"
RDEPENDS:${PN} += "python(abi) python39-WebTest python39-manuel python39-six python39-zope.testing"
