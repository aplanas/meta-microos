...
RPROVIDES:${PN} += "tex(utfsym.sty) texlive-utfsym"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(l3keys2e.sty) tex(newunicodechar.sty) tex(tikz.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
