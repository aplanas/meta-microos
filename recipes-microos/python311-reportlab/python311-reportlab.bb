...
RPROVIDES:${PN} += "python3.11dist(reportlab) python311-ReportLab python311-reportlab python311-reportlab(aarch-64) python3dist(reportlab)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libfreetype.so.6()(64bit) python(abi) python311-Pillow"
