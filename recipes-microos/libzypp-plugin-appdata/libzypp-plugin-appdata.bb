...
RPROVIDES:${PN} += "appstream-provider libzypp-plugin-appdata"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/python3 appstream-glib libzypp python3-cmdln python3-createrepo_c zypper"
