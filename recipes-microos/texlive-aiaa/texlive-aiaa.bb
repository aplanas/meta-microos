...
RPROVIDES:${PN} += "tex(aiaa-tc.cls) texlive-aiaa"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(article.cls) tex(fancyhdr.sty) tex(graphicx.sty) tex(ifthen.sty) tex(lastpage.sty) tex(overcite.sty) tex(setspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
