...
RPROVIDES:${PN} += "libassuan-devel libassuan-devel(aarch-64) pkgconfig(libassuan)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libassuan0 libgpg-error-devel pkgconfig(gpg-error)"
