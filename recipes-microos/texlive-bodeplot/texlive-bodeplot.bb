...
RPROVIDES:${PN} += "tex(bodeplot.sty) texlive-bodeplot"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(environ.sty) tex(ifplatform.sty) tex(pdftexcmds.sty) tex(pgfplots.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
