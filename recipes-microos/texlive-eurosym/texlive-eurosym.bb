...
RPROVIDES:${PN} += "tex(eurosym.map) tex(eurosym.sty) tex(feybl10.tfm) tex(feybo10.tfm) tex(feybr10.tfm) tex(feyml10.tfm) tex(feymo10.tfm) tex(feymr10.tfm) texlive-eurosym"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-eurosym-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
