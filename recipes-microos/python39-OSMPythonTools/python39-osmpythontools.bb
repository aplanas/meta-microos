...
RPROVIDES:${PN} += "python3.9dist(osmpythontools) python39-OSMPythonTools python3dist(osmpythontools)"
RDEPENDS:${PN} += "python(abi) python39-beautifulsoup4 python39-geojson python39-lxml python39-numpy python39-pandas python39-ujson python39-xarray"
