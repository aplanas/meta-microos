...
RPROVIDES:${PN} += "cfn-lint python3.9dist(cfn-lint) python39-cfn-lint python3dist(cfn-lint)"
RDEPENDS:${PN} += "(python39-jsonschema > 3.0 with python39-jsonschema < 5) /bin/sh /usr/bin/python3.9 git-core python(abi) python39-PyYAML python39-aws-sam-translator python39-jschema-to-python python39-jsonpatch python39-junit-xml python39-networkx python39-sarif-om update-alternatives"
