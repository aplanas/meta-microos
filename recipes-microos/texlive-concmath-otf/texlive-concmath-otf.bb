...
RPROVIDES:${PN} += "tex(concmath-otf.sty) texlive-concmath-otf"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(iftex.sty) tex(unicode-math.sty) tex(xkeyval.sty) texlive texlive-concmath-otf-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
