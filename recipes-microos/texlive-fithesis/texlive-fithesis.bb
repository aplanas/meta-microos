...
RPROVIDES:${PN} += "tex(fithesis-base.sty) tex(fithesis-czech.def) tex(fithesis-english.def) tex(fithesis-mu-10.clo) tex(fithesis-mu-11.clo) tex(fithesis-mu-12.clo) tex(fithesis-mu-base.sty) tex(fithesis-mu-econ.sty) tex(fithesis-mu-fi.sty) tex(fithesis-mu-fsps.sty) tex(fithesis-mu-fss.sty) tex(fithesis-mu-law.sty) tex(fithesis-mu-med.sty) tex(fithesis-mu-ped.sty) tex(fithesis-mu-pharm.sty) tex(fithesis-mu-phil.sty) tex(fithesis-mu-sci.sty) tex(fithesis-slovak.def) tex(fithesis.cls) tex(fithesis2.cls) tex(fithesis3.cls) tex(fithesis4.cls) texlive-fithesis"
