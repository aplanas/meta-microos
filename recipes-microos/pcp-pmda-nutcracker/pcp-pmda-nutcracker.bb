...
RPROVIDES:${PN} += "config(pcp-pmda-nutcracker) pcp-pmda-nutcracker pcp-pmda-nutcracker(aarch-64)"
RDEPENDS:${PN} += "/bin/sh perl(JSON) perl(YAML::XS::LibYAML) perl-PCP-PMDA"
