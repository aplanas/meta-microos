...
RPROVIDES:${PN} += "python3.11dist(gpstime) python311-gpstime python3dist(gpstime)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-appdirs python311-python-dateutil python311-requests timezone update-alternatives"
