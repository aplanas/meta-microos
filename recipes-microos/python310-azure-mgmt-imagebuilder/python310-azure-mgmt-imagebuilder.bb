...
RPROVIDES:${PN} += "python3-azure-mgmt-imagebuilder python3.10dist(azure-mgmt-imagebuilder) python310-azure-mgmt-imagebuilder python3dist(azure-mgmt-imagebuilder)"
