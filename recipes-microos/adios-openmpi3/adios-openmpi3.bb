...
RPROVIDES:${PN} += "adios-openmpi3 adios-openmpi3(aarch-64) config(adios-openmpi3)"
RDEPENDS:${PN} += "/bin/bash /usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbz2.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) libhdf5.so.200()(64bit) libhdf5_hl.so.200()(64bit) liblz4.so.1()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) libmpi.so.40()(64bit) libnetcdf.so.19()(64bit) libz.so.1()(64bit) python3-PyYAML python3-xml"
