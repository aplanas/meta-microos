...
RPROVIDES:${PN} += "man(dvitype.1) man(pooltype.1) texlive-texware"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-texware-bin"
