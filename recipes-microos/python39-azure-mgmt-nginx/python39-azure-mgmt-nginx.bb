...
RPROVIDES:${PN} += "python3.9dist(azure-mgmt-nginx) python39-azure-mgmt-nginx python3dist(azure-mgmt-nginx)"
RDEPENDS:${PN} += "(python39-typing_extensions >= 4.0.1 if python39-base < 3.8) python(abi) python39-azure-common python39-azure-mgmt-core python39-azure-mgmt-nspkg python39-azure-nspkg python39-msrest"
