...
RPROVIDES:${PN} += "python3.9dist(mysqlclient) python39-MySQL-python python39-mysql python39-mysqlclient python39-mysqlclient(aarch-64) python3dist(mysqlclient)"
