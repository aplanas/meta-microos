...
locale(soundconverter:en_AU) \
locale(soundconverter:en_CA) \
locale(soundconverter:en_GB) \
...
locale(soundconverter:fr_CA) \
locale(soundconverter:fr_FR) \
