...
RPROVIDES:${PN} += "perl(Crypt::OpenSSL::Bignum) perl(Crypt::OpenSSL::Bignum::CTX) perl-Crypt-OpenSSL-Bignum perl-Crypt-OpenSSL-Bignum(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) perl(:MODULE_COMPAT_5.36.0)"
