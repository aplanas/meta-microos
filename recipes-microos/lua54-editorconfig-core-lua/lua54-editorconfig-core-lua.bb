...
RPROVIDES:${PN} += "lua-editorconfig-core-lua lua54-LPeg lua54-editorconfig-core-lua lua54-editorconfig-core-lua(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libeditorconfig.so.0()(64bit) lua54"
