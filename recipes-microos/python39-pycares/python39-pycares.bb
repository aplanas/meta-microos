...
RPROVIDES:${PN} += "python3.9dist(pycares) python39-pycares python39-pycares(aarch-64) python3dist(pycares)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.28)(64bit) python(abi) python39-cffi"
