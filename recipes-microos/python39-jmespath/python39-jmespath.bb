...
RPROVIDES:${PN} += "python3.9dist(jmespath) python39-jmespath python3dist(jmespath)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-ply update-alternatives"
