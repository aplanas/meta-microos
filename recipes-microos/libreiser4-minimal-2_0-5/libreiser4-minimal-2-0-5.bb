...
RPROVIDES:${PN} += "libreiser4-minimal-2.0.so.5()(64bit) libreiser4-minimal-2_0-5 libreiser4-minimal-2_0-5(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libaal-1.0.so.7()(64bit) libc.so.6(GLIBC_2.33)(64bit) libreadline.so.8()(64bit) libuuid.so.1()(64bit) libuuid.so.1(UUID_1.0)(64bit)"
