...
RPROVIDES:${PN} += "libavfs.so.0()(64bit) libavfs.so.0(LIBAVFS)(64bit) libavfs0 libavfs0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbz2.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) liblz.so.1()(64bit) liblzma.so.5()(64bit) liblzma.so.5(XZ_5.0)(64bit) libneon.so.27()(64bit) libz.so.1()(64bit) libzstd.so.1()(64bit)"
