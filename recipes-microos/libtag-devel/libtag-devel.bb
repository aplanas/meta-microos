...
RPROVIDES:${PN} += "libtag-devel libtag-devel(aarch-64) pkgconfig(taglib) pkgconfig(taglib_c) taglib-devel"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libstdc++-devel libtag1 libtag_c0 pkgconfig(taglib) zlib-devel"
