...
RPROVIDES:${PN} += "python3-azure-mgmt-resourcegraph python3.10dist(azure-mgmt-resourcegraph) python310-azure-mgmt-resourcegraph python3dist(azure-mgmt-resourcegraph)"
