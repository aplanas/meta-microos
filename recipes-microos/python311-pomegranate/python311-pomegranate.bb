...
RPROVIDES:${PN} += "python3.11dist(pomegranate) python311-pomegranate python311-pomegranate(aarch-64) python3dist(pomegranate)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-PyYAML python311-joblib python311-networkx python311-numpy python311-scipy"
