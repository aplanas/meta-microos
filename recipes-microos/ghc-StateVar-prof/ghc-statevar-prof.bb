...
RPROVIDES:${PN} += "ghc-StateVar-prof ghc-StateVar-prof(aarch-64) ghc-prof(StateVar-1.2.2-GlWluWgK8kgE7IUHzo2idN)"
RDEPENDS:${PN} += "ghc-StateVar-devel ghc-prof(base-4.17.1.0) ghc-prof(stm-2.5.1.0) ghc-prof(transformers-0.5.6.2)"
