...
RPROVIDES:${PN} += "python3-vobject python3.10dist(vobject) python310-vobject python3dist(vobject) vobject"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-python-dateutil python310-six update-alternatives"
