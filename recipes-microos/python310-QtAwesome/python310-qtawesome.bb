...
RPROVIDES:${PN} += "python3-QtAwesome python3.10dist(qtawesome) python310-QtAwesome python3dist(qtawesome)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-QtPy update-alternatives"
