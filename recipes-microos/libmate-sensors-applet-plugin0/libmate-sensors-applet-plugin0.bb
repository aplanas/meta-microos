...
RPROVIDES:${PN} += "libmate-sensors-applet-plugin.so.0()(64bit) libmate-sensors-applet-plugin0 libmate-sensors-applet-plugin0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit)"
