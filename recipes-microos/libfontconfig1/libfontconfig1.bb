...
RPROVIDES:${PN} += "libfontconfig.so.1()(64bit) libfontconfig1 libfontconfig1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig fontconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libexpat.so.1()(64bit) libfreetype.so.6()(64bit)"
