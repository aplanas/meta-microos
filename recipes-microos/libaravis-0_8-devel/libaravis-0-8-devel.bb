...
RPROVIDES:${PN} += "libaravis-0_8-devel libaravis-0_8-devel(aarch-64) pkgconfig(aravis-0.8)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libaravis-0_8-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libusb-1.0) pkgconfig(libxml-2.0) pkgconfig(zlib)"
