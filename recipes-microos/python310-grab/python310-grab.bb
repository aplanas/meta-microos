...
RPROVIDES:${PN} += "python3-grab python3.10dist(grab) python310-grab python3dist(grab)"
RDEPENDS:${PN} += "python(abi) python310-defusedxml python310-lxml python310-pycurl python310-selection python310-six python310-user_agent python310-weblib"
