...
RPROVIDES:${PN} += "pkgconfig(timezonemap) timezonemap-devel timezonemap-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libtimezonemap1 pkgconfig(gio-2.0) pkgconfig(gtk+-3.0) pkgconfig(json-glib-1.0)"
