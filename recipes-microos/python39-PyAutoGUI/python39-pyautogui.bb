...
RPROVIDES:${PN} += "python3.9dist(pyautogui) python39-PyAutoGUI python3dist(pyautogui)"
RDEPENDS:${PN} += "python(abi) python39-Pillow python39-PyMsgBox python39-PyScreeze python39-PyTweening python39-python-xlib"
