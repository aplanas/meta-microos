...
RPROVIDES:${PN} += "ghc-base64-bytestring-devel ghc-base64-bytestring-devel(aarch-64) ghc-devel(base64-bytestring-1.2.1.0-8KbzJpmSQbYKTeew1rv0hh)"
RDEPENDS:${PN} += "/bin/sh ghc-base64-bytestring ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0)"
