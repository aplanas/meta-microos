...
RPROVIDES:${PN} += "ruby3.2-rubygem-dry-inflector ruby3.2-rubygem-dry-inflector(aarch-64) rubygem(dry-inflector) rubygem(ruby:3.2.0:dry-inflector) rubygem(ruby:3.2.0:dry-inflector:1) rubygem(ruby:3.2.0:dry-inflector:1.0) rubygem(ruby:3.2.0:dry-inflector:1.0.0)"
