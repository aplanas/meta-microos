...
RPROVIDES:${PN} += "ghc-async-prof ghc-async-prof(aarch-64) ghc-prof(async-2.2.4-Is3H7ZPNMkM5reIoCaqYrF)"
RDEPENDS:${PN} += "ghc-async-devel ghc-prof(base-4.17.1.0) ghc-prof(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-prof(stm-2.5.1.0)"
