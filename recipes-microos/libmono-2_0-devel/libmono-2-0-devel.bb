...
RPROVIDES:${PN} += "libmono-2_0-devel libmono-2_0-devel(aarch-64) pkgconfig(mono-2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmono-2_0-1 libmonosgen-2_0-devel mono-core"
