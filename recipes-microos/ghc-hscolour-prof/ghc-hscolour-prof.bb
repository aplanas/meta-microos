...
RPROVIDES:${PN} += "ghc-hscolour-prof ghc-hscolour-prof(aarch-64) ghc-prof(hscolour-1.24.4-B0NmEhYuPI790UQrsiXLka)"
RDEPENDS:${PN} += "ghc-hscolour-devel ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7)"
