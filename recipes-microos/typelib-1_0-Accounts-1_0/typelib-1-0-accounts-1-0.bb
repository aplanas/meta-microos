...
RPROVIDES:${PN} += "typelib(Accounts) typelib-1_0-Accounts-1_0 typelib-1_0-Accounts-1_0(aarch-64)"
RDEPENDS:${PN} += "libaccounts-glib.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
