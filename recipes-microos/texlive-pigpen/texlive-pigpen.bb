...
RPROVIDES:${PN} += "tex(pigpen.map) tex(pigpen.sty) tex(pigpen.tex) tex(pigpen.tfm) texlive-pigpen"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-pigpen-fonts texlive-scripts texlive-scripts-bin"
