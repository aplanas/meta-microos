...
RPROVIDES:${PN} += "ruby3.2-rubygem-concurrent-ruby ruby3.2-rubygem-concurrent-ruby(aarch-64) rubygem(concurrent-ruby) rubygem(ruby:3.2.0:concurrent-ruby) rubygem(ruby:3.2.0:concurrent-ruby:1) rubygem(ruby:3.2.0:concurrent-ruby:1.1) rubygem(ruby:3.2.0:concurrent-ruby:1.1.10)"
