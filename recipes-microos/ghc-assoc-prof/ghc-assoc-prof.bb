...
RPROVIDES:${PN} += "ghc-assoc-prof ghc-assoc-prof(aarch-64) ghc-prof(assoc-1.0.2-IAwklVGxRFw6xcadvaWWl7)"
RDEPENDS:${PN} += "ghc-assoc-devel ghc-prof(base-4.17.1.0) ghc-prof(bifunctors-5.5.15-7mn3oj93MLM2f6K5DVlnRL) ghc-prof(tagged-0.8.7-CYOhX22Df3PFW5V1S0dOJa)"
