...
RPROVIDES:${PN} += "libavc1394 libavc1394-tools libavc1394-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libavc1394.so.0()(64bit) libc.so.6(GLIBC_2.34)(64bit) libraw1394.so.11()(64bit) librom1394.so.0()(64bit)"
