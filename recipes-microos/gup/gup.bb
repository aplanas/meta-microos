...
RPROVIDES:${PN} += "config(gup) gup gup(aarch-64)"
RDEPENDS:${PN} += "/bin/sh group(news) inn ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) user(news)"
