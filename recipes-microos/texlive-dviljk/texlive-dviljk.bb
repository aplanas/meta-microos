...
RPROVIDES:${PN} += "man(dvihp.1) man(dvilj.1) man(dvilj2p.1) man(dvilj4.1) man(dvilj4l.1) man(dvilj6.1) texlive-dviljk"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-dviljk-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
