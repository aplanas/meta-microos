...
RPROVIDES:${PN} += "tex(gfsneohellenicot.sty) texlive-gfsneohellenicmath"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontspec.sty) tex(unicode-math.sty) texlive texlive-filesystem texlive-gfsneohellenicmath-fonts texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
