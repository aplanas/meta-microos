...
RPROVIDES:${PN} += "libimobiledevice-glue-devel libimobiledevice-glue-devel(aarch-64) pkgconfig(libimobiledevice-glue-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libimobiledevice-glue-1_0-0 pkgconfig(libplist-2.0)"
