...
RPROVIDES:${PN} += "libfontenc.so.1()(64bit) libfontenc1 libfontenc1(aarch-64) xorg-x11-libfontenc"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.26)(64bit) libz.so.1()(64bit)"
