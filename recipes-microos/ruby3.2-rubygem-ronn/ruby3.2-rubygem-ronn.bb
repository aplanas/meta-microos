...
RPROVIDES:${PN} += "ruby3.2-rubygem-ronn ruby3.2-rubygem-ronn(aarch-64) rubygem(ronn) rubygem(ruby:3.2.0:ronn) rubygem(ruby:3.2.0:ronn:0) rubygem(ruby:3.2.0:ronn:0.7) rubygem(ruby:3.2.0:ronn:0.7.3)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/ruby.ruby3.2 ruby(abi) rubygem(ruby:3.2.0:hpricot) rubygem(ruby:3.2.0:mustache) rubygem(ruby:3.2.0:rdiscount) update-alternatives"
