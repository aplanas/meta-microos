...
RPROVIDES:${PN} += "pkgconfig(totem) totem-devel totem-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig(gio-2.0) pkgconfig(gtk+-3.0) pkgconfig(totem-plparser) totem"
