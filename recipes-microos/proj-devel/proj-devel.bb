...
RPROVIDES:${PN} += "cmake(proj) cmake(proj4) libproj-devel pkgconfig(proj) proj-devel proj-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libproj25 pkgconfig(libcurl) pkgconfig(libtiff-4) pkgconfig(sqlite3)"
