...
RPROVIDES:${PN} += "tex(beamercolorthemetorinoth.sty) tex(beamerfontthemetorinoth.sty) tex(beamerinnerthemetorinoth.sty) tex(beamerouterthemetorinoth.sty) tex(beamerthemeTorinoTh.sty) texlive-beamer2thesis"
