...
RPROVIDES:${PN} += "python3.11dist(voluptuous-serialize) python311-voluptuous-serialize python3dist(voluptuous-serialize)"
RDEPENDS:${PN} += "python(abi) python311-voluptuous"
