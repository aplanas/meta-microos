...
RPROVIDES:${PN} += "python3-MapProxy python3.10dist(mapproxy) python3dist(mapproxy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 libgeos_c1 proj python(abi) python3-Pillow python3-PyYAML update-alternatives"
