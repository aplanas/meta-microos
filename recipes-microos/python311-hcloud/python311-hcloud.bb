...
RPROVIDES:${PN} += "python3.11dist(hcloud) python311-hcloud python3dist(hcloud)"
RDEPENDS:${PN} += "python(abi) python311-future python311-python-dateutil python311-requests"
