...
RPROVIDES:${PN} += "python3.9dist(django-opentracing) python39-django-opentracing python3dist(django-opentracing)"
RDEPENDS:${PN} += "python(abi) python39-Django python39-opentracing python39-six"
