...
RPROVIDES:${PN} += "python3-eventlet python3.10dist(eventlet) python310-eventlet python3dist(eventlet)"
RDEPENDS:${PN} += "libnss_usrfiles2 netcfg python(abi) python310-dnspython python310-greenlet python310-six"
