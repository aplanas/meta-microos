...
RPROVIDES:${PN} += "typelib(Ggit) typelib-1_0-Ggit-1_0 typelib-1_0-Ggit-1_0(aarch-64)"
RDEPENDS:${PN} += "libgit2-glib-1.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
