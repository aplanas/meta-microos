...
RPROVIDES:${PN} += "tex(codehigh.sty) texlive-codehigh"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(catchfile.sty) tex(expl3.sty) tex(iftex.sty) tex(luatexbase.sty) tex(ninecolors.sty) tex(varwidth.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
