...
RPROVIDES:${PN} += "python3-django-codemod python3.10dist(django-codemod) python310-django-codemod python3dist(django-codemod)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-click python310-libcst python310-pathspec python310-rich-click update-alternatives"
