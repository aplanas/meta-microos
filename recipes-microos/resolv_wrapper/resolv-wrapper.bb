...
RPROVIDES:${PN} += "cmake(resolv_wrapper) libresolv_wrapper.so.0()(64bit) pkgconfig(resolv_wrapper) resolv_wrapper resolv_wrapper(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig /usr/bin/pkg-config cmake ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) pkgconf-pkg-config"
