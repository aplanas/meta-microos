...
RPROVIDES:${PN} += "libwpg-devel libwpg-devel(aarch-64) pkgconfig(libwpg-0.3)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libwpg-0_3-3 pkgconfig(librevenge-0.0) pkgconfig(libwpd-0.10)"
