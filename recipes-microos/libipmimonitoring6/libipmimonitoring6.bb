...
RPROVIDES:${PN} += "libipmimonitoring.so.6()(64bit) libipmimonitoring6 libipmimonitoring6(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libfreeipmi.so.17()(64bit)"
