...
RPROVIDES:${PN} += "python3.9dist(jupyter-contrib-core) python39-jupyter-contrib-core python39-jupyter_contrib_core python3dist(jupyter-contrib-core)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-jupyter-core python39-notebook python39-setuptools python39-tornado python39-traitlets update-alternatives"
