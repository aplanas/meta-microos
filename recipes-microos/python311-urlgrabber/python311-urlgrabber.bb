...
RPROVIDES:${PN} += "python3.11dist(urlgrabber) python311-urlgrabber python3dist(urlgrabber)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-pycurl update-alternatives"
