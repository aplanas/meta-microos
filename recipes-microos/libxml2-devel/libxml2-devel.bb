...
RPROVIDES:${PN} += "libxml2-devel libxml2-devel(aarch-64) pkgconfig(libxml-2.0)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config glibc-devel libxml2 libxml2-2 libxml2-tools pkgconfig(liblzma) pkgconfig(zlib) readline-devel xz-devel"
