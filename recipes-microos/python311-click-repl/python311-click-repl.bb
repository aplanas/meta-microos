...
RPROVIDES:${PN} += "python3.11dist(click-repl) python311-click-repl python3dist(click-repl)"
RDEPENDS:${PN} += "python(abi) python311-click python311-prompt_toolkit python311-six"
