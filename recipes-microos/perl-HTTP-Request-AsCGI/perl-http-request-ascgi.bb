...
RPROVIDES:${PN} += "perl(HTTP::Request::AsCGI) perl-HTTP-Request-AsCGI"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Carp) perl(Class::Accessor) perl(HTTP::Request) perl(HTTP::Response) perl(IO::File) perl(URI::Escape)"
