...
RPROVIDES:${PN} += "python3.11dist(eventlet) python311-eventlet python3dist(eventlet)"
RDEPENDS:${PN} += "libnss_usrfiles2 netcfg python(abi) python311-dnspython python311-greenlet python311-six"
