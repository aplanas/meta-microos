...
RPROVIDES:${PN} += "config(fwnn) fwnn fwnn(aarch-64)"
RDEPENDS:${PN} += "/bin/sh fwnncom ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcrypt.so.1()(64bit) libcrypt.so.1(XCRYPT_2.0)(64bit) libtinfo.so.6()(64bit) libtinfo.so.6(NCURSES6_TINFO_5.0.19991023)(64bit) libtinfo.so.6(NCURSES6_TINFO_5.7.20081102)(64bit) libwnn.so.0()(64bit) libwrap.so.0()(64bit) shadow"
