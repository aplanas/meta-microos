...
RPROVIDES:${PN} += "python3.8dist(cirq-core) python38-cirq-core python3dist(cirq-core)"
RDEPENDS:${PN} += "python(abi) python38-duet python38-matplotlib python38-networkx python38-numpy python38-pandas python38-scipy python38-sortedcontainers python38-sympy python38-tqdm python38-typing_extensions"
