...
RPROVIDES:${PN} += "nkitserv:/usr/sbin/in.talkd talk-server talk-server(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libnss_usrfiles2 net-tools netcfg systemd"
