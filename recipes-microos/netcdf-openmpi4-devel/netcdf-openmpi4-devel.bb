...
RPROVIDES:${PN} += "netcdf-openmpi4-devel netcdf-openmpi4-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh hdf5-openmpi4-devel libcurl-devel libnetcdf19-openmpi4 netcdf-devel-data openmpi4-devel pkgconfig zlib-devel"
