...
RPROVIDES:${PN} += "perl(MooX::Options) perl(MooX::Options::Descriptive) perl(MooX::Options::Descriptive::Usage) perl(MooX::Options::Role) perl-MooX-Options"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Getopt::Long) perl(Getopt::Long::Descriptive) perl(MRO::Compat) perl(Module::Runtime) perl(Moo) perl(MooX::Locale::Passthrough) perl(Path::Class) perl(Text::LineFold) perl(strictures)"
