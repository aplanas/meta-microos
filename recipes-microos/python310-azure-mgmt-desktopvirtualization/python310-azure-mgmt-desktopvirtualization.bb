...
RPROVIDES:${PN} += "python3-azure-mgmt-desktopvirtualization python3.10dist(azure-mgmt-desktopvirtualization) python310-azure-mgmt-desktopvirtualization python3dist(azure-mgmt-desktopvirtualization)"
