...
RPROVIDES:${PN} += "ghc-asn1-parse-prof ghc-asn1-parse-prof(aarch-64) ghc-prof(asn1-parse-0.9.5-EPDirjvv9Ch16KeQVAexUV)"
RDEPENDS:${PN} += "ghc-asn1-parse-devel ghc-prof(asn1-encoding-0.9.6-Hputs8NTOGr9EmEd7QDXHk) ghc-prof(asn1-types-0.3.4-GYlFjiH4jmgJII5TgUQfXm) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0)"
