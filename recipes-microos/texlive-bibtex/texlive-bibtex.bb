...
RPROVIDES:${PN} += "tex(apalike.sty) tex(apalike.tex) texlive-bibtex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-bibtex-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
