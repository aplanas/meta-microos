...
RPROVIDES:${PN} += "python3-telethon-session-sqlalchemy python3.10dist(telethon-session-sqlalchemy) python310-telethon-session-sqlalchemy python3dist(telethon-session-sqlalchemy)"
