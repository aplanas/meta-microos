...
RPROVIDES:${PN} += "python3.11dist(ciscoconfparse) python311-ciscoconfparse python3dist(ciscoconfparse)"
RDEPENDS:${PN} += "python(abi) python311-dnspython python311-loguru python311-toml"
