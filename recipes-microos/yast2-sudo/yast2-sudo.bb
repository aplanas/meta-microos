...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.Sudo.desktop) metainfo() metainfo(org.opensuse.yast.Sudo.metainfo.xml) yast2-sudo"
RDEPENDS:${PN} += "/usr/bin/perl yast2 yast2-ruby-bindings yast2-users"
