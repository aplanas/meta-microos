...
RPROVIDES:${PN} += "cdemu-client-lang cdemu-client-lang-all locale(cdemu-client:de) locale(cdemu-client:fr) locale(cdemu-client:pl) locale(cdemu-client:ru) locale(cdemu-client:sl) locale(cdemu-client:sv)"
