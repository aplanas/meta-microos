...
RPROVIDES:${PN} += "ruby3.2-rubygem-fake_ftp-0_1 ruby3.2-rubygem-fake_ftp-0_1(aarch-64) rubygem(fake_ftp) rubygem(ruby:3.2.0:fake_ftp) rubygem(ruby:3.2.0:fake_ftp:0) rubygem(ruby:3.2.0:fake_ftp:0.1) rubygem(ruby:3.2.0:fake_ftp:0.1.1)"
