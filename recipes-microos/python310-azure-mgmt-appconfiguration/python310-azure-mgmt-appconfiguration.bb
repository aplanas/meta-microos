...
RPROVIDES:${PN} += "python3-azure-mgmt-appconfiguration python3.10dist(azure-mgmt-appconfiguration) python310-azure-mgmt-appconfiguration python3dist(azure-mgmt-appconfiguration)"
