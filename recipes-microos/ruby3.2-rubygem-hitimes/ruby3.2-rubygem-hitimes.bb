...
RPROVIDES:${PN} += "ruby3.2-rubygem-hitimes ruby3.2-rubygem-hitimes(aarch-64) rubygem(hitimes) rubygem(ruby:3.2.0:hitimes) rubygem(ruby:3.2.0:hitimes:2) rubygem(ruby:3.2.0:hitimes:2.0) rubygem(ruby:3.2.0:hitimes:2.0.0)"
