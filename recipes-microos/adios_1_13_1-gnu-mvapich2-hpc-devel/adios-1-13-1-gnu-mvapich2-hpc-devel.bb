...
RPROVIDES:${PN} += "adios_1_13_1-gnu-mvapich2-hpc-devel adios_1_13_1-gnu-mvapich2-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "adios_1_13_1-gnu-mvapich2-hpc adios_1_13_1-gnu-mvapich2-hpc-devel-static gnu-compilers-hpc-devel hdf5-gnu-mvapich2-hpc-devel lua-lmod mvapich2-gnu-hpc-devel netcdf-gnu-mvapich2-hpc-devel"
