...
RPROVIDES:${PN} += "tex(tex4ebook.sty) texlive-tex4ebook"
RDEPENDS:${PN} += "/bin/sh /usr/bin/luatex /usr/bin/texlua coreutils ed findutils grep sed tex(etoolbox.sty) tex(graphicx.sty) tex(kvoptions.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-make4ht texlive-scripts texlive-scripts-bin texlive-tex4ebook-bin texlive-tex4ht"
