...
RPROVIDES:${PN} += "config(davfs2) davfs2 davfs2(aarch-64) fuse-davfs2"
RDEPENDS:${PN} += "/bin/sh /usr/sbin/groupadd /usr/sbin/useradd fuse ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libneon.so.27()(64bit)"
