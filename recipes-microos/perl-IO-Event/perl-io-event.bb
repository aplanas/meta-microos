...
RPROVIDES:${PN} += "perl(IO::Event) perl(IO::Event::AnyEvent) perl(IO::Event::Callback) perl(IO::Event::Emulate) perl(IO::Event::Event) perl(IO::Event::INET::Callback) perl(IO::Event::Socket::UNIX) perl(IO::Event::UNIX::Callback) perl-IO-Event"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(IO::Handle) perl(List::MoreUtils) perl(Time::HiRes)"
