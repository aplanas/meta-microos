...
RPROVIDES:${PN} += "config(texlive-fdsymbol-fonts) font(fdsymbol) font(fdsymbola) font(fdsymbolb) font(fdsymbolc) font(fdsymbold) font(fdsymbole) font(fdsymbolf) texlive-fdsymbol-fonts"
