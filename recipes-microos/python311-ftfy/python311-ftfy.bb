...
RPROVIDES:${PN} += "python3.11dist(ftfy) python311-ftfy python3dist(ftfy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-wcwidth update-alternatives"
