...
RPROVIDES:${PN} += "tex(skmath.sty) texlive-skmath"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(expl3.sty) tex(isomath.sty) tex(l3keys2e.sty) tex(mathtools.sty) tex(xfrac.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
