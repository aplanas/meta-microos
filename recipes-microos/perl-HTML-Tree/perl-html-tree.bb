...
RPROVIDES:${PN} += "perl(HTML::AsSubs) perl(HTML::Element) perl(HTML::Element::traverse) perl(HTML::Parse) perl(HTML::Tree) perl(HTML::TreeBuilder) perl-HTML-Tree"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(HTML::Entities) perl(HTML::Parser) perl(HTML::Tagset)"
