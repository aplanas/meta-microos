...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-gnome-gnome_internet patterns-gnome-gnome_internet(aarch-64) patterns-openSUSE-gnome_internet"
RDEPENDS:${PN} += ""
