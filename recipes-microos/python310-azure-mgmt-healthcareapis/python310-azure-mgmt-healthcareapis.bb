...
RPROVIDES:${PN} += "python3-azure-mgmt-healthcareapis python3.10dist(azure-mgmt-healthcareapis) python310-azure-mgmt-healthcareapis python3dist(azure-mgmt-healthcareapis)"
