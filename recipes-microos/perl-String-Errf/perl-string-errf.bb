...
RPROVIDES:${PN} += "perl(String::Errf) perl-String-Errf"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Params::Util) perl(String::Formatter) perl(Sub::Exporter) perl(Time::Piece) perl(parent)"
