...
RPROVIDES:${PN} += "parallel-netcdf-openmpi1 pnetcdf-openmpi1 pnetcdf-openmpi1(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libmpi.so.12()(64bit) libpnetcdf.so.4()(64bit) libpnetcdf4-openmpi1 openmpi1"
