...
RPROVIDES:${PN} += "opusfile-devel opusfile-devel(aarch-64) pkgconfig(opusfile) pkgconfig(opusurl)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libopusfile0 pkgconfig pkgconfig(ogg) pkgconfig(openssl) pkgconfig(opus) pkgconfig(opusfile)"
