...
RPROVIDES:${PN} += "tex(pbalance.sty) texlive-pbalance"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atbegshi.sty) tex(atveryend.sty) tex(balance.sty) tex(etoolbox.sty) tex(expl3.sty) tex(filehook.sty) tex(zref-abspage.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
