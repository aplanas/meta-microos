...
RPROVIDES:${PN} += "tex(polexpr-examples.tex) tex(polexpr.sty) tex(polexprcore.tex) tex(polexprexpr.tex) tex(polexprsturm.tex) texlive-polexpr"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(xintexpr.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
