...
RPROVIDES:${PN} += "ghc-devel(easy-file-0.2.3-Bwh7vXkS9r2GpL1fsuKjo4) ghc-easy-file-devel ghc-easy-file-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(directory-1.3.7.1) ghc-devel(filepath-1.4.2.2) ghc-devel(time-1.12.2) ghc-devel(unix-2.7.3) ghc-easy-file"
