...
RPROVIDES:${PN} += "perl(OBEXFTP) perl(OBEXFTP::client) perl(OBEXFTPc) perl-obexftp perl-obexftp(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libobexftp.so.0()(64bit) obexftp perl-base"
