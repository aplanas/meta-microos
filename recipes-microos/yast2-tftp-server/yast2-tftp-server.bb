...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.TFTPServer.desktop) metainfo() metainfo(org.opensuse.yast.TFTPServer.metainfo.xml) yast2-tftp-server"
RDEPENDS:${PN} += "augeas-lenses lsof rubygem(ruby:3.2.0:cfa) yast2 yast2-journal yast2-ruby-bindings"
