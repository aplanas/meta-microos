...
RPROVIDES:${PN} += "config(ldirectord) heartbeat-ldirectord ldirectord ldirectord(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl ipvsadm logrotate perl-IO-Socket-INET6 perl-MailTools perl-Net-SSLeay perl-Socket6 perl-libwww-perl resource-agents systemd"
