...
RPROVIDES:${PN} += "google-noto-sans-jp-fonts-full noto-sans-jp-fonts-full"
RDEPENDS:${PN} += "google-noto-sans-jp-black-fonts google-noto-sans-jp-demilight-fonts google-noto-sans-jp-fonts google-noto-sans-jp-light-fonts google-noto-sans-jp-medium-fonts google-noto-sans-jp-thin-fonts"
