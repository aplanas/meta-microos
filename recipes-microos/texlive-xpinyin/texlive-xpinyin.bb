...
RPROVIDES:${PN} += "tex(xpinyin-database.def) tex(xpinyin.sty) texlive-xpinyin"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(CJKutf8.sty) tex(expl3.sty) tex(l3keys2e.sty) tex(xCJK2uni.sty) tex(xeCJK.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
