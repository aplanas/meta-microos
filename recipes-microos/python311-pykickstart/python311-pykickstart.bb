...
RPROVIDES:${PN} += "python3.11dist(pykickstart) python311-pykickstart python3dist(pykickstart)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-requests"
