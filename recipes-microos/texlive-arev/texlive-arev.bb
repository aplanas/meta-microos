...
RPROVIDES:${PN} += "tex(ArevSans-Bold.tfm) tex(ArevSans-BoldOblique.tfm) tex(ArevSans-Oblique.tfm) tex(ArevSans-Roman.tfm) tex(ams-mdbch.sty) tex(arev.map) tex(arev.sty) tex(arevmath.sty) tex(arevoml.enc) tex(arevoms.enc) tex(arevot1.enc) tex(arevsymbols.tex) tex(arevtext.sty) tex(favb8r.tfm) tex(favb8t.tfm) tex(favb8t.vf) tex(favbi8r.tfm) tex(favbi8t.tfm) tex(favbi8t.vf) tex(favmb7t.tfm) tex(favmbi7m.tfm) tex(favmr7t.tfm) tex(favmr7y.tfm) tex(favmri7m.tfm) tex(favr8r.tfm) tex(favr8t.tfm) tex(favr8t.vf) tex(favri8r.tfm) tex(favri8t.tfm) tex(favri8t.vf) tex(omlzavm.fd) tex(omszavm.fd) tex(ot1zavm.fd) tex(t1fav.fd) tex(uzavm.fd) tex(zavmb7t.tfm) tex(zavmb7t.vf) tex(zavmbi7m.tfm) tex(zavmbi7m.vf) tex(zavmr7t.tfm) tex(zavmr7t.vf) tex(zavmr7y.tfm) tex(zavmr7y.vf) tex(zavmri7m.tfm) tex(zavmri7m.vf) texlive-arev"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsfonts.sty) tex(amssymb.sty) tex(beramono.sty) tex(fontenc.sty) tex(ifthen.sty) tex(md-chb7m.tfm) tex(md-chb7t.tfm) tex(md-chb7y.tfm) tex(mdacmr.fd) tex(textcomp.sty) tex(updmap.cfg) texlive texlive-arev-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
