...
RPROVIDES:${PN} += "tex(hyph-fi-x-school.ec.tex) tex(hyph-fi-x-school.tex) tex(hyph-fi.ec.tex) tex(hyph-fi.tex) tex(loadhyph-fi-x-school.tex) tex(loadhyph-fi.tex) texlive-hyphen-finnish"
