...
RPROVIDES:${PN} += "gkeyfile-sharp-devel gkeyfile-sharp-devel(aarch-64) pkgconfig(gkeyfile-sharp)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gkeyfile-sharp pkgconfig(glib-sharp-2.0)"
