...
RPROVIDES:${PN} += "gobby-lang gobby-lang-all locale(gobby:ca) locale(gobby:de) locale(gobby:el_GR) locale(gobby:en_GB) locale(gobby:fr) locale(gobby:it_IT) locale(gobby:ja) locale(gobby:pt_BR) locale(gobby:zh_TW)"
RDEPENDS:${PN} += "gobby"
