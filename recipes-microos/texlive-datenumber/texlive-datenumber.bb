...
RPROVIDES:${PN} += "tex(datenumber.sty) tex(datenumberUSenglish.ldf) tex(datenumberdummy.ldf) tex(datenumberenglish.ldf) tex(datenumberfrench.ldf) tex(datenumbergerman.ldf) tex(datenumberspanish.ldf) texlive-datenumber"
