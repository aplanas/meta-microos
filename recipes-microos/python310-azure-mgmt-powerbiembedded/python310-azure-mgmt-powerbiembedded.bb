...
RPROVIDES:${PN} += "python3-azure-mgmt-powerbiembedded python3.10dist(azure-mgmt-powerbiembedded) python310-azure-mgmt-powerbiembedded python3dist(azure-mgmt-powerbiembedded)"
