...
RPROVIDES:${PN} += "tex(thumbpdf.sty) tex(thumbpdf.tex) texlive-thumbpdf"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl coreutils ed findutils grep perl(Config) perl(Getopt::Long) perl(strict) sed tex(ifluatex.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-thumbpdf-bin"
