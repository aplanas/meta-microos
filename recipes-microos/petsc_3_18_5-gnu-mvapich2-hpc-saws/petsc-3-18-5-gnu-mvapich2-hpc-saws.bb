...
RPROVIDES:${PN} += "petsc_3_18_5-gnu-mvapich2-hpc-saws petsc_3_18_5-gnu-mvapich2-hpc-saws(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /usr/bin/python3 libpetsc_3_18_5-gnu-mvapich2-hpc"
