...
RPROVIDES:${PN} += "ruby3.2-rubygem-mixlib-log ruby3.2-rubygem-mixlib-log(aarch-64) rubygem(mixlib-log) rubygem(ruby:3.2.0:mixlib-log) rubygem(ruby:3.2.0:mixlib-log:3) rubygem(ruby:3.2.0:mixlib-log:3.0) rubygem(ruby:3.2.0:mixlib-log:3.0.9)"
