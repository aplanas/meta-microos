...
RPROVIDES:${PN} += "tex(sageep.cls) texlive-sageep"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(caption.sty) tex(courier.sty) tex(geometry.sty) tex(helvet.sty) tex(indentfirst.sty) tex(mathptmx.sty) tex(natbib.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
