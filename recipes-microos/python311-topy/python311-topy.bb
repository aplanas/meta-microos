...
RPROVIDES:${PN} += "python3.11dist(topy) python311-topy python3dist(topy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-beautifulsoup4 python311-regex update-alternatives"
