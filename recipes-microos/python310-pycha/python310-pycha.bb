...
RPROVIDES:${PN} += "python3-pycha python3.10dist(pycha) python310-pycha python3dist(pycha)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-cairocffi update-alternatives"
