...
RPROVIDES:${PN} += "tex(combinedgraphics.sty) texlive-combinedgraphics"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.cfg) tex(color.sty) tex(graphicx.sty) tex(keyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
