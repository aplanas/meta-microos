...
RPROVIDES:${PN} += "libckteec.so.0()(64bit) libckteec0 libckteec0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libteec.so.1()(64bit)"
