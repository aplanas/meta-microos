...
RPROVIDES:${PN} += "gtk2-metatheme-gilouche gtk2-theme-SLED gtk2-theme-openSUSE metacity-theme-SLED metacity-theme-openSUSE"
RDEPENDS:${PN} += "/bin/sh gtk2 gtk2-engine-clearlooks tango-icon-theme"
