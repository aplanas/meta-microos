...
RPROVIDES:${PN} += "python3.10dist(udiskie) python3dist(udiskie) udiskie"
RDEPENDS:${PN} += "/usr/bin/python3 gdk-pixbuf-loader-rsvg python(abi) python3-PyYAML python3-docopt python3-gobject python3-setuptools python3-xml typelib(AppIndicator3) typelib(AyatanaAppIndicator3) typelib(GLib) typelib(Gio) typelib(Gtk) typelib(Notify) udisks2"
