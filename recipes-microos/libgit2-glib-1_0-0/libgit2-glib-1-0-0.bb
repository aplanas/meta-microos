...
RPROVIDES:${PN} += "libgit2-glib-1.0.so.0()(64bit) libgit2-glib-1_0-0 libgit2-glib-1_0-0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgio-2.0.so.0()(64bit) libgit2.so.1.6()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit)"
