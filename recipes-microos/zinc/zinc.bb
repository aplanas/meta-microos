...
RPROVIDES:${PN} += "mvn(com.typesafe.zinc:zinc) mvn(com.typesafe.zinc:zinc:pom:) zinc"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.scala-lang:scala-library) mvn(org.scala-sbt:incremental-compiler) sbt"
