...
RPROVIDES:${PN} += "gtk-sharp-beans-devel gtk-sharp-beans-devel(aarch-64) pkgconfig(gtk-sharp-beans-2.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gtk-sharp-beans pkgconfig(glib-sharp-2.0) pkgconfig(gtk-sharp-2.0)"
