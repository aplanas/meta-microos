...
RPROVIDES:${PN} += "python3.11dist(gear) python311-gear python3dist(gear)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-extras python311-pbr python311-python-daemon python311-six update-alternatives"
