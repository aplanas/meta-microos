...
RPROVIDES:${PN} += "libqsqlpsql.so()(64bit) libqsqlpsql.so(Qt_6)(64bit) libqsqlpsql.so(Qt_6.0)(64bit) libqsqlpsql.so(Qt_6.1)(64bit) libqsqlpsql.so(Qt_6.2)(64bit) libqsqlpsql.so(Qt_6.3)(64bit) libqsqlpsql.so(Qt_6.4)(64bit) libqsqlpsql.so(Qt_6.5)(64bit) libqsqlpsql.so(Qt_6.5.1_PRIVATE_API)(64bit) qt6-sql-postgresql qt6-sql-postgresql(aarch-64)"
