...
RPROVIDES:${PN} += "config(monitoring-plugins-repomd) monitoring-plugins-repomd nagios-plugins-repomd"
RDEPENDS:${PN} += "/bin/bash bash curl grep monitoring-plugins-common"
