...
RPROVIDES:${PN} += "config(texlive-skaknew-fonts) font(chessalphadiagram) font(skaknew-diagram) font(skaknew-diagramt) font(skaknew-figurine) font(skaknewfigurine) texlive-skaknew-fonts"
