...
RPROVIDES:${PN} += "ruby3.2-rubygem-down ruby3.2-rubygem-down(aarch-64) rubygem(down) rubygem(ruby:3.2.0:down) rubygem(ruby:3.2.0:down:5) rubygem(ruby:3.2.0:down:5.3) rubygem(ruby:3.2.0:down:5.3.1)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:addressable:2)"
