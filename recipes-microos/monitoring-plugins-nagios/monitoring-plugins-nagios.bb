...
RPROVIDES:${PN} += "monitoring-plugins-nagios monitoring-plugins-nagios(aarch-64) nagios-plugins-nagios"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) monitoring_daemon"
