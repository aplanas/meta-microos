...
RPROVIDES:${PN} += "python3.11dist(lmfit) python311-lmfit python3dist(lmfit)"
RDEPENDS:${PN} += "python(abi) python311-asteval python311-numpy python311-scipy python311-uncertainties"
