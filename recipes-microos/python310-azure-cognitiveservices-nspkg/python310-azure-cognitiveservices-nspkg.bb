...
RPROVIDES:${PN} += "python3-azure-cognitiveservices-nspkg python3.10dist(azure-cognitiveservices-nspkg) python310-azure-cognitiveservices-nspkg python3dist(azure-cognitiveservices-nspkg)"
