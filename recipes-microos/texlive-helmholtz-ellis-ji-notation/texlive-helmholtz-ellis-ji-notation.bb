...
RPROVIDES:${PN} += "tex(helmholtz-ellis-ji-notation.sty) texlive-helmholtz-ellis-ji-notation"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontspec.sty) texlive texlive-filesystem texlive-helmholtz-ellis-ji-notation-fonts texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
