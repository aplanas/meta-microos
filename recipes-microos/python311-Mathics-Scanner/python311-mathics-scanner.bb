...
RPROVIDES:${PN} += "python3.11dist(mathics-scanner) python311-Mathics-Scanner python3dist(mathics-scanner)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 /usr/bin/python3.11 python(abi) python311-PyYAML python311-chardet python311-click update-alternatives"
