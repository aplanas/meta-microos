...
RPROVIDES:${PN} += "perl(MooseX::Aliases) perl(MooseX::Aliases::Meta::Trait::Attribute) perl(MooseX::Aliases::Meta::Trait::Class) perl(MooseX::Aliases::Meta::Trait::Method) perl(MooseX::Aliases::Meta::Trait::Role) perl(MooseX::Aliases::Meta::Trait::Role::ApplicationToClass) perl(MooseX::Aliases::Meta::Trait::Role::ApplicationToRole) perl(MooseX::Aliases::Meta::Trait::Role::Composite) perl-MooseX-Aliases"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Moose) perl(Moose::Exporter) perl(Moose::Role) perl(Moose::Util::TypeConstraints)"
