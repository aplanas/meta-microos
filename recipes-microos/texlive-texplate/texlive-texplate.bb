...
RPROVIDES:${PN} += "tex(texplate.jar) texlive-texplate"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep java sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-texplate-bin"
