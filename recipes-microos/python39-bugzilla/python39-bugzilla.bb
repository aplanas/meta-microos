...
RPROVIDES:${PN} += "python3.9dist(python-bugzilla) python39-bugzilla python3dist(python-bugzilla)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-requests update-alternatives"
