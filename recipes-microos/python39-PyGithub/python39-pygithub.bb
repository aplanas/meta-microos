...
RPROVIDES:${PN} += "python3.9dist(pygithub) python39-PyGithub python3dist(pygithub)"
RDEPENDS:${PN} += "python(abi) python39-Deprecated python39-PyJWT python39-PyNaCl python39-requests"
