...
RPROVIDES:${PN} += "tex(hardmarg.sty) tex(screenplay.cls) texlive-screenplay"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(courier.sty) tex(geometry.sty) tex(ifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
