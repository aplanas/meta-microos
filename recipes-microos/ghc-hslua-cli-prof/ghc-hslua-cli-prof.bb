...
RPROVIDES:${PN} += "ghc-hslua-cli-prof ghc-hslua-cli-prof(aarch-64) ghc-prof(hslua-cli-1.4.1-EEaz0ST6ErtHZSjIcYe3Kp)"
RDEPENDS:${PN} += "ghc-hslua-cli-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(hslua-core-2.3.1-S0Tmk0QBS1InOMEfkNHVC) ghc-prof(hslua-marshalling-2.3.0-1lHdh994uwdEmrYudOnEBq) ghc-prof(hslua-repl-0.1.1-Cn1WzYftAVL4Hlxy0N0ea1) ghc-prof(lua-2.3.1-16mGxirchUh4T3oJJYdFzu) ghc-prof(text-2.0.2) ghc-prof(unix-2.7.3)"
