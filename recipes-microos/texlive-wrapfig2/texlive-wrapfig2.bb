...
RPROVIDES:${PN} += "tex(wrapfig2.sty) texlive-wrapfig2"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(curve2e.sty) tex(etoolbox.sty) tex(float.sty) tex(xcolor.sty) tex(xfp.sty) tex(xkeyval.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
