...
RPROVIDES:${PN} += "gedit-devel gedit-devel(aarch-64) gedit-doc gedit2-devel pkgconfig(gedit)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gedit gtksourceview-devel pkgconfig(amtk-5) pkgconfig(gio-2.0) pkgconfig(gtk+-3.0) pkgconfig(libpeas-gtk-1.0) pkgconfig(tepl-6) python3-gedit"
