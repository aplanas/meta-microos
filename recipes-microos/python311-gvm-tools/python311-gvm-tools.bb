...
RPROVIDES:${PN} += "python3.11dist(gvm-tools) python311-gvm-tools python3dist(gvm-tools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-python-gvm update-alternatives"
