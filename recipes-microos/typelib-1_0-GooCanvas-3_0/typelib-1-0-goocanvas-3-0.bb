...
RPROVIDES:${PN} += "typelib(GooCanvas) typelib-1_0-GooCanvas-3_0 typelib-1_0-GooCanvas-3_0(aarch-64)"
RDEPENDS:${PN} += "libgoocanvas-3.0.so.9()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
