...
RPROVIDES:${PN} += "libva-devel libva-devel(aarch-64) pkgconfig(libva) pkgconfig(libva-drm) pkgconfig(libva-wayland) pkgconfig(libva-x11)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libva-drm2 libva-wayland2 libva-x11-2 libva2 pkgconfig(libdrm) pkgconfig(libva) pkgconfig(wayland-client) pkgconfig(x11) pkgconfig(xfixes)"
