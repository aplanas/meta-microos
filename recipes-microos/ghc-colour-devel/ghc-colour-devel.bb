...
RPROVIDES:${PN} += "ghc-colour-devel ghc-colour-devel(aarch-64) ghc-devel(colour-2.3.6-7jQe2xj5Lsa5MbX38iH7Ln)"
RDEPENDS:${PN} += "/bin/sh ghc-colour ghc-compiler ghc-devel(base-4.17.1.0)"
