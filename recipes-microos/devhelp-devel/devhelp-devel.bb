...
RPROVIDES:${PN} += "devhelp-devel devhelp-devel(aarch-64) pkgconfig(libdevhelp-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config devhelp pkgconfig(gio-2.0) pkgconfig(gsettings-desktop-schemas) pkgconfig(gtk+-3.0) pkgconfig(webkit2gtk-4.1) typelib-1_0-Devhelp-3_0"
