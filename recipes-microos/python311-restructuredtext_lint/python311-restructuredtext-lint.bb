...
RPROVIDES:${PN} += "python3.11dist(restructuredtext-lint) python311-restructuredtext_lint python3dist(restructuredtext-lint)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-docutils update-alternatives"
