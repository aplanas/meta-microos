...
RPROVIDES:${PN} += "gdl-devel gdl-devel(aarch-64) pkgconfig(gdl-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgdl-3-5 pkgconfig(gtk+-3.0) pkgconfig(libxml-2.0) typelib-1_0-Gdl-3"
