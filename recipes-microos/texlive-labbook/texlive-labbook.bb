...
RPROVIDES:${PN} += "tex(labbook.cls) texlive-labbook"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(makeidx.sty) tex(scrbook.cls) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
