...
RPROVIDES:${PN} += "libgdm.so.1()(64bit) libgdm1 libgdm1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig gdm-schema ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libsystemd.so.0()(64bit) libsystemd.so.0(LIBSYSTEMD_209)(64bit)"
