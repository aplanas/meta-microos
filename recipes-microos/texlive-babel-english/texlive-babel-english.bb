...
RPROVIDES:${PN} += "tex(UKenglish.ldf) tex(USenglish.ldf) tex(american.ldf) tex(australian.ldf) tex(british.ldf) tex(canadian.ldf) tex(english.ldf) tex(newzealand.ldf) texlive-babel-english"
