...
RPROVIDES:${PN} += "typelib(GtkSource) typelib-1_0-GtkSource-3_0 typelib-1_0-GtkSource-3_0(aarch-64)"
RDEPENDS:${PN} += "libgtksourceview-3.0.so.1()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
