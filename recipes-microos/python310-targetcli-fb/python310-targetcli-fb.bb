...
RPROVIDES:${PN} += "python3-targetcli-fb python3.10dist(targetcli-fb) python310-targetcli-fb python3dist(targetcli-fb) targetcli targetcli-fb"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-configshell-fb python310-dbus-python python310-rtslib-fb python310-six targetcli-fb-common update-alternatives"
