...
RPROVIDES:${PN} += "ruby3.2-rubygem-mime ruby3.2-rubygem-mime(aarch-64) rubygem(mime) rubygem(ruby:3.2.0:mime) rubygem(ruby:3.2.0:mime:0) rubygem(ruby:3.2.0:mime:0.4) rubygem(ruby:3.2.0:mime:0.4.4)"
