...
RPROVIDES:${PN} += "python3-ConfigUpdater python3-configupdater python3.10dist(configupdater) python310-ConfigUpdater python310-configupdater python3dist(configupdater)"
