...
RPROVIDES:${PN} += "libXfont2-devel libXfont2-devel(aarch-64) pkgconfig(xfont2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXfont2-2 pkgconfig(fontenc) pkgconfig(fontsproto) pkgconfig(freetype2) pkgconfig(xproto) pkgconfig(zlib)"
