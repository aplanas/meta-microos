...
RPROVIDES:${PN} += "application() application(fcitx-light.desktop) fcitx-ui-light fcitx-ui-light(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libXft.so.2()(64bit) libXpm.so.4()(64bit) libc.so.6(GLIBC_2.17)(64bit) libfontconfig.so.1()(64bit)"
