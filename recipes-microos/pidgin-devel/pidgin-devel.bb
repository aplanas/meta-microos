...
RPROVIDES:${PN} += "pidgin-devel pidgin-devel(aarch-64) pkgconfig(pidgin)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libpurple-devel pidgin pkgconfig(glib-2.0) pkgconfig(gtk+-2.0) pkgconfig(purple)"
