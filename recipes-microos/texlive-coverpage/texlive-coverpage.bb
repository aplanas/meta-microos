...
RPROVIDES:${PN} += "tex(CoverPage.cfg) tex(CoverPage.sty) texlive-coverpage"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(keyval.sty) tex(textcomp.sty) tex(url.sty) tex(verbatim.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
