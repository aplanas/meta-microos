...
RPROVIDES:${PN} += "yast2-installation:/usr/share/YaST2/clients/vendor.ycp yast2-update yast2-update(aarch-64)"
RDEPENDS:${PN} += "pigz rubygem(ruby:3.2.0:nokogiri) yast2 yast2-installation yast2-packager yast2-pkg-bindings yast2-ruby-bindings yast2-storage-ng"
