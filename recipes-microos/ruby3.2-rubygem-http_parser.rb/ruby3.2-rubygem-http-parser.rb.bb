...
RPROVIDES:${PN} += "ruby3.2-rubygem-http_parser.rb ruby3.2-rubygem-http_parser.rb(aarch-64) rubygem(http_parser.rb) rubygem(ruby:3.2.0:http_parser.rb) rubygem(ruby:3.2.0:http_parser.rb:0) rubygem(ruby:3.2.0:http_parser.rb:0.8) rubygem(ruby:3.2.0:http_parser.rb:0.8.0)"
