...
RPROVIDES:${PN} += "python3.9dist(python-evtx) python39-evtx python3dist(python-evtx)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 alts python(abi) python39-hexdump python39-lxml python39-six"
