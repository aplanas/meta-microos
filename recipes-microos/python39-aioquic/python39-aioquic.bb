...
RPROVIDES:${PN} += "python3.9dist(aioquic) python39-aioquic python39-aioquic(aarch-64) python3dist(aioquic)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) python(abi) python39-certifi python39-cryptography python39-pyOpenSSL python39-pylsqpack"
