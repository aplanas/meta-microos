...
RPROVIDES:${PN} += "ghc-devel(email-validate-2.3.2.18-8MZFHS3GPuQLNTYP4EPLHD) ghc-email-validate-devel ghc-email-validate-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(attoparsec-0.14.4-21v4nlnPs0qLZ5R1FIK9u3) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(template-haskell-2.19.0.0) ghc-email-validate"
