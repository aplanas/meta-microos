...
RPROVIDES:${PN} += "tex(pdfxup-template.tex) texlive-pdfxup"
RDEPENDS:${PN} += "/bin/bash /bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-pdfxup-bin texlive-scripts texlive-scripts-bin"
