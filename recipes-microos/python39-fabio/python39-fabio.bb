...
RPROVIDES:${PN} += "python3.9dist(fabio) python39-fabio python39-fabio(aarch-64) python3dist(fabio)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-Pillow python39-h5py python39-lxml python39-numpy python39-qt5 update-alternatives"
