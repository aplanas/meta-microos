...
RPROVIDES:${PN} += "config(libibverbs) libbnxt_re-rdmav34.so()(64bit) libcxgb3-rdmav34.so()(64bit) libcxgb4-rdmav34.so()(64bit) liberdma-rdmav34.so()(64bit) libhfi1verbs-rdmav34.so()(64bit) libhns-rdmav34.so()(64bit) libibverbs libibverbs(aarch-64) libipathverbs-rdmav34.so()(64bit) libirdma-rdmav34.so()(64bit) libmthca-rdmav34.so()(64bit) libocrdma-rdmav34.so()(64bit) libqedr-rdmav34.so()(64bit) librxe-rdmav34.so()(64bit) libsiw-rdmav34.so()(64bit) libvmw_pvrdma-rdmav34.so()(64bit)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libefa1 libibverbs.so.1()(64bit) libibverbs.so.1(IBVERBS_1.1)(64bit) libibverbs.so.1(IBVERBS_PRIVATE_34)(64bit) libmana1 libmlx4-1 libmlx5-1 rdma-core(aarch-64)"
