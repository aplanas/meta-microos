...
RPROVIDES:${PN} += "python3-rss2email python3.10dist(rss2email) python310-rss2email python3dist(rss2email)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python3.10dist(feedparser) python3.10dist(html2text) python310-feedparser python310-html2text python310-setuptools update-alternatives"
