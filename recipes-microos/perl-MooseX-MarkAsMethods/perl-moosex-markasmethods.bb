...
RPROVIDES:${PN} += "perl(MooseX::MarkAsMethods) perl(MooseX::MarkAsMethods::MetaRole::MethodMarker) perl-MooseX-MarkAsMethods"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(B::Hooks::EndOfScope) perl(Moose) perl(Moose::Exporter) perl(Moose::Role) perl(Moose::Util::MetaRole) perl(namespace::autoclean)"
