...
RPROVIDES:${PN} += "python3.11dist(autopep8) python311-autopep8 python3dist(autopep8)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-pycodestyle update-alternatives"
