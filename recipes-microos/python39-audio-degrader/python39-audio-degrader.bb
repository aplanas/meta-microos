...
RPROVIDES:${PN} += "python3.9dist(audio-degrader) python39-audio-degrader python3dist(audio-degrader)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-SoundFile python39-scipy python39-sox update-alternatives"
