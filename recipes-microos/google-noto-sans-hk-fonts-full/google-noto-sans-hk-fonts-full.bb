...
RPROVIDES:${PN} += "google-noto-sans-hk-fonts-full noto-sans-hk-fonts-full"
RDEPENDS:${PN} += "google-noto-sans-hk-black-fonts google-noto-sans-hk-demilight-fonts google-noto-sans-hk-fonts google-noto-sans-hk-light-fonts google-noto-sans-hk-medium-fonts google-noto-sans-hk-thin-fonts"
