...
RPROVIDES:${PN} += "tex(keyvaltable.sty) texlive-keyvaltable"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(booktabs.sty) tex(colortbl.sty) tex(etoolbox.sty) tex(trimspaces.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
