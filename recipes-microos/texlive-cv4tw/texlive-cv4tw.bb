...
RPROVIDES:${PN} += "tex(cv4tw-scheme.sty) tex(cv4tw-theme-compact.sty) tex(cv4tw-theme-core.sty) tex(cv4tw-theme-sharp.sty) tex(cv4tw-theme-simple.sty) tex(cv4tw.cls) texlive-cv4tw"
