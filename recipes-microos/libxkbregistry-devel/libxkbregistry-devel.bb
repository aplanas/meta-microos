...
RPROVIDES:${PN} += "libxkbregistry-devel libxkbregistry-devel(aarch-64) pkgconfig(xkbregistry)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxkbregistry0 pkgconfig(libxml-2.0)"
