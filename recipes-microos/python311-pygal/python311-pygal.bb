...
RPROVIDES:${PN} += "python3.11dist(pygal) python311-pygal python3dist(pygal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-lxml update-alternatives"
