...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-personalizer) python311-azure-cognitiveservices-personalizer python3dist(azure-cognitiveservices-personalizer)"
