...
RPROVIDES:${PN} += "tex(mugsthesis.cls) texlive-mugsthesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(indentfirst.sty) tex(memoir.cls) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
