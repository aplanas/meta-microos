...
RPROVIDES:${PN} += "fcgiwrap fcgiwrap(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/mkdir /usr/bin/touch fillup libc.so.6(GLIBC_2.34)(64bit) libfcgi.so.0()(64bit) libsystemd.so.0()(64bit) libsystemd.so.0(LIBSYSTEMD_209)(64bit) systemd"
