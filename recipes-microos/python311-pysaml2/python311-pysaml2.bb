...
RPROVIDES:${PN} += "python3.11dist(pysaml2) python311-pysaml2 python311-pysaml2(aarch-64) python3dist(pysaml2)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Paste python311-cryptography python311-defusedxml python311-importlib-resources python311-pyOpenSSL python311-python-dateutil python311-pytz python311-repoze.who python311-requests python311-six python311-xmlschema python311-zope.interface update-alternatives"
