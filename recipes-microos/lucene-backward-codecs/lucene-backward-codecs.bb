...
RPROVIDES:${PN} += "lucene-backward-codecs mvn(org.apache.lucene:lucene-backward-codecs) mvn(org.apache.lucene:lucene-backward-codecs:pom:) osgi(org.apache.lucene.backward-codecs)"
