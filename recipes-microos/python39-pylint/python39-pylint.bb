...
RDEPENDS:${PN} += "(python39-astroid >= 2.15.4 with python39-astroid < 2.17.0~dev0) (python39-isort >= 4.2.5 with python39-isort < 6) (python39-mccabe >= 0.6 with python39-mccabe < 0.8) /bin/sh /usr/bin/python3.9 python(abi) python39-dill python39-platformdirs python39-tomli python39-tomlkit python39-typing-extensions update-alternatives"
