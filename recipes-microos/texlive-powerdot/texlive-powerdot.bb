...
RPROVIDES:${PN} += "tex(powerdot-aggie.sty) tex(powerdot-bframe.sty) tex(powerdot-ciment.sty) tex(powerdot-default.sty) tex(powerdot-elcolors.sty) tex(powerdot-fyma.sty) tex(powerdot-horatio.sty) tex(powerdot-husky.sty) tex(powerdot-ikeda.sty) tex(powerdot-jefka.sty) tex(powerdot-klope.sty) tex(powerdot-paintings.sty) tex(powerdot-pazik.sty) tex(powerdot-sailor.sty) tex(powerdot-simple.sty) tex(powerdot-tycja.sty) tex(powerdot-upen.sty) tex(powerdot.cls) texlive-powerdot"
