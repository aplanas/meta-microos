...
RPROVIDES:${PN} += "ghc-fgl-prof ghc-fgl-prof(aarch-64) ghc-prof(fgl-5.8.0.0-1euDADByC3LGFbnFGelVpn)"
RDEPENDS:${PN} += "ghc-fgl-devel ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(deepseq-1.4.8.0) ghc-prof(transformers-0.5.6.2)"
