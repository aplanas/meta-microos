...
RPROVIDES:${PN} += "pangomm-devel pangomm-devel(aarch-64) pkgconfig(pangomm-2.48)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libpangomm-2_48-1 pkgconfig(cairomm-1.16) pkgconfig(giomm-2.68) pkgconfig(pangocairo)"
