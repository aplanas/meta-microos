...
RPROVIDES:${PN} += "arm-none-eabi-gcc cross-arm-none-gcc12 cross-arm-none-gcc12(aarch-64)"
RDEPENDS:${PN} += "/bin/sh cross-arm-binutils libstdc++6-devel-gcc12 update-alternatives"
