...
RPROVIDES:${PN} += "jakarta-activation mvn(jakarta.activation:jakarta.activation-api) mvn(jakarta.activation:jakarta.activation-api:pom:) osgi(jakarta.activation-api)"
