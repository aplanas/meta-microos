...
RPROVIDES:${PN} += "perl(Date::Calc) perl(Date::Calc::Object) perl(Date::Calc::PP) perl(Date::Calendar) perl(Date::Calendar::Profiles) perl(Date::Calendar::Year) perl-Date-Calc"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Bit::Vector) perl(Carp::Clan)"
