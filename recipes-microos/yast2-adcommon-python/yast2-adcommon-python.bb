...
RDEPENDS:${PN} += "krb5-client python(abi) python3-keyring python3-ldap python3-ldb samba-client samba-dsdb-modules samba-python3 yast2 yast2-python3-bindings"
