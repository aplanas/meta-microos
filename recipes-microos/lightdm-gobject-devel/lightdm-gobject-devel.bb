...
RPROVIDES:${PN} += "lightdm-gobject-devel lightdm-gobject-devel(aarch-64) pkgconfig(liblightdm-gobject-1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblightdm-gobject-1-0 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libxklavier) pkgconfig(x11)"
