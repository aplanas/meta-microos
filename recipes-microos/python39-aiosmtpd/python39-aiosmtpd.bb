...
RPROVIDES:${PN} += "python3.9dist(aiosmtpd) python39-aiosmtpd python3dist(aiosmtpd)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-atpublic python39-attrs update-alternatives user(nobody)"
