...
RPROVIDES:${PN} += "liballegro_image.so.5.2()(64bit) liballegro_image5_2 liballegro_image5_2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) liballegro.so.5.2()(64bit) libc.so.6(GLIBC_2.17)(64bit) libfreeimage.so.3()(64bit) libjpeg.so.8()(64bit) libjpeg.so.8(LIBJPEG_8.0)(64bit) libpng16.so.16()(64bit) libpng16.so.16(PNG16_0)(64bit) libwebp.so.7()(64bit)"
