...
RPROVIDES:${PN} += "collectd-plugin-amqp collectd-plugin-amqp(aarch-64)"
RDEPENDS:${PN} += "collectd ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) librabbitmq.so.4()(64bit) libyajl.so.2()(64bit)"
