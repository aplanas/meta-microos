...
RPROVIDES:${PN} += "typelib(ModemManager) typelib-1_0-ModemManager-1_0 typelib-1_0-ModemManager-1_0(aarch-64)"
RDEPENDS:${PN} += "libmm-glib.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
