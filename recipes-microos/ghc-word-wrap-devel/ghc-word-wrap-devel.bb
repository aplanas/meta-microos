...
RPROVIDES:${PN} += "ghc-devel(word-wrap-0.5-8lP0dTi9CAzDFiJFYJ3rcZ) ghc-word-wrap-devel ghc-word-wrap-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(text-2.0.2) ghc-word-wrap"
