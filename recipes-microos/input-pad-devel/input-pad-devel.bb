...
RPROVIDES:${PN} += "input-pad-devel input-pad-devel(aarch-64) pkgconfig(input-pad)"
RDEPENDS:${PN} += "/usr/bin/pkg-config input-pad pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gtk+-3.0)"
