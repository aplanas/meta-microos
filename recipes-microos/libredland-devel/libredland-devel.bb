...
RPROVIDES:${PN} += "libredland-devel libredland-devel(aarch-64) pkgconfig(redland)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config librdf0 pkgconfig(raptor2) pkgconfig(rasqal)"
