...
RPROVIDES:${PN} += "python3.11dist(ndg-httpsclient) python311-ndg-httpsclient python3dist(ndg-httpsclient)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-pyOpenSSL python311-pyasn1 update-alternatives"
