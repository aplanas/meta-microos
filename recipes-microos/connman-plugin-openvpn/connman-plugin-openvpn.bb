...
RPROVIDES:${PN} += "connman-plugin-openvpn connman-plugin-openvpn(aarch-64)"
RDEPENDS:${PN} += "connman ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdbus-1.so.3()(64bit) libdbus-1.so.3(LIBDBUS_1_3)(64bit) openvpn"
