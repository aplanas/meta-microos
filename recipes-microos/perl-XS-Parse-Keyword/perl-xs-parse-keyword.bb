...
RPROVIDES:${PN} += "perl(XS::Parse::Infix) perl(XS::Parse::Infix::Builder) perl(XS::Parse::Infix::Builder_data) perl(XS::Parse::Keyword) perl(XS::Parse::Keyword::Builder) perl(XS::Parse::Keyword::Builder_data) perl-XS-Parse-Keyword perl-XS-Parse-Keyword(aarch-64)"
