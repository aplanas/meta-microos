...
RPROVIDES:${PN} += "python3-hvplot python3.10dist(hvplot) python310-hvplot python3dist(hvplot)"
RDEPENDS:${PN} += "(python310-bokeh >= 1.0.0 with python310-bokeh < 2.5) python(abi) python310-colorcet python310-holoviews python310-numpy python310-packaging python310-pandas python310-panel python310-param update-alternatives"
