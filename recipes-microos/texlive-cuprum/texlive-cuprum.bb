...
RPROVIDES:${PN} += "tex(cprbit8t.tfm) tex(cprbn8t.tfm) tex(cprmit8t.tfm) tex(cprmn8t.tfm) tex(cuprum.map) tex(cuprum.sty) tex(t1cpr.fd) texlive-cuprum"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-cuprum-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
