...
RPROVIDES:${PN} += "python3.11dist(astunparse) python311-astunparse python311-astunparse(aarch-64) python3dist(astunparse)"
RDEPENDS:${PN} += "python(abi) python311-six python311-wheel"
