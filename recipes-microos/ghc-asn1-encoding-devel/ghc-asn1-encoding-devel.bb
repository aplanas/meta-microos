...
RPROVIDES:${PN} += "ghc-asn1-encoding-devel ghc-asn1-encoding-devel(aarch-64) ghc-devel(asn1-encoding-0.9.6-Hputs8NTOGr9EmEd7QDXHk)"
RDEPENDS:${PN} += "/bin/sh ghc-asn1-encoding ghc-compiler ghc-devel(asn1-types-0.3.4-GYlFjiH4jmgJII5TgUQfXm) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(hourglass-0.2.12-3PFbUFQLMNb8Ad2s9SU5p3)"
