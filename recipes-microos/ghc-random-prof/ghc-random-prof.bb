...
RPROVIDES:${PN} += "ghc-prof(random-1.2.1.1-I0wUgAAbf0g3qHR3e8uT0o) ghc-random-prof ghc-random-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(mtl-2.2.2) ghc-prof(splitmix-0.1.0.4-7e8CibdlMRLAGh7KO5VlFe) ghc-random-devel"
