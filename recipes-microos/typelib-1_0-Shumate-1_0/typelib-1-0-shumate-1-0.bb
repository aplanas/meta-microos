...
RPROVIDES:${PN} += "typelib(Shumate) typelib-1_0-Shumate-1_0 typelib-1_0-Shumate-1_0(aarch-64)"
RDEPENDS:${PN} += "libshumate-1.0.so.1()(64bit) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Graphene) typelib(Gsk) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(PangoCairo) typelib(cairo) typelib(freetype2)"
