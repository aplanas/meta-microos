...
RPROVIDES:${PN} += "man(lacheck.1) texlive-lacheck"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-lacheck-bin texlive-scripts texlive-scripts-bin"
