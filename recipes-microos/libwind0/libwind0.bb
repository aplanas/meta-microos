...
RPROVIDES:${PN} += "libwind.so.0()(64bit) libwind.so.0(HEIMDAL_WIND_1.0)(64bit) libwind0 libwind0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcom_err.so.2()(64bit)"
