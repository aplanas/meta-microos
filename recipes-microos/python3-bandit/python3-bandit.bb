...
RPROVIDES:${PN} += "python3-bandit python3.10dist(bandit) python3dist(bandit)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 python(abi) python3-GitPython python3-PyYAML python3-stestr python3-stevedore python3-toml update-alternatives"
