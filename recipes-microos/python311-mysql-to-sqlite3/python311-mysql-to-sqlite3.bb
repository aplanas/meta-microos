...
RPROVIDES:${PN} += "python3.11dist(mysql-to-sqlite3) python311-mysql-to-sqlite3 python3dist(mysql-to-sqlite3)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-click python311-mysql-connector-python python311-python-slugify python311-pytimeparse python311-simplejson python311-six python311-tabulate python311-tqdm"
