...
RPROVIDES:${PN} += "bamf-devel bamf-devel(aarch-64) pkgconfig(libbamf3)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libbamf3-2 pkgconfig(gio-2.0) pkgconfig(glib-2.0) typelib-1_0-Bamf-3_0"
