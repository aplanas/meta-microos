...
RPROVIDES:${PN} += "python3-oletools python3.10dist(oletools) python310-oletools python3dist(oletools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-colorclass python310-easygui python310-msoffcrypto-tool python310-olefile python310-pyparsing"
