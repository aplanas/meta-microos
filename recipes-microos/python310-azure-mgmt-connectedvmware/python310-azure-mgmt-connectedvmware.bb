...
RPROVIDES:${PN} += "python3-azure-mgmt-connectedvmware python3.10dist(azure-mgmt-connectedvmware) python310-azure-mgmt-connectedvmware python3dist(azure-mgmt-connectedvmware)"
