...
RPROVIDES:${PN} += "python3-azure-mgmt-commerce python3.10dist(azure-mgmt-commerce) python310-azure-mgmt-commerce python3dist(azure-mgmt-commerce)"
RDEPENDS:${PN} += "python(abi) python310-azure-common python310-azure-mgmt-core python310-azure-mgmt-nspkg python310-azure-nspkg"
