...
RPROVIDES:${PN} += "libgtpnl-tools libgtpnl-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgtpnl.so.0()(64bit) libgtpnl.so.0(LIBGTPNL_1.0)(64bit) libmnl.so.0()(64bit) libmnl.so.0(LIBMNL_1.0)(64bit)"
