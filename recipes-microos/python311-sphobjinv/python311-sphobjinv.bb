...
RPROVIDES:${PN} += "python3.11dist(sphobjinv) python311-sphobjinv python3dist(sphobjinv)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-attrs python311-certifi python311-jsonschema update-alternatives"
