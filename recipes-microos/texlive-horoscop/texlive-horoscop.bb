...
RPROVIDES:${PN} += "tex(horoscop.sty) texlive-horoscop"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(iftex.sty) tex(marvosym.sty) tex(pict2e.sty) tex(starfont.sty) tex(trig.sty) tex(wasysym.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
