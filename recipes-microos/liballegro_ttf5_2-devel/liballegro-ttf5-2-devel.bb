...
RPROVIDES:${PN} += "liballegro_ttf5_2-devel liballegro_ttf5_2-devel(aarch-64) pkgconfig(allegro_ttf-5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liballegro_ttf5_2 pkgconfig(allegro_font-5)"
