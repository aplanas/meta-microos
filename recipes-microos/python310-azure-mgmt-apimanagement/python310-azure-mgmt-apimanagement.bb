...
RPROVIDES:${PN} += "python3-azure-mgmt-apimanagement python3.10dist(azure-mgmt-apimanagement) python310-azure-mgmt-apimanagement python3dist(azure-mgmt-apimanagement)"
