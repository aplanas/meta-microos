...
RPROVIDES:${PN} += "ghc-devel(fgl-5.8.0.0-1euDADByC3LGFbnFGelVpn) ghc-fgl-devel ghc-fgl-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(deepseq-1.4.8.0) ghc-devel(transformers-0.5.6.2) ghc-fgl"
