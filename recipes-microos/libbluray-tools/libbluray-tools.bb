...
RPROVIDES:${PN} += "libbluray-tools libbluray-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbluray.so.2()(64bit) libc.so.6(GLIBC_2.34)(64bit)"
