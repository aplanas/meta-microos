...
RPROVIDES:${PN} += "ghc-css-text-devel ghc-css-text-devel(aarch-64) ghc-devel(css-text-0.1.3.0-21S5OjTqOp19taDQmfqmQs)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-css-text ghc-devel(attoparsec-0.14.4-21v4nlnPs0qLZ5R1FIK9u3) ghc-devel(base-4.17.1.0) ghc-devel(text-2.0.2)"
