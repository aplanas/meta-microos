...
RPROVIDES:${PN} += "ruby3.2-rubygem-rouge ruby3.2-rubygem-rouge(aarch-64) rubygem(rouge) rubygem(ruby:3.2.0:rouge) rubygem(ruby:3.2.0:rouge:4) rubygem(ruby:3.2.0:rouge:4.0) rubygem(ruby:3.2.0:rouge:4.0.0)"
