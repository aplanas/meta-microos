...
RPROVIDES:${PN} += "python38-lalburst python38-lalburst(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgsl.so.25()(64bit) liblal.so.20()(64bit) liblalburst.so.6()(64bit) liblalsupport.so.14()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.29)(64bit) python(abi) python38-glue python38-lal python38-lalmetaio python38-lalsimulation python38-ligo-lw python38-numpy python38-scipy"
