...
RPROVIDES:${PN} += "libpositioningquickplugin.so()(64bit) libpositioningquickplugin.so(Qt_6)(64bit) libpositioningquickplugin.so(Qt_6.0)(64bit) libpositioningquickplugin.so(Qt_6.1)(64bit) libpositioningquickplugin.so(Qt_6.2)(64bit) libpositioningquickplugin.so(Qt_6.3)(64bit) libpositioningquickplugin.so(Qt_6.4)(64bit) libpositioningquickplugin.so(Qt_6.5)(64bit) libpositioningquickplugin.so(Qt_6.5.1_PRIVATE_API)(64bit) qt6-location-imports qt6-positioning-imports qt6-positioning-imports(aarch-64) qt6qmlimport(QtPositioning.2) qt6qmlimport(QtPositioning.5) qt6qmlimport(QtPositioning.6)"
