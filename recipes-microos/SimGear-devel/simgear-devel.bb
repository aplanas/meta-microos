...
RPROVIDES:${PN} += "SimGear-devel SimGear-devel(aarch-64) cmake(SimGear)"
RDEPENDS:${PN} += "libOpenSceneGraph-devel libSimGearCore-2020_3_18 pkgconfig(liblzma) pkgconfig(openal) pkgconfig(zlib) udns-devel"
