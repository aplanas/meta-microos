...
RPROVIDES:${PN} += "libseafile.so.0()(64bit) libseafile0 libseafile0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libsearpc.so.1()(64bit)"
