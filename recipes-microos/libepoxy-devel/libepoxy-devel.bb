...
RPROVIDES:${PN} += "libepoxy-devel libepoxy-devel(aarch-64) pkgconfig(epoxy)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libepoxy0 pkgconfig(egl) pkgconfig(gl) pkgconfig(x11)"
