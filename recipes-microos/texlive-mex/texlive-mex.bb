...
RPROVIDES:${PN} += "config(texlive-mex) tex(lamex.tex) tex(mex.tex) tex(mex1.tex) tex(mex2.tex) tex(mexconf.tex) texlive-mex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(language.dat) tex(language.dat.lua) tex(language.def) texlive texlive-enctex texlive-filesystem texlive-hyph-utf8 texlive-hyphen-base texlive-hyphen-polish texlive-knuth-lib texlive-kpathsea texlive-kpathsea-bin texlive-mex-bin texlive-pdftex texlive-pl texlive-plain texlive-scripts texlive-scripts-bin texlive-tex texlive-tex-ini-files texlive-utf8mex"
