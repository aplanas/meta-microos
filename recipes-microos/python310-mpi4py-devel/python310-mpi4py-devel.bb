...
RPROVIDES:${PN} += "python3-mpi4py-devel python310-mpi4py-devel python310-mpi4py-devel(aarch-64)"
RDEPENDS:${PN} += "python310-devel python310-mpi4py python310-mpi4py-common-devel"
