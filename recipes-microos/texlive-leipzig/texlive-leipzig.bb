...
RPROVIDES:${PN} += "tex(leipzig.sty) tex(leipzig.tex) texlive-leipzig"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(glossaries.sty) tex(glossary-inline.sty) tex(glossary-mcols.sty) tex(glossary-tree.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
