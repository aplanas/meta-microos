...
RPROVIDES:${PN} += "perl(CsgFunctions) perl(CsgSimplex) votca-common votca-csg-common votca-xtp-common"
RDEPENDS:${PN} += "/bin/bash /usr/bin/awk /usr/bin/perl /usr/bin/python3 bash perl"
