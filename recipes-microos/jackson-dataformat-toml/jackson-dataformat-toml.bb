...
RPROVIDES:${PN} += "jackson-dataformat-toml mvn(com.fasterxml.jackson.dataformat:jackson-dataformat-toml) mvn(com.fasterxml.jackson.dataformat:jackson-dataformat-toml:pom:) osgi(com.fasterxml.jackson.dataformat.jackson-dataformat-toml)"
