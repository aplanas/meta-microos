...
RPROVIDES:${PN} += "ghc-IfElse-prof ghc-IfElse-prof(aarch-64) ghc-prof(IfElse-0.85-7KBtFS87aFz8e1Xg4MUrMX)"
RDEPENDS:${PN} += "ghc-IfElse-devel ghc-prof(base-4.17.1.0) ghc-prof(mtl-2.2.2)"
