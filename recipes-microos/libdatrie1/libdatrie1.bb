...
RPROVIDES:${PN} += "libdatrie.so.1()(64bit) libdatrie.so.1(DATRIE_0.2)(64bit) libdatrie.so.1(DATRIE_0.2.13)(64bit) libdatrie.so.1(DATRIE_0.2.4)(64bit) libdatrie.so.1(DATRIE_0.2.6)(64bit) libdatrie.so.1(DATRIE_0.2.7)(64bit) libdatrie1 libdatrie1(aarch-64)"
