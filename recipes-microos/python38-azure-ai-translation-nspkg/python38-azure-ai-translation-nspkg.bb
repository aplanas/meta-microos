...
RPROVIDES:${PN} += "python3.8dist(azure-ai-translation-nspkg) python38-azure-ai-translation-nspkg python3dist(azure-ai-translation-nspkg)"
RDEPENDS:${PN} += "python38-azure-ai-nspkg python38-azure-nspkg"
