...
RPROVIDES:${PN} += "farstream-devel farstream-devel(aarch-64) pkgconfig(farstream-0.2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libfarstream-0_2-5 pkgconfig(gstreamer-1.0) pkgconfig(gstreamer-base-1.0) typelib-1_0-Farstream-0_2"
