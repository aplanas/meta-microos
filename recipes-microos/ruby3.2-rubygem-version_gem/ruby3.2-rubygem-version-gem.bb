...
RPROVIDES:${PN} += "ruby3.2-rubygem-version_gem ruby3.2-rubygem-version_gem(aarch-64) rubygem(ruby:3.2.0:version_gem) rubygem(ruby:3.2.0:version_gem:1) rubygem(ruby:3.2.0:version_gem:1.1) rubygem(ruby:3.2.0:version_gem:1.1.1) rubygem(version_gem)"
