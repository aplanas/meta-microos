...
RPROVIDES:${PN} += "typelib(GVncPulse) typelib-1_0-GVncPulse-1_0 typelib-1_0-GVncPulse-1_0(aarch-64)"
RDEPENDS:${PN} += "libgvncpulse-1.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(GVnc) typelib(Gio)"
