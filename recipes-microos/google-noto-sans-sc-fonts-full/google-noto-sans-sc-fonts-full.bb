...
RPROVIDES:${PN} += "google-noto-sans-sc-fonts-full noto-sans-sc-fonts-full"
RDEPENDS:${PN} += "google-noto-sans-sc-black-fonts google-noto-sans-sc-demilight-fonts google-noto-sans-sc-fonts google-noto-sans-sc-light-fonts google-noto-sans-sc-medium-fonts google-noto-sans-sc-thin-fonts"
