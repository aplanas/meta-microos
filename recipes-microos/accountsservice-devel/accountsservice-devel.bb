...
RPROVIDES:${PN} += "accountsservice-devel accountsservice-devel(aarch-64) pkgconfig(accountsservice)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libaccountsservice0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(polkit-gobject-1) typelib-1_0-AccountsService-1_0"
