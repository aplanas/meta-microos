...
RPROVIDES:${PN} += "jawn-ast mvn(org.spire-math:jawn-ast_2.10) mvn(org.spire-math:jawn-ast_2.10:pom:) mvn(org.typelevel:jawn-ast_2.10) mvn(org.typelevel:jawn-ast_2.10:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.scala-lang:scala-library) mvn(org.typelevel:jawn-parser_2.10) mvn(org.typelevel:jawn-util_2.10)"
