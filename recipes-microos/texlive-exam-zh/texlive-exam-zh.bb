...
RPROVIDES:${PN} += "tex(exam-zh-chinese-english.sty) tex(exam-zh-choices.sty) tex(exam-zh-font.sty) tex(exam-zh-question.sty) tex(exam-zh-symbols.sty) tex(exam-zh-textfigure.sty) tex(exam-zh.cls) texlive-exam-zh"
