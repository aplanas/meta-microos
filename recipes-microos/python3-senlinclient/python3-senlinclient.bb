...
RPROVIDES:${PN} += "python3-senlinclient python3.10dist(python-senlinclient) python3dist(python-senlinclient)"
RDEPENDS:${PN} += "python(abi) python3-PrettyTable python3-PyYAML python3-heatclient python3-keystoneauth1 python3-openstackclient python3-openstacksdk python3-osc-lib python3-oslo.i18n python3-oslo.serialization python3-oslo.utils python3-pbr python3-requests"
