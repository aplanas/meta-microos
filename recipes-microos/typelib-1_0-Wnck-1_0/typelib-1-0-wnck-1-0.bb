...
RPROVIDES:${PN} += "typelib(Wnck) typelib-1_0-Wnck-1_0 typelib-1_0-Wnck-1_0(aarch-64)"
RDEPENDS:${PN} += "libwnck-1.so.22()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2)"
