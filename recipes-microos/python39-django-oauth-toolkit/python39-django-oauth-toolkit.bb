...
RPROVIDES:${PN} += "python3.9dist(django-oauth-toolkit) python39-django-oauth-toolkit python3dist(django-oauth-toolkit)"
RDEPENDS:${PN} += "python(abi) python39-Django python39-jwcrypto python39-oauthlib python39-requests"
