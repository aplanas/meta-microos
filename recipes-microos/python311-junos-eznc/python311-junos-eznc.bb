...
RPROVIDES:${PN} += "python3.11dist(junos-eznc) python311-junos-eznc python3dist(junos-eznc)"
RDEPENDS:${PN} += "python(abi) python311-Jinja2 python311-PyYAML python311-lxml python311-ncclient python311-netaddr python311-ntc-templates python311-paramiko python311-pyparsing python311-pyserial python311-scp python311-six python311-transitions"
