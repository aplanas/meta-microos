...
RPROVIDES:${PN} += "tex(bezierplot.sty) texlive-bezierplot"
RDEPENDS:${PN} += "/bin/sh /usr/bin/lua coreutils ed findutils grep sed tex(iftex.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
