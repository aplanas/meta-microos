...
RPROVIDES:${PN} += "python3.9dist(spotipy) python39-spotipy python3dist(spotipy)"
RDEPENDS:${PN} += "python(abi) python39-redis python39-requests python39-six python39-urllib3"
