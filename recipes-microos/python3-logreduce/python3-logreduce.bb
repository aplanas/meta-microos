...
RPROVIDES:${PN} += "python3-logreduce python3.10dist(logreduce) python3dist(logreduce)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-CherryPy python3-PyYAML python3-SQLAlchemy python3-aiohttp python3-alembic python3-gear python3-numpy python3-requests python3-scikit-learn python3-scipy python3-voluptuous"
