...
RPROVIDES:${PN} += "python3-azure-communication-chat python3.10dist(azure-communication-chat) python310-azure-communication-chat python3dist(azure-communication-chat)"
