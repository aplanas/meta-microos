...
RPROVIDES:${PN} += "typelib(Template) typelib-1_0-Template-1_0 typelib-1_0-Template-1_0(aarch-64)"
RDEPENDS:${PN} += "libtemplate_glib-1.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
