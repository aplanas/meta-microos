...
RPROVIDES:${PN} += "python3-dennis python3.10dist(dennis) python310-dennis python3dist(dennis)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-click python310-polib update-alternatives"
