...
RPROVIDES:${PN} += "tex(cjkutf8-josa.sty) tex(cjkutf8-ko.sty) tex(cjkutf8-nanummjhanja.sty) tex(kolabels-utf.sty) tex(konames-utf.sty) tex(kotex.sty) texlive-cjk-ko"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(CJKfntef.sty) tex(CJKutf8.sty) tex(kotexutf.sty) tex(luatexko.sty) tex(ulem.sty) tex(xetexko.sty) texlive texlive-cjk texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
