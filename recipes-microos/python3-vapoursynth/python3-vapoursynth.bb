...
RPROVIDES:${PN} += "python3-vapoursynth python3-vapoursynth(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libvapoursynth-62.so()(64bit) python(abi)"
