...
RPROVIDES:${PN} += "tex(10point.tex) tex(10pointss.tex) tex(11point.tex) tex(12point.tex) tex(14point.tex) tex(17point.tex) tex(20point.tex) tex(7point.tex) tex(8point.tex) tex(9point.tex) texlive-varisize"
