...
RPROVIDES:${PN} += "libcangjie-tools libcangjie-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcangjie.so.2()(64bit) libcangjie2 libsqlite3.so.0()(64bit)"
