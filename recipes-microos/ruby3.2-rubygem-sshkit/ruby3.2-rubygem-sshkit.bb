...
RPROVIDES:${PN} += "ruby3.2-rubygem-sshkit ruby3.2-rubygem-sshkit(aarch-64) rubygem(ruby:3.2.0:sshkit) rubygem(ruby:3.2.0:sshkit:1) rubygem(ruby:3.2.0:sshkit:1.21) rubygem(ruby:3.2.0:sshkit:1.21.3) rubygem(sshkit)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:net-scp) rubygem(ruby:3.2.0:net-ssh)"
