...
RPROVIDES:${PN} += "tex(frontespizio.sty) texlive-frontespizio"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(afterpage.sty) tex(atbegshi.sty) tex(environ.sty) tex(graphicx.sty) tex(ifpdf.sty) tex(ifxetex.sty) tex(inputenc.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
