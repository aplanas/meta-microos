...
RPROVIDES:${PN} += "python3-neovim python3-nvim python3.10dist(pynvim) python310-neovim python310-nvim python3dist(pynvim)"
RDEPENDS:${PN} += "neovim python(abi) python310-greenlet python310-msgpack-python"
