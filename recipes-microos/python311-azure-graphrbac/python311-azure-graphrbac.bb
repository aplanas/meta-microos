...
RPROVIDES:${PN} += "python3.11dist(azure-graphrbac) python311-azure-graphrbac python3dist(azure-graphrbac)"
RDEPENDS:${PN} += "python(abi) python311-azure-common python311-azure-nspkg python311-msrest python311-msrestazure"
