...
application(messages.desktop) \
application(org.opensuse.yast.Group.Hardware.desktop) \
application(org.opensuse.yast.Group.HighAvailability.desktop) \
application(org.opensuse.yast.Group.Misc.desktop) \
application(org.opensuse.yast.Group.NetworkServices.desktop) \
application(org.opensuse.yast.Group.Security.desktop) \
application(org.opensuse.yast.Group.Software.desktop) \
application(org.opensuse.yast.Group.Support.desktop) \
application(org.opensuse.yast.Group.System.desktop) \
application(org.opensuse.yast.Group.Virtualization.desktop) \
perl(MailTable) \
