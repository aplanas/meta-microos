...
RPROVIDES:${PN} += "tex(ltxguidex.cls) texlive-ltxguidex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(enumitem.sty) tex(framed.sty) tex(hyperref.sty) tex(ltxguide.cls) tex(showexpl.sty) tex(xcolor.sty) tex(xkeyval.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
