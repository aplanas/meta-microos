...
RPROVIDES:${PN} += "font(xyatip) font(xybsql) font(xybtip) font(xycirc) font(xycmat) font(xycmbt) font(xydash) font(xyeuat) font(xyeubt) font(xyluat) font(xylubt) texlive-xypic-fonts"
