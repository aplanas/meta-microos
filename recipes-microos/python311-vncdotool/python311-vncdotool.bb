...
RPROVIDES:${PN} += "python3.11dist(vncdotool) python311-vncdotool python3dist(vncdotool)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Pillow python311-Twisted update-alternatives"
