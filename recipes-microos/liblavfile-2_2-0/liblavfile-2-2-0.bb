...
RPROVIDES:${PN} += "liblavfile-2.2.so.0()(64bit) liblavfile-2_2-0 liblavfile-2_2-0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libdv.so.4()(64bit) libmjpegutils-2.2.so.0()(64bit) libquicktime.so.0()(64bit)"
