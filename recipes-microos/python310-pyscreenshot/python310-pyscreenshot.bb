...
RPROVIDES:${PN} += "python3-pyscreenshot python3.10dist(pyscreenshot) python310-pyscreenshot python3dist(pyscreenshot)"
RDEPENDS:${PN} += "python(abi) python310-EasyProcess python310-entrypoint2 python310-jeepney python310-mss xorg-x11-server-extra"
