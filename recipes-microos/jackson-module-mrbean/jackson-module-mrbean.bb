...
RPROVIDES:${PN} += "jackson-module-mrbean mvn(com.fasterxml.jackson.module:jackson-module-mrbean) mvn(com.fasterxml.jackson.module:jackson-module-mrbean:pom:) osgi(com.fasterxml.jackson.module.jackson-module-mrbean)"
