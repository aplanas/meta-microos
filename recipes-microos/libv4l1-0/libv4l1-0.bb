...
RPROVIDES:${PN} += "libv4l1-0 libv4l1-0(aarch-64) libv4l1.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libv4l libv4l2.so.0()(64bit)"
