...
RPROVIDES:${PN} += "liblastfm-qt5-devel liblastfm-qt5-devel(aarch-64)"
RDEPENDS:${PN} += "liblastfm5-1 liblastfm_fingerprint5-1 pkgconfig pkgconfig(Qt5Core) pkgconfig(Qt5DBus) pkgconfig(Qt5Network) pkgconfig(Qt5Xml)"
