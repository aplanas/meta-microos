...
RPROVIDES:${PN} += "libqobs-devel libqobs-devel(aarch-64) pkgconfig(libqobs)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libqobs2(aarch-64) pkgconfig(Qt5Core) pkgconfig(Qt5Gui) pkgconfig(Qt5Network)"
