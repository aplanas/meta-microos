...
RPROVIDES:${PN} += "python3.10dist(trytond-stock) python3dist(trytond-stock) trytond_stock"
RDEPENDS:${PN} += "python(abi) trytond trytond_company trytond_currency trytond_party trytond_product"
