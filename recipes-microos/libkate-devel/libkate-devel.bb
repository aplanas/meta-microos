...
RPROVIDES:${PN} += "libkate-devel libkate-devel(aarch-64) pkgconfig(kate) pkgconfig(oggkate)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libkate1 liboggkate1 pkgconfig(kate) pkgconfig(ogg)"
