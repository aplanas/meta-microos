...
RPROVIDES:${PN} += "tex(hep-bibliography.sty) texlive-hep-bibliography"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(biblatex.sty) tex(kvoptions.sty) tex(relsize.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
