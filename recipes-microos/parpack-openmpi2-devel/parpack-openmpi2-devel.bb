...
RPROVIDES:${PN} += "parpack-openmpi2-devel parpack-openmpi2-devel(aarch-64)"
RDEPENDS:${PN} += "blas-devel gcc-fortran lapack-devel libparpack2-openmpi2 openmpi2-devel"
