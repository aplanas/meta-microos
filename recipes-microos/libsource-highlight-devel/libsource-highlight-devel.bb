...
RPROVIDES:${PN} += "libsource-highlight-devel libsource-highlight-devel(aarch-64) pkgconfig(source-highlight)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libsource-highlight4"
