...
RPROVIDES:${PN} += "tex(copti.tfm) tex(coptic.sty) tex(copto.tfm) tex(lcopcoptic.fd) tex(prnthyph.sty) texlive-cbcoptic"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(textcomp.sty) texlive texlive-cbcoptic-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
