...
RPROVIDES:${PN} += "python3-python-jose python3.10dist(python-jose) python310-python-jose python3dist(python-jose)"
RDEPENDS:${PN} += "python(abi) python310-ecdsa python310-pyasn1 python310-rsa"
