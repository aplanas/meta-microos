...
RPROVIDES:${PN} += "tex(ulqda.sty) texlive-ulqda"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl coreutils ed findutils grep perl(Digest::SHA1) perl(Getopt::Long) sed tex(dot2texi.sty) tex(multicol.sty) tex(soul.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-ulqda-bin"
