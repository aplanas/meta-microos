...
RPROVIDES:${PN} += "felix-gogo-parent mvn(org.apache.felix:gogo-parent:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.felix:felix-parent:pom:)"
