...
RPROVIDES:${PN} += "netcdf_4_9_2-gnu-mpich-hpc-devel-static netcdf_4_9_2-gnu-mpich-hpc-devel-static(aarch-64)"
RDEPENDS:${PN} += "libcurl-devel netcdf_4_9_2-gnu-mpich-hpc-devel zlib-devel"
