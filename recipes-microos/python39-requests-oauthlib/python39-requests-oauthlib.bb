...
RPROVIDES:${PN} += "python3.9dist(requests-oauthlib) python39-requests-oauthlib python3dist(requests-oauthlib)"
RDEPENDS:${PN} += "python(abi) python39-oauthlib python39-requests"
