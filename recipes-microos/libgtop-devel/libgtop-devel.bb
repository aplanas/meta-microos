...
RPROVIDES:${PN} += "libgtop-devel libgtop-devel(aarch-64) pkgconfig(libgtop-2.0)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libgtop-2_0-11 pkgconfig(glib-2.0) typelib-1_0-GTop-2_0"
