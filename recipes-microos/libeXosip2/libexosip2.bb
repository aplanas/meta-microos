...
RPROVIDES:${PN} += "libeXosip2 libeXosip2(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libeXosip2.so.15()(64bit) libosip2.so.15()(64bit) libosipparser2.so.15()(64bit)"
