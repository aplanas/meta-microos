...
RPROVIDES:${PN} += "mpeg2dec mpeg2dec(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libmpeg2-0 libmpeg2.so.0()(64bit) libmpeg2convert.so.0()(64bit) libmpeg2convert0"
