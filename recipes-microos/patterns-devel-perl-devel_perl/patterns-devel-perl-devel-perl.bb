...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-devel-perl-devel_perl patterns-devel-perl-devel_perl(aarch-64)"
RDEPENDS:${PN} += ""
