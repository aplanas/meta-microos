...
RPROVIDES:${PN} += "tex(lua-typo-2021-04-18.sty) tex(lua-typo.cfg) tex(lua-typo.sty) texlive-lua-typo"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atveryend.sty) tex(kvoptions.sty) tex(luacode.sty) tex(luacolor.sty) tex(luatexbase.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
