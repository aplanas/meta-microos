...
RPROVIDES:${PN} += "python3.11dist(azure-mgmt-datalake-store) python311-azure-mgmt-datalake-store python3dist(azure-mgmt-datalake-store)"
RDEPENDS:${PN} += "python(abi) python311-azure-common python311-azure-mgmt-core python311-azure-mgmt-datalake-nspkg python311-azure-mgmt-nspkg python311-azure-nspkg python311-msrest"
