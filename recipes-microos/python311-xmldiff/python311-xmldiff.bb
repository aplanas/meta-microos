...
RPROVIDES:${PN} += "python3.11dist(xmldiff) python311-xmldiff python3dist(xmldiff)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-lxml python311-setuptools update-alternatives"
