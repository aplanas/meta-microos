...
RPROVIDES:${PN} += "ruby3.2-rubygem-docile ruby3.2-rubygem-docile(aarch-64) rubygem(docile) rubygem(ruby:3.2.0:docile) rubygem(ruby:3.2.0:docile:1) rubygem(ruby:3.2.0:docile:1.4) rubygem(ruby:3.2.0:docile:1.4.0)"
