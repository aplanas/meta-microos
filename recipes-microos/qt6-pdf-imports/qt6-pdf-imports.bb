...
RPROVIDES:${PN} += "libpdfquickplugin.so()(64bit) \
libpdfquickplugin.so(Qt_6)(64bit) \
libpdfquickplugin.so(Qt_6.0)(64bit) \
libpdfquickplugin.so(Qt_6.1)(64bit) \
libpdfquickplugin.so(Qt_6.2)(64bit) \
libpdfquickplugin.so(Qt_6.3)(64bit) \
libpdfquickplugin.so(Qt_6.4)(64bit) \
libpdfquickplugin.so(Qt_6.5)(64bit) \
libpdfquickplugin.so(Qt_6.5.1_PRIVATE_API)(64bit) \
qt6-pdf-imports \
