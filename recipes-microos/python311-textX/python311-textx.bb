...
RPROVIDES:${PN} += "python3.11dist(textx) python311-textX python3dist(textx)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Arpeggio python311-click python311-future python311-setuptools update-alternatives"
