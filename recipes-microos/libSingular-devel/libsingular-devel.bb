...
RPROVIDES:${PN} += "libSingular-devel libSingular-devel(aarch-64) pkgconfig(Singular)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libSingular-4_3_1 mpfr-devel pkgconfig(factory) pkgconfig(libpolys) pkgconfig(omalloc) pkgconfig(singular_resources)"
