...
RPROVIDES:${PN} += "jackson-jaxrs-providers mvn(com.fasterxml.jackson.jaxrs:jackson-jaxrs-base) mvn(com.fasterxml.jackson.jaxrs:jackson-jaxrs-base:pom:) osgi(com.fasterxml.jackson.jaxrs.jackson-jaxrs-base)"
