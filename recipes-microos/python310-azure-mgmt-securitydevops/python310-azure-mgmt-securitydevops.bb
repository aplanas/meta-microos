...
RPROVIDES:${PN} += "python3-azure-mgmt-securitydevops python3.10dist(azure-mgmt-securitydevops) python310-azure-mgmt-securitydevops python3dist(azure-mgmt-securitydevops)"
