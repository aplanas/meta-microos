...
RPROVIDES:${PN} += "tex(ot1rojud.fd) tex(rojud.map) tex(rojud.sty) tex(rojud.tfm) tex(turojud.fd) texlive-rojud"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(iftex.sty) tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-rojud-fonts texlive-scripts texlive-scripts-bin"
