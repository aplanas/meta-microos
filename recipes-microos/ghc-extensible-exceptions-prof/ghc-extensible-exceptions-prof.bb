...
RPROVIDES:${PN} += "ghc-extensible-exceptions-prof ghc-extensible-exceptions-prof(aarch-64) ghc-prof(extensible-exceptions-0.1.1.4-ItoFoaqbPMuGIlsBr6VhGY)"
RDEPENDS:${PN} += "ghc-extensible-exceptions-devel ghc-prof(base-4.17.1.0)"
