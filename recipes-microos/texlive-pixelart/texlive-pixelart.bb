...
RPROVIDES:${PN} += "tex(pixelart.sty) tex(pixelart0.sty) texlive-pixelart"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(iftex.sty) tex(luacode.sty) tex(pgf.sty) tex(pgfkeys.sty) tex(pgfopts.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
