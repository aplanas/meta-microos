...
RPROVIDES:${PN} += "ruby3.2-rubygem-pdf-core ruby3.2-rubygem-pdf-core(aarch-64) rubygem(pdf-core) rubygem(ruby:3.2.0:pdf-core) rubygem(ruby:3.2.0:pdf-core:0) rubygem(ruby:3.2.0:pdf-core:0.9) rubygem(ruby:3.2.0:pdf-core:0.9.0)"
