...
RPROVIDES:${PN} += "tex(ifplatform.sty) texlive-ifplatform"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(catchfile.sty) tex(ifluatex.sty) tex(pdftexcmds.sty) tex(shellesc.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
