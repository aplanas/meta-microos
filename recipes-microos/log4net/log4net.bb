...
RPROVIDES:${PN} += "log4net mono(log4net) pkgconfig(log4net)"
RDEPENDS:${PN} += "/usr/bin/pkg-config mono(System) mono(System.Data) mono(System.Web) mono(System.Xml) mono(mscorlib)"
