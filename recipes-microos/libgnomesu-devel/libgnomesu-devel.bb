...
RPROVIDES:${PN} += "libgnomesu-devel libgnomesu-devel(aarch-64) pkgconfig(libgnomesu-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgnomesu libgnomesu0 pkgconfig(glib-2.0)"
