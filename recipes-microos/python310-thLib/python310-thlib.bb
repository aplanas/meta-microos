...
RPROVIDES:${PN} += "python3-thLib python3.10dist(thlib) python310-thLib python3dist(thlib)"
RDEPENDS:${PN} += "python(abi) python310-matplotlib python310-numpy python310-pandas python310-scikit-image python310-scipy python310-statsmodels python310-sympy"
