...
RPROVIDES:${PN} += "python311-cairo-devel python311-pycairo-devel python311-pycairo-devel(aarch-64)"
RDEPENDS:${PN} += "python311-devel python311-pycairo python311-pycairo-common-devel"
