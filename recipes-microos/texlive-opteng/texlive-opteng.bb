...
RPROVIDES:${PN} += "tex(opteng.sty) texlive-opteng"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(fancybox.sty) tex(geometry.sty) tex(graphicx.sty) tex(overcite.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
