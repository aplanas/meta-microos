...
RPROVIDES:${PN} += "libgpod-lang libgpod-lang-all locale(libgpod:de) locale(libgpod:es) locale(libgpod:fr) locale(libgpod:he) locale(libgpod:it) locale(libgpod:ja) locale(libgpod:ro) locale(libgpod:sv) locale(libgpod:zh_CN)"
RDEPENDS:${PN} += "libgpod"
