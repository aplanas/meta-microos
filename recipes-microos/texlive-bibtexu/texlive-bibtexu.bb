...
RPROVIDES:${PN} += "man(bibtexu.1) texlive-bibtexu"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-bibtexu-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
