...
RPROVIDES:${PN} += "libqsqlite.so()(64bit) libqsqlite.so(Qt_6)(64bit) libqsqlite.so(Qt_6.0)(64bit) libqsqlite.so(Qt_6.1)(64bit) libqsqlite.so(Qt_6.2)(64bit) libqsqlite.so(Qt_6.3)(64bit) libqsqlite.so(Qt_6.4)(64bit) libqsqlite.so(Qt_6.5)(64bit) libqsqlite.so(Qt_6.5.1_PRIVATE_API)(64bit) qt6-sql-sqlite qt6-sql-sqlite(aarch-64)"
