...
RPROVIDES:${PN} += "typelib(Libmsi) typelib-1_0-Libmsi-1_0 typelib-1_0-Libmsi-1_0(aarch-64)"
RDEPENDS:${PN} += "libmsi.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
