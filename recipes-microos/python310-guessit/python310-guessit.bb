...
RPROVIDES:${PN} += "python3-guessit python3.10dist(guessit) python310-guessit python3dist(guessit)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-babelfish python310-importlib-resources python310-python-dateutil python310-rebulk update-alternatives"
