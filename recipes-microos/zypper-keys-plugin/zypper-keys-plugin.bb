...
RPROVIDES:${PN} += "python3.10dist(zyppkeys) python3dist(zyppkeys) zypper-keys-plugin"
RDEPENDS:${PN} += "/usr/bin/python3 curl python(abi) python3-pytz python3-requests sudo zypper"
