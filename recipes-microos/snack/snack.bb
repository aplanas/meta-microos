...
RPROVIDES:${PN} += "libsnack.so()(64bit) libsnackogg.so()(64bit) libsound.so()(64bit) snack snack(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libasound.so.2()(64bit) libasound.so.2(ALSA_0.9)(64bit) libasound.so.2(ALSA_0.9.0rc4)(64bit) libc.so.6(GLIBC_2.17)(64bit) libogg.so.0()(64bit) libvorbis.so.0()(64bit) libvorbisenc.so.2()(64bit) tcl tk"
