...
RPROVIDES:${PN} += "ghc-devel(vector-stream-0.1.0.0-C5Yyq3DPEhXAQSqkM8V92s) ghc-vector-stream-devel ghc-vector-stream-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(ghc-prim-0.9.0) ghc-vector-stream"
