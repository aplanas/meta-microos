...
RPROVIDES:${PN} += "libnetcdf-fortran-gnu-openmpi2-hpc libnetcdf-fortran-gnu-openmpi2-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/sh libnetcdf-fortran_4_5_3-gnu-openmpi2-hpc"
