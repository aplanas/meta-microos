...
RPROVIDES:${PN} += "cacti-spine cacti-spine(aarch-64) config(cacti-spine)"
RDEPENDS:${PN} += "cacti ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.29)(64bit) libmariadb.so.3()(64bit) libmariadb.so.3(libmysqlclient_18)(64bit) libnetsnmp.so.40()(64bit) rrdtool"
