...
RPROVIDES:${PN} += "tex(pzdr.tfm) tex(uuzd.fd) tex(uzd.map) tex(uzdr.tfm) texlive-zapfding"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-zapfding-fonts"
