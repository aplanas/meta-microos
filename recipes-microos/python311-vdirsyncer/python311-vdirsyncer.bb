...
RPROVIDES:${PN} += "python3.11dist(vdirsyncer) python311-vdirsyncer python3dist(vdirsyncer) vdirsyncer"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-aiostream python311-atomicwrites python311-click python311-click-log python311-click-threading python311-requests python311-requests-toolbelt update-alternatives"
