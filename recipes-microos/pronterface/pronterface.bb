...
RPROVIDES:${PN} += "application() application(pronterface.desktop) metainfo() metainfo(pronterface.appdata.xml) pronterface"
RDEPENDS:${PN} += "/usr/bin/python3 pronsole python3-wxPython"
