...
RPROVIDES:${PN} += "typelib(GnomeAutoar) typelib-1_0-GnomeAutoar-0_1 typelib-1_0-GnomeAutoar-0_1(aarch-64)"
RDEPENDS:${PN} += "libgnome-autoar-0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
