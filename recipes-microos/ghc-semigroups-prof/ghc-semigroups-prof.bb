...
RPROVIDES:${PN} += "ghc-prof(semigroups-0.20-KtsaS4jNcGkoC9puVZ6vB) ghc-semigroups-prof ghc-semigroups-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-semigroups-devel"
