...
RPROVIDES:${PN} += "python3-rrdtool python3-rrdtool(aarch-64) python3.10dist(rrdtool) python3dist(rrdtool)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) librrd.so.8()(64bit) python(abi) python3 rrdtool"
