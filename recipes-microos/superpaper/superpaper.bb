...
RPROVIDES:${PN} += "application() application(superpaper.desktop) python3-superpaper python3.10dist(superpaper) python38-superpaper python3dist(superpaper) superpaper"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Pillow python3-numpy python3-screeninfo python3-system_hotkey python3-wxPython python3-xcffib python3-xpybutil"
