...
RPROVIDES:${PN} += "perl(Specio::Library::Path::Tiny) perl-Specio-Library-Path-Tiny"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Path::Tiny) perl(Specio) perl(Specio::Declare) perl(Specio::Exporter) perl(Specio::Library::Builtins) perl(Specio::PartialDump) perl(parent)"
