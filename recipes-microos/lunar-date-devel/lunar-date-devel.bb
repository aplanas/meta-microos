...
RPROVIDES:${PN} += "lunar-date-devel lunar-date-devel(aarch-64) pkgconfig(lunar-date-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblunar-date-3_0-1 pkgconfig(gio-2.0) typelib-1_0-LunarDate-3_0"
