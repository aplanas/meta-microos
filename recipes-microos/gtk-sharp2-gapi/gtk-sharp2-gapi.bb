...
RPROVIDES:${PN} += "gtk-sharp2-gapi gtk-sharp2-gapi(aarch-64) mono(gapi-fixup) mono(gapi-parser) mono(gapi_codegen) pkgconfig(gapi-2.0)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl /usr/bin/pkg-config mono(System.Xml) mono(mscorlib) perl-XML-LibXML perl-XML-LibXML-Common perl-XML-SAX"
