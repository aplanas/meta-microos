...
RPROVIDES:${PN} += "python3-hatch-jupyter-builder python3-hatch_jupyter_builder python3.10dist(hatch-jupyter-builder) python310-hatch-jupyter-builder python310-hatch_jupyter_builder python3dist(hatch-jupyter-builder)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 alts python(abi) python310-hatchling"
