...
RPROVIDES:${PN} += "gwenhywfar-tools gwenhywfar-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libgwenhywfar.so.79()(64bit) libgwenhywfar79 libssl.so.3()(64bit) libssl.so.3(OPENSSL_3.0.0)(64bit)"
