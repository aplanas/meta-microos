...
RPROVIDES:${PN} += "mpiP_3_5-gnu-openmpi3-hpc-devel-static mpiP_3_5-gnu-openmpi3-hpc-devel-static(aarch-64)"
RDEPENDS:${PN} += "gnu-compilers-hpc-devel openmpi3-gnu-hpc-devel"
