...
RPROVIDES:${PN} += "ghc-cabal2spec-prof ghc-cabal2spec-prof(aarch-64) ghc-prof(cabal2spec-2.7.0-9ijIHSPt0QmI4YnWoXNap7)"
RDEPENDS:${PN} += "ghc-cabal2spec-devel ghc-prof(Cabal-3.8.1.0) ghc-prof(base-4.17.1.0) ghc-prof(filepath-1.4.2.2) ghc-prof(time-1.12.2)"
