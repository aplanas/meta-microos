...
RPROVIDES:${PN} += "python3.9dist(basictracer) python39-basictracer python3dist(basictracer)"
RDEPENDS:${PN} += "python(abi) python39-opentracing python39-protobuf python39-six"
