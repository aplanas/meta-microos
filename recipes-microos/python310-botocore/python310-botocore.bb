...
RDEPENDS:${PN} += "(python310-jmespath >= 0.7.1 with python310-jmespath < 2.0.0) (python310-python-dateutil >= 2.1 with python310-python-dateutil < 3.0.0) python(abi) python310-requests"
