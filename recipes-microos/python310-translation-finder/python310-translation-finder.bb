...
RPROVIDES:${PN} += "python3-translation-finder python3.10dist(translation-finder) python310-translation-finder python3dist(translation-finder)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-ruamel.yaml python310-setuptools python310-weblate-language-data update-alternatives"
