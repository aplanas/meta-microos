...
RPROVIDES:${PN} += "tex(beamerinnerthemesimplelines.sty) tex(beamerouterthemesidebarwithminiframes.sty) tex(beamerouterthemesplitwithminiframes.sty) tex(beamerouterthemetwolines.sty) texlive-beamerauxtheme"
