...
locale(xfce4-settings:en_AU) \
locale(xfce4-settings:en_CA) \
locale(xfce4-settings:en_GB) \
...
locale(xfce4-settings:zh_CN) \
locale(xfce4-settings:zh_HK) \
locale(xfce4-settings:zh_TW) \
xfce4-settings-lang \
