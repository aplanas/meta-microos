...
RPROVIDES:${PN} += "python3.11dist(grab) python311-grab python3dist(grab)"
RDEPENDS:${PN} += "python(abi) python311-defusedxml python311-lxml python311-pycurl python311-selection python311-six python311-user_agent python311-weblib"
