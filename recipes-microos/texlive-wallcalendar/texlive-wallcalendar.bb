...
RPROVIDES:${PN} += "tex(wallcalendar-czech.tex) tex(wallcalendar-dutch.tex) tex(wallcalendar-english.tex) tex(wallcalendar-french.tex) tex(wallcalendar-german.tex) tex(wallcalendar-hungarian.tex) tex(wallcalendar-italian.tex) tex(wallcalendar-japanese.tex) tex(wallcalendar-norwegian.tex) tex(wallcalendar-portuguese.tex) tex(wallcalendar-romanian.tex) tex(wallcalendar-serbian.tex) tex(wallcalendar-slovakian.tex) tex(wallcalendar-slovenian.tex) tex(wallcalendar-spanish.tex) tex(wallcalendar-swedish.tex) tex(wallcalendar-thai.tex) tex(wallcalendar.cls) texlive-wallcalendar"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(babel.sty) tex(calc.sty) tex(ccicons.sty) tex(eso-pic.sty) tex(etoolbox.sty) tex(graphicx.sty) tex(luacode.sty) tex(memoir.cls) tex(microtype.sty) tex(multicol.sty) tex(nag.sty) tex(pdftexcmds.sty) tex(pgfopts.sty) tex(tikz.sty) tex(wasysym.sty) tex(xcoffins.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
