...
RPROVIDES:${PN} += "ghc-prof(time-locale-compat-0.1.1.5-4KOdffkWEDD5CJkcMekvXY) ghc-time-locale-compat-prof ghc-time-locale-compat-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(time-1.12.2) ghc-time-locale-compat-devel"
