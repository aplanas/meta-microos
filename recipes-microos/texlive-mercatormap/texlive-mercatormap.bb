...
RPROVIDES:${PN} += "tex(mercatormap.sty) tex(mercatorpy.def) tex(mercatorsupplier.def) texlive-mercatormap"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(expl3.sty) tex(graphicx.sty) tex(pdftexcmds.sty) tex(siunitx.sty) tex(tikz.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
