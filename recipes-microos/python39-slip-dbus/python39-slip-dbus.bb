...
RPROVIDES:${PN} += "python3.9dist(slip.dbus) python39-slip-dbus python3dist(slip.dbus)"
RDEPENDS:${PN} += "python(abi) python39-dbus-python python39-decorator python39-six python39-slip"
