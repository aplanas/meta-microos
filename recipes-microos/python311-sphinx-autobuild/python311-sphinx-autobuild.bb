...
RPROVIDES:${PN} += "python3.11dist(sphinx-autobuild) python311-sphinx-autobuild python3dist(sphinx-autobuild)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Sphinx python311-colorama python311-livereload update-alternatives"
