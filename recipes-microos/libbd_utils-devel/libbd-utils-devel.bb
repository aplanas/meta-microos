...
RPROVIDES:${PN} += "libbd_utils-devel libbd_utils-devel(aarch-64) pkgconfig(blockdev-utils)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glib2-devel libbd_utils2 pkgconfig(glib-2.0)"
