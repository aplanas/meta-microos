...
RPROVIDES:${PN} += "libwbxml2-devel libwbxml2-devel(aarch-64) pkgconfig(libwbxml2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libexpat-devel libwbxml2-1 pkgconfig(expat)"
