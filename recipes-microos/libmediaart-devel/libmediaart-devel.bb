...
RPROVIDES:${PN} += "libmediaart-devel libmediaart-devel(aarch-64) pkgconfig(libmediaart-2.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmediaart-2_0-0 pkgconfig(gdk-pixbuf-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) typelib-1_0-MediaArt-2_0"
