...
RPROVIDES:${PN} += "tex(bxpapersize.sty) texlive-bxpapersize"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atbegshi.sty) tex(ifluatex.sty) tex(ifpdf.sty) tex(ifptex.sty) tex(ifvtex.sty) tex(ifxetex.sty) tex(pxatbegshi.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
