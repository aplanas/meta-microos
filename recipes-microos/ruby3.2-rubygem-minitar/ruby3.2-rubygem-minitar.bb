...
RPROVIDES:${PN} += "ruby3.2-rubygem-minitar ruby3.2-rubygem-minitar(aarch-64) rubygem(minitar) rubygem(ruby:3.2.0:minitar) rubygem(ruby:3.2.0:minitar:0) rubygem(ruby:3.2.0:minitar:0.9)"
