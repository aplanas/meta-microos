...
RPROVIDES:${PN} += "libmjpegutils-devel libmjpegutils-devel(aarch-64) mjpegtools-devel pkgconfig(mjpegtools)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblavfile-2_2-0 liblavjpeg-2_2-0 liblavplay-2_2-0 liblavrec-2_2-0 libmjpegutils-2_2-0 libmpeg2encpp-2_2-0 libmplex2-2_2-0"
