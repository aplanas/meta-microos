...
RPROVIDES:${PN} += "perl(Net::HTTPServer) perl(Net::HTTPServer::CaptureSTDOUT) perl(Net::HTTPServer::Request) perl(Net::HTTPServer::Response) perl(Net::HTTPServer::Session) perl-Net-HTTPServer"
