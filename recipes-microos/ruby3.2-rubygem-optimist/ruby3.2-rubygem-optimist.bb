...
RPROVIDES:${PN} += "ruby3.2-rubygem-optimist ruby3.2-rubygem-optimist(aarch-64) rubygem(optimist) rubygem(ruby:3.2.0:optimist) rubygem(ruby:3.2.0:optimist:3) rubygem(ruby:3.2.0:optimist:3.0) rubygem(ruby:3.2.0:optimist:3.0.1)"
