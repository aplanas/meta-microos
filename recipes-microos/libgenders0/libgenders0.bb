...
RPROVIDES:${PN} += "libgenders.so.0()(64bit) libgenders0 libgenders0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig genders-base ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit)"
