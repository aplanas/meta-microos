...
RPROVIDES:${PN} += "typelib(FolksEds) typelib-1_0-FolksEds-0_7 typelib-1_0-FolksEds-0_7(aarch-64)"
RDEPENDS:${PN} += "typelib(Camel) typelib(EBookContacts) typelib(EDataServer) typelib(Folks) typelib(GLib) typelib(GObject) typelib(Gee) typelib(Gio) typelib(Soup) typelib(libxml2)"
