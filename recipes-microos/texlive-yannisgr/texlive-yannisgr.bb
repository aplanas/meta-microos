...
RPROVIDES:${PN} += "tex(mrgrbf10.tfm) tex(mrgrrg10.tfm) tex(mrgrsl10.tfm) tex(mrgrti10.tfm) tex(rgrbf10.tfm) tex(rgrrg10.tfm) tex(rgrsc10.tfm) tex(rgrsl10.tfm) tex(rgrti10.tfm) texlive-yannisgr"
