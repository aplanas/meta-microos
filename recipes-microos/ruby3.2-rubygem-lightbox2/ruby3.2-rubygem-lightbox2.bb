...
RPROVIDES:${PN} += "ruby3.2-rubygem-lightbox2 ruby3.2-rubygem-lightbox2(aarch-64) rubygem(lightbox2) rubygem(ruby:3.2.0:lightbox2) rubygem(ruby:3.2.0:lightbox2:2) rubygem(ruby:3.2.0:lightbox2:2.11) rubygem(ruby:3.2.0:lightbox2:2.11.3)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:jquery-rails)"
