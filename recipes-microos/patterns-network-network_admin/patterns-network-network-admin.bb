...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-network-network_admin patterns-network-network_admin(aarch-64)"
RDEPENDS:${PN} += "pattern()"
