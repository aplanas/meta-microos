...
RPROVIDES:${PN} += "pkgconfig(xed) xed-devel xed-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gtk+-3.0) pkgconfig(gtksourceview-3.0) pkgconfig(gtksourceview-4) pkgconfig(libpeas-1.0) pkgconfig(libpeas-gtk-1.0) pkgconfig(libxml-2.0) pkgconfig(x11) pkgconfig(xapp) xed"
