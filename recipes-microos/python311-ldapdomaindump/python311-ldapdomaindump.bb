...
RPROVIDES:${PN} += "python3.11dist(ldapdomaindump) python311-ldapdomaindump python3dist(ldapdomaindump)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-dnspython python311-future python311-ldap3"
