...
RPROVIDES:${PN} += "gtkglext-devel gtkglext-devel(aarch-64) pkgconfig(gdkglext-1.0) pkgconfig(gdkglext-x11-1.0) pkgconfig(gtkglext-1.0) pkgconfig(gtkglext-x11-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config Mesa-devel libgtkglext-x11-1_0-0 pkgconfig(gdk-2.0) pkgconfig(gdkglext-x11-1.0) pkgconfig(gl) pkgconfig(gtk+-2.0)"
