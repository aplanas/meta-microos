...
RPROVIDES:${PN} += "python3.9dist(skyfield) python39-skyfield python3dist(skyfield)"
RDEPENDS:${PN} += "python(abi) python39-astropy python39-beautifulsoup4 python39-certifi python39-html5lib python39-jplephem python39-lxml python39-matplotlib python39-numpy python39-pandas python39-sgp4"
