...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-search-customsearch) python311-azure-cognitiveservices-search-customsearch python3dist(azure-cognitiveservices-search-customsearch)"
