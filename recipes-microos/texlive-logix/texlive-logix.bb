...
RPROVIDES:${PN} += "tex(logix.sty) texlive-logix"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(arydshln.sty) tex(iftex.sty) tex(mathtools.sty) tex(unicode-math.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-logix-fonts texlive-scripts texlive-scripts-bin"
