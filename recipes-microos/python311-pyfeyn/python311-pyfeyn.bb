...
RPROVIDES:${PN} += "python3.11dist(pyfeyn) python311-pyfeyn python3dist(pyfeyn)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyX update-alternatives"
