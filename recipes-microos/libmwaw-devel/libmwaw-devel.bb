...
RPROVIDES:${PN} += "libmwaw-devel libmwaw-devel(aarch-64) pkgconfig(libmwaw-0.3)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmwaw-0_3-3 pkgconfig(librevenge-0.0) pkgconfig(librevenge-stream-0.0)"
