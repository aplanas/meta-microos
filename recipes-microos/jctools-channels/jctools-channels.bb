...
RPROVIDES:${PN} += "jctools-channels mvn(org.jctools:jctools-channels) mvn(org.jctools:jctools-channels:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.jctools:jctools-core) mvn(org.ow2.asm:asm-all)"
