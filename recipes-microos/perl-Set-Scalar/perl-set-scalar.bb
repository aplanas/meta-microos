...
RPROVIDES:${PN} += "perl(Set::Scalar) perl(Set::Scalar::Base) perl(Set::Scalar::Null) perl(Set::Scalar::Real) perl(Set::Scalar::Universe) perl(Set::Scalar::Valued) perl(Set::Scalar::ValuedUniverse) perl(Set::Scalar::Virtual) perl-Set-Scalar"
