...
RPROVIDES:${PN} += "perl(Email::Valid) perl-Email-Valid"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(IO::CaptureOutput) perl(Mail::Address) perl(Net::DNS) perl(Net::Domain::TLD)"
