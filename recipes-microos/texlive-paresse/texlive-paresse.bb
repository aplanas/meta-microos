...
RPROVIDES:${PN} += "tex(paresse-old.sty) tex(paresse-utf8.sty) tex(paresse.sty) texlive-paresse"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(expl3.sty) tex(iftex.sty) tex(l3keys2e.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
