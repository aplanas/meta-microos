...
RPROVIDES:${PN} += "ghc-devel(libyaml-0.1.2-HGo47aMnIYAKZUBwKE0axw) ghc-libyaml-devel ghc-libyaml-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(conduit-1.3.4.3-dAZVHPSYjL2zQ4RzAuWi2) ghc-devel(resourcet-1.2.6-69eF6Rrz9wX13sOJF59GPv) ghc-libyaml libyaml-devel"
