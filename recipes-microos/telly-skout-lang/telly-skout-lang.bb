...
RPROVIDES:${PN} += "locale(telly-skout:ca) locale(telly-skout:ca@valencia) locale(telly-skout:cs) locale(telly-skout:de) locale(telly-skout:en_GB) locale(telly-skout:es) locale(telly-skout:fi) locale(telly-skout:fr) locale(telly-skout:it) locale(telly-skout:ja) locale(telly-skout:ka) locale(telly-skout:ko) locale(telly-skout:lt) locale(telly-skout:nl) locale(telly-skout:pl) locale(telly-skout:pt) locale(telly-skout:ru) locale(telly-skout:sk) locale(telly-skout:sl) locale(telly-skout:sv) locale(telly-skout:tr) locale(telly-skout:uk) locale(telly-skout:zh_CN) locale(telly-skout:zh_TW) telly-skout-lang telly-skout-lang-all"
