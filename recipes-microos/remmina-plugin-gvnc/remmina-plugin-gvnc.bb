...
RPROVIDES:${PN} += "remmina-plugin-gvnc remmina-plugin-gvnc(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgdk-3.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libgtk-vnc-2.0.so.0()(64bit) libgvnc-1.0.so.0()(64bit) libgvncpulse-1.0.so.0()(64bit) remmina"
