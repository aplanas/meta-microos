...
RPROVIDES:${PN} += "deepin-movie-devel deepin-movie-devel(aarch-64) pkgconfig(libdmr)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdmr0_1 pkgconfig(Qt5Concurrent) pkgconfig(Qt5Network) pkgconfig(Qt5Widgets) pkgconfig(Qt5X11Extras) pkgconfig(dtkcore) pkgconfig(dtkwidget) pkgconfig(gl)"
