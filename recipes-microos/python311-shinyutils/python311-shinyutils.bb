...
RPROVIDES:${PN} += "python3.11dist(shinyutils) python311-shinyutils python3dist(shinyutils)"
RDEPENDS:${PN} += "python(abi) python311-crayons python311-matplotlib python311-seaborn"
