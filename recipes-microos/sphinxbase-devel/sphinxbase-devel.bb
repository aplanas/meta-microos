...
RPROVIDES:${PN} += "pkgconfig(sphinxbase) sphinxbase-devel sphinxbase-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config alsa-devel lapack-devel libsndfile-devel libsphinxad0 libsphinxbase1"
