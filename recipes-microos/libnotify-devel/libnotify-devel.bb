...
RPROVIDES:${PN} += "libnotify-devel libnotify-devel(aarch-64) libnotify-doc pkgconfig(libnotify)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnotify4 pkgconfig(gdk-pixbuf-2.0) pkgconfig(gio-2.0) pkgconfig(glib-2.0) typelib-1_0-Notify-0_7"
