...
RPROVIDES:${PN} += "perl(File::HomeDir) perl(File::HomeDir::Darwin) perl(File::HomeDir::Darwin::Carbon) perl(File::HomeDir::Darwin::Cocoa) perl(File::HomeDir::Driver) perl(File::HomeDir::FreeDesktop) perl(File::HomeDir::MacOS9) perl(File::HomeDir::Test) perl(File::HomeDir::Unix) perl(File::HomeDir::Windows) perl-File-HomeDir"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(File::Path) perl(File::Temp) perl(File::Which)"
