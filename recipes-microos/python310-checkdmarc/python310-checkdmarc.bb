...
RPROVIDES:${PN} += "python3-checkdmarc python3.10dist(checkdmarc) python310-checkdmarc python3dist(checkdmarc)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-dnspython python310-expiringdict python310-publicsuffix2 python310-pyleri python310-requests python310-timeout-decorator"
