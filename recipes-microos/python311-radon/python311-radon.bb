...
RPROVIDES:${PN} += "python3.11dist(radon) python311-radon python3dist(radon)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-colorama python311-future python311-mando update-alternatives"
