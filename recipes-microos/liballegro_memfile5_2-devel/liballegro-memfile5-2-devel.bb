...
RPROVIDES:${PN} += "liballegro_memfile5_2-devel liballegro_memfile5_2-devel(aarch-64) pkgconfig(allegro_memfile-5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liballegro_memfile5_2 pkgconfig(allegro-5)"
