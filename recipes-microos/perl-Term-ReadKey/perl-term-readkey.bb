...
RPROVIDES:${PN} += "perl(Term::ReadKey) perl-Term-ReadKey perl-Term-ReadKey(aarch-64) perl-TermReadKey"
RDEPENDS:${PN} += "/bin/stty ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.28)(64bit) perl(:MODULE_COMPAT_5.36.0)"
