...
RPROVIDES:${PN} += "mvn(oauth.signpost:oauth-signpost:pom:) oauth-signpost"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven.plugins:maven-compiler-plugin) mvn(org.apache.maven.plugins:maven-jar-plugin)"
