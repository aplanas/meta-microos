...
RPROVIDES:${PN} += "config(lightdm) group(lightdm) lightdm lightdm(aarch-64) user(lightdm)"
RDEPENDS:${PN} += "/bin/sh gdmflexiserver ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libXdmcp.so.6()(64bit) libaudit.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) libgcrypt.so.20()(64bit) libgcrypt.so.20(GCRYPT_1.6)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libpam.so.0()(64bit) libpam.so.0(LIBPAM_1.0)(64bit) libxcb.so.1()(64bit) lightdm-greeter sysuser-shadow xdm"
