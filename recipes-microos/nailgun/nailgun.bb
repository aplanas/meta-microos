...
RPROVIDES:${PN} += "mvn(com.martiansoftware:nailgun-all:pom:) mvn(com.martiansoftware:nailgun-examples) mvn(com.martiansoftware:nailgun-examples:pom:) mvn(com.martiansoftware:nailgun-server) mvn(com.martiansoftware:nailgun-server:pom:) nailgun"
