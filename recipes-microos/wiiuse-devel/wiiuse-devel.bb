...
RPROVIDES:${PN} += "wiiuse-devel wiiuse-devel(aarch-64)"
RDEPENDS:${PN} += "bluez-devel ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libGL.so.1()(64bit) libGLU.so.1()(64bit) libSDL-1.2.so.0()(64bit) libc.so.6(GLIBC_2.34)(64bit) libglut.so.3()(64bit) libwiiuse.so.0()(64bit) libwiiuse0"
