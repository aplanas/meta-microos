...
RPROVIDES:${PN} += "locale(spice-up:ca) locale(spice-up:de) locale(spice-up:es) locale(spice-up:fr) locale(spice-up:ja) locale(spice-up:pt_BR) locale(spice-up:pt_PT) locale(spice-up:sr) locale(spice-up:sr@latin) spice-up-lang spice-up-lang-all"
