...
RPROVIDES:${PN} += "libwayland-cursor.so.0()(64bit) libwayland-cursor0 libwayland-cursor0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.28)(64bit) libwayland-client.so.0()(64bit)"
