...
RPROVIDES:${PN} += "v4l-conf v4l-conf(aarch-64) xawtv:/usr/bin/v4l-conf"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libXxf86dga.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) permissions"
