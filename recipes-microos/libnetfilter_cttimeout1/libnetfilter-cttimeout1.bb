...
RPROVIDES:${PN} += "libnetfilter_cttimeout.so.1()(64bit) libnetfilter_cttimeout.so.1(LIBNETFILTER_CTTIMEOUT_1.0)(64bit) libnetfilter_cttimeout.so.1(LIBNETFILTER_CTTIMEOUT_1.1)(64bit) libnetfilter_cttimeout1 libnetfilter_cttimeout1(aarch-64)"
