...
RPROVIDES:${PN} += "tex(yathesis-demo.sty) tex(yathesis-translations.tex) tex(yathesis.cls) texlive-yathesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(adjustbox.sty) tex(array.sty) tex(babel.sty) tex(biblatex.sty) tex(book.cls) tex(bookmark.sty) tex(colophon.sty) tex(csquotes.sty) tex(datatool.sty) tex(datetime2.sty) tex(draftwatermark.sty) tex(environ.sty) tex(epigraph.sty) tex(etoc.sty) tex(etoolbox.sty) tex(fncychap.sty) tex(geometry.sty) tex(glossaries-babel.sty) tex(glossaries-english.ldf) tex(graphicx.sty) tex(hypcap.sty) tex(ifdraft.sty) tex(iflang.sty) tex(iftex.sty) tex(letltxmacro.sty) tex(marvosym.sty) tex(morewrites.sty) tex(nonumonpart.sty) tex(pgfopts.sty) tex(setspace.sty) tex(tabularx.sty) tex(tcolorbox.sty) tex(titlesec.sty) tex(tocbibind.sty) tex(translator.sty) tex(twoopt.sty) tex(xcolor.sty) tex(xifthen.sty) tex(xkeyval.sty) tex(xparse.sty) tex(xpatch.sty) tex(xstring.sty) tex(zref.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
