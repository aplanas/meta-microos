...
RPROVIDES:${PN} += "libiodbc-devel libiodbc-devel(aarch-64) pkgconfig(libiodbc)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config iodbc libdrvproxy2 libiodbc2 libiodbcadm2 pkgconfig(gtk+-2.0)"
