...
RPROVIDES:${PN} += "config(tuned) tuned"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/python3 cpupower ethtool gawk hdparm polkit python(abi) python3-configobj python3-dbus-python python3-decorator python3-gobject python3-linux-procfs python3-pyudev systemd util-linux virt-what"
