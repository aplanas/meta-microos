...
RPROVIDES:${PN} += "tex(8rbch.fd) tex(8rpag.fd) tex(8rpbk.fd) tex(8rpcr.fd) tex(8rphv.fd) tex(8rpnc.fd) tex(8rppl.fd) tex(8rptm.fd) tex(8rput.fd) tex(8rpzc.fd) tex(avant.sty) tex(bookman.sty) tex(chancery.sty) tex(charter.map) tex(charter.sty) tex(courier.sty) tex(fpls.map) tex(helvet.sty) tex(mathpazo.sty) tex(mathpple.sty) tex(mathptm.sty) tex(mathptmx.sty) tex(newcent.sty) tex(omlbch.fd) tex(omlpag.fd) tex(omlpbk.fd) tex(omlpcr.fd) tex(omlphv.fd) tex(omlpnc.fd) tex(omlppl.fd) tex(omlptm.fd) tex(omlptmcm.fd) tex(omlput.fd) tex(omlpzc.fd) tex(omlzplm.fd) tex(omlzpple.fd) tex(omlztmcm.fd) tex(omsbch.fd) tex(omspag.fd) tex(omspbk.fd) tex(omspcr.fd) tex(omsphv.fd) tex(omspnc.fd) tex(omsppl.fd) tex(omsptm.fd) tex(omsput.fd) tex(omspzc.fd) tex(omspzccm.fd) tex(omszplm.fd) tex(omszpple.fd) tex(omsztmcm.fd) tex(omxpsycm.fd) tex(omxzplm.fd) tex(omxzpple.fd) tex(omxztmcm.fd) tex(ot1bch.fd) tex(ot1pag.fd) tex(ot1pbk.fd) tex(ot1pcr.fd) tex(ot1phv.fd) tex(ot1pnc.fd) tex(ot1ppl.fd) tex(ot1pplj.fd) tex(ot1pplx.fd) tex(ot1ptm.fd) tex(ot1ptmcm.fd) tex(ot1put.fd) tex(ot1pzc.fd) tex(ot1zplm.fd) tex(ot1zpple.fd) tex(ot1ztmcm.fd) tex(palatino.sty) tex(pazo.map) tex(pifont.sty) tex(psnfss.map) tex(t1bch.fd) tex(t1pag.fd) tex(t1pbk.fd) tex(t1pcr.fd) tex(t1phv.fd) tex(t1pnc.fd) tex(t1ppl.fd) tex(t1pplj.fd) tex(t1pplx.fd) tex(t1ptm.fd) tex(t1put.fd) tex(t1pzc.fd) tex(times.sty) tex(ts1bch.fd) tex(ts1pag.fd) tex(ts1pbk.fd) tex(ts1pcr.fd) tex(ts1phv.fd) tex(ts1pnc.fd) tex(ts1ppl.fd) tex(ts1pplj.fd) tex(ts1pplx.fd) tex(ts1ptm.fd) tex(ts1put.fd) tex(ts1pzc.fd) tex(ufplm.fd) tex(ufplmbb.fd) tex(upsy.fd) tex(upzd.fd) tex(utopia.map) tex(utopia.sty) texlive-psnfss"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(keyval.sty) tex(updmap.cfg) texlive texlive-filesystem texlive-graphics texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-symbol texlive-zapfding"
