...
RPROVIDES:${PN} += "hplip-devel hplip-devel(aarch-64)"
RDEPENDS:${PN} += "cups-devel dbus-1-devel hplip-hpijs hplip-sane libopenssl-devel libusb-1_0-devel net-snmp-devel"
