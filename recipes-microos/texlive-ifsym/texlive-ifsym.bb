...
RPROVIDES:${PN} += "tex(ifclk10.tfm) tex(ifclkb10.tfm) tex(ifgeo10.tfm) tex(ifgeob10.tfm) tex(ifgeobn10.tfm) tex(ifgeobw10.tfm) tex(ifgeon10.tfm) tex(ifgeow10.tfm) tex(ifsym.sty) tex(ifsym10.tfm) tex(ifsymb10.tfm) tex(ifsymbi10.tfm) tex(ifsymi10.tfm) tex(ifwea10.tfm) tex(ifweab10.tfm) tex(uifblk.fd) tex(uifclk.fd) tex(uifgeo.fd) tex(uifsym.fd) tex(uifwea.fd) texlive-ifsym"
