...
RPROVIDES:${PN} += "python3.9dist(dkimpy) python39-dkimpy python3dist(dkimpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyNaCl python39-authres python39-dnspython python39-setuptools update-alternatives"
