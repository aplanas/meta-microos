...
RPROVIDES:${PN} += "gimp-2.0-devel gimp-devel gimp-devel(aarch-64) gimp-doc pkgconfig(gimp-2.0) pkgconfig(gimpthumb-2.0) pkgconfig(gimpui-2.0) rpm_macro(gimp_abi_version) rpm_macro(gimp_api_version)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgimp-2_0-0 libgimpbase-2.0.so.0()(64bit) libgimpui-2_0-0 libglib-2.0.so.0()(64bit) pkgconfig(cairo) pkgconfig(gdk-pixbuf-2.0) pkgconfig(gegl-0.4) pkgconfig(gimp-2.0) pkgconfig(gtk+-2.0)"
