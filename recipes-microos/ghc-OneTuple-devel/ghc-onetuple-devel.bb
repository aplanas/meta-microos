...
RPROVIDES:${PN} += "ghc-OneTuple-devel ghc-OneTuple-devel(aarch-64) ghc-devel(OneTuple-0.3.1-IKxZBiZNgF5H3QnFEzgDrd)"
RDEPENDS:${PN} += "/bin/sh ghc-OneTuple ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(ghc-prim-0.9.0) ghc-devel(template-haskell-2.19.0.0)"
