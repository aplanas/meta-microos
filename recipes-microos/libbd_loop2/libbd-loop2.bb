...
RPROVIDES:${PN} += "libbd_loop.so.2()(64bit) libbd_loop2 libbd_loop2(aarch-64) libblockdev-loop"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libbd_utils.so.2()(64bit) libbd_utils2 libc.so.6(GLIBC_2.27)(64bit) libglib-2.0.so.0()(64bit)"
