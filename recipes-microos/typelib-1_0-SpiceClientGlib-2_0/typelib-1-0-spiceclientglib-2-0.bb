...
RPROVIDES:${PN} += "typelib(SpiceClientGLib) typelib-1_0-SpiceClientGlib-2_0 typelib-1_0-SpiceClientGlib-2_0(aarch-64)"
RDEPENDS:${PN} += "libspice-client-glib-2.0.so.8()(64bit) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gio) typelib(Gst) typelib(GstBase)"
