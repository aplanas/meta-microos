...
RPROVIDES:${PN} += "python3.11dist(distroinfo) python311-distroinfo python3dist(distroinfo)"
RDEPENDS:${PN} += "python(abi) python311-PyYAML python311-pbr python311-requests python311-six"
