...
RPROVIDES:${PN} += "pkgconfig(libuhttpmock-1.0) uhttpmock-devel uhttpmock-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libuhttpmock-1_0-1 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(libsoup-3.0) typelib-1_0-Uhm-1_0"
