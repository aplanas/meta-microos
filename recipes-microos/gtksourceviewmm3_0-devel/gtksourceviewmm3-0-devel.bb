...
RPROVIDES:${PN} += "gtksourceviewmm3_0-devel gtksourceviewmm3_0-devel(aarch-64) pkgconfig(gtksourceviewmm-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgtksourceviewmm-3_0-0 pkgconfig(glibmm-2.4) pkgconfig(gtkmm-3.0) pkgconfig(gtksourceview-3.0)"
