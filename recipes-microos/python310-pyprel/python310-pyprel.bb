...
RPROVIDES:${PN} += "python3-pyprel python3.10dist(pyprel) python310-pyprel python3dist(pyprel)"
RDEPENDS:${PN} += "python(abi) python310-Pillow python310-numpy python310-pandas python310-pyfiglet python310-shijian"
