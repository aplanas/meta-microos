...
RPROVIDES:${PN} += "supercollider-devel supercollider-devel(aarch-64)"
RDEPENDS:${PN} += "alsa-devel avahi-devel libjack-devel libsndfile-devel libudev-devel pkgconfig supercollider"
