...
RPROVIDES:${PN} += "python3.9dist(sat-search) python39-sat-search python3dist(sat-search)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-sat-stac update-alternatives"
