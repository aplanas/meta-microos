...
RPROVIDES:${PN} += "application() application(fireworkx.desktop) application(flurry.desktop) application(fuzzyflakes.desktop) application(glmatrix.desktop) application(goop.desktop) application(metaballs.desktop) application(pacman.desktop) application(pong.desktop) application(substrate.desktop) config(xscreensaver-data) xscreensaver-data xscreensaver-data(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libEGL.so.1()(64bit) libGL.so.1()(64bit) libGLU.so.1()(64bit) libX11.so.6()(64bit) libXext.so.6()(64bit) libXft.so.2()(64bit) libXt.so.6()(64bit) libc.so.6(GLIBC_2.34)(64bit) libgdk_pixbuf-2.0.so.0()(64bit) libgio-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.27)(64bit) libm.so.6(GLIBC_2.29)(64bit)"
