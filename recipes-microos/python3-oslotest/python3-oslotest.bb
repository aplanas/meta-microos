...
RPROVIDES:${PN} += "python3-oslotest python3.10dist(oslotest) python3dist(oslotest)"
RDEPENDS:${PN} += "/bin/bash /usr/bin/python3 python(abi) python3-debtcollector python3-fixtures python3-python-subunit python3-stestr python3-testtools"
