...
RPROVIDES:${PN} += "pkgconfig(template-glib-1.0) template-glib-devel template-glib-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig(gio-2.0) pkgconfig(gobject-introspection-1.0) typelib-1_0-Template-1_0"
