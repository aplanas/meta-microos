...
RPROVIDES:${PN} += "ruby3.2-rubygem-cri ruby3.2-rubygem-cri(aarch-64) rubygem(cri) rubygem(ruby:3.2.0:cri) rubygem(ruby:3.2.0:cri:2) rubygem(ruby:3.2.0:cri:2.15) rubygem(ruby:3.2.0:cri:2.15.11)"
