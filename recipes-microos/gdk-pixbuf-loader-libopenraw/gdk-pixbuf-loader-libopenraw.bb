...
RPROVIDES:${PN} += "gdk-pixbuf-loader-libopenraw gdk-pixbuf-loader-libopenraw(aarch-64) libopenraw_pixbuf.so()(64bit)"
RDEPENDS:${PN} += "/bin/sh gdk-pixbuf-query-loaders ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgdk_pixbuf-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libopenraw.so.9()(64bit)"
