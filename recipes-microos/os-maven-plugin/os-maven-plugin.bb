...
RPROVIDES:${PN} += "mvn(kr.motd.maven:os-maven-plugin) mvn(kr.motd.maven:os-maven-plugin:pom:) os-maven-plugin"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.google.code.findbugs:jsr305) mvn(org.apache.maven:maven-plugin-api) mvn(org.codehaus.plexus:plexus-utils)"
