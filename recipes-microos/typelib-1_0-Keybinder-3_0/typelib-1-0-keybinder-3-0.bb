...
RPROVIDES:${PN} += "typelib(Keybinder) typelib-1_0-Keybinder-3_0 typelib-1_0-Keybinder-3_0(aarch-64)"
RDEPENDS:${PN} += "libkeybinder-3.0.so.0()(64bit) typelib(GLib) typelib(GObject)"
