...
RPROVIDES:${PN} += "libpciaccess.so.0()(64bit) libpciaccess0 libpciaccess0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libz.so.1()(64bit) libz.so.1(ZLIB_1.2.3.3)(64bit)"
