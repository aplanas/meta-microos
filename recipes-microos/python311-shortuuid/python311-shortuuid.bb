...
RPROVIDES:${PN} += "python3.11dist(shortuuid) python311-shortuuid python3dist(shortuuid)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-base update-alternatives"
