...
RPROVIDES:${PN} += "python3.11dist(parfive) python311-parfive python3dist(parfive)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-aiohttp python311-tqdm update-alternatives"
