...
RPROVIDES:${PN} += "google-noto-sans-kr-fonts-full noto-sans-kr-fonts-full"
RDEPENDS:${PN} += "google-noto-sans-kr-black-fonts google-noto-sans-kr-demilight-fonts google-noto-sans-kr-fonts google-noto-sans-kr-light-fonts google-noto-sans-kr-medium-fonts google-noto-sans-kr-thin-fonts"
