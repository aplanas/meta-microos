...
RPROVIDES:${PN} += "python3.9dist(qdarkstyle) python39-QDarkStyle python3dist(qdarkstyle)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-QtPy python39-setuptools"
