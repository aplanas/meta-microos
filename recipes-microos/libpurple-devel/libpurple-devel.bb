...
RPROVIDES:${PN} += "libpurple-devel libpurple-devel(aarch-64) pkgconfig(purple)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libpurple pkgconfig(glib-2.0) pkgconfig(libxml-2.0)"
