...
RPROVIDES:${PN} += "python3.9dist(azure-cognitiveservices-vision-face) python39-azure-cognitiveservices-vision-face python3dist(azure-cognitiveservices-vision-face)"
