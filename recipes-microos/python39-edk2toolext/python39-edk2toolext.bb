...
RPROVIDES:${PN} += "python3.9dist(edk2-pytool-extensions) python39-edk2toolext python3dist(edk2-pytool-extensions)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-edk2toollib python39-pefile python39-pyOpenSSL update-alternatives"
