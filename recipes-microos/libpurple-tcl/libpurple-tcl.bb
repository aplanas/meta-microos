...
RPROVIDES:${PN} += "libpurple-tcl libpurple-tcl(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libpurple libtcl8.6.so()(64bit) libtk8.6.so()(64bit)"
