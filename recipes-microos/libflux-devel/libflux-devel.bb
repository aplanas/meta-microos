...
RPROVIDES:${PN} += "libflux-devel libflux-devel(aarch-64) pkgconfig(flux)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libc.so.6(GLIBC_2.34)(64bit) libflux0_193_0 libgcc_s.so.1()(64bit) libgcc_s.so.1(GCC_3.0)(64bit) libgcc_s.so.1(GCC_3.3)(64bit) libgcc_s.so.1(GCC_4.2.0)(64bit)"
