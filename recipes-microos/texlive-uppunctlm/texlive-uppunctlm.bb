...
RPROVIDES:${PN} += "tex(ec-uplmri10.tfm) tex(ec-uplmri10.vf) tex(ec-uplmri12.tfm) tex(ec-uplmri12.vf) tex(ec-uplmri7.tfm) tex(ec-uplmri7.vf) tex(ec-uplmri8.tfm) tex(ec-uplmri8.vf) tex(ec-uplmri9.tfm) tex(ec-uplmri9.vf) tex(t1uplmr.fd) tex(uppunctlm.sty) texlive-uppunctlm"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ec-lmr10.tfm) tex(ec-lmr12.tfm) tex(ec-lmr7.tfm) tex(ec-lmr8.tfm) tex(ec-lmr9.tfm) tex(ec-lmri10.tfm) tex(ec-lmri12.tfm) tex(ec-lmri7.tfm) tex(ec-lmri8.tfm) tex(ec-lmri9.tfm) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
