...
RPROVIDES:${PN} += "python-libgpiod python3-gpiod python3-gpiod(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgpiod.so.2()(64bit) libgpiomockup.so.0()(64bit) python(abi)"
