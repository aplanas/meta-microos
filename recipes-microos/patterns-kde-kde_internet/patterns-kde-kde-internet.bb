...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-kde-kde_internet patterns-openSUSE-kde4_internet patterns-openSUSE-kde_internet"
RDEPENDS:${PN} += ""
