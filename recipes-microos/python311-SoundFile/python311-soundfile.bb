...
RPROVIDES:${PN} += "python3.11dist(soundfile) python311-PySoundFile python311-SoundFile python311-soundfile python3dist(soundfile)"
RDEPENDS:${PN} += "libsndfile1 python(abi) python311-cffi"
