...
RPROVIDES:${PN} += "ghc-blaze-markup-devel ghc-blaze-markup-devel(aarch-64) ghc-devel(blaze-markup-0.8.2.8-1rqnOPcdOmIw0iYwB3Kqc)"
RDEPENDS:${PN} += "/bin/sh ghc-blaze-markup ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(blaze-builder-0.4.2.2-1GcRIc7N7YHId5Q5gRvlvW) ghc-devel(bytestring-0.11.4.0) ghc-devel(text-2.0.2)"
