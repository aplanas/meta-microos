...
RPROVIDES:${PN} += "libcroco-devel libcroco-devel(aarch-64) pkgconfig(libcroco-0.6)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libcroco libcroco-0_6-3 pkgconfig(glib-2.0) pkgconfig(libxml-2.0)"
