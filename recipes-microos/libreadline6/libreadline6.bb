...
RPROVIDES:${PN} += "bash:/lib64/libreadline.so.6 libhistory.so.6()(64bit) libhistory.so.6(READLINE_6.3)(64bit) libreadline.so.6()(64bit) libreadline.so.6(READLINE_6.3)(64bit) libreadline6 libreadline6(aarch-64) readline"
