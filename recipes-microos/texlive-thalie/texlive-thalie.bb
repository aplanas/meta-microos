...
RPROVIDES:${PN} += "tex(thalie.sty) texlive-thalie"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(pgfkeys.sty) tex(pgfopts.sty) tex(suffix.sty) tex(tabularx.sty) tex(translations.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
