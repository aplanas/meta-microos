...
RPROVIDES:${PN} += "python3.9dist(irc) python39-irc python39-irclib python3dist(irc)"
RDEPENDS:${PN} += "python(abi) python39-importlib-metadata python39-jaraco.collections python39-jaraco.functools python39-jaraco.logging python39-jaraco.stream python39-jaraco.text python39-more-itertools python39-pytz python39-tempora"
