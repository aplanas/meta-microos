...
RPROVIDES:${PN} += "cmake(QXmpp) cmake(QXmppOmemo) libqxmpp-devel libqxmpp-devel(aarch-64) libqxmpp-qt5-devel pkgconfig(qxmpp)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libqxmpp4 pkgconfig(gstreamer-1.0)"
