...
RPROVIDES:${PN} += "ghc-devel(vault-0.3.1.5-1nJxIV9kR8e5L3ZIpYZHc) ghc-vault-devel ghc-vault-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-devel(unordered-containers-0.2.19.1-KblUXVJ0SvRCcK89PoBx7E) ghc-vault"
