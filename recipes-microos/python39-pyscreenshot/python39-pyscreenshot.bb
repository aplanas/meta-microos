...
RPROVIDES:${PN} += "python3.9dist(pyscreenshot) python39-pyscreenshot python3dist(pyscreenshot)"
RDEPENDS:${PN} += "python(abi) python39-EasyProcess python39-entrypoint2 python39-jeepney python39-mss xorg-x11-server-extra"
