...
RPROVIDES:${PN} += "libverto-glib.so.1()(64bit) libverto-glib1 libverto-glib1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libverto.so.1()(64bit) libverto1"
