...
RPROVIDES:${PN} += "libmdbsql.so.3()(64bit) libmdbsql3 libmdbsql3(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libmdb.so.3()(64bit)"
