...
RPROVIDES:${PN} += "ruby3.2-rubygem-netrc \
ruby3.2-rubygem-netrc(aarch-64) \
rubygem(netrc) \
rubygem(ruby:3.2.0:netrc) \
rubygem(ruby:3.2.0:netrc:0) \
rubygem(ruby:3.2.0:netrc:0.11) \
rubygem(ruby:3.2.0:netrc:0.11.0)"
