...
RPROVIDES:${PN} += "python3.11dist(pywlroots) python311-pywlroots python311-pywlroots(aarch-64) python3dist(pywlroots)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libwlroots.so.11()(64bit) python(abi) python311-pywayland python311-xkbcommon"
