...
RPROVIDES:${PN} += "ruby3.2-rubygem-httpclient ruby3.2-rubygem-httpclient(aarch-64) rubygem(httpclient) rubygem(ruby:3.2.0:httpclient) rubygem(ruby:3.2.0:httpclient:2) rubygem(ruby:3.2.0:httpclient:2.8) rubygem(ruby:3.2.0:httpclient:2.8.3)"
