...
RPROVIDES:${PN} += "python3.9dist(cauldron-notebook) python39-cauldron-notebook python3dist(cauldron-notebook)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Flask python39-Jinja2 python39-Markdown python39-beautifulsoup4 python39-numpy python39-pandas python39-pygments python39-requests update-alternatives"
