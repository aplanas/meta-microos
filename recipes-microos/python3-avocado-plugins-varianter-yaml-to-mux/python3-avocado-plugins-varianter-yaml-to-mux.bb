...
RPROVIDES:${PN} += "python3-avocado-plugins-varianter-yaml-to-mux python3.10dist(avocado-framework-plugin-varianter-yaml-to-mux) python3dist(avocado-framework-plugin-varianter-yaml-to-mux)"
RDEPENDS:${PN} += "python(abi) python3-avocado python3-pyaml"
