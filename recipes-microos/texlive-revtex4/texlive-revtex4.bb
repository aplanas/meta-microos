...
RPROVIDES:${PN} += "tex(10pt.rtx) tex(11pt.rtx) tex(12pt.rtx) tex(aps.rtx) tex(revsymb.sty) tex(revtex4.cls) tex(rmp.rtx) texlive-revtex4"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(hyperref.sty) tex(natbib.sty) tex(url.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
