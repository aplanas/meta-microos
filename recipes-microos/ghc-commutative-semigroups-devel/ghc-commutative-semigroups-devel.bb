...
RPROVIDES:${PN} += "ghc-commutative-semigroups-devel ghc-commutative-semigroups-devel(aarch-64) ghc-devel(commutative-semigroups-0.1.0.1-EHuCShtv7U46wPCL9foais)"
RDEPENDS:${PN} += "/bin/sh ghc-commutative-semigroups ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7)"
