...
RPROVIDES:${PN} += "compiz-emerald-devel compiz-emerald-devel(aarch-64) pkgconfig(emeraldengine)"
RDEPENDS:${PN} += "/usr/bin/pkg-config compiz-emerald gcc-c++ pkgconfig(cairo) pkgconfig(gtk+-3.0) pkgconfig(libdecoration) pkgconfig(libwnck-3.0) pkgconfig(pangocairo) pkgconfig(xi) pkgconfig(xrender)"
