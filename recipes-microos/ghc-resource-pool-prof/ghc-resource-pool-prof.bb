...
RPROVIDES:${PN} += "ghc-prof(resource-pool-0.4.0.0-CALzen0PV047R0s78YnQuW) ghc-resource-pool-prof ghc-resource-pool-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-prof(primitive-0.7.4.0-AeB0oysC3TAJw9tDpuX8hq) ghc-prof(time-1.12.2) ghc-resource-pool-devel"
