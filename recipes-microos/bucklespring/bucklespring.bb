...
RPROVIDES:${PN} += "application() application(buckle.desktop) bucklespring bucklespring(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libXtst.so.6()(64bit) libalure.so.1()(64bit) libalure.so.1(LIBALURE_1.0)(64bit) libc.so.6(GLIBC_2.34)(64bit) libopenal.so.1()(64bit)"
