...
RPROVIDES:${PN} += "python3.9dist(azure-cognitiveservices-vision-contentmoderator) python39-azure-cognitiveservices-vision-contentmoderator python3dist(azure-cognitiveservices-vision-contentmoderator)"
RDEPENDS:${PN} += "python(abi) python39-azure-cognitiveservices-nspkg python39-azure-cognitiveservices-vision-nspkg python39-azure-common python39-azure-nspkg python39-msrest"
