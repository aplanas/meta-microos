...
RPROVIDES:${PN} += "python3-Glymur python3.10dist(glymur) python310-Glymur python3dist(glymur)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-lxml python310-numpy python310-packaging update-alternatives"
