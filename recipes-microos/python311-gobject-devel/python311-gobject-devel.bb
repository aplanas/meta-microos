...
RPROVIDES:${PN} += "python311-gobject-devel python311-gobject-devel(aarch-64)"
RDEPENDS:${PN} += "python311-devel python311-gobject python311-gobject-Gdk python311-gobject-cairo python311-gobject-common-devel"
