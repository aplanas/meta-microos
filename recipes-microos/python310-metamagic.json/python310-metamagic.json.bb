...
RPROVIDES:${PN} += "python3-metamagic.json python3.10dist(metamagic.json) python310-metamagic.json python310-metamagic.json(aarch-64) python3dist(metamagic.json)"
