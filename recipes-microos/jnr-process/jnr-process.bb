...
RPROVIDES:${PN} += "jnr-process mvn(com.github.jnr:jnr-process) mvn(com.github.jnr:jnr-process:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.github.jnr:jnr-constants) mvn(com.github.jnr:jnr-enxio) mvn(com.github.jnr:jnr-posix)"
