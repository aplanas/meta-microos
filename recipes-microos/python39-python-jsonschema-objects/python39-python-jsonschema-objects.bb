...
RPROVIDES:${PN} += "python3.9dist(python-jsonschema-objects) python39-python-jsonschema-objects python3dist(python-jsonschema-objects)"
RDEPENDS:${PN} += "python(abi) python39-Markdown python39-inflection python39-jsonschema python39-six"
