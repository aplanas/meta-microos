...
RPROVIDES:${PN} += "config(gssntlmssp) gssntlmssp gssntlmssp(aarch-64)"
RDEPENDS:${PN} += "krb5 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libgssapi_krb5.so.2()(64bit) libgssapi_krb5.so.2(gssapi_krb5_2_MIT)(64bit) libunistring.so.5()(64bit) libwbclient.so.0()(64bit) libwbclient.so.0(WBCLIENT_0.12)(64bit) libwbclient.so.0(WBCLIENT_0.9)(64bit) libz.so.1()(64bit)"
