...
RPROVIDES:${PN} += "python3.9dist(pytest-git) python39-pytest-git python3dist(pytest-git)"
RDEPENDS:${PN} += "python(abi) python39-GitPython python39-pytest python39-pytest-shutil"
