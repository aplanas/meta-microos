...
RPROVIDES:${PN} += "libinsane-devel libinsane-devel(aarch-64) pkgconfig(libinsane)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libinsane1 pkgconfig(sane-backends) typelib-1_0-Libinsane-1_0"
