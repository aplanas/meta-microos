...
RPROVIDES:${PN} += "python3.11dist(certbot-dns-digitalocean) python311-certbot-dns-digitalocean python3dist(certbot-dns-digitalocean)"
RDEPENDS:${PN} += "python(abi) python311-acme python311-certbot python311-digitalocean python311-six python311-zope.interface"
