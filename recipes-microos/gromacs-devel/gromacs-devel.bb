...
RPROVIDES:${PN} += "cmake(gmxapi) cmake(gromacs) gromacs-devel gromacs-devel(aarch-64) pkgconfig(libgromacs)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gromacs libgmxapi0 libgromacs8 libnblib_gmx0 pkgconfig(fftw3f)"
