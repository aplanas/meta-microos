...
RPROVIDES:${PN} += "python3.11dist(zignal) python311-zignal python3dist(zignal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-matplotlib python311-numpy python311-samplerate python311-scipy update-alternatives"
