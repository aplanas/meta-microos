...
RPROVIDES:${PN} += "pkgconfig(xwayland) xwayland-devel xwayland-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config c_compiler meson pkgconfig(libdrm) pkgconfig(xau) pkgconfig(xdmcp) pkgconfig(xkbfile) pkgconfig(xtrans) pkgconfig(xv) xwayland"
