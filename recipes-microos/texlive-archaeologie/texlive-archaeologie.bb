...
RPROVIDES:${PN} += "tex(archaeologie.bbx) tex(archaeologie.cbx) tex(english-archaeologie.lbx) tex(french-archaeologie.lbx) tex(german-archaeologie.lbx) tex(italian-archaeologie.lbx) tex(spanish-archaeologie.lbx) texlive-archaeologie"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(standard.bbx) tex(ulem.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
