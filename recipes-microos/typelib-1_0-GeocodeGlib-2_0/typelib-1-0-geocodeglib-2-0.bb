...
RPROVIDES:${PN} += "typelib(GeocodeGlib) typelib-1_0-GeocodeGlib-2_0 typelib-1_0-GeocodeGlib-2_0(aarch-64)"
RDEPENDS:${PN} += "libgeocode-glib-2.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Json) typelib(Soup)"
