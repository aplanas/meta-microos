...
RPROVIDES:${PN} += "python3.9dist(urlgrabber) python39-urlgrabber python3dist(urlgrabber)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-pycurl update-alternatives"
