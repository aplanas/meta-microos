...
RPROVIDES:${PN} += "python3.11dist(dash) python311-dash python3dist(dash)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Flask python311-Flask-Compress python311-beautifulsoup4 python311-dash-core-components python311-dash-html-components python311-dash-table python311-percy python311-plotly update-alternatives"
