...
RPROVIDES:${PN} += "perl(Mojo::SQLite) perl(Mojo::SQLite::Database) perl(Mojo::SQLite::Migrations) perl(Mojo::SQLite::PubSub) perl(Mojo::SQLite::Results) perl(Mojo::SQLite::Transaction) perl-Mojo-SQLite"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DBD::SQLite) perl(DBI) perl(Mojolicious) perl(SQL::Abstract::Pg) perl(URI) perl(URI::db) perl(URI::file)"
