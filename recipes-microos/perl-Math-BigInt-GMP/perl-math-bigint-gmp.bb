...
RPROVIDES:${PN} += "perl(Math::BigInt::GMP) perl-Math-BigInt-GMP perl-Math-BigInt-GMP(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) libgmp.so.10()(64bit) perl(:MODULE_COMPAT_5.36.0) perl(Carp) perl(Math::BigInt)"
