...
RPROVIDES:${PN} += "tex(grffile-2017-06-30.sty) tex(grffile.sty) texlive-grffile"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphics.sty) tex(graphicx.sty) tex(ifpdf.sty) tex(ifxetex.sty) tex(kvoptions.sty) tex(pdftexcmds.sty) tex(stringenc.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
