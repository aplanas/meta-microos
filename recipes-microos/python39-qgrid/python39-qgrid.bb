...
RPROVIDES:${PN} += "python3.9dist(qgrid) python39-qgrid python3dist(qgrid)"
RDEPENDS:${PN} += "jupyter-qgrid python(abi) python39-ipywidgets python39-notebook python39-pandas"
