...
RPROVIDES:${PN} += "typelib(Gcr) typelib-1_0-Gcr-4 typelib-1_0-Gcr-4(aarch-64)"
RDEPENDS:${PN} += "libgcr-4.so.4()(64bit) typelib(GLib) typelib(GObject) typelib(Gck) typelib(Gio) typelib-1_0-Gck-2"
