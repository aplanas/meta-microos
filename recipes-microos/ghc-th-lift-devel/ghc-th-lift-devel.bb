...
RPROVIDES:${PN} += "ghc-devel(th-lift-0.8.3-BVnK9vFPlpnBx7d6MzGvJN) ghc-th-lift-devel ghc-th-lift-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(ghc-prim-0.9.0) ghc-devel(template-haskell-2.19.0.0) ghc-devel(th-abstraction-0.4.5.0-8bY5lBPMorfFW3yG6gFNZT) ghc-th-lift"
