...
RPROVIDES:${PN} += "libchromaprint-devel libchromaprint-devel(aarch-64) pkgconfig(libchromaprint)"
RDEPENDS:${PN} += "/usr/bin/pkg-config fftw3-devel libchromaprint1 libtag-devel"
