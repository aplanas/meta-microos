...
RPROVIDES:${PN} += "python3-azure-mgmt-authorization python3.10dist(azure-mgmt-authorization) python310-azure-mgmt-authorization python3dist(azure-mgmt-authorization)"
RDEPENDS:${PN} += "python(abi) python310-azure-common python310-azure-mgmt-core python310-azure-nspkg python310-msrest"
