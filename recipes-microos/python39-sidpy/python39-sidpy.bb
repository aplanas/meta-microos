...
RPROVIDES:${PN} += "python3.9dist(sidpy) python39-sidpy python3dist(sidpy)"
RDEPENDS:${PN} += "python(abi) python39-ase python39-cytoolz python39-dask python39-dask-array python39-distributed python39-h5py python39-ipython python39-ipywidgets python39-joblib python39-matplotlib python39-numpy python39-psutil python39-scikit-learn python39-scipy python39-toolz"
