...
RPROVIDES:${PN} += "aws-sdk-java-elasticloadbalancing mvn(com.amazonaws:aws-java-sdk-elasticloadbalancing) mvn(com.amazonaws:aws-java-sdk-elasticloadbalancing:pom:)"
