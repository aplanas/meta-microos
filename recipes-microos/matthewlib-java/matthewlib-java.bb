...
RPROVIDES:${PN} += "libcgi-java.so()(64bit) libmatthew-java libunix-java.so()(64bit) matthewlib-java matthewlib-java(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig java javapackages-tools libc.so.6(GLIBC_2.17)(64bit)"
