...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.DRBD.desktop) metainfo() metainfo(org.opensuse.yast.DRBD.metainfo.xml) yast2-drbd yast2-drbd(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/ruby drbd yast2 yast2-ruby-bindings"
