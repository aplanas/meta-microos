...
RPROVIDES:${PN} += "python3.11dist(markdown-it-py) python311-markdown-it-py python3dist(markdown-it-py)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-mdurl update-alternatives"
