...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.Alternatives.desktop) metainfo() metainfo(org.opensuse.yast.Alternatives.metainfo.xml) yast2-alternatives yast2-alternatives(aarch-64)"
RDEPENDS:${PN} += ""
