...
RPROVIDES:${PN} += "pkgconfig(pygobject-3.0) python-gobject-common-devel python-gobject-common-devel(aarch-64) python310-gobject-common-devel python311-gobject-common-devel python39-gobject-common-devel"
RDEPENDS:${PN} += "/usr/bin/pkg-config glib2-devel gobject-introspection-devel libffi-devel pkgconfig(cairo) pkgconfig(cairo-gobject) pkgconfig(gobject-2.0) pkgconfig(libffi)"
