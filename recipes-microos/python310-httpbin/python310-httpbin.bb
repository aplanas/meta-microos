...
RPROVIDES:${PN} += "python3-httpbin python3.10dist(httpbin) python310-httpbin python3dist(httpbin)"
RDEPENDS:${PN} += "python(abi) python310-Brotli python310-Flask python310-MarkupSafe python310-Werkzeug python310-blinker python310-decorator python310-flasgger python310-gevent python310-itsdangerous python310-six"
