...
RPROVIDES:${PN} += "application() application(grsync.desktop) grsync grsync(aarch-64) metainfo() metainfo(grsync.appdata.xml) mimehandler(application/x-grsync-session)"
RDEPENDS:${PN} += "/bin/bash ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libpango-1.0.so.0()(64bit) rsync"
