...
RPROVIDES:${PN} += "python3.11dist(jupyter-latex-envs) python311-jupyter_latex_envs python3dist(jupyter-latex-envs)"
RDEPENDS:${PN} += "python(abi) python311-ipython python311-jupyter_core python311-nbconvert python311-notebook python311-traitlets"
