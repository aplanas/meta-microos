...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-language-nspkg) python311-azure-cognitiveservices-language-nspkg python3dist(azure-cognitiveservices-language-nspkg)"
