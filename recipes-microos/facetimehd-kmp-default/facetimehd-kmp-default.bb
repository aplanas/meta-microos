...
RPROVIDES:${PN} += "facetimehd-kmp facetimehd-kmp-default facetimehd-kmp-default(aarch-64) facetimehd-kmp-default-k6.3.4_1 kmod(facetimehd.ko) multiversion(kernel)"
