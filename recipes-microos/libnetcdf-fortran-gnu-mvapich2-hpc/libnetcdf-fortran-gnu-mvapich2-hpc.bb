...
RPROVIDES:${PN} += "libnetcdf-fortran-gnu-mvapich2-hpc libnetcdf-fortran-gnu-mvapich2-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/sh libnetcdf-fortran_4_5_3-gnu-mvapich2-hpc"
