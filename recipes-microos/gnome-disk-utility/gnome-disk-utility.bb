...
application(gnome-disk-image-mounter.desktop) \
application(gnome-disk-image-writer.desktop) \
application(org.gnome.DiskUtility.desktop) \
gnome-disk-utility \
gnome-disk-utility(aarch-64) \
metainfo() \
metainfo(org.gnome.DiskUtility.appdata.xml) \
