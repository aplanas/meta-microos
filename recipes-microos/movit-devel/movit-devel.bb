...
RPROVIDES:${PN} += "movit-devel movit-devel(aarch-64) pkgconfig(movit)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmovit8 pkgconfig(eigen3) pkgconfig(epoxy) pkgconfig(fftw3)"
