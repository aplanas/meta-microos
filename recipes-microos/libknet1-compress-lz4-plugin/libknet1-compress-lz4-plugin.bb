...
RPROVIDES:${PN} += "libknet1-compress-lz4-plugin libknet1-compress-lz4-plugin(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) libknet1(aarch-64) liblz4.so.1()(64bit)"
