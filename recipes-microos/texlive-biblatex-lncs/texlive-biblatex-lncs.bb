...
RPROVIDES:${PN} += "tex(lncs.bbx) tex(lncs.cbx) texlive-biblatex-lncs"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(numeric.bbx) tex(numeric.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
