...
RPROVIDES:${PN} += "fcitx-fbterm fcitx-fbterm(aarch-64) locale(fbterm:ko;zh_CN;zh_SG)"
RDEPENDS:${PN} += "/bin/bash libc.so.6(GLIBC_2.34)(64bit) libfcitx-gclient.so.1()(64bit) libfcitx-utils.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit)"
