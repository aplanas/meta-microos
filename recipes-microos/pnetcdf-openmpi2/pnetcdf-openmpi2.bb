...
RPROVIDES:${PN} += "parallel-netcdf-openmpi2 pnetcdf-openmpi2 pnetcdf-openmpi2(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libmpi.so.20()(64bit) libpnetcdf.so.4()(64bit) libpnetcdf4-openmpi2 openmpi2"
