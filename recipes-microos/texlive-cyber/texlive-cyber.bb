...
RPROVIDES:${PN} += "tex(cyber.sty) texlive-cyber"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(fancyhdr.sty) tex(graphicx.sty) tex(index.sty) tex(longtable.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
