...
RPROVIDES:${PN} += "monitoring-plugins-breeze monitoring-plugins-breeze(aarch-64) nagios-plugins-breeze"
RDEPENDS:${PN} += "/usr/bin/perl monitoring-plugins-common net-snmp perl"
