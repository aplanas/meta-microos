...
RPROVIDES:${PN} += "ghc-data-default-class-devel ghc-data-default-class-devel(aarch-64) ghc-devel(data-default-class-0.1.2.0-2LD1I8dZmn7BW4dkzEwdGZ)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-data-default-class ghc-devel(base-4.17.1.0)"
