...
RPROVIDES:${PN} += "tex(dtk-authoryear.bbx) tex(dtk-logos.sty) texlive-dtk-bibliography"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(authoryear.bbx) tex(dantelogo.sty) tex(fetamont.sty) tex(hologo.sty) tex(iftex.sty) tex(unicode-math.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
