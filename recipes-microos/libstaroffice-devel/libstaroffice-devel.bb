...
RPROVIDES:${PN} += "libstaroffice-devel libstaroffice-devel(aarch-64) pkgconfig(libstaroffice-0.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libstaroffice-0_0-0 libstdc++-devel pkgconfig(librevenge-0.0)"
