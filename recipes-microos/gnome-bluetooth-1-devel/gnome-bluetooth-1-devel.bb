...
RPROVIDES:${PN} += "gnome-bluetooth-1-devel gnome-bluetooth-1-devel(aarch-64) pkgconfig(gnome-bluetooth-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gnome-bluetooth-1 libgnome-bluetooth13 pkgconfig(gio-2.0) pkgconfig(gtk+-3.0) typelib-1_0-GnomeBluetooth-1_0"
