...
RPROVIDES:${PN} += "python3.9dist(parver) python39-parver python3dist(parver)"
RDEPENDS:${PN} += "python(abi) python39-Arpeggio python39-attrs python39-typing_extensions"
