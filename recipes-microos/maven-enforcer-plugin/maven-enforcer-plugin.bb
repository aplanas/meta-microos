...
RPROVIDES:${PN} += "maven-enforcer-plugin mvn(org.apache.maven.plugins:maven-enforcer-plugin) mvn(org.apache.maven.plugins:maven-enforcer-plugin:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(commons-lang:commons-lang) mvn(org.apache.maven.enforcer:enforcer-api) mvn(org.apache.maven.enforcer:enforcer-rules) mvn(org.apache.maven.plugin-testing:maven-plugin-testing-harness) mvn(org.apache.maven:maven-artifact) mvn(org.apache.maven:maven-core) mvn(org.apache.maven:maven-plugin-api) mvn(org.codehaus.plexus:plexus-utils)"
