...
RPROVIDES:${PN} += "ghc-devel(memory-0.18.0-2DG6nqjfLMK4MSR77XYQqL) ghc-memory-devel ghc-memory-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(basement-0.0.15-6OmKTVi2kFpCWMoKDlsO4S) ghc-devel(bytestring-0.11.4.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(ghc-prim-0.9.0) ghc-memory"
