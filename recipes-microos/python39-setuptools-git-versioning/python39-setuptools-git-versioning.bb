...
RPROVIDES:${PN} += "python3.9dist(setuptools-git-versioning) python39-setuptools-git-versioning python39-setuptools_git_versioning python3dist(setuptools-git-versioning)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 git-core python(abi) python39-Deprecated python39-packaging python39-setuptools python39-toml update-alternatives"
