...
RPROVIDES:${PN} += "python3-azure-cognitiveservices-personalizer python3.10dist(azure-cognitiveservices-personalizer) python310-azure-cognitiveservices-personalizer python3dist(azure-cognitiveservices-personalizer)"
