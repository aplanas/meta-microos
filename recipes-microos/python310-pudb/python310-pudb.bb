...
RPROVIDES:${PN} += "python3-pudb python3.10dist(pudb) python310-pudb python3dist(pudb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Pygments python310-urwid update-alternatives"
