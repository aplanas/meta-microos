...
RPROVIDES:${PN} += "python3.9dist(pytest-benchmark) python39-pytest-benchmark python3dist(pytest-benchmark)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-py-cpuinfo python39-pytest update-alternatives"
