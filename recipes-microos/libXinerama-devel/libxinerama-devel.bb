...
RPROVIDES:${PN} += "libXinerama-devel libXinerama-devel(aarch-64) pkgconfig(xinerama)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXinerama1 pkgconfig(x11) pkgconfig(xext) pkgconfig(xineramaproto)"
