...
RPROVIDES:${PN} += "ruby3.2-rubygem-sexp_processor ruby3.2-rubygem-sexp_processor(aarch-64) rubygem(ruby:3.2.0:sexp_processor) rubygem(ruby:3.2.0:sexp_processor:4) rubygem(ruby:3.2.0:sexp_processor:4.16) rubygem(ruby:3.2.0:sexp_processor:4.16.1) rubygem(sexp_processor)"
