...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-devel-base-devel_kernel patterns-devel-base-devel_kernel(aarch-64)"
RDEPENDS:${PN} += "pattern()"
