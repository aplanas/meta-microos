...
RPROVIDES:${PN} += "libplplotjavac_wrap.so()(64bit) plplot-java plplot-java(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/bash java ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libplplot.so.17()(64bit) plplot-common"
