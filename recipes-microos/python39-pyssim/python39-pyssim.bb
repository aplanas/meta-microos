...
RPROVIDES:${PN} += "python3.9dist(pyssim) python39-pyssim python3dist(pyssim)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Pillow python39-numpy python39-scipy update-alternatives"
