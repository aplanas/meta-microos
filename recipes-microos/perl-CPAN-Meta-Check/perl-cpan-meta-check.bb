...
RPROVIDES:${PN} += "perl(CPAN::Meta::Check) perl-CPAN-Meta-Check"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(CPAN::Meta::Prereqs) perl(CPAN::Meta::Requirements) perl(Module::Metadata)"
