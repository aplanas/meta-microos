...
RPROVIDES:${PN} += "python3-oic python3.10dist(oic) python310-oic python3dist(oic)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Beaker python310-Mako python310-cryptography python310-dbm python310-defusedxml python310-pycryptodomex python310-pyjwkest python310-requests python310-typing python310-typing_extensions"
