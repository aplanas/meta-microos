...
RPROVIDES:${PN} += "tex(amsbsy.sty) tex(amscd.sty) tex(amsgen.sty) tex(amsmath-2018-12-01.sty) tex(amsmath.sty) tex(amsopn.sty) tex(amstex.sty) tex(amstext.sty) tex(amsxtra.sty) texlive-amsmath"
