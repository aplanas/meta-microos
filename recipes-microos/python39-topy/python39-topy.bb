...
RPROVIDES:${PN} += "python3.9dist(topy) python39-topy python3dist(topy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-beautifulsoup4 python39-regex update-alternatives"
