...
RPROVIDES:${PN} += "python3.9dist(jinja2-pluralize) python39-jinja2-pluralize python3dist(jinja2-pluralize)"
RDEPENDS:${PN} += "python(abi) python39-Jinja2 python39-inflect"
