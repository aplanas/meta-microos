...
RPROVIDES:${PN} += "ghc-network-info-prof ghc-network-info-prof(aarch-64) ghc-prof(network-info-0.2.1-G9nMDkAKQecAEHIupCmq9I)"
RDEPENDS:${PN} += "ghc-network-info-devel ghc-prof(base-4.17.1.0)"
