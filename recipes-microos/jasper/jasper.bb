...
RPROVIDES:${PN} += "jasper jasper(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libGLU.so.1()(64bit) libGLX.so.0()(64bit) libOpenGL.so.0()(64bit) libc.so.6(GLIBC_2.34)(64bit) libglut.so.3()(64bit) libjasper.so.7()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit)"
