...
RPROVIDES:${PN} += "tex(pseudo.sty) texlive-pseudo"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(aliascnt.sty) tex(array.sty) tex(colortbl.sty) tex(etoolbox.sty) tex(expl3.sty) tex(l3keys2e.sty) tex(pgfkeys.sty) tex(xcolor.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
