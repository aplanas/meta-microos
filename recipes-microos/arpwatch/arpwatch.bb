...
RPROVIDES:${PN} += "arpwatch arpwatch(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/touch arpwatch-ethercodes coreutils fillup ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpcap.so.1()(64bit) libresolv.so.2()(64bit) libresolv.so.2(GLIBC_2.17)(64bit)"
