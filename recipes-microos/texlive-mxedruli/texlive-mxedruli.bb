...
RPROVIDES:${PN} += "tex(mxed10.tfm) tex(mxedbf10.tfm) tex(mxedc10.tfm) tex(mxedi10.tfm) tex(mxedruli.map) tex(mxedruli.sty) tex(umxed.fd) tex(uxuc.fd) tex(xuc10.tfm) tex(xucuri.sty) texlive-mxedruli"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-mxedruli-fonts texlive-scripts texlive-scripts-bin"
