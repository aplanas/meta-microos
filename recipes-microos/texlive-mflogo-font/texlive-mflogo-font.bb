...
RPROVIDES:${PN} += "tex(mflogo.map) texlive-mflogo-font"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-mflogo-font-fonts texlive-scripts texlive-scripts-bin"
