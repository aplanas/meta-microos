...
RPROVIDES:${PN} += "python3.10dist(transifex-client) python3dist(transifex-client) transifex-client"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 python(abi) python3-python-slugify python3-requests python3-setuptools python3-urllib3 update-alternatives"
