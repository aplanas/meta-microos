...
RPROVIDES:${PN} += "perl(OLE::Storage_Lite) perl(OLE::Storage_Lite::PPS) perl(OLE::Storage_Lite::PPS::Dir) perl(OLE::Storage_Lite::PPS::File) perl(OLE::Storage_Lite::PPS::Root) perl-OLE-Storage_Lite"
