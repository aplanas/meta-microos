...
RPROVIDES:${PN} += "libbrotlienc.so.1()(64bit) libbrotlienc1 libbrotlienc1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libbrotlicommon.so.1()(64bit) libc.so.6(GLIBC_2.17)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.29)(64bit)"
