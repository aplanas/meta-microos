...
RPROVIDES:${PN} += "apfel-devel apfel-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/bash LHAPDF-devel libAPFEL.so.0()(64bit) libAPFEL0 libLHAPDF-6.5.4.so()(64bit) libc.so.6(GLIBC_2.34)(64bit) libgfortran.so.5()(64bit) libgfortran.so.5(GFORTRAN_8)(64bit)"
