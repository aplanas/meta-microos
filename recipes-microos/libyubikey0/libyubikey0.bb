...
RPROVIDES:${PN} += "libyubikey.so.0()(64bit) libyubikey.so.0(YUBIKEY_1.0)(64bit) libyubikey.so.0(YUBIKEY_1.5)(64bit) libyubikey.so.0(YUBIKEY_1.6)(64bit) libyubikey0 libyubikey0(aarch-64)"
