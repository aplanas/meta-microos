...
RPROVIDES:${PN} += "python3.11dist(pycha) python311-pycha python3dist(pycha)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-cairocffi update-alternatives"
