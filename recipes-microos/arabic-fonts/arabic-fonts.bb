...
RPROVIDES:${PN} += "arabic-fonts fonts-arabic locale(ar) scalable-font-ar"
RDEPENDS:${PN} += "/bin/sh aaa_base arabic-ae-fonts arabic-bitmap-fonts arabic-kacst-fonts arabic-kacstone-fonts arabic-naqsh-fonts coreutils perl"
