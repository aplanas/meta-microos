...
RPROVIDES:${PN} += "libevent libevent-2.1.so.7()(64bit) libevent-2_1-7 libevent-2_1-7(aarch-64) libevent_core-2.1.so.7()(64bit) libevent_extra-2.1.so.7()(64bit) libevent_openssl-2.1.so.7()(64bit) libevent_pthreads-2.1.so.7()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.36)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libssl.so.3()(64bit) libssl.so.3(OPENSSL_3.0.0)(64bit)"
