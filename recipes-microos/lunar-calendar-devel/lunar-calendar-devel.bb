...
RPROVIDES:${PN} += "lunar-calendar-devel lunar-calendar-devel(aarch-64) pkgconfig(lunar-calendar-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblunar-calendar-3_0-1 pkgconfig(gtk+-3.0) pkgconfig(lunar-date-3.0)"
