...
RPROVIDES:${PN} += "google-noto-serif-sc-fonts-full noto-serif-sc-fonts-full"
RDEPENDS:${PN} += "google-noto-serif-sc-black-fonts google-noto-serif-sc-extralight-fonts google-noto-serif-sc-fonts google-noto-serif-sc-light-fonts google-noto-serif-sc-medium-fonts google-noto-serif-sc-semibold-fonts"
