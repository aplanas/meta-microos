...
RPROVIDES:${PN} += "perl(NetPacket) perl(NetPacket::ARP) perl(NetPacket::Ethernet) perl(NetPacket::ICMP) perl(NetPacket::ICMPv6) perl(NetPacket::IGMP) perl(NetPacket::IP) perl(NetPacket::IPX) perl(NetPacket::IPv6) perl(NetPacket::TCP) perl(NetPacket::UDP) perl(NetPacket::USBMon) perl-NetPacket"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Socket) perl(parent)"
