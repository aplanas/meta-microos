...
RPROVIDES:${PN} += "python3.9dist(pytest-bdd) python39-pytest-bdd python3dist(pytest-bdd)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Mako python39-glob2 python39-parse python39-parse_type python39-py python39-pytest update-alternatives"
