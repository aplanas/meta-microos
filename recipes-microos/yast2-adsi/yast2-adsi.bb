...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.ADSI.desktop) metainfo() metainfo(org.opensuse.yast.ADSI.metainfo.xml) yast2-adsi"
RDEPENDS:${PN} += "krb5-client python3-ldap samba-client samba-python3 yast2 yast2-adcommon-python yast2-python3-bindings"
