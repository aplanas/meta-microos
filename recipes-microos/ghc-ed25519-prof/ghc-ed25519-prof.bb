...
RPROVIDES:${PN} += "ghc-ed25519-prof ghc-ed25519-prof(aarch-64) ghc-prof(ed25519-0.0.5.0-EkN6WeFwHLH4dNF4Xthto8)"
RDEPENDS:${PN} += "ghc-ed25519-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(ghc-prim-0.9.0)"
