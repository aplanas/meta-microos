...
RPROVIDES:${PN} += "libdbdfreetds.so()(64bit) libdbi-drivers-dbd-freetds libdbi-drivers-dbd-freetds(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libct.so.4()(64bit) libdbi.so.3()(64bit) libdbi.so.3(ABI_3)(64bit)"
