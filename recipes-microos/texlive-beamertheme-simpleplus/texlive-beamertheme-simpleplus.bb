...
RPROVIDES:${PN} += "tex(beamercolorthemeSimplePlus.sty) tex(beamerfontthemeSimplePlus.sty) tex(beamerinnerthemeSimplePlus.sty) tex(beamerthemeSimplePlus.sty) texlive-beamertheme-simpleplus"
