...
RPROVIDES:${PN} += "python3.9dist(jsonpatch) python39-jsonpatch python3dist(jsonpatch)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 alts python(abi) python39-jsonpointer"
