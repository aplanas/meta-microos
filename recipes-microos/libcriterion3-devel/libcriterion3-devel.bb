...
RPROVIDES:${PN} += "libcriterion3-devel libcriterion3-devel(aarch-64) pkgconfig(criterion)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libcriterion3 pkgconfig(boxfort) pkgconfig(libffi) pkgconfig(libgit2) pkgconfig(nanomsg)"
