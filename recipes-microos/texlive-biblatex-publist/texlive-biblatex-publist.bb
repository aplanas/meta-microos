...
RPROVIDES:${PN} += "tex(publist.bbx) tex(publist.cbx) texlive-biblatex-publist"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(numeric.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
