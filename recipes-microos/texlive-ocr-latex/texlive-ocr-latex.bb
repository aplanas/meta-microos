...
RPROVIDES:${PN} += "tex(ocr.sty) tex(ot1oca.fd) tex(ot1ocra.fd) tex(ot1ocrb.fd) tex(ot1ocrbn.fd) tex(ot1ocrbns.fd) tex(ot1ocrbo.fd) tex(ot1ocrbs.fd) texlive-ocr-latex"
