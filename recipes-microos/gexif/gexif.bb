...
RPROVIDES:${PN} += "application() application(gexif.desktop) gexif gexif(aarch-64)"
RDEPENDS:${PN} += "gexif-lang ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libexif-gtk.so.5()(64bit) libexif.so.12()(64bit) libgdk_pixbuf-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit)"
