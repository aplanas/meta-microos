...
RPROVIDES:${PN} += "python3.11dist(jsonpatch) python311-jsonpatch python3dist(jsonpatch)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 alts python(abi) python311-jsonpointer"
