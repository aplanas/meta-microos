...
RPROVIDES:${PN} += "python3.11dist(pycocotools) python311-cocotools python311-pycocotools python311-pycocotools(aarch-64) python3dist(pycocotools)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-Cython python311-matplotlib python311-setuptools"
