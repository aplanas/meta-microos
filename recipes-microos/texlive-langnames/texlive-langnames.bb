...
RPROVIDES:${PN} += "tex(langnames.sty) tex(ln_fams_glot.tex) tex(ln_fams_wals.tex) tex(ln_langs_glot.tex) tex(ln_langs_glot_native.tex) tex(ln_langs_wals.tex) tex(ln_langs_wals_native.tex) texlive-langnames"
