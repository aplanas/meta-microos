...
RPROVIDES:${PN} += "cal10n mvn(ch.qos.cal10n:cal10n-ant-task) mvn(ch.qos.cal10n:cal10n-ant-task:pom:) mvn(ch.qos.cal10n:cal10n-api) mvn(ch.qos.cal10n:cal10n-api:pom:) mvn(ch.qos.cal10n:cal10n-parent:pom:) osgi(cal10n.api)"
