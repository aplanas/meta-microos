...
RPROVIDES:${PN} += "libcollection.so.4()(64bit) libcollection.so.4(COLLECTION_0.6.2)(64bit) libcollection.so.4(COLLECTION_0.7)(64bit) libcollection4 libcollection4(aarch-64)"
