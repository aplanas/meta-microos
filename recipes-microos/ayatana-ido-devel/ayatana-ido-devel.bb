...
RPROVIDES:${PN} += "ayatana-ido-devel ayatana-ido-devel(aarch-64) pkgconfig(libayatana-ido3-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libayatana-ido3-0_4-0 pkgconfig(glib-2.0) pkgconfig(gobject-introspection-1.0) pkgconfig(gtk+-3.0) typelib-1_0-AyatanaIdo3-0_4"
