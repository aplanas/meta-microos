...
RPROVIDES:${PN} += "ruby3.2-rubygem-base32 ruby3.2-rubygem-base32(aarch-64) rubygem(base32) rubygem(ruby:3.2.0:base32) rubygem(ruby:3.2.0:base32:0) rubygem(ruby:3.2.0:base32:0.3) rubygem(ruby:3.2.0:base32:0.3.4)"
