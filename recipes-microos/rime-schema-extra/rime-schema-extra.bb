...
RDEPENDS:${PN} += "rime-schema-array rime-schema-cantonese rime-schema-combo-pinyin rime-schema-double-pinyin rime-schema-emoji rime-schema-essay-simp rime-schema-ipa rime-schema-middle-chinese rime-schema-pinyin-simp rime-schema-quick rime-schema-scj rime-schema-soutzoe rime-schema-stenotype rime-schema-wubi rime-schema-wugniu"
