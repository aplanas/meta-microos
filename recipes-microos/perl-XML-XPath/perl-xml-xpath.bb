...
RPROVIDES:${PN} += "perl(XML::XPath) perl(XML::XPath::Boolean) perl(XML::XPath::Builder) perl(XML::XPath::Expr) perl(XML::XPath::Function) perl(XML::XPath::Literal) perl(XML::XPath::LocationPath) perl(XML::XPath::Node) perl(XML::XPath::Node::Attribute) perl(XML::XPath::Node::AttributeImpl) perl(XML::XPath::Node::Comment) perl(XML::XPath::Node::CommentImpl) perl(XML::XPath::Node::Element) perl(XML::XPath::Node::ElementImpl) perl(XML::XPath::Node::Namespace) perl(XML::XPath::Node::NamespaceImpl) perl(XML::XPath::Node::PI) perl(XML::XPath::Node::PIImpl) perl(XML::XPath::Node::Text) perl(XML::XPath::Node::TextImpl) perl(XML::XPath::NodeImpl) perl(XML::XPath::NodeSet) perl(XML::XPath::Number) perl(XML::XPath::Parser) perl(XML::XPath::PerlSAX) perl(XML::XPath::Root) perl(XML::XPath::Step) perl(XML::XPath::Variable) perl(XML::XPath::XMLParser) perl-XML-XPath"
RDEPENDS:${PN} += "/usr/bin/env perl(:MODULE_COMPAT_5.36.0) perl(Scalar::Util) perl(XML::Parser)"
