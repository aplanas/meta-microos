...
RPROVIDES:${PN} += "cmake(Qt5HunspellInputMethod) libQt5HunspellInputMethod-private-headers-devel libQt5HunspellInputMethod-private-headers-devel(aarch-64)"
RDEPENDS:${PN} += "libQt5HunspellInputMethod5 libqt5-qtvirtualkeyboard-private-headers-devel"
