...
RPROVIDES:${PN} += "python3.11dist(rdflib) python311-rdflib python3dist(rdflib)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-html5lib python311-isodate python311-pyparsing update-alternatives"
