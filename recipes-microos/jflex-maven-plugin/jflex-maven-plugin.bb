...
RPROVIDES:${PN} += "jflex-maven-plugin mvn(de.jflex:jflex-maven-plugin) mvn(de.jflex:jflex-maven-plugin:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.google.code.findbugs:jsr305) mvn(com.google.guava:guava) mvn(de.jflex:jflex) mvn(org.apache.maven:maven-core) mvn(org.apache.maven:maven-plugin-api)"
