...
RPROVIDES:${PN} += "tex(go.sty) tex(go10.tfm) tex(go15.tfm) tex(go1bla10.tfm) tex(go1bla15.tfm) tex(go1bla20.tfm) tex(go1whi10.tfm) tex(go1whi15.tfm) tex(go1whi20.tfm) tex(go20.tfm) tex(go2bla10.tfm) tex(go2bla15.tfm) tex(go2bla20.tfm) tex(go2whi10.tfm) tex(go2whi15.tfm) tex(go2whi20.tfm) tex(gosign50.tfm) texlive-go"
