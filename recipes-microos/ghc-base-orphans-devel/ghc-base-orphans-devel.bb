...
RPROVIDES:${PN} += "ghc-base-orphans-devel ghc-base-orphans-devel(aarch-64) ghc-devel(base-orphans-0.8.8.2-Hl8yFKsRlc4HPNXP65SlX8)"
RDEPENDS:${PN} += "/bin/sh ghc-base-orphans ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(ghc-prim-0.9.0)"
