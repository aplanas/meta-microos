...
RPROVIDES:${PN} += "tex(eocc10.tfm) tex(eorm10.tfm) tex(eorm5.tfm) tex(eorm6.tfm) tex(eorm7.tfm) tex(eorm8.tfm) tex(eorm9.tfm) tex(eosl10.tfm) tex(eosl5.tfm) tex(eosl6.tfm) tex(eosl7.tfm) tex(eosl8.tfm) tex(eosl9.tfm) tex(eoti10.tfm) tex(tcssdc10.tfm) tex(torm10.tfm) tex(torm5.tfm) tex(torm6.tfm) tex(torm7.tfm) tex(torm8.tfm) tex(torm9.tfm) tex(tosl10.tfm) tex(tosl5.tfm) tex(tosl6.tfm) tex(tosl7.tfm) tex(tosl8.tfm) tex(tosl9.tfm) tex(toti10.tfm) texlive-ecc"
