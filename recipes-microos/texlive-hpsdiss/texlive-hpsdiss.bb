...
RPROVIDES:${PN} += "tex(hpsdiss.cls) texlive-hpsdiss"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(book.cls) tex(calc.sty) tex(colordvi.sty) tex(geometry.sty) tex(graphicx.sty) tex(mparhack.sty) tex(ragged2e.sty) tex(rotating.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
