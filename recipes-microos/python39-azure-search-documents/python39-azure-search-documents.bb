...
RPROVIDES:${PN} += "python3.9dist(azure-search-documents) python39-azure-search-documents python3dist(azure-search-documents)"
RDEPENDS:${PN} += "python(abi) python39-azure-common python39-azure-core python39-azure-nspkg python39-azure-search-nspkg python39-msrest python39-typing_extensions"
