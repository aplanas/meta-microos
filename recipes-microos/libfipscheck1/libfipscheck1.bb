...
RPROVIDES:${PN} += "libfipscheck.so.1()(64bit) libfipscheck1 libfipscheck1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig /usr/bin/fipscheck ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit)"
