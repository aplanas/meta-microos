...
RPROVIDES:${PN} += "tex(ascelike.cls) texlive-ascelike"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(endfloat.sty) tex(ifthen.sty) tex(lineno.sty) tex(setspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
