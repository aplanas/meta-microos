...
RPROVIDES:${PN} += "config(radvd) group(radvd) radvd radvd(aarch-64) user(radvd)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/touch fillup group(daemon) ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) sysuser-shadow"
