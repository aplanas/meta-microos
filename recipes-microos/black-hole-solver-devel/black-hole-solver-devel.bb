...
RPROVIDES:${PN} += "black-hole-solver-devel black-hole-solver-devel(aarch-64) pkgconfig(libblack-hole-solver)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libblack_hole_solver1"
