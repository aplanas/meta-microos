...
RPROVIDES:${PN} += "gudev-sharp-devel gudev-sharp-devel(aarch-64) pkgconfig(gudev-sharp-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gudev-sharp pkgconfig(glib-sharp-2.0)"
