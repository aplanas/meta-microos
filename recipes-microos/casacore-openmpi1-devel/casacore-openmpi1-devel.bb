...
RPROVIDES:${PN} += "casacore-openmpi1-devel casacore-openmpi1-devel(aarch-64)"
RDEPENDS:${PN} += "gsl-devel hdf5-devel lapack-devel libboost_python3-devel libcasacore7-openmpi1 pkgconfig(cfitsio) pkgconfig(fftw3) pkgconfig(ncurses) pkgconfig(wcslib) readline-devel"
