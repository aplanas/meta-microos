...
RPROVIDES:${PN} += "application() application(usbauth.desktop) yast2-usbauth"
RDEPENDS:${PN} += "libusbauth-configparser1 rubygem(ffi) xdg-utils yast2 yast2-ruby-bindings"
