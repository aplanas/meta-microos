...
RPROVIDES:${PN} += "mvn(io.prometheus:simpleclient_httpserver) mvn(io.prometheus:simpleclient_httpserver:pom:) osgi(io.prometheus.simpleclient_httpserver) prometheus-simpleclient-java-httpserver"
