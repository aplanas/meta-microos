...
RPROVIDES:${PN} += "ruby3.2-rubygem-liquid-4 ruby3.2-rubygem-liquid-4(aarch-64) rubygem(liquid) rubygem(ruby:3.2.0:liquid) rubygem(ruby:3.2.0:liquid:4) rubygem(ruby:3.2.0:liquid:4.0) rubygem(ruby:3.2.0:liquid:4.0.3)"
