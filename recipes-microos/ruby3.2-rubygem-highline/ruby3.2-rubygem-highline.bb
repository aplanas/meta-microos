...
RPROVIDES:${PN} += "ruby3.2-rubygem-highline ruby3.2-rubygem-highline(aarch-64) rubygem(highline) rubygem(ruby:3.2.0:highline) rubygem(ruby:3.2.0:highline:2) rubygem(ruby:3.2.0:highline:2.0) rubygem(ruby:3.2.0:highline:2.0.3)"
