...
RPROVIDES:${PN} += "bootsplash-branding bootsplash-branding-upstream config(bootsplash-branding-upstream)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/mkdir /usr/bin/touch bootsplash fillup perl"
