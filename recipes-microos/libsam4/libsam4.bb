...
RPROVIDES:${PN} += "libsam.so.4()(64bit) libsam.so.4(COROSYNC_SAM_1.0)(64bit) libsam4 libsam4(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcmap.so.4()(64bit) libcmap.so.4(COROSYNC_CMAP_1.0)(64bit) libquorum.so.5()(64bit) libquorum.so.5(COROSYNC_QUORUM_1.0)(64bit)"
