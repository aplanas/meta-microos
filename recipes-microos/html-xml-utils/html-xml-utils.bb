...
RPROVIDES:${PN} += "html-xml-utils html-xml-utils(aarch-64)"
RDEPENDS:${PN} += "/bin/bash ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcurl.so.4()(64bit) libidn2.so.0()(64bit) libidn2.so.0(IDN2_0.0.0)(64bit)"
