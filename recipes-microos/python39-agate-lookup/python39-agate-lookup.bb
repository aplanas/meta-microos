...
RPROVIDES:${PN} += "python3.9dist(agate-lookup) python39-agate-lookup python3dist(agate-lookup)"
RDEPENDS:${PN} += "python(abi) python39-PyYAML python39-agate python39-requests"
