...
RPROVIDES:${PN} += "texdev(glyphtounicode-cmex.tex) texdev(latex-lab-kernel-changes.sty) texdev(latex-lab-testphase-block-tagging.sty) texdev(latex-lab-testphase-math.sty) texdev(latex-lab-testphase-new-or-1.sty) texdev(latex-lab-testphase-new-or-2.sty) texdev(latex-lab-testphase-sec-tagging.sty) texdev(latex-lab-testphase-toc-tagging.sty) texlive-latex-lab-dev"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(xtemplate.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
