...
RPROVIDES:${PN} += "ghc-network-multicast-prof ghc-network-multicast-prof(aarch-64) ghc-prof(network-multicast-0.3.2-GrPQCwnsCBBDUXDpEy9gVm)"
RDEPENDS:${PN} += "ghc-network-multicast-devel ghc-prof(base-4.17.1.0) ghc-prof(network-3.1.2.8-HNDBp0HF6t0D1fzE2MDtPd) ghc-prof(network-bsd-2.8.1.0-D1RjTzX7Byx4U4fOdbAEll)"
