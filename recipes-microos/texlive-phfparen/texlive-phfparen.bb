...
RPROVIDES:${PN} += "tex(phfparen.sty) texlive-phfparen"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(etoolbox.sty) tex(kvoptions.sty) tex(mathtools.sty) tex(xparse.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
