...
RPROVIDES:${PN} += "python3.11dist(terminaltables) python311-terminaltables python3dist(terminaltables)"
RDEPENDS:${PN} += "python(abi) python311-colorama python311-colorclass python311-termcolor"
