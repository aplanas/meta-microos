...
RPROVIDES:${PN} += "python3-PyQt6-DataVisualization python3-qtdatavisualization-qt6 python3.10dist(pyqt6-datavisualization) python310-PyQt6-DataVisualization python310-PyQt6-DataVisualization(aarch-64) python310-qtdatavisualization-qt6 python3dist(pyqt6-datavisualization)"
