...
RPROVIDES:${PN} += "fcitx-pinyin fcitx-pinyin(aarch-64)"
RDEPENDS:${PN} += "fcitx ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit)"
