...
RPROVIDES:${PN} += "python3.9dist(ndg-httpsclient) python39-ndg-httpsclient python3dist(ndg-httpsclient)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-pyOpenSSL python39-pyasn1 update-alternatives"
