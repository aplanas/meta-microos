...
RPROVIDES:${PN} += "ruby3.2-rubygem-pairing_heap ruby3.2-rubygem-pairing_heap(aarch-64) rubygem(pairing_heap) rubygem(ruby:3.2.0:pairing_heap) rubygem(ruby:3.2.0:pairing_heap:1) rubygem(ruby:3.2.0:pairing_heap:1.0) rubygem(ruby:3.2.0:pairing_heap:1.0.0)"
