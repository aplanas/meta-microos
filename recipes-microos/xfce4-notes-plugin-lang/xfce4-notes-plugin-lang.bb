...
locale(xfce4-notes-plugin:en_AU) \
locale(xfce4-notes-plugin:en_CA) \
locale(xfce4-notes-plugin:en_GB) \
...
locale(xfce4-notes-plugin:pt_BR) \
...
locale(xfce4-notes-plugin:zh_CN) \
locale(xfce4-notes-plugin:zh_TW) \
