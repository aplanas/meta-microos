...
RPROVIDES:${PN} += "tex(muthesis.cls) tex(third-rep.cls) texlive-muthesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(report.cls) tex(setspace.sty) tex(verbatim.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
