...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-gnome-gnome_games patterns-gnome-gnome_games(aarch-64) patterns-openSUSE-gnome_games"
RDEPENDS:${PN} += ""
