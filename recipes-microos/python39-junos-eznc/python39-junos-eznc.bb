...
RPROVIDES:${PN} += "python3.9dist(junos-eznc) python39-junos-eznc python3dist(junos-eznc)"
RDEPENDS:${PN} += "python(abi) python39-Jinja2 python39-PyYAML python39-lxml python39-ncclient python39-netaddr python39-ntc-templates python39-paramiko python39-pyparsing python39-pyserial python39-scp python39-six python39-transitions"
