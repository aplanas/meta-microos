...
RPROVIDES:${PN} += "perl(XML::SemanticDiff) perl(XML::SemanticDiff::BasicHandler) perl(XML::SemanticDiff::PathFinder) perl(XML::SemanticDiff::PathFinder::Obj) perl-XML-SemanticDiff"
