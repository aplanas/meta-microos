...
RPROVIDES:${PN} += "pkgconfig(SignOnExtension) pkgconfig(signond) signond-libs-devel signond-libs-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig(Qt5Core) signond signond-libs"
