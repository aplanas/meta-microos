...
RPROVIDES:${PN} += "python3.9dist(lektor) python39-Lektor python3dist(lektor)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Babel python39-ExifRead python39-Flask python39-Jinja2 python39-click python39-filetype python39-inifile python39-mistune python39-python-slugify python39-requests python39-setuptools python39-watchdog update-alternatives"
