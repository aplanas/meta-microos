...
RPROVIDES:${PN} += "vagrant-libvirt vagrant-libvirt(aarch-64)"
RDEPENDS:${PN} += "/bin/sh libvirt qemu-arm rubygem(ruby:3.2.0:diffy) rubygem(ruby:3.2.0:fog-core:2) rubygem(ruby:3.2.0:fog-libvirt) rubygem(ruby:3.2.0:nokogiri:1) rubygem(ruby:3.2.0:rexml) rubygem(ruby:3.2.0:xml-simple) vagrant"
