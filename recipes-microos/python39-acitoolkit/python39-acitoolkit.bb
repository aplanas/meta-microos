...
RPROVIDES:${PN} += "python3.9dist(acitoolkit) python39-acitoolkit python3dist(acitoolkit)"
RDEPENDS:${PN} += "python(abi) python39-graphviz python39-jsonschema python39-requests python39-tabulate python39-websocket-client"
