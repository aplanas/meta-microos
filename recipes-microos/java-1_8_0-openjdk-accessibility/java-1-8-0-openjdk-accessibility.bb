...
RPROVIDES:${PN} += "config(java-1_8_0-openjdk-accessibility) java-1_8_0-openjdk-accessibility java-1_8_0-openjdk-accessibility(aarch-64)"
RDEPENDS:${PN} += "/bin/sh java-1_8_0-openjdk java-atk-wrapper"
