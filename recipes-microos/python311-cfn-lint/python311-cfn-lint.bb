...
RPROVIDES:${PN} += "cfn-lint python3.11dist(cfn-lint) python311-cfn-lint python3dist(cfn-lint)"
RDEPENDS:${PN} += "(python311-jsonschema > 3.0 with python311-jsonschema < 5) /bin/sh /usr/bin/python3.11 git-core python(abi) python311-PyYAML python311-aws-sam-translator python311-jschema-to-python python311-jsonpatch python311-junit-xml python311-networkx python311-sarif-om update-alternatives"
