...
RPROVIDES:${PN} += "tex(english-software.lbx) tex(french-software.lbx) tex(software-biblatex.sty) tex(software.bbx) texlive-biblatex-software"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(english.lbx) tex(french.lbx) tex(xurl.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
