...
RPROVIDES:${PN} += "python3.11dist(dkimpy) python311-dkimpy python3dist(dkimpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyNaCl python311-authres python311-dnspython python311-setuptools update-alternatives"
