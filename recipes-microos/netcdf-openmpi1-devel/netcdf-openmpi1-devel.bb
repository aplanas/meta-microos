...
RPROVIDES:${PN} += "netcdf-openmpi1-devel netcdf-openmpi1-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh hdf5-openmpi1-devel libcurl-devel libnetcdf19-openmpi1 netcdf-devel-data openmpi1-devel pkgconfig zlib-devel"
