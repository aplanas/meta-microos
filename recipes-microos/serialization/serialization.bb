...
RPROVIDES:${PN} += "mvn(org.scala-sbt:serialization_2.10) mvn(org.scala-sbt:serialization_2.10:pom:) serialization"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.json4s:json4s-ast_2.10) mvn(org.scala-lang.modules:scala-pickling_2.10) mvn(org.scala-lang:scala-library) mvn(org.typelevel:jawn-json4s_2.10) mvn(org.typelevel:jawn-parser_2.10)"
