...
RPROVIDES:${PN} += "python3-altair python3.10dist(altair) python310-altair python3dist(altair)"
RDEPENDS:${PN} += "python(abi) python310-Jinja2 python310-entrypoints python310-jsonschema python310-numpy python310-pandas python310-toolz python310-typing"
