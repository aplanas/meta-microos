...
RPROVIDES:${PN} += "openamp-examples openamp-examples(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libmetal.so.0()(64bit) libopen_amp.so.0()(64bit) libopen_amp0"
