...
RPROVIDES:${PN} += "tex(beamercolorthemeSimpleDarkBlue.sty) tex(beamerfontthemeSimpleDarkBlue.sty) tex(beamerthemeSimpleDarkBlue.sty) texlive-beamertheme-simpledarkblue"
