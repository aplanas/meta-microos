...
RPROVIDES:${PN} += "tex(at.sty) tex(cmtt.sty) tex(doafter.sty) tex(footnote.sty) tex(mTTcmtt.fd) tex(mTTenc.def) tex(mathenv.sty) tex(mdwlist.sty) tex(mdwmath.sty) tex(mdwtab.sty) tex(sverb.sty) tex(syntax.sty) texlive-mdwtools"
