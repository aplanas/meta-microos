...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-containers-kubernetes-utilities patterns-kubernetes-kubernetes_utilities patterns-kubernetes-kubernetes_utilities(aarch-64)"
RDEPENDS:${PN} += "helm k9s kail kubectl-who-can pattern() rakkess rbac-lookup reg"
