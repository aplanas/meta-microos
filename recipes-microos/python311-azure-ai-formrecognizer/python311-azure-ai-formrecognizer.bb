...
RPROVIDES:${PN} += "python3.11dist(azure-ai-formrecognizer) python311-azure-ai-formrecognizer python3dist(azure-ai-formrecognizer)"
RDEPENDS:${PN} += "python(abi) python311-azure-ai-nspkg python311-azure-common python311-azure-core python311-msrest python311-typing_extensions"
