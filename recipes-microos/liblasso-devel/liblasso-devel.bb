...
RPROVIDES:${PN} += "liblasso-devel liblasso-devel(aarch-64) pkgconfig(lasso)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblasso3(aarch-64) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libxml-2.0) pkgconfig(libxslt) pkgconfig(xmlsec1)"
