...
RPROVIDES:${PN} += "metacity-devel metacity-devel(aarch-64) pkgconfig(libmetacity)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmetacity3 pkgconfig(glib-2.0) pkgconfig(gtk+-3.0)"
