...
RPROVIDES:${PN} += "config(lalmetaio-devel) lalmetaio-devel lalmetaio-devel(aarch-64) pkgconfig(lalmetaio)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) liblal.so.20()(64bit) liblalmetaio.so.10()(64bit) liblalmetaio10 pkgconfig(lal) pkgconfig(libmetaio)"
