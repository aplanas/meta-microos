...
RPROVIDES:${PN} += "python3.9dist(guessit) python39-guessit python3dist(guessit)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-babelfish python39-importlib-resources python39-python-dateutil python39-rebulk update-alternatives"
