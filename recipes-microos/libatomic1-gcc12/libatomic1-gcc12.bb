...
RPROVIDES:${PN} += "libatomic.so.1()(64bit) libatomic.so.1(LIBATOMIC_1.0)(64bit) libatomic.so.1(LIBATOMIC_1.1)(64bit) libatomic.so.1(LIBATOMIC_1.2)(64bit) libatomic1 libatomic1-gcc12 libatomic1-gcc12(aarch-64)"
