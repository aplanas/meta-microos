...
RPROVIDES:${PN} += "kmod(v4l2loopback.ko) multiversion(kernel) v4l2loopback-kmp v4l2loopback-kmp-default v4l2loopback-kmp-default(aarch-64) v4l2loopback-kmp-default-k6.3.4_1"
