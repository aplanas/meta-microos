...
RPROVIDES:${PN} += "python3.11dist(google-cloud-storage) python311-google-cloud-storage python3dist(google-cloud-storage)"
RDEPENDS:${PN} += "python(abi) python311-google-api-core python311-google-auth python311-google-cloud-core python311-google-resumable-media python311-googleapis-common-protos python311-requests"
