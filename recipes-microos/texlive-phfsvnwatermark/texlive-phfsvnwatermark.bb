...
RPROVIDES:${PN} += "tex(phfsvnwatermark.sty) texlive-phfsvnwatermark"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(currfile.sty) tex(eso-pic.sty) tex(kvoptions.sty) tex(svn-multi.sty) tex(svn.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
