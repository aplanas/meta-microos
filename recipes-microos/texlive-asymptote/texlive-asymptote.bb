...
RPROVIDES:${PN} += "tex(asycolors.sty) tex(asymptote.sty) tex(colo-asy.tex) tex(ocg.sty) texlive-asymptote"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 coreutils ed findutils grep python3-tk sed tex(catchfile.sty) tex(color.sty) tex(graphicx.sty) tex(ifpdf.sty) tex(ifthen.sty) tex(ifxetex.sty) tex(keyval.sty) texlive texlive-asymptote-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-media9 texlive-movie15 texlive-scripts texlive-scripts-bin"
