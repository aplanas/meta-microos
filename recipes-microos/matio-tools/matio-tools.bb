...
RPROVIDES:${PN} += "matio-tools matio-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libhdf5 libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libmatio.so.11()(64bit) libmatio11"
