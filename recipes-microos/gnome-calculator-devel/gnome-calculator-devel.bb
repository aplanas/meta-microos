...
RPROVIDES:${PN} += "gnome-calculator-devel gnome-calculator-devel(aarch-64) pkgconfig(gcalc-2) pkgconfig(gci-1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gnome-calculator libgcalc-2-1_0_1 libgci-1-0_0_0 pkgconfig(gcalc-2) pkgconfig(gee-0.8) pkgconfig(gio-2.0) pkgconfig(gtk4)"
