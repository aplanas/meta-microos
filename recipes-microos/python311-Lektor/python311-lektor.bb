...
RPROVIDES:${PN} += "python3.11dist(lektor) python311-Lektor python3dist(lektor)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Babel python311-ExifRead python311-Flask python311-Jinja2 python311-click python311-filetype python311-inifile python311-mistune python311-python-slugify python311-requests python311-setuptools python311-watchdog update-alternatives"
