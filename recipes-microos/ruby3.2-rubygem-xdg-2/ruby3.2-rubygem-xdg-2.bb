...
RPROVIDES:${PN} += "ruby3.2-rubygem-xdg-2 ruby3.2-rubygem-xdg-2(aarch-64) rubygem(ruby:3.2.0:xdg) rubygem(ruby:3.2.0:xdg:2) rubygem(ruby:3.2.0:xdg:2.2) rubygem(ruby:3.2.0:xdg:2.2.5) rubygem(xdg)"
