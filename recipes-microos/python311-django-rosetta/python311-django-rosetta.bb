...
RPROVIDES:${PN} += "python3.11dist(django-rosetta) python311-django-rosetta python3dist(django-rosetta)"
RDEPENDS:${PN} += "python(abi) python311-Django python311-polib python311-requests"
