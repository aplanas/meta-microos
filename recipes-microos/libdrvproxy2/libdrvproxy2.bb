...
RPROVIDES:${PN} += "libdrvproxy.so.2()(64bit) libdrvproxy2 libdrvproxy2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit) libiodbcadm.so.2()(64bit) libiodbcinst.so.2()(64bit)"
