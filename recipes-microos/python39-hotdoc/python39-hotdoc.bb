...
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 /usr/bin/sh clang-devel ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) libjson-glib-1.0.so.0()(64bit) libjson-glib-1.0.so.0(libjson-glib-1.0.so.0)(64bit) libxml2.so.2()(64bit) libxml2.so.2(LIBXML2_2.4.30)(64bit) libxml2.so.2(LIBXML2_2.6.0)(64bit) libxml2.so.2(LIBXML2_2.7.3)(64bit) llvm-devel python(abi) python39-PyYAML python39-appdirs python39-cchardet python39-dbus-deviation python39-feedgen python39-lxml python39-networkx python39-pkgconfig python39-schema python39-toposort python39-wheezy.template update-alternatives"
