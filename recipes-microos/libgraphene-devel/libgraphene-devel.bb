...
RPROVIDES:${PN} += "libgraphene-devel libgraphene-devel(aarch-64) pkgconfig(graphene-1.0) pkgconfig(graphene-gobject-1.0)"
RDEPENDS:${PN} += "/usr/bin/env /usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgraphene-1.0.so.0()(64bit) libgraphene-1_0-0 pkgconfig(gobject-2.0) pkgconfig(graphene-1.0) typelib(Graphene) typelib-1_0-Graphene-1_0"
