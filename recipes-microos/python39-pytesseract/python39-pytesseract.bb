...
RPROVIDES:${PN} += "python3.9dist(pytesseract) python39-pytesseract python3dist(pytesseract)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 pkgconfig(tesseract) python(abi) python39-Pillow python39-setuptools tesseract-ocr-traineddata-deu tesseract-ocr-traineddata-eng update-alternatives"
