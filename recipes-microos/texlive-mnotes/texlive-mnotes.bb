...
RPROVIDES:${PN} += "tex(mnotes.sty) texlive-mnotes"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(ifoddpage.sty) tex(kvoptions.sty) tex(marginnote.sty) tex(sidenotes.sty) tex(soul.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
