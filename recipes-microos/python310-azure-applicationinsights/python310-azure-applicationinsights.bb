...
RPROVIDES:${PN} += "python3-azure-applicationinsights python3.10dist(azure-applicationinsights) python310-azure-applicationinsights python3dist(azure-applicationinsights)"
