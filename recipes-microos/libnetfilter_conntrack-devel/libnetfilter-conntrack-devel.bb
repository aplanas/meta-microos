...
RPROVIDES:${PN} += "libnetfilter_conntrack-devel libnetfilter_conntrack-devel(aarch-64) pkgconfig(libnetfilter_conntrack)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnetfilter_conntrack3 pkgconfig(libnfnetlink)"
