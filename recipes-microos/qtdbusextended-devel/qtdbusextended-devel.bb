...
RPROVIDES:${PN} += "pkgconfig(dbusextended-qt5) qtdbusextended-devel qtdbusextended-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdbusextended-qt5-1 pkgconfig(Qt5Core) pkgconfig(Qt5DBus)"
