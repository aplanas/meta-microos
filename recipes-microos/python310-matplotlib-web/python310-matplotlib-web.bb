...
RPROVIDES:${PN} += "python3-matplotlib-web python310-matplotlib-web python310-matplotlib-web(aarch-64)"
RDEPENDS:${PN} += "python(abi) python310-matplotlib python310-tornado"
