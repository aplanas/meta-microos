...
RPROVIDES:${PN} += "python3.11dist(zodb) python311-ZODB python3dist(zodb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-BTrees python311-ZConfig python311-persistent python311-six python311-transaction python311-zc.lockfile python311-zodbpickle python311-zope.interface update-alternatives"
