...
RPROVIDES:${PN} += "perl(Cache::BaseCache) perl(Cache::BaseCacheTester) perl(Cache::Cache) perl(Cache::CacheMetaData) perl(Cache::CacheSizer) perl(Cache::CacheTester) perl(Cache::CacheUtils) perl(Cache::FileBackend) perl(Cache::FileCache) perl(Cache::MemoryBackend) perl(Cache::MemoryCache) perl(Cache::NullCache) perl(Cache::Object) perl(Cache::SharedMemoryBackend) perl(Cache::SharedMemoryCache) perl(Cache::SizeAwareCache) perl(Cache::SizeAwareCacheTester) perl(Cache::SizeAwareFileCache) perl(Cache::SizeAwareMemoryCache) perl(Cache::SizeAwareSharedMemoryCache) perl-Cache-Cache"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Digest::SHA1) perl(Error) perl(IPC::ShareLite)"
