...
RPROVIDES:${PN} += "config(orthos2) orthos2 orthos2-1.2.169+git.a693485-1.1 python3.10dist(orthos2) python3dist(orthos2)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /sbin/service /usr/bin/perl ansible logrotate nginx python(abi) python3-Django python3-django-auth-ldap python3-django-extensions python3-djangorestframework python3-ldap python3-netaddr python3-paramiko python3-psycopg2 python3-validators sudo uwsgi uwsgi-python3"
