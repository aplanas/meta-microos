...
RPROVIDES:${PN} += "ghc-devel(safe-exceptions-0.1.7.3-4ydW60ruqZ4IdMpKf3b6BD) ghc-safe-exceptions-devel ghc-safe-exceptions-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(exceptions-0.10.5) ghc-devel(transformers-0.5.6.2) ghc-safe-exceptions"
