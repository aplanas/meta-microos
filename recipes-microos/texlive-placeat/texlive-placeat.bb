...
RPROVIDES:${PN} += "tex(placeat.sty) texlive-placeat"
RDEPENDS:${PN} += "/bin/sh /usr/bin/luatex coreutils ed findutils grep sed tex(atbegshi.sty) tex(luacode.sty) tex(luatexbase.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
