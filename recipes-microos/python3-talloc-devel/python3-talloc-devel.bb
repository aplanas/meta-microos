...
RPROVIDES:${PN} += "pkgconfig(pytalloc-util.cpython-310-aarch64-linux-gnu) python3-talloc-devel python3-talloc-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkg-config python3-talloc"
