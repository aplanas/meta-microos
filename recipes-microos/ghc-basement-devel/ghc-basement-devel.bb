...
RPROVIDES:${PN} += "ghc-basement-devel ghc-basement-devel(aarch-64) ghc-devel(basement-0.0.15-6OmKTVi2kFpCWMoKDlsO4S)"
RDEPENDS:${PN} += "/bin/sh ghc-basement ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(ghc-prim-0.9.0)"
