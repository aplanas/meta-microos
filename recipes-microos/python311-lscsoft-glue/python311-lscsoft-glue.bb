...
RPROVIDES:${PN} += "python-glue python3.11dist(lscsoft-glue) python311-glue python311-lscsoft-glue python311-lscsoft-glue(aarch-64) python3dist(lscsoft-glue)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) lscsoft-glue-data python(abi) python311-ligo-segments python311-numpy python311-pyRXP update-alternatives"
