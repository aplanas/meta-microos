...
RPROVIDES:${PN} += "tex(hvlogos.sty) texlive-hvlogos"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(dantelogo.sty) tex(expl3.sty) tex(fetamont.sty) tex(hologo.sty) tex(unicode-math.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
