...
RPROVIDES:${PN} += "python3.11dist(agate) python311-agate python3dist(agate)"
RDEPENDS:${PN} += "python(abi) python311-Babel python311-isodate python311-leather python311-parsedatetime python311-python-slugify python311-pytimeparse"
