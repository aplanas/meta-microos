...
RPROVIDES:${PN} += "bluez-obexd bluez-obexd(aarch-64)"
RDEPENDS:${PN} += "/bin/sh bluez ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdbus-1.so.3()(64bit) libdbus-1.so.3(LIBDBUS_1_3)(64bit) libglib-2.0.so.0()(64bit) libicalvcal.so.3()(64bit)"
