...
RPROVIDES:${PN} += "tex(hep-text.sty) texlive-hep-text"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(babel.sty) tex(csquotes.sty) tex(enumitem.sty) tex(foreign.sty) tex(kvoptions.sty) tex(pdftexcmds.sty) tex(relsize.sty) tex(soulutf8.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
