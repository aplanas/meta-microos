...
RPROVIDES:${PN} += "libparlatype-devel libparlatype-devel(aarch-64) pkgconfig(parlatype)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libparlatype5 pkgconfig(gstreamer-1.0) pkgconfig(gtk+-3.0)"
