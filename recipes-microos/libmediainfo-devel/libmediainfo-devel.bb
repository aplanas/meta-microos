...
RPROVIDES:${PN} += "libmediainfo-devel libmediainfo-devel(aarch-64) pkgconfig(libmediainfo)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmediainfo0 pkgconfig(libcurl) pkgconfig(libzen)"
