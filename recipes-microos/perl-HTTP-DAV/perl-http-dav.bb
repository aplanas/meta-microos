...
RPROVIDES:${PN} += "perl(HTTP::DAV) perl(HTTP::DAV::Comms) perl(HTTP::DAV::Headers) perl(HTTP::DAV::Lock) perl(HTTP::DAV::Resource) perl(HTTP::DAV::ResourceList) perl(HTTP::DAV::Response) perl(HTTP::DAV::UserAgent) perl(HTTP::DAV::Utils) perl-HTTP-DAV"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(LWP) perl(URI) perl(URI::Escape) perl(XML::DOM)"
