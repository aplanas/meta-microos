...
RPROVIDES:${PN} += "tex(kvoptions-patch.sty) tex(kvoptions.sty) texlive-kvoptions"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etexcmds.sty) tex(keyval.sty) tex(kvsetkeys.sty) tex(ltxcmds.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
