...
RPROVIDES:${PN} += "python3.9dist(language-check) python39-language-check python3dist(language-check)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/perl /usr/bin/python3 /usr/bin/python3.9 java python(abi) update-alternatives"
