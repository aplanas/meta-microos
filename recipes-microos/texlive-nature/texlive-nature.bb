...
RPROVIDES:${PN} += "tex(nature.cls) texlive-nature"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(cite.sty) tex(fullpage.sty) tex(ifthen.sty) tex(times.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
