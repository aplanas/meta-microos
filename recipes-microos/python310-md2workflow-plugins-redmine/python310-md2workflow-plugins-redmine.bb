...
RPROVIDES:${PN} += "python3-md2workflow-plugins-redmine python310-md2workflow-plugins-redmine"
RDEPENDS:${PN} += "python(abi) python310-md2workflow python310-python-redmine"
