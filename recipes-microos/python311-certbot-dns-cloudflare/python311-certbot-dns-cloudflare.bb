...
RPROVIDES:${PN} += "python3.11dist(certbot-dns-cloudflare) python311-certbot-dns-cloudflare python3dist(certbot-dns-cloudflare)"
RDEPENDS:${PN} += "python(abi) python311-acme python311-certbot python311-cloudflare python311-zope.interface"
