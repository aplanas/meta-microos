...
RPROVIDES:${PN} += "python3-moto-all python310-moto-all"
RDEPENDS:${PN} += "python310-PyYAML python310-aws-xray-sdk python310-cfn-lint python310-docker python310-graphql-core python310-idna python310-jsondiff python310-moto python310-openapi-spec-validator python310-pyparsing python310-python-jose python310-setuptools python310-sshpubkeys"
