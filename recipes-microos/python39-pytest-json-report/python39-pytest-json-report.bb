...
RPROVIDES:${PN} += "python3.9dist(pytest-json-report) python39-pytest-json-report python3dist(pytest-json-report)"
RDEPENDS:${PN} += "python(abi) python39-py python39-pytest python39-pytest-metadata"
