...
RPROVIDES:${PN} += "lib3ds-devel lib3ds-devel(aarch-64) pkgconfig(lib3ds)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config glibc-devel lib3ds-1-3 lib3ds-1.so.3()(64bit) libc.so.6(GLIBC_2.34)(64bit)"
