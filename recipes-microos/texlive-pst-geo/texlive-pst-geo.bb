...
RPROVIDES:${PN} += "tex(Staedte3dJG.tex) tex(africa-bdy_II.dat) tex(africa-cil_II.dat) tex(africa-riv_II.dat) tex(asia-bdy_II.dat) tex(asia-cil_II.dat) tex(asia-isl_II.dat) tex(asia-riv_II.dat) tex(aus.dat) tex(c-cap.dat) tex(c-sub.dat) tex(canada.dat) tex(capitals.dat) tex(capitals.tex) tex(capitals3d.tex) tex(cities.tex) tex(citycapitals.dat) tex(citysub.dat) tex(corse.dat) tex(europe-bdy_II.dat) tex(europe-cil_II.dat) tex(europe-riv_II.dat) tex(france.dat) tex(germany.dat) tex(mexico.dat) tex(northamerica-bdy_II.dat) tex(northamerica-cil_II.dat) tex(northamerica-pby_II.dat) tex(northamerica-riv_II.dat) tex(pborder.dat) tex(pcoast.dat) tex(pisland.dat) tex(plake.dat) tex(pst-geo.sty) tex(pst-geo.tex) tex(rhone.dat) tex(ridge.dat) tex(river.dat) tex(seine.dat) tex(southamerica-arc_II.dat) tex(southamerica-bdy_II.dat) tex(southamerica-cil_II.dat) tex(southamerica-riv_II.dat) tex(transfrm.dat) tex(trench.dat) tex(usa.dat) tex(villesFrance.tex) tex(villesFrance3d.tex) tex(villesItalia.tex) tex(villesItalia3d.tex) tex(wfraczon.dat) tex(wmaglin.dat) texlive-pst-geo"
