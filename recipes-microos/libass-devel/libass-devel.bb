...
RPROVIDES:${PN} += "libass-devel libass-devel(aarch-64) pkgconfig(libass)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libass9 pkgconfig(fontconfig) pkgconfig(freetype2) pkgconfig(fribidi) pkgconfig(harfbuzz)"
