...
RPROVIDES:${PN} += "python3.9dist(bobo) python39-bobo python3dist(bobo)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-WebOb python39-six update-alternatives"
