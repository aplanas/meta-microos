...
RPROVIDES:${PN} += "python3-kasa python3.10dist(python-kasa) python310-kasa python3dist(python-kasa)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-anyio python310-asyncclick python310-pydantic python310-setuptools python310-voluptuous python310-xdoctest update-alternatives"
