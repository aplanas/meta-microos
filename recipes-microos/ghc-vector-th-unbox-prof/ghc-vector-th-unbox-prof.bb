...
RPROVIDES:${PN} += "ghc-prof(vector-th-unbox-0.2.2-8WH0ofCzoXcG1eDIxYKY6t) ghc-vector-th-unbox-prof ghc-vector-th-unbox-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(template-haskell-2.19.0.0) ghc-prof(vector-0.13.0.0-AbjrQrWxuFpAjIHk3G7xsp) ghc-vector-th-unbox-devel"
