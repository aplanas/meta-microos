...
RPROVIDES:${PN} += "ghc-devel(html-1.0.1.2-U7qWIp0bJwCnAFPlj3UZy) ghc-html-devel ghc-html-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-html"
