...
RPROVIDES:${PN} += "tex(shdoc.sty) texlive-shdoc"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(caption.sty) tex(float.sty) tex(ifthen.sty) tex(kvoptions.sty) tex(mdframed.sty) tex(relsize.sty) tex(stringstrings.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
