...
RPROVIDES:${PN} += "libportal-gtk4-devel libportal-gtk4-devel(aarch-64) pkgconfig(libportal-gtk4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libportal-gtk4-1 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(gtk4) pkgconfig(libportal) typelib-1_0-XdpGtk4-1_0"
