...
RPROVIDES:${PN} += "ruby3.2-rubygem-inifile ruby3.2-rubygem-inifile(aarch-64) rubygem(inifile) rubygem(ruby:3.2.0:inifile) rubygem(ruby:3.2.0:inifile:3) rubygem(ruby:3.2.0:inifile:3.0) rubygem(ruby:3.2.0:inifile:3.0.0)"
