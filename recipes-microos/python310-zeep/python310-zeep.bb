...
RPROVIDES:${PN} += "python3-zeep python3.10dist(zeep) python310-zeep python3dist(zeep)"
RDEPENDS:${PN} += "python(abi) python310-attrs python310-cached-property python310-isodate python310-lxml python310-platformdirs python310-pytz python310-requests python310-requests-file python310-requests-toolbelt"
