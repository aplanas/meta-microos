...
RPROVIDES:${PN} += "libsingular_resources-devel libsingular_resources-devel(aarch-64) pkgconfig(singular_resources)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libsingular_resources-4_3_1"
