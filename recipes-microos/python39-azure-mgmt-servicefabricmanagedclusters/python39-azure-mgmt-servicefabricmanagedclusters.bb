...
RPROVIDES:${PN} += "python3.9dist(azure-mgmt-servicefabricmanagedclusters) python39-azure-mgmt-servicefabricmanagedclusters python3dist(azure-mgmt-servicefabricmanagedclusters)"
