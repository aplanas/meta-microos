...
RPROVIDES:${PN} += "locale(wxhexeditor:ar) locale(wxhexeditor:cs) locale(wxhexeditor:de) locale(wxhexeditor:es) locale(wxhexeditor:fr) locale(wxhexeditor:it) locale(wxhexeditor:pl) locale(wxhexeditor:pt_BR) locale(wxhexeditor:ro) locale(wxhexeditor:ru) locale(wxhexeditor:tr) locale(wxhexeditor:zh_CN) wxhexeditor-lang wxhexeditor-lang-all"
