...
RPROVIDES:${PN} += "python3-python-coveralls python3.10dist(python-coveralls) python310-python-coveralls python3dist(python-coveralls)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-PyYAML python310-coverage python310-requests python310-six update-alternatives"
