...
RPROVIDES:${PN} += "python3.11dist(behave) python311-behave python3dist(behave)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-parse python311-parse_type python311-six update-alternatives"
