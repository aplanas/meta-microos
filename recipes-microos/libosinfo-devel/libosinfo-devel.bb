...
RPROVIDES:${PN} += "libosinfo-devel libosinfo-devel(aarch-64) pkgconfig(libosinfo-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libosinfo-1_0-0 pkgconfig(gobject-2.0) typelib-1_0-Libosinfo-1_0"
