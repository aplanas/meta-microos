...
RPROVIDES:${PN} += "application() application(phoronix-test-suite-launcher.desktop) application(phoronix-test-suite.desktop) config(phoronix-test-suite) metainfo() metainfo(phoronix-test-suite.appdata.xml) mimehandler(application/x-openbenchmarking) phoronix-test-suite"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/env php8 php8-curl php8-dom php8-gd php8-openssl php8-pcntl php8-posix php8-sockets php8-zip php8-zlib systemd xdg-utils"
