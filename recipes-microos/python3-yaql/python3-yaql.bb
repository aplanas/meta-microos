...
RPROVIDES:${PN} += "python3-yaql python3.10dist(yaql) python3dist(yaql)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Babel python3-ply python3-python-dateutil"
