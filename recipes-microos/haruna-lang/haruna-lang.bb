...
RPROVIDES:${PN} += "haruna-lang haruna-lang-all locale(haruna:ar) locale(haruna:ca) locale(haruna:ca@valencia) locale(haruna:cs) locale(haruna:de) locale(haruna:en_GB) locale(haruna:es) locale(haruna:eu) locale(haruna:fi) locale(haruna:fr) locale(haruna:hi) locale(haruna:id) locale(haruna:it) locale(haruna:ja) locale(haruna:ka) locale(haruna:ko) locale(haruna:lt) locale(haruna:nl) locale(haruna:pl) locale(haruna:pt) locale(haruna:pt_BR) locale(haruna:ru) locale(haruna:sk) locale(haruna:sl) locale(haruna:sv) locale(haruna:ta) locale(haruna:tr) locale(haruna:uk) locale(haruna:zh_CN) locale(haruna:zh_TW)"
RDEPENDS:${PN} += "haruna"
