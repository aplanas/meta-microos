...
RPROVIDES:${PN} += "python3-azure-mgmt-applicationinsights python3.10dist(azure-mgmt-applicationinsights) python310-azure-mgmt-applicationinsights python3dist(azure-mgmt-applicationinsights)"
