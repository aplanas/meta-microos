...
RPROVIDES:${PN} += "tex(musixguit.sty) texlive-musixguit"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(musixgui.tex) tex(musixper.tex) tex(musixtex.sty) tex(setspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
