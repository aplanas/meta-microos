...
RPROVIDES:${PN} += "tex(quran-de.sty) tex(qurantext-deii.translation.def) tex(qurantext-deiii.translation.def) tex(qurantext-deiv.translation.def) texlive-quran-de"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(quran.sty) tex(qurantext-de.translation.def) tex(xkeyval.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
