...
RPROVIDES:${PN} += "parpack-openmpi3-devel parpack-openmpi3-devel(aarch-64)"
RDEPENDS:${PN} += "blas-devel gcc-fortran lapack-devel libparpack2-openmpi3 openmpi3-devel"
