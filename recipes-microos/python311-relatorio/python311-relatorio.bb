...
RPROVIDES:${PN} += "python3.11dist(relatorio) python311-relatorio python3dist(relatorio)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Genshi python311-PyYAML python311-lxml python311-pycha python311-python-magic update-alternatives"
