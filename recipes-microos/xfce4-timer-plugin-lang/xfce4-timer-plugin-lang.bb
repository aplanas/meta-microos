...
locale(xfce4-timer-plugin:en_AU) \
locale(xfce4-timer-plugin:en_GB) \
...
locale(xfce4-timer-plugin:pt_BR) \
...
locale(xfce4-timer-plugin:zh_CN) \
locale(xfce4-timer-plugin:zh_TW) \
