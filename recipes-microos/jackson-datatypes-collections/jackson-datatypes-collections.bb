...
RPROVIDES:${PN} += "jackson-datatypes-collections mvn(com.fasterxml.jackson.datatype:jackson-datatypes-collections:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.fasterxml.jackson.core:jackson-core) mvn(com.fasterxml.jackson.core:jackson-databind) mvn(com.fasterxml.jackson:jackson-base:pom:)"
