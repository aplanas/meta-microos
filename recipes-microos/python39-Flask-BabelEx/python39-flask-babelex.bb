...
RPROVIDES:${PN} += "python3.9dist(flask-babelex) python39-Flask-BabelEx python3dist(flask-babelex)"
RDEPENDS:${PN} += "python(abi) python39-Babel python39-Flask python39-Jinja2 python39-speaklater"
