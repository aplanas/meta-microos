...
RPROVIDES:${PN} += "python3-flower python3.10dist(flower) python310-flower python3dist(flower)"
RDEPENDS:${PN} += "python(abi) python310-Babel python310-celery python310-certifi python310-humanize python310-prometheus_client python310-pytz python310-tornado update-alternatives"
