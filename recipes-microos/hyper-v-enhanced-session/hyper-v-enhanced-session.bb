...
RPROVIDES:${PN} += "config(hyper-v-enhanced-session) hyper-v-enhanced-session"
RDEPENDS:${PN} += "(kmod(hv_sock.ko) if kernel) (lightdm or gdm or kdm) /bin/sh hyper-v vncmanager xmessage xorg-x11-Xvnc-novnc xorgxrdp xrdp"
