...
RPROVIDES:${PN} += "lxappearance-devel lxappearance-devel(aarch-64) pkgconfig(lxappearance)"
RDEPENDS:${PN} += "/usr/bin/pkg-config lxappearance pkgconfig(gthread-2.0) pkgconfig(gtk+-2.0)"
