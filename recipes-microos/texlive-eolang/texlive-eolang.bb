...
RPROVIDES:${PN} += "tex(eolang.sty) texlive-eolang"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsfonts.sty) tex(amsmath.sty) tex(amssymb.sty) tex(fancyvrb.sty) tex(hyperref.sty) tex(iexec.sty) tex(ifluatex.sty) tex(ifxetex.sty) tex(pdftexcmds.sty) tex(pgfopts.sty) tex(stmaryrd.sty) tex(tikz.sty) tex(trimclip.sty) tex(xstring.sty) texlive texlive-amsfonts texlive-amsmath texlive-fancyvrb texlive-filesystem texlive-iexec texlive-kpathsea texlive-kpathsea-bin texlive-pgf texlive-pgfopts texlive-scripts texlive-scripts-bin texlive-stmaryrd"
