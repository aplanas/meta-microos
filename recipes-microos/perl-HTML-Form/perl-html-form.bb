...
RPROVIDES:${PN} += "perl(HTML::Form) perl(HTML::Form::FileInput) perl(HTML::Form::IgnoreInput) perl(HTML::Form::ImageInput) perl(HTML::Form::Input) perl(HTML::Form::KeygenInput) perl(HTML::Form::ListInput) perl(HTML::Form::SubmitInput) perl(HTML::Form::TextInput) perl-HTML-Form"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(HTML::TokeParser) perl(HTTP::Request) perl(HTTP::Request::Common) perl(Test::More) perl(URI) perl(parent)"
