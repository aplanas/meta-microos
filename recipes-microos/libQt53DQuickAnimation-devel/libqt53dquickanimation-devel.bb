...
RPROVIDES:${PN} += "cmake(Qt53DQuickAnimation) libQt53DQuickAnimation-devel libQt53DQuickAnimation-devel(aarch-64) pkgconfig(Qt53DQuickAnimation)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libQt53DQuickAnimation5 pkgconfig(Qt53DAnimation) pkgconfig(Qt53DCore) pkgconfig(Qt53DQuick) pkgconfig(Qt53DRender) pkgconfig(Qt5Core) pkgconfig(Qt5Gui) pkgconfig(Qt5Qml)"
