...
RPROVIDES:${PN} += "ghc-cryptohash-md5-prof ghc-cryptohash-md5-prof(aarch-64) ghc-prof(cryptohash-md5-0.11.101.0-1tswcJp9v68CZlxGZzmcPV)"
RDEPENDS:${PN} += "ghc-cryptohash-md5-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0)"
