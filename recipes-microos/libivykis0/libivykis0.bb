...
RPROVIDES:${PN} += "libivykis.so.0()(64bit) libivykis.so.0(IVYKIS_0.29)(64bit) libivykis.so.0(IVYKIS_0.30)(64bit) libivykis.so.0(IVYKIS_0.33)(64bit) libivykis.so.0(IVYKIS_0.40)(64bit) libivykis0 libivykis0(aarch-64)"
