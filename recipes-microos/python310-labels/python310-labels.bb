...
RPROVIDES:${PN} += "python3-labels python3.10dist(labels) python310-labels python3dist(labels)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-attrs python310-click python310-pytoml python310-requests update-alternatives"
