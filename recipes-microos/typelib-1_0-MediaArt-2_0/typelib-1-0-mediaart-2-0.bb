...
RPROVIDES:${PN} += "typelib(MediaArt) typelib-1_0-MediaArt-2_0 typelib-1_0-MediaArt-2_0(aarch-64)"
RDEPENDS:${PN} += "libmediaart-2.0.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
