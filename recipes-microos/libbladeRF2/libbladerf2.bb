...
RPROVIDES:${PN} += "libbladeRF.so.2()(64bit) libbladeRF2 libbladeRF2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig bladeRF-udev ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libusb-1.0.so.0()(64bit)"
