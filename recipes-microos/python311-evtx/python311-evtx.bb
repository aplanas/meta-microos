...
RPROVIDES:${PN} += "python3.11dist(python-evtx) python311-evtx python3dist(python-evtx)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 alts python(abi) python311-hexdump python311-lxml python311-six"
