...
RPROVIDES:${PN} += "libusbredirparser.so.1()(64bit) libusbredirparser.so.1(USBREDIRPARSER_0.10.0)(64bit) libusbredirparser.so.1(USBREDIRPARSER_0.11.0)(64bit) libusbredirparser.so.1(USBREDIRPARSER_0.8.0)(64bit) libusbredirparser0 libusbredirparser1 libusbredirparser1(aarch-64)"
