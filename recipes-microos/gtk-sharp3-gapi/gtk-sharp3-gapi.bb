...
RPROVIDES:${PN} += "gtk-sharp3-gapi gtk-sharp3-gapi(aarch-64) mono(gapi-fixup) mono(gapi-parser) mono(gapi_codegen)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl mono(System) mono(System.Xml) mono(mscorlib) perl-XML-LibXML perl-XML-LibXML-Common perl-XML-SAX"
