...
RPROVIDES:${PN} += "python3-asyncpg python3.10dist(asyncpg) python310-asyncpg python310-asyncpg(aarch-64) python3dist(asyncpg)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libpq5 python(abi)"
