...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-gnome-devel_gnome patterns-gnome-devel_gnome(aarch-64) patterns-openSUSE-devel_gnome"
RDEPENDS:${PN} += "pattern()"
