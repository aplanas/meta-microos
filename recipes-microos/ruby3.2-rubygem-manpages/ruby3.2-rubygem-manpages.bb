...
RPROVIDES:${PN} += "ruby3.2-rubygem-manpages ruby3.2-rubygem-manpages(aarch-64) rubygem(manpages) rubygem(ruby:3.2.0:manpages) rubygem(ruby:3.2.0:manpages:0) rubygem(ruby:3.2.0:manpages:0.6) rubygem(ruby:3.2.0:manpages:0.6.1)"
RDEPENDS:${PN} += "/bin/bash ruby(abi)"
