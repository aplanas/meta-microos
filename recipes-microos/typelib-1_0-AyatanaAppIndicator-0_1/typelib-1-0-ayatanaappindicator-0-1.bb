...
RPROVIDES:${PN} += "typelib(AyatanaAppIndicator) typelib-1_0-AyatanaAppIndicator-0_1 typelib-1_0-AyatanaAppIndicator-0_1(aarch-64)"
RDEPENDS:${PN} += "libayatana-appindicator.so.1()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2)"
