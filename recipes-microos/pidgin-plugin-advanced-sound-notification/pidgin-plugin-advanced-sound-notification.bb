...
RPROVIDES:${PN} += "pidgin-plugin-advanced-sound-notification pidgin-plugin-advanced-sound-notification(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit) libpurple.so.0()(64bit) pidgin"
