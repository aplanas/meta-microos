...
RPROVIDES:${PN} += "ghc-Decimal-devel ghc-Decimal-devel(aarch-64) ghc-devel(Decimal-0.5.2-1qhxZ7R9Om3AQz2LFWOWmX)"
RDEPENDS:${PN} += "/bin/sh ghc-Decimal ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0)"
