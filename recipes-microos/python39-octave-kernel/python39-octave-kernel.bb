...
RPROVIDES:${PN} += "python3.9dist(octave-kernel) python39-jupyter_octave_kernel python39-octave-kernel python3dist(octave-kernel)"
RDEPENDS:${PN} += "jupyter-octave-kernel python(abi) python39-ipykernel python39-jupyter-client python39-metakernel"
