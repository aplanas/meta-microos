...
RPROVIDES:${PN} += "libdeclarative_remoteobjectsplugin.so()(64bit) libdeclarative_remoteobjectsplugin.so(Qt_6)(64bit) libdeclarative_remoteobjectsplugin.so(Qt_6.0)(64bit) libdeclarative_remoteobjectsplugin.so(Qt_6.1)(64bit) libdeclarative_remoteobjectsplugin.so(Qt_6.2)(64bit) libdeclarative_remoteobjectsplugin.so(Qt_6.3)(64bit) libdeclarative_remoteobjectsplugin.so(Qt_6.4)(64bit) libdeclarative_remoteobjectsplugin.so(Qt_6.5)(64bit) libdeclarative_remoteobjectsplugin.so(Qt_6.5.1_PRIVATE_API)(64bit) qt6-remoteobjects-imports qt6-remoteobjects-imports(aarch-64)"
