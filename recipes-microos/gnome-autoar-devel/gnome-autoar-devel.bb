...
RPROVIDES:${PN} += "gnome-autoar-devel gnome-autoar-devel(aarch-64) pkgconfig(gnome-autoar-0) pkgconfig(gnome-autoar-gtk-0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgnome-autoar-0-0 libgnome-autoar-gtk-0-0 pkgconfig(gio-2.0) pkgconfig(glib-2.0) pkgconfig(gtk+-3.0) pkgconfig(libarchive) typelib-1_0-GnomeAutoar-0_1 typelib-1_0-GnomeAutoarGtk-0_1"
