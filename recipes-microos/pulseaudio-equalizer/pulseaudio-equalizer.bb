...
RPROVIDES:${PN} += "application() application(com.github.pulseaudio-equalizer-ladspa.Equalizer.desktop) pulseaudio-equalizer"
RDEPENDS:${PN} += "/bin/bash /usr/bin/python3 bc ladspa-swh-plugins pulseaudio-daemon pulseaudio-utils python(abi) python3-gobject python3-gobject-Gdk typelib(GLib) typelib(Gio) typelib(Gtk)"
