...
RPROVIDES:${PN} += "ruby3.2-rubygem-little-plugger ruby3.2-rubygem-little-plugger(aarch-64) rubygem(little-plugger) rubygem(ruby:3.2.0:little-plugger) rubygem(ruby:3.2.0:little-plugger:1) rubygem(ruby:3.2.0:little-plugger:1.1) rubygem(ruby:3.2.0:little-plugger:1.1.4)"
