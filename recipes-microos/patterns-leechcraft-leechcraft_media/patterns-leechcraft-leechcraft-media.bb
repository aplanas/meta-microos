...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() patterns-leechcraft-leechcraft_media patterns-leechcraft-leechcraft_media(aarch-64)"
RDEPENDS:${PN} += "leechcraft-lmp pattern()"
