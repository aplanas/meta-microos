...
RPROVIDES:${PN} += "config(monitoring-plugins-procs) monitoring-plugins-procs monitoring-plugins-procs(aarch-64) monitoring-plugins-procs_perf nagios-plugins-procs"
