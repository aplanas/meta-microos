...
RPROVIDES:${PN} += "libosmgpsmap-devel libosmgpsmap-devel(aarch-64) pkgconfig(osmgpsmap-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libosmgpsmap-1_0-1 pkgconfig(gtk+-3.0) pkgconfig(libsoup-2.4) typelib-1_0-OsmGpsMap-1_0"
