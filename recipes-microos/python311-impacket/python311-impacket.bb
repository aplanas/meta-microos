...
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Flask python311-chardet python311-future python311-ldap3 python311-ldapdomaindump python311-pyOpenSSL python311-pyasn1 python311-pycryptodomex python311-six update-alternatives"
