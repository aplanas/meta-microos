...
RPROVIDES:${PN} += "libimobiledevice-devel libimobiledevice-devel(aarch-64) pkgconfig(libimobiledevice-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libimobiledevice-1_0-6 pkgconfig(libimobiledevice-glue-1.0) pkgconfig(libplist-2.0) pkgconfig(libusbmuxd-2.0) pkgconfig(openssl)"
