...
RPROVIDES:${PN} += "liblognorm.so.5()(64bit) liblognorm5 liblognorm5(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libestr.so.0()(64bit) libfastjson.so.4()(64bit) libpcre.so.1()(64bit)"
