...
RPROVIDES:${PN} += "ghc-devel(reflection-2.1.7-KcOWE7PS1mHy6gA2edHvV) ghc-reflection-devel ghc-reflection-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(template-haskell-2.19.0.0) ghc-reflection"
