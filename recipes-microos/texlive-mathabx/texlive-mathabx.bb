...
RPROVIDES:${PN} += "tex(matha10.tfm) tex(matha12.tfm) tex(matha5.tfm) tex(matha6.tfm) tex(matha7.tfm) tex(matha8.tfm) tex(matha9.tfm) tex(mathabx.sty) tex(mathabx.tex) tex(mathastrotest10.tfm) tex(mathb10.tfm) tex(mathb12.tfm) tex(mathb5.tfm) tex(mathb6.tfm) tex(mathb7.tfm) tex(mathb8.tfm) tex(mathb9.tfm) tex(mathc10.tfm) tex(mathu10.tfm) tex(mathux10.tfm) tex(mathx10.tfm) tex(mathx12.tfm) tex(mathx5.tfm) tex(mathx6.tfm) tex(mathx7.tfm) tex(mathx8.tfm) tex(mathx9.tfm) texlive-mathabx"
