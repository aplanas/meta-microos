...
RPROVIDES:${PN} += "tex(plarydshln.sty) tex(plautopatch.sty) tex(plcollcell.sty) tex(plextarydshln.sty) tex(plsiunitx.sty) tex(pxpgfrcs.sty) tex(pxstfloats.sty) texlive-plautopatch"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(arydshln.sty) tex(collcell.sty) tex(colortbl.sty) tex(delarray.sty) tex(filehook.sty) tex(pgfrcs.sty) tex(plarray.sty) tex(plext.sty) tex(plextarray.sty) tex(plextcolortbl.sty) tex(plextdelarray.sty) tex(pxeveryshi.sty) tex(siunitx.sty) tex(stfloats.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
