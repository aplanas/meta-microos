...
RPROVIDES:${PN} += "ghc-HUnit-devel ghc-HUnit-devel(aarch-64) ghc-devel(HUnit-1.6.2.0-iqxwhcxJRu7EJOd1Mnwmb)"
RDEPENDS:${PN} += "/bin/sh ghc-HUnit ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(call-stack-0.4.0-K9VxYWjBEvtITBfD6bL7Dk) ghc-devel(deepseq-1.4.8.0)"
