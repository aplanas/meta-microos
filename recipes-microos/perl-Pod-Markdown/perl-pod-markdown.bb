...
RPROVIDES:${PN} += "perl(Pod::Markdown) perl(Pod::Perldoc::ToMarkdown) perl-Pod-Markdown"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(Pod::Simple) perl(Pod::Simple::Methody) perl(URI::Escape) perl(parent)"
