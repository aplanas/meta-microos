...
RPROVIDES:${PN} += "python3.10dist(sesdev) python3dist(sesdev) sesdev"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Jinja2 python3-PrettyTable python3-PyYAML python3-click python3-libvirt-python python3-pycryptodomex python3-setuptools sesdev-qa vagrant vagrant-libvirt"
