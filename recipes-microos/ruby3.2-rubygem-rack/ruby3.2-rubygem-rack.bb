...
RPROVIDES:${PN} += "ruby3.2-rubygem-rack ruby3.2-rubygem-rack(aarch-64) rubygem(rack) rubygem(ruby:3.2.0:rack) rubygem(ruby:3.2.0:rack:3) rubygem(ruby:3.2.0:rack:3.0) rubygem(ruby:3.2.0:rack:3.0.7)"
