...
RPROVIDES:${PN} += "tex(abc.sty) tex(mup.sty) texlive-abc"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(ifluatex.sty) tex(ifpdf.sty) tex(keyval.sty) tex(shellesc.sty) tex(verbatim.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
