...
RPROVIDES:${PN} += "fontconfig-devel fontconfig-devel(aarch-64) pkgconfig(fontconfig)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gettext-devel glibc-devel libfontconfig1 pkgconfig(expat) pkgconfig(freetype2)"
