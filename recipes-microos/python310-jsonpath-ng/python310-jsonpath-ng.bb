...
RPROVIDES:${PN} += "python3-jsonpath-ng python3.10dist(jsonpath-ng) python310-jsonpath-ng python3dist(jsonpath-ng)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-decorator python310-ply python310-six"
