...
RPROVIDES:${PN} += "config(vsftpd) ftp-server vsftpd vsftpd(aarch-64)"
RDEPENDS:${PN} += "/bin/sh group(nobody) ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcap.so.2()(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libpam.so.0()(64bit) libpam.so.0(LIBPAM_1.0)(64bit) libssl.so.3()(64bit) libssl.so.3(OPENSSL_3.0.0)(64bit) logrotate shadow systemd user(ftp)"
