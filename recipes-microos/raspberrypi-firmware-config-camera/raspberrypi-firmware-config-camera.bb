...
RPROVIDES:${PN} += "config(raspberrypi-firmware-config-camera) raspberrypi-firmware-branding-openSUSE raspberrypi-firmware-config raspberrypi-firmware-config-camera raspberrypi-firmware-config-rpi raspberrypi-firmware-config-rpi0w raspberrypi-firmware-config-rpi2 raspberrypi-firmware-config-rpi3"
RDEPENDS:${PN} += "(raspberrypi-firmware-extra or raspberrypi-firmware-extra-pi4) /bin/sh raspberrypi-firmware"
