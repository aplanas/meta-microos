...
RPROVIDES:${PN} += "pmix-plugin-munge pmix-plugin-munge(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libmca_common_dstore1 libmunge.so.2()(64bit) libpmix.so.2()(64bit)"
