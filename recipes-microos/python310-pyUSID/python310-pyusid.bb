...
RPROVIDES:${PN} += "python3-pyUSID python3.10dist(pyusid) python310-pyUSID python3dist(pyusid)"
RDEPENDS:${PN} += "python(abi) python310-Pillow python310-cytoolz python310-dask python310-h5py python310-numpy python310-psutil python310-sidpy python310-toolz"
