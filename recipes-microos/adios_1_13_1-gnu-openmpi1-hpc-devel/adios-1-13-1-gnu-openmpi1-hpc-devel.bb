...
RPROVIDES:${PN} += "adios_1_13_1-gnu-openmpi1-hpc-devel adios_1_13_1-gnu-openmpi1-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "adios_1_13_1-gnu-openmpi1-hpc adios_1_13_1-gnu-openmpi1-hpc-devel-static gnu-compilers-hpc-devel hdf5-gnu-openmpi1-hpc-devel lua-lmod netcdf-gnu-openmpi1-hpc-devel openmpi1-gnu-hpc-devel"
