...
RPROVIDES:${PN} += "python3.11dist(proton-client) python311-proton-client python3dist(proton-client)"
RDEPENDS:${PN} += "python(abi) python311-bcrypt python311-gnupg python311-pyOpenSSL python311-requests"
