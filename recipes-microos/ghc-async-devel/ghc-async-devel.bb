...
RPROVIDES:${PN} += "ghc-async-devel ghc-async-devel(aarch-64) ghc-devel(async-2.2.4-Is3H7ZPNMkM5reIoCaqYrF)"
RDEPENDS:${PN} += "/bin/sh ghc-async ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-devel(stm-2.5.1.0)"
