...
RPROVIDES:${PN} += "python3.9dist(virtualenv-clone) python39-virtualenv-clone python3dist(virtualenv-clone)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-virtualenv update-alternatives"
