...
RPROVIDES:${PN} += "python3.9dist(flasgger) python39-flasgger python3dist(flasgger)"
RDEPENDS:${PN} += "python(abi) python39-Flask python39-PyYAML python39-jsonschema python39-mistune python39-six"
