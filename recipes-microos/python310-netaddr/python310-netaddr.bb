...
RPROVIDES:${PN} += "python3-netaddr python3.10dist(netaddr) python310-netaddr python3dist(netaddr)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-importlib-metadata python310-importlib_resources update-alternatives"
