...
RPROVIDES:${PN} += "tex(chemexec.sty) texlive-chemexec"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(accents.sty) tex(amsmath.sty) tex(calc.sty) tex(framed.sty) tex(ifthen.sty) tex(mhchem.sty) tex(tikz.sty) tex(ulem.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
