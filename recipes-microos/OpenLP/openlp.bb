...
RPROVIDES:${PN} += "OpenLP application() application(openlp.desktop) mimehandler(application/x-openlp-service) python3.10dist(openlp) python3dist(openlp)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 hicolor-icon-theme python(abi) python3-Mako python3-SQLAlchemy python3-alembic python3-beautifulsoup4 python3-chardet python3-lxml python3-pyenchant python3-qt5 python3-xdg shared-mime-info"
