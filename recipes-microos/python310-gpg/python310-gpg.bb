...
RPROVIDES:${PN} += "python3-gpg python3.10dist(gpg) python310-gpg python310-gpg(aarch-64) python3dist(gpg)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgpgme.so.11()(64bit) libgpgme.so.11(GPGME_1.0)(64bit) libgpgme.so.11(GPGME_1.1)(64bit) python(abi)"
