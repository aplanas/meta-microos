...
RPROVIDES:${PN} += "perl(Mock::Quick) perl(Mock::Quick::Class) perl(Mock::Quick::Method) perl(Mock::Quick::Object) perl(Mock::Quick::Object::Control) perl(Mock::Quick::Util) perl(Object::Quick) perl-Mock-Quick"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Exporter::Declare)"
