...
RPROVIDES:${PN} += "libheimdal libheimdal-devel libheimdal-devel(aarch-64)"
RDEPENDS:${PN} += "db-devel glibc-devel libasn1-8 libgssapi3 libhcrypto4 libhdb9 libheimbase1 libheimedit0 libheimntlm0 libhx509-5 libkadm5clnt7 libkadm5srv8 libkafs0 libkdc2 libkrb5-26 libotp0 libroken18 libsl0 libwind0 pkgconfig(com_err) pkgconfig(ncurses) pkgconfig(sqlite3)"
