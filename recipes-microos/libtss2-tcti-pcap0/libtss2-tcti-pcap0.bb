...
RPROVIDES:${PN} += "libtss2-tcti-pcap.so.0()(64bit) libtss2-tcti-pcap0 libtss2-tcti-pcap0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libtss2-mu.so.0()(64bit) libtss2-tctildr.so.0()(64bit)"
