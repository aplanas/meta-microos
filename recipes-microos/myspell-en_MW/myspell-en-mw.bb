...
RPROVIDES:${PN} += "locale(libreoffice:en_MW) locale(seamonkey-spellchecker:en_MW) myspell-dictionary myspell-en_MW"
RDEPENDS:${PN} += "myspell-dictionaries myspell-en myspell-en_GB myspell-en_US myspell-en_ZA"
