...
RPROVIDES:${PN} += "python3.9dist(checkdmarc) python39-checkdmarc python3dist(checkdmarc)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-dnspython python39-expiringdict python39-publicsuffix2 python39-pyleri python39-requests python39-timeout-decorator"
