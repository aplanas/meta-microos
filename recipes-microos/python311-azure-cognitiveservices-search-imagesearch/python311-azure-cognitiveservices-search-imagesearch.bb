...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-search-imagesearch) python311-azure-cognitiveservices-search-imagesearch python3dist(azure-cognitiveservices-search-imagesearch)"
