...
RPROVIDES:${PN} += "python3.9dist(proton-client) python39-proton-client python3dist(proton-client)"
RDEPENDS:${PN} += "python(abi) python39-bcrypt python39-gnupg python39-pyOpenSSL python39-requests"
