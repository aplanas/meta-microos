...
RPROVIDES:${PN} += "python3-azure-mgmt-graphservices python3.10dist(azure-mgmt-graphservices) python310-azure-mgmt-graphservices python3dist(azure-mgmt-graphservices)"
