...
RPROVIDES:${PN} += "tex(neuralnetwork.sty) texlive-neuralnetwork"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(algorithmicx.sty) tex(environ.sty) tex(etoolbox.sty) tex(mathtools.sty) tex(tikz.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
