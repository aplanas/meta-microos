...
RPROVIDES:${PN} += "libssh2-devel libssh2-devel(aarch-64) pkgconfig(libssh2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libssh2-1 pkgconfig(libcrypto) pkgconfig(libssl) pkgconfig(zlib)"
