...
RPROVIDES:${PN} += "python3-sphobjinv python3.10dist(sphobjinv) python310-sphobjinv python3dist(sphobjinv)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-attrs python310-certifi python310-jsonschema update-alternatives"
