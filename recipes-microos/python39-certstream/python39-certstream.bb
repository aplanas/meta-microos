...
RPROVIDES:${PN} += "python3.9dist(certstream) python39-certstream python3dist(certstream)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python3-termcolor python3-websocket-client update-alternatives"
