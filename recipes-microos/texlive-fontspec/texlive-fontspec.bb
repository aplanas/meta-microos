...
RPROVIDES:${PN} += "tex(fontspec-luatex.sty) tex(fontspec-xetex.sty) tex(fontspec.cfg) tex(fontspec.sty) texlive-fontspec"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontenc.sty) tex(luaotfload.sty) tex(xparse.sty) tex(xunicode.sty) texlive texlive-euenc texlive-filesystem texlive-iftex texlive-kpathsea texlive-kpathsea-bin texlive-l3kernel texlive-l3packages texlive-lm texlive-scripts texlive-scripts-bin texlive-xunicode"
