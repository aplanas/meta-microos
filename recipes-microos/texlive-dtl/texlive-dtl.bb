...
RPROVIDES:${PN} += "man(dt2dv.1) man(dv2dt.1) texlive-dtl"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-dtl-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
