...
RPROVIDES:${PN} += "tex(gitexinfo.sty) tex(gitinfo2.sty) texlive-gitinfo2"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(eso-pic.sty) tex(etoolbox.sty) tex(kvoptions.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
