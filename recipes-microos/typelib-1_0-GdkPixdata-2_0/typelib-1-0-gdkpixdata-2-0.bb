...
RPROVIDES:${PN} += "typelib(GdkPixdata) typelib-1_0-GdkPixdata-2_0 typelib-1_0-GdkPixdata-2_0(aarch-64)"
RDEPENDS:${PN} += "libgdk_pixbuf-2.0.so.0()(64bit) typelib(GLib) typelib(GModule) typelib(GObject) typelib(GdkPixbuf) typelib(Gio)"
