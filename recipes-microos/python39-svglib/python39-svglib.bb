...
RPROVIDES:${PN} += "python3.9dist(svglib) python39-svglib python3dist(svglib)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-cssselect2 python39-lxml python39-reportlab python39-tinycss2 update-alternatives"
