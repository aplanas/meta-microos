...
RPROVIDES:${PN} += "libbraille-fake0-14 libbraille-fake0-14(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libbraille libbraille-0.so.14()(64bit) libgdk-x11-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit)"
