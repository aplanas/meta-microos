...
RPROVIDES:${PN} += "glassfish-hk2-osgi-resource-locator mvn(org.glassfish.hk2:osgi-resource-locator) mvn(org.glassfish.hk2:osgi-resource-locator:pom:) osgi(org.glassfish.hk2.osgi-resource-locator) osgi-resource-locator"
