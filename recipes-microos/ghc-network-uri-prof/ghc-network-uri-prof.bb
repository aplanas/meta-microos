...
RPROVIDES:${PN} += "ghc-network-uri-prof ghc-network-uri-prof(aarch-64) ghc-prof(network-uri-2.6.4.2-4kNQnaE9heqEL1mH8FE5xH)"
RDEPENDS:${PN} += "ghc-network-uri-devel ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(parsec-3.1.16.1) ghc-prof(template-haskell-2.19.0.0) ghc-prof(th-compat-0.1.4-Bzk38miPOyTJh1KMkOoOkv)"
