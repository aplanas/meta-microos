...
RPROVIDES:${PN} += "languagetool-tools mvn(org.languagetool:languagetool-tools) mvn(org.languagetool:languagetool-tools:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(commons-cli:commons-cli) mvn(org.carrot2:morfologik-tools) mvn(org.languagetool:languagetool-core)"
