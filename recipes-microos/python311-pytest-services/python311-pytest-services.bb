...
RPROVIDES:${PN} += "python3.11dist(pytest-services) python311-pytest-services python3dist(pytest-services)"
RDEPENDS:${PN} += "python(abi) python311-psutil python311-pytest python311-requests python311-setuptools python311-zc.lockfile"
