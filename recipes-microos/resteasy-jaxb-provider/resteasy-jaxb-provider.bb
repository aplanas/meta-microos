...
RPROVIDES:${PN} += "mvn(org.jboss.resteasy:resteasy-jaxb-provider) mvn(org.jboss.resteasy:resteasy-jaxb-provider:pom:) resteasy-jaxb-provider"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.sun.xml.bind:jaxb-impl) mvn(javax.xml.bind:jaxb-api) mvn(org.apache.tomcat:tomcat-servlet-api) mvn(org.jboss.logging:jboss-logging) mvn(org.jboss.logging:jboss-logging-annotations) mvn(org.jboss.logging:jboss-logging-processor)"
