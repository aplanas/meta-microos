...
RPROVIDES:${PN} += "python3.9dist(jsonschema) python39-jsonschema python3dist(jsonschema)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 alts python(abi) python39-attrs python39-pyrsistent"
