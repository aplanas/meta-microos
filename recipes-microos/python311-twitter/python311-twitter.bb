...
RPROVIDES:${PN} += "python3.11dist(twitter) python311-twitter python3dist(twitter)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python3.11dist(certifi) python3.11dist(setuptools) update-alternatives"
