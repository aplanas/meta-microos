...
RPROVIDES:${PN} += "python3.11dist(devpi-client) python311-devpi-client python3dist(devpi-client)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-build python311-check-manifest python311-devpi-common python311-pkginfo python311-pluggy python311-py python311-tox python311-wheel update-alternatives"
