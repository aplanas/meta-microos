...
RPROVIDES:${PN} += "libatomicparsley.so.0()(64bit) libatomicparsley0 libatomicparsley0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libgdk_pixbuf-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgpod.so.4()(64bit) libgtkpod.so.1()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit)"
