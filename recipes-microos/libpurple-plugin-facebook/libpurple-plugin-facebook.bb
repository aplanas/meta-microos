...
RPROVIDES:${PN} += "libfacebook.so()(64bit) libpurple-plugin-facebook libpurple-plugin-facebook(aarch-64) purple-facebook"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libjson-glib-1.0.so.0()(64bit) libjson-glib-1.0.so.0(libjson-glib-1.0.so.0)(64bit) libpurple.so.0()(64bit) libz.so.1()(64bit)"
