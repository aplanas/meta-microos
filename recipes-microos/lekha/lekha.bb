...
RPROVIDES:${PN} += "application() application(lekha.desktop) lekha lekha(aarch-64) mimehandler(application/pdf) python3.10dist(lekha) python3dist(lekha)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-PyPDF2 python3-efl python3-xdg"
