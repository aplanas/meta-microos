...
RPROVIDES:${PN} += "python3.9dist(jfscripts) python39-jfscripts python3dist(jfscripts)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyPDF2 python39-sphinx-argparse python39-termcolor update-alternatives"
