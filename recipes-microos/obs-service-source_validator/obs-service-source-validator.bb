...
RPROVIDES:${PN} += "obs-service-source_validator osc-source_validator perl(DebianSourceChangesValidator)"
RDEPENDS:${PN} += "/bin/bash /usr/bin/perl /usr/bin/python3 /usr/bin/xmllint build gpg2 patch perl-TimeDate rpm-build"
