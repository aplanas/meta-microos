...
RPROVIDES:${PN} += "ruby3.2-rubygem-polyglot ruby3.2-rubygem-polyglot(aarch-64) rubygem(polyglot) rubygem(ruby:3.2.0:polyglot) rubygem(ruby:3.2.0:polyglot:0) rubygem(ruby:3.2.0:polyglot:0.3) rubygem(ruby:3.2.0:polyglot:0.3.5)"
