...
RPROVIDES:${PN} += "ruby3.2-rubygem-fast_gettext ruby3.2-rubygem-fast_gettext(aarch-64) rubygem(fast_gettext) rubygem(ruby:3.2.0:fast_gettext) rubygem(ruby:3.2.0:fast_gettext:2) rubygem(ruby:3.2.0:fast_gettext:2.2) rubygem(ruby:3.2.0:fast_gettext:2.2.0)"
