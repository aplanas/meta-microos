...
RPROVIDES:${PN} += "config(python3-libstoragemgmt) python3-libstoragemgmt python3-libstoragemgmt(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libstoragemgmt(aarch-64) libstoragemgmt.so.1()(64bit) python(abi)"
