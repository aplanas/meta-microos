...
RPROVIDES:${PN} += "ruby3.2-rubygem-globalid ruby3.2-rubygem-globalid(aarch-64) rubygem(globalid) rubygem(ruby:3.2.0:globalid) rubygem(ruby:3.2.0:globalid:1) rubygem(ruby:3.2.0:globalid:1.1) rubygem(ruby:3.2.0:globalid:1.1.0)"
