...
RPROVIDES:${PN} += "tex(dictsym.map) tex(dictsym.sty) tex(dictsym.tfm) texlive-dictsym"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(keyval.sty) tex(pifont.sty) tex(updmap.cfg) texlive texlive-dictsym-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
