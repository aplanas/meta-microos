...
RPROVIDES:${PN} += "pkgconfig(pygtk-2.0) python-gtk-devel python-gtk-devel(aarch-64) python2-gtk-devel"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config /usr/bin/python /usr/bin/python2 pkgconfig(gtk+-2.0) pkgconfig(pygobject-2.0) python-cairo-devel python-gobject2-devel python-gtk"
