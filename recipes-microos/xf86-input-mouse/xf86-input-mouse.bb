...
RPROVIDES:${PN} += "xf86-input-mouse xf86-input-mouse(aarch-64)"
RDEPENDS:${PN} += "/bin/sh X11_ABI_XINPUT ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) udev"
