...
RPROVIDES:${PN} += "libuct-devel libuct-devel(aarch-64) pkgconfig(ucx-cma) pkgconfig(ucx-ib) pkgconfig(ucx-rdmacm) pkgconfig(ucx-uct)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libuct0 pkgconfig(libibverbs) pkgconfig(librdmacm) pkgconfig(ucx-ucs)"
