...
RPROVIDES:${PN} += "python3.9dist(nxapi-plumbing) python39-nxapi-plumbing python3dist(nxapi-plumbing)"
RDEPENDS:${PN} += "python(abi) python39-future python39-lxml python39-requests python39-scp python39-six"
