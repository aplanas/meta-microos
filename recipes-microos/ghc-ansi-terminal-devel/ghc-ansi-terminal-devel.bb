...
RPROVIDES:${PN} += "ghc-ansi-terminal-devel ghc-ansi-terminal-devel(aarch-64) ghc-devel(ansi-terminal-0.11.5-5x0MoHxm5r6DDoyv5djCW3)"
RDEPENDS:${PN} += "/bin/sh ghc-ansi-terminal ghc-compiler ghc-devel(ansi-terminal-types-0.11.5-9ffXWswmNhoANlpnF2SnhR) ghc-devel(base-4.17.1.0) ghc-devel(colour-2.3.6-7jQe2xj5Lsa5MbX38iH7Ln)"
