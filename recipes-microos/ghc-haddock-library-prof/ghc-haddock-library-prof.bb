...
RPROVIDES:${PN} += "ghc-haddock-library-prof ghc-haddock-library-prof(aarch-64) ghc-prof(haddock-library-1.11.0-3IU1wl1Mct8946s210c9Hs)"
RDEPENDS:${PN} += "ghc-haddock-library-devel ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(parsec-3.1.16.1) ghc-prof(text-2.0.2)"
