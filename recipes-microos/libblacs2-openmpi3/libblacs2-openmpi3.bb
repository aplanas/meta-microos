...
RPROVIDES:${PN} += "libblacs.so.2.1.0()(64bit) libblacs2-openmpi3 libblacs2-openmpi3(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libmpi.so.40()(64bit)"
