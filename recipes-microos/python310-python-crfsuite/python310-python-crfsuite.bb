...
RPROVIDES:${PN} += "python3-python-crfsuite python3.10dist(python-crfsuite) python310-python-crfsuite python310-python-crfsuite(aarch-64) python3dist(python-crfsuite)"
