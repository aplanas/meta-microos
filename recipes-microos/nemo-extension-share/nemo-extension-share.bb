...
RPROVIDES:${PN} += "libnemo-share.so()(64bit) nemo-extension-share nemo-extension-share(aarch-64) nemo-share"
RDEPENDS:${PN} += "/sbin/ldconfig /usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libnemo-extension.so.1()(64bit) nemo"
