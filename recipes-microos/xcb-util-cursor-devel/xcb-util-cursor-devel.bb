...
RPROVIDES:${PN} += "pkgconfig(xcb-cursor) xcb-util-cursor-devel xcb-util-cursor-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxcb-cursor0 pkgconfig(xcb) pkgconfig(xcb-image) pkgconfig(xcb-render) pkgconfig(xcb-renderutil)"
