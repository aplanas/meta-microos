...
RPROVIDES:${PN} += "python3.11dist(transip) python311-transip python3dist(transip)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-cryptography python311-requests python311-setuptools python311-suds update-alternatives"
