...
RPROVIDES:${PN} += "python3.11dist(txtorcon) python311-txtorcon python3dist(txtorcon)"
RDEPENDS:${PN} += "python(abi) python311-Automat python311-Twisted-tls python311-incremental python311-zope.interface"
