...
RPROVIDES:${PN} += "tex(zref-abspage.sty) tex(zref-abspos.sty) tex(zref-base.sty) tex(zref-counter.sty) tex(zref-dotfill.sty) tex(zref-env.sty) tex(zref-hyperref.sty) tex(zref-lastpage.sty) tex(zref-marks.sty) tex(zref-nextpage.sty) tex(zref-pageattr.sty) tex(zref-pagelayout.sty) tex(zref-perpage.sty) tex(zref-runs.sty) tex(zref-savepos.sty) tex(zref-thepage.sty) tex(zref-titleref.sty) tex(zref-totpages.sty) tex(zref-user.sty) tex(zref-xr.sty) tex(zref.sty) texlive-zref"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atbegshi.sty) tex(atveryend.sty) tex(auxhook.sty) tex(etexcmds.sty) tex(gettitlestring.sty) tex(iftex.sty) tex(infwarerr.sty) tex(keyval.sty) tex(kvdefinekeys.sty) tex(kvoptions.sty) tex(kvsetkeys.sty) tex(ltxcmds.sty) tex(makerobust.sty) tex(pdftexcmds.sty) tex(uniquecounter.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
