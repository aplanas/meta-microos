...
RPROVIDES:${PN} += "monitoring-plugins-nwc_health nagios-plugins-nwc_health"
RDEPENDS:${PN} += "/usr/bin/perl perl(File::Slurp) perl(JSON) perl(JSON::XS) perl-Nagios-Plugin perl-Net-SNMP"
