...
RPROVIDES:${PN} += "mvn(org.mozilla:rhino-engine) mvn(org.mozilla:rhino-engine:pom:) rhino-engine"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.mozilla:rhino) rhino"
