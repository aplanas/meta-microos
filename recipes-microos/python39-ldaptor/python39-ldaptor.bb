...
RPROVIDES:${PN} += "python3.9dist(ldaptor) python39-ldaptor python3dist(ldaptor)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Twisted-tls python39-passlib python39-pyparsing python39-zope.interface update-alternatives"
