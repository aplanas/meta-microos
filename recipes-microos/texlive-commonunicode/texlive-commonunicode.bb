...
RPROVIDES:${PN} += "tex(commonunicode.sty) texlive-commonunicode"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsfonts.sty) tex(amssymb.sty) tex(mathrsfs.sty) tex(mathtools.sty) tex(stmaryrd.sty) tex(wasysym.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
