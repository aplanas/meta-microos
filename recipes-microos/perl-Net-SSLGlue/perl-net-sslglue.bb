...
RPROVIDES:${PN} += "perl(Net::SSLGlue) perl(Net::SSLGlue::FTP) perl(Net::SSLGlue::FTP::SingleSessionCache) perl(Net::SSLGlue::LDAP) perl(Net::SSLGlue::LWP) perl(Net::SSLGlue::LWP::Socket) perl(Net::SSLGlue::POP3) perl(Net::SSLGlue::POP3::_SSL_Socket) perl(Net::SSLGlue::POP3::_SSLified) perl(Net::SSLGlue::SMTP) perl(Net::SSLGlue::SMTP::_SSL_Socket) perl(Net::SSLGlue::SMTP::_SSLified) perl(Net::SSLGlue::Socket) perl(Net::SSLGlue::Socket::HANDLE) perl-Net-SSLGlue"
