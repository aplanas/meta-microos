...
RPROVIDES:${PN} += "atkmm1_6-devel atkmm1_6-devel(aarch-64) pkgconfig(atkmm-1.6)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libatkmm-1_6-1 pkgconfig(atk) pkgconfig(glibmm-2.4)"
