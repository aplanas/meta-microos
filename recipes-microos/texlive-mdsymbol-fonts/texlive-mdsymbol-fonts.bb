...
RPROVIDES:${PN} += "config(texlive-mdsymbol-fonts) font(mdsymbol) font(mdsymbola) font(mdsymbolb) font(mdsymbolc) font(mdsymbold) font(mdsymbole) font(mdsymbolf) texlive-mdsymbol-fonts"
