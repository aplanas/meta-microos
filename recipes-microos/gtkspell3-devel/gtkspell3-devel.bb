...
RPROVIDES:${PN} += "gtkspell3-devel gtkspell3-devel(aarch-64) pkgconfig(gtkspell3-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgtkspell3-3-0 pkgconfig(enchant-2) pkgconfig(glib-2.0) pkgconfig(gtk+-3.0) typelib-1_0-GtkSpell-3_0"
