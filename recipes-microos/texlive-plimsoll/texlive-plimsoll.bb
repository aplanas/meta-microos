...
RPROVIDES:${PN} += "tex(plimsoll-sans.tfm) tex(plimsoll.enc) tex(plimsoll.map) tex(plimsoll.sty) tex(plimsoll.tfm) texlive-plimsoll"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-plimsoll-fonts texlive-scripts texlive-scripts-bin"
