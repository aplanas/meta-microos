...
RPROVIDES:${PN} += "python3.9dist(azure-multiapi-storage) python39-azure-multiapi-storage python3dist(azure-multiapi-storage)"
RDEPENDS:${PN} += "python(abi) python39-azure-common python39-azure-core python39-azure-nspkg python39-cryptography python39-msrest python39-python-dateutil python39-requests"
