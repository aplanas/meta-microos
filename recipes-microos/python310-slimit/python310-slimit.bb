...
RPROVIDES:${PN} += "python3-slimit python3.10dist(slimit) python310-slimit python3dist(slimit)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-ply python310-setuptools update-alternatives"
