...
RPROVIDES:${PN} += "perl(Dancer2::Plugin::Auth::Extensible::Provider::DBIC) perl-Dancer2-Plugin-Auth-Extensible-Provider-DBIC"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DBIx::Class::ResultClass::HashRefInflator) perl(Dancer2) perl(Dancer2::Core::Types) perl(Dancer2::Plugin::Auth::Extensible) perl(Dancer2::Plugin::DBIC) perl(DateTime) perl(Moo) perl(String::CamelCase) perl(namespace::clean)"
