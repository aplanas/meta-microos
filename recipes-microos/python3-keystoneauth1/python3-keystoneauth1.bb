...
RPROVIDES:${PN} += "python3-keystoneauth1 python3.10dist(keystoneauth1) python3dist(keystoneauth1)"
RDEPENDS:${PN} += "python(abi) python3-PyYAML python3-iso8601 python3-lxml python3-oauthlib python3-os-service-types python3-requests python3-requests-kerberos python3-six python3-stevedore"
