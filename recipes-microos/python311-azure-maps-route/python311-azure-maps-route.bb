...
RPROVIDES:${PN} += "python3.11dist(azure-maps-route) python311-azure-maps-route python3dist(azure-maps-route)"
RDEPENDS:${PN} += "python(abi) python311-azure-common python311-azure-mgmt-core python311-azure-nspkg python311-msrest python311-requests"
