...
RPROVIDES:${PN} += "tex(csbulacronym.sty) tex(csbulletin.cls) tex(csbulobalka.cls) tex(csbulobalka.sty) tex(csbulv1.cls) texlive-csbulletin"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(article.cls) tex(babel.sty) tex(color.sty) tex(fancyvrb.sty) tex(fontenc.sty) tex(graphicx.sty) tex(ifpdf.sty) tex(lmodern.sty) tex(mflogo.sty) tex(verbatim.sty) tex(zwpagelayout.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
