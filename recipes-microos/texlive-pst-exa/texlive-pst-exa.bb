...
RPROVIDES:${PN} += "tex(pst-exa.sty) texlive-pst-exa"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(accsupp.sty) tex(changepage.sty) tex(etoolbox.sty) tex(showexpl.sty) tex(tcolorbox.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
