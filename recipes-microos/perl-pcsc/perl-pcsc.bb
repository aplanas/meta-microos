...
RPROVIDES:${PN} += "perl(Chipcard::PCSC) perl(Chipcard::PCSC::Card) perl-pcsc perl-pcsc(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) perl(:MODULE_COMPAT_5.36.0) perl-base"
