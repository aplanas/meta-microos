...
RPROVIDES:${PN} += "python3.9dist(colorcet) python39-colorcet python3dist(colorcet)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-param python39-pyct update-alternatives"
