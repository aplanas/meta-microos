...
locale(xfce4-mailwatch-plugin:en_AU) \
locale(xfce4-mailwatch-plugin:en_GB) \
...
locale(xfce4-mailwatch-plugin:pt_BR) \
...
locale(xfce4-mailwatch-plugin:zh_CN) \
locale(xfce4-mailwatch-plugin:zh_TW) \
