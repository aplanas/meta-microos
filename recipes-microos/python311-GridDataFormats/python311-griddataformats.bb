...
RPROVIDES:${PN} += "python3.11dist(griddataformats) python311-GridDataFormats python3dist(griddataformats)"
RDEPENDS:${PN} += "python(abi) python311-mrcfile python311-numpy python311-scipy"
