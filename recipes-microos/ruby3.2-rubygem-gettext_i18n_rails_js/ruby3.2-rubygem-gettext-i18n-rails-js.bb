...
RPROVIDES:${PN} += "ruby3.2-rubygem-gettext_i18n_rails_js ruby3.2-rubygem-gettext_i18n_rails_js(aarch-64) rubygem(gettext_i18n_rails_js) rubygem(ruby:3.2.0:gettext_i18n_rails_js) rubygem(ruby:3.2.0:gettext_i18n_rails_js:1) rubygem(ruby:3.2.0:gettext_i18n_rails_js:1.3) rubygem(ruby:3.2.0:gettext_i18n_rails_js:1.3.1)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:gettext) rubygem(ruby:3.2.0:gettext_i18n_rails) rubygem(ruby:3.2.0:po_to_json) rubygem(ruby:3.2.0:rails)"
