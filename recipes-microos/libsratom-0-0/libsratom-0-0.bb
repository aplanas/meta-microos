...
RPROVIDES:${PN} += "libsratom-0-0 libsratom-0-0(aarch-64) libsratom-0.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libserd-0.so.0()(64bit) libsord-0.so.0()(64bit)"
