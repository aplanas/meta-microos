...
RPROVIDES:${PN} += "python3-oslo.messaging python3.10dist(oslo.messaging) python3dist(oslo.messaging)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-PyYAML python3-WebOb python3-amqp python3-cachetools python3-debtcollector python3-futurist python3-greenlet python3-kombu python3-oslo.config python3-oslo.i18n python3-oslo.log python3-oslo.metrics python3-oslo.middleware python3-oslo.serialization python3-oslo.service python3-oslo.utils python3-stevedore"
