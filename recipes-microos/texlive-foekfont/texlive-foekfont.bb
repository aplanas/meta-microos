...
RPROVIDES:${PN} += "tex(foekfont.map) tex(foekfont.sty) tex(foekfont.tfm) tex(ot1foekfont.fd) tex(t1foekfont.fd) texlive-foekfont"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-foekfont-fonts texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
