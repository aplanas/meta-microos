...
RPROVIDES:${PN} += "latex2html perl(L2hos) perl(L2hos::Dos) perl(L2hos::Mac) perl(L2hos::OS2) perl(L2hos::Unix) perl(L2hos::Win32) perl(cfgcache)"
RDEPENDS:${PN} += "/usr/bin/perl ghostscript_any latex2html-pngicons netpbm perl texlive-dvips texlive-latex texlive-preview"
