...
RPROVIDES:${PN} += "thunar-dropbox thunar-plugin-dropbox thunar-plugin-dropbox(aarch-64)"
RDEPENDS:${PN} += "dropbox ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libthunarx-3.so.0()(64bit) thunar"
