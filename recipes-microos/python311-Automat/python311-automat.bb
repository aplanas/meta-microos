...
RPROVIDES:${PN} += "python3.11dist(automat) python311-Automat python3dist(automat)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-attrs update-alternatives"
