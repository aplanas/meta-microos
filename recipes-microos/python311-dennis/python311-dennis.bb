...
RPROVIDES:${PN} += "python3.11dist(dennis) python311-dennis python3dist(dennis)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-click python311-polib update-alternatives"
