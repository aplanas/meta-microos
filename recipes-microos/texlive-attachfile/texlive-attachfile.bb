...
RPROVIDES:${PN} += "tex(attachfile.sty) texlive-attachfile"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(color.sty) tex(hyperref.sty) tex(ifpdf.sty) tex(keyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
