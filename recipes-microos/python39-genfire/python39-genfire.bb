...
RPROVIDES:${PN} += "python3.9dist(genfire) python39-genfire python3dist(genfire)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Pillow python39-PyQt5 python39-numpy python39-pyFFTW python39-pyparsing python39-scipy python39-setuptools update-alternatives"
