...
RPROVIDES:${PN} += "pkgconfig(gi-docgen) python3-gi-docgen python3.10dist(gi-docgen) python3dist(gi-docgen)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config /usr/bin/python3 python(abi) python3-Jinja2 python3-Markdown python3-MarkupSafe python3-Pygments python3-toml python3-typogrify"
