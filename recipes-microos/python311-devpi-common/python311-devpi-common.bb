...
RPROVIDES:${PN} += "python3.11dist(devpi-common) python311-devpi-common python3dist(devpi-common)"
RDEPENDS:${PN} += "python(abi) python311-packaging python311-py python311-requests"
