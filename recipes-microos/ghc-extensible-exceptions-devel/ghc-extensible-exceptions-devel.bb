...
RPROVIDES:${PN} += "ghc-devel(extensible-exceptions-0.1.1.4-ItoFoaqbPMuGIlsBr6VhGY) ghc-extensible-exceptions-devel ghc-extensible-exceptions-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-extensible-exceptions"
