...
RPROVIDES:${PN} += "config(xml-commons-resolver) mvn(xml-resolver:xml-resolver) mvn(xml-resolver:xml-resolver:pom:) osgi(org.apache.xml.resolver) xerces-j2-xml-resolver xml-commons xml-commons-resolver xml-commons-resolver10 xml-commons-resolver11 xml-commons-resolver12 xml-resolver"
