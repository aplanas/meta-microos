...
RPROVIDES:${PN} += "wob wob(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libinih.so.0()(64bit) libseccomp.so.2()(64bit) libwayland-client.so.0()(64bit)"
