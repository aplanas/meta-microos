...
RPROVIDES:${PN} += "python3.11dist(conu) python311-conu python3dist(conu)"
RDEPENDS:${PN} += "python(abi) python311-docker python311-flexmock python311-kubernetes python311-pytest python311-requests"
