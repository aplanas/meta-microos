...
RPROVIDES:${PN} += "libpocketsphinx.so.3()(64bit) libpocketsphinx3 libpocketsphinx3(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) libsphinxbase.so.3()(64bit) pocketsphinx5"
