...
RPROVIDES:${PN} += "python3.9dist(azure-mgmt-core) python39-azure-mgmt-core python3dist(azure-mgmt-core)"
RDEPENDS:${PN} += "python(abi) python39-azure-core python39-azure-mgmt-nspkg python39-azure-nspkg"
