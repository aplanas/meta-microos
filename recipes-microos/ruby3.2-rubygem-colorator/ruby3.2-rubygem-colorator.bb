...
RPROVIDES:${PN} += "ruby3.2-rubygem-colorator ruby3.2-rubygem-colorator(aarch-64) rubygem(colorator) rubygem(ruby:3.2.0:colorator) rubygem(ruby:3.2.0:colorator:1) rubygem(ruby:3.2.0:colorator:1.1) rubygem(ruby:3.2.0:colorator:1.1.0)"
