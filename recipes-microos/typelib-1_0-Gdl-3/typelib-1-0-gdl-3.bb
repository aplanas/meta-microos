...
RPROVIDES:${PN} += "typelib(Gdl) typelib-1_0-Gdl-3 typelib-1_0-Gdl-3(aarch-64)"
RDEPENDS:${PN} += "libgdl-3.so.5()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
