...
RPROVIDES:${PN} += "python39-dask-all python39-dask-complete"
RDEPENDS:${PN} += "python39-dask python39-dask-array python39-dask-bag python39-dask-dataframe python39-dask-delayed python39-dask-diagnostics python39-dask-distributed python39-dask-dot python39-lz4 python39-pyarrow"
