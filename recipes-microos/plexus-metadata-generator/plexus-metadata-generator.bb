...
RPROVIDES:${PN} += "mvn(org.codehaus.plexus:plexus-metadata-generator) mvn(org.codehaus.plexus:plexus-metadata-generator:pom:) plexus-metadata-generator"
RDEPENDS:${PN} += "/bin/bash apache-commons-cli guava java-headless javapackages-filesystem jdom2 mvn(com.thoughtworks.qdox:qdox) mvn(org.codehaus.plexus:plexus-component-annotations) mvn(org.codehaus.plexus:plexus-container-default) mvn(org.codehaus.plexus:plexus-utils) mvn(org.jdom:jdom2) mvn(org.ow2.asm:asm) objectweb-asm plexus-cli plexus-containers-component-annotations plexus-containers-container-default plexus-utils qdox xbean"
