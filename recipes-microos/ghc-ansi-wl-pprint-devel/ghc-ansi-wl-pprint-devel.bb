...
RPROVIDES:${PN} += "ghc-ansi-wl-pprint-devel ghc-ansi-wl-pprint-devel(aarch-64) ghc-devel(ansi-wl-pprint-0.6.9-1uNId4TIZRh7T7KEIBVXZI)"
RDEPENDS:${PN} += "/bin/sh ghc-ansi-wl-pprint ghc-compiler ghc-devel(ansi-terminal-0.11.5-5x0MoHxm5r6DDoyv5djCW3) ghc-devel(base-4.17.1.0)"
