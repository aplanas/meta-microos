...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-openSUSE-xfce_office patterns-xfce-xfce_office patterns-xfce-xfce_office(aarch-64)"
RDEPENDS:${PN} += "pattern()"
