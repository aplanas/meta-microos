...
RPROVIDES:${PN} += "python3.11dist(flask-oidc) python311-flask-oidc python3dist(flask-oidc)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Authlib python311-Flask python311-requests update-alternatives"
