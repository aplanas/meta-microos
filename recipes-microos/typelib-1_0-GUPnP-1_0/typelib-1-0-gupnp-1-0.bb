...
RPROVIDES:${PN} += "typelib(GUPnP) typelib-1_0-GUPnP-1_0 typelib-1_0-GUPnP-1_0(aarch-64)"
RDEPENDS:${PN} += "libgupnp-1.6.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(GSSDP) typelib(Gio) typelib(Soup) typelib(libxml2)"
