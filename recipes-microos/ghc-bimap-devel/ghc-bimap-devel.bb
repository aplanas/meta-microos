...
RPROVIDES:${PN} += "ghc-bimap-devel ghc-bimap-devel(aarch-64) ghc-devel(bimap-0.5.0-3nKyJuRybYg2I5XOsBhwKE)"
RDEPENDS:${PN} += "/bin/sh ghc-bimap ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(deepseq-1.4.8.0) ghc-devel(exceptions-0.10.5)"
