...
RPROVIDES:${PN} += "libgamin libgamin-1-0 libgamin-1-0(aarch-64) libgamin-1.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig gamin-server ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit)"
