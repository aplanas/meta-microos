...
RPROVIDES:${PN} += "ghc-bsb-http-chunked-devel ghc-bsb-http-chunked-devel(aarch-64) ghc-devel(bsb-http-chunked-0.0.0.4-7TdDxnBU7De3tUquWdckvl)"
RDEPENDS:${PN} += "/bin/sh ghc-bsb-http-chunked ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0)"
