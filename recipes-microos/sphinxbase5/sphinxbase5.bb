...
RPROVIDES:${PN} += "sphinxbase5 sphinxbase5(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.29)(64bit) libsphinxad.so.3()(64bit) libsphinxbase.so.3()(64bit) update-alternatives"
