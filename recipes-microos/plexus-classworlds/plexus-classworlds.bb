...
RPROVIDES:${PN} += "classworlds mvn(classworlds:classworlds) mvn(classworlds:classworlds:pom:) mvn(org.codehaus.plexus:plexus-classworlds) mvn(org.codehaus.plexus:plexus-classworlds:pom:) osgi(org.codehaus.plexus.classworlds) plexus-classworlds"
