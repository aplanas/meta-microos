...
RPROVIDES:${PN} += "libfoma-hfst.so.0()(64bit) libfoma-hfst0 libfoma-hfst0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libpthread.so.0()(64bit) libpthread.so.0(GLIBC_2.17)(64bit)"
