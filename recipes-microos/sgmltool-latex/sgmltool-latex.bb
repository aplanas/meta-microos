...
RPROVIDES:${PN} += "sgmltool-latex sgmltool-latex(aarch-64) sgmltool:/usr/bin/sgml2latex"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl coreutils sgmltool texlive-epsf texlive-filesystem texlive-kpathsea texlive-latex texlive-url"
