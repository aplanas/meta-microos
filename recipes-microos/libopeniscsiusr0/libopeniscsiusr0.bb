...
RPROVIDES:${PN} += "libopeniscsiusr.so.0()(64bit) libopeniscsiusr0 libopeniscsiusr0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libkmod.so.2()(64bit) libkmod.so.2(LIBKMOD_5)(64bit)"
