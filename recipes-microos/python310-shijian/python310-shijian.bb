...
RPROVIDES:${PN} += "python3-shijian python3.10dist(shijian) python310-shijian python3dist(shijian)"
RDEPENDS:${PN} += "python310-matplotlib python310-numpy python310-pandas python310-python-dateutil python310-scikit-learn python310-scipy python310-seaborn python310-technicolor"
