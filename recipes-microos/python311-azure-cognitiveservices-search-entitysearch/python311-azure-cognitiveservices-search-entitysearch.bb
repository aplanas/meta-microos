...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-search-entitysearch) python311-azure-cognitiveservices-search-entitysearch python3dist(azure-cognitiveservices-search-entitysearch)"
