...
RPROVIDES:${PN} += "ruby3.2-rubygem-json-schema ruby3.2-rubygem-json-schema(aarch-64) rubygem(json-schema) rubygem(ruby:3.2.0:json-schema) rubygem(ruby:3.2.0:json-schema:3) rubygem(ruby:3.2.0:json-schema:3.0) rubygem(ruby:3.2.0:json-schema:3.0.0)"
