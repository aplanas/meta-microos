...
RPROVIDES:${PN} += "tex(aligned-overset.sty) texlive-aligned-overset"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(expl3.sty) tex(mathtools.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
