...
RPROVIDES:${PN} += "nbdkit-tmpdisk-plugin nbdkit-tmpdisk-plugin(aarch-64)"
RDEPENDS:${PN} += "e2fsprogs ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) nbdkit-server util-linux"
