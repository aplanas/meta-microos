...
RPROVIDES:${PN} += "ghc-auto-update-devel ghc-auto-update-devel(aarch-64) ghc-devel(auto-update-0.1.6-CObek7rRQnGB5D6p02bNzQ)"
RDEPENDS:${PN} += "/bin/sh ghc-auto-update ghc-compiler ghc-devel(base-4.17.1.0)"
