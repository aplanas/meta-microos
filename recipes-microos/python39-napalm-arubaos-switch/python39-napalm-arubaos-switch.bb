...
RPROVIDES:${PN} += "python3.9dist(napalm-arubaos-switch) python39-napalm-arubaos-switch python3dist(napalm-arubaos-switch)"
RDEPENDS:${PN} += "python(abi) python39-napalm python39-netaddr python39-requests python39-requests-toolbelt python39-textfsm"
