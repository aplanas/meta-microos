...
RPROVIDES:${PN} += "tex(dfgpdata.sty) tex(dfgproposal.cls) tex(dfgreporting.cls) tex(eupdata.sty) tex(euproposal.cls) tex(eureporting.cls) tex(pdata.sty) tex(proposal.cls) tex(reporting.cls) texlive-proposal"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amssymb.sty) tex(array.sty) tex(babel.sty) tex(biblatex.sty) tex(boxedminipage.sty) tex(chngcntr.sty) tex(colortbl.sty) tex(comment.sty) tex(csquotes.sty) tex(ed.sty) tex(eurosym.sty) tex(fancyhdr.sty) tex(geometry.sty) tex(gitinfo2.sty) tex(graphicx.sty) tex(helvet.sty) tex(longtable.sty) tex(mdframed.sty) tex(paralist.sty) tex(rotating.sty) tex(svninfo.sty) tex(textcomp.sty) tex(tikz.sty) tex(url.sty) tex(wasysym.sty) tex(wrapfig.sty) tex(xcolor.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
