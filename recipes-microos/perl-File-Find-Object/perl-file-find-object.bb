...
RPROVIDES:${PN} += "perl(File::Find::Object) perl(File::Find::Object::Base) perl(File::Find::Object::DeepPath) perl(File::Find::Object::PathComp) perl(File::Find::Object::Result) perl(File::Find::Object::TopPath) perl-File-Find-Object"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Class::XSAccessor) perl(parent)"
