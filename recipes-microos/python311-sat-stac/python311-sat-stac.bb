...
RPROVIDES:${PN} += "python3.11dist(sat-stac) python311-sat-stac python3dist(sat-stac)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-python-dateutil python311-requests update-alternatives"
