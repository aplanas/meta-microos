...
RPROVIDES:${PN} += "ruby3.2-rubygem-json ruby3.2-rubygem-json(aarch-64) rubygem(json) rubygem(ruby:3.2.0:json) rubygem(ruby:3.2.0:json:2) rubygem(ruby:3.2.0:json:2.6) rubygem(ruby:3.2.0:json:2.6.3)"
