...
RPROVIDES:${PN} += "gdbm-devel gdbm-devel(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgdbm.so.6()(64bit) libgdbm6 libgdbm_compat4 libreadline.so.8()(64bit)"
