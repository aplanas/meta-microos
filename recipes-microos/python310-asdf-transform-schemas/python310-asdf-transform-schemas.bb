...
RPROVIDES:${PN} += "python3-asdf-transform-schemas python3-asdf_transform_schemas python3.10dist(asdf-transform-schemas) python310-asdf-transform-schemas python310-asdf_transform_schemas python3dist(asdf-transform-schemas)"
RDEPENDS:${PN} += "python(abi) python310-asdf-standard"
