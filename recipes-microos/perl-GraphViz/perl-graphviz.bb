...
RPROVIDES:${PN} += "perl(DB) perl(Devel::GraphVizProf) perl(GraphViz) perl(GraphViz::Data::Grapher) perl(GraphViz::No) perl(GraphViz::Parse::RecDescent) perl(GraphViz::Parse::Yacc) perl(GraphViz::Parse::Yapp) perl(GraphViz::Regex) perl(GraphViz::Small) perl(GraphViz::XML) perl-GraphViz"
RDEPENDS:${PN} += "cairo graphviz graphviz-gnome pango perl(:MODULE_COMPAT_5.36.0) perl(File::Which) perl(IPC::Run) perl(LWP::Simple) perl(Parse::RecDescent) perl(XML::Twig) perl(XML::XPath)"
