...
RPROVIDES:${PN} += "ocr_1_0_1-gnu-openmpi3-hpc-devel ocr_1_0_1-gnu-openmpi3-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "gnu-compilers-hpc-devel ocr_1_0_1-gnu-openmpi3-hpc openmpi3-gnu-hpc-devel"
