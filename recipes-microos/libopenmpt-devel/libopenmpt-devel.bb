...
RPROVIDES:${PN} += "libopenmpt-devel libopenmpt-devel(aarch-64) pkgconfig(libopenmpt)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libopenmpt0 pkgconfig(libmpg123) pkgconfig(ogg) pkgconfig(vorbis) pkgconfig(vorbisfile) pkgconfig(zlib)"
