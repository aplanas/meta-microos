...
RPROVIDES:${PN} += "typelib(Qrtr) typelib-1_0-Qrtr-1_0 typelib-1_0-Qrtr-1_0(aarch-64)"
RDEPENDS:${PN} += "libqrtr-glib.so.0()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
