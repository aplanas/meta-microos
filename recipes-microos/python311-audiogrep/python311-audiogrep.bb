...
RPROVIDES:${PN} += "python3.11dist(audiogrep) python311-audiogrep python3dist(audiogrep)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 ffmpeg pocketsphinx python(abi) python311-pydub update-alternatives"
