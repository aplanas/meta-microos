...
RPROVIDES:${PN} += "perl(File::ShareDir::ProjectDistDir) perl-File-ShareDir-ProjectDistDir"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(File::ShareDir) perl(Path::FindDev) perl(Path::IsDev) perl(Path::Tiny) perl(Sub::Exporter)"
