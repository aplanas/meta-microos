...
RPROVIDES:${PN} += "tex(nbaseprt.sty) tex(numprint.sty) tex(numprint032.sty) texlive-numprint"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(calc.sty) tex(ifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
