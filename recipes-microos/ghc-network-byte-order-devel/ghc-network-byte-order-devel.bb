...
RPROVIDES:${PN} += "ghc-devel(network-byte-order-0.1.6-9jNlcwvZjC3K8A2S0a4vrO) ghc-network-byte-order-devel ghc-network-byte-order-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-network-byte-order"
