...
RPROVIDES:${PN} += "tex(soulpos.sty) texlive-soulpos"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(keyval.sty) tex(soulutf8.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-oberdiek texlive-scripts texlive-scripts-bin texlive-soul"
