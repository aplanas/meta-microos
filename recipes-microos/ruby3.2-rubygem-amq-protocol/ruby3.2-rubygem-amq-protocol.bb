...
RPROVIDES:${PN} += "ruby3.2-rubygem-amq-protocol ruby3.2-rubygem-amq-protocol(aarch-64) rubygem(amq-protocol) rubygem(ruby:3.2.0:amq-protocol) rubygem(ruby:3.2.0:amq-protocol:2) rubygem(ruby:3.2.0:amq-protocol:2.3) rubygem(ruby:3.2.0:amq-protocol:2.3.2)"
RDEPENDS:${PN} += "/usr/bin/env /usr/bin/ruby.ruby3.2 ruby(abi)"
