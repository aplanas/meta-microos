...
RPROVIDES:${PN} += "tex(textgreek.sty) texlive-textgreek"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-greek-fontenc texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
