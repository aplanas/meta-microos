...
RPROVIDES:${PN} += "ghc-devel(edit-distance-0.2.2.1-6sqaVuKvJlk4f2SjC0p5nu) ghc-edit-distance-devel ghc-edit-distance-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(random-1.2.1.1-I0wUgAAbf0g3qHR3e8uT0o) ghc-edit-distance"
