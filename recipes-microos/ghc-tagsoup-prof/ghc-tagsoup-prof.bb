...
RPROVIDES:${PN} += "ghc-prof(tagsoup-0.14.8-KqOLe3dJpuA4KsHZJW2cTn) ghc-tagsoup-prof ghc-tagsoup-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(containers-0.6.7) ghc-prof(text-2.0.2) ghc-tagsoup-devel"
