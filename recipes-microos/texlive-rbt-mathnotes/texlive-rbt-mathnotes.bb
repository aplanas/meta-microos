...
RPROVIDES:${PN} += "tex(rbt-mathnotes-formula-sheet.cls) tex(rbt-mathnotes-hw.cls) tex(rbt-mathnotes-messages.sty) tex(rbt-mathnotes-util.sty) tex(rbt-mathnotes.cls) tex(rbt-mathnotes.sty) texlive-rbt-mathnotes"
