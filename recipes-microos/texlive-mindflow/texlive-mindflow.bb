...
RPROVIDES:${PN} += "tex(mindflow.sty) texlive-mindflow"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(kvoptions.sty) tex(lineno.sty) tex(nowidow.sty) tex(tcolorbox.sty) tex(verbatim.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
