...
RPROVIDES:${PN} += "python311-matplotlib-qt-shared python311-matplotlib-qt5 python311-matplotlib-qt5(aarch-64)"
RDEPENDS:${PN} += "python(abi) python311-matplotlib python311-qt5"
