...
RPROVIDES:${PN} += "liballegro_dialog5_2-devel liballegro_dialog5_2-devel(aarch-64) pkgconfig(allegro_dialog-5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liballegro_dialog5_2 pkgconfig(allegro-5)"
