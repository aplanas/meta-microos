...
RPROVIDES:${PN} += "python3-ssdeep python3.10dist(ssdeep) python310-ssdeep python310-ssdeep(aarch-64) python3dist(ssdeep)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libfuzzy.so.2()(64bit) python(abi) python310-cffi ssdeep"
