...
RPROVIDES:${PN} += "python3.11dist(blockdiag) python311-blockdiag python3dist(blockdiag)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Pillow python311-funcparserlib python311-setuptools python311-webcolors update-alternatives"
