...
RPROVIDES:${PN} += "python3-setuptools-git-versioning python3-setuptools_git_versioning python3.10dist(setuptools-git-versioning) python310-setuptools-git-versioning python310-setuptools_git_versioning python3dist(setuptools-git-versioning)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 git-core python(abi) python310-Deprecated python310-packaging python310-setuptools python310-toml update-alternatives"
