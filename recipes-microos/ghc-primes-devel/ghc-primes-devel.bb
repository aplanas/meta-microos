...
RPROVIDES:${PN} += "ghc-devel(primes-0.2.1.0-EDehUtw1pOPPL7EktYCRg) ghc-primes-devel ghc-primes-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-primes"
