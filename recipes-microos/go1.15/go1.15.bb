...
RPROVIDES:${PN} += "config(go1.15) go go-devel go-devel-static go1.15 go1.15(aarch-64) golang(API) libstd.so()(64bit)"
RDEPENDS:${PN} += "/bin/bash /bin/sh binutils-gold gcc libc.so.6(GLIBC_2.34)(64bit) update-alternatives"
