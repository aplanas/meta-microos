...
RPROVIDES:${PN} += "tex(tablvar.sty) texlive-tablvar"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(colortbl.sty) tex(ifthen.sty) tex(multido.sty) tex(pst-node.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
