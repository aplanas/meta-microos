...
RPROVIDES:${PN} += "python3-azure-keyvault-certificates python3.10dist(azure-keyvault-certificates) python310-azure-keyvault-certificates python3dist(azure-keyvault-certificates)"
