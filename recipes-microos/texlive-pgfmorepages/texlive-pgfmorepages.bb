...
RPROVIDES:${PN} += "tex(pgfmorepages.sty) tex(pgfmorepageslayouts.code.tex) texlive-pgfmorepages"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(pgfcore.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
