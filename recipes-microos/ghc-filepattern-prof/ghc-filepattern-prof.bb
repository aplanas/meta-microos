...
RPROVIDES:${PN} += "ghc-filepattern-prof ghc-filepattern-prof(aarch-64) ghc-prof(filepattern-0.1.3-CFBsL0RN2YG3tR2tZTKdgo)"
RDEPENDS:${PN} += "ghc-filepattern-devel ghc-prof(base-4.17.1.0) ghc-prof(directory-1.3.7.1) ghc-prof(extra-1.7.13-CLIQu72ADU8JHmf7UWoQG4) ghc-prof(filepath-1.4.2.2)"
