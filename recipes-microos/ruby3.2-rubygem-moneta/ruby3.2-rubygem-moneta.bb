...
RPROVIDES:${PN} += "ruby3.2-rubygem-moneta ruby3.2-rubygem-moneta(aarch-64) rubygem(moneta) rubygem(ruby:3.2.0:moneta) rubygem(ruby:3.2.0:moneta:1) rubygem(ruby:3.2.0:moneta:1.5) rubygem(ruby:3.2.0:moneta:1.5.2)"
