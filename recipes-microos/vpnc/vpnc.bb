...
RPROVIDES:${PN} += "config(vpnc) vpnc vpnc(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /sbin/ip /usr/bin/perl /usr/bin/sed ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgcrypt.so.20()(64bit) libgcrypt.so.20(GCRYPT_1.6)(64bit) libgnutls.so.30()(64bit) libgnutls.so.30(GNUTLS_3_4)(64bit)"
