...
RPROVIDES:${PN} += "mutt-ics mutt_ics python3-mutt-ics python3.10dist(mutt-ics) python310-mutt-ics python3dist(mutt-ics)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-icalendar python310-setuptools update-alternatives"
