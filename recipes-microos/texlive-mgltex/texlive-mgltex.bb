...
RPROVIDES:${PN} += "mathgl-tex tex(mgltex.sty) texlive-mgltex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(ifpdf.sty) tex(keyval.sty) tex(verbatim.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
