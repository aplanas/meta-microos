...
RPROVIDES:${PN} += "python-qtwebengine-qt5-sip python311-qtwebengine-qt5-api python311-qtwebengine-qt5-devel python311-qtwebengine-qt5-devel(aarch-64) python311-qtwebengine-qt5-sip"
