...
RPROVIDES:${PN} += "pkgconfig(spread-sheet-widget) spread-sheet-widget-devel spread-sheet-widget-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libspread-sheet-widget0 pkgconfig(glib-2.0) pkgconfig(gtk+-3.0)"
