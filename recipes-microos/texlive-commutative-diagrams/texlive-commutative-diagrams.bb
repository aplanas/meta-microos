...
RPROVIDES:${PN} += "tex(commutative-diagrams.sty) tex(commutative-diagrams.tex) tex(kodi.sty) tex(t-commutative-diagrams.tex) tex(tikzlibrarycommutative-diagrams.bapto.code.tex) tex(tikzlibrarycommutative-diagrams.code.tex) tex(tikzlibrarycommutative-diagrams.diorthono.code.tex) tex(tikzlibrarycommutative-diagrams.ektropi.code.tex) tex(tikzlibrarycommutative-diagrams.katharizo.code.tex) tex(tikzlibrarycommutative-diagrams.koinos.code.tex) tex(tikzlibrarycommutative-diagrams.mandyas.code.tex) tex(tikzlibrarycommutative-diagrams.mitra.code.tex) tex(tikzlibrarycommutative-diagrams.ozos.code.tex) tex(tikzlibrarycommutative-diagrams.ramma.code.tex) tex(tikzlibrarycommutative-diagrams.velos.code.tex) texlive-commutative-diagrams"
