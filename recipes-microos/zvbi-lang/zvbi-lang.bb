...
RPROVIDES:${PN} += "locale(zvbi:de) locale(zvbi:en@boldquot) locale(zvbi:en@quot) locale(zvbi:es) locale(zvbi:fr) locale(zvbi:it) locale(zvbi:ka) locale(zvbi:nl) locale(zvbi:pl) zvbi-lang zvbi-lang-all"
RDEPENDS:${PN} += "zvbi"
