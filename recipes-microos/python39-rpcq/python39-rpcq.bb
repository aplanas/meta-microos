...
RPROVIDES:${PN} += "python3.9dist(rpcq) python39-rpcq python3dist(rpcq)"
RDEPENDS:${PN} += "python(abi) python39-msgpack python39-python-rapidjson python39-pyzmq python39-ruamel.yaml"
