...
RPROVIDES:${PN} += "application() application(org.opensuse.yast.NFS.desktop) metainfo() metainfo(org.opensuse.yast.NFS.metainfo.xml) yast2-config-network:/usr/lib/YaST2/clients/lan_nfs_client.ycp yast2-config-nfs yast2-config-nfs-devel yast2-nfs-client yast2-trans-nfs"
RDEPENDS:${PN} += "/usr/bin/killall yast2 yast2-nfs-common yast2-ruby-bindings yast2-storage-ng"
