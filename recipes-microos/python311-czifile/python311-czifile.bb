...
RPROVIDES:${PN} += "python3.11dist(czifile) python311-czifile python3dist(czifile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-imagecodecs python311-numpy python311-scipy python311-tifffile update-alternatives"
