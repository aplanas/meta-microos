...
RPROVIDES:${PN} += "fftw-devel fftw3_3_3_10-gnu-openmpi4-hpc-devel fftw3_3_3_10-gnu-openmpi4-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh glibc-devel gnu-compilers-hpc-devel ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libfftw3_3_3_10-gnu-openmpi4-hpc libgomp.so.1()(64bit) libgomp.so.1(GOMP_4.0)(64bit) libgomp.so.1(OMP_1.0)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) openmpi4-gnu-hpc-devel"
