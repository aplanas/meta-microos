...
RPROVIDES:${PN} += "libodfgen-devel libodfgen-devel(aarch-64) pkgconfig(libodfgen-0.1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libodfgen-0_1-1 libstdc++-devel pkgconfig(librevenge-0.0) pkgconfig(librevenge-stream-0.0)"
