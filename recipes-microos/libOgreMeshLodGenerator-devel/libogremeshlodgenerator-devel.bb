...
RPROVIDES:${PN} += "libOgreMeshLodGenerator-devel libOgreMeshLodGenerator-devel(aarch-64) pkgconfig(OGRE-MeshLodGenerator)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libOgreMeshLodGenerator13_5 pkgconfig(OGRE)"
