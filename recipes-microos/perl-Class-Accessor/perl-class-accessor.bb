...
RPM_NAME = "perl-Class-Accessor-0.51-1.20.noarch.rpm"
...
RPROVIDES:${PN} += "perl(Class::Accessor) perl(Class::Accessor::Fast) perl(Class::Accessor::Faster) perl-Class-Accessor"
