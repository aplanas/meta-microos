...
RPROVIDES:${PN} += "mvn(org.mybatis:mybatis-parent:pom:) mybatis-parent"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.felix:maven-bundle-plugin) mvn(org.apache.maven.plugins:maven-jar-plugin) mvn(org.apache.maven.wagon:wagon-ssh)"
