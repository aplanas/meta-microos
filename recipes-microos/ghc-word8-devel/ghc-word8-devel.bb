...
RPROVIDES:${PN} += "ghc-devel(word8-0.1.3-9uGjviso2af8K0EP8UmxRD) ghc-word8-devel ghc-word8-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-word8"
