...
RPROVIDES:${PN} += "ruby3.2-rubygem-temple ruby3.2-rubygem-temple(aarch-64) rubygem(ruby:3.2.0:temple) rubygem(ruby:3.2.0:temple:0) rubygem(ruby:3.2.0:temple:0.10) rubygem(ruby:3.2.0:temple:0.10.0) rubygem(temple)"
