...
RPROVIDES:${PN} += "tex(mdputu.sty) tex(mdputubi7t.tfm) tex(mdputubi7t.vf) tex(mdputubi8t.tfm) tex(mdputubi8t.vf) tex(mdputuri7t.tfm) tex(mdputuri7t.vf) tex(mdputuri8t.tfm) tex(mdputuri8t.vf) tex(ot1mdputu.fd) tex(t1mdputu.fd) texlive-mdputu"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(mdputb7t.tfm) tex(mdputb8t.tfm) tex(mdputbi7t.tfm) tex(mdputbi8t.tfm) tex(mdputr7t.tfm) tex(mdputr8t.tfm) tex(mdputri7t.tfm) tex(mdputri8t.tfm) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
