...
RPROVIDES:${PN} += "lua-moonscript lua54-moonscript"
RDEPENDS:${PN} += "/bin/sh /usr/bin/lua5.4 lua54 lua54-alt-getopt lua54-argparse lua54-loadkit lua54-lpeg lua54-luafilesystem update-alternatives"
