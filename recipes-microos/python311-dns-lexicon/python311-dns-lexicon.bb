...
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyYAML python311-beautifulsoup4 python311-cryptography python311-importlib-metadata python311-requests python311-tldextract update-alternatives"
