...
RPROVIDES:${PN} += "tex(pgfmolbio.chromatogram.tex) tex(pgfmolbio.convert.tex) tex(pgfmolbio.domains.tex) tex(pgfmolbio.sty) texlive-pgfmolbio"
RDEPENDS:${PN} += "/bin/sh /usr/bin/luatex coreutils ed findutils grep sed tex(ifluatex.sty) tex(luatexbase-modutils.sty) tex(tikz.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
