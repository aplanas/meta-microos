...
RPROVIDES:${PN} += "tex(ot1skt.fd) tex(skt.sty) tex(skt10.tfm) tex(skt8.tfm) tex(skt9.tfm) tex(sktb10.tfm) tex(sktbs10.tfm) tex(sktf10.tfm) tex(sktfs10.tfm) tex(skts10.tfm) texlive-sanskrit"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifthen.sty) tex(relsize.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
