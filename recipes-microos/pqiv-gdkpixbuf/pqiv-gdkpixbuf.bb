...
RPROVIDES:${PN} += "pqiv-gdkpixbuf pqiv-gdkpixbuf(aarch-64)"
RDEPENDS:${PN} += "libcairo.so.2()(64bit) libgdk-3.so.0()(64bit) libgdk_pixbuf-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) pqiv"
