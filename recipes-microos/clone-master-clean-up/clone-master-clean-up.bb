...
RPROVIDES:${PN} += "clone-master-clean-up config(clone-master-clean-up)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/mkdir /usr/bin/touch coreutils curl fillup sed systemd"
