...
RPROVIDES:${PN} += "ghc-disk-free-space-prof ghc-disk-free-space-prof(aarch-64) ghc-prof(disk-free-space-0.1.0.1-CGtWAgWYeLt876pNI1pHoX)"
RDEPENDS:${PN} += "ghc-disk-free-space-devel ghc-prof(base-4.17.1.0)"
