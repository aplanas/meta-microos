...
RPROVIDES:${PN} += "perl(Passwd::Keyring::KDEWallet) perl-Passwd-Keyring-KDEWallet"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(File::ShareDir) perl(Net::DBus) perl(Proc::SyncExec) perl(Try::Tiny)"
