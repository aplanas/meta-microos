...
RPROVIDES:${PN} += "python3-azure-mgmt-servicelinker python3.10dist(azure-mgmt-servicelinker) python310-azure-mgmt-servicelinker python3dist(azure-mgmt-servicelinker)"
