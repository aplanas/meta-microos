...
RPROVIDES:${PN} += "mariadb-java-client mariadb-java-client(aarch-64) mvn(mariadb:mariadb-connector-java) mvn(mariadb:mariadb-connector-java:pom:) mvn(org.mariadb.jdbc:mariadb-java-client) mvn(org.mariadb.jdbc:mariadb-java-client:pom:) osgi(org.mariadb.jdbc)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mariadb"
