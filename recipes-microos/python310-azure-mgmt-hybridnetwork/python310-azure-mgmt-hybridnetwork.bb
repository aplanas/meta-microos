...
RPROVIDES:${PN} += "python3-azure-mgmt-hybridnetwork python3.10dist(azure-mgmt-hybridnetwork) python310-azure-mgmt-hybridnetwork python3dist(azure-mgmt-hybridnetwork)"
