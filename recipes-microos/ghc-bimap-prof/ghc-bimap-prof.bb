...
RPROVIDES:${PN} += "ghc-bimap-prof ghc-bimap-prof(aarch-64) ghc-prof(bimap-0.5.0-3nKyJuRybYg2I5XOsBhwKE)"
RDEPENDS:${PN} += "ghc-bimap-devel ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(deepseq-1.4.8.0) ghc-prof(exceptions-0.10.5)"
