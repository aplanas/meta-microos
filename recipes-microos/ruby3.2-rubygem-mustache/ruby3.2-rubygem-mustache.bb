...
RPROVIDES:${PN} += "ruby3.2-rubygem-mustache ruby3.2-rubygem-mustache(aarch-64) rubygem(mustache) rubygem(ruby:3.2.0:mustache) rubygem(ruby:3.2.0:mustache:1) rubygem(ruby:3.2.0:mustache:1.1) rubygem(ruby:3.2.0:mustache:1.1.1)"
