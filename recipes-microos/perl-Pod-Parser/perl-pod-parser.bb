...
RPROVIDES:${PN} += "perl(Pod::Cache) perl(Pod::Cache::Item) perl(Pod::Find) perl(Pod::Hyperlink) perl(Pod::InputObjects) perl(Pod::InputSource) perl(Pod::InteriorSequence) perl(Pod::List) perl(Pod::Paragraph) perl(Pod::ParseTree) perl(Pod::ParseUtils) perl(Pod::Parser) perl(Pod::PlainText) perl(Pod::Select) perl-Pod-Parser"
