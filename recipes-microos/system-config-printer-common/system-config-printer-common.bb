...
RDEPENDS:${PN} += "/usr/bin/python3 dbus-1-python3 python3-cairo python3-cups python3-cupshelpers python3-gobject python3-gobject-Gdk python3-smbc typelib(GLib) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gtk) typelib(Handy) typelib(Notify) typelib(PackageKitGlib) typelib(Pango) typelib(Polkit) typelib(Secret)"
