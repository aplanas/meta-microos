...
RPROVIDES:${PN} += "perl(MooseX::Types::LoadableClass) perl-MooseX-Types-LoadableClass"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Module::Runtime) perl(MooseX::Types) perl(MooseX::Types::Moose) perl(namespace::autoclean)"
