...
RPROVIDES:${PN} += "typelib(Signon) typelib-1_0-Signon-2_0 typelib-1_0-Signon-2_0(aarch-64)"
RDEPENDS:${PN} += "libsignon-glib.so.2()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
