...
RPROVIDES:${PN} += "config(vm-install) vm-install vm-install(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 kdump python(abi) python3-dbus-python python3-libvirt-python python3-libxml2-python python3-netifaces python3-pycurl qemu-tools tftp(client) usbutils"
