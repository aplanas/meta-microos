...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-desktop-books patterns-desktop-books(aarch-64) patterns-openSUSE-books"
RDEPENDS:${PN} += ""
