...
RPROVIDES:${PN} += "fbiterm fbiterm(aarch-64) locale(ja;ko;zh)"
RDEPENDS:${PN} += "group(tty) ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libXfont.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) libiterm.so.1()(64bit)"
