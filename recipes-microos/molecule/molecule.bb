...
RDEPENDS:${PN} += "/usr/bin/python3.10 ansible-core python(abi) python3-Jinja2 python3-PyYAML python3-ansible-compat python3-base python3-click python3-click-help-colors python3-cookiecutter python3-enrich python3-jsonschema python3-packaging python3-pluggy python3-rich"
