...
RPROVIDES:${PN} += "ghc-code-page-prof ghc-code-page-prof(aarch-64) ghc-prof(code-page-0.2.1-DXkPgctk3OAKMpgAjUBS3D)"
RDEPENDS:${PN} += "ghc-code-page-devel ghc-prof(base-4.17.1.0)"
