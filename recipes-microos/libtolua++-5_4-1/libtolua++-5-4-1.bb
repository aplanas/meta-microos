...
RPROVIDES:${PN} += "libtolua++-5.4.so.1()(64bit) libtolua++-5_4-1 libtolua++-5_4-1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) liblua5.4.so.5()(64bit) libm.so.6()(64bit)"
