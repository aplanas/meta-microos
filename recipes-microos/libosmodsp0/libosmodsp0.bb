...
RPROVIDES:${PN} += "libosmodsp.so.0()(64bit) libosmodsp0 libosmodsp0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libfftw3f.so.3()(64bit)"
