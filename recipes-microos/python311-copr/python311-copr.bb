...
RPROVIDES:${PN} += "python3.11dist(copr) python311-copr python3dist(copr)"
RDEPENDS:${PN} += "python(abi) python311-marshmallow python311-munch python311-requests python311-requests-toolbelt"
