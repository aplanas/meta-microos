...
application(tuxguitar.desktop) \
libtuxguitar-alsa-jni.so()(64bit) \
libtuxguitar-fluidsynth-jni.so()(64bit) \
libtuxguitar-jack-jni.so()(64bit) \
libtuxguitar-oss-jni.so()(64bit) \
mimehandler(audio/midi) \
mimehandler(audio/x-gtp) \
mimehandler(audio/x-ptb) \
mimehandler(audio/x-tuxguitar) \
