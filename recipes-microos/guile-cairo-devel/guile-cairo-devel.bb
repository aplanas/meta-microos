...
RPROVIDES:${PN} += "guile-cairo-devel guile-cairo-devel(aarch-64) pkgconfig(guile-cairo)"
RDEPENDS:${PN} += "/usr/bin/pkg-config cairo-devel guile-cairo guile-devel pkgconfig(cairo) pkgconfig(guile-3.0)"
