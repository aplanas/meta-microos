...
RPROVIDES:${PN} += "ghc-asn1-types-devel ghc-asn1-types-devel(aarch-64) ghc-devel(asn1-types-0.3.4-GYlFjiH4jmgJII5TgUQfXm)"
RDEPENDS:${PN} += "/bin/sh ghc-asn1-types ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(hourglass-0.2.12-3PFbUFQLMNb8Ad2s9SU5p3) ghc-devel(memory-0.18.0-2DG6nqjfLMK4MSR77XYQqL)"
