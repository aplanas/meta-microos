...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-kde-kde_multimedia patterns-openSUSE-kde4_multimedia patterns-openSUSE-kde_multimedia"
RDEPENDS:${PN} += ""
