...
RPROVIDES:${PN} += "typelib(LibvirtSandbox) typelib-1_0-LibvirtSandbox-1_0 typelib-1_0-LibvirtSandbox-1_0(aarch-64)"
RDEPENDS:${PN} += "libvirt-sandbox-1.0.so.5()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(LibvirtGConfig) typelib(LibvirtGLib) typelib(LibvirtGObject) typelib(libxml2)"
