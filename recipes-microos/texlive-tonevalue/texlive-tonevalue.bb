...
RPROVIDES:${PN} += "tex(tonevalue.sty) texlive-tonevalue"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(contour.sty) tex(etoolbox.sty) tex(listofitems.sty) tex(tikz.sty) tex(xcolor.sty) tex(xkeyval.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
