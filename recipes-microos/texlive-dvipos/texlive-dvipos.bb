...
RPROVIDES:${PN} += "man(dvipos.1) texlive-dvipos"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-dvipos-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
