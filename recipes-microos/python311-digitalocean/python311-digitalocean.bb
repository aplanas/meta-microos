...
RPROVIDES:${PN} += "python3.11dist(python-digitalocean) python311-digitalocean python3dist(python-digitalocean)"
RDEPENDS:${PN} += "python(abi) python311-jsonpickle python311-pytest python311-requests python311-responses"
