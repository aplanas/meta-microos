...
RPROVIDES:${PN} += "python3.9dist(openai) python39-openai python3dist(openai)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-aiohttp python39-requests python39-tqdm update-alternatives"
