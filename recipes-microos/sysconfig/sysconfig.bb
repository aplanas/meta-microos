...
RPROVIDES:${PN} += "config(sysconfig) sysconfig sysconfig(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /sbin/ldconfig /usr/bin/chmod /usr/bin/grep /usr/bin/mkdir /usr/bin/touch fillup"
