...
RPROVIDES:${PN} += "ruby3.2-rubygem-bcrypt ruby3.2-rubygem-bcrypt(aarch-64) rubygem(bcrypt) rubygem(ruby:3.2.0:bcrypt) rubygem(ruby:3.2.0:bcrypt:3) rubygem(ruby:3.2.0:bcrypt:3.1) rubygem(ruby:3.2.0:bcrypt:3.1.18)"
