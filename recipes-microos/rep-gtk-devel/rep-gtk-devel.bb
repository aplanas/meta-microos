...
RPROVIDES:${PN} += "pkgconfig(rep-gtk) rep-gtk-devel rep-gtk-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config pkgconfig(gdk-pixbuf-2.0) pkgconfig(gtk+-2.0) pkgconfig(librep) rep-gtk"
