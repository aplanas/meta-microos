...
RPROVIDES:${PN} += "python3.9dist(azure-schemaregistry-avroserializer) python39-azure-schemaregistry-avroserializer python3dist(azure-schemaregistry-avroserializer)"
RDEPENDS:${PN} += "python(abi) python39-avro python39-azure-core python39-azure-nspkg python39-azure-schemaregistry python39-msrest"
