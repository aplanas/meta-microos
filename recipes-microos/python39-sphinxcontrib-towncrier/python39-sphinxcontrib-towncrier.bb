...
RPROVIDES:${PN} += "python3.9dist(sphinxcontrib-towncrier) python39-sphinxcontrib-towncrier python3dist(sphinxcontrib-towncrier)"
RDEPENDS:${PN} += "python(abi) python39-Sphinx python39-towncrier"
