...
RPROVIDES:${PN} += "ruby3.2-rubygem-rspec-mocks-3_5 ruby3.2-rubygem-rspec-mocks-3_5(aarch-64) rubygem(rspec-mocks) rubygem(ruby:3.2.0:rspec-mocks) rubygem(ruby:3.2.0:rspec-mocks:3) rubygem(ruby:3.2.0:rspec-mocks:3.5) rubygem(ruby:3.2.0:rspec-mocks:3.5.0)"
