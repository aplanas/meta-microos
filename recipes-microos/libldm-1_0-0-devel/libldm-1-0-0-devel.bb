...
RPROVIDES:${PN} += "libldm-1_0-0-devel libldm-1_0-0-devel(aarch-64) pkgconfig(ldm-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libldm-1_0-0 pkgconfig(devmapper) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(json-glib-1.0)"
