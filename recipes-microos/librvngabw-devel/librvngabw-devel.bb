...
RPROVIDES:${PN} += "librvngabw-devel librvngabw-devel(aarch-64) pkgconfig(librvngabw-0.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config librvngabw-0_0-0 pkgconfig(librevenge-0.0) pkgconfig(librevenge-stream-0.0)"
