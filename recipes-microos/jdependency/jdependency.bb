...
RPROVIDES:${PN} += "jdependency mvn(org.vafer:jdependency) mvn(org.vafer:jdependency:pom:)"
RDEPENDS:${PN} += "apache-commons-io java-headless javapackages-filesystem mvn(commons-io:commons-io) mvn(org.ow2.asm:asm) mvn(org.ow2.asm:asm-analysis) mvn(org.ow2.asm:asm-commons) mvn(org.ow2.asm:asm-tree) mvn(org.ow2.asm:asm-util) objectweb-asm"
