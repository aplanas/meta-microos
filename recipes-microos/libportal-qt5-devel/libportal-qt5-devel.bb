...
RPROVIDES:${PN} += "libportal-qt5-devel libportal-qt5-devel(aarch-64) pkgconfig(libportal-qt5)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libportal-qt5-1 pkgconfig(Qt5Core) pkgconfig(Qt5Gui) pkgconfig(Qt5Widgets) pkgconfig(Qt5X11Extras) pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(libportal)"
