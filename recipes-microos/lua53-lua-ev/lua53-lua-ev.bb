...
RPROVIDES:${PN} += "lua53-lua-ev lua53-lua-ev(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libev.so.4()(64bit) liblua5.3.so.5()(64bit) lua53"
