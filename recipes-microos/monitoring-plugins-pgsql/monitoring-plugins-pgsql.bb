...
RPROVIDES:${PN} += "monitoring-plugins-pgsql monitoring-plugins-pgsql(aarch-64) nagios-plugins-pgsql"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpq.so.5()(64bit)"
