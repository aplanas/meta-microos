...
RPROVIDES:${PN} += "python3.9dist(pudb) python39-pudb python3dist(pudb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Pygments python39-urwid update-alternatives"
