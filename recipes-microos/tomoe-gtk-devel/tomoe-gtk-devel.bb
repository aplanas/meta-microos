...
RPROVIDES:${PN} += "pkgconfig(tomoe-gtk) tomoe-gtk-devel tomoe-gtk-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gucharmap-devel pkgconfig(gtk+-2.0) pkgconfig(tomoe) tomoe-devel tomoe-gtk"
