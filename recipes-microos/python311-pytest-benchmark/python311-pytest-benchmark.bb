...
RPROVIDES:${PN} += "python3.11dist(pytest-benchmark) python311-pytest-benchmark python3dist(pytest-benchmark)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-py-cpuinfo python311-pytest update-alternatives"
