...
RPROVIDES:${PN} += "geany-devel geany-devel(aarch-64) pkgconfig(geany)"
RDEPENDS:${PN} += "/usr/bin/pkg-config geany gtk3-devel libgeany0 pkgconfig(glib-2.0) pkgconfig(gtk+-3.0)"
