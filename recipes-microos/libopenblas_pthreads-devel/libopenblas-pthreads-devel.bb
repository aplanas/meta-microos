...
RPROVIDES:${PN} += "libopenblas_pthreads-devel libopenblas_pthreads-devel(aarch-64) openblas-devel(other)"
RDEPENDS:${PN} += "libopenblas_pthreads0 openblas-common-devel"
