...
RPROVIDES:${PN} += "tex(grid-system.sty) texlive-grid-system"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(environ.sty) tex(forloop.sty) tex(ifthen.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
