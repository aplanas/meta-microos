...
RPROVIDES:${PN} += "python3-nilearn python3.10dist(nilearn) python310-nilearn python3dist(nilearn)"
RDEPENDS:${PN} += "/bin/bash python(abi) python310-joblib python310-matplotlib python310-nibabel python310-numpy python310-requests python310-scikit-learn python310-scipy"
