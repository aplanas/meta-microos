...
RPROVIDES:${PN} += "chemical-mime-data pkgconfig(chemical-mime-data)"
RDEPENDS:${PN} += "/usr/bin/pkg-config hicolor-icon-theme pkgconfig(shared-mime-info) shared-mime-info"
