...
RPROVIDES:${PN} += "python3.9dist(oic) python39-oic python3dist(oic)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Beaker python39-Mako python39-cryptography python39-dbm python39-defusedxml python39-pycryptodomex python39-pyjwkest python39-requests python39-typing python39-typing_extensions"
