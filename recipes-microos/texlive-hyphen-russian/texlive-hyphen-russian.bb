...
RPROVIDES:${PN} += "tex(hyph-ru.t2a.tex) tex(hyph-ru.tex) tex(loadhyph-ru.tex) texlive-hyphen-russian"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(language.dat) tex(language.dat.lua) tex(language.def) texlive texlive-filesystem texlive-hyph-utf8 texlive-hyphen-base texlive-kpathsea texlive-kpathsea-bin texlive-ruhyphen texlive-scripts texlive-scripts-bin"
