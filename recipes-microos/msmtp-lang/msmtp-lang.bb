...
RPROVIDES:${PN} += "locale(msmtp:de) locale(msmtp:eo) locale(msmtp:fr) locale(msmtp:pt_BR) locale(msmtp:sr) locale(msmtp:sv) locale(msmtp:ta) locale(msmtp:uk) msmtp-lang msmtp-lang-all"
RDEPENDS:${PN} += "msmtp"
