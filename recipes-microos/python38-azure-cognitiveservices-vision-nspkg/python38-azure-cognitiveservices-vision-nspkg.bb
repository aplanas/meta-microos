...
RPROVIDES:${PN} += "python3.8dist(azure-cognitiveservices-vision-nspkg) python38-azure-cognitiveservices-vision-nspkg python3dist(azure-cognitiveservices-vision-nspkg)"
