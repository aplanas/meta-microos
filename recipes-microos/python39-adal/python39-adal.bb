...
RPROVIDES:${PN} += "python3.9dist(adal) python39-adal python3dist(adal)"
RDEPENDS:${PN} += "python(abi) python39-PyJWT python39-cryptography python39-python-dateutil python39-requests"
