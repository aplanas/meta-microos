...
RPROVIDES:${PN} += "python3.11dist(nilearn) python311-nilearn python3dist(nilearn)"
RDEPENDS:${PN} += "/bin/bash python(abi) python311-joblib python311-matplotlib python311-nibabel python311-numpy python311-requests python311-scikit-learn python311-scipy"
