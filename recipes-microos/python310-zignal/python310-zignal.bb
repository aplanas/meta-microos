...
RPROVIDES:${PN} += "python3-zignal python3.10dist(zignal) python310-zignal python3dist(zignal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-matplotlib python310-numpy python310-samplerate python310-scipy update-alternatives"
