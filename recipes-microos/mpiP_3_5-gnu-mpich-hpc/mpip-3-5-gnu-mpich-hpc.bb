...
RPROVIDES:${PN} += "mpiP_3_5-gnu-mpich-hpc mpiP_3_5-gnu-mpich-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/perl gnu-compilers-hpc ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libunwind.so.8()(64bit) lua-lmod mpich-gnu-hpc"
