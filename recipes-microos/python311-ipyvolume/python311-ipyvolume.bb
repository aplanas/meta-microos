...
RPM_NAME = "python311-ipyvolume-0.6.1-1.2.noarch.rpm"
RPM_HASH = "8c6e9031fd25c1279c9b9e052c9f798b01e1177c72f0b8e7aaa97e1522ef1c580c8de3cc1af02167d4f13aec81b04caf9ccbfd9d689049269e47bf2b4ac497db"
REPO_ARCH = "noarch"

RPROVIDES:${PN} += "python3.11dist(ipyvolume) python311-ipyvolume python3dist(ipyvolume)"
RDEPENDS:${PN} += "jupyter-ipyvolume python(abi) python311-Pillow python311-bqplot python311-ipyvue python311-ipyvuetify python311-ipywebrtc python311-ipywidgets python311-matplotlib python311-numpy python311-pythreejs python311-requests python311-traitlets python311-traittypes"
