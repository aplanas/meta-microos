...
RPROVIDES:${PN} += "python3.11dist(aina) python311-aina python3dist(aina)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-base python311-click update-alternatives"
