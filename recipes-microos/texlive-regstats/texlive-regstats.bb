...
RPROVIDES:${PN} += "tex(regstats.sty) texlive-regstats"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atveryend.sty) tex(etex.sty) tex(ifluatex.sty) tex(ifpdf.sty) tex(intcalc.sty) tex(kvoptions.sty) tex(ltxcmds.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
