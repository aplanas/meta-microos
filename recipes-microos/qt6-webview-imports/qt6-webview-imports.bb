...
RPROVIDES:${PN} += "libqtwebviewquickplugin.so()(64bit) \
libqtwebviewquickplugin.so(Qt_6)(64bit) \
libqtwebviewquickplugin.so(Qt_6.0)(64bit) \
libqtwebviewquickplugin.so(Qt_6.1)(64bit) \
libqtwebviewquickplugin.so(Qt_6.2)(64bit) \
libqtwebviewquickplugin.so(Qt_6.3)(64bit) \
libqtwebviewquickplugin.so(Qt_6.4)(64bit) \
libqtwebviewquickplugin.so(Qt_6.5)(64bit) \
libqtwebviewquickplugin.so(Qt_6.5.1_PRIVATE_API)(64bit) \
qt6-webview-imports \
qt6-webview-imports(aarch-64) \
