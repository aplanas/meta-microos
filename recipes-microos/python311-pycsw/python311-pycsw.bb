...
RPROVIDES:${PN} += "python3.11dist(pycsw) python311-pycsw python3dist(pycsw)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-OWSLib python311-Shapely python311-geolinks python311-lxml python311-pyproj python311-xmltodict update-alternatives"
