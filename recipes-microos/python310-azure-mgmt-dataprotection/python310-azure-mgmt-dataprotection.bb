...
RPROVIDES:${PN} += "python3-azure-mgmt-dataprotection python3.10dist(azure-mgmt-dataprotection) python310-azure-mgmt-dataprotection python3dist(azure-mgmt-dataprotection)"
