...
RPROVIDES:${PN} += "config(vcontrold) group(vcontrold) user(vcontrold) vcontrold vcontrold(aarch-64)"
RDEPENDS:${PN} += "/bin/sh group(dialout) ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libxml2.so.2()(64bit) libxml2.so.2(LIBXML2_2.4.30)(64bit) libxml2.so.2(LIBXML2_2.6.3)(64bit) sysuser-shadow"
