...
RPROVIDES:${PN} += "python3.11dist(azure-cognitiveservices-vision-nspkg) python311-azure-cognitiveservices-vision-nspkg python3dist(azure-cognitiveservices-vision-nspkg)"
