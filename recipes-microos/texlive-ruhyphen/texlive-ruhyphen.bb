...
RPROVIDES:${PN} += "tex(catkoi.tex) tex(cyryoal.tex) tex(cyryoas.tex) tex(cyryoct.tex) tex(cyryodv.tex) tex(cyryomg.tex) tex(cyryovl.tex) tex(cyryozn.tex) tex(enrhm2.tex) tex(hypht2.tex) tex(koi2koi.tex) tex(koi2lcy.tex) tex(koi2ot2.tex) tex(koi2t2a.tex) tex(koi2ucy.tex) tex(ruenhyph.tex) tex(ruhyphal.tex) tex(ruhyphas.tex) tex(ruhyphct.tex) tex(ruhyphdv.tex) tex(ruhyphen.tex) tex(ruhyphmg.tex) tex(ruhyphvl.tex) tex(ruhyphzn.tex) texlive-ruhyphen"
