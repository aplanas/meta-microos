...
RPROVIDES:${PN} += "python39-qt5-remoteobjects-devel python39-qt5-remoteobjects-devel(aarch-64)"
RDEPENDS:${PN} += "pkgconfig(Qt5RemoteObjects) python(abi) python39-qt5-devel"
