...
RPROVIDES:${PN} += "ghc-crypto-cipher-types-prof ghc-crypto-cipher-types-prof(aarch-64) ghc-prof(crypto-cipher-types-0.0.9-4A4LPNV9DwQ1VQ3vwUnE52)"
RDEPENDS:${PN} += "ghc-crypto-cipher-types-devel ghc-prof(base-4.17.1.0) ghc-prof(byteable-0.1.1-KSaZugJOm4ALb4WyX9cufg) ghc-prof(bytestring-0.11.4.0) ghc-prof(securemem-0.1.10-BbcWu3otOS6JQaPW3JfszZ)"
