...
RPROVIDES:${PN} += "tex(hamnosys.sty) texlive-hamnosys"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontspec.sty) tex(iftex.sty) tex(ifthen.sty) tex(kvoptions.sty) tex(ucharclasses.sty) texlive texlive-filesystem texlive-hamnosys-fonts texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
