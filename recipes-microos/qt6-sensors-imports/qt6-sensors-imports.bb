...
RPROVIDES:${PN} += "libsensorsquickplugin.so()(64bit) libsensorsquickplugin.so(Qt_6)(64bit) libsensorsquickplugin.so(Qt_6.0)(64bit) libsensorsquickplugin.so(Qt_6.1)(64bit) libsensorsquickplugin.so(Qt_6.2)(64bit) libsensorsquickplugin.so(Qt_6.3)(64bit) libsensorsquickplugin.so(Qt_6.4)(64bit) libsensorsquickplugin.so(Qt_6.5)(64bit) libsensorsquickplugin.so(Qt_6.5.1_PRIVATE_API)(64bit) qt6-sensors-imports qt6-sensors-imports(aarch-64)"
