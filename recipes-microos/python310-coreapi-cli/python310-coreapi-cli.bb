...
RPROVIDES:${PN} += "python3-coreapi-cli python3.10dist(coreapi-cli) python310-coreapi-cli python3dist(coreapi-cli)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-click python310-coreapi python310-coreschema python310-itypes python310-requests python310-uritemplate update-alternatives"
