...
RPROVIDES:${PN} += "tex(xecyr.sty) texlive-xecyr"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifluatex.sty) tex(ifxetex.sty) tex(inputenc.sty) tex(luatextra.sty) tex(misccorr.sty) tex(xltxtra.sty) tex(xunicode.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
