...
RPROVIDES:${PN} += "python3.11dist(django-mailman3) python311-django-mailman3 python3dist(django-mailman3)"
RDEPENDS:${PN} += "python(abi) python311-Django python311-django-allauth python311-django-gravatar2 python311-mailmanclient python311-pytz"
