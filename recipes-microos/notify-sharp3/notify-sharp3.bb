...
RPROVIDES:${PN} += "mono(notify-sharp) notify-sharp3"
RDEPENDS:${PN} += "mono(dbus-sharp) mono(dbus-sharp-glib) mono(gdk-sharp) mono(glib-sharp) mono(gtk-sharp) mono(mscorlib)"
