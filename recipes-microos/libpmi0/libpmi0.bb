...
RPROVIDES:${PN} += "libpmi.so.0()(64bit) libpmi0 libpmi0(aarch-64) libpmi2.so.0()(64bit)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libslurm_pmi.so()(64bit)"
