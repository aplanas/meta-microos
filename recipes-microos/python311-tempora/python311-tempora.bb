...
RPROVIDES:${PN} += "python3.11dist(tempora) python311-tempora python3dist(tempora)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 alts python(abi) python311-jaraco.functools python311-pytz"
