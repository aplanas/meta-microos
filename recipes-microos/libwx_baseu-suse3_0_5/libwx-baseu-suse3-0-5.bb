...
libwx_baseu-suse.so.3.0.5(WXU_3.0.1)(64bit) \
libwx_baseu-suse.so.3.0.5(WXU_3.0.2)(64bit) \
libwx_baseu-suse.so.3.0.5(WXU_3.0.3)(64bit) \
libwx_baseu-suse.so.3.0.5(WXU_3.0.4)(64bit) \
libwx_baseu-suse.so.3.0.5(WXU_3.0.5)(64bit) \
