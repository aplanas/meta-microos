...
RPROVIDES:${PN} += "tex(biotex.sty) tex(textopo.def) tex(textopo.sty) texlive-textopo"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.sty) tex(graphics.sty) tex(texshade.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
