...
RPROVIDES:${PN} += "tex(pst-poker.sty) texlive-pst-poker"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(multido.sty) tex(pst-blur.sty) tex(pst-fill.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
