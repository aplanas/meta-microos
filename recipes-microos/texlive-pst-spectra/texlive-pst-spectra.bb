...
RPROVIDES:${PN} += "tex(pst-spectra.sty) tex(pst-spectra.tex) texlive-pst-spectra"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(multido.sty) tex(pstricks.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
