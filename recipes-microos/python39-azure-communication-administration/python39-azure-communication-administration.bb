...
RPROVIDES:${PN} += "python3.9dist(azure-communication-administration) python39-azure-communication-administration python3dist(azure-communication-administration)"
