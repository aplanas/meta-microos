...
RPROVIDES:${PN} += "python3.9dist(txtorcon) python39-txtorcon python3dist(txtorcon)"
RDEPENDS:${PN} += "python(abi) python39-Automat python39-Twisted-tls python39-incremental python39-zope.interface"
