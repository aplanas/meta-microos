...
RPROVIDES:${PN} += "ghc-devel(hourglass-0.2.12-3PFbUFQLMNb8Ad2s9SU5p3) ghc-hourglass-devel ghc-hourglass-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-hourglass"
