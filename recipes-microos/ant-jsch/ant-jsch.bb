...
RPROVIDES:${PN} += "ant-jsch config(ant-jsch) mvn(org.apache.ant:ant-jsch) mvn(org.apache.ant:ant-jsch:pom:)"
RDEPENDS:${PN} += "ant java-headless javapackages-filesystem jsch mvn(com.jcraft:jsch) mvn(org.apache.ant:ant)"
