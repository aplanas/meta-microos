...
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep perl perl(TeXLive::TLUtils) sed tex(texmf.cnf) texlive texlive-filesystem texlive-haranoaji-fonts texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-texlive.infra"
