...
RPROVIDES:${PN} += "locale(reco:ca) locale(reco:es) locale(reco:fr) locale(reco:it) locale(reco:ja) locale(reco:lt) locale(reco:nl) locale(reco:pl) locale(reco:pt) locale(reco:pt_BR) locale(reco:ru) locale(reco:tr) reco-lang reco-lang-all"
RDEPENDS:${PN} += "reco"
