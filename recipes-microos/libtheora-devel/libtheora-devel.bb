...
RPROVIDES:${PN} += "libtheora-devel libtheora-devel(aarch-64) pkgconfig(theora) pkgconfig(theoradec) pkgconfig(theoraenc)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libogg-devel libtheora0 libtheoradec1 libtheoraenc1 pkgconfig(ogg) pkgconfig(theoradec)"
