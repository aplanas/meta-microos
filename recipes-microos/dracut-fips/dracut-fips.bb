...
RPROVIDES:${PN} += "config(dracut-fips) dracut-fips dracut-fips(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh dracut libcryptsetup12-hmac libgcrypt20-hmac libkcapi-tools libopenssl1_1-hmac"
