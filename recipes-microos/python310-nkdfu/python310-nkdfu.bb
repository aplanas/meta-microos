...
RPROVIDES:${PN} += "python3-nkdfu python3.10dist(nkdfu) python310-nkdfu python3dist(nkdfu)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 intelhex python(abi) python310-fire python310-libusb1 python310-tqdm update-alternatives"
