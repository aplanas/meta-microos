...
RPROVIDES:${PN} += "perl(Time::CTime) perl(Time::DaysInMonth) perl(Time::JulianDay) perl(Time::ParseDate) perl(Time::Timezone) perl-Time-modules perl-Time-modules(aarch-64)"
