...
RPROVIDES:${PN} += "python3-file-magic python3-magic python3.10dist(file-magic) python310-file-magic python310-magic python310-magic(aarch-64) python3dist(file-magic)"
