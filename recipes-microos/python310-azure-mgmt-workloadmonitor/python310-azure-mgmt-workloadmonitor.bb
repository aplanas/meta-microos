...
RPROVIDES:${PN} += "python3-azure-mgmt-workloadmonitor python3.10dist(azure-mgmt-workloadmonitor) python310-azure-mgmt-workloadmonitor python3dist(azure-mgmt-workloadmonitor)"
