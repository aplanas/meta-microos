...
RPROVIDES:${PN} += "cluster-glue-devel cluster-glue-devel(aarch-64) libglue-devel"
RDEPENDS:${PN} += "/bin/sh cluster-glue-libs ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libglib-2.0.so.0()(64bit) libpils.so.2()(64bit) libplumb.so.2()(64bit) libstonith.so.1()(64bit)"
