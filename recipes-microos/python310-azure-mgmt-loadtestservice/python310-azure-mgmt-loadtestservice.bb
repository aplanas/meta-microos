...
RPROVIDES:${PN} += "python3-azure-mgmt-loadtestservice python3.10dist(azure-mgmt-loadtestservice) python310-azure-mgmt-loadtestservice python3dist(azure-mgmt-loadtestservice)"
