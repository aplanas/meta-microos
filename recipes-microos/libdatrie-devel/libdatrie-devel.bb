...
RPROVIDES:${PN} += "libdatrie-devel libdatrie-devel(aarch-64) pkgconfig(datrie-0.2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdatrie.so.1()(64bit) libdatrie.so.1(DATRIE_0.2)(64bit) libdatrie1"
