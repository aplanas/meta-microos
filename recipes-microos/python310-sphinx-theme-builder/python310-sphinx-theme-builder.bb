...
RPROVIDES:${PN} += "python3-sphinx-theme-builder python3.10dist(sphinx-theme-builder) python310-sphinx-theme-builder python3dist(sphinx-theme-builder)"
RDEPENDS:${PN} += "(python310-tomli if python310-base < 3.11) /bin/sh /usr/bin/python3.10 python(abi) python310-click python310-nodeenv python310-packaging python310-pyproject-metadata python310-rich python310-setuptools update-alternatives"
