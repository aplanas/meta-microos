...
RPROVIDES:${PN} += "pkgconfig(qoauth) qoauth-qt5-devel qoauth-qt5-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libqoauth2 pkgconfig(Qt5Core) pkgconfig(Qt5Network) pkgconfig(qca2-qt5)"
