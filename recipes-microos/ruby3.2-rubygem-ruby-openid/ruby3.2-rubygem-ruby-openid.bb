...
RPROVIDES:${PN} += "ruby3.2-rubygem-ruby-openid \
ruby3.2-rubygem-ruby-openid(aarch-64) \
rubygem(ruby-openid) \
rubygem(ruby:3.2.0:ruby-openid) \
rubygem(ruby:3.2.0:ruby-openid:2) \
rubygem(ruby:3.2.0:ruby-openid:2.9) \
rubygem(ruby:3.2.0:ruby-openid:2.9.2)"
