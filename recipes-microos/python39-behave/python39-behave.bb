...
RPROVIDES:${PN} += "python3.9dist(behave) python39-behave python3dist(behave)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-parse python39-parse_type python39-six update-alternatives"
