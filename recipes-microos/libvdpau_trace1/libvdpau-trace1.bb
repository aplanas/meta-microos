...
RPROVIDES:${PN} += "libvdpau_trace libvdpau_trace.so.1()(64bit) libvdpau_trace1 libvdpau_trace1(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libvdpau1"
