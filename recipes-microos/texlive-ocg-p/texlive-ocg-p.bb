...
RPROVIDES:${PN} += "tex(ocg-p.sty) texlive-ocg-p"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(datatool.sty) tex(eso-pic.sty) tex(ifpdf.sty) tex(ifxetex.sty) tex(listings.sty) tex(tikz.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
