...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-openSUSE-xfce_laptop patterns-xfce-xfce_laptop patterns-xfce-xfce_laptop(aarch-64)"
RDEPENDS:${PN} += "pattern()"
