...
RPROVIDES:${PN} += "python3.9dist(roifile) python39-roifile python3dist(roifile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-matplotlib python39-numpy python39-tifffile update-alternatives"
