...
RPROVIDES:${PN} += "tex(churchslavonic.sty) tex(cu-calendar.sty) tex(cu-kinovar.sty) tex(cu-num.sty) tex(cu-util.sty) tex(gloss-churchslavonic.ldf) texlive-churchslavonic"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(intcalc.sty) tex(xcolor.sty) texlive texlive-etoolbox texlive-filesystem texlive-fonts-churchslavonic texlive-hyphen-churchslavonic texlive-kpathsea texlive-kpathsea-bin texlive-oberdiek texlive-scripts texlive-scripts-bin texlive-xcolor"
