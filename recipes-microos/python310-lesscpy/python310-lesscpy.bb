...
RPROVIDES:${PN} += "python3-lesscpy python3.10dist(lesscpy) python310-lesscpy python3dist(lesscpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-ply python310-setuptools python310-six update-alternatives"
