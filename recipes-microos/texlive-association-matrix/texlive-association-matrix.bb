...
RPROVIDES:${PN} += "tex(association-matrix.sty) texlive-association-matrix"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(forloop.sty) tex(ifthen.sty) tex(textcomp.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
