...
RPROVIDES:${PN} += "ghc-devel(setenv-0.1.1.3-5NpDWBw9aN36gdxnY8UI9x) ghc-setenv-devel ghc-setenv-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(unix-2.7.3) ghc-setenv"
