...
RPROVIDES:${PN} += "ruby3.2-rubygem-afm ruby3.2-rubygem-afm(aarch-64) rubygem(afm) rubygem(ruby:3.2.0:afm) rubygem(ruby:3.2.0:afm:0) rubygem(ruby:3.2.0:afm:0.2) rubygem(ruby:3.2.0:afm:0.2.2)"
