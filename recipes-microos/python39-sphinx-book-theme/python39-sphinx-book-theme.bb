...
RPROVIDES:${PN} += "python3.9dist(sphinx-book-theme) python39-sphinx-book-theme python3dist(sphinx-book-theme)"
RDEPENDS:${PN} += "python(abi) python39-PyYAML python39-Sphinx python39-beautifulsoup4 python39-click python39-docutils python39-pydata-sphinx-theme"
