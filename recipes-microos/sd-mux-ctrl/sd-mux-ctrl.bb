...
RPROVIDES:${PN} += "sd-mux-ctrl sd-mux-ctrl(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libftdi1.so.2()(64bit) libpopt.so.0()(64bit) libpopt.so.0(LIBPOPT_0)(64bit)"
