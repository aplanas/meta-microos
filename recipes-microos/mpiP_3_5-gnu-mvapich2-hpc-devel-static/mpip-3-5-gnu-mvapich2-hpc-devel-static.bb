...
RPROVIDES:${PN} += "mpiP_3_5-gnu-mvapich2-hpc-devel-static mpiP_3_5-gnu-mvapich2-hpc-devel-static(aarch-64)"
RDEPENDS:${PN} += "gnu-compilers-hpc-devel mvapich2-gnu-hpc-devel"
