...
RPROVIDES:${PN} += "tex(newpax.sty) texlive-newpax"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(auxhook.sty) tex(etoolbox.sty) tex(graphicx.sty) tex(kvoptions.sty) tex(kvsetkeys.sty) tex(ltxcmds.sty) tex(pdfmanagement-testphase.sty) tex(xfp.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
