...
RPROVIDES:${PN} += "tex(create-theorem.sty) texlive-create-theorem"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsfonts.sty) tex(crefthe.sty) texlive texlive-crefthe texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
