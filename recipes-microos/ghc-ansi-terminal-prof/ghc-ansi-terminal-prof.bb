...
RPROVIDES:${PN} += "ghc-ansi-terminal-prof ghc-ansi-terminal-prof(aarch-64) ghc-prof(ansi-terminal-0.11.5-5x0MoHxm5r6DDoyv5djCW3)"
RDEPENDS:${PN} += "ghc-ansi-terminal-devel ghc-prof(ansi-terminal-types-0.11.5-9ffXWswmNhoANlpnF2SnhR) ghc-prof(base-4.17.1.0) ghc-prof(colour-2.3.6-7jQe2xj5Lsa5MbX38iH7Ln)"
