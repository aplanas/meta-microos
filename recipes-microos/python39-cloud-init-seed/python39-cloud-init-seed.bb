...
RPROVIDES:${PN} += "python3.9dist(cloud-init-seed) python39-cloud-init-seed python3dist(cloud-init-seed)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 mkisofs python(abi) update-alternatives"
