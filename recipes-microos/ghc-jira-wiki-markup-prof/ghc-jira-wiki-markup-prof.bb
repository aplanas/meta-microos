...
RPROVIDES:${PN} += "ghc-jira-wiki-markup-prof ghc-jira-wiki-markup-prof(aarch-64) ghc-prof(jira-wiki-markup-1.5.1-7ePG3tP2CY82wODfjMZ5nH)"
RDEPENDS:${PN} += "ghc-jira-wiki-markup-devel ghc-prof(base-4.17.1.0) ghc-prof(mtl-2.2.2) ghc-prof(parsec-3.1.16.1) ghc-prof(text-2.0.2)"
