...
RPROVIDES:${PN} += "libexif-gtk-devel libexif-gtk-devel(aarch-64) pkgconfig(libexif-gtk)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gtk2-devel libexif-devel libexif-gtk pkgconfig(gtk+-2.0) pkgconfig(libexif)"
