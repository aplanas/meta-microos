...
RPROVIDES:${PN} += "libgladeui-2-devel libgladeui-2-devel(aarch-64) pkgconfig(gladeui-2.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgladeui-2-13 pkgconfig(glib-2.0) pkgconfig(gmodule-2.0) pkgconfig(gtk+-3.0) typelib-1_0-Gladeui-2_0"
