...
RPROVIDES:${PN} += "libxfce4util-devel libxfce4util-devel(aarch-64) pkgconfig(libxfce4util-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxfce4util-tools libxfce4util7 pkgconfig(glib-2.0) typelib-1_0-Libxfce4util-1_0"
