...
RPROVIDES:${PN} += "libcacard-devel libcacard-devel(aarch-64) pkgconfig(libcacard)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glib2-devel libcacard0 mozilla-nspr mozilla-nss pkgconfig(glib-2.0) pkgconfig(nss)"
