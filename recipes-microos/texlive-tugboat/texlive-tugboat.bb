...
RPROVIDES:${PN} += "tex(ltugboat.cls) tex(ltugboat.sty) tex(ltugcomn.sty) tex(ltugproc.cls) tex(ltugproc.sty) texlive-tugboat"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(article.cls) tex(mflogo.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
