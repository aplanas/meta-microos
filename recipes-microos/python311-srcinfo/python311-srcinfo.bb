...
RPROVIDES:${PN} += "python3.11dist(srcinfo) python311-srcinfo python3dist(srcinfo)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-parse update-alternatives"
