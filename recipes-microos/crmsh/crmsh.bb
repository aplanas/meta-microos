...
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 /usr/bin/python3.10 /usr/bin/which crmsh-scripts csync2 pacemaker python(abi) python3 python3-PyYAML python3-curses python3-lxml python3-python-dateutil"
