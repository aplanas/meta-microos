...
RPROVIDES:${PN} += "menu-cache-devel menu-cache-devel(aarch-64) pkgconfig(libmenu-cache)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmenu-cache3 menu-cache pkgconfig(glib-2.0) pkgconfig(libfm-extra)"
