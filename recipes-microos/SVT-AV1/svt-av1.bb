...
RPROVIDES:${PN} += "SVT-AV1 SVT-AV1(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libSvtAv1Dec.so.0()(64bit) libSvtAv1Enc.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit)"
