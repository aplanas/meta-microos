...
RPROVIDES:${PN} += "python3-behave python3.10dist(behave) python310-behave python3dist(behave)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-parse python310-parse_type python310-six update-alternatives"
