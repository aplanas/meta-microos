...
RPROVIDES:${PN} += "libtheoraenc.so.1()(64bit) libtheoraenc.so.1(libtheora.so.1.0)(64bit) libtheoraenc.so.1(libtheoraenc_1.0)(64bit) libtheoraenc1 libtheoraenc1(aarch-64)"
