...
RPROVIDES:${PN} += "python3.11dist(social-auth-core) python311-social-auth-core python3dist(social-auth-core)"
RDEPENDS:${PN} += "python(abi) python311-PyJWT python311-cryptography python311-defusedxml python311-oauthlib python311-python3-openid python311-requests python311-requests-oauthlib"
