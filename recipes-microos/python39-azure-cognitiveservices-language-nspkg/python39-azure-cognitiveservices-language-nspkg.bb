...
RPROVIDES:${PN} += "python3.9dist(azure-cognitiveservices-language-nspkg) python39-azure-cognitiveservices-language-nspkg python3dist(azure-cognitiveservices-language-nspkg)"
