...
RPROVIDES:${PN} += "tex(todonotes.sty) texlive-todonotes"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(ifthen.sty) tex(tikz.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-pgf texlive-scripts texlive-scripts-bin texlive-tools texlive-xcolor texlive-xkeyval"
