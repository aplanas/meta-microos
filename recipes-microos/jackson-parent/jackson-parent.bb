...
RPROVIDES:${PN} += "jackson-parent mvn(com.fasterxml.jackson:jackson-parent:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.fasterxml:oss-parent:pom:)"
