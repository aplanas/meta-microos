...
RPROVIDES:${PN} += "config(lynis) lynis"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/mkdir /usr/bin/touch bash cron fillup findutils libnss_usrfiles2 logrotate net-tools-deprecated netcfg wget"
