...
RPROVIDES:${PN} += "ruby3.2-rubygem-bindata ruby3.2-rubygem-bindata(aarch-64) rubygem(bindata) rubygem(ruby:3.2.0:bindata) rubygem(ruby:3.2.0:bindata:2) rubygem(ruby:3.2.0:bindata:2.4) rubygem(ruby:3.2.0:bindata:2.4.14)"
