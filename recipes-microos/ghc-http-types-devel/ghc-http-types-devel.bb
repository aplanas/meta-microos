...
RPROVIDES:${PN} += "ghc-devel(http-types-0.12.3-4BrMFwRucoT4fBt8cCVFS6) ghc-http-types-devel ghc-http-types-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(case-insensitive-1.2.1.0-AumZoR4Lds63HJj8OQwHY3) ghc-devel(text-2.0.2) ghc-http-types"
