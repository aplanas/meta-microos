...
RPROVIDES:${PN} += "tex(xindex.sty) texlive-xindex"
RDEPENDS:${PN} += "/bin/sh /usr/bin/texlua coreutils ed findutils grep sed tex(imakeidx.sty) tex(makeidx.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-xindex-bin"
