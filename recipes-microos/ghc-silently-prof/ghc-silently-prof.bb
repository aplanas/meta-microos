...
RPROVIDES:${PN} += "ghc-prof(silently-1.2.5.3-HiTtkArMijI9DvRcUmgkYR) ghc-silently-prof ghc-silently-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(directory-1.3.7.1) ghc-silently-devel"
