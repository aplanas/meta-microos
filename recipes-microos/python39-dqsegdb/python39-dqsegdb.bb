...
RPROVIDES:${PN} += "python3.9dist(dqsegdb) python39-dqsegdb python3dist(dqsegdb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-gwdatafind python39-lal python39-lscsoft-glue python39-numpy python39-pyOpenSSL python39-pyRXP update-alternatives"
