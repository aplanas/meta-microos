...
RPROVIDES:${PN} += "config(prewikka) prewikka prewikka-core python3.10dist(prewikka) python3dist(prewikka)"
RDEPENDS:${PN} += "/usr/bin/python3 prewikka-lang python(abi) python3-Babel python3-Mako python3-PyYAML python3-Werkzeug python3-croniter python3-gevent python3-lark-parser python3-libprelude python3-libpreludedb python3-python-dateutil python3-pytz python3-voluptuous xorg-x11-fonts"
