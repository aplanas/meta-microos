...
RPROVIDES:${PN} += "python3-testtools python3.10dist(testtools) python310-testtools python3dist(testtools)"
RDEPENDS:${PN} += "python(abi) python310-pbr python310-python-mimeparse python310-traceback2"
