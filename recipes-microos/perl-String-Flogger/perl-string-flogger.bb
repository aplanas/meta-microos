...
RPROVIDES:${PN} += "perl(String::Flogger) perl-String-Flogger"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(JSON::MaybeXS) perl(Params::Util) perl(Sub::Exporter) perl(Sub::Exporter::Util)"
