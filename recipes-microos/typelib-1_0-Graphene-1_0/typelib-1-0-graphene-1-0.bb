...
RPROVIDES:${PN} += "typelib(Graphene) typelib-1_0-Graphene-1_0 typelib-1_0-Graphene-1_0(aarch-64)"
RDEPENDS:${PN} += "libgraphene-1.0.so.0()(64bit) typelib(GLib) typelib(GObject)"
