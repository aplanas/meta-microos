...
RPROVIDES:${PN} += "ruby3.2-rubygem-jwt ruby3.2-rubygem-jwt(aarch-64) rubygem(jwt) rubygem(ruby:3.2.0:jwt) rubygem(ruby:3.2.0:jwt:2) rubygem(ruby:3.2.0:jwt:2.5) rubygem(ruby:3.2.0:jwt:2.5.0)"
