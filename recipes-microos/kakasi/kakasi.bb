...
RPROVIDES:${PN} += "kakasi kakasi(aarch-64) libkakasi.so.2()(64bit)"
RDEPENDS:${PN} += "/bin/sh /sbin/ldconfig kakasi-dict ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit)"
