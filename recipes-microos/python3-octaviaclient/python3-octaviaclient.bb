...
RPROVIDES:${PN} += "python3-octaviaclient python3.10dist(python-octaviaclient) python3dist(python-octaviaclient)"
RDEPENDS:${PN} += "python(abi) python3-Babel python3-cliff python3-keystoneauth1 python3-netifaces python3-neutronclient python3-openstackclient python3-osc-lib python3-oslo.serialization python3-oslo.utils python3-requests"
