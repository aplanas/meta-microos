...
RPROVIDES:${PN} += "python3.11dist(azure-mgmt-appcomplianceautomation) python311-azure-mgmt-appcomplianceautomation python3dist(azure-mgmt-appcomplianceautomation)"
