...
RPROVIDES:${PN} += "perl(Pod::POM) perl(Pod::POM::Constants) perl(Pod::POM::Node) perl(Pod::POM::Node::Begin) perl(Pod::POM::Node::Code) perl(Pod::POM::Node::Content) perl(Pod::POM::Node::For) perl(Pod::POM::Node::Head1) perl(Pod::POM::Node::Head2) perl(Pod::POM::Node::Head3) perl(Pod::POM::Node::Head4) perl(Pod::POM::Node::Item) perl(Pod::POM::Node::Over) perl(Pod::POM::Node::Pod) perl(Pod::POM::Node::Sequence) perl(Pod::POM::Node::Text) perl(Pod::POM::Node::Verbatim) perl(Pod::POM::Nodes) perl(Pod::POM::Test) perl(Pod::POM::View) perl(Pod::POM::View::HTML) perl(Pod::POM::View::Pod) perl(Pod::POM::View::Text) perl-Pod-POM"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(parent)"
