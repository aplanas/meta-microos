...
RPROVIDES:${PN} += "libglut.so.3()(64bit) libglut3 libglut3(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libGL.so.1()(64bit) libX11.so.6()(64bit) libXi.so.6()(64bit) libXrandr.so.2()(64bit) libXxf86vm.so.1()(64bit) libc.so.6(GLIBC_2.17)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit)"
