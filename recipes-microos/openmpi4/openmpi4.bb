...
RPROVIDES:${PN} += "mpi openmpi openmpi4 openmpi4(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libevent_core-2.1.so.7()(64bit) libmpi.so.40()(64bit) libopen-pal.so.40()(64bit) libopen-rte.so.40()(64bit) liboshmem.so.40()(64bit) mpi-selector openmpi-runtime-config openmpi4-libs openssh"
