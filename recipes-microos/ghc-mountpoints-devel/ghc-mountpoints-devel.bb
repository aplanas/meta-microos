...
RPROVIDES:${PN} += "ghc-devel(mountpoints-1.0.2-1s316lA2PKMJiFY8pZCQYD) ghc-mountpoints-devel ghc-mountpoints-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-mountpoints"
