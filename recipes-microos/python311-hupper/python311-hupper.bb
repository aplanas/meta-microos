...
RPROVIDES:${PN} += "python3.11dist(hupper) python311-hupper python3dist(hupper)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-watchdog update-alternatives"
