...
RPROVIDES:${PN} += "mvn(io.prometheus:simpleclient_servlet) mvn(io.prometheus:simpleclient_servlet:pom:) osgi(io.prometheus.simpleclient_servlet) prometheus-simpleclient-java-servlet"
