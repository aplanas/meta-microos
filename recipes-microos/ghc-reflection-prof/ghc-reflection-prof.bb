...
RPROVIDES:${PN} += "ghc-prof(reflection-2.1.7-KcOWE7PS1mHy6gA2edHvV) ghc-reflection-prof ghc-reflection-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(template-haskell-2.19.0.0) ghc-reflection-devel"
