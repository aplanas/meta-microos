...
RPROVIDES:${PN} += "librubberband-devel librubberband-devel(aarch-64) pkgconfig(rubberband)"
RDEPENDS:${PN} += "/usr/bin/pkg-config librubberband2 pkgconfig pkgconfig(fftw3)"
