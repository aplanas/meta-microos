...
RPROVIDES:${PN} += "tex(kdpcover.cls) texlive-kdpcover"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(anyfontsize.sty) tex(article.cls) tex(calc.sty) tex(geometry.sty) tex(graphicx.sty) tex(iexec.sty) tex(microtype.sty) tex(setspace.sty) tex(textpos.sty) tex(tikz.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-anyfontsize texlive-filesystem texlive-geometry texlive-graphics texlive-kpathsea texlive-kpathsea-bin texlive-microtype texlive-pgf texlive-scripts texlive-scripts-bin texlive-setspace texlive-textpos texlive-tools texlive-xcolor texlive-xifthen texlive-xkeyval"
