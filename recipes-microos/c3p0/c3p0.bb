...
RPROVIDES:${PN} += "c3p0 hibernate_jdbc_cache mvn(c3p0:c3p0) mvn(c3p0:c3p0:pom:) mvn(com.mchange:c3p0) mvn(com.mchange:c3p0:pom:)"
RDEPENDS:${PN} += "/bin/sh java-headless javapackages-filesystem mchange-commons mvn(com.mchange:mchange-commons-java) update-alternatives"
