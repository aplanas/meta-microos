...
RPROVIDES:${PN} += "python3.11dist(pip-tools) python311-pip-tools python3dist(pip-tools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-build python311-click python311-pip python311-setuptools python311-wheel"
