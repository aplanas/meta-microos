...
RPROVIDES:${PN} += "kernelshark-devel kernelshark-devel(aarch-64) pkgconfig(libkshark)"
RDEPENDS:${PN} += "/usr/bin/pkg-config kernelshark pkgconfig(json-c) pkgconfig(libtracecmd)"
