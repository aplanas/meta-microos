...
RPROVIDES:${PN} += "VFlib3 VFlib3(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libVFlib3.so.10()(64bit) libX11.so.6()(64bit) libc.so.6(GLIBC_2.34)(64bit) libkpathsea.so.6()(64bit)"
