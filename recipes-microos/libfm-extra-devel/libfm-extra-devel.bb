...
RPROVIDES:${PN} += "libfm-extra-devel libfm-extra-devel(aarch-64) pkgconfig(libfm-extra)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libfm-extra4 pkgconf-pkg-config pkgconfig(glib-2.0)"
