...
RPROVIDES:${PN} += "python3.9dist(azure-eventhub-checkpointstoreblob) python39-azure-eventhub-checkpointstoreblob python3dist(azure-eventhub-checkpointstoreblob)"
RDEPENDS:${PN} += "python(abi) python39-azure-core python39-azure-eventhub python39-azure-nspkg python39-cryptography python39-msrest"
