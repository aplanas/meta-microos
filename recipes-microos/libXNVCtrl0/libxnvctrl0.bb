...
RPROVIDES:${PN} += "libXNVCtrl.so.0()(64bit) libXNVCtrl0 libXNVCtrl0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig libX11.so.6()(64bit) libXext.so.6()(64bit) libc.so.6(GLIBC_2.17)(64bit)"
