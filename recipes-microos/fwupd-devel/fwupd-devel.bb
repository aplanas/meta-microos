...
RPROVIDES:${PN} += "fwupd-devel fwupd-devel(aarch-64) pkgconfig(fwupd)"
RDEPENDS:${PN} += "/usr/bin/pkg-config fwupd libfwupd2 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(gmodule-2.0) pkgconfig(jcat) pkgconfig(json-glib-1.0) pkgconfig(libcurl) typelib-1_0-Fwupd-2_0"
