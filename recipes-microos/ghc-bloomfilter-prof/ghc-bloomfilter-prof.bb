...
RPROVIDES:${PN} += "ghc-bloomfilter-prof ghc-bloomfilter-prof(aarch-64) ghc-prof(bloomfilter-2.0.1.0-3hF1ySDPbPQA7KQQeHgCqI)"
RDEPENDS:${PN} += "ghc-bloomfilter-devel ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(deepseq-1.4.8.0)"
