...
RPROVIDES:${PN} += "python3.11dist(asciimatics) python311-asciimatics python3dist(asciimatics)"
RDEPENDS:${PN} += "python(abi) python311-Pillow python311-curses python311-future python311-pyfiglet python311-wcwidth"
