...
RPROVIDES:${PN} += "python3.9dist(goosempl) python39-GooseMPL python3dist(goosempl)"
RDEPENDS:${PN} += "python(abi) python39-PyYAML python39-deprecation python39-matplotlib python39-matplotlib-latex python39-numpy python39-scipy texlive-amsfonts texlive-amsmath texlive-tools"
