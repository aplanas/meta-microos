...
RPROVIDES:${PN} += "python3.11dist(drms) python311-drms python3dist(drms)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-numpy python311-pandas update-alternatives"
