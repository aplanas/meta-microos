...
RPROVIDES:${PN} += "tex(rutitlepage.sty) texlive-rutitlepage"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(geometry.sty) tex(graphicx.sty) tex(iflang.sty) tex(ifpdf.sty) tex(keyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
