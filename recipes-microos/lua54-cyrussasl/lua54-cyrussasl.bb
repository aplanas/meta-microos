...
RPROVIDES:${PN} += "lua-cyrussasl lua54-cyrussasl lua54-cyrussasl(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsasl2.so.3()(64bit) lua54"
