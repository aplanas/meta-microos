...
RPROVIDES:${PN} += "man(pdftosrc.1) texlive-pdftools-doc:/usr/share/man/man1/pdftosrc.1.gz texlive-pdftosrc"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-pdftosrc-bin texlive-scripts texlive-scripts-bin"
