...
RPROVIDES:${PN} += "python3-dnf-plugins-core python3-dnf-plugins-extras-debug python3-dnf-plugins-extras-repoclosure python3-dnf-plugins-extras-repograph python3-dnf-plugins-extras-repomanage"
RDEPENDS:${PN} += "python(abi) python3-dateutil python3-dbus-python python3-distro python3-dnf python3-hawkey"
