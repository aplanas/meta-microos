...
RPROVIDES:${PN} += "python3.11dist(pyct) python311-pyct python3dist(pyct)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyYAML python311-param python311-requests update-alternatives"
