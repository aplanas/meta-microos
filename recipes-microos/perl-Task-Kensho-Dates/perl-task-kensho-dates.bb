...
RPROVIDES:${PN} += "perl(Task::Kensho::Dates) perl-Task-Kensho-Dates"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DateTime) perl(Time::Moment) perl(Time::ParseDate) perl(Time::Piece)"
