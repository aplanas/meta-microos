...
RPROVIDES:${PN} += "python3.11dist(django-pglocks) python311-django-pglocks python3dist(django-pglocks)"
RDEPENDS:${PN} += "python(abi) python311-Django python311-psycopg2"
