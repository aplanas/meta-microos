...
RPROVIDES:${PN} += "python3.9dist(pyprel) python39-pyprel python3dist(pyprel)"
RDEPENDS:${PN} += "python(abi) python39-Pillow python39-numpy python39-pandas python39-pyfiglet python39-shijian"
