...
RPROVIDES:${PN} += "apache2-mod_authn_otp apache2-mod_authn_otp(aarch-64) otptool"
RDEPENDS:${PN} += "apache_mmn_20120211 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) suse_maintenance_mmn_0"
