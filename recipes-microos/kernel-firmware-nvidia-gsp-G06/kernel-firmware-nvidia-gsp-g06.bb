...
RPROVIDES:${PN} += "firmware(nvidia/525.116.04/gsp_ad10x.bin) firmware(nvidia/525.116.04/gsp_tu10x.bin) kernel-firmware-nvidia-gsp-G06 kernel-firmware-nvidia-gsp-G06(aarch-64) multiversion(kernel)"
RDEPENDS:${PN} += ""
