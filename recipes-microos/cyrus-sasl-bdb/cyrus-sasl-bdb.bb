...
RPROVIDES:${PN} += "cyrus-sasl-bdb cyrus-sasl-bdb(aarch-64) libanonymous.so.3()(64bit) liblogin.so.3()(64bit) libsasldb.so.3()(64bit)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libdb-4.8.so()(64bit) libgssapi_krb5.so.2()(64bit) libgssapi_krb5.so.2(gssapi_krb5_2_MIT)(64bit) libsasl2-3 libsasl2.so.3()(64bit)"
