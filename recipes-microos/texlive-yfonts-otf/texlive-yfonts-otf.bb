...
RPROVIDES:${PN} += "tex(oldgerm-otf.sty) tex(yfonts-otf.sty) texlive-yfonts-otf"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontspec.sty) tex(iftex.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-yfonts-otf-fonts"
