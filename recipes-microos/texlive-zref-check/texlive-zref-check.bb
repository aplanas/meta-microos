...
RPROVIDES:${PN} += "tex(zref-check.sty) texlive-zref-check"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifdraft.sty) tex(zref-abspage.sty) tex(zref-hyperref.sty) tex(zref-user.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
