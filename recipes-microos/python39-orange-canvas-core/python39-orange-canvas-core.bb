...
RPROVIDES:${PN} += "python3.9dist(orange-canvas-core) python39-orange-canvas-core python3dist(orange-canvas-core)"
RDEPENDS:${PN} += "python(abi) python39-AnyQt python39-CacheControl python39-commonmark python39-dictdiffer python39-docutils python39-qt5 python39-requests"
