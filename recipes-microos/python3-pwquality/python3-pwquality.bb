...
RPROVIDES:${PN} += "python-pwquality python3-pwquality python3-pwquality(aarch-64) python3.10dist(pwquality) python3dist(pwquality)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libpwquality.so.1()(64bit) libpwquality.so.1(LIBPWQUALITY_1.0)(64bit) python(abi)"
