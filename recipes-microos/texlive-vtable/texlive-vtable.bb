...
RPROVIDES:${PN} += "tex(vtable.sty) texlive-vtable"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(alphalph.sty) tex(array.sty) tex(calc.sty) tex(dashrule.sty) tex(etoolbox.sty) tex(forloop.sty) tex(graphicx.sty) tex(varwidth.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
