...
RPROVIDES:${PN} += "tex(pst-math.sty) tex(pst-math.tex) texlive-pst-math"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifluatex.sty) tex(pst-calculate.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
