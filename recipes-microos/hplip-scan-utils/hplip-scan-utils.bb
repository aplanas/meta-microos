...
RPROVIDES:${PN} += "application() application(hp-uiscan.desktop) hplip-scan hplip-scan-utils hplip-scan-utils(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 hplip ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsane.so.1()(64bit) python(abi) python3-Pillow python3-scikit-image"
