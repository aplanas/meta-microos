...
RPROVIDES:${PN} += "allegro44-tools allegro44-tools(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) liballeg.so.4.4()(64bit) libc.so.6(GLIBC_2.34)(64bit) libjpgalleg.so.4.4()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.29)(64bit)"
