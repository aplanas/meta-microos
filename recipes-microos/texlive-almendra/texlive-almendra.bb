...
tex(almendra.map) \
tex(almendra.sty) \
tex(almndr_2bmcpz.enc) \
tex(almndr_aphd5h.enc) \
tex(almndr_d2g35l.enc) \
tex(almndr_fqyk3x.enc) \
tex(almndr_gd2dkq.enc) \
tex(almndr_jcmsbq.enc) \
tex(almndr_ktaaad.enc) \
tex(almndr_ncjtqa.enc) \
tex(almndr_piphgo.enc) \
tex(almndr_x2ojwl.enc) \
tex(almndr_xs7q5m.enc) \
