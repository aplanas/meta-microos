...
RPROVIDES:${PN} += "python3-azure-synapse python3-azure-synapse-spark python3.10dist(azure-synapse-spark) python310-azure-synapse python310-azure-synapse-spark python3dist(azure-synapse-spark)"
