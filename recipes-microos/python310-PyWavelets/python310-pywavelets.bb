...
RPROVIDES:${PN} += "python3-PyWavelets python3-PyWavelets-doc python3.10dist(pywavelets) python310-PyWavelets python310-PyWavelets(aarch-64) python310-PyWavelets-doc python3dist(pywavelets)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-numpy"
