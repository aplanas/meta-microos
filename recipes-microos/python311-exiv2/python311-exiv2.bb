...
RPROVIDES:${PN} += "libexiv2python.cpython-311-aarch64-linux-gnu.so()(64bit) python3.11dist(py3exiv2) python311-exiv2 python311-exiv2(aarch-64) python3dist(py3exiv2)"
