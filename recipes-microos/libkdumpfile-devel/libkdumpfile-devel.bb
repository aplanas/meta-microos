...
RPROVIDES:${PN} += "libkdumpfile-devel libkdumpfile-devel(aarch-64) pkgconfig(libkdumpfile)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libkdumpfile10 pkgconfig(libaddrxlat) pkgconfig(libzstd) pkgconfig(lzo2) pkgconfig(snappy) pkgconfig(zlib)"
