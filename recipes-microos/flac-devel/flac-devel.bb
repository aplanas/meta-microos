...
RPROVIDES:${PN} += "flac-devel flac-devel(aarch-64) pkgconfig(flac) pkgconfig(flac++)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libFLAC++10 libFLAC12 libstdc++-devel pkgconfig(flac) pkgconfig(ogg)"
