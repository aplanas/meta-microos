...
RPROVIDES:${PN} += "libdbdmysql.so()(64bit) libdbi-drivers-dbd-mysql libdbi-drivers-dbd-mysql(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libdbi.so.3()(64bit) libdbi.so.3(ABI_3)(64bit) libmariadb.so.3()(64bit) libmariadb.so.3(libmysqlclient_18)(64bit)"
