...
RPROVIDES:${PN} += "man(synctex.1) man(synctex.5) texlive-synctex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-synctex-bin"
