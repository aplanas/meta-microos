...
RPROVIDES:${PN} += "python3.9dist(python-gitlab) python39-python-gitlab python3dist(python-gitlab)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-argcomplete python39-requests python39-requests-toolbelt python39-setuptools update-alternatives"
