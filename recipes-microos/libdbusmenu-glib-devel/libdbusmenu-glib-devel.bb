...
RPROVIDES:${PN} += "libdbusmenu-glib-devel libdbusmenu-glib-devel(aarch-64) pkgconfig(dbusmenu-glib-0.4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libdbusmenu-glib4 pkgconfig(dbus-glib-1) typelib-1_0-Dbusmenu-0_4"
