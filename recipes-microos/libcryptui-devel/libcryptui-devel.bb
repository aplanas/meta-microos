...
RPROVIDES:${PN} += "libcryptui-devel libcryptui-devel(aarch-64) pkgconfig(cryptui-0.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libcryptui0 pkgconfig(dbus-glib-1) pkgconfig(gio-2.0) pkgconfig(gtk+-3.0) typelib-1_0-CryptUI-0_0"
