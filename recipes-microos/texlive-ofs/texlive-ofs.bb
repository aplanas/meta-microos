...
RPROVIDES:${PN} += "tex(a117.tex) tex(a35.sty) tex(a35.tex) tex(allfonts.sty) tex(allfonts.tex) tex(amsfn.tex) tex(mtfn.tex) tex(ofs-6a.tex) tex(ofs-6c.tex) tex(ofs-6k.tex) tex(ofs-6s.tex) tex(ofs-6t.tex) tex(ofs-6x.tex) tex(ofs-6y.tex) tex(ofs-8c.tex) tex(ofs-8t.tex) tex(ofs-8x.tex) tex(ofs-8z.tex) tex(ofs-ams.tex) tex(ofs-cm.tex) tex(ofs-mt.tex) tex(ofs-ps.tex) tex(ofs-px.tex) tex(ofs-slt.tex) tex(ofs-tx.tex) tex(ofs.sty) tex(ofs.tex) tex(ofsdef.tex) tex(pantyk.tex) tex(txfn.tex) texlive-ofs"
