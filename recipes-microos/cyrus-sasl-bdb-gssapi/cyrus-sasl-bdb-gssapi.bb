...
RPROVIDES:${PN} += "cyrus-sasl-bdb-gssapi cyrus-sasl-bdb-gssapi(aarch-64) libgssapiv2.so.3()(64bit)"
RDEPENDS:${PN} += "cyrus-sasl-bdb ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgssapi_krb5.so.2()(64bit) libgssapi_krb5.so.2(gssapi_krb5_2_MIT)(64bit)"
