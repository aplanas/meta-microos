...
RPROVIDES:${PN} += "tex(xltxtra.sty) texlive-xltxtra"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fontspec.sty) tex(ifluatex.sty) tex(ifxetex.sty) tex(metalogo.sty) tex(realscripts.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-metalogo texlive-scripts texlive-scripts-bin"
