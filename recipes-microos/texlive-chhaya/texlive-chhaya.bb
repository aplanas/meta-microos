...
RPROVIDES:${PN} += "tex(chhaya.sty) tex(sankshep.tex) texlive-chhaya"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(glossaries.sty) tex(iftex.sty) tex(marathi.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
