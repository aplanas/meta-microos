...
RPROVIDES:${PN} += "python3.9dist(certbot-apache) python39-certbot-apache python3dist(certbot-apache)"
RDEPENDS:${PN} += "apache2 augeas-lenses python(abi) python39-acme python39-augeas python39-certbot"
