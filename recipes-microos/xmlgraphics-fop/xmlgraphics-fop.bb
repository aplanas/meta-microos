...
RPROVIDES:${PN} += "config(xmlgraphics-fop) fo-formatter fop mvn(org.apache.xmlgraphics:fop) mvn(org.apache.xmlgraphics:fop:pom:) xmlgraphics-fop"
RDEPENDS:${PN} += "java java-headless javapackages-filesystem mvn(com.thoughtworks.qdox:qdox) mvn(commons-io:commons-io) mvn(commons-logging:commons-logging) mvn(javax.servlet:servlet-api) mvn(org.apache.pdfbox:fontbox) mvn(org.apache.xmlgraphics:batik-anim) mvn(org.apache.xmlgraphics:batik-awt-util) mvn(org.apache.xmlgraphics:batik-bridge) mvn(org.apache.xmlgraphics:batik-extension) mvn(org.apache.xmlgraphics:batik-gvt) mvn(org.apache.xmlgraphics:batik-transcoder) mvn(org.apache.xmlgraphics:xmlgraphics-commons) xml-commons-apis"
