...
RPROVIDES:${PN} += "ghc-devel(vector-th-unbox-0.2.2-8WH0ofCzoXcG1eDIxYKY6t) ghc-vector-th-unbox-devel ghc-vector-th-unbox-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(template-haskell-2.19.0.0) ghc-devel(vector-0.13.0.0-AbjrQrWxuFpAjIHk3G7xsp) ghc-vector-th-unbox"
