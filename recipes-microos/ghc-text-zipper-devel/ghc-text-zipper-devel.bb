...
RPROVIDES:${PN} += "ghc-devel(text-zipper-0.12-HAxIdT2NfEj1pbIOe2MIin) ghc-text-zipper-devel ghc-text-zipper-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(text-2.0.2) ghc-devel(vector-0.13.0.0-AbjrQrWxuFpAjIHk3G7xsp) ghc-text-zipper"
