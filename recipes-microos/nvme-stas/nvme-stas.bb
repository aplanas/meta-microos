...
RPROVIDES:${PN} += "config(nvme-stas) nvme-stas nvme-stas(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 avahi python(abi) python3-dasbus python3-gobject python3-libnvme python3-pyudev python3-systemd typelib(GLib) typelib(GObject) typelib(Gio)"
