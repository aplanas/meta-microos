...
RPROVIDES:${PN} += "python3-pytest-bdd python3.10dist(pytest-bdd) python310-pytest-bdd python3dist(pytest-bdd)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Mako python310-glob2 python310-parse python310-parse_type python310-py python310-pytest update-alternatives"
