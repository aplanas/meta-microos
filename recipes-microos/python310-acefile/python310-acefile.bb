...
RPROVIDES:${PN} += "python3-acefile python3.10dist(acefile) python310-acefile python310-acefile(aarch-64) python3dist(acefile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-setuptools update-alternatives"
