...
RPROVIDES:${PN} += "tex(play.cls) tex(play.sty) texlive-play"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(book.cls) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
