...
RPROVIDES:${PN} += "tex(ProfLabo.sty) texlive-proflabo"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifthen.sty) tex(listofitems.sty) tex(pgf.sty) tex(simplekv.sty) tex(tikz.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
