...
RPROVIDES:${PN} += "jogl2 jogl2(aarch-64) libjogl_cg.so()(64bit) libjogl_desktop.so()(64bit) libjogl_mobile.so()(64bit) libnativewindow_awt.so()(64bit) libnativewindow_x11.so()(64bit) libnewt.so()(64bit)"
RDEPENDS:${PN} += "gluegen2 java jpackage-utils libX11.so.6()(64bit) libXcursor.so.1()(64bit) libXrandr.so.2()(64bit) libXrender.so.1()(64bit) libXxf86vm.so.1()(64bit) libc.so.6(GLIBC_2.34)(64bit) libjawt.so()(64bit)"
