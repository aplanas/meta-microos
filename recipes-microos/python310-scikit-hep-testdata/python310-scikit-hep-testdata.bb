...
RPROVIDES:${PN} += "python3-scikit-hep-testdata python3.10dist(scikit-hep-testdata) python310-scikit-hep-testdata python3dist(scikit-hep-testdata)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-PyYAML python310-requests scikit-hep-testdata-files update-alternatives"
