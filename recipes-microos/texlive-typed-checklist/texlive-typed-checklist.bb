...
RPROVIDES:${PN} += "tex(typed-checklist.sty) texlive-typed-checklist"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(asciilist.sty) tex(bbding.sty) tex(etoolbox.sty) tex(marginnote.sty) tex(tabularx.sty) tex(xcolor.sty) tex(xkeyval.sty) tex(xltabular.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
