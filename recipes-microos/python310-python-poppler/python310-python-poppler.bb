...
RPROVIDES:${PN} += "python3-python-poppler python3.10dist(python-poppler) python310-python-poppler python310-python-poppler(aarch-64) python3dist(python-poppler)"
