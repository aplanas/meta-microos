...
RPROVIDES:${PN} += "python3.9dist(targetcli-fb) python39-targetcli-fb python3dist(targetcli-fb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-configshell-fb python39-dbus-python python39-rtslib-fb python39-six targetcli-fb-common update-alternatives"
