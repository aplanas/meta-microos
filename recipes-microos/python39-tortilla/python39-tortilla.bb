...
RPROVIDES:${PN} += "python3.9dist(tortilla) python39-tortilla python3dist(tortilla)"
RDEPENDS:${PN} += "python(abi) python39-colorama python39-formats python39-httpretty python39-requests python39-six"
