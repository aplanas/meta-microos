...
RPROVIDES:${PN} += "tex(niceframe.map) texlive-niceframe-type1"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-niceframe-type1-fonts texlive-scripts texlive-scripts-bin"
