...
RPROVIDES:${PN} += "ghc-prof(some-1.0.5-3dwCpkSImpx8T8axxRPR3Z) ghc-some-prof ghc-some-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-some-devel"
