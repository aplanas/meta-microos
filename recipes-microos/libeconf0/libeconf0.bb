...
RPROVIDES:${PN} += "libeconf.so.0()(64bit) libeconf.so.0(LIBECONF_0.2)(64bit) libeconf.so.0(LIBECONF_0.3)(64bit) libeconf.so.0(LIBECONF_0.4)(64bit) libeconf.so.0(LIBECONF_0.5)(64bit) libeconf.so.0(LIBECONF_ALPHA)(64bit) libeconf0 libeconf0(aarch-64)"
