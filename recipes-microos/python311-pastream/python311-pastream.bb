...
RPROVIDES:${PN} += "python3.11dist(pastream) python311-pastream python311-pastream(aarch-64) python3dist(pastream)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsndfile portaudio python(abi) python311-SoundFile python311-cffi python311-pa-ringbuffer python311-sounddevice update-alternatives"
