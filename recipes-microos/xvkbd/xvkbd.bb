...
RPROVIDES:${PN} += "application() application(xvkbd.desktop) xvkbd xvkbd(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libXaw3d.so.8()(64bit) libXmu.so.6()(64bit) libXt.so.6()(64bit) libXtst.so.6()(64bit) libc.so.6(GLIBC_2.34)(64bit)"
