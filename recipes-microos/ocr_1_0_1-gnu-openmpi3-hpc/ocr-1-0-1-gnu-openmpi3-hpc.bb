...
RPROVIDES:${PN} += "ocr_1_0_1-gnu-openmpi3-hpc ocr_1_0_1-gnu-openmpi3-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh gnu-compilers-hpc libc.so.6(GLIBC_2.34)(64bit) libopenmpi3-gnu-hpc lua-lmod openmpi3-gnu-hpc"
