...
RPROVIDES:${PN} += "glassfish-jax-rs-api mvn(jakarta.ws.rs:jakarta.ws.rs-api) mvn(jakarta.ws.rs:jakarta.ws.rs-api:pom:) mvn(javax.ws.rs:javax.ws.rs-api) mvn(javax.ws.rs:javax.ws.rs-api:pom:) osgi(jakarta.ws.rs-api)"
