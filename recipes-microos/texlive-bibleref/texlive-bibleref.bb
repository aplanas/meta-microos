...
RPROVIDES:${PN} += "tex(bibleref-xidx.sty) tex(bibleref.sty) texlive-bibleref"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsgen.sty) tex(fmtcount.sty) tex(ifthen.sty) tex(ifxetex.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
