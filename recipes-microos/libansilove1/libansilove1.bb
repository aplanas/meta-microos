...
RPROVIDES:${PN} += "libansilove.so.1()(64bit) libansilove1 libansilove1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libgd.so.3()(64bit)"
