...
RPROVIDES:${PN} += "python3.9dist(pyhepmc3) python3.9dist(pyhepmc3.search) python39-HepMC python39-HepMC(aarch-64) python3dist(pyhepmc3) python3dist(pyhepmc3.search)"
