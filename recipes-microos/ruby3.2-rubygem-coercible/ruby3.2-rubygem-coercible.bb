...
RPROVIDES:${PN} += "ruby3.2-rubygem-coercible ruby3.2-rubygem-coercible(aarch-64) rubygem(coercible) rubygem(ruby:3.2.0:coercible) rubygem(ruby:3.2.0:coercible:1) rubygem(ruby:3.2.0:coercible:1.0) rubygem(ruby:3.2.0:coercible:1.0.0)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:descendants_tracker:0.0)"
