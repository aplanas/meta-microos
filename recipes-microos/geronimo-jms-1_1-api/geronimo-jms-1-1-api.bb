...
RPROVIDES:${PN} += "geronimo-jms-1_1-api jms jms_1_1_api jms_api mvn(javax.jms:jms) mvn(javax.jms:jms:pom:) mvn(org.apache.geronimo.specs:geronimo-jms_1.1_spec) mvn(org.apache.geronimo.specs:geronimo-jms_1.1_spec:pom:)"
