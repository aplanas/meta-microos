...
RPROVIDES:${PN} += "python3-azure-mgmt-marketplaceordering python3.10dist(azure-mgmt-marketplaceordering) python310-azure-mgmt-marketplaceordering python3dist(azure-mgmt-marketplaceordering)"
