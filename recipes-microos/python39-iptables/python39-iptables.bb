...
RPROVIDES:${PN} += "libxtwrapper.cpython-39-aarch64-linux-gnu.so()(64bit) python3.9dist(python-iptables) python39-iptables python39-iptables(aarch-64) python3dist(python-iptables)"
