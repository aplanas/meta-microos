...
RPROVIDES:${PN} += "application() application(org.gnome.Extensions.desktop) gnome-extensions gnome-extensions(aarch-64) metainfo() metainfo(org.gnome.Extensions.metainfo.xml)"
RDEPENDS:${PN} += "/bin/sh gnome-shell typelib(Adw) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Gtk) typelib(Shew)"
