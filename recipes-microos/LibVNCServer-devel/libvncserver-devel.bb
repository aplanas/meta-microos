...
RPROVIDES:${PN} += "LibVNCServer-devel LibVNCServer-devel(aarch-64) pkgconfig(libvncclient) pkgconfig(libvncserver)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gnutls-devel libvncclient1 libvncserver1 zlib-devel"
