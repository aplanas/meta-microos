...
RPROVIDES:${PN} += "python3-matrix-common python3-matrix_common python3.10dist(matrix-common) python310-matrix-common python310-matrix_common python3dist(matrix-common)"
