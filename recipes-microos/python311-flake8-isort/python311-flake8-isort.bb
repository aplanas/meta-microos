...
RPROVIDES:${PN} += "python3.11dist(flake8-isort) python311-flake8-isort python3dist(flake8-isort)"
RDEPENDS:${PN} += "python(abi) python311-flake8 python311-isort python311-testfixtures"
