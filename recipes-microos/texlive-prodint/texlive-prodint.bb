...
RPROVIDES:${PN} += "tex(prodint.map) tex(prodint.sty) tex(prodint.tfm) texlive-prodint"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-prodint-fonts texlive-scripts texlive-scripts-bin"
