...
RPROVIDES:${PN} += "tex(kinematikz.sty) texlive-kinematikz"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(graphicx.sty) tex(ifthen.sty) tex(listofitems.sty) tex(tikz-3dplot.sty) tex(tikz.sty) tex(xpatch.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
