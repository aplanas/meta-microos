...
RPROVIDES:${PN} += "tex(prettytok.sty) texlive-prettytok"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(precattl.sty) texlive texlive-filecontentsdef texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-l3kernel texlive-precattl texlive-scripts texlive-scripts-bin"
