...
RPROVIDES:${PN} += "perl(XML::Twig) perl(XML::Twig::Elt) perl(XML::Twig::Entity) perl(XML::Twig::Entity_list) perl(XML::Twig::Notation) perl(XML::Twig::Notation_list) perl(XML::Twig::XPath) perl(XML::Twig::XPath::Attribute) perl(XML::Twig::XPath::Elt) perl(XML::Twig::XPath::Namespace) perl-XML-Twig"
RDEPENDS:${PN} += "/usr/bin/perl expat perl(:MODULE_COMPAT_5.36.0) perl(Encode) perl(XML::Parser) perl-XML-Parser"
