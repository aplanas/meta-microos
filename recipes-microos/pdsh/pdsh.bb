...
RPROVIDES:${PN} += "pdsh pdsh(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/perl ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libmunge.so.2()(64bit) libreadline.so.8()(64bit)"
