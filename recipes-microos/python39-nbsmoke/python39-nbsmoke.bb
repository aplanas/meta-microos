...
RPROVIDES:${PN} += "python3.9dist(nbsmoke) python39-jupyter_nbsmoke python39-nbsmoke python3dist(nbsmoke)"
RDEPENDS:${PN} += "python(abi) python39-ipykernel python39-jupyter-client python39-nbconvert python39-nbformat python39-param python39-pyflakes python39-pytest"
