...
RPROVIDES:${PN} += "python3.9dist(framel) python39-framel python39-framel(aarch-64) python3dist(framel)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libframel.so.8()(64bit) libpython3.9.so.1.0()(64bit) python(abi)"
