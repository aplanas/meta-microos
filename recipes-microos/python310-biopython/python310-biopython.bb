...
RPROVIDES:${PN} += "python3-biopython python3.10dist(biopython) python310-biopython python310-biopython(aarch-64) python3dist(biopython)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-numpy python310-xml"
