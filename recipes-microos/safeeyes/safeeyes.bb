...
RPROVIDES:${PN} += "application() application(safeeyes.desktop) python3.10dist(safeeyes) python3dist(safeeyes) safeeyes"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Babel python3-cairo python3-croniter python3-gobject python3-psutil python3-python-xlib typelib(AppIndicator3) typelib(Notify)"
