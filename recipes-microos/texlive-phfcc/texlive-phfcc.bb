...
RPROVIDES:${PN} += "tex(phfcc.sty) texlive-phfcc"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(kvoptions.sty) tex(lua-ul.sty) tex(marginnote.sty) tex(xcolor.sty) tex(xkeyval.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
