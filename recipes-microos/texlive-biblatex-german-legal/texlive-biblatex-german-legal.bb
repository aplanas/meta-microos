...
RPROVIDES:${PN} += "tex(german-legal-book.bbx) tex(german-legal-book.cbx) texlive-biblatex-german-legal"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ext-authortitle.bbx) tex(ext-authortitle.cbx) tex(xpatch.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
