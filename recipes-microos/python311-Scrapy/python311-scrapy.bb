...
RPROVIDES:${PN} += "python3.11dist(scrapy) python311-Scrapy python3dist(scrapy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Protego python311-PyDispatcher python311-Twisted python311-cryptography python311-cssselect python311-itemadapter python311-itemloaders python311-lxml python311-parsel python311-pyOpenSSL python311-queuelib python311-service_identity python311-setuptools python311-tldextract python311-w3lib python311-zope.interface update-alternatives"
