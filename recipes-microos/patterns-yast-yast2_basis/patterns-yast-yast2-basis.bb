...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-icon() pattern-order() pattern-visible() patterns-yast-yast2_basis patterns-yast-yast2_basis(aarch-64)"
RDEPENDS:${PN} += "libyui-ncurses-pkg yast2 yast2-alternatives yast2-firewall yast2-packager yast2-theme"
