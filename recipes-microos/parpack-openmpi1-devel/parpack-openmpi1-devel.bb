...
RPROVIDES:${PN} += "parpack-openmpi-devel parpack-openmpi1-devel parpack-openmpi1-devel(aarch-64)"
RDEPENDS:${PN} += "blas-devel gcc-fortran lapack-devel libparpack2-openmpi1 openmpi1-devel"
