...
RPROVIDES:${PN} += "python3.11dist(mypy-protobuf) python311-mypy-protobuf python3dist(mypy-protobuf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-protobuf update-alternatives"
