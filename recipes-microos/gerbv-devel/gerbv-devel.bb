...
RPROVIDES:${PN} += "gerbv-devel gerbv-devel(aarch-64) pkgconfig(libgerbv)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gtk2-devel libgerbv1 libpng-devel pkgconfig(glib-2.0) pkgconfig(gtk+-2.0)"
