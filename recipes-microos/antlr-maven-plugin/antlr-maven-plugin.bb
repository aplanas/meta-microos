...
RPROVIDES:${PN} += "antlr-maven-plugin mvn(org.codehaus.mojo:antlr-maven-plugin) mvn(org.codehaus.mojo:antlr-maven-plugin:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.commons:commons-exec) mvn(org.apache.maven.reporting:maven-reporting-impl) mvn(org.apache.maven.wagon:wagon-provider-api) mvn(org.apache.maven:maven-plugin-api) mvn(org.apache.maven:maven-project) mvn(org.codehaus.plexus:plexus-i18n) mvn(org.codehaus.plexus:plexus-utils)"
