...
RPROVIDES:${PN} += "python3-cufflinks python3.10dist(cufflinks) python310-cufflinks python3dist(cufflinks)"
RDEPENDS:${PN} += "python(abi) python310-colorlover python310-numpy python310-pandas python310-plotly python310-six"
