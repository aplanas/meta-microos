...
RPROVIDES:${PN} += "perl(Convert::BinHex) perl(Convert::BinHex::Bin2Hex) perl(Convert::BinHex::Fork) perl(Convert::BinHex::Hex2Bin) perl(Convert::BinHex::IO_Handle) perl(Convert::BinHex::IO_Scalar) perl-Convert-BinHex"
