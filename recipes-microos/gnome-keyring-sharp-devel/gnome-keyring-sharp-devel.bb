...
RPROVIDES:${PN} += "gnome-keyring-sharp-devel gnome-keyring-sharp-devel(aarch-64) pkgconfig(gnome-keyring-sharp-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config gnome-keyring-sharp pkgconf-pkg-config"
