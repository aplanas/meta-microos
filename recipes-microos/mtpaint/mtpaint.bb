...
RPROVIDES:${PN} += "application() application(mtpaint.desktop) mimehandler(image/bmp) mimehandler(image/gif) mimehandler(image/jpeg) mimehandler(image/jpg) mimehandler(image/pjpeg) mimehandler(image/png) mimehandler(image/svg) mimehandler(image/svg+xml) mimehandler(image/tiff) mimehandler(image/x-bmp) mimehandler(image/x-ms-bmp) mimehandler(image/x-pcx) mimehandler(image/x-png) mimehandler(image/x-portable-anymap) mimehandler(image/x-portable-bitmap) mimehandler(image/x-portable-graymap) mimehandler(image/x-portable-pixmap) mimehandler(image/x-tga) mimehandler(image/x-xbitmap) mimehandler(image/x-xbm) mimehandler(image/x-xpixmap) mimehandler(image/x-xpm) mimehandler(image/xbm) mimehandler(image/xpm) mtpaint mtpaint(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ImageMagick ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libc.so.6(GLIBC_2.34)(64bit) libcairo.so.2()(64bit) libfreetype.so.6()(64bit) libgdk-3.so.0()(64bit) libgdk_pixbuf-2.0.so.0()(64bit) libgif.so.7()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libjpeg.so.8()(64bit) libjpeg.so.8(LIBJPEG_8.0)(64bit) liblcms2.so.2()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libm.so.6(GLIBC_2.29)(64bit) libopenjp2.so.7()(64bit) libpango-1.0.so.0()(64bit) libpangocairo-1.0.so.0()(64bit) libpng16.so.16()(64bit) libpng16.so.16(PNG16_0)(64bit) libtiff.so.6()(64bit) libtiff.so.6(LIBTIFF_4.0)(64bit) libwebp.so.7()(64bit) libz.so.1()(64bit) libz.so.1(ZLIB_1.2.0)(64bit)"
