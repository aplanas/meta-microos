...
RPROVIDES:${PN} += "libgdk_pixbuf_xlib-2.0.so.0()(64bit) libgdk_pixbuf_xlib-2_0-0 libgdk_pixbuf_xlib-2_0-0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libc.so.6(GLIBC_2.17)(64bit) libgdk_pixbuf-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit)"
