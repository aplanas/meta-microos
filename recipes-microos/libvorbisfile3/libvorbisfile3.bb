...
RPROVIDES:${PN} += "libvorbisfile.so.3()(64bit) libvorbisfile3 libvorbisfile3(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libogg.so.0()(64bit) libvorbis.so.0()(64bit)"
