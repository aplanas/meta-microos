...
RPROVIDES:${PN} += "ruby3.2-rubygem-crass ruby3.2-rubygem-crass(aarch-64) rubygem(crass) rubygem(ruby:3.2.0:crass) rubygem(ruby:3.2.0:crass:1) rubygem(ruby:3.2.0:crass:1.0) rubygem(ruby:3.2.0:crass:1.0.6)"
