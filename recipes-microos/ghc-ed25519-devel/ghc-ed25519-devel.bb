...
RPROVIDES:${PN} += "ghc-devel(ed25519-0.0.5.0-EkN6WeFwHLH4dNF4Xthto8) ghc-ed25519-devel ghc-ed25519-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(ghc-prim-0.9.0) ghc-ed25519"
