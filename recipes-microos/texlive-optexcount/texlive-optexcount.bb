...
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 coreutils ed findutils grep sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-optexcount-bin texlive-scripts texlive-scripts-bin"
