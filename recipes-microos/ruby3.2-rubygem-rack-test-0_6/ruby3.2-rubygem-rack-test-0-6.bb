...
RPROVIDES:${PN} += "ruby3.2-rubygem-rack-test-0_6 ruby3.2-rubygem-rack-test-0_6(aarch-64) rubygem(rack-test) rubygem(ruby:3.2.0:rack-test) rubygem(ruby:3.2.0:rack-test:0) rubygem(ruby:3.2.0:rack-test:0.6) rubygem(ruby:3.2.0:rack-test:0.6.3)"
