...
RPROVIDES:${PN} += "python3-azure-mgmt-storagemover python3.10dist(azure-mgmt-storagemover) python310-azure-mgmt-storagemover python3dist(azure-mgmt-storagemover)"
