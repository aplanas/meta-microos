...
RPROVIDES:${PN} += "python3.11dist(zope.interface) python311-zope.interface python311-zope.interface(aarch-64) python3dist(zope.interface)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-setuptools"
