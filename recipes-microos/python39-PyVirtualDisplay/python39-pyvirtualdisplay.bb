...
RPROVIDES:${PN} += "python3.9dist(pyvirtualdisplay) python39-PyVirtualDisplay python3dist(pyvirtualdisplay)"
RDEPENDS:${PN} += "python(abi) python39-EasyProcess xorg-x11-Xvfb"
