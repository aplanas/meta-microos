...
RPROVIDES:${PN} += "openmpi-macros-provider openmpi_5_0_0-gnu-hpc-macros-devel openmpi_5_0_0-gnu-hpc-macros-devel(aarch-64) rpm_macro(hpc_openmpi_init) rpm_macro(hpc_openmpi_requires) rpm_macro(hpc_openmpi_requires_devel) rpm_macro(hpc_setup_openmpi)"
