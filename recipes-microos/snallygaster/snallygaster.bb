...
RPROVIDES:${PN} += "python3.10dist(snallygaster) python3dist(snallygaster) snallygaster"
RDEPENDS:${PN} += "/usr/bin/python3 python3-beautifulsoup4 python3-dnspython python3-urllib3"
