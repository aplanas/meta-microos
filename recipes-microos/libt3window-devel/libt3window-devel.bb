...
RPROVIDES:${PN} += "libt3window-devel libt3window-devel(aarch-64) pkgconfig(libt3window)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libt3window0 pkgconfig(libtranscript) pkgconfig(tinfo)"
