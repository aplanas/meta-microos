...
RPROVIDES:${PN} += "keybinder-3.0-devel keybinder-3.0-devel(aarch-64) pkgconfig(keybinder-3.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libkeybinder-3_0-0 pkgconfig pkgconfig(gtk+-3.0)"
