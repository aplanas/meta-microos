...
RPROVIDES:${PN} += "perl(Mail::Address) perl(Mail::Cap) perl(Mail::Field) perl(Mail::Field::AddrList) perl(Mail::Field::Date) perl(Mail::Field::Generic) perl(Mail::Filter) perl(Mail::Header) perl(Mail::Internet) perl(Mail::Mailer) perl(Mail::Mailer::qmail) perl(Mail::Mailer::rfc822) perl(Mail::Mailer::sendmail) perl(Mail::Mailer::smtp) perl(Mail::Mailer::smtp::pipe) perl(Mail::Mailer::smtps) perl(Mail::Mailer::smtps::pipe) perl(Mail::Mailer::testfile) perl(Mail::Mailer::testfile::pipe) perl(Mail::Send) perl(Mail::Util) perl(MailTools) perl-MailTools"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Date::Format) perl(Date::Parse)"
