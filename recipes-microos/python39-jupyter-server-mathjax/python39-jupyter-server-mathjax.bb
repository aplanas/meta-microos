...
RPROVIDES:${PN} += "python3.9dist(jupyter-server-mathjax) python39-jupyter-server-mathjax python3dist(jupyter-server-mathjax)"
RDEPENDS:${PN} += "jupyter-server-mathjax python(abi) python39-jupyter_server"
