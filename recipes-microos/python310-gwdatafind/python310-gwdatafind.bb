...
RPROVIDES:${PN} += "python3-gwdatafind python3.10dist(gwdatafind) python310-gwdatafind python3dist(gwdatafind)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-igwn-auth-utils-requests python310-ligo-segments update-alternatives"
