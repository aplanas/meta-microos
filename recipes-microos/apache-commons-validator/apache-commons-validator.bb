...
RPROVIDES:${PN} += "apache-commons-validator commons-validator jakarta-commons-validator mvn(commons-validator:commons-validator) mvn(commons-validator:commons-validator:pom:) mvn(org.apache.commons:commons-validator) mvn(org.apache.commons:commons-validator:pom:)"
RDEPENDS:${PN} += "commons-beanutils commons-collections commons-digester commons-logging java-headless javapackages-filesystem mvn(commons-beanutils:commons-beanutils) mvn(commons-collections:commons-collections) mvn(commons-digester:commons-digester) mvn(commons-logging:commons-logging) oro"
