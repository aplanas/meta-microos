...
RPROVIDES:${PN} += "ghc-devel(unix-time-0.4.9-DrdwBL0FLhc5jN9Hujlou0) ghc-unix-time-devel ghc-unix-time-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(binary-0.8.9.1) ghc-devel(bytestring-0.11.4.0) ghc-devel(old-time-1.1.0.3-6MrxIvEBZcaI0p7TDiYNU1) ghc-unix-time"
