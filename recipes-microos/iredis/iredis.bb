...
RPROVIDES:${PN} += "iredis python3.10dist(iredis) python3dist(iredis)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Pygments python3-click python3-configobj python3-importlib-resources python3-mistune python3-pendulum python3-prompt_toolkit python3-redis python3-wcwidth"
