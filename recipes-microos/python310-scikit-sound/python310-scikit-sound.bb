...
RPROVIDES:${PN} += "python3-scikit-sound python3.10dist(scikit-sound) python310-scikit-sound python3dist(scikit-sound)"
RDEPENDS:${PN} += "python(abi) python310-PyYAML python310-appdirs python310-docutils python310-pygame python310-scipy"
