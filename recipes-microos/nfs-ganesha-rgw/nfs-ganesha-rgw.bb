...
RPROVIDES:${PN} += "config(nfs-ganesha-rgw) libfsalrgw.so()(64bit) nfs-ganesha-rgw nfs-ganesha-rgw(aarch-64)"
RDEPENDS:${PN} += "ceph-common ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libganesha_nfsd.so.3.3()(64bit) librgw.so.2()(64bit) nfs-ganesha"
