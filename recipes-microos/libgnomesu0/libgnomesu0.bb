...
RPROVIDES:${PN} += "libgnomesu.so.0()(64bit) libgnomesu0 libgnomesu0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libgdk-3.so.0()(64bit) libgdk_pixbuf-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgnomesu libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit)"
