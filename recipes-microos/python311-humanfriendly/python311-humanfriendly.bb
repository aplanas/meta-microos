...
RPROVIDES:${PN} += "python3.11dist(humanfriendly) python311-humanfriendly python3dist(humanfriendly)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311 update-alternatives"
