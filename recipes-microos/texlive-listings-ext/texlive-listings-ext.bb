...
RPROVIDES:${PN} += "tex(listings-ext.sty) texlive-listings-ext"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(listings.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-listings-ext-bin texlive-scripts texlive-scripts-bin"
