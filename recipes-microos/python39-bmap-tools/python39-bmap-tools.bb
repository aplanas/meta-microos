...
RPROVIDES:${PN} += "python3.9dist(bmap-tools) python39-bmap-tools python3dist(bmap-tools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-gpg update-alternatives"
