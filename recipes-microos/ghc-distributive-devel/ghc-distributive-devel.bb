...
RPROVIDES:${PN} += "ghc-devel(distributive-0.6.2.1-GisXwtVaDTaDcC79Nunm79) ghc-distributive-devel ghc-distributive-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(base-orphans-0.8.8.2-Hl8yFKsRlc4HPNXP65SlX8) ghc-devel(tagged-0.8.7-CYOhX22Df3PFW5V1S0dOJa) ghc-devel(transformers-0.5.6.2) ghc-distributive"
