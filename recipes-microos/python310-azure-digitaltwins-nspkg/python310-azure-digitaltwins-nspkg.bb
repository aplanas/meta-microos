...
RPROVIDES:${PN} += "python3-azure-digitaltwins-nspkg python3.10dist(azure-digitaltwins-nspkg) python310-azure-digitaltwins-nspkg python3dist(azure-digitaltwins-nspkg)"
