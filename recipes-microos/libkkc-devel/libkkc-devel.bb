...
RPROVIDES:${PN} += "libkkc-devel libkkc-devel(aarch-64) pkgconfig(kkc-1.0)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config libkkc2 pkgconfig(gee-0.8) pkgconfig(gio-2.0) pkgconfig(gobject-2.0) pkgconfig(json-glib-1.0)"
