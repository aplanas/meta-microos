...
RPROVIDES:${PN} += "libbd_dm-devel libbd_dm-devel(aarch-64) libblockdev-dm-devel"
RDEPENDS:${PN} += "device-mapper-devel dmraid-devel glib2-devel libbd_dm2 libbd_utils-devel systemd-devel"
