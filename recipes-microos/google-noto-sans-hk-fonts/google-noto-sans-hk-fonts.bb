...
RPROVIDES:${PN} += "google-noto-sans-hk-fonts locale(zh_HK;zh_MO) noto-sans-cjkhk noto-sans-cjkhk-fonts noto-sans-hk-fonts scalable-font-zh-HK scalable-font-zh-MO"
RDEPENDS:${PN} += "google-noto-sans-hk-bold-fonts google-noto-sans-hk-regular-fonts"
