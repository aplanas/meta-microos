...
RPROVIDES:${PN} += "application() application(qtodotxt.desktop) mimehandler(text/plain) python3.10dist(qtodotxt) python3dist(qtodotxt) qtodotxt"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 python(abi) python3-dateutil python3-qt5"
