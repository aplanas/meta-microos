...
RPROVIDES:${PN} += "perl(HTTP::Server::PSGI::Net::Server::PreFork) perl(Plack::Handler::Starman) perl(Starman) perl(Starman::Server) perl-Starman"
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(Data::Dump) perl(HTTP::Date) perl(HTTP::Parser::XS) perl(HTTP::Status) perl(Net::Server) perl(Plack) perl(Test::TCP) perl(parent)"
