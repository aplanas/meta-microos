...
RPROVIDES:${PN} += "tex(cntperchap.sty) texlive-cntperchap"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(assoccnt.sty) tex(ifthen.sty) tex(morewrites.sty) tex(xparse.sty) tex(xpatch.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
