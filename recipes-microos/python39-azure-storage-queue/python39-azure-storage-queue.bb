...
RPROVIDES:${PN} += "python3.9dist(azure-storage-queue) python39-azure-storage-queue python3dist(azure-storage-queue)"
RDEPENDS:${PN} += "(python39-typing_extensions >= 4.0.1 if python39-base < 3.8) python(abi) python39-azure-common python39-azure-core python39-azure-nspkg python39-azure-storage-common python39-azure-storage-nspkg python39-cryptography python39-isodate"
