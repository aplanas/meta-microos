...
RPROVIDES:${PN} += "tex(skb.cfg) tex(skb.sty) tex(skbarticle.cls) tex(skbbeamer.cls) tex(skbbook.cls) tex(skblncsbeamer.cls) tex(skblncsppt.cls) tex(skbmoderncv.cls) texlive-skb"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(acronym.sty) tex(beamer.cls) tex(beamerarticle.sty) tex(biblatex.sty) tex(booktabs.sty) tex(colortbl.sty) tex(comment.sty) tex(datetime.sty) tex(dirtree.sty) tex(enumitem.sty) tex(etoolbox.sty) tex(float.sty) tex(gensymb.sty) tex(graphicx.sty) tex(ifpdf.sty) tex(keyval.sty) tex(listings.sty) tex(longtable.sty) tex(memoir.cls) tex(moderncv.cls) tex(optional.sty) tex(pgf.sty) tex(textcomp.sty) tex(units.sty) tex(versions.sty) tex(wasysym.sty) tex(xcolor.sty) tex(xmpmulti.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
