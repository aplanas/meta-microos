...
RPROVIDES:${PN} += "libklu-1_3_9 libklu.so.1()(64bit) libklu1 libklu1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libamd.so.2()(64bit) libbtf.so.1()(64bit) libc.so.6(GLIBC_2.17)(64bit) libcolamd.so.2()(64bit) libsuitesparseconfig.so.5()(64bit)"
