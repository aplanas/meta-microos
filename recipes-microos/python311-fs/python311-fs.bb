...
RPROVIDES:${PN} += "python3.11dist(fs) python311-fs python3dist(fs)"
RDEPENDS:${PN} += "python(abi) python311-appdirs python311-psutil python311-pytz python311-setuptools python311-six"
