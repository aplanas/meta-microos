...
RPROVIDES:${PN} += "tex(cool.sty) texlive-cool"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(amssymb.sty) tex(bbm.sty) tex(coollist.sty) tex(coolstr.sty) tex(forloop.sty) tex(ifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
