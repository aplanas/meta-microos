...
RPROVIDES:${PN} += "ghc-devel(dlist-1.0-BmTLN13CmmLQvuHz7BjP9) ghc-dlist-devel ghc-dlist-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-dlist"
