...
RPROVIDES:${PN} += "python3.11dist(pyscreenshot) python311-pyscreenshot python3dist(pyscreenshot)"
RDEPENDS:${PN} += "python(abi) python311-EasyProcess python311-entrypoint2 python311-jeepney python311-mss xorg-x11-server-extra"
