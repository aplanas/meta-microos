...
RPROVIDES:${PN} += "locale(mate-applet-softupd:en_GB) locale(mate-applet-softupd:en_US) locale(mate-applet-softupd:fr_FR) locale(mate-applet-softupd:pt_BR) locale(mate-applet-softupd:pt_PT) locale(mate-applet-softupd:ru_RU) locale(mate-applet-softupd:zh_CN) mate-applet-softupd-lang mate-applet-softupd-lang-all"
