...
RPROVIDES:${PN} += "GLw1 MesaGLw libGLw.so.1()(64bit) libGLw1 libGLw1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libGL.so.1()(64bit) libX11.so.6()(64bit) libXt.so.6()(64bit) libc.so.6(GLIBC_2.17)(64bit)"
