...
RPROVIDES:${PN} += "python3.11dist(convertdate) python311-convertdate python3dist(convertdate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-PyMeeus update-alternatives"
