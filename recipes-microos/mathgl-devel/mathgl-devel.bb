...
RPROVIDES:${PN} += "cmake(MathGL2) cmake(mathgl2) mathgl-devel mathgl-devel(aarch-64)"
RDEPENDS:${PN} += "cmake libmgl-fltk8 libmgl-glut8 libmgl-mpi8 libmgl-qt5-8 libmgl-wnd8 libmgl-wx8 libmgl8"
