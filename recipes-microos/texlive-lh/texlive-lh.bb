...
RPROVIDES:${PN} += "tex(lh-lcy.sty) tex(lh-lcyccr.sty) tex(lh-lcyxccr.sty) tex(lh-ot2.sty) tex(lh-ot2ccr.sty) tex(lh-ot2xccr.sty) tex(lh-t2accr.sty) tex(lh-t2axccr.sty) tex(lh-t2bccr.sty) tex(lh-t2bxccr.sty) tex(lh-t2cccr.sty) tex(lh-t2cxccr.sty) tex(lh-x2ccr.sty) tex(lh-x2xccr.sty) tex(nfssfox.tex) tex(testfox.tex) tex(testkern.tex) texlive-lh"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-ec texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
