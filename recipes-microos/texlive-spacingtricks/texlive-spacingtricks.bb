...
RPROVIDES:${PN} += "tex(spacingtricks.sty) texlive-spacingtricks"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(centeredline.sty) tex(ifthen.sty) tex(pifont.sty) tex(setspace.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
