...
RPROVIDES:${PN} += "python3-dash python3.10dist(dash) python310-dash python3dist(dash)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Flask python310-Flask-Compress python310-beautifulsoup4 python310-dash-core-components python310-dash-html-components python310-dash-table python310-percy python310-plotly update-alternatives"
