...
RPROVIDES:${PN} += "tex(llncsconf.sty) texlive-llncsconf"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(eso-pic.sty) tex(hyperref.sty) tex(ifthen.sty) tex(rcsinfo.sty) tex(svninfo.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
