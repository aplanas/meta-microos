...
RPROVIDES:${PN} += "libgudev-1_0-devel libgudev-1_0-devel(aarch-64) pkgconfig(gudev-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgudev-1_0-0 pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(libudev) typelib-1_0-GUdev-1_0"
