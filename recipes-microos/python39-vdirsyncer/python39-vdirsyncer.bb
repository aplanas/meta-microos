...
RPROVIDES:${PN} += "python3.9dist(vdirsyncer) python39-vdirsyncer python3dist(vdirsyncer) vdirsyncer"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-aiostream python39-atomicwrites python39-click python39-click-log python39-click-threading python39-requests python39-requests-toolbelt update-alternatives"
