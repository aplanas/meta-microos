...
RPROVIDES:${PN} += "tex(xcharter-otf.sty) texlive-xcharter-math"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(iftex.sty) tex(realscripts.sty) tex(unicode-math.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-xcharter-math-fonts"
