...
RPROVIDES:${PN} += "ruby3.2-rubygem-yast-rake ruby3.2-rubygem-yast-rake(aarch-64) rubygem(ruby:3.2.0:yast-rake) rubygem(ruby:3.2.0:yast-rake:0) rubygem(ruby:3.2.0:yast-rake:0.2) rubygem(ruby:3.2.0:yast-rake:0.2.48) rubygem(yast-rake)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:packaging_rake_tasks) rubygem(ruby:3.2.0:rake)"
