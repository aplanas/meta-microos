...
RPROVIDES:${PN} += "python3.11dist(flake8-docstrings) python311-flake8-docstrings python3dist(flake8-docstrings)"
RDEPENDS:${PN} += "python(abi) python311-flake8 python311-flake8-polyfill python311-pydocstyle"
