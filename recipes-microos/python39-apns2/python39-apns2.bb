...
RPROVIDES:${PN} += "python3.9dist(apns2) python39-apns2 python3dist(apns2)"
RDEPENDS:${PN} += "python(abi) python39-PyJWT python39-cryptography python39-h2 python39-httpx"
