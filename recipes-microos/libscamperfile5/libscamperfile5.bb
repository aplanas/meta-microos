...
RPROVIDES:${PN} += "libscamperfile.so.5()(64bit) libscamperfile5 libscamperfile5(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.36)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libz.so.1()(64bit)"
