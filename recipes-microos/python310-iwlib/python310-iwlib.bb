...
RPROVIDES:${PN} += "python3-iwlib python3.10dist(iwlib) python310-iwlib python310-iwlib(aarch-64) python3dist(iwlib)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libiw.so.30()(64bit) python(abi) python310-cffi"
