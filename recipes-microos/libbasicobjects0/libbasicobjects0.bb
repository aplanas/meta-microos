...
RPROVIDES:${PN} += "libbasicobjects.so.0()(64bit) libbasicobjects.so.0(BASICOBJECTS_0.1.0)(64bit) libbasicobjects.so.0(BASICOBJECTS_0.1.1)(64bit) libbasicobjects0 libbasicobjects0(aarch-64)"
