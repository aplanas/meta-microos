...
RPROVIDES:${PN} += "perl(WWW::PAUSE::CleanUpHomeDir) perl-WWW-PAUSE-CleanUpHomeDir"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Class::Accessor::Grouped) perl(Devel::TakeHashArgs) perl(HTML::TokeParser::Simple) perl(Sort::Versions) perl(URI) perl(WWW::Mechanize)"
