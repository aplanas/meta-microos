...
RPROVIDES:${PN} += "hawk-apiserver hawk-apiserver(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.34)(64bit) libcib.so.27()(64bit) libcrmcommon.so.34()(64bit) libglib-2.0.so.0()(64bit) pacemaker"
