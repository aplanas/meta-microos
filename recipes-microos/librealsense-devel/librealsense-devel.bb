...
RPROVIDES:${PN} += "cmake(realsense2) cmake(realsense2-gl) librealsense-devel librealsense-devel(aarch-64) pkgconfig(realsense2) pkgconfig(realsense2-gl)"
RDEPENDS:${PN} += "/usr/bin/pkg-config librealsense2_53 pkgconfig(realsense2)"
