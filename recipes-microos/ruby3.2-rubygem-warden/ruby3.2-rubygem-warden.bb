...
RPROVIDES:${PN} += "ruby3.2-rubygem-warden ruby3.2-rubygem-warden(aarch-64) rubygem(ruby:3.2.0:warden) rubygem(ruby:3.2.0:warden:1) rubygem(ruby:3.2.0:warden:1.2) rubygem(ruby:3.2.0:warden:1.2.9) rubygem(warden)"
