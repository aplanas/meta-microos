...
RPROVIDES:${PN} += "python3-hypothesmith python3.10dist(hypothesmith) python310-hypothesmith python3dist(hypothesmith)"
RDEPENDS:${PN} += "python(abi) python310-base python310-hypothesis python310-lark python310-libcst"
