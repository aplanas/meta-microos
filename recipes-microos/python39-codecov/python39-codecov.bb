...
RPROVIDES:${PN} += "python3.9dist(codecov) python39-codecov python3dist(codecov)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-coverage python39-requests update-alternatives"
