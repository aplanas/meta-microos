...
RPROVIDES:${PN} += "liblavrec-2.2.so.0()(64bit) liblavrec-2_2-0 liblavrec-2_2-0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) liblavfile-2.2.so.0()(64bit) liblavjpeg-2.2.so.0()(64bit) libmjpegutils-2.2.so.0()(64bit)"
