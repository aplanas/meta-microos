...
RPROVIDES:${PN} += "etrophy-devel etrophy-devel(aarch-64) pkgconfig(etrophy)"
RDEPENDS:${PN} += "/usr/bin/pkg-config efl-devel elementary-devel etrophy-data libetrophy0 pkgconfig(ecore) pkgconfig(ecore-file) pkgconfig(eet) pkgconfig(eina) pkgconfig(elementary) pkgconfig(evas)"
