...
RPROVIDES:${PN} += "python3.9dist(pyramid-debugtoolbar) python39-pyramid-debugtoolbar python3dist(pyramid-debugtoolbar)"
RDEPENDS:${PN} += "python(abi) python39-Pygments python39-pyramid python39-pyramid-mako"
