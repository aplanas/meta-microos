...
RPROVIDES:${PN} += "perl(Net::HTTP) perl(Net::HTTP::Methods) perl(Net::HTTP::NB) perl(Net::HTTPS) perl-Net-HTTP"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Compress::Raw::Zlib) perl(IO::Uncompress::Gunzip) perl(URI)"
