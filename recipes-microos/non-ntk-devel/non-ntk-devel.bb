...
RPROVIDES:${PN} += "non-ntk-devel non-ntk-devel(aarch-64) pkgconfig(ntk) pkgconfig(ntk_gl) pkgconfig(ntk_images)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libntk1 pkgconfig(cairo) pkgconfig(gl) pkgconfig(x11) pkgconfig(xft)"
