...
RPROVIDES:${PN} += "python3-jupyter_notebook-lang python3-notebook-lang python3-notebook-lang-all python310-jupyter_notebook-lang python310-notebook-lang python310-notebook-lang-all"
