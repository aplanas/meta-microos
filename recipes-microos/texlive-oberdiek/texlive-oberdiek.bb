...
RPROVIDES:${PN} += "tex(aliascnt.sty) tex(bmpsize-base.sty) tex(bmpsize-dvipdfm.def) tex(bmpsize-dvipdfmx.def) tex(bmpsize-dvips.def) tex(bmpsize-test.tex) tex(bmpsize.sty) tex(centernot.sty) tex(chemarr.sty) tex(classlist.sty) tex(colonequals.sty) tex(dvipscol.sty) tex(engord.sty) tex(enparen.sty) tex(eolgrab.sty) tex(fibnum.sty) tex(flags.sty) tex(holtxdoc.sty) tex(hypbmsec.sty) tex(hypcap.sty) tex(hypgotoe.sty) tex(hyphsubst.sty) tex(ifdraft.sty) tex(iflang.sty) tex(pdfcolparallel.sty) tex(pdfcolparcolumns.sty) tex(pdfcrypt.sty) tex(pdfrender.sty) tex(protecteddef.sty) tex(resizegather.sty) tex(rotchiffre.sty) tex(scrindex.sty) tex(setouterhbox.sty) tex(settobox.sty) tex(stackrel.sty) tex(stampinclude.sty) tex(tabularht.sty) tex(tabularkv.sty) tex(telprint.sty) tex(thepdfnumber.sty) tex(twoopt.sty) texlive-oberdiek"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(array.sty) tex(atveryend.sty) tex(bigintcalc.sty) tex(etexcmds.sty) tex(fontspec.sty) tex(fp-basic.sty) tex(fp-snap.sty) tex(graphics.sty) tex(hologo.sty) tex(hypdoc.sty) tex(hyperref.sty) tex(iftex.sty) tex(index.sty) tex(infwarerr.sty) tex(intcalc.sty) tex(keyval.sty) tex(kvoptions.sty) tex(kvsetkeys.sty) tex(letltxmacro.sty) tex(ltxcmds.sty) tex(parallel.sty) tex(parcolumns.sty) tex(pdfcol.sty) tex(pdfescape.sty) tex(pdftexcmds.sty) tex(remreset.sty) tex(unicode-math.sty) tex(uniquecounter.sty) tex(zref-base.sty) texlive texlive-auxhook texlive-filesystem texlive-grfext texlive-grffile texlive-iftex texlive-infwarerr texlive-kpathsea texlive-kpathsea-bin texlive-kvoptions texlive-pdftexcmds texlive-scripts texlive-scripts-bin"
