...
RPROVIDES:${PN} += "python3-sphinxcontrib-httpdomain python3.10dist(sphinxcontrib-httpdomain) python310-sphinxcontrib-httpdomain python3dist(sphinxcontrib-httpdomain)"
