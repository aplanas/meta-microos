...
RPROVIDES:${PN} += "PDAL-devel PDAL-devel(aarch-64) cmake(PDAL) libPDAL-devel libPDAL13-devel libpdal-devel libpdal13-devel pkgconfig(pdal)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config cmake laszip-devel libPDAL13 libboost_filesystem-devel libboost_headers-devel libboost_program_options-devel pkgconfig(gdal) pkgconfig(libxml-2.0) xz-devel zlib-devel"
