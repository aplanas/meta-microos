...
RPROVIDES:${PN} += "python3.11dist(pytest-xprocess) python311-pytest-xprocess python3dist(pytest-xprocess)"
RDEPENDS:${PN} += "python(abi) python311-psutil python311-py python311-pytest"
