...
RPROVIDES:${PN} += "python3.11dist(webruntime) python311-webruntime python3dist(webruntime)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-dialite update-alternatives"
