...
RPROVIDES:${PN} += "ghc-dec-devel ghc-dec-devel(aarch-64) ghc-devel(dec-0.0.5-4k85S2UkQTWCpK3j0IuOFm)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-dec ghc-devel(base-4.17.1.0) ghc-devel(boring-0.2.1-J8lJX6Vz53r2bssyBwOtpl)"
