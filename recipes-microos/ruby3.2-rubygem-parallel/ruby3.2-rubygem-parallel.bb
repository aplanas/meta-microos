...
RPROVIDES:${PN} += "ruby3.2-rubygem-parallel ruby3.2-rubygem-parallel(aarch-64) rubygem(parallel) rubygem(ruby:3.2.0:parallel) rubygem(ruby:3.2.0:parallel:1) rubygem(ruby:3.2.0:parallel:1.22) rubygem(ruby:3.2.0:parallel:1.22.1)"
