...
RPROVIDES:${PN} += "bumblebee-status bumblebee-status(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 dbus-1 i3 libX11.so.6()(64bit) libc.so.6(GLIBC_2.34)(64bit) psmisc python3 python3-dbus-python python3-netifaces python3-power python3-psutil python3-pytz python3-requests python3-tzlocal sudo xdg-utils"
