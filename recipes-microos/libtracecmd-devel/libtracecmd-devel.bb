...
RPROVIDES:${PN} += "libtracecmd-devel libtracecmd-devel(aarch-64) pkgconfig(libtracecmd)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libtracecmd1 pkgconfig(libtraceevent) pkgconfig(libtracefs) pkgconfig(libzstd)"
