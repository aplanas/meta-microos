...
RPROVIDES:${PN} += "ruby3.2-rubygem-rainbow ruby3.2-rubygem-rainbow(aarch-64) rubygem(rainbow) rubygem(ruby:3.2.0:rainbow) rubygem(ruby:3.2.0:rainbow:3) rubygem(ruby:3.2.0:rainbow:3.1) rubygem(ruby:3.2.0:rainbow:3.1.1)"
