...
RPROVIDES:${PN} += "typelib(GtkSpell) typelib-1_0-GtkSpell-3_0 typelib-1_0-GtkSpell-3_0(aarch-64)"
RDEPENDS:${PN} += "libgtkspell3-3.so.0()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
