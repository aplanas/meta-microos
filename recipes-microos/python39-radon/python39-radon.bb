...
RPROVIDES:${PN} += "python3.9dist(radon) python39-radon python3dist(radon)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-colorama python39-future python39-mando update-alternatives"
