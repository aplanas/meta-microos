...
RPROVIDES:${PN} += "libetonyek-devel libetonyek-devel(aarch-64) pkgconfig(libetonyek-0.1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libetonyek-0_1-1 libwpd-devel pkgconfig(liblangtag) pkgconfig(librevenge-0.0) pkgconfig(libxml-2.0) pkgconfig(zlib)"
