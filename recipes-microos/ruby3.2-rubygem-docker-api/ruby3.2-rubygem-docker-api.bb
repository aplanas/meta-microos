...
RPROVIDES:${PN} += "ruby3.2-rubygem-docker-api ruby3.2-rubygem-docker-api(aarch-64) rubygem(docker-api) rubygem(ruby:3.2.0:docker-api) rubygem(ruby:3.2.0:docker-api:2) rubygem(ruby:3.2.0:docker-api:2.2) rubygem(ruby:3.2.0:docker-api:2.2.0)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:excon) rubygem(ruby:3.2.0:multi_json)"
