...
RPROVIDES:${PN} += "python3.9dist(pynacl) python39-PyNaCl python39-PyNaCl(aarch-64) python3dist(pynacl)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libsodium.so.23()(64bit) python(abi) python39-cffi"
