...
RPROVIDES:${PN} += "application() application(gcdemu.desktop) gcdemu"
RDEPENDS:${PN} += "/bin/sh /usr/bin/env cdemu-daemon python3-gobject-Gdk typelib(AyatanaAppIndicator3) typelib(GLib) typelib(GObject) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(Notify)"
