...
RPROVIDES:${PN} += "typelib(Mbim) typelib-1_0-Mbim-1_0 typelib-1_0-Mbim-1_0(aarch-64)"
RDEPENDS:${PN} += "libmbim-glib.so.4()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
