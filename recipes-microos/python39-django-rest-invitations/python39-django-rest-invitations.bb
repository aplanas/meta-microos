...
RPROVIDES:${PN} += "python3.9dist(django-rest-invitations) python39-django-rest-invitations python3dist(django-rest-invitations)"
RDEPENDS:${PN} += "python(abi) python39-django-invitations python39-djangorestframework"
