...
RPROVIDES:${PN} += "typelib(BlockDev) typelib-1_0-BlockDev-2_0 typelib-1_0-BlockDev-2_0(aarch-64)"
RDEPENDS:${PN} += "libbd_utils.so.2()(64bit) libblockdev.so.2()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
