...
RPROVIDES:${PN} += "python3.11dist(itemloaders) python311-itemloaders python3dist(itemloaders)"
RDEPENDS:${PN} += "python(abi) python311-itemadapter python311-jmespath python311-parsel python311-w3lib"
