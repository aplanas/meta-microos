...
RPROVIDES:${PN} += "tex(register.sty) texlive-register"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(float.sty) tex(graphicx.sty) tex(ifthen.sty) tex(xcolor.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
