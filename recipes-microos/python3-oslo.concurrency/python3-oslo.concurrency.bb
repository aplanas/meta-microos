...
RPROVIDES:${PN} += "python3-oslo.concurrency python3.10dist(oslo.concurrency) python3dist(oslo.concurrency)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-fasteners python3-oslo.config python3-oslo.i18n python3-oslo.utils"
