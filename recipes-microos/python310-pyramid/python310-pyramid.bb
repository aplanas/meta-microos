...
RPROVIDES:${PN} += "python3-pyramid python3.10dist(pyramid) python310-pyramid python3dist(pyramid)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-PasteDeploy python310-WebOb python310-hupper python310-plaster python310-plaster-pastedeploy python310-setuptools python310-translationstring python310-venusian python310-zope.deprecation python310-zope.interface update-alternatives"
