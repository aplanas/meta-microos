...
RPROVIDES:${PN} += "libfm-devel libfm-devel(aarch-64) pkgconfig(libfm)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libfm libfm4 pkgconfig pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gthread-2.0) pkgconfig(libfm-extra)"
