...
RPROVIDES:${PN} += "perl(DBIx::Class::InflateColumn::FS) perl(DBIx::Class::InflateColumn::FS::ResultSet) perl-DBIx-Class-InflateColumn-FS"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(DBD::SQLite) perl(DBICx::TestDatabase) perl(DBIx::Class) perl(DBIx::Class::UUIDColumns) perl(Path::Class)"
