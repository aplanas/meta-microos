...
RPROVIDES:${PN} += "tex(minitoc.sty) tex(mtcmess.sty) tex(mtcoff.sty) tex(mtcpatchmem.sty) texlive-minitoc"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(flafter.sty) tex(notoccite.sty) tex(placeins.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
