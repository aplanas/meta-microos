...
RPROVIDES:${PN} += "tex(xskak-keys.sty) tex(xskak-nagdef.sty) tex(xskak.sty) texlive-xskak"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(chessboard.sty) tex(etoolbox.sty) tex(xifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
