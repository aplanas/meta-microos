...
RPROVIDES:${PN} += "ghc-devel(hinotify-0.4.1-8EvWCUqnZLR2V2Cj5bSrk3) ghc-hinotify-devel ghc-hinotify-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(async-2.2.4-Is3H7ZPNMkM5reIoCaqYrF) ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(containers-0.6.7) ghc-devel(unix-2.7.3) ghc-hinotify"
