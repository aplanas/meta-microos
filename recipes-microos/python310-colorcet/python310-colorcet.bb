...
RPROVIDES:${PN} += "python3-colorcet python3.10dist(colorcet) python310-colorcet python3dist(colorcet)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-param python310-pyct update-alternatives"
