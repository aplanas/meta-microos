...
RPROVIDES:${PN} += "mvn(nekohtml:nekohtml) mvn(nekohtml:nekohtml:pom:) mvn(net.sourceforge.nekohtml:nekohtml) mvn(net.sourceforge.nekohtml:nekohtml-xni) mvn(net.sourceforge.nekohtml:nekohtml:pom:) nekohtml osgi(org.cyberneko.html)"
RDEPENDS:${PN} += "/bin/bash bcel java-headless javapackages-filesystem javapackages-tools mvn(xerces:xercesImpl) xerces-j2 xml-apis"
