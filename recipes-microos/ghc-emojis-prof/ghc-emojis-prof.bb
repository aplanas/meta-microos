...
RPROVIDES:${PN} += "ghc-emojis-prof ghc-emojis-prof(aarch-64) ghc-prof(emojis-0.1.2-Gz9J6Rv977iEZp4TYp7wAm)"
RDEPENDS:${PN} += "ghc-emojis-devel ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(text-2.0.2)"
