...
RPROVIDES:${PN} += "tex(eu1enc.def) tex(eu1lmdh.fd) tex(eu1lmr.fd) tex(eu1lmss.fd) tex(eu1lmssq.fd) tex(eu1lmtt.fd) tex(eu1lmvtt.fd) tex(eu2enc.def) tex(eu2lmdh.fd) tex(eu2lmr.fd) tex(eu2lmss.fd) tex(eu2lmssq.fd) tex(eu2lmtt.fd) tex(eu2lmvtt.fd) texlive-euenc"
