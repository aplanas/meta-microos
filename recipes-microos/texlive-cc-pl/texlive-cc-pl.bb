...
RPROVIDES:${PN} += "tex(ccpl.map) tex(pccsc10.tfm) tex(pcmi10.tfm) tex(pcr10.tfm) tex(pcr5.tfm) tex(pcr6.tfm) tex(pcr7.tfm) tex(pcr8.tfm) tex(pcr9.tfm) tex(pcsl10.tfm) tex(pcslc9.tfm) tex(pcti10.tfm) texlive-cc-pl"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-cc-pl-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
