...
RPROVIDES:${PN} += "python3.9dist(conu) python39-conu python3dist(conu)"
RDEPENDS:${PN} += "python(abi) python39-docker python39-flexmock python39-kubernetes python39-pytest python39-requests"
