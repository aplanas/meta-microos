...
RPROVIDES:${PN} += "ghc-old-time-prof ghc-old-time-prof(aarch-64) ghc-prof(old-time-1.1.0.3-6MrxIvEBZcaI0p7TDiYNU1)"
RDEPENDS:${PN} += "ghc-old-time-devel ghc-prof(base-4.17.1.0) ghc-prof(old-locale-1.0.0.7-B5o2Qz0CVVSCB1XGw7OfzR)"
