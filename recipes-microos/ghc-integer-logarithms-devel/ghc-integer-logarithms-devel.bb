...
RPROVIDES:${PN} += "ghc-devel(integer-logarithms-1.0.3.1-Hm9v2fsfG1DA5soPSLssZu) ghc-integer-logarithms-devel ghc-integer-logarithms-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(array-0.5.4.0) ghc-devel(base-4.17.1.0) ghc-devel(ghc-bignum-1.3) ghc-devel(ghc-prim-0.9.0) ghc-integer-logarithms"
