...
RPROVIDES:${PN} += "python3.11dist(scikit-sound) python311-scikit-sound python3dist(scikit-sound)"
RDEPENDS:${PN} += "python(abi) python311-PyYAML python311-appdirs python311-docutils python311-pygame python311-scipy"
