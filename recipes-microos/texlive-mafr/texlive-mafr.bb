...
RPROVIDES:${PN} += "tex(cours.cls) tex(fiche.cls) tex(mafr.sty) texlive-mafr"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(a4wide.sty) tex(article.cls) tex(babel.sty) tex(fontenc.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
