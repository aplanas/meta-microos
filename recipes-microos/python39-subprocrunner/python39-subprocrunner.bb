...
RPROVIDES:${PN} += "python3.9dist(subprocrunner) python39-subprocrunner python3dist(subprocrunner)"
RDEPENDS:${PN} += "python(abi) python39-loguru python39-mbstrdecoder python39-typepy"
