...
RPROVIDES:${PN} += "ghc-prof(semver-0.4.0.1-ExZNCX3NISc5JbXfrvXt6N) ghc-semver-prof ghc-semver-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(attoparsec-0.14.4-21v4nlnPs0qLZ5R1FIK9u3) ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-prof(text-2.0.2) ghc-semver-devel"
