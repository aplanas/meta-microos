...
RPROVIDES:${PN} += "cmake(gwengui-cpp) cmake(gwengui-qt5) cmake(gwenhywfar) gwenhywfar-devel gwenhywfar-devel(aarch-64) pkgconfig(gwengui-fox16) pkgconfig(gwengui-gtk2) pkgconfig(gwengui-gtk3) pkgconfig(gwengui-qt5) pkgconfig(gwenhywfar)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/pkg-config glibc-devel libgwengui-fox16-79 libgwengui-gtk2-79 libgwengui-gtk3-79 libgwengui-qt5-79 libgwenhywfar79"
