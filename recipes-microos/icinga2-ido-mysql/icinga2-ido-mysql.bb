...
RPROVIDES:${PN} += "config(icinga2-ido-mysql) icinga2-ido-mysql icinga2-ido-mysql(aarch-64) libmysql_shim.so.2.13.7()(64bit)"
RDEPENDS:${PN} += "/bin/sh icinga2-bin libmariadb.so.3()(64bit) libmariadb.so.3(libmysqlclient_18)(64bit) libstdc++.so.6()(64bit) libstdc++.so.6(CXXABI_1.3)(64bit) libstdc++.so.6(GLIBCXX_3.4)(64bit)"
