...
RPROVIDES:${PN} += "python3-cirq python3.10dist(cirq) python310-cirq python3dist(cirq)"
RDEPENDS:${PN} += "python(abi) python310-cirq-aqt python310-cirq-core python310-cirq-google python310-cirq-ionq python310-cirq-pasqal python310-cirq-web"
