...
RPROVIDES:${PN} += "python3-pyroma python3.10dist(pyroma) python310-pyroma python3dist(pyroma)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Pygments python310-docutils python310-setuptools update-alternatives"
