...
RPROVIDES:${PN} += "ruby3.2-rubygem-mime-types-data ruby3.2-rubygem-mime-types-data(aarch-64) rubygem(mime-types-data) rubygem(ruby:3.2.0:mime-types-data) rubygem(ruby:3.2.0:mime-types-data:3) rubygem(ruby:3.2.0:mime-types-data:3.2022) rubygem(ruby:3.2.0:mime-types-data:3.2022.0105)"
