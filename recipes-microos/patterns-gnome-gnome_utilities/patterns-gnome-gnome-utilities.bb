...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-gnome-gnome_utilities patterns-gnome-gnome_utilities(aarch-64) patterns-openSUSE-gnome_utilities"
RDEPENDS:${PN} += "pattern()"
