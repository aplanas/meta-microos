...
RPROVIDES:${PN} += "python3-scikit-sparse python3.10dist(scikit-sparse) python310-scikit-sparse python310-scikit-sparse(aarch-64) python3dist(scikit-sparse)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcholmod.so.3()(64bit) python(abi) python310-numpy python310-scipy"
