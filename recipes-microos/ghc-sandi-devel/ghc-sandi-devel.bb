...
RPROVIDES:${PN} += "ghc-devel(sandi-0.5-G6Jka3yQQG77V9ypm6cnaU) ghc-sandi-devel ghc-sandi-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(conduit-1.3.4.3-dAZVHPSYjL2zQ4RzAuWi2) ghc-devel(exceptions-0.10.5) ghc-sandi"
