...
RPROVIDES:${PN} += "python3.11dist(tortilla) python311-tortilla python3dist(tortilla)"
RDEPENDS:${PN} += "python(abi) python311-colorama python311-formats python311-httpretty python311-requests python311-six"
