...
RPROVIDES:${PN} += "ghc-devel(unliftio-core-0.2.1.0-AEtYfdyUWlJCLfz2d4hPbj) ghc-unliftio-core-devel ghc-unliftio-core-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(transformers-0.5.6.2) ghc-unliftio-core"
