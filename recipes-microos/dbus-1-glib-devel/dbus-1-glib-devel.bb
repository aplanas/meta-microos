...
RPROVIDES:${PN} += "dbus-1-glib-devel dbus-1-glib-devel(aarch-64) pkgconfig(dbus-glib-1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config dbus-1-glib-tool libdbus-glib-1-2 pkgconfig(dbus-1) pkgconfig(glib-2.0) pkgconfig(gobject-2.0)"
