...
RPROVIDES:${PN} += "python3-matplotlib-tk python310-matplotlib-tk python310-matplotlib-tk(aarch-64)"
RDEPENDS:${PN} += "python(abi) python310-Pillow-tk python310-matplotlib python310-tk tcl"
