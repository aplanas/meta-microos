...
RPROVIDES:${PN} += "tex(gamebook.sty) texlive-gamebook"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(draftwatermark.sty) tex(enumitem.sty) tex(extramarks.sty) tex(fancyhdr.sty) tex(ifthen.sty) tex(prelim2e.sty) tex(scrtime.sty) tex(titlesec.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
