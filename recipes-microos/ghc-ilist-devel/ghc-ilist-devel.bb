...
RPROVIDES:${PN} += "ghc-devel(ilist-0.4.0.1-KsvLIKFcqVNEl2m4LjZZwM) ghc-ilist-devel ghc-ilist-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-ilist"
