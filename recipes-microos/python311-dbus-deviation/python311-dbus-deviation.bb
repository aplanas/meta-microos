...
RPROVIDES:${PN} += "python3.11dist(dbus-deviation) python311-dbus-deviation python3dist(dbus-deviation)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-lxml"
