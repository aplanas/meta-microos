...
RPROVIDES:${PN} += "python3-django-assets python3.10dist(django-assets) python310-django-assets python3dist(django-assets)"
RDEPENDS:${PN} += "python(abi) python310-Django python310-webassets"
