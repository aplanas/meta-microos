...
RPROVIDES:${PN} += "python3.11dist(ldaptor) python311-ldaptor python3dist(ldaptor)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Twisted-tls python311-passlib python311-pyparsing python311-zope.interface update-alternatives"
