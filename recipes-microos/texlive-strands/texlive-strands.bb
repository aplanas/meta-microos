...
RPROVIDES:${PN} += "tex(strands.sty) texlive-strands"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(forarray.sty) tex(ifthen.sty) tex(tikz.sty) tex(xfp.sty) tex(xkeyval.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
