...
RPROVIDES:${PN} += "tex(austrian.ldf) tex(german.ldf) tex(germanb.ldf) tex(naustrian.ldf) tex(ngerman.ldf) tex(ngermanb.ldf) tex(nswissgerman.ldf) tex(swissgerman.ldf) texlive-babel-german"
