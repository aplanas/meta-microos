...
RPROVIDES:${PN} += "python3.11dist(bmap-tools) python311-bmap-tools python3dist(bmap-tools)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-gpg update-alternatives"
