...
RPROVIDES:${PN} += "tex(defpattern.sty) tex(fp-addons.sty) tex(fp-basic.sty) tex(fp-eqn.sty) tex(fp-eval.sty) tex(fp-exp.sty) tex(fp-pas.sty) tex(fp-random.sty) tex(fp-snap.sty) tex(fp-trigo.sty) tex(fp-upn.sty) tex(fp.sty) tex(fp.tex) tex(lfp.sty) texlive-fp"
