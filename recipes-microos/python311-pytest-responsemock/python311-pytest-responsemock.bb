...
RPROVIDES:${PN} += "python3.11dist(pytest-responsemock) python311-pytest-responsemock python3dist(pytest-responsemock)"
RDEPENDS:${PN} += "python(abi) python311-pytest python311-responses"
