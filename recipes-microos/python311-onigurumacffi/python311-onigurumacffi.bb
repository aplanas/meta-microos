...
RPROVIDES:${PN} += "python3.11dist(onigurumacffi) python311-onigurumacffi python311-onigurumacffi(aarch-64) python3dist(onigurumacffi)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libonig.so.5()(64bit) python(abi) python311-cffi"
