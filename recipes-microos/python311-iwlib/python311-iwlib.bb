...
RPROVIDES:${PN} += "python3.11dist(iwlib) python311-iwlib python311-iwlib(aarch-64) python3dist(iwlib)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libiw.so.30()(64bit) python(abi) python311-cffi"
