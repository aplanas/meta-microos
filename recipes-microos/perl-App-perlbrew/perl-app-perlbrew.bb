...
RDEPENDS:${PN} += "/usr/bin/perl perl(:MODULE_COMPAT_5.36.0) perl(CPAN::Perl::Releases) perl(Capture::Tiny) perl(Devel::PatchPerl) perl(ExtUtils::MakeMaker) perl(File::Temp) perl(JSON::PP) perl(Pod::Usage) perl(local::lib)"
