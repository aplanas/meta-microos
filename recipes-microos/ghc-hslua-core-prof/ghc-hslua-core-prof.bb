...
RPROVIDES:${PN} += "ghc-hslua-core-prof ghc-hslua-core-prof(aarch-64) ghc-prof(hslua-core-2.3.1-S0Tmk0QBS1InOMEfkNHVC)"
RDEPENDS:${PN} += "ghc-hslua-core-devel ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(exceptions-0.10.5) ghc-prof(lua-2.3.1-16mGxirchUh4T3oJJYdFzu) ghc-prof(mtl-2.2.2) ghc-prof(text-2.0.2)"
