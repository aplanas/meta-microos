...
RPROVIDES:${PN} += "python3-flasgger python3.10dist(flasgger) python310-flasgger python3dist(flasgger)"
RDEPENDS:${PN} += "python(abi) python310-Flask python310-PyYAML python310-jsonschema python310-mistune python310-six"
