...
RPROVIDES:${PN} += "python3.11dist(psycopg2cffi) python311-psycopg2cffi python311-psycopg2cffi(aarch-64) python3dist(psycopg2cffi)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libpq.so.5()(64bit) python(abi) python311-cffi python311-six"
