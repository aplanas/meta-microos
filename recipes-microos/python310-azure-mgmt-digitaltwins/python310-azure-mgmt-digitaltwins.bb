...
RPROVIDES:${PN} += "python3-azure-mgmt-digitaltwins python3.10dist(azure-mgmt-digitaltwins) python310-azure-mgmt-digitaltwins python3dist(azure-mgmt-digitaltwins)"
