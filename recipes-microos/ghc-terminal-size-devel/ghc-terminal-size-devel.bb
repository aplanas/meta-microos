...
RPROVIDES:${PN} += "ghc-devel(terminal-size-0.3.4-1tPFLsRvnmSGNryq4PMCAd) ghc-terminal-size-devel ghc-terminal-size-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-terminal-size"
