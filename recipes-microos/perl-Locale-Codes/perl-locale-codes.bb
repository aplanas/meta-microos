...
RPROVIDES:${PN} += "perl(Locale::Codes) perl(Locale::Codes::Constants) perl(Locale::Codes::Country) perl(Locale::Codes::Currency) perl(Locale::Codes::LangExt) perl(Locale::Codes::LangFam) perl(Locale::Codes::LangVar) perl(Locale::Codes::Language) perl(Locale::Codes::Script) perl(Locale::Country) perl(Locale::Currency) perl(Locale::Language) perl(Locale::Script) perl-Locale-Codes"
