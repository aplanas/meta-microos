...
RPROVIDES:${PN} += "ghc-hinotify-prof ghc-hinotify-prof(aarch-64) ghc-prof(hinotify-0.4.1-8EvWCUqnZLR2V2Cj5bSrk3)"
RDEPENDS:${PN} += "ghc-hinotify-devel ghc-prof(async-2.2.4-Is3H7ZPNMkM5reIoCaqYrF) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(containers-0.6.7) ghc-prof(unix-2.7.3)"
