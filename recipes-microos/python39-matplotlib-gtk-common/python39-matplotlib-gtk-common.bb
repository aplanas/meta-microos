...
RPROVIDES:${PN} += "python39-matplotlib-gtk-common python39-matplotlib-gtk-common(aarch-64)"
RDEPENDS:${PN} += "gdk-pixbuf-loader-rsvg python(abi) python39-gobject-Gdk python39-gobject-cairo python39-matplotlib python39-matplotlib-cairo"
