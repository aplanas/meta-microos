...
RPROVIDES:${PN} += "docker-compose-switch docker-compose-switch(aarch-64)"
RDEPENDS:${PN} += "/bin/sh docker docker-compose libc.so.6(GLIBC_2.34)(64bit) update-alternatives"
