...
RPROVIDES:${PN} += "ruby3.2-rubygem-trollop ruby3.2-rubygem-trollop(aarch-64) rubygem(ruby:3.2.0:trollop) rubygem(ruby:3.2.0:trollop:2) rubygem(ruby:3.2.0:trollop:2.9) rubygem(ruby:3.2.0:trollop:2.9.10) rubygem(trollop)"
