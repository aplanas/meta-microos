...
RPROVIDES:${PN} += "typelib(Nemo) typelib-1_0-Nemo-3_0 typelib-1_0-Nemo-3_0(aarch-64)"
RDEPENDS:${PN} += "libnemo-extension.so.1()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
