...
RPROVIDES:${PN} += "git-pw python3.9dist(git-pw) python39-git-pw python3dist(git-pw)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 git-core python(abi) python39-arrow python39-click python39-pyaml python39-requests python39-tabulate update-alternatives"
