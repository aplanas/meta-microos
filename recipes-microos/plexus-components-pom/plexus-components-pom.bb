...
RPROVIDES:${PN} += "mvn(org.codehaus.plexus:plexus-components:pom:) plexus-components-pom"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.codehaus.plexus:plexus-component-metadata) mvn(org.codehaus.plexus:plexus:pom:)"
