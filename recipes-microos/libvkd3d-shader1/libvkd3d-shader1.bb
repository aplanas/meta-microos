...
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libSPIRV-Tools-shared-2023.3~rc1.so()(64bit) libc.so.6(GLIBC_2.33)(64bit)"
