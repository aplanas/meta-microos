...
RPROVIDES:${PN} += "python3.9dist(asciimatics) python39-asciimatics python3dist(asciimatics)"
RDEPENDS:${PN} += "python(abi) python39-Pillow python39-curses python39-future python39-pyfiglet python39-wcwidth"
