...
RPROVIDES:${PN} += "python3.9dist(mypy-protobuf) python39-mypy-protobuf python3dist(mypy-protobuf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-protobuf update-alternatives"
