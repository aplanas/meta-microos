...
RPROVIDES:${PN} += "perl(MooseX::ClassAttribute) perl(MooseX::ClassAttribute::Meta::Role::Attribute) perl(MooseX::ClassAttribute::Trait::Application) perl(MooseX::ClassAttribute::Trait::Application::ToClass) perl(MooseX::ClassAttribute::Trait::Application::ToRole) perl(MooseX::ClassAttribute::Trait::Attribute) perl(MooseX::ClassAttribute::Trait::Class) perl(MooseX::ClassAttribute::Trait::Mixin::HasClassAttributes) perl(MooseX::ClassAttribute::Trait::Role) perl(MooseX::ClassAttribute::Trait::Role::Composite) perl-MooseX-ClassAttribute"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(List::Util) perl(Moose) perl(Moose::Exporter) perl(Moose::Meta::Role::Attribute) perl(Moose::Role) perl(Moose::Util) perl(Moose::Util::MetaRole) perl(namespace::autoclean) perl(namespace::clean)"
