...
RPROVIDES:${PN} += "arpack-devel arpack-ng-devel arpack-ng-devel(aarch-64) cmake(arpackng) pkgconfig(arpack) pkgconfig(arpackSolver)"
RDEPENDS:${PN} += "/usr/bin/pkg-config blas-devel gcc-fortran lapack-devel libarpack2 pkgconfig(arpack) pkgconfig(eigen3)"
