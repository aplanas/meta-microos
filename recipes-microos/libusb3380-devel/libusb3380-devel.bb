...
RPROVIDES:${PN} += "libusb3380-devel libusb3380-devel(aarch-64) pkgconfig(libusb3380)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libusb3380-0 pkgconfig(libusb) pkgconfig(libusb-1.0)"
