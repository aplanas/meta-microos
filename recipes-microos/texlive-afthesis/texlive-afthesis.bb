...
RPROVIDES:${PN} += "tex(afthes10.sty) tex(afthes11.sty) tex(afthes12.sty) tex(afthesis.cls) tex(afthesis.sty) texlive-afthesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(caption2.sty) tex(ulem.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
