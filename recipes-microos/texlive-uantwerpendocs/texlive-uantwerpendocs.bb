...
RPROVIDES:${PN} += "tex(beamercolorthemeuantwerpen.sty) tex(beamerfontthemeuantwerpen.sty) tex(beamerinnerthemeuantwerpen.sty) tex(beamerouterthemeuantwerpen.sty) tex(beamerthemeuantwerpen.sty) tex(uantwerpenbamathesis.cls) tex(uantwerpencolorlogoscheme.sty) tex(uantwerpencommonoptions.clo) tex(uantwerpencoursetext.cls) tex(uantwerpenexam.cls) tex(uantwerpenletter.cls) tex(uantwerpenphdthesis.cls) tex(uantwerpenreport.cls) texlive-uantwerpendocs"
