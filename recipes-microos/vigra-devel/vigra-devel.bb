...
RPROVIDES:${PN} += "vigra-devel vigra-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/python3 fftw3-devel hdf5-devel libjpeg-devel libpng-devel libstdc++-devel libtiff-devel libvigraimpex11 openexr-devel python3-base zlib-devel"
