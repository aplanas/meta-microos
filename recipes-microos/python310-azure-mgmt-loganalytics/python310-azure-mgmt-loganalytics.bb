...
RPROVIDES:${PN} += "python3-azure-mgmt-loganalytics python3.10dist(azure-mgmt-loganalytics) python310-azure-mgmt-loganalytics python3dist(azure-mgmt-loganalytics)"
