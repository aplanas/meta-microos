...
RPROVIDES:${PN} += "libgltf-devel libgltf-devel(aarch-64) pkgconfig(libgltf-0.1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glm-devel libgltf-0_1-1 libstdc++-devel pkgconfig(epoxy)"
