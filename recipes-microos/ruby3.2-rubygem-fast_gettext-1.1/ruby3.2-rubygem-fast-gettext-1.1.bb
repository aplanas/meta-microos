...
RPROVIDES:${PN} += "ruby3.2-rubygem-fast_gettext-1.1 ruby3.2-rubygem-fast_gettext-1.1(aarch-64) rubygem(fast_gettext) rubygem(ruby:3.2.0:fast_gettext) rubygem(ruby:3.2.0:fast_gettext:1) rubygem(ruby:3.2.0:fast_gettext:1.1) rubygem(ruby:3.2.0:fast_gettext:1.1.2)"
