...
RPROVIDES:${PN} += "tex(gcomplutum8a.tfm) tex(gcomplutum8a.vf) tex(gcomplutum8r.tfm) tex(gcomplutumo8a.tfm) tex(gcomplutumo8a.vf) tex(gcomplutumo8r.tfm) tex(gfscomplutum.map) tex(gfscomplutum.sty) tex(gpcomplutum.enc) tex(lgrcomplutum.fd) texlive-gfscomplutum"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(updmap.cfg) texlive texlive-filesystem texlive-gfscomplutum-fonts texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
