...
RPROVIDES:${PN} += "python3-azure-synapse python3-azure-synapse-managedprivateendpoints python3.10dist(azure-synapse-managedprivateendpoints) python310-azure-synapse python310-azure-synapse-managedprivateendpoints python3dist(azure-synapse-managedprivateendpoints)"
