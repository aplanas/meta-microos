...
RPROVIDES:${PN} += "libchealpix.so.0()(64bit) libchealpix0 libchealpix0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcfitsio.so.10()(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit)"
