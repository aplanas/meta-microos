...
RPROVIDES:${PN} += "python3-psycopg2cffi python3.10dist(psycopg2cffi) python310-psycopg2cffi python310-psycopg2cffi(aarch-64) python3dist(psycopg2cffi)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libpq.so.5()(64bit) python(abi) python310-cffi python310-six"
