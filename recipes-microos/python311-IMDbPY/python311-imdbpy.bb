...
RPROVIDES:${PN} += "python3.11dist(imdbpy) python311-IMDbPY python3dist(imdbpy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-SQLAlchemy python311-lxml update-alternatives"
