...
RPROVIDES:${PN} += "gcin-anthy gcin-anthy(aarch-64) gcin-anthy-module"
RDEPENDS:${PN} += "/sbin/ldconfig gcin libanthy.so.0()(64bit) libc.so.6(GLIBC_2.17)(64bit) libgdk-3.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit)"
