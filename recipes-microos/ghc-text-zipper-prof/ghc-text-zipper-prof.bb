...
RPROVIDES:${PN} += "ghc-prof(text-zipper-0.12-HAxIdT2NfEj1pbIOe2MIin) ghc-text-zipper-prof ghc-text-zipper-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-prof(deepseq-1.4.8.0) ghc-prof(text-2.0.2) ghc-prof(vector-0.13.0.0-AbjrQrWxuFpAjIHk3G7xsp) ghc-text-zipper-devel"
