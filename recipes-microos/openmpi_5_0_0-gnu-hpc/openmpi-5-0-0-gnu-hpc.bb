...
RPROVIDES:${PN} += "mpi openmpi_5_0_0-gnu-hpc openmpi_5_0_0-gnu-hpc(aarch-64)"
RDEPENDS:${PN} += "/bin/sh gnu-compilers-hpc ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libevent_core-2.1.so.7()(64bit) libhwloc.so.15()(64bit) libopenmpi_5_0_0-gnu-hpc lua-lmod openmpi-runtime-config openssh"
