...
RPROVIDES:${PN} += "autoyast2-utils inst-source-utils perl(ABStructured) perl(ABStructured::saxparser) perl(ABXML) perl(RPMQ)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/perl gpg2 perl-XML-Parser"
