...
RPROVIDES:${PN} += "nauty nauty(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libnauty-2.8.6.so()(64bit) libnautyL1-2.8.6.so()(64bit) libnautyW1-2.8.6.so()(64bit)"
