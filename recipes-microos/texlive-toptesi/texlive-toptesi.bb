...
RPROVIDES:${PN} += "tex(topcoman.sty) tex(topfront.sty) tex(toptesi-dottorale.sty) tex(toptesi-magistrale.sty) tex(toptesi-monografia.sty) tex(toptesi-scudo.sty) tex(toptesi-sss.sty) tex(toptesi.cfg) tex(toptesi.cls) tex(toptesi.sty) texlive-toptesi"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(amsmath.sty) tex(amssymb.sty) tex(amsthm.sty) tex(babel.sty) tex(booktabs.sty) tex(calc.sty) tex(caption.sty) tex(csquotes.sty) tex(etoolbox.sty) tex(fancyvrb.sty) tex(float.sty) tex(fontspec.sty) tex(frontespizio.sty) tex(graphicx.sty) tex(iftex.sty) tex(ifthen.sty) tex(imakeidx.sty) tex(indentfirst.sty) tex(lscape.sty) tex(multirow.sty) tex(nomencl.sty) tex(polyglossia.sty) tex(report.cls) tex(scrextend.sty) tex(setspace.sty) tex(siunitx.sty) tex(subcaption.sty) tex(tabularx.sty) tex(textcomp.sty) tex(trace.sty) tex(unicode-math.sty) tex(xcolor.sty) tex(xkeyval.sty) tex(xparse.sty) tex(xspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
