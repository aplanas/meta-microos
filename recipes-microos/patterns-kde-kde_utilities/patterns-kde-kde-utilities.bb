...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-kde-kde_utilities patterns-openSUSE-kde4_utilities patterns-openSUSE-kde_utilities"
RDEPENDS:${PN} += ""
