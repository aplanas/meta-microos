...
RPROVIDES:${PN} += "python3.9dist(flower) python39-flower python3dist(flower)"
RDEPENDS:${PN} += "python(abi) python39-Babel python39-celery python39-certifi python39-humanize python39-prometheus_client python39-pytz python39-tornado update-alternatives"
