...
RPROVIDES:${PN} += "python3-azure-mgmt-powerbidedicated python3.10dist(azure-mgmt-powerbidedicated) python310-azure-mgmt-powerbidedicated python3dist(azure-mgmt-powerbidedicated)"
