...
RPROVIDES:${PN} += "python3.9dist(terminaltables) python39-terminaltables python3dist(terminaltables)"
RDEPENDS:${PN} += "python(abi) python39-colorama python39-colorclass python39-termcolor"
