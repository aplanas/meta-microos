...
RPROVIDES:${PN} += "tex(fix-tudscrfonts.sty) tex(mathswap.sty) tex(tudscr-gitinfo.sty) tex(tudscrartcl.cls) tex(tudscrbase.sty) tex(tudscrbook.cls) tex(tudscrcolor.sty) tex(tudscrcomp.sty) tex(tudscrdoc.cls) tex(tudscrfonts.sty) tex(tudscrmanual.cls) tex(tudscrmanual.sty) tex(tudscrposter.cls) tex(tudscrreprt.cls) tex(tudscrsupervisor.sty) tex(twocolfix.sty) texlive-tudscr"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(auto-pst-pdf.sty) tex(babel.sty) tex(bm.sty) tex(bookmark.sty) tex(booktabs.sty) tex(calc.sty) tex(caption.sty) tex(csquotes.sty) tex(ellipsis.sty) tex(enumitem.sty) tex(environ.sty) tex(etoolbox.sty) tex(filemod.sty) tex(floatrow.sty) tex(fontenc.sty) tex(fontspec.sty) tex(geometry.sty) tex(graphicx.sty) tex(hologo.sty) tex(hyphsubst.sty) tex(ifplatform.sty) tex(iftex.sty) tex(imakeidx.sty) tex(isodate.sty) tex(kvsetkeys.sty) tex(letltxmacro.sty) tex(listings.sty) tex(lmodern.sty) tex(marginnote.sty) tex(mathastext.sty) tex(newunicodechar.sty) tex(omliwona.fd) tex(omsiwona.fd) tex(pdfpages.sty) tex(pdftexcmds.sty) tex(quoting.sty) tex(ragged2e.sty) tex(scrbase.sty) tex(scrextend.sty) tex(scrhack.sty) tex(scrlayer-scrpage.sty) tex(scrlfile.sty) tex(scrwfile.sty) tex(setspace.sty) tex(shellesc.sty) tex(tabularx.sty) tex(textcomp.sty) tex(tikz.sty) tex(todonotes.sty) tex(trimspaces.sty) tex(units.sty) tex(url.sty) tex(varioref.sty) tex(xcolor.sty) tex(xpatch.sty) tex(xspace.sty) texlive texlive-cbfonts texlive-environ texlive-etoolbox texlive-filesystem texlive-geometry texlive-graphics texlive-greek-inputenc texlive-iwona texlive-koma-script texlive-kpathsea texlive-kpathsea-bin texlive-mathastext texlive-mweights texlive-oberdiek texlive-opensans texlive-scripts texlive-scripts-bin texlive-trimspaces texlive-xcolor texlive-xpatch"
