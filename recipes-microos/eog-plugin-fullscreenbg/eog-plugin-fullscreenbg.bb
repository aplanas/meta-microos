...
RPROVIDES:${PN} += "eog-plugin-fullscreenbg eog-plugin-fullscreenbg(aarch-64) eog-plugins:/usr/lib64/eog/plugins/fullscreenbg.plugin metainfo() metainfo(eog-fullscreenbg.appdata.xml)"
RDEPENDS:${PN} += "eog-plugins-data typelib(Eog) typelib(GObject) typelib(Gdk) typelib(Gio) typelib(Gtk) typelib(PeasGtk)"
