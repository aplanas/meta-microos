...
RPROVIDES:${PN} += "python3.9dist(azure-mgmt-appcomplianceautomation) python39-azure-mgmt-appcomplianceautomation python3dist(azure-mgmt-appcomplianceautomation)"
