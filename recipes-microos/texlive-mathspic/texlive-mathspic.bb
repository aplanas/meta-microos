...
RPROVIDES:${PN} += "tex(mathspic.sty) texlive-mathspic"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl coreutils ed findutils grep perl(Math::Trig) perl(constant) sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-mathspic-bin texlive-scripts texlive-scripts-bin"
