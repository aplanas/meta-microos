...
RPROVIDES:${PN} += "DevIL-devel DevIL-devel(aarch-64) libdevil-devel pkgconfig(IL) pkgconfig(ILU) pkgconfig(ILUT)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libIL1 pkgconfig(IL)"
