...
RPROVIDES:${PN} += "python3-GooseMPL python3.10dist(goosempl) python310-GooseMPL python3dist(goosempl)"
RDEPENDS:${PN} += "python(abi) python310-PyYAML python310-deprecation python310-matplotlib python310-matplotlib-latex python310-numpy python310-scipy texlive-amsfonts texlive-amsmath texlive-tools"
