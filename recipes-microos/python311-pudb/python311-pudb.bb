...
RPROVIDES:${PN} += "python3.11dist(pudb) python311-pudb python3dist(pudb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-Pygments python311-urwid update-alternatives"
