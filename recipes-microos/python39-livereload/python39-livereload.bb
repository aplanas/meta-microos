...
RPROVIDES:${PN} += "python3.9dist(livereload) python39-livereload python3dist(livereload)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-six python39-tornado update-alternatives"
