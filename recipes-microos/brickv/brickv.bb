...
RPROVIDES:${PN} += "application() application(brickv.desktop) brickv python3.10dist(brickv) python3dist(brickv)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-pytz python3-qt5 python3-serial python3-tzlocal"
