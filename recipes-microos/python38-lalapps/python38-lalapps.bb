...
RPROVIDES:${PN} += "python38-lalapps python38-lalapps(aarch-64)"
RDEPENDS:${PN} += "python(abi) python38-h5py python38-lal python38-lalburst python38-lalframe python38-lalinference python38-lalinspiral python38-lalmetaio python38-lalpulsar python38-lalsimulation python38-ligo-lw python38-ligo-segments python38-matplotlib python38-numpy python38-scipy"
