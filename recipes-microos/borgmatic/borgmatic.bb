...
RPROVIDES:${PN} += "borgmatic config(borgmatic) python3.10dist(borgmatic) python3dist(borgmatic)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 borgbackup python(abi) python3-colorama python3-jsonschema python3-pykwalify python3-requests python3-ruamel.yaml python3-setuptools"
