...
RPROVIDES:${PN} += "libXaw3d-devel libXaw3d-devel(aarch-64) pkgconfig(xaw3d) xaw3d-devel xaw3d:/usr/include/X11/Xaw3d/Xaw3dP.h"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXaw3d6 libXaw3d7 libXaw3d8 pkgconfig(x11) pkgconfig(xext) pkgconfig(xmu) pkgconfig(xproto) pkgconfig(xt)"
