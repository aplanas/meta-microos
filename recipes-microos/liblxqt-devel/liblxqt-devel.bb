...
RPROVIDES:${PN} += "cmake(lxqt) liblxqt-devel liblxqt-devel(aarch-64) pkgconfig(lxqt)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblxqt1 pkgconfig pkgconfig(Qt5DBus) pkgconfig(Qt5Widgets) pkgconfig(Qt5X11Extras) pkgconfig(Qt5Xdg) pkgconfig(Qt5Xml)"
