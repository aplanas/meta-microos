...
RPROVIDES:${PN} += "tex(mpgraphics.sty) texlive-mpgraphics"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(color.cfg) tex(color.sty) tex(graphicx.sty) tex(ifpdf.sty) tex(ifplatform.sty) tex(iftex.sty) tex(moreverb.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
