...
RPROVIDES:${PN} += "tex(authorindex.sty) texlive-authorindex"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl coreutils ed findutils grep perl(Getopt::Std) perl(strict) perl(warnings) sed texlive texlive-authorindex-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
