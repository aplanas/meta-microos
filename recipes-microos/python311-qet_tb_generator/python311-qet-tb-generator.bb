...
RPROVIDES:${PN} += "python3.11dist(qet-tb-generator) python311-qet_tb_generator python3dist(qet-tb-generator)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-qt5 qelectrotech update-alternatives"
