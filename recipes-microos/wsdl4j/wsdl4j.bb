...
RPROVIDES:${PN} += "mvn(axis:axis-wsdl4j) mvn(axis:axis-wsdl4j:pom:) mvn(wsdl4j:wsdl4j) mvn(wsdl4j:wsdl4j:pom:) osgi(javax.wsdl) wsdl4j"
RDEPENDS:${PN} += "java java-headless javapackages-filesystem jaxp_parser_impl"
