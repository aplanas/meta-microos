...
RPROVIDES:${PN} += "perl(Log::Dispatch) perl(Log::Dispatch::ApacheLog) perl(Log::Dispatch::Base) perl(Log::Dispatch::Code) perl(Log::Dispatch::Email) perl(Log::Dispatch::Email::MIMELite) perl(Log::Dispatch::Email::MailSend) perl(Log::Dispatch::Email::MailSender) perl(Log::Dispatch::Email::MailSendmail) perl(Log::Dispatch::File) perl(Log::Dispatch::File::Locked) perl(Log::Dispatch::Handle) perl(Log::Dispatch::Null) perl(Log::Dispatch::Output) perl(Log::Dispatch::Screen) perl(Log::Dispatch::Syslog) perl(Log::Dispatch::Types) perl(Log::Dispatch::Vars) perl-Log-Dispatch"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Devel::GlobalDestruction) perl(Dist::CheckConflicts) perl(Module::Runtime) perl(Params::ValidationCompiler) perl(Specio) perl(Specio::Declare) perl(Specio::Exporter) perl(Specio::Library::Builtins) perl(Specio::Library::Numeric) perl(Specio::Library::String) perl(Sys::Syslog) perl(Try::Tiny) perl(namespace::autoclean) perl(parent)"
