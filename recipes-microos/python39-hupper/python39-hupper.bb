...
RPROVIDES:${PN} += "python3.9dist(hupper) python39-hupper python3dist(hupper)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-watchdog update-alternatives"
