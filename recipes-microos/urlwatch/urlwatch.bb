...
RPROVIDES:${PN} += "python3.10dist(urlwatch) python3dist(urlwatch) urlwatch"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-PyYAML python3-appdirs python3-cssselect python3-lxml python3-minidb python3-requests"
