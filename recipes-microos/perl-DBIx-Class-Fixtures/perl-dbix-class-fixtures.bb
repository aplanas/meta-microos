...
RPROVIDES:${PN} += "perl(DBIx::Class::Fixtures) perl(DBIx::Class::Fixtures::DBI) perl(DBIx::Class::Fixtures::DBI::Pg) perl(DBIx::Class::Fixtures::DBI::mysql) perl(DBIx::Class::Fixtures::External::File) perl(DBIx::Class::Fixtures::Schema) perl-DBIx-Class-Fixtures"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Class::Accessor::Grouped) perl(Config::Any) perl(DBIx::Class) perl(DBIx::Class::Schema::Loader) perl(Data::Dump::Streamer) perl(Data::Visitor) perl(DateTime) perl(DateTime::Format::MySQL) perl(DateTime::Format::Pg) perl(DateTime::Format::SQLite) perl(File::Copy::Recursive) perl(File::Temp) perl(Hash::Merge) perl(IO::All) perl(JSON::Syck) perl(Path::Class) perl(Scalar::Util)"
