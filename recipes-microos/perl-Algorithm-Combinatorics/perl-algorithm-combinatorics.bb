...
RPROVIDES:${PN} += "perl(Algorithm::Combinatorics) perl(Algorithm::Combinatorics::Iterator) perl(Algorithm::Combinatorics::JustCoderef) perl-Algorithm-Combinatorics perl-Algorithm-Combinatorics(aarch-64)"
