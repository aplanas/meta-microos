...
RPROVIDES:${PN} += "fcitx-gtk3 fcitx-gtk3(aarch-64)"
RDEPENDS:${PN} += "/bin/sh gtk3-tools ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libfcitx-gclient.so.1()(64bit) libfcitx-utils.so.0()(64bit) libgdk-3.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-3.so.0()(64bit) libpango-1.0.so.0()(64bit) libxkbcommon.so.0()(64bit) libxkbcommon.so.0(V_0.5.0)(64bit)"
