...
RPROVIDES:${PN} += "libdep.so()(64bit) mingw64-cross-binutils mingw64-cross-binutils(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libfl.so.2()(64bit) libm.so.6()(64bit) mingw64-cross-binutils-utils mingw64-filesystem"
