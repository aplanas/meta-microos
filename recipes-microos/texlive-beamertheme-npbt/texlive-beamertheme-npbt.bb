...
RPROVIDES:${PN} += "tex(beamercolorthemeNPBT_EUFOM.sty) tex(beamercolorthemeNPBT_FOM.sty) tex(beamercolorthemeNPBT_FOM_ifes.sty) tex(beamercolorthemeNPBT_SC.sty) tex(beamerouterthemeNPBT_FOM.sty) tex(beamerouterthemeNPBT_FOM_ifes.sty) tex(beamerthemeNPBT.sty) texlive-beamertheme-npbt"
