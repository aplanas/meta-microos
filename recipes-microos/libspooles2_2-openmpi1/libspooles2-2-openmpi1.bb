...
RPROVIDES:${PN} += "libspooles.so.2.2()(64bit) libspooles2_2-openmpi1 libspooles2_2-openmpi1(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit) libmpi.so.12()(64bit)"
