...
RPROVIDES:${PN} += "hdf5-devel hdf5-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh hdf5 hdf5-devel-data libhdf5-200 libhdf5_cpp200 libhdf5_fortran200 libhdf5_hl200 libhdf5_hl_cpp200 libhdf5hl_fortran200 zlib-devel"
