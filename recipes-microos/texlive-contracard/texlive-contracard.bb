...
RPROVIDES:${PN} += "tex(contracard.cls) tex(contracard.sty) texlive-contracard"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(calc.sty) tex(geometry.sty) tex(ifthen.sty) tex(imakeidx.sty) tex(intcalc.sty) tex(textcomp.sty) tex(titlesec.sty) tex(tocloft.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
