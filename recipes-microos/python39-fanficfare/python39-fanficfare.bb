...
RPROVIDES:${PN} += "python3.9dist(fanficfare) python39-fanficfare python3dist(fanficfare)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-beautifulsoup4 python39-chardet python39-cloudscraper python39-html2text python39-html5lib python39-requests-file python39-setuptools update-alternatives"
