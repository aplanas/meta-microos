...
RPROVIDES:${PN} += "tex(fixlatvian.sty) texlive-fixlatvian"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(caption.sty) tex(etoolbox.sty) tex(icomma.sty) tex(indentfirst.sty) tex(perpage.sty) tex(polyglossia.sty) tex(svn-prov.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
