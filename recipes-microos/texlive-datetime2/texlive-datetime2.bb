...
RPROVIDES:${PN} += "tex(datetime2-calc.sty) tex(datetime2.sty) texlive-datetime2"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(pgfcalendar.sty) tex(pgfkeys.sty) tex(tracklang.sty) tex(xkeyval.sty) texlive texlive-etoolbox texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-tracklang texlive-xkeyval"
