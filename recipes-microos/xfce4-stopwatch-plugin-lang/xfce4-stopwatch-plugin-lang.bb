...
locale(xfce4-stopwatch-plugin:en_AU) \
locale(xfce4-stopwatch-plugin:en_CA) \
locale(xfce4-stopwatch-plugin:en_GB) \
...
locale(xfce4-stopwatch-plugin:pt_BR) \
...
locale(xfce4-stopwatch-plugin:zh_CN) \
locale(xfce4-stopwatch-plugin:zh_TW) \
