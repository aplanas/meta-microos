...
RPROVIDES:${PN} += "python3-azure-communication-rooms python3.10dist(azure-communication-rooms) python310-azure-communication-rooms python3dist(azure-communication-rooms)"
