...
RPROVIDES:${PN} += "tex(rerunfilecheck.sty) texlive-rerunfilecheck"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(atveryend.sty) tex(infwarerr.sty) tex(kvoptions.sty) tex(pdftexcmds.sty) tex(uniquecounter.sty) texlive texlive-atveryend texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-uniquecounter"
