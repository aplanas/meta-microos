...
RPROVIDES:${PN} += "perl(Archive::Tar::Wrapper) perl-Archive-Tar-Wrapper"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(CPAN::Meta) perl(File::Which) perl(IPC::Run) perl(Log::Log4perl)"
