...
RPROVIDES:${PN} += "tex(nomencl.sty) texlive-nomencl"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(array.sty) tex(ifthen.sty) tex(longtable.sty) tex(siunitx.sty) tex(tocbasic.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
