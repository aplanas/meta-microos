...
RPROVIDES:${PN} += "tex(numspell-english.sty) tex(numspell-french.sty) tex(numspell-german.sty) tex(numspell-italian.sty) tex(numspell-latin.sty) tex(numspell-magyar.sty) tex(numspell.sty) texlive-numspell"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(iflang.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
