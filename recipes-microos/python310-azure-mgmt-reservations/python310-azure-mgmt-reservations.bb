...
RPROVIDES:${PN} += "python3-azure-mgmt-reservations python3.10dist(azure-mgmt-reservations) python310-azure-mgmt-reservations python3dist(azure-mgmt-reservations)"
