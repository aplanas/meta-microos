...
RPROVIDES:${PN} += "libwebpdemux.so.2()(64bit) libwebpdemux2 libwebpdemux2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libwebp.so.7()(64bit)"
