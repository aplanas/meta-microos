...
RPROVIDES:${PN} += "caribou caribou(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libatspi.so.0()(64bit) libc.so.6(GLIBC_2.34)(64bit) libgdk-3.so.0()(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libwayland-server.so.0()(64bit) python(abi) python3-atspi python3-xml typelib(Caribou) typelib(Clutter) typelib(GLib) typelib(GObject) typelib(Gdk) typelib(Gio) typelib(Gtk)"
