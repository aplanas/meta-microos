...
RPROVIDES:${PN} += "gnulib gnulib-devel"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl /usr/bin/python3 bison coreutils diffutils gettext-devel gperf libtool make patch texinfo"
