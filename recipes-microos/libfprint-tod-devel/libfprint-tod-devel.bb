...
RPROVIDES:${PN} += "libfprint-tod-devel libfprint-tod-devel(aarch-64) pkgconfig(libfprint-2-tod-1)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libfprint libfprint-2-tod1 libfprint-devel libfprint-tod pkgconfig(glib-2.0) pkgconfig(gudev-1.0) pkgconfig(gusb) pkgconfig(libfprint-2) pkgconfig(nss) pkgconfig(pixman-1)"
