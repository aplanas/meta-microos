...
RPROVIDES:${PN} += "liblangtag-devel liblangtag-devel(aarch-64) pkgconfig(liblangtag)"
RDEPENDS:${PN} += "/usr/bin/pkg-config liblangtag1 pkgconfig(glib-2.0) pkgconfig(libxml-2.0)"
