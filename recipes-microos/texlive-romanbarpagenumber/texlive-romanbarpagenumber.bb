...
RPROVIDES:${PN} += "tex(romanbarpagenumber.sty) texlive-romanbarpagenumber"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(kvoptions.sty) tex(romanbar.sty) tex(xifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
