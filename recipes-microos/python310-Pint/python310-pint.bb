...
RPROVIDES:${PN} += "python3-Pint python3.10dist(pint) python310-Pint python3dist(pint)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/env /usr/bin/python3.10 python(abi) python310-importlib-metadata python310-importlib-resources python310-packaging python310-uncertainties"
