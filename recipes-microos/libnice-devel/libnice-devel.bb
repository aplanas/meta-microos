...
RPROVIDES:${PN} += "libnice-devel libnice-devel(aarch-64) libnice-doc pkgconfig(nice)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libnice10 pkgconfig(gio-2.0) pkgconfig(gnutls) pkgconfig(gthread-2.0) pkgconfig(gupnp-igd-1.6) typelib-1_0-Nice-0_1"
