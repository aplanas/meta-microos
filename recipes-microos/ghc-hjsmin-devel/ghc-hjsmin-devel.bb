...
RPROVIDES:${PN} += "ghc-devel(hjsmin-0.2.1-G11T0ofJtyz5gQQf6GRgL1) ghc-hjsmin-devel ghc-hjsmin-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(bytestring-0.11.4.0) ghc-devel(language-javascript-0.7.1.0-3FqnIQtG3956Mxug7EpqjM) ghc-devel(text-2.0.2) ghc-hjsmin"
