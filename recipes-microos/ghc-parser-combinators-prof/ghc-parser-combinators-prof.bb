...
RPROVIDES:${PN} += "ghc-parser-combinators-prof ghc-parser-combinators-prof(aarch-64) ghc-prof(parser-combinators-1.3.0-69OkkuibEVDB76y6u8xJBt)"
RDEPENDS:${PN} += "ghc-parser-combinators-devel ghc-prof(base-4.17.1.0)"
