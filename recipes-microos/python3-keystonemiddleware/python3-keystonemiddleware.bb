...
RPROVIDES:${PN} += "python3-keystonemiddleware python3.10dist(keystonemiddleware) python3dist(keystonemiddleware)"
RDEPENDS:${PN} += "python(abi) python3-WebOb python3-keystoneauth1 python3-keystoneclient python3-oslo.cache python3-oslo.config python3-oslo.context python3-oslo.i18n python3-oslo.log python3-oslo.messaging python3-oslo.serialization python3-oslo.utils python3-pycadf python3-python-memcached python3-requests"
