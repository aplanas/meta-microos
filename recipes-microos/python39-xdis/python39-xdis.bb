...
RPROVIDES:${PN} += "python3.9dist(xdis) python39-xdis python3dist(xdis)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-click python39-setuptools python39-six update-alternatives"
