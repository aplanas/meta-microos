...
RPROVIDES:${PN} += "python38-lalsimulation python38-lalsimulation(aarch-64)"
RDEPENDS:${PN} += "lalsimulation-data ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) liblal.so.20()(64bit) liblalsimulation.so.31()(64bit) liblalsupport.so.14()(64bit) python(abi) python38-lal python38-numpy"
