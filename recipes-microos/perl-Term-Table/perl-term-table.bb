...
RPROVIDES:${PN} += "perl(Term::Table) perl(Term::Table::Cell) perl(Term::Table::CellStack) perl(Term::Table::HashBase) perl(Term::Table::LineBreak) perl(Term::Table::Spacer) perl(Term::Table::Util) perl-Term-Table"
