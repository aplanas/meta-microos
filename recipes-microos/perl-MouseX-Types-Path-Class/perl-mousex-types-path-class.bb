...
RPROVIDES:${PN} += "perl(MouseX::Types::Path::Class) perl-MouseX-Types-Path-Class"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Mouse) perl(MouseX::Types) perl(Path::Class)"
