...
RPROVIDES:${PN} += "perl(Protocol::WebSocket) perl(Protocol::WebSocket::Client) perl(Protocol::WebSocket::Cookie) perl(Protocol::WebSocket::Cookie::Request) perl(Protocol::WebSocket::Cookie::Response) perl(Protocol::WebSocket::Frame) perl(Protocol::WebSocket::Handshake) perl(Protocol::WebSocket::Handshake::Client) perl(Protocol::WebSocket::Handshake::Server) perl(Protocol::WebSocket::Message) perl(Protocol::WebSocket::Request) perl(Protocol::WebSocket::Response) perl(Protocol::WebSocket::Stateful) perl(Protocol::WebSocket::URL) perl-Protocol-WebSocket"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Digest::SHA)"
