...
RPROVIDES:${PN} += "ghc-prof(these-1.1.1.1-3POHYes25uBIW53bcrDd39) ghc-these-prof ghc-these-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(assoc-1.0.2-IAwklVGxRFw6xcadvaWWl7) ghc-prof(base-4.17.1.0) ghc-prof(binary-0.8.9.1) ghc-prof(deepseq-1.4.8.0) ghc-prof(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-these-devel"
