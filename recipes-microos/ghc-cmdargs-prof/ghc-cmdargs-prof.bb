...
RPROVIDES:${PN} += "ghc-cmdargs-prof ghc-cmdargs-prof(aarch-64) ghc-prof(cmdargs-0.10.22-JxALoPeruUH3tSM40P8Mx)"
RDEPENDS:${PN} += "ghc-cmdargs-devel ghc-prof(base-4.17.1.0) ghc-prof(filepath-1.4.2.2) ghc-prof(process-1.6.16.0) ghc-prof(template-haskell-2.19.0.0) ghc-prof(transformers-0.5.6.2)"
