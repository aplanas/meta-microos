...
RPROVIDES:${PN} += "python3-spglib python3-spglib(aarch-64) python3.10dist(spglib) python3dist(spglib)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python3-numpy"
