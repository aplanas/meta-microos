...
RPROVIDES:${PN} += "python3.9dist(bloscpack) python39-bloscpack python3dist(bloscpack)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-blosc python39-numpy update-alternatives"
