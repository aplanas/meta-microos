...
RPROVIDES:${PN} += "python3-jupyter-events python3-jupyter_events python3.10dist(jupyter-events) python310-jupyter-events python310-jupyter_events python3dist(jupyter-events)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 alts python(abi) python310-PyYAML python310-jsonschema-format-nongpl python310-python-json-logger python310-rfc3339-validator python310-rfc3986-validator python310-traitlets"
