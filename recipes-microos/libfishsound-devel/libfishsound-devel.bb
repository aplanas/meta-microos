...
RPROVIDES:${PN} += "libfishsound-devel libfishsound-devel(aarch-64) pkgconfig(fishsound)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libfishsound1 pkgconfig(flac) pkgconfig(speex) pkgconfig(vorbis) pkgconfig(vorbisenc)"
