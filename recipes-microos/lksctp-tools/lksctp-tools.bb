...
RPROVIDES:${PN} += "libsctp.so.1()(64bit) libsctp.so.1(VERS_1)(64bit) libsctp.so.1(VERS_2)(64bit) libsctp.so.1(VERS_3)(64bit) libwithsctp.so.1()(64bit) lksctp-tools lksctp-tools(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit)"
