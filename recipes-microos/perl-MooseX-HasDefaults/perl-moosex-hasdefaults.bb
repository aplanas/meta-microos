...
RPROVIDES:${PN} += "perl(MooseX::HasDefaults) perl(MooseX::HasDefaults::Meta::IsRO) perl(MooseX::HasDefaults::Meta::IsRW) perl(MooseX::HasDefaults::RO) perl(MooseX::HasDefaults::RW) perl-MooseX-HasDefaults"
