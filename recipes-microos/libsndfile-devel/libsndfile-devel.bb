...
RPROVIDES:${PN} += "cmake(SndFile) libsndd libsndfile-devel libsndfile-devel(aarch-64) pkgconfig(sndfile)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glibc-devel libsndfile1 libstdc++-devel pkgconfig(flac) pkgconfig(ogg) pkgconfig(opus) pkgconfig(speex) pkgconfig(vorbis) pkgconfig(vorbisenc)"
