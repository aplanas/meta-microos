...
RPROVIDES:${PN} += "python3.9dist(netpbmfile) python39-netpbmfile python3dist(netpbmfile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-matplotlib python39-numpy update-alternatives"
