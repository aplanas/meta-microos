...
RPROVIDES:${PN} += "armnn-devel armnn-devel(aarch-64) cmake(Armnn)"
RDEPENDS:${PN} += "armnn libarmnn32 libarmnnBasePipeServer32 libarmnnSerializer32 libarmnnTestUtils2 libarmnnTfLiteParser24 libtimelineDecoder32 libtimelineDecoderJson32"
