...
RPROVIDES:${PN} += "libloadpng.so.4.4()(64bit) libloadpng4_4 libloadpng4_4(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) liballeg.so.4.4()(64bit) libc.so.6(GLIBC_2.17)(64bit) libpng16.so.16()(64bit) libpng16.so.16(PNG16_0)(64bit)"
