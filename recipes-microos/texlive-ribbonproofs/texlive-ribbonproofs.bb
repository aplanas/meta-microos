...
RPROVIDES:${PN} += "tex(ribbonproofs.sty) texlive-ribbonproofs"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etextools.sty) tex(tikz.sty) tex(xcolor.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
