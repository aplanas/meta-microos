...
RPROVIDES:${PN} += "jboss-parent mvn(org.jboss:jboss-parent:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.apache.maven.plugins:maven-source-plugin)"
