...
RPROVIDES:${PN} += "ghc-cereal-prof ghc-cereal-prof(aarch-64) ghc-prof(cereal-0.5.8.3-LNsxCTyOF85AKtb4iLTs8f)"
RDEPENDS:${PN} += "ghc-cereal-devel ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(containers-0.6.7) ghc-prof(ghc-prim-0.9.0)"
