...
RPROVIDES:${PN} += "liballegro_memfile.so.5.2()(64bit) liballegro_memfile5_2 liballegro_memfile5_2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig liballegro.so.5.2()(64bit) libc.so.6(GLIBC_2.17)(64bit)"
