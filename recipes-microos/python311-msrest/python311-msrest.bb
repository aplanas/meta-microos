...
RPROVIDES:${PN} += "python3.11dist(msrest) python311-msrest python3dist(msrest)"
RDEPENDS:${PN} += "python(abi) python311-azure-core python311-certifi python311-isodate python311-requests python311-requests-oauthlib"
