...
RPROVIDES:${PN} += "findbugs-bcel mvn(com.google.code.findbugs:bcel) mvn(com.google.code.findbugs:bcel-findbugs) mvn(com.google.code.findbugs:bcel-findbugs:pom:) mvn(com.google.code.findbugs:bcel:pom:)"
