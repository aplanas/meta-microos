...
RPROVIDES:${PN} += "libgweather4-devel libgweather4-devel(aarch-64) pkgconfig(gweather4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libgweather-4-0 pkgconfig(geocode-glib-2.0) pkgconfig(gio-2.0) pkgconfig(json-glib-1.0) pkgconfig(libsoup-3.0) pkgconfig(libxml-2.0) typelib-1_0-GWeather-4_0"
