...
RPROVIDES:${PN} += "tex(to-be-determined.sty) texlive-to-be-determined"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(soul.sty) tex(xcolor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-soul texlive-xcolor"
