...
RPROVIDES:${PN} += "libexiv2python.cpython-310-aarch64-linux-gnu.so()(64bit) python3-exiv2 python3.10dist(py3exiv2) python310-exiv2 python310-exiv2(aarch-64) python3dist(py3exiv2)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libboost_python-py3.so.1.82.0()(64bit) libc.so.6(GLIBC_2.32)(64bit) libexiv2.so.27()(64bit) libgcc_s.so.1()(64bit) libgcc_s.so.1(GCC_3.0)(64bit) libstdc++.so.6()(64bit) libstdc++.so.6(CXXABI_1.3)(64bit) libstdc++.so.6(GLIBCXX_3.4)(64bit) libstdc++.so.6(GLIBCXX_3.4.21)(64bit) libstdc++.so.6(GLIBCXX_3.4.9)(64bit) python(abi)"
