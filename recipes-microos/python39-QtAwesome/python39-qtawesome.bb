...
RPROVIDES:${PN} += "python3.9dist(qtawesome) python39-QtAwesome python3dist(qtawesome)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-QtPy update-alternatives"
