...
RPROVIDES:${PN} += "ruby3.2-rubygem-xmlrpc \
ruby3.2-rubygem-xmlrpc(aarch-64) \
rubygem(ruby:3.2.0:xmlrpc) \
rubygem(ruby:3.2.0:xmlrpc:0) \
rubygem(ruby:3.2.0:xmlrpc:0.3) \
rubygem(ruby:3.2.0:xmlrpc:0.3.2) \
rubygem(xmlrpc)"
