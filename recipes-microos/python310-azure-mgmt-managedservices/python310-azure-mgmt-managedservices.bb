...
RPROVIDES:${PN} += "python3-azure-mgmt-managedservices python3.10dist(azure-mgmt-managedservices) python310-azure-mgmt-managedservices python3dist(azure-mgmt-managedservices)"
