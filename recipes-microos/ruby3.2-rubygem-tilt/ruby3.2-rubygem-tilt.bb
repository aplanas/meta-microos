...
RPROVIDES:${PN} += "ruby3.2-rubygem-tilt ruby3.2-rubygem-tilt(aarch-64) rubygem(ruby:3.2.0:tilt) rubygem(ruby:3.2.0:tilt:2) rubygem(ruby:3.2.0:tilt:2.0) rubygem(ruby:3.2.0:tilt:2.0.11) rubygem(tilt)"
