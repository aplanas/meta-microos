...
RPROVIDES:${PN} += "python3.11dist(stestr) python311-stestr python3dist(stestr)"
RDEPENDS:${PN} += "python(abi) python311-PyYAML python311-fixtures python311-future python311-pbr python311-python-subunit python311-testtools python311-voluptuous"
