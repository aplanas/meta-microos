...
RPROVIDES:${PN} += "cmake(FreeGLUT) freeglut-devel freeglut-devel(aarch-64) mesaglut-devel pkgconfig(glut)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libglut3 pkgconfig(gl) pkgconfig(glu)"
