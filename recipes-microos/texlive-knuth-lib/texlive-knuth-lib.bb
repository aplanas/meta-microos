...
RPROVIDES:${PN} += "tex(logo10.tfm) tex(logo8.tfm) tex(logo9.tfm) tex(logobf10.tfm) tex(logosl10.tfm) tex(manfnt.tfm) tex(manmac.tex) tex(mftmac.tex) tex(null.tex) tex(story.tex) tex(testfont.tex) tex(webmac.tex) texlive-knuth-lib texlive-misc"
