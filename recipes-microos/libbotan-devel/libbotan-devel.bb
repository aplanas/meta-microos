...
RPROVIDES:${PN} += "Botan-devel libbotan-devel libbotan-devel(aarch-64) pkgconfig(botan-2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libbotan-2-19 libbz2-devel pkgconfig(liblzma) pkgconfig(sqlite3) trousers-devel"
