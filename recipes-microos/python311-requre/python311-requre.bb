...
RPROVIDES:${PN} += "python3.11dist(requre) python311-requre python3dist(requre)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-GitPython python311-PyYAML python311-click python311-requests"
