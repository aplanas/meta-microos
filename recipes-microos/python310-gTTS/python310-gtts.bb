...
RPROVIDES:${PN} += "python3-gTTS python3.10dist(gtts) python310-gTTS python3dist(gtts)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-beautifulsoup4 python310-click python310-gTTS-token python310-requests python310-setuptools python310-six update-alternatives"
