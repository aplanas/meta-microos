...
RPROVIDES:${PN} += "python3.9dist(azure-cognitiveservices-vision-nspkg) python39-azure-cognitiveservices-vision-nspkg python3dist(azure-cognitiveservices-vision-nspkg)"
