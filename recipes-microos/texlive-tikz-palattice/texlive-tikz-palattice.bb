...
RPROVIDES:${PN} += "tex(tikz-palattice.sty) texlive-tikz-palattice"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(iflang.sty) tex(ifthen.sty) tex(siunitx.sty) tex(tikz.sty) tex(xargs.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
