...
RPROVIDES:${PN} += "ghc-devel(th-abstraction-0.4.5.0-8bY5lBPMorfFW3yG6gFNZT) ghc-th-abstraction-devel ghc-th-abstraction-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(containers-0.6.7) ghc-devel(ghc-prim-0.9.0) ghc-devel(template-haskell-2.19.0.0) ghc-th-abstraction"
