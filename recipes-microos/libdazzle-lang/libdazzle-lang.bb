...
RPROVIDES:${PN} += "libdazzle-lang libdazzle-lang-all locale(libdazzle:de) locale(libdazzle:es) locale(libdazzle:eu) locale(libdazzle:pl) locale(libdazzle:sv) locale(libdazzle:uk) locale(libdazzle:zh_CN)"
