...
RPROVIDES:${PN} += "python3.11dist(argon2-cffi-bindings) python311-argon2-cffi-bindings python311-argon2-cffi-bindings(aarch-64) python311-argon2_cffi_bindings python3dist(argon2-cffi-bindings)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libargon2.so.1()(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-cffi"
