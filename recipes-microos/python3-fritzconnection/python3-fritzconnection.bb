...
RPROVIDES:${PN} += "python3-fritzconnection python3.10dist(fritzconnection) python3dist(fritzconnection)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-lxml python3-requests python3-setuptools"
