...
RPROVIDES:${PN} += "tex(pst-func.sty) tex(pst-func.tex) texlive-pst-func"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(pst-math.sty) tex(pst-plot.sty) tex(pst-tools.sty) tex(pst-xkey.sty) tex(pstricks-add.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
