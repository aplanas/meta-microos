...
RPROVIDES:${PN} += "perl(TryCatch) perl-TryCatch perl-TryCatch(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.17)(64bit) perl(:MODULE_COMPAT_5.36.0) perl(B::Hooks::EndOfScope) perl(B::Hooks::OP::Check) perl(B::Hooks::OP::PPAddr) perl(Devel::Declare) perl(Moose) perl(MooseX::Types) perl(Parse::Method::Signatures) perl(Scope::Upper) perl(Sub::Exporter) perl(Variable::Magic) perl(namespace::clean)"
