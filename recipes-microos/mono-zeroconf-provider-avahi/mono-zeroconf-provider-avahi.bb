...
RPROVIDES:${PN} += "mono(Mono.Zeroconf.Providers.AvahiDBus) mono-zeroconf-provider mono-zeroconf-provider-avahi"
RDEPENDS:${PN} += "avahi mono(Mono.Posix) mono(Mono.Zeroconf) mono(System) mono(System.Xml) mono(mscorlib)"
