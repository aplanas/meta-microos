...
RPROVIDES:${PN} += "libglade2-devel libglade2-devel(aarch-64) pkgconfig(libglade-2.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config /usr/bin/python3 libglade-2_0-0 pkgconfig(gtk+-2.0) pkgconfig(libxml-2.0)"
