...
RPROVIDES:${PN} += "maven-surefire-plugin mvn(org.apache.maven.plugins:maven-surefire-plugin) mvn(org.apache.maven.plugins:maven-surefire-plugin:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(commons-io:commons-io) mvn(org.apache.commons:commons-lang3) mvn(org.apache.maven.surefire:maven-surefire-common)"
