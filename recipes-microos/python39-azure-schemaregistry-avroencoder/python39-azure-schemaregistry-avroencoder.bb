...
RPROVIDES:${PN} += "python3.9dist(azure-schemaregistry-avroencoder) python39-azure-schemaregistry-avroencoder python3dist(azure-schemaregistry-avroencoder)"
RDEPENDS:${PN} += "python(abi) python39-avro python39-azure-nspkg python39-azure-schemaregistry python39-typing_extensions"
