...
RPROVIDES:${PN} += "pkgconfig(xmlsec1-openssl) xmlsec1-openssl-devel xmlsec1-openssl-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libxmlsec1-openssl1 pkgconfig(libxml-2.0) pkgconfig(libxslt) xmlsec1-devel"
