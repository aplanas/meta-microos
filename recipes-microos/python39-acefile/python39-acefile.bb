...
RPROVIDES:${PN} += "python3.9dist(acefile) python39-acefile python39-acefile(aarch-64) python3dist(acefile)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-setuptools update-alternatives"
