...
RPROVIDES:${PN} += "config(gnome-branding-MicroOS) gnome-branding-MicroOS"
RDEPENDS:${PN} += "/bin/sh flatpak gio-branding-openSUSE sound-theme-freedesktop transactional-update zenity"
