...
RPROVIDES:${PN} += "cmake(ginac) ginac-devel ginac-devel(aarch-64) libginac-devel pkgconfig(ginac)"
RDEPENDS:${PN} += "/usr/bin/pkg-config cln-devel libginac11 pkgconfig(cln)"
