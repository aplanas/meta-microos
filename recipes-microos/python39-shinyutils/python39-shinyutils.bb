...
RPROVIDES:${PN} += "python3.9dist(shinyutils) python39-shinyutils python3dist(shinyutils)"
RDEPENDS:${PN} += "python(abi) python39-crayons python39-matplotlib python39-seaborn"
