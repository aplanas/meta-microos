...
RPROVIDES:${PN} += "python3-dulwich python3.10dist(dulwich) python310-dulwich python310-dulwich(aarch-64) python3dist(dulwich)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-urllib3 update-alternatives"
