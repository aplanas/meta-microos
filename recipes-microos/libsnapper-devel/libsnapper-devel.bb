...
RPROVIDES:${PN} += "libsnapper-devel libsnapper-devel(aarch-64)"
RDEPENDS:${PN} += "gcc-c++ libacl-devel libboost_headers-devel libbtrfs-devel libmount-devel libsnapper7 libstdc++-devel libxml2-devel"
