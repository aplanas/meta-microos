...
RPROVIDES:${PN} += "python3-python-afl python3-python_afl python3.10dist(python-afl) python310-python-afl python310-python-afl(aarch-64) python310-python_afl python3dist(python-afl)"
RDEPENDS:${PN} += "/bin/sh afl ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) update-alternatives"
