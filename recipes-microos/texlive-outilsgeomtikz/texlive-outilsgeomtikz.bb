...
RPROVIDES:${PN} += "tex(OutilsGeomTikz.sty) texlive-outilsgeomtikz"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(nicefrac.sty) tex(pgffor.sty) tex(simplekv.sty) tex(tikz.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
