...
RPROVIDES:${PN} += "libcsync-plugin-owncloud libcsync-plugin-owncloud(aarch-64)"
RDEPENDS:${PN} += "libc.so.6(GLIBC_2.33)(64bit) libcsync.so.0()(64bit) libcsync0 libneon.so.27()(64bit)"
