...
RPROVIDES:${PN} += "libmbim-devel libmbim-devel(aarch-64) pkgconfig(mbim-glib)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libmbim-glib4 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0)"
