...
RPROVIDES:${PN} += "typelib(GUPnPDLNAGst) typelib-1_0-GUPnPDLNAGst-2_0 typelib-1_0-GUPnPDLNAGst-2_0(aarch-64)"
RDEPENDS:${PN} += "libgupnp-dlna-gst-2.0.so.4()(64bit) typelib(GLib) typelib(GModule) typelib(GObject) typelib(GUPnPDLNA) typelib(Gst) typelib(GstAudio) typelib(GstBase) typelib(GstPbutils) typelib(GstVideo)"
