...
RPROVIDES:${PN} += "ruby3.2-rubygem-prawn ruby3.2-rubygem-prawn(aarch-64) rubygem(prawn) rubygem(ruby:3.2.0:prawn) rubygem(ruby:3.2.0:prawn:2) rubygem(ruby:3.2.0:prawn:2.4) rubygem(ruby:3.2.0:prawn:2.4.0)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:pdf-core:0.9) rubygem(ruby:3.2.0:ttfunk:1)"
