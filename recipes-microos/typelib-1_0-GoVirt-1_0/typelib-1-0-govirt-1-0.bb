...
RPROVIDES:${PN} += "typelib(GoVirt) typelib-1_0-GoVirt-1_0 typelib-1_0-GoVirt-1_0(aarch-64)"
RDEPENDS:${PN} += "libgovirt.so.2()(64bit) typelib(GLib) typelib(GObject) typelib(Gio) typelib(Rest) typelib(Soup)"
