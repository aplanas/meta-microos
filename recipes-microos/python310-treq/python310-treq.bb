...
RPROVIDES:${PN} += "python3-treq python3.10dist(treq) python310-treq python3dist(treq)"
RDEPENDS:${PN} += "python(abi) python310-Twisted-tls python310-attrs python310-hyperlink python310-incremental python310-requests"
