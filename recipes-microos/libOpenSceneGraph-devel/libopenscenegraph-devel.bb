...
RPROVIDES:${PN} += "libOpenSceneGraph-devel libOpenSceneGraph-devel(aarch-64) pkgconfig(openscenegraph) pkgconfig(openscenegraph-osg) pkgconfig(openscenegraph-osgAnimation) pkgconfig(openscenegraph-osgDB) pkgconfig(openscenegraph-osgFX) pkgconfig(openscenegraph-osgGA) pkgconfig(openscenegraph-osgManipulator) pkgconfig(openscenegraph-osgParticle) pkgconfig(openscenegraph-osgShadow) pkgconfig(openscenegraph-osgSim) pkgconfig(openscenegraph-osgTerrain) pkgconfig(openscenegraph-osgText) pkgconfig(openscenegraph-osgUtil) pkgconfig(openscenegraph-osgViewer) pkgconfig(openscenegraph-osgVolume) pkgconfig(openscenegraph-osgWidget)"
RDEPENDS:${PN} += "/usr/bin/pkg-config curl-devel freeglut-devel giflib-devel libOpenSceneGraph161 libOpenThreads-devel libjpeg-devel libpng-devel pkgconfig(freetype2) pkgconfig(librsvg-2.0) pkgconfig(libtiff-4) pkgconfig(openscenegraph-osg) pkgconfig(openscenegraph-osgDB) pkgconfig(openscenegraph-osgGA) pkgconfig(openscenegraph-osgText) pkgconfig(openscenegraph-osgUtil) pkgconfig(openscenegraph-osgViewer) pkgconfig(openthreads) pkgconfig(poppler-glib) pkgconfig(sdl2) pkgconfig(xrandr)"
