...
RPROVIDES:${PN} += "glassfish-servlet-api mvn(javax.servlet:javax.servlet-api) mvn(javax.servlet:javax.servlet-api:pom:) mvn(javax.servlet:servlet-api) mvn(javax.servlet:servlet-api:pom:) mvn(org.apache.geronimo.specs:geronimo-servlet_3.0_spec) mvn(org.apache.geronimo.specs:geronimo-servlet_3.0_spec:pom:) mvn(org.eclipse.jetty.orbit:javax.servlet) mvn(org.eclipse.jetty.orbit:javax.servlet:pom:) osgi(javax.servlet-api)"
