...
RPROVIDES:${PN} += "config(monitoring-plugins-mailstat) monitoring-plugins-mailstat nagios-plugins-mailstat"
RDEPENDS:${PN} += "/usr/bin/perl mailgraph monitoring-plugins-common perl(RRDs)"
