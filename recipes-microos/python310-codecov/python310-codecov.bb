...
RPROVIDES:${PN} += "python3-codecov python3.10dist(codecov) python310-codecov python3dist(codecov)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-coverage python310-requests update-alternatives"
