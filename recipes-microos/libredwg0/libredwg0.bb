...
RPROVIDES:${PN} += "libredwg.so.0()(64bit) libredwg.so.0(V_0.12.5)(64bit) libredwg0 libredwg0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) libm.so.6()(64bit) libm.so.6(GLIBC_2.17)(64bit)"
