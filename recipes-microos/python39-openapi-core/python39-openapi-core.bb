...
RPROVIDES:${PN} += "python3.9dist(openapi-core) python39-openapi-core python3dist(openapi-core)"
RDEPENDS:${PN} += "python(abi) python39-Werkzeug python39-isodate python39-jsonschema-spec python39-more-itertools python39-openapi-schema-validator python39-openapi-spec-validator python39-parse python39-pathable python39-typing-extensions"
