...
RPROVIDES:${PN} += "python3.11dist(cbor) python311-cbor python311-cbor(aarch-64) python3dist(cbor)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python311-base"
