...
RPROVIDES:${PN} += "config(mathml-dtd) mathml-dtd"
RDEPENDS:${PN} += "/bin/sh /usr/bin/edit-xml-catalog /usr/bin/sgml-register-catalog /usr/bin/xmlcatalog awk grep libxml2 sed sgml-skel"
