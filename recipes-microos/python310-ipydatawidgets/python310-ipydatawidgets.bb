...
RPROVIDES:${PN} += "python3-ipydatawidgets python3-jupyter_ipydatawidgets python3.10dist(ipydatawidgets) python310-ipydatawidgets python310-jupyter_ipydatawidgets python3dist(ipydatawidgets)"
RDEPENDS:${PN} += "jupyter-ipydatawidgets python(abi) python310-ipywidgets python310-numpy python310-traittypes"
