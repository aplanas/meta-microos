...
RPROVIDES:${PN} += "python3.9dist(jsbeautifier) python39-jsbeautifier python3dist(jsbeautifier)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-EditorConfig python39-setuptools python39-six update-alternatives"
