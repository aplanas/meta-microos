...
RPROVIDES:${PN} += "python3.11dist(pygithub) python311-PyGithub python3dist(pygithub)"
RDEPENDS:${PN} += "python(abi) python311-Deprecated python311-PyJWT python311-PyNaCl python311-requests"
