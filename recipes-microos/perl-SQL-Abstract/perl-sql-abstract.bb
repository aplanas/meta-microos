...
RPROVIDES:${PN} += "perl(DBIx::Class::SQLMaker::Role::SQLA2Passthrough) perl(DBIx::Class::Storage::Debug::PrettyPrint) perl(SQL::Abstract) perl(SQL::Abstract::Formatter) perl(SQL::Abstract::Parts) perl(SQL::Abstract::Plugin::BangOverrides) perl(SQL::Abstract::Plugin::ExtraClauses) perl(SQL::Abstract::Reference) perl(SQL::Abstract::Role::Plugin) perl(SQL::Abstract::Test) perl(SQL::Abstract::Tree) perl-SQL-Abstract"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Hash::Merge) perl(MRO::Compat) perl(Moo) perl(Sub::Quote) perl(Test::Builder::Module) perl(Test::Deep) perl(Text::Balanced)"
