...
RPROVIDES:${PN} += "python3-CherryPy python3.10dist(cherrypy) python310-CherryPy python3dist(cherrypy)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 alts python(abi) python310-cheroot python310-jaraco.collections python310-more-itertools python310-portend python310-zc.lockfile"
