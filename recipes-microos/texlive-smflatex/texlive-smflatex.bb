...
RPROVIDES:${PN} += "tex(smfart.cls) tex(smfbib.sty) tex(smfbook.cls) tex(smfbull.sty) tex(smfenum.sty) tex(smfgen.sty) tex(smfhyperref.sty) tex(smfmulti.sty) tex(smfthm.sty) texlive-smflatex"
