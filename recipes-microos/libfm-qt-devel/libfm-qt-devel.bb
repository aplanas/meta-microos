...
RPROVIDES:${PN} += "cmake(fm-qt) libfm-qt-devel libfm-qt-devel(aarch-64) pkgconfig(libfm-qt)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libfm-qt13 pkgconfig pkgconfig(Qt5Widgets) pkgconfig(Qt5X11Extras) pkgconfig(libmenu-cache)"
