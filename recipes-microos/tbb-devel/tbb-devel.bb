...
RPROVIDES:${PN} += "cmake(TBB) pkgconfig(tbb) tbb-devel tbb-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config c++_compiler libirml1 libtbb12 libtbbbind_2_5-3 libtbbmalloc2"
