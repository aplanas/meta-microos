...
RPROVIDES:${PN} += "python3-azure-mgmt-resourceconnector python3.10dist(azure-mgmt-resourceconnector) python310-azure-mgmt-resourceconnector python3dist(azure-mgmt-resourceconnector)"
