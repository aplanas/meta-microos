...
RPROVIDES:${PN} += "python3-intake python3.10dist(intake) python310-intake python3dist(intake)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Jinja2 python310-PyYAML python310-appdirs python310-dask python310-dask-bag python310-entrypoints python310-fsspec python310-msgpack update-alternatives"
