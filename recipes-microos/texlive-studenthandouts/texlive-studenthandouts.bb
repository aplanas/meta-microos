...
RPROVIDES:${PN} += "tex(studenthandouts.sty) texlive-studenthandouts"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(changepage.sty) tex(fancyhdr.sty) tex(fmtcount.sty) tex(geometry.sty) tex(ifthen.sty) tex(tocloft.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
