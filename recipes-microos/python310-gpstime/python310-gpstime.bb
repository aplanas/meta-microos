...
RPROVIDES:${PN} += "python3-gpstime python3.10dist(gpstime) python310-gpstime python3dist(gpstime)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-appdirs python310-python-dateutil python310-requests timezone update-alternatives"
