...
RPROVIDES:${PN} += "NetworkManager-openvpn NetworkManager-openvpn(aarch-64) group(nm-openvpn) libnm-vpn-plugin-openvpn.so()(64bit) user(nm-openvpn)"
RDEPENDS:${PN} += "/bin/sh NetworkManager ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgmodule-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libnm.so.0()(64bit) libnm.so.0(libnm_1_0_0)(64bit) libnm.so.0(libnm_1_2_0)(64bit) openvpn sysuser-shadow"
