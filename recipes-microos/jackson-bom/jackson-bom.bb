...
RPROVIDES:${PN} += "jackson-bom mvn(com.fasterxml.jackson:jackson-base:pom:) mvn(com.fasterxml.jackson:jackson-bom:pom:)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(com.fasterxml.jackson:jackson-parent:pom:)"
