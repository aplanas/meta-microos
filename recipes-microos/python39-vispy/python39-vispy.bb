...
RPROVIDES:${PN} += "python3.9dist(vispy) python39-vispy python39-vispy(aarch-64) python3dist(vispy)"
RDEPENDS:${PN} += "fontconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-cassowary python39-decorator python39-freetype-py python39-husl python39-numpy python39-pypng python39-qt5"
