...
RPROVIDES:${PN} += "application() application(mc.desktop) config(mc) mc mc(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh /usr/bin/env /usr/bin/perl /usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libe2p.so.2()(64bit) libglib-2.0.so.0()(64bit) libgmodule-2.0.so.0()(64bit) libgpm.so.2()(64bit) libslang.so.2()(64bit) libslang.so.2(SLANG2)(64bit) libssh2.so.1()(64bit) permissions"
