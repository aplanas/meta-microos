...
RPROVIDES:${PN} += "python3.11dist(discogs-client) python311-discogs-client python3dist(discogs-client)"
RDEPENDS:${PN} += "python(abi) python311-oauthlib python311-requests python311-six"
