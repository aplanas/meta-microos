...
RPROVIDES:${PN} += "tex(vancouver.bbx) tex(vancouver.cbx) texlive-biblatex-vancouver"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ifthen.sty) tex(numeric.bbx) tex(numeric.cbx) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
