...
RPROVIDES:${PN} += "libnemo-fileroller.so()(64bit) nemo-extension-fileroller nemo-extension-fileroller(aarch-64) nemo-fileroller"
RDEPENDS:${PN} += "/sbin/ldconfig file-roller libc.so.6(GLIBC_2.17)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libnemo-extension.so.1()(64bit) nemo"
