...
RPROVIDES:${PN} += "tex(movie15.sty) texlive-movie15"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(everyshi.sty) tex(fp.sty) tex(ifdraft.sty) tex(ifpdf.sty) tex(ifthen.sty) tex(keyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
