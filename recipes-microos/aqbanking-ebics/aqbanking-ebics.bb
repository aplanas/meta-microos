...
RPROVIDES:${PN} += "aqbanking-ebics aqbanking-ebics(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig aqbanking ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libaqbanking.so.44()(64bit) libc.so.6(GLIBC_2.34)(64bit) libgwenhywfar.so.79()(64bit)"
