...
RPROVIDES:${PN} += "config(postgresql12-plr) postgresql12-plr postgresql12-plr(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig R-base ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libR.so()(64bit) libc.so.6(GLIBC_2.33)(64bit) postgresql12-server"
