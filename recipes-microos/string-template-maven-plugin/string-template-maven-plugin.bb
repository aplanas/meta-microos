...
RPROVIDES:${PN} += "mvn(com.webguys:string-template-maven-plugin) mvn(com.webguys:string-template-maven-plugin:pom:) string-template-maven-plugin"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.antlr:ST4) mvn(org.apache.maven:maven-artifact) mvn(org.apache.maven:maven-core) mvn(org.apache.maven:maven-plugin-api) mvn(org.eclipse.aether:aether-util) mvn(org.twdata.maven:mojo-executor)"
