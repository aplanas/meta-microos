...
RPROVIDES:${PN} += "tex(yagusylo.cfg) tex(yagusylo.sty) texlive-yagusylo"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(suffix.sty) tex(xargs.sty) tex(xcolor.sty) tex(xifthen.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
