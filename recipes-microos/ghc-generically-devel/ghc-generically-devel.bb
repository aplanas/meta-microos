...
RPROVIDES:${PN} += "ghc-devel(generically-0.1.1-9IDkuVjdBOA27Mdybf3GBx) ghc-generically-devel ghc-generically-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(base-orphans-0.8.8.2-Hl8yFKsRlc4HPNXP65SlX8) ghc-generically"
