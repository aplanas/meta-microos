...
RPROVIDES:${PN} += "libopenscap_sce.so.25()(64bit) libopenscap_sce25 libopenscap_sce25(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libopenscap.so.25()(64bit) libpcre.so.1()(64bit)"
