...
RPROVIDES:${PN} += "libfsalnull.so()(64bit) nfs-ganesha-nullfs nfs-ganesha-nullfs(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libganesha_nfsd.so.3.3()(64bit) nfs-ganesha"
