...
RPROVIDES:${PN} += "glassfish-el-api mvn(javax.el:el-api) mvn(javax.el:el-api:pom:) mvn(javax.el:javax.el-api) mvn(javax.el:javax.el-api:pom:) mvn(org.glassfish:javax.el-api) mvn(org.glassfish:javax.el-api:pom:) osgi(javax.el-api)"
