...
RPROVIDES:${PN} += "apache-pdfbox mvn(org.apache.pdfbox:fontbox) mvn(org.apache.pdfbox:fontbox:pom:) mvn(org.apache.pdfbox:pdfbox) mvn(org.apache.pdfbox:pdfbox-debugger) mvn(org.apache.pdfbox:pdfbox-debugger:pom:) mvn(org.apache.pdfbox:pdfbox-tools) mvn(org.apache.pdfbox:pdfbox-tools:pom:) mvn(org.apache.pdfbox:pdfbox:pom:) osgi(org.apache.pdfbox) osgi(org.apache.pdfbox.fontbox)"
RDEPENDS:${PN} += "apache-commons-logging java-headless javapackages-filesystem mvn(commons-logging:commons-logging)"
