...
RPROVIDES:${PN} += "typelib(Colord) typelib-1_0-Colord-1_0 typelib-1_0-Colord-1_0(aarch-64)"
RDEPENDS:${PN} += "libcolord.so.2()(64bit) typelib(GLib) typelib(GObject) typelib(Gio)"
