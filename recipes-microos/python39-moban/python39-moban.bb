...
RPROVIDES:${PN} += "python3.9dist(moban) python39-moban python3dist(moban)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 git-core python(abi) python39-Jinja2 python39-appdirs python39-crayons python39-fs python39-jinja2-fsloader python39-lml python39-ruamel.yaml update-alternatives"
