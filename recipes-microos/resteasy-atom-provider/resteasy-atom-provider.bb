...
RPROVIDES:${PN} += "mvn(org.jboss.resteasy:resteasy-atom-provider) mvn(org.jboss.resteasy:resteasy-atom-provider:pom:) resteasy-atom-provider"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.jboss.logging:jboss-logging-annotations) mvn(org.jboss.logging:jboss-logging-processor) mvn(org.jboss.resteasy:resteasy-jaxb-provider) mvn(org.jboss.resteasy:resteasy-jaxrs)"
