...
RPROVIDES:${PN} += "python3.9dist(relatorio) python39-relatorio python3dist(relatorio)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Genshi python39-PyYAML python39-lxml python39-pycha python39-python-magic update-alternatives"
