...
RPROVIDES:${PN} += "makeinfo makeinfo(aarch-64) texinfo:/usr/bin/makeinfo"
RDEPENDS:${PN} += "/usr/bin/perl ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.33)(64bit) perl perl(Text::Unidecode)"
