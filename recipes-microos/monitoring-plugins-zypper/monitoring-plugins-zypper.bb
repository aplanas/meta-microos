...
RPROVIDES:${PN} += "config(monitoring-plugins-zypper) monitoring-plugins-zypper nagios-plugins-zypper"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl apparmor-abstractions gawk grep perl(Getopt::Long) perl(POSIX) perl(Time::Local) rpm sudo systemd zypper"
