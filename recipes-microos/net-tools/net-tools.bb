...
RPROVIDES:${PN} += "net-tools net-tools(aarch-64) net_tool"
RDEPENDS:${PN} += "hostname ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit)"
