...
RPROVIDES:${PN} += "ruby3.2-rubygem-packaging_rake_tasks ruby3.2-rubygem-packaging_rake_tasks(aarch-64) rubygem(packaging_rake_tasks) rubygem(ruby:3.2.0:packaging_rake_tasks) rubygem(ruby:3.2.0:packaging_rake_tasks:1) rubygem(ruby:3.2.0:packaging_rake_tasks:1.5) rubygem(ruby:3.2.0:packaging_rake_tasks:1.5.3)"
