...
RPROVIDES:${PN} += "python3.9dist(pyct) python39-pyct python3dist(pyct)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-PyYAML python39-param python39-requests update-alternatives"
