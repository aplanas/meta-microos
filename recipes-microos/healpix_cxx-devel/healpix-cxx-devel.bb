...
RPROVIDES:${PN} += "healpix_cxx-devel healpix_cxx-devel(aarch-64) pkgconfig(healpix_cxx)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libhealpix_cxx3 pkgconfig(cfitsio) pkgconfig(libsharp) pkgconfig(zlib)"
