...
RPROVIDES:${PN} += "libgtkhotkey-devel libgtkhotkey-devel(aarch-64) pkgconfig(gtkhotkey-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glib2-devel gtk2-devel libgtkhotkey1 pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(gtk+-2.0)"
