...
RPROVIDES:${PN} += "python3-oslo.metrics python3.10dist(oslo.metrics) python3dist(oslo.metrics)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-oslo.config python3-oslo.log python3-oslo.utils python3-pbr python3-prometheus-client"
