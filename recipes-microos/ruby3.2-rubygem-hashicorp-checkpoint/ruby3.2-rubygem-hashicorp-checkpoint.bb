...
RPROVIDES:${PN} += "ruby3.2-rubygem-hashicorp-checkpoint ruby3.2-rubygem-hashicorp-checkpoint(aarch-64) rubygem(hashicorp-checkpoint) rubygem(ruby:3.2.0:hashicorp-checkpoint) rubygem(ruby:3.2.0:hashicorp-checkpoint:0) rubygem(ruby:3.2.0:hashicorp-checkpoint:0.1) rubygem(ruby:3.2.0:hashicorp-checkpoint:0.1.5)"
