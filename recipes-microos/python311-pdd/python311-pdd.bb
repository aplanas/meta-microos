...
RPROVIDES:${PN} += "python3.11dist(pdd) python311-pdd python3dist(pdd)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-python-dateutil python311-setuptools update-alternatives"
