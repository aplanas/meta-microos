...
RPROVIDES:${PN} += "man(ctie.1) texlive-ctie"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed texlive texlive-ctie-bin texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
