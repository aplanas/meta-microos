...
RPROVIDES:${PN} += "perl(Mo) perl(Mo::Golf) perl(Mo::Inline) perl(Mo::Moose) perl(Mo::Mouse) perl(Mo::build) perl(Mo::builder) perl(Mo::chain) perl(Mo::coerce) perl(Mo::default) perl(Mo::exporter) perl(Mo::import) perl(Mo::importer) perl(Mo::is) perl(Mo::nonlazy) perl(Mo::option) perl(Mo::required) perl(Mo::xs) perl-Mo"
