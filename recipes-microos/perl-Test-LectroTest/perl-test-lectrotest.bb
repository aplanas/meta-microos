...
RPROVIDES:${PN} += "perl(Test::LectroTest) perl(Test::LectroTest::Compat) perl(Test::LectroTest::FailureRecorder) perl(Test::LectroTest::Generator) perl(Test::LectroTest::Property) perl(Test::LectroTest::TestRunner) perl(Test::LectroTest::TestRunner::results) perl(Test::LectroTest::TestRunner::testcontroller) perl-Test-LectroTest"
