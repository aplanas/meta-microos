...
RPROVIDES:${PN} += "python3-sphinx-autobuild python3.10dist(sphinx-autobuild) python310-sphinx-autobuild python3dist(sphinx-autobuild)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Sphinx python310-colorama python310-livereload update-alternatives"
