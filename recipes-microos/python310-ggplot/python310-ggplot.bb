...
RPROVIDES:${PN} += "python3-ggplot python3.10dist(ggplot) python310-ggplot python3dist(ggplot)"
RDEPENDS:${PN} += "python(abi) python310-Cycler python310-brewer2mpl python310-matplotlib python310-numpy python310-pandas python310-patsy python310-scipy python310-six python310-statsmodels"
