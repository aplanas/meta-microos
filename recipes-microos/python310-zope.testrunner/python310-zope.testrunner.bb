...
RPROVIDES:${PN} += "python3-zope.testrunner python3.10dist(zope.testrunner) python310-zope.testrunner python3dist(zope.testrunner)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-zope.exceptions python310-zope.interface update-alternatives"
