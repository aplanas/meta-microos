...
RPROVIDES:${PN} += "vtk-openmpi3-devel:/usr/lib64/mpi/gcc/openmpi3/lib64//libvtkJava.so vtk-openmpi3-java-devel vtk-openmpi3-java-devel(aarch-64)"
RDEPENDS:${PN} += "java-devel vtk-openmpi3-devel vtk-openmpi3-java"
