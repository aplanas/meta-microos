...
RPROVIDES:${PN} += "python3.9dist(django-collectd-rest) python39-django-collectd-rest python39-django-collectd-rest(aarch-64) python3dist(django-collectd-rest)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) librrd.so.8()(64bit) python(abi) python39-Django python39-djangorestframework rrdtool"
