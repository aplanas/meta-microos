...
RPROVIDES:${PN} += "libdvdnav libdvdnav.so.4()(64bit) libdvdnav4 libdvdnav4(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libdvdread.so.8()(64bit)"
