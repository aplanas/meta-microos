...
RPROVIDES:${PN} += "ghc-prof(setlocale-1.0.0.10-8gNxxDe254d2fufYktFd7s) ghc-setlocale-prof ghc-setlocale-prof(aarch-64)"
RDEPENDS:${PN} += "ghc-prof(base-4.17.1.0) ghc-setlocale-devel"
