...
RPROVIDES:${PN} += "tex(minim-alloc.tex) tex(minim-doc.sty) tex(minim-etex.tex) tex(minim-hooks.tex) tex(minim-lmodern.tex) tex(minim-pdfresources.tex) tex(minim-plain.tex) tex(minim.tex) texlive-minim"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(luaotfload.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
