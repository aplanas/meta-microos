...
RPROVIDES:${PN} += "application() application(solaar.desktop) metainfo() metainfo(io.github.pwr_solaar.solaar.metainfo.xml) python3.10dist(solaar) python3dist(solaar) solaar solaar-cli"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-PyYAML python3-evdev python3-gobject python3-gobject-Gdk python3-hid-parser python3-psutil python3-python-xlib python3-pyudev python3-typing_extensions solaar-udev typelib-1_0-Gtk-3_0"
