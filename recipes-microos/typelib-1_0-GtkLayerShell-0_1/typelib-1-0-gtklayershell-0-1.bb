...
RPROVIDES:${PN} += "typelib(GtkLayerShell) typelib-1_0-GtkLayerShell-0_1 typelib-1_0-GtkLayerShell-0_1(aarch-64)"
RDEPENDS:${PN} += "libgtk-layer-shell.so.0()(64bit) typelib(Atk) typelib(GLib) typelib(GModule) typelib(GObject) typelib(Gdk) typelib(GdkPixbuf) typelib(Gio) typelib(Gtk) typelib(HarfBuzz) typelib(Pango) typelib(cairo) typelib(freetype2) typelib(xlib)"
