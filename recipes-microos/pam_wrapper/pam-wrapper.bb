...
RPROVIDES:${PN} += "cmake(pam_wrapper) libpam_wrapper.so.0()(64bit) pam_wrapper pam_wrapper(aarch-64) pkgconfig(pam_wrapper)"
RDEPENDS:${PN} += "/sbin/ldconfig /usr/bin/pkg-config ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libpam.so.0()(64bit) libpam.so.0(LIBPAM_1.0)(64bit)"
