...
RPROVIDES:${PN} += "python3.9dist(avro) python39-avro python3dist(avro)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-Twisted python39-zope.interface update-alternatives"
