...
RPROVIDES:${PN} += "python3.9dist(eventlet) python39-eventlet python3dist(eventlet)"
RDEPENDS:${PN} += "libnss_usrfiles2 netcfg python(abi) python39-dnspython python39-greenlet python39-six"
