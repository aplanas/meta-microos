...
RPROVIDES:${PN} += "pattern() pattern-category() pattern-extends() pattern-icon() pattern-order() patterns-kde-kde_games patterns-openSUSE-kde4_games patterns-openSUSE-kde_games"
RDEPENDS:${PN} += ""
