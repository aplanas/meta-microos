...
RPROVIDES:${PN} += "libcanberra-gtk-module.so()(64bit) libcanberra-gtk2-module libcanberra-gtk2-module(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libX11.so.6()(64bit) libc.so.6(GLIBC_2.17)(64bit) libcanberra-gtk-module-common libcanberra-gtk.so.0()(64bit) libgdk-x11-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libgtk-x11-2.0.so.0()(64bit)"
