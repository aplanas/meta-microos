...
RPROVIDES:${PN} += "python3.8dist(azure-cognitiveservices-search-nspkg) python38-azure-cognitiveservices-search-nspkg python3dist(azure-cognitiveservices-search-nspkg)"
