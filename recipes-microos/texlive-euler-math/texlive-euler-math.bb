...
RPROVIDES:${PN} += "tex(euler-math.sty) tex(neo-euler.sty) texlive-euler-math"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(iftex.sty) tex(unicode-math.sty) tex(xkeyval.sty) texlive texlive-euler-math-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
