...
RPROVIDES:${PN} += "tex(commedit.sty) texlive-commedit"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(changepage.sty) tex(etoolbox.sty) tex(everyshi.sty) tex(graphicx.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
