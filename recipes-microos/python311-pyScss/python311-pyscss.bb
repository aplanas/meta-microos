...
RPROVIDES:${PN} += "python3.11dist(pyscss) python311-pyScss python311-pyScss(aarch-64) python3dist(pyscss)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libpcre.so.1()(64bit) python(abi) python311-setuptools python311-six update-alternatives"
