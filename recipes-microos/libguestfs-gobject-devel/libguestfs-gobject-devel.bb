...
RPROVIDES:${PN} += "libguestfs-gobject-devel libguestfs-gobject-devel(aarch-64) pkgconfig(libguestfs-gobject-1.0)"
RDEPENDS:${PN} += "/usr/bin/pkg-config glib2-devel libguestfs-gobject-1_0 pkgconfig(gio-2.0) pkgconfig(gobject-2.0) pkgconfig(libguestfs)"
