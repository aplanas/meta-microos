...
RPROVIDES:${PN} += "tex(umthesis.cls) texlive-umthesis"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(book.cls) tex(etex.sty) tex(hyperref.sty) tex(ifthen.sty) tex(setspace.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
