...
RPROVIDES:${PN} += "python3.9dist(btrees) python39-BTrees python39-BTrees(aarch-64) python39-BTrees-doc python3dist(btrees)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python39-persistent python39-zope.interface"
