...
RPROVIDES:${PN} += "ruby3.2-rubygem-Ascii85 ruby3.2-rubygem-Ascii85(aarch-64) rubygem(Ascii85) rubygem(ruby:3.2.0:Ascii85) rubygem(ruby:3.2.0:Ascii85:1) rubygem(ruby:3.2.0:Ascii85:1.1) rubygem(ruby:3.2.0:Ascii85:1.1.0)"
