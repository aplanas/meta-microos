...
RPROVIDES:${PN} += "tex(ProfLycee-old.sty) tex(ProfLycee.sty) tex(proflycee-tools-minted.tex) tex(proflycee-tools-piton.tex) tex(proflycee-tools-pythontex.tex) texlive-proflycee"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(csvsimple.sty) tex(expl3.sty) tex(fancyvrb.sty) tex(fontawesome5.sty) tex(hologo.sty) tex(iftex.sty) tex(ifthen.sty) tex(listofitems.sty) tex(mathtools.sty) tex(minted.sty) tex(nicefrac.sty) tex(pgf.sty) tex(pgffor.sty) tex(piton.sty) tex(pythontex.sty) tex(randomlist.sty) tex(simplekv.sty) tex(siunitx.sty) tex(tabularray.sty) tex(tcolorbox.sty) tex(tikz.sty) tex(tkz-tab.sty) tex(xcolor.sty) tex(xfp.sty) tex(xintbinhex.sty) tex(xintexpr.sty) tex(xinttools.sty) tex(xkeyval.sty) tex(xparse.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
