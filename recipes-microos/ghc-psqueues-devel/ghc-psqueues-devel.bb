...
RPROVIDES:${PN} += "ghc-devel(psqueues-0.2.7.3-F3Vf47seRPn11NfFVgsy6O) ghc-psqueues-devel ghc-psqueues-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0) ghc-devel(ghc-prim-0.9.0) ghc-devel(hashable-1.4.2.0-FFBRhuY0w4YLmuLEs5uQAt) ghc-psqueues"
