...
RPROVIDES:${PN} += "perl(Devel::AssertC99) perl(Devel::CheckCompiler) perl-Devel-CheckCompiler"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(ExtUtils::CBuilder) perl(parent)"
