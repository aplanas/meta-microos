...
RPROVIDES:${PN} += "ghc-http-date-prof ghc-http-date-prof(aarch-64) ghc-prof(http-date-0.0.11-IfCBGXPFiMuIKzFtOTNgnD)"
RDEPENDS:${PN} += "ghc-http-date-devel ghc-prof(array-0.5.4.0) ghc-prof(attoparsec-0.14.4-21v4nlnPs0qLZ5R1FIK9u3) ghc-prof(base-4.17.1.0) ghc-prof(bytestring-0.11.4.0) ghc-prof(time-1.12.2)"
