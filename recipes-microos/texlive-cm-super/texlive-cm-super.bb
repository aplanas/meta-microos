...
RPROVIDES:${PN} += "tex(cm-super-t1.enc) tex(cm-super-t1.map) tex(cm-super-t2a.enc) tex(cm-super-t2a.map) tex(cm-super-t2b.enc) tex(cm-super-t2b.map) tex(cm-super-t2c.enc) tex(cm-super-t2c.map) tex(cm-super-ts1.enc) tex(cm-super-ts1.map) tex(cm-super-x2.enc) tex(cm-super-x2.map) tex(type1ec.sty) texlive-cm-super"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(t1cmr.fd) tex(updmap.cfg) texlive texlive-cm-super-fonts texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
