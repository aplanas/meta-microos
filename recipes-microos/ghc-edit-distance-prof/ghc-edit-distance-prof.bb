...
RPROVIDES:${PN} += "ghc-edit-distance-prof ghc-edit-distance-prof(aarch-64) ghc-prof(edit-distance-0.2.2.1-6sqaVuKvJlk4f2SjC0p5nu)"
RDEPENDS:${PN} += "ghc-edit-distance-devel ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(containers-0.6.7) ghc-prof(random-1.2.1.1-I0wUgAAbf0g3qHR3e8uT0o)"
