...
RPROVIDES:${PN} += "tex(lexref.sty) texlive-lexref"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(ifthen.sty) tex(nomencl.sty) tex(splitidx.sty) tex(stringstrings.sty) tex(xargs.sty) tex(xstring.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
