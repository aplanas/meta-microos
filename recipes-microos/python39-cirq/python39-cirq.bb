...
RPROVIDES:${PN} += "python3.9dist(cirq) python39-cirq python3dist(cirq)"
RDEPENDS:${PN} += "python(abi) python39-cirq-aqt python39-cirq-core python39-cirq-google python39-cirq-ionq python39-cirq-pasqal python39-cirq-web"
