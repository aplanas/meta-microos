...
RPROVIDES:${PN} += "ruby3.2-rubygem-os ruby3.2-rubygem-os(aarch-64) rubygem(os) rubygem(ruby:3.2.0:os) rubygem(ruby:3.2.0:os:1) rubygem(ruby:3.2.0:os:1.1) rubygem(ruby:3.2.0:os:1.1.4)"
