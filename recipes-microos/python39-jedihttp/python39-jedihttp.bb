...
RPROVIDES:${PN} += "python3.9dist(jedihttp) python39-jedihttp python3dist(jedihttp)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-bottle python39-jedi python39-waitress update-alternatives"
