...
RPROVIDES:${PN} += "ghc-devel(iwlib-0.1.2-1s738Tb3Wf2CvjJviNtWBD) ghc-iwlib-devel ghc-iwlib-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ghc-compiler ghc-devel(base-4.17.1.0) ghc-iwlib libiw-devel"
