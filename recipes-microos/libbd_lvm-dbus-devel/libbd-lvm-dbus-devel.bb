...
RPROVIDES:${PN} += "libbd_lvm-dbus-devel libbd_lvm-dbus-devel(aarch-64) libblockdev-lvm-dbus-devel"
RDEPENDS:${PN} += "glib2-devel libbd_lvm-dbus2 libbd_lvm-devel libbd_utils-devel"
