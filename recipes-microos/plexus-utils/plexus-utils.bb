...
RPROVIDES:${PN} += "mvn(org.codehaus.plexus:plexus-utils) mvn(org.codehaus.plexus:plexus-utils:pom:) mvn(plexus:plexus-utils) mvn(plexus:plexus-utils:pom:) osgi(org.codehaus.plexus.utils) plexus-utils"
