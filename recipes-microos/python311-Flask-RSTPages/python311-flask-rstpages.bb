...
RPROVIDES:${PN} += "python3.11dist(flask-rstpages) python311-Flask-RSTPages python3dist(flask-rstpages)"
RDEPENDS:${PN} += "python(abi) python311-Flask python311-Pygments python311-docutils"
