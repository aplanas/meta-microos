...
RPROVIDES:${PN} += "python3-cinderclient python3.10dist(python-cinderclient) python3dist(python-cinderclient)"
RDEPENDS:${PN} += "/usr/bin/python3 python(abi) python3-Babel python3-PrettyTable python3-keystoneauth1 python3-oslo.i18n python3-oslo.utils python3-requests"
