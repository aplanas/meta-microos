...
RPROVIDES:${PN} += "ghc-microlens-prof ghc-microlens-prof(aarch-64) ghc-prof(microlens-0.4.13.1-ARwI8t2x86cAxRs56XPcG1)"
RDEPENDS:${PN} += "ghc-microlens-devel ghc-prof(base-4.17.1.0)"
