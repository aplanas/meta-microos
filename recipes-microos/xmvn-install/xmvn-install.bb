...
RPROVIDES:${PN} += "mvn(org.fedoraproject.xmvn:xmvn-install) mvn(org.fedoraproject.xmvn:xmvn-install:pom:) xmvn-install"
RDEPENDS:${PN} += "/bin/bash apache-commons-compress beust-jcommander java-headless javapackages-filesystem javapackages-tools mvn(com.beust:jcommander) mvn(org.apache.commons:commons-compress) mvn(org.fedoraproject.xmvn:xmvn-api) mvn(org.fedoraproject.xmvn:xmvn-core) mvn(org.ow2.asm:asm) mvn(org.slf4j:slf4j-api) mvn(org.slf4j:slf4j-simple) objectweb-asm slf4j xmvn-api xmvn-core"
