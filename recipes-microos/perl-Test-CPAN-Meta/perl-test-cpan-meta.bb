...
RPROVIDES:${PN} += "perl(Test::CPAN::Meta) perl(Test::CPAN::Meta::Version) perl-Test-CPAN-Meta"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Parse::CPAN::Meta) perl(Test::More)"
