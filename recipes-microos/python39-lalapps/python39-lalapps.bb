...
RPROVIDES:${PN} += "python39-lalapps python39-lalapps(aarch-64)"
RDEPENDS:${PN} += "python(abi) python39-h5py python39-lal python39-lalburst python39-lalframe python39-lalinference python39-lalinspiral python39-lalmetaio python39-lalpulsar python39-lalsimulation python39-ligo-lw python39-ligo-segments python39-matplotlib python39-numpy python39-scipy"
