...
RPROVIDES:${PN} += "adios_1_13_1-gnu-mpich-hpc-devel adios_1_13_1-gnu-mpich-hpc-devel(aarch-64)"
RDEPENDS:${PN} += "adios_1_13_1-gnu-mpich-hpc adios_1_13_1-gnu-mpich-hpc-devel-static gnu-compilers-hpc-devel hdf5-gnu-mpich-hpc-devel lua-lmod mpich-gnu-hpc-devel netcdf-gnu-mpich-hpc-devel"
