...
RPROVIDES:${PN} += "dpdk-thunderx-kmp dpdk-thunderx-kmp-default dpdk-thunderx-kmp-default(aarch-64) dpdk-thunderx-kmp-default-k6.3.4_1 kmod(rte_kni.ko) multiversion(kernel)"
