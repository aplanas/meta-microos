...
RPROVIDES:${PN} += "freetype-tools freetype-tools(aarch-64)"
RDEPENDS:${PN} += "/bin/sh freetype ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libttf.so.2()(64bit)"
