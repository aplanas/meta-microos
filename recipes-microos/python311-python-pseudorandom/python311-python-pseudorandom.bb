...
RPROVIDES:${PN} += "python3.11dist(python-pseudorandom) python311-python-pseudorandom python3dist(python-pseudorandom)"
RDEPENDS:${PN} += "python(abi) python311-python-datamatrix"
