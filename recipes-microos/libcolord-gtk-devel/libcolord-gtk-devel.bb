...
RPROVIDES:${PN} += "libcolord-gtk-devel libcolord-gtk-devel(aarch-64) pkgconfig(colord-gtk) pkgconfig(colord-gtk4)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libcolord-gtk1 libcolord-gtk4-1 pkgconfig(colord) pkgconfig(gtk+-3.0) pkgconfig(gtk4) typelib-1_0-ColordGtk-1_0"
