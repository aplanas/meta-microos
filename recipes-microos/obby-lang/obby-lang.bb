...
RPROVIDES:${PN} += "locale(obby:ast) locale(obby:ca) locale(obby:da) locale(obby:de) locale(obby:en_GB) locale(obby:es) locale(obby:fr) locale(obby:it) locale(obby:nl) locale(obby:oc) locale(obby:pt_BR) locale(obby:sv) locale(obby:uk) obby-lang obby-lang-all"
RDEPENDS:${PN} += "obby"
