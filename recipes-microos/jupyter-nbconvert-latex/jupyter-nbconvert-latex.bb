...
RPROVIDES:${PN} += "jupyter-nbconvert-latex python310-jupyter_nbconvert-latex python310-nbconvert-latex python311-jupyter_nbconvert-latex python311-nbconvert-latex python39-jupyter_nbconvert-latex python39-nbconvert-latex"
RDEPENDS:${PN} += "jupyter-nbconvert tex(adjustbox.sty) tex(eurosym.sty) tex(ulem.sty) texlive-bibtex texlive-makeindex"
