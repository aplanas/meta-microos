...
RPROVIDES:${PN} += "python3.11dist(qgrid) python311-qgrid python3dist(qgrid)"
RDEPENDS:${PN} += "jupyter-qgrid python(abi) python311-ipywidgets python311-notebook python311-pandas"
