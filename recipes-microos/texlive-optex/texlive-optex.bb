...
RPROVIDES:${PN} += "tex(op-demo.tex) tex(op-letter-cs.tex) tex(op-letter-en.tex) tex(op-mathalign.tex) tex(op-slides.tex) texlive-optex"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(language.dat) tex(language.dat.lua) tex(language.def) texlive texlive-amsfonts texlive-cm texlive-ec texlive-filesystem texlive-hyphen-base texlive-kpathsea texlive-kpathsea-bin texlive-librarian texlive-lm texlive-luaotfload texlive-luatex texlive-optex-bin texlive-rsfs texlive-scripts texlive-scripts-bin texlive-unicode-data"
