...
RPROVIDES:${PN} += "libpurple-meanwhile libpurple-plugin-sametime libpurple-plugin-sametime(aarch-64) libsametime.so()(64bit)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libglib-2.0.so.0()(64bit) libmeanwhile.so.1()(64bit) libpurple"
