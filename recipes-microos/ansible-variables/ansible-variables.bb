...
RPROVIDES:${PN} += "ansible-variables python3.10dist(ansible-variables) python3dist(ansible-variables)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 ansible-core python(abi) python3-rich update-alternatives"
