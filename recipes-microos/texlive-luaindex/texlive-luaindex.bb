...
RPROVIDES:${PN} += "tex(luaindex.sty) texlive-luaindex"
RDEPENDS:${PN} += "/bin/sh /usr/bin/luatex coreutils ed findutils grep sed tex(ifluatex.sty) tex(luatexbase-compat.sty) tex(luatexbase-modutils.sty) tex(scrbase.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
