...
RPROVIDES:${PN} += "python3-azure-mgmt-communication python3.10dist(azure-mgmt-communication) python310-azure-mgmt-communication python3dist(azure-mgmt-communication)"
