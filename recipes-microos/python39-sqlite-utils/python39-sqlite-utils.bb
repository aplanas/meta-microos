...
RPROVIDES:${PN} += "python3.9dist(sqlite-utils) python39-sqlite-utils python3dist(sqlite-utils)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-click python39-click-default-group python39-sqlite-fts4 python39-tabulate update-alternatives"
