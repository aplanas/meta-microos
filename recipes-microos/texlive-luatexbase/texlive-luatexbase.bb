...
RPROVIDES:${PN} += "tex(luatexbase-attr.sty) tex(luatexbase-cctb.sty) tex(luatexbase-compat.sty) tex(luatexbase-loader.sty) tex(luatexbase-mcb.sty) tex(luatexbase-modutils.sty) tex(luatexbase-regs.sty) tex(luatexbase.sty) texlive-luatexbase"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(ctablestack.sty) texlive texlive-ctablestack texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
