...
RPROVIDES:${PN} += "tex(fnpct-2019-10-05.sty) tex(fnpct.sty) texlive-fnpct"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(l3keys2e.sty) tex(scrextend.sty) tex(scrlfile.sty) tex(translations.sty) tex(xparse.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
