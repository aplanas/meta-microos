...
RPROVIDES:${PN} += "python3.9dist(azure-mgmt-baremetalinfrastructure) python39-azure-mgmt-baremetalinfrastructure python3dist(azure-mgmt-baremetalinfrastructure)"
