...
RPROVIDES:${PN} += "python3-pifpaf python3.10dist(pifpaf) python310-pifpaf python3dist(pifpaf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Jinja2 python310-click python310-daiquiri python310-fixtures python310-psutil python310-requests python310-testrepository python310-testtools python310-xattr update-alternatives"
