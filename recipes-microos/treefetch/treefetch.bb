...
RPROVIDES:${PN} += "bundled(rust-crate:aho-corasick) bundled(rust-crate:memchr) bundled(rust-crate:regex) bundled(rust-crate:regex-syntax) bundled(rust-crate:treefetch) treefetch treefetch(aarch-64)"
