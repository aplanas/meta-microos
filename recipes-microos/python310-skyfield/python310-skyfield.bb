...
RPROVIDES:${PN} += "python3-skyfield python3.10dist(skyfield) python310-skyfield python3dist(skyfield)"
RDEPENDS:${PN} += "python(abi) python310-astropy python310-beautifulsoup4 python310-certifi python310-html5lib python310-jplephem python310-lxml python310-matplotlib python310-numpy python310-pandas python310-sgp4"
