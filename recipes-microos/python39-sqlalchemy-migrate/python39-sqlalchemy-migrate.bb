...
RPROVIDES:${PN} += "python3.9dist(sqlalchemy-migrate) python39-sqlalchemy-migrate python3dist(sqlalchemy-migrate)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.9 python(abi) python39-SQLAlchemy python39-Tempita python39-decorator python39-six python39-sqlparse update-alternatives"
