...
RPROVIDES:${PN} += "openocd openocd(aarch-64)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libftdi1.so.2()(64bit) libhidapi-hidraw.so.0()(64bit) libjaylink.so.0()(64bit) libjim.so.0.81()(64bit) libusb-1.0.so.0()(64bit) openocd-data udev"
