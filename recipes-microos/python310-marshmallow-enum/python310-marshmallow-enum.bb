...
RPROVIDES:${PN} += "python3-marshmallow-enum python3.10dist(marshmallow-enum) python310-marshmallow-enum python3dist(marshmallow-enum)"
RDEPENDS:${PN} += "python(abi) python310-marshmallow"
