...
RPROVIDES:${PN} += "netcdf-openmpi3-devel netcdf-openmpi3-devel(aarch-64)"
RDEPENDS:${PN} += "/bin/sh hdf5-openmpi3-devel libcurl-devel libnetcdf19-openmpi3 netcdf-devel-data openmpi3-devel pkgconfig zlib-devel"
