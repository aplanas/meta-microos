...
RPROVIDES:${PN} += "config(htcondor-credmon-oauth) htcondor-credmon-oauth htcondor-credmon-oauth(aarch-64)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 htcondor httpd mod_wsgi python3-Flask python3-condor python3-cryptography python3-requests-oauthlib python3-scitokens python3-six"
