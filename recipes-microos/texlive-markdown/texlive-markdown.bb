...
RPROVIDES:${PN} += "tex(markdown.sty) tex(markdown.tex) tex(markdownthemewitiko_dot.sty) tex(markdownthemewitiko_graphicx_http.sty) tex(markdownthemewitiko_tilde.sty) tex(t-markdown.tex) texlive-markdown"
