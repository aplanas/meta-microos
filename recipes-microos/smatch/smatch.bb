...
RPROVIDES:${PN} += "smatch smatch(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /usr/bin/perl /usr/bin/python3 ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libcrypto.so.3()(64bit) libcrypto.so.3(OPENSSL_3.0.0)(64bit) libsqlite3.so.0()(64bit)"
