...
RPROVIDES:${PN} += "config(wqy-zenhei-fonts) font(:lang=aa) font(:lang=af) font(:lang=an) font(:lang=av) font(:lang=ay) font(:lang=be) font(:lang=bg) font(:lang=bi) font(:lang=br) font(:lang=ca) font(:lang=ce) font(:lang=ch) font(:lang=co) font(:lang=da) font(:lang=de) font(:lang=el) font(:lang=en) font(:lang=es) font(:lang=eu) font(:lang=fil) font(:lang=fj) font(:lang=fo) font(:lang=fr) font(:lang=fur) font(:lang=fy) font(:lang=gd) font(:lang=gl) font(:lang=gv) font(:lang=ho) font(:lang=ht) font(:lang=ia) font(:lang=id) font(:lang=ie) font(:lang=ik) font(:lang=io) font(:lang=is) font(:lang=it) font(:lang=ja) font(:lang=jv) font(:lang=kj) font(:lang=ko) font(:lang=kum) font(:lang=kwm) font(:lang=lb) font(:lang=lez) font(:lang=lg) font(:lang=li) font(:lang=mg) font(:lang=ms) font(:lang=nb) font(:lang=nds) font(:lang=ng) font(:lang=nl) font(:lang=nn) font(:lang=no) font(:lang=nr) font(:lang=ny) font(:lang=oc) font(:lang=om) font(:lang=os) font(:lang=pap-an) font(:lang=pap-aw) font(:lang=pt) font(:lang=rm) font(:lang=rn) font(:lang=ru) font(:lang=rw) font(:lang=sc) font(:lang=sel) font(:lang=sg) font(:lang=sm) font(:lang=sma) font(:lang=smj) font(:lang=sn) font(:lang=so) font(:lang=sq) font(:lang=sr) font(:lang=ss) font(:lang=st) font(:lang=su) font(:lang=sv) font(:lang=sw) font(:lang=tl) font(:lang=to) font(:lang=ts) font(:lang=uz) font(:lang=vo) font(:lang=wa) font(:lang=wo) font(:lang=xh) font(:lang=yap) font(:lang=za) font(:lang=zh-cn) font(:lang=zh-sg) font(:lang=zh-tw) font(:lang=zu) font(wenquanyizenheimono) font(wenquanyizenheisharp) font(文泉驛正黑) font(文泉驛等寬正黑) font(文泉驛點陣正黑) font(文泉驿正黑) font(文泉驿点阵正黑) font(文泉驿等宽正黑) locale(zh_TW;zh_CN;zh_SG) scalable-font-zh-CN scalable-font-zh-SG scalable-font-zh-TW ttf-wqy-zenhei wqy-zenhei-fonts"
