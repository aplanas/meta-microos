...
RPROVIDES:${PN} += "ansible-cmdb python3.10dist(ansible-cmdb) python3dist(ansible-cmdb)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3 python(abi) python3-Mako python3-PyYAML python3-jsonxs"
