...
RPROVIDES:${PN} += "python3.11dist(sphinx-book-theme) python311-sphinx-book-theme python3dist(sphinx-book-theme)"
RDEPENDS:${PN} += "python(abi) python311-PyYAML python311-Sphinx python311-beautifulsoup4 python311-click python311-docutils python311-pydata-sphinx-theme"
