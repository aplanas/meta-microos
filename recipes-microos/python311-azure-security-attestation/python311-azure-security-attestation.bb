...
RPROVIDES:${PN} += "python3.11dist(azure-security-attestation) python311-azure-security-attestation python3dist(azure-security-attestation)"
RDEPENDS:${PN} += "python(abi) python311-azure-core python311-azure-nspkg python311-azure-security-nspkg python311-cryptography python311-msrest"
