...
RPROVIDES:${PN} += "perl(Module::Build::Tiny) perl-Module-Build-Tiny"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(CPAN::Meta) perl(ExtUtils::CBuilder) perl(ExtUtils::Config) perl(ExtUtils::Helpers) perl(ExtUtils::InstallPaths) perl(ExtUtils::ParseXS) perl(Getopt::Long) perl(JSON::PP) perl(TAP::Harness::Env)"
