...
RPROVIDES:${PN} += "ruby3.2-rubygem-slop \
ruby3.2-rubygem-slop(aarch-64) \
rubygem(ruby:3.2.0:slop) \
rubygem(ruby:3.2.0:slop:4) \
rubygem(ruby:3.2.0:slop:4.9) \
rubygem(ruby:3.2.0:slop:4.9.3) \
rubygem(slop)"
