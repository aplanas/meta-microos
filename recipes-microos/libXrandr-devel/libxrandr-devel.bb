...
RPROVIDES:${PN} += "libXrandr-devel libXrandr-devel(aarch-64) pkgconfig(xrandr)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libXrandr2 pkgconfig(randrproto) pkgconfig(x11) pkgconfig(xext) pkgconfig(xproto) pkgconfig(xrender)"
