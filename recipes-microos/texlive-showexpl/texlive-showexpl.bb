...
RPROVIDES:${PN} += "tex(showexpl.sty) texlive-showexpl"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(float.sty) tex(graphicx.sty) tex(listings.sty) tex(refcount.sty) tex(varwidth.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
