...
RPROVIDES:${PN} += "python3-pyfeyn python3.10dist(pyfeyn) python310-pyfeyn python3dist(pyfeyn)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-PyX update-alternatives"
