...
RPROVIDES:${PN} += "python3.8dist(pyqtgraph) python38-pyqtgraph python3dist(pyqtgraph)"
RDEPENDS:${PN} += "(python38-qt5 >= 5.12 or python38-PyQt6 >= 6.1) python(abi) python38-numpy"
