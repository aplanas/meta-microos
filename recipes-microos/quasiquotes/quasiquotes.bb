...
RPROVIDES:${PN} += "mvn(org.scalamacros:quasiquotes_2.10) mvn(org.scalamacros:quasiquotes_2.10:pom:) quasiquotes quasiquotes(aarch-64)"
RDEPENDS:${PN} += "java-headless javapackages-filesystem mvn(org.scala-lang:scala-library) mvn(org.scala-lang:scala-reflect)"
