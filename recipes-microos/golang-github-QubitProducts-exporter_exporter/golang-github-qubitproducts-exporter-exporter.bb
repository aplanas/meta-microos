...
RPROVIDES:${PN} += "config(golang-github-QubitProducts-exporter_exporter) golang-github-QubitProducts-exporter_exporter golang-github-QubitProducts-exporter_exporter(aarch-64)"
