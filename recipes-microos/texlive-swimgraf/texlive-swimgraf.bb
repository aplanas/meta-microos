...
RPROVIDES:${PN} += "tex(swimgraf.cfg) tex(swimgraf.sty) texlive-swimgraf"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(keyval.sty) tex(mathpazo.sty) tex(pst-plot.sty) tex(pstcol.sty) tex(pstricks.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
