...
RPROVIDES:${PN} += "libqmi-devel libqmi-devel(aarch-64) pkgconfig(qmi-glib)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libqmi-glib5 pkgconfig(gio-2.0) pkgconfig(gio-unix-2.0) pkgconfig(glib-2.0) pkgconfig(gobject-2.0) pkgconfig(mbim-glib) pkgconfig(qrtr-glib) typelib-1_0-Qmi-1_0"
