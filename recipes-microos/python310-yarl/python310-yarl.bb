...
RPROVIDES:${PN} += "python3-yarl python3.10dist(yarl) python310-yarl python310-yarl(aarch-64) python3dist(yarl)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) python(abi) python310-idna python310-multidict"
