...
RPROVIDES:${PN} += "python3-qcs-api-client python3.10dist(qcs-api-client) python310-qcs-api-client python3dist(qcs-api-client)"
RDEPENDS:${PN} += "python(abi) python310-PyJWT python310-attrs python310-dateutil python310-httpx python310-iso8601 python310-pyRFC3339 python310-pydantic python310-retrying python310-toml"
