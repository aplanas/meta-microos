...
RPROVIDES:${PN} += "tex(standalone.cfg) tex(standalone.cls) tex(standalone.sty) tex(standalone.tex) texlive-standalone"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(adjustbox.sty) tex(currfile-abspath.sty) tex(currfile.sty) tex(filemod-expmin.sty) tex(gincltex.sty) tex(ifluatex.sty) tex(ifpdf.sty) tex(ifxetex.sty) tex(luatex85.sty) tex(multido.sty) tex(pdftexcmds.sty) tex(preview.sty) tex(pstricks.sty) tex(shellesc.sty) tex(tikz.sty) tex(trimclip.sty) tex(varwidth.sty) tex(xkeyval.sty) texlive texlive-adjustbox texlive-currfile texlive-filemod texlive-filesystem texlive-gincltex texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-xkeyval"
