...
RPROVIDES:${PN} += "python3-libsmdev python310-libsmdev python310-libsmdev(aarch-64)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcerror.so.1()(64bit) libcerror.so.1(V_20220101)(64bit) libsmdev.so.1()(64bit) libsmdev.so.1(V_20221028)(64bit) python(abi)"
