...
RPROVIDES:${PN} += "jupyter-jupyterlab jupyter-jupyterlab-discovery"
RDEPENDS:${PN} += "/usr/bin/python3.10 jupyter-jupyterlab-filesystem nodejs npm python3dist(jupyterlab)"
