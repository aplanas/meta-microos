...
RPROVIDES:${PN} += "python3.11dist(ghp-import) python311-ghp-import python3dist(ghp-import)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-dateutil update-alternatives"
