...
RPROVIDES:${PN} += "python3.9dist(gcsfs) python39-gcsfs python3dist(gcsfs)"
RDEPENDS:${PN} += "python(abi) python39-aiohttp python39-decorator python39-fsspec python39-google-auth python39-google-auth-oauthlib python39-google-cloud-storage python39-requests"
