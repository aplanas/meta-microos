...
RPROVIDES:${PN} += "tex(gbt7714.sty) texlive-gbt7714"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(natbib.sty) tex(url.sty) texlive texlive-bibtex texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-natbib texlive-scripts texlive-scripts-bin texlive-url"
