...
RPROVIDES:${PN} += "gutenprint-devel gutenprint-devel(aarch-64) pkgconfig(gutenprint) pkgconfig(gutenprintui2)"
RDEPENDS:${PN} += "/usr/bin/pkg-config cups ghostscript-library glibc-devel gtk2-devel gutenprint pkgconfig(gtk+-2.0) pkgconfig(gutenprint)"
