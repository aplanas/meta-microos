...
RPROVIDES:${PN} += "python3-ezdxf python3.10dist(ezdxf) python310-ezdxf python310-ezdxf(aarch-64) python3dist(ezdxf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-pyparsing update-alternatives"
