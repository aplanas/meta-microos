...
RPROVIDES:${PN} += "tex(hyph-as.tex) tex(hyph-bn.tex) tex(hyph-gu.tex) tex(hyph-hi.tex) tex(hyph-kn.tex) tex(hyph-ml.tex) tex(hyph-mr.tex) tex(hyph-or.tex) tex(hyph-pa.tex) tex(hyph-pi.tex) tex(hyph-ta.tex) tex(hyph-te.tex) tex(loadhyph-as.tex) tex(loadhyph-bn.tex) tex(loadhyph-gu.tex) tex(loadhyph-hi.tex) tex(loadhyph-kn.tex) tex(loadhyph-ml.tex) tex(loadhyph-mr.tex) tex(loadhyph-or.tex) tex(loadhyph-pa.tex) tex(loadhyph-pi.tex) tex(loadhyph-ta.tex) tex(loadhyph-te.tex) texlive-hyphen-indic"
