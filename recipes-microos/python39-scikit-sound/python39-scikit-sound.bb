...
RPROVIDES:${PN} += "python3.9dist(scikit-sound) python39-scikit-sound python3dist(scikit-sound)"
RDEPENDS:${PN} += "python(abi) python39-PyYAML python39-appdirs python39-docutils python39-pygame python39-scipy"
