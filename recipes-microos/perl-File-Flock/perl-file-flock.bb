...
RPM_NAME = "perl-File-Flock-2014.01-1.19.noarch.rpm"
...
RPROVIDES:${PN} += "perl(File::Flock) perl(File::Flock::Forking) perl(File::Flock::Subprocess) perl(File::Flock::Subprocess::Connections) perl(File::Flock::Subprocess::Master) perl-File-Flock"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(AnyEvent) perl(Data::Structure::Util) perl(File::Slurp) perl(IO::Event) perl(Test::SharedFork)"
