...
RPROVIDES:${PN} += "python3-xhtml2pdf python3.10dist(xhtml2pdf) python310-xhtml2pdf python3dist(xhtml2pdf)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.10 python(abi) python310-Pillow python310-PyPDF3 python310-arabic-reshaper python310-html5lib python310-python-bidi python310-reportlab python310-setuptools update-alternatives"
