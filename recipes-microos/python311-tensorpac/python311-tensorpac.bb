...
RPROVIDES:${PN} += "python3.11dist(tensorpac) python311-tensorpac python3dist(tensorpac)"
RDEPENDS:${PN} += "python(abi) python311-joblib python311-numpy python311-scipy"
