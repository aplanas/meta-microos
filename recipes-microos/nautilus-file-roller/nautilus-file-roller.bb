...
RPROVIDES:${PN} += "libnautilus-fileroller.so()(64bit) nautilus-file-roller nautilus-file-roller(aarch-64)"
RDEPENDS:${PN} += "file-roller ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libgio-2.0.so.0()(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libnautilus-extension.so.4()(64bit) nautilus"
