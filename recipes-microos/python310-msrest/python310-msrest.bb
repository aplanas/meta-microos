...
RPROVIDES:${PN} += "python3-msrest python3.10dist(msrest) python310-msrest python3dist(msrest)"
RDEPENDS:${PN} += "python(abi) python310-azure-core python310-certifi python310-isodate python310-requests python310-requests-oauthlib"
