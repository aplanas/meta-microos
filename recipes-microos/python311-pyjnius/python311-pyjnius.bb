...
RPROVIDES:${PN} += "python3.11dist(pyjnius) python311-pyjnius python311-pyjnius(aarch-64) python3dist(pyjnius)"
RDEPENDS:${PN} += "ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) python(abi) python311-Cython"
