...
RPROVIDES:${PN} += "ruby3.2-rubygem-simpleidn ruby3.2-rubygem-simpleidn(aarch-64) rubygem(ruby:3.2.0:simpleidn) rubygem(ruby:3.2.0:simpleidn:0) rubygem(ruby:3.2.0:simpleidn:0.2) rubygem(ruby:3.2.0:simpleidn:0.2.1) rubygem(simpleidn)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:unf:0.1)"
