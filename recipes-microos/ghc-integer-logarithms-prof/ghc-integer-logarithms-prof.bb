...
RPROVIDES:${PN} += "ghc-integer-logarithms-prof ghc-integer-logarithms-prof(aarch-64) ghc-prof(integer-logarithms-1.0.3.1-Hm9v2fsfG1DA5soPSLssZu)"
RDEPENDS:${PN} += "ghc-integer-logarithms-devel ghc-prof(array-0.5.4.0) ghc-prof(base-4.17.1.0) ghc-prof(ghc-bignum-1.3) ghc-prof(ghc-prim-0.9.0)"
