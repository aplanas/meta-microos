...
RPROVIDES:${PN} += "python3.11dist(memory-profiler) python311-memory_profiler python3dist(memory-profiler)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-psutil update-alternatives"
