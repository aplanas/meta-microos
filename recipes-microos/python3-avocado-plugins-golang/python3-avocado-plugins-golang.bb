...
RPROVIDES:${PN} += "python3-avocado-plugins-golang python3.10dist(avocado-framework-plugin-golang) python3dist(avocado-framework-plugin-golang)"
RDEPENDS:${PN} += "go python(abi) python3-avocado"
