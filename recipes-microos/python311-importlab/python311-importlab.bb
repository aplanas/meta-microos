...
RPROVIDES:${PN} += "python3.11dist(importlab) python311-importlab python3dist(importlab)"
RDEPENDS:${PN} += "/bin/sh /usr/bin/python3.11 python(abi) python311-networkx update-alternatives"
