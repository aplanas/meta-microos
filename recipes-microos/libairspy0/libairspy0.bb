...
RPROVIDES:${PN} += "libairspy.so.0()(64bit) libairspy0 libairspy0(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig airspy-udev ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.34)(64bit) libusb-1.0.so.0()(64bit)"
