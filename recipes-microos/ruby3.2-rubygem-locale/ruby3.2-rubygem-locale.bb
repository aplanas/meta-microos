...
RPROVIDES:${PN} += "ruby3.2-rubygem-locale ruby3.2-rubygem-locale(aarch-64) rubygem(locale) rubygem(ruby:3.2.0:locale) rubygem(ruby:3.2.0:locale:2) rubygem(ruby:3.2.0:locale:2.1) rubygem(ruby:3.2.0:locale:2.1.3)"
