...
RPROVIDES:${PN} += "libboost_python-py3-1_82_0-devel libboost_python-py3-1_82_0-devel(aarch-64) libboost_python3-devel-impl"
RDEPENDS:${PN} += "libboost_headers1_82_0-devel libboost_python-py3-1_82_0"
