...
RPROVIDES:${PN} += "python3.11dist(redfish) python311-redfish python3dist(redfish)"
RDEPENDS:${PN} += "python(abi) python311-jsonpatch python311-jsonpath-rw python311-jsonpointer python311-requests python311-requests-toolbelt python311-requests-unixsocket"
