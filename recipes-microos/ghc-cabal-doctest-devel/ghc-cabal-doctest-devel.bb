...
RPROVIDES:${PN} += "ghc-cabal-doctest-devel ghc-cabal-doctest-devel(aarch-64) ghc-devel(cabal-doctest-1.0.9-E4yWN7tR5mMItu3qIh0oSF)"
RDEPENDS:${PN} += "/bin/sh ghc-cabal-doctest ghc-compiler ghc-devel(Cabal-3.8.1.0) ghc-devel(base-4.17.1.0) ghc-devel(directory-1.3.7.1) ghc-devel(filepath-1.4.2.2)"
