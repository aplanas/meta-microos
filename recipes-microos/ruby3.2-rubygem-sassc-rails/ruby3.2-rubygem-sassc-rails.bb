...
RPROVIDES:${PN} += "ruby3.2-rubygem-sassc-rails ruby3.2-rubygem-sassc-rails(aarch-64) rubygem(ruby:3.2.0:sassc-rails) rubygem(ruby:3.2.0:sassc-rails:2) rubygem(ruby:3.2.0:sassc-rails:2.1) rubygem(ruby:3.2.0:sassc-rails:2.1.2) rubygem(sassc-rails)"
RDEPENDS:${PN} += "ruby(abi) rubygem(ruby:3.2.0:railties) rubygem(ruby:3.2.0:sassc) rubygem(ruby:3.2.0:sprockets) rubygem(ruby:3.2.0:sprockets-rails) rubygem(ruby:3.2.0:tilt)"
