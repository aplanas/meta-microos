...
RPROVIDES:${PN} += "libmodulemd.so.2()(64bit) libmodulemd2 libmodulemd2(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.28)(64bit) libglib-2.0.so.0()(64bit) libgobject-2.0.so.0()(64bit) libmagic.so.1()(64bit) librpmio.so.9()(64bit) libyaml-0.so.2()(64bit)"
