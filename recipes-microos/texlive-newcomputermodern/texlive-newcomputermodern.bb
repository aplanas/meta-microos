...
RPROVIDES:${PN} += "tex(newcomputermodern.sty) texlive-newcomputermodern"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(fspdefault.sty) tex(fspolddefault.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-newcomputermodern-fonts texlive-scripts texlive-scripts-bin"
