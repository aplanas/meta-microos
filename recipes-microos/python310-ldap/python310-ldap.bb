...
RPROVIDES:${PN} += "python3-ldap python3.10dist(python-ldap) python310-ldap python310-ldap(aarch-64) python3dist(python-ldap)"
RDEPENDS:${PN} += "/bin/sh ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) liblber.so.2()(64bit) liblber.so.2(OPENLDAP_2.200)(64bit) libldap.so.2()(64bit) libldap.so.2(OPENLDAP_2.200)(64bit) python(abi) python310-pyasn1 python310-pyasn1-modules"
