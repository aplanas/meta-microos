...
RPROVIDES:${PN} += "tex(tikz-trackschematic.sty) tex(tikzlibrarytrackschematic.code.tex) tex(tikzlibrarytrackschematic.constructions.code.tex) tex(tikzlibrarytrackschematic.electrics.code.tex) tex(tikzlibrarytrackschematic.measures.code.tex) tex(tikzlibrarytrackschematic.symbology.code.tex) tex(tikzlibrarytrackschematic.topology.code.tex) tex(tikzlibrarytrackschematic.trafficcontrol.code.tex) tex(tikzlibrarytrackschematic.vehicles.code.tex) texlive-tikz-trackschematic"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(etoolbox.sty) tex(tikz.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin"
