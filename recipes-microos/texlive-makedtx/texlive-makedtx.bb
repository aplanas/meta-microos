...
RPROVIDES:${PN} += "tex(createdtx.sty) texlive-makedtx"
RDEPENDS:${PN} += "/bin/sh /usr/bin/perl coreutils ed findutils grep perl(Getopt::Long) sed texlive texlive-filesystem texlive-kpathsea texlive-kpathsea-bin texlive-makedtx-bin texlive-scripts texlive-scripts-bin"
