...
RPROVIDES:${PN} += "python3-compizconfig python310-compizconfig python310-compizconfig(aarch-64)"
RDEPENDS:${PN} += "compiz ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit) libcompizconfig.so.0()(64bit) python(abi)"
