...
RPROVIDES:${PN} += "ghc-Only-devel ghc-Only-devel(aarch-64) ghc-devel(Only-0.1-ETd5YCT0TwGLbN8rgpgTS8)"
RDEPENDS:${PN} += "/bin/sh ghc-Only ghc-compiler ghc-devel(base-4.17.1.0) ghc-devel(deepseq-1.4.8.0)"
