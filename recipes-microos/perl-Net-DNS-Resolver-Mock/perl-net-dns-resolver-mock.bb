...
RPROVIDES:${PN} += "perl(Net::DNS::Resolver::Mock) perl-Net-DNS-Resolver-Mock"
RDEPENDS:${PN} += "perl(:MODULE_COMPAT_5.36.0) perl(Net::DNS::Packet) perl(Net::DNS::Question) perl(Net::DNS::Resolver) perl(Net::DNS::ZoneFile)"
