...
RPROVIDES:${PN} += "libhdf5_hl_1_12_2-gnu-openmpi3-hpc libhdf5_hl_1_12_2-gnu-openmpi3-hpc(aarch-64)"
RDEPENDS:${PN} += "/sbin/ldconfig hdf5_1_12_2-gnu-openmpi3-hpc-module ld-linux-aarch64.so.1()(64bit) ld-linux-aarch64.so.1(GLIBC_2.17)(64bit) libc.so.6(GLIBC_2.17)(64bit)"
