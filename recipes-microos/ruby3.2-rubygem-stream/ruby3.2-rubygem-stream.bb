...
RPROVIDES:${PN} += "ruby3.2-rubygem-stream ruby3.2-rubygem-stream(aarch-64) rubygem(ruby:3.2.0:stream) rubygem(ruby:3.2.0:stream:0) rubygem(ruby:3.2.0:stream:0.5) rubygem(ruby:3.2.0:stream:0.5.5) rubygem(stream)"
