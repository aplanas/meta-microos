...
RPROVIDES:${PN} += "python3.9dist(azure-synapse-managedprivateendpoints) python39-azure-synapse python39-azure-synapse-managedprivateendpoints python3dist(azure-synapse-managedprivateendpoints)"
