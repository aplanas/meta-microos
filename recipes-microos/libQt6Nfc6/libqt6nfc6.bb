...
RPROVIDES:${PN} += "libQt6Nfc.so.6()(64bit) \
libQt6Nfc.so.6(Qt_6)(64bit) \
libQt6Nfc.so.6(Qt_6.0)(64bit) \
libQt6Nfc.so.6(Qt_6.1)(64bit) \
libQt6Nfc.so.6(Qt_6.2)(64bit) \
libQt6Nfc.so.6(Qt_6.3)(64bit) \
libQt6Nfc.so.6(Qt_6.4)(64bit) \
libQt6Nfc.so.6(Qt_6.5)(64bit) \
libQt6Nfc.so.6(Qt_6.5.1_PRIVATE_API)(64bit) \
libQt6Nfc6 \
libQt6Nfc6(aarch-64)"
