...
RPROVIDES:${PN} += "mozldap-devel mozldap-devel(aarch-64) pkgconfig(mozldap)"
RDEPENDS:${PN} += "/usr/bin/pkg-config mozilla-nspr-devel mozilla-nss-devel mozldap-libs pkgconfig pkgconfig(nspr) pkgconfig(nss)"
