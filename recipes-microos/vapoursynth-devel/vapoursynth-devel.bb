...
RPROVIDES:${PN} += "pkgconfig(vapoursynth) pkgconfig(vapoursynth-script) vapoursynth-devel vapoursynth-devel(aarch-64)"
RDEPENDS:${PN} += "/usr/bin/pkg-config libvapoursynth-62 libvapoursynth-script0 pkgconfig(python-3.10) pkgconfig(vapoursynth) pkgconfig(zimg)"
