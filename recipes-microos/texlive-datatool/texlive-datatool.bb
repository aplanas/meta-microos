...
RPROVIDES:${PN} += "tex(databar.sty) tex(databib.sty) tex(datagidx.sty) tex(datapie.sty) tex(dataplot.sty) tex(datatool-base.sty) tex(datatool-fp.sty) tex(datatool-pgfmath.sty) tex(datatool.sty) tex(person.sty) texlive-datatool"
RDEPENDS:${PN} += "/bin/sh coreutils ed findutils grep sed tex(afterpage.sty) tex(amsmath.sty) tex(etoolbox.sty) tex(fp.sty) tex(ifthen.sty) tex(mfirstuc.sty) tex(multicol.sty) tex(pgfkeys.sty) tex(pgfmath.sty) tex(pgfrcs.sty) tex(substr.sty) tex(textcase.sty) tex(tikz.sty) tex(xfor.sty) tex(xkeyval.sty) texlive texlive-filesystem texlive-fp texlive-kpathsea texlive-kpathsea-bin texlive-scripts texlive-scripts-bin texlive-substr texlive-xfor texlive-xkeyval"
