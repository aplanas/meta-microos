...
RPROVIDES:${PN} += "config(slurm-testsuite) slurm-testsuite slurm-testsuite(aarch-64)"
RDEPENDS:${PN} += "/bin/bash /bin/sh bind-utils bzip2 expect gcc-c++ libnuma-devel mariadb openmpi4-gnu-hpc-devel pam pdsh perl-slurm pmix-devel slurm slurm-auth-none slurm-cray slurm-devel slurm-hdf5 slurm-lua slurm-munge slurm-node slurm-openlava slurm-rest slurm-seff slurm-sjstat slurm-slurmdbd slurm-sql slurm-torque sudo tar"
