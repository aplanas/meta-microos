...
RPROVIDES:${PN} += "ruby3.2-rubygem-rspec-expectations-3_5 \
ruby3.2-rubygem-rspec-expectations-3_5(aarch-64) \
rubygem(rspec-expectations) \
rubygem(ruby:3.2.0:rspec-expectations) \
rubygem(ruby:3.2.0:rspec-expectations:3) \
rubygem(ruby:3.2.0:rspec-expectations:3.5) \
rubygem(ruby:3.2.0:rspec-expectations:3.5.0)"
