...
locale(thunar-plugin-media-tags:en_AU) \
locale(thunar-plugin-media-tags:en_CA) \
locale(thunar-plugin-media-tags:en_GB) \
...
locale(thunar-plugin-media-tags:pt_BR) \
...
locale(thunar-plugin-media-tags:zh_CN) \
