...
RPROVIDES:${PN} += "ruby3.2-rubygem-multi-xml \
rubygem-multi-xml \
rubygem-ruby-3.2.0-multi-xml \
rubygem-ruby-3.2.0-multi-xml-0 \
rubygem-ruby-3.2.0-multi-xml-0.6 \
rubygem-ruby-3.2.0-multi-xml-0.6.0"
