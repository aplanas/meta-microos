...
RPROVIDES:${PN} += "ruby3.2-rubygem-attr-required \
rubygem-attr-required \
rubygem-ruby-3.2.0-attr-required \
rubygem-ruby-3.2.0-attr-required-1 \
rubygem-ruby-3.2.0-attr-required-1.0 \
rubygem-ruby-3.2.0-attr-required-1.0.1"
