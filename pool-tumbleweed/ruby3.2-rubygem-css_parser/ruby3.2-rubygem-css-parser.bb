...
RPROVIDES:${PN} += "ruby3.2-rubygem-css-parser \
rubygem-css-parser \
rubygem-ruby-3.2.0-css-parser \
rubygem-ruby-3.2.0-css-parser-1 \
rubygem-ruby-3.2.0-css-parser-1.12 \
rubygem-ruby-3.2.0-css-parser-1.12.0"
