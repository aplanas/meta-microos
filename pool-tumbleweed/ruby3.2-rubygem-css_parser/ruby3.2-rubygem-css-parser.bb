...
RPROVIDES:${PN} += "ruby3.2-rubygem-css_parser \
ruby3.2-rubygem-css_parser(aarch-64) \
rubygem(css_parser) \
rubygem(ruby:3.2.0:css_parser) \
rubygem(ruby:3.2.0:css_parser:1) \
rubygem(ruby:3.2.0:css_parser:1.12) \
rubygem(ruby:3.2.0:css_parser:1.12.0)"
