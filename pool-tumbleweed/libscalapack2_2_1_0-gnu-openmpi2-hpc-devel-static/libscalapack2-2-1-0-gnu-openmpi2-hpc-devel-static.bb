...
RPROVIDES:${PN} += "libscalapack2_2_1_0-gnu-openmpi2-hpc-devel-static \
libscalapack2_2_1_0-gnu-openmpi2-hpc-devel-static(aarch-64) \
scalapack_2_1_0-gnu-openmpi2-hpc-devel-static"
