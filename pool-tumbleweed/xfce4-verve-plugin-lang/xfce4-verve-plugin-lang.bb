...
locale(xfce4-verve-plugin:en_AU) \
locale(xfce4-verve-plugin:en_CA) \
locale(xfce4-verve-plugin:en_GB) \
...
locale(xfce4-verve-plugin:pt_BR) \
...
locale(xfce4-verve-plugin:zh_CN) \
locale(xfce4-verve-plugin:zh_TW) \
