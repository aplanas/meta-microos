...
RPROVIDES:${PN} += "libcrypto.so.1.0.0()(64bit) \
libcrypto.so.1.0.0(OPENSSL_1.0.0)(64bit) \
libcrypto.so.1.0.0(OPENSSL_1.0.1)(64bit) \
libcrypto.so.1.0.0(OPENSSL_1.0.1_EC)(64bit) \
libcrypto.so.1.0.0(OPENSSL_1.0.2)(64bit) \
libgost.so()(64bit) \
libgost.so(OPENSSL_1.0.0)(64bit) \
libgost.so(OPENSSL_1.0.1)(64bit) \
libgost.so(OPENSSL_1.0.1_EC)(64bit) \
libgost.so(OPENSSL_1.0.2)(64bit) \
libopenssl1_0_0 \
libopenssl1_0_0(aarch-64) \
libssl.so.1.0.0()(64bit) \
libssl.so.1.0.0(OPENSSL_1.0.0)(64bit) \
libssl.so.1.0.0(OPENSSL_1.0.1)(64bit) \
libssl.so.1.0.0(OPENSSL_1.0.1_EC)(64bit) \
libssl.so.1.0.0(OPENSSL_1.0.2)(64bit)"
