...
RPROVIDES:${PN} += "rpm_macro(rb_build_ruby_abis) \
rpm_macro(rb_build_versions) \
rpm_macro(rb_default_ruby) \
rpm_macro(rb_default_ruby_abi) \
rpm_macro(rb_default_ruby_suffix) \
rpm_macro(rubydevelruby32) \
rpm_macro(rubydevelxruby32) \
rpm_macro(rubygemsruby32) \
rpm_macro(rubygemsxruby32) \
rpm_macro(rubyruby32) \
rpm_macro(rubyxruby32) \
ruby(abi) \
ruby-default \
ruby3.2 \
ruby3.2(aarch-64) \
...
rubygem(ruby:3.2.0:did_you_mean) \
rubygem(ruby:3.2.0:did_you_mean:1) \
rubygem(ruby:3.2.0:did_you_mean:1.6) \
rubygem(ruby:3.2.0:did_you_mean:1.6.3) \
...
rubygem(ruby:3.2.0:error_highlight) \
rubygem(ruby:3.2.0:error_highlight:0) \
rubygem(ruby:3.2.0:error_highlight:0.5) \
rubygem(ruby:3.2.0:error_highlight:0.5.1) \
...
rubygem(ruby:3.2.0:mutex_m) \
rubygem(ruby:3.2.0:mutex_m:0) \
rubygem(ruby:3.2.0:mutex_m:0.1) \
rubygem(ruby:3.2.0:mutex_m:0.1.2) \
...
rubygem(ruby:3.2.0:power_assert) \
rubygem(ruby:3.2.0:power_assert:2) \
rubygem(ruby:3.2.0:power_assert:2.0) \
rubygem(ruby:3.2.0:power_assert:2.0.3) \
...
rubygem(ruby:3.2.0:syntax_suggest) \
rubygem(ruby:3.2.0:syntax_suggest:1) \
rubygem(ruby:3.2.0:syntax_suggest:1.0) \
rubygem(ruby:3.2.0:syntax_suggest:1.0.2) \
