...
RPROVIDES:${PN} += "ruby3.2-rubygem-orm-adapter \
rubygem-orm-adapter \
rubygem-ruby-3.2.0-orm-adapter \
rubygem-ruby-3.2.0-orm-adapter-0 \
rubygem-ruby-3.2.0-orm-adapter-0.5 \
rubygem-ruby-3.2.0-orm-adapter-0.5.0"
