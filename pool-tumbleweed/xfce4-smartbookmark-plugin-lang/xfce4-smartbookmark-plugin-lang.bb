...
locale(xfce4-smartbookmark-plugin:en_AU) \
locale(xfce4-smartbookmark-plugin:en_CA) \
locale(xfce4-smartbookmark-plugin:en_GB) \
...
locale(xfce4-smartbookmark-plugin:pt_BR) \
...
locale(xfce4-smartbookmark-plugin:zh_CN) \
locale(xfce4-smartbookmark-plugin:zh_TW) \
