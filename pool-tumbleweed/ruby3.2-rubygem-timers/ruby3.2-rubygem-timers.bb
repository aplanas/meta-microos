...
RPROVIDES:${PN} += "ruby3.2-rubygem-timers \
ruby3.2-rubygem-timers(aarch-64) \
rubygem(ruby:3.2.0:timers) \
rubygem(ruby:3.2.0:timers:4) \
rubygem(ruby:3.2.0:timers:4.3) \
rubygem(ruby:3.2.0:timers:4.3.5) \
rubygem(timers)"
