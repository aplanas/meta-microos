...
RPROVIDES:${PN} += "ruby3.2-rubygem-vagrant-cloud \
rubygem-ruby-3.2.0-vagrant-cloud \
rubygem-ruby-3.2.0-vagrant-cloud-3 \
rubygem-ruby-3.2.0-vagrant-cloud-3.0 \
rubygem-ruby-3.2.0-vagrant-cloud-3.0.5 \
rubygem-vagrant-cloud"
