...
locale(xfce4-session:en_AU) \
locale(xfce4-session:en_CA) \
locale(xfce4-session:en_GB) \
...
locale(xfce4-session:zh_CN) \
locale(xfce4-session:zh_HK) \
locale(xfce4-session:zh_TW) \
xfce4-session-lang \
