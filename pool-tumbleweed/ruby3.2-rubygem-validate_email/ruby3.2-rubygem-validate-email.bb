...
RPROVIDES:${PN} += "ruby3.2-rubygem-validate-email \
rubygem-ruby-3.2.0-validate-email \
rubygem-ruby-3.2.0-validate-email-0 \
rubygem-ruby-3.2.0-validate-email-0.1 \
rubygem-ruby-3.2.0-validate-email-0.1.6 \
