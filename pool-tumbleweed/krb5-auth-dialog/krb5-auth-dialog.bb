...
application(org.gnome.KrbAuthDialog.desktop) \
krb5-auth-dialog \
krb5-auth-dialog(aarch-64) \
libka-plugin-afs.so()(64bit) \
libka-plugin-dummy.so()(64bit) \
libka-plugin-gnomelock.so()(64bit) \
libka-plugin-pam.so()(64bit) \
metainfo() \
metainfo(org.gnome.KrbAuthDialog.metainfo.xml)"
