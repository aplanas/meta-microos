...
RPROVIDES:${PN} += "ruby3.2-rubygem-openid-connect \
rubygem-openid-connect \
rubygem-ruby-3.2.0-openid-connect \
rubygem-ruby-3.2.0-openid-connect-2 \
rubygem-ruby-3.2.0-openid-connect-2.2 \
rubygem-ruby-3.2.0-openid-connect-2.2.0"
...
rubygem-ruby-3.2.0-validate-email \
