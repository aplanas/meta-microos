...
locale(xfce4-datetime-plugin:en_AU) \
locale(xfce4-datetime-plugin:en_CA) \
locale(xfce4-datetime-plugin:en_GB) \
...
locale(xfce4-datetime-plugin:pt_BR) \
...
locale(xfce4-datetime-plugin:zh_CN) \
locale(xfce4-datetime-plugin:zh_TW) \
