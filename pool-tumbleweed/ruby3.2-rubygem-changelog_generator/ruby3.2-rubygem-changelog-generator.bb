...
RPROVIDES:${PN} += "ruby3.2-rubygem-changelog-generator \
rubygem-changelog-generator \
rubygem-ruby-3.2.0-changelog-generator \
rubygem-ruby-3.2.0-changelog-generator-0 \
rubygem-ruby-3.2.0-changelog-generator-0.3 \
rubygem-ruby-3.2.0-changelog-generator-0.3.0"
