...
application(modem-manager-gui.desktop) \
libmodcm_connman112.so()(64bit) \
libmodcm_nm09.so()(64bit) \
libmodcm_pppd245.so()(64bit) \
libmodmm_mm06.so()(64bit) \
libmodmm_mm07.so()(64bit) \
libmodmm_ofono109.so()(64bit) \
metainfo() \
