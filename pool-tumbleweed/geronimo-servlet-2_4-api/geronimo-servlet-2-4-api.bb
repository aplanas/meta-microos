...
RPROVIDES:${PN} += "geronimo-servlet-2_4-api \
mvn(org.apache.geronimo.specs:geronimo-servlet_2.4_spec) \
mvn(org.apache.geronimo.specs:geronimo-servlet_2.4_spec:pom:) \
servlet \
servlet_2_4_api \
servlet_api"
RDEPENDS:${PN} += "/bin/sh \
