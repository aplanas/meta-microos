...
locale(brisk-menu:de_CH) \
locale(brisk-menu:el) \
locale(brisk-menu:en_GB) \
locale(brisk-menu:en_US) \
locale(brisk-menu:eo) \
locale(brisk-menu:es) \
locale(brisk-menu:es_AR) \
locale(brisk-menu:es_MX) \
locale(brisk-menu:eu) \
locale(brisk-menu:fi) \
locale(brisk-menu:fr_FR) \
...
locale(brisk-menu:nb_NO) \
locale(brisk-menu:nl_BE) \
locale(brisk-menu:nn) \
locale(brisk-menu:pl) \
locale(brisk-menu:pt_BR) \
locale(brisk-menu:pt_PT) \
