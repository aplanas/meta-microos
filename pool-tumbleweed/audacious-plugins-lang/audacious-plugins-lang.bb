...
locale(audacious-plugins:en_GB) \
locale(audacious-plugins:es) \
locale(audacious-plugins:es_AR) \
locale(audacious-plugins:es_MX) \
...
locale(audacious-plugins:pt_BR) \
locale(audacious-plugins:pt_PT) \
