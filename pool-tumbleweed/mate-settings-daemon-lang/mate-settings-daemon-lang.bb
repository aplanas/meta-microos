...
locale(mate-settings-daemon:bn_IN) \
...
locale(mate-settings-daemon:en_AU) \
locale(mate-settings-daemon:en_CA) \
locale(mate-settings-daemon:en_GB) \
locale(mate-settings-daemon:eo) \
locale(mate-settings-daemon:es) \
locale(mate-settings-daemon:es_AR) \
locale(mate-settings-daemon:es_CL) \
locale(mate-settings-daemon:es_CO) \
locale(mate-settings-daemon:es_CR) \
locale(mate-settings-daemon:es_DO) \
locale(mate-settings-daemon:es_EC) \
locale(mate-settings-daemon:es_ES) \
locale(mate-settings-daemon:es_MX) \
locale(mate-settings-daemon:es_NI) \
locale(mate-settings-daemon:es_PA) \
locale(mate-settings-daemon:es_PE) \
locale(mate-settings-daemon:es_PR) \
locale(mate-settings-daemon:es_SV) \
locale(mate-settings-daemon:es_UY) \
locale(mate-settings-daemon:es_VE) \
...
locale(mate-settings-daemon:pt_BR) \
...
locale(mate-settings-daemon:zh_CN) \
locale(mate-settings-daemon:zh_HK) \
