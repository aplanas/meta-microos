...
RPROVIDES:${PN} += "ruby3.2-rubygem-http-form_data \
ruby3.2-rubygem-http-form_data(aarch-64) \
rubygem(http-form_data) \
rubygem(ruby:3.2.0:http-form_data) \
rubygem(ruby:3.2.0:http-form_data:2) \
rubygem(ruby:3.2.0:http-form_data:2.3) \
rubygem(ruby:3.2.0:http-form_data:2.3.0)"
