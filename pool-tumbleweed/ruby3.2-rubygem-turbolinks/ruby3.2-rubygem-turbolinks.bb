...
RPROVIDES:${PN} += "ruby3.2-rubygem-turbolinks \
ruby3.2-rubygem-turbolinks(aarch-64) \
rubygem(ruby:3.2.0:turbolinks) \
rubygem(ruby:3.2.0:turbolinks:5) \
rubygem(ruby:3.2.0:turbolinks:5.2) \
rubygem(ruby:3.2.0:turbolinks:5.2.1) \
rubygem(turbolinks)"
