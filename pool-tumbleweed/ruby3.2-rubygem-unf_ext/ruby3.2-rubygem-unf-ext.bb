...
RPROVIDES:${PN} += "ruby3.2-rubygem-unf_ext \
ruby3.2-rubygem-unf_ext(aarch-64) \
rubygem(ruby:3.2.0:unf_ext) \
rubygem(ruby:3.2.0:unf_ext:0) \
rubygem(ruby:3.2.0:unf_ext:0.0) \
rubygem(ruby:3.2.0:unf_ext:0.0.8) \
rubygem(unf_ext)"
