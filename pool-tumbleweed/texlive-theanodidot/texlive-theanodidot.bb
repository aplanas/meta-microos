...
tex(TheanoDidot.map) \
tex(TheanoDidot.sty) \
tex(thdid_alkcdl.enc) \
tex(thdid_ertqq3.enc) \
tex(thdid_f66p55.enc) \
tex(thdid_izaajv.enc) \
tex(thdid_k6ngqv.enc) \
tex(thdid_lqxlns.enc) \
tex(thdid_oiucyb.enc) \
tex(thdid_whuz6y.enc) \
