...
RPROVIDES:${PN} += "libQt6Quick3DHelpersImpl.so.6()(64bit) \
libQt6Quick3DHelpersImpl.so.6(Qt_6)(64bit) \
libQt6Quick3DHelpersImpl.so.6(Qt_6.0)(64bit) \
libQt6Quick3DHelpersImpl.so.6(Qt_6.1)(64bit) \
libQt6Quick3DHelpersImpl.so.6(Qt_6.2)(64bit) \
libQt6Quick3DHelpersImpl.so.6(Qt_6.3)(64bit) \
libQt6Quick3DHelpersImpl.so.6(Qt_6.4)(64bit) \
libQt6Quick3DHelpersImpl.so.6(Qt_6.5)(64bit) \
libQt6Quick3DHelpersImpl.so.6(Qt_6.5.1_PRIVATE_API)(64bit) \
libQt6Quick3DHelpersImpl6 \
libQt6Quick3DHelpersImpl6(aarch-64)"
