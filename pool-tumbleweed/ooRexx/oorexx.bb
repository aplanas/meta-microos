...
RPROVIDES:${PN} += "libhostemu.so.4()(64bit) \
librexx.so.4()(64bit) \
librexxapi.so.4()(64bit) \
librexxutil.so.4()(64bit) \
librxmath.so.4()(64bit) \
librxregexp.so.4()(64bit) \
librxsock.so.4()(64bit) \
librxunixsys.so.4()(64bit) \
ooRexx \
ooRexx(aarch-64) \
rpm_macro(_ooRexx) \
