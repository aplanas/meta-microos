...
ghc-compiler(aarch-64) \
hsc2hs-0.68.8-3.1"
RDEPENDS:${PN} += "/bin/sh \
gcc \
ghc-base-devel \
ghc-filesystem \
libHSCabal-3.8.1.0-ghc9.4.5.so()(64bit) \
...
libHSghc-9.4.5-ghc9.4.5.so()(64bit) \
...
libHShpc-0.6.1.0-ghc9.4.5.so()(64bit) \
libHSlibiserv-9.4.5-ghc9.4.5.so()(64bit) \
