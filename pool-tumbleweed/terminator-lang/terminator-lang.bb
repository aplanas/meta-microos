...
locale(terminator:en_AU) \
locale(terminator:en_CA) \
locale(terminator:en_GB) \
...
locale(terminator:pt_BR) \
locale(terminator:ro) \
locale(terminator:ru) \
locale(terminator:ru_RU) \
...
locale(terminator:zh_CN) \
locale(terminator:zh_HK) \
