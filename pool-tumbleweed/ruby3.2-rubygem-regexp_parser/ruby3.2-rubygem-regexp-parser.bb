...
RPROVIDES:${PN} += "ruby3.2-rubygem-regexp-parser \
rubygem-regexp-parser \
rubygem-ruby-3.2.0-regexp-parser \
rubygem-ruby-3.2.0-regexp-parser-2 \
rubygem-ruby-3.2.0-regexp-parser-2.6 \
rubygem-ruby-3.2.0-regexp-parser-2.6.1"
