...
RPROVIDES:${PN} += "ruby3.2-rubygem-regexp_parser \
ruby3.2-rubygem-regexp_parser(aarch-64) \
rubygem(regexp_parser) \
rubygem(ruby:3.2.0:regexp_parser) \
rubygem(ruby:3.2.0:regexp_parser:2) \
rubygem(ruby:3.2.0:regexp_parser:2.6) \
rubygem(ruby:3.2.0:regexp_parser:2.6.1)"
