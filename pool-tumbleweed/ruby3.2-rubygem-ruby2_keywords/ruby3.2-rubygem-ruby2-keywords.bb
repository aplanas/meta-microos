...
RPROVIDES:${PN} += "ruby3.2-rubygem-ruby2_keywords \
ruby3.2-rubygem-ruby2_keywords(aarch-64) \
rubygem(ruby2_keywords) \
rubygem(ruby:3.2.0:ruby2_keywords) \
rubygem(ruby:3.2.0:ruby2_keywords:0) \
rubygem(ruby:3.2.0:ruby2_keywords:0.0) \
rubygem(ruby:3.2.0:ruby2_keywords:0.0.5)"
