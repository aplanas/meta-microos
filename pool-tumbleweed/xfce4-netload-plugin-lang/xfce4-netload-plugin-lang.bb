...
locale(xfce4-netload-plugin:en_AU) \
locale(xfce4-netload-plugin:en_CA) \
locale(xfce4-netload-plugin:en_GB) \
...
locale(xfce4-netload-plugin:pt_BR) \
...
locale(xfce4-netload-plugin:zh_CN) \
locale(xfce4-netload-plugin:zh_TW) \
