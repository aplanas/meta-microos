...
RPROVIDES:${PN} += "jupyter-jupyter_core-filesystem \
jupyter-jupyter_core-macros-devel \
python310-jupyter_core-filesystem \
python310-jupyter_core-macros-devel \
python311-jupyter_core-filesystem \
python311-jupyter_core-macros-devel \
python39-jupyter_core-filesystem \
python39-jupyter_core-macros-devel \
rpm_macro(_jupyter_confdir) \
rpm_macro(_jupyter_config) \
rpm_macro(_jupyter_distconfig) \
