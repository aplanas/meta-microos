...
RPROVIDES:${PN} += "ruby3.2-rubygem-sexp-processor \
rubygem-ruby-3.2.0-sexp-processor \
rubygem-ruby-3.2.0-sexp-processor-4 \
rubygem-ruby-3.2.0-sexp-processor-4.16 \
rubygem-ruby-3.2.0-sexp-processor-4.16.1 \
rubygem-sexp-processor"
