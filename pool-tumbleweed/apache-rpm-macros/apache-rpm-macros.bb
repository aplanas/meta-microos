...
apache-rpm-macros(aarch-64) \
rpm_macro(apache_access_syntax_version) \
rpm_macro(apache_apxs) \
rpm_macro(apache_branch) \
rpm_macro(apache_cflags) \
rpm_macro(apache_datadir) \
rpm_macro(apache_group) \
rpm_macro(apache_includedir) \
rpm_macro(apache_libexecdir) \
rpm_macro(apache_localstatedir) \
rpm_macro(apache_major) \
rpm_macro(apache_mmn) \
rpm_macro(apache_pname) \
rpm_macro(apache_serverroot) \
rpm_macro(apache_suse_maintenance_mmn) \
