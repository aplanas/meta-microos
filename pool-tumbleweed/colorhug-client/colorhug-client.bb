...
application(com.hughski.ColorHug.Backlight.desktop) \
application(com.hughski.ColorHug.CcmxLoader.desktop) \
application(com.hughski.ColorHug.DisplayAnalysis.desktop) \
application(com.hughski.ColorHug.FlashLoader.desktop) \
colorhug-client \
colorhug-client(aarch-64) \
metainfo() \
metainfo(com.hughski.ColorHug.Backlight.appdata.xml) \
metainfo(com.hughski.ColorHug.CcmxLoader.appdata.xml) \
metainfo(com.hughski.ColorHug.DisplayAnalysis.appdata.xml) \
metainfo(com.hughski.ColorHug.FlashLoader.appdata.xml) \
mimehandler(application/x-ccmx)"
