...
firmware(amdgpu/psp_13_0_5_asd.bin) \
...
firmware(amdgpu/psp_13_0_8_asd.bin) \
...
firmware(amdgpu/tahiti_k_smc.bin) \
...
firmware(dpaa2/mc/mc_10.10.0_ls1088a.itb) \
...
firmware(liquidio/lio_210nv_nic.bin) \
...
firmware(mellanox/lc_ini_bundle_2010_1006.bin) \
...
firmware(mrvl/prestera/mvsw_prestera_fw-v2.0.img) \
...
firmware(netronome/bpf/nic_AMDA0058-0011_2x40.nffw) \
...
firmware(nvidia/gk20a/fecs_data.bin) \
firmware(nvidia/gk20a/fecs_inst.bin) \
firmware(nvidia/gk20a/gpccs_data.bin) \
firmware(nvidia/gk20a/gpccs_inst.bin) \
firmware(nvidia/gk20a/sw_bundle_init.bin) \
firmware(nvidia/gk20a/sw_ctx.bin) \
firmware(nvidia/gk20a/sw_method_init.bin) \
firmware(nvidia/gk20a/sw_nonctx.bin) \
...
firmware(nvidia/tu10x/typec/ccg_boot.cyacd) \
firmware(nvidia/tu10x/typec/ccg_primary.cyacd) \
firmware(nvidia/tu10x/typec/ccg_secondary.cyacd) \
...
firmware(ti-connectivity/TIInit_6.2.31.bts) \
