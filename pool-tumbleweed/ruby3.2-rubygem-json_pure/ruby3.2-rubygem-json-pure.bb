...
RPROVIDES:${PN} += "ruby3.2-rubygem-json-pure \
rubygem-json-pure \
rubygem-ruby-3.2.0-json-pure \
rubygem-ruby-3.2.0-json-pure-2 \
rubygem-ruby-3.2.0-json-pure-2.6 \
rubygem-ruby-3.2.0-json-pure-2.6.3"
