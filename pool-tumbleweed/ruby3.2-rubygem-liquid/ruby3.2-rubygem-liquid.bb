...
RPROVIDES:${PN} += "ruby3.2-rubygem-liquid \
ruby3.2-rubygem-liquid(aarch-64) \
rubygem(liquid) \
rubygem(ruby:3.2.0:liquid) \
rubygem(ruby:3.2.0:liquid:5) \
rubygem(ruby:3.2.0:liquid:5.4) \
rubygem(ruby:3.2.0:liquid:5.4.0)"
