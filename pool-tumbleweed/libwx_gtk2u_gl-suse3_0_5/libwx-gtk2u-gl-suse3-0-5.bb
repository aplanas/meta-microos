...
RPROVIDES:${PN} += "libwx_gtk2u_gl-suse.so.3.0.5()(64bit) \
libwx_gtk2u_gl-suse.so.3.0.5(WXU_3.0)(64bit) \
libwx_gtk2u_gl-suse.so.3.0.5(WXU_3.0.1)(64bit) \
libwx_gtk2u_gl-suse.so.3.0.5(WXU_3.0.2)(64bit) \
libwx_gtk2u_gl-suse.so.3.0.5(WXU_3.0.3)(64bit) \
libwx_gtk2u_gl-suse.so.3.0.5(WXU_3.0.4)(64bit) \
libwx_gtk2u_gl-suse.so.3.0.5(WXU_3.0.5)(64bit) \
libwx_gtk2u_gl-suse3_0_5 \
libwx_gtk2u_gl-suse3_0_5(aarch-64)"
