...
RPROVIDES:${PN} += "ruby3.2-rubygem-turbolinks-source \
ruby3.2-rubygem-turbolinks-source(aarch-64) \
rubygem(ruby:3.2.0:turbolinks-source) \
rubygem(ruby:3.2.0:turbolinks-source:5) \
rubygem(ruby:3.2.0:turbolinks-source:5.2) \
rubygem(ruby:3.2.0:turbolinks-source:5.2.0) \
