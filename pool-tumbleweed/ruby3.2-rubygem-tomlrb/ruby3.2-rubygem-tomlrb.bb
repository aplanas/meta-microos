...
RPROVIDES:${PN} += "ruby3.2-rubygem-tomlrb \
ruby3.2-rubygem-tomlrb(aarch-64) \
rubygem(ruby:3.2.0:tomlrb) \
rubygem(ruby:3.2.0:tomlrb:2) \
rubygem(ruby:3.2.0:tomlrb:2.0) \
rubygem(ruby:3.2.0:tomlrb:2.0.3) \
rubygem(tomlrb)"
