...
RPROVIDES:${PN} += "gstreamer1(element-xcamfilter)()(64bit) \
gstreamer1(element-xcamsrc)()(64bit) \
libgstxcamfilter.so()(64bit) \
libgstxcamsrc.so()(64bit) \
libxcam1 \
libxcam1(aarch-64) \
libxcam_capi.so.1()(64bit) \
libxcam_core.so.1()(64bit) \
libxcam_gles.so.1()(64bit) \
