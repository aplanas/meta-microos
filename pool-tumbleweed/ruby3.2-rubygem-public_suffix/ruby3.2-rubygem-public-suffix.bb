...
RPROVIDES:${PN} += "ruby3.2-rubygem-public_suffix \
ruby3.2-rubygem-public_suffix(aarch-64) \
rubygem(public_suffix) \
rubygem(ruby:3.2.0:public_suffix) \
rubygem(ruby:3.2.0:public_suffix:5) \
rubygem(ruby:3.2.0:public_suffix:5.0) \
rubygem(ruby:3.2.0:public_suffix:5.0.0)"
