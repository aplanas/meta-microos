...
RPROVIDES:${PN} += "ruby3.2-rubygem-public-suffix \
rubygem-public-suffix \
rubygem-ruby-3.2.0-public-suffix \
rubygem-ruby-3.2.0-public-suffix-5 \
rubygem-ruby-3.2.0-public-suffix-5.0 \
rubygem-ruby-3.2.0-public-suffix-5.0.0"
