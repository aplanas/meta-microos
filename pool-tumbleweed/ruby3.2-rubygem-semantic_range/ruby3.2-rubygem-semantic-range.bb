...
RPROVIDES:${PN} += "ruby3.2-rubygem-semantic-range \
rubygem-ruby-3.2.0-semantic-range \
rubygem-ruby-3.2.0-semantic-range-3 \
rubygem-ruby-3.2.0-semantic-range-3.0 \
rubygem-ruby-3.2.0-semantic-range-3.0.0 \
