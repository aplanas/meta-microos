...
RPROVIDES:${PN} += "ruby3.2-rubygem-semantic_range \
ruby3.2-rubygem-semantic_range(aarch-64) \
rubygem(ruby:3.2.0:semantic_range) \
rubygem(ruby:3.2.0:semantic_range:3) \
