...
RPROVIDES:${PN} += "ruby3.2-rubygem-importmap-rails \
ruby3.2-rubygem-importmap-rails(aarch-64) \
rubygem(importmap-rails) \
rubygem(ruby:3.2.0:importmap-rails) \
rubygem(ruby:3.2.0:importmap-rails:1) \
rubygem(ruby:3.2.0:importmap-rails:1.1) \
rubygem(ruby:3.2.0:importmap-rails:1.1.5)"
