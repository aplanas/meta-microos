...
octave-devel(aarch-64) \
pkgconfig(octave) \
pkgconfig(octinterp) \
rpm_macro(octave) \
rpm_macro(octave_api) \
rpm_macro(octave_blas) \
rpm_macro(octave_pkg_build) \
rpm_macro(octave_pkg_install) \
rpm_macro(octave_pkg_src) \
rpm_macro(octave_pkg_test) \
rpm_macro(octlib_dir) \
