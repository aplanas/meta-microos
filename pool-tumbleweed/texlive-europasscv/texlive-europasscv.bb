...
tex(europasscv.cls) \
tex(europasscv_ca.def) \
tex(europasscv_cs.def) \
tex(europasscv_da.def) \
tex(europasscv_de.def) \
tex(europasscv_el.def) \
tex(europasscv_en.def) \
tex(europasscv_es.def) \
tex(europasscv_fr.def) \
tex(europasscv_hu.def) \
tex(europasscv_it.def) \
tex(europasscv_nb.def) \
tex(europasscv_pl.def) \
tex(europasscv_pt.def) \
tex(europasscv_ro.def) \
tex(europasscv_sk.def) \
tex(europasscv_sl.def) \
