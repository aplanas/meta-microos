...
RPROVIDES:${PN} += "firmware(mediatek/BT_RAM_CODE_MT7922_1_1_hdr.bin) \
...
firmware(mediatek/mt7615_cr4.bin) \
firmware(mediatek/mt7615_n9.bin) \
firmware(mediatek/mt7615_rom_patch.bin) \
firmware(mediatek/mt7622_n9.bin) \
firmware(mediatek/mt7622_rom_patch.bin) \
firmware(mediatek/mt7622pr2h.bin) \
firmware(mediatek/mt7650.bin) \
firmware(mediatek/mt7650e.bin) \
firmware(mediatek/mt7662.bin) \
firmware(mediatek/mt7662_rom_patch.bin) \
firmware(mediatek/mt7662u.bin) \
firmware(mediatek/mt7662u_rom_patch.bin) \
firmware(mediatek/mt7663_n9_rebb.bin) \
firmware(mediatek/mt7663_n9_v3.bin) \
firmware(mediatek/mt7663pr2h.bin) \
firmware(mediatek/mt7663pr2h_rebb.bin) \
firmware(mediatek/mt7668pr2h.bin) \
firmware(mediatek/mt7915_eeprom.bin) \
firmware(mediatek/mt7915_eeprom_dbdc.bin) \
firmware(mediatek/mt7915_rom_patch.bin) \
firmware(mediatek/mt7915_wa.bin) \
firmware(mediatek/mt7915_wm.bin) \
firmware(mediatek/mt7916_eeprom.bin) \
firmware(mediatek/mt7916_rom_patch.bin) \
firmware(mediatek/mt7916_wa.bin) \
firmware(mediatek/mt7916_wm.bin) \
firmware(mediatek/mt7981_rom_patch.bin) \
firmware(mediatek/mt7981_wa.bin) \
firmware(mediatek/mt7981_wm.bin) \
firmware(mediatek/mt7981_wo.bin) \
firmware(mediatek/mt7986_eeprom_mt7975_dual.bin) \
firmware(mediatek/mt7986_eeprom_mt7976.bin) \
firmware(mediatek/mt7986_eeprom_mt7976_dbdc.bin) \
