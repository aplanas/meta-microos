...
RPROVIDES:${PN} += "ruby3.2-rubygem-multi-json \
rubygem-multi-json \
rubygem-ruby-3.2.0-multi-json \
rubygem-ruby-3.2.0-multi-json-1 \
rubygem-ruby-3.2.0-multi-json-1.15 \
rubygem-ruby-3.2.0-multi-json-1.15.0"
