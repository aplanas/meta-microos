...
locale(xfce4-places-plugin:en_AU) \
locale(xfce4-places-plugin:en_GB) \
...
locale(xfce4-places-plugin:pt_BR) \
...
locale(xfce4-places-plugin:zh_CN) \
locale(xfce4-places-plugin:zh_TW) \
