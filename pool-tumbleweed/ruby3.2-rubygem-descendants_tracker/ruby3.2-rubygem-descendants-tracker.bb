...
RPROVIDES:${PN} += "ruby3.2-rubygem-descendants_tracker \
ruby3.2-rubygem-descendants_tracker(aarch-64) \
rubygem(descendants_tracker) \
rubygem(ruby:3.2.0:descendants_tracker) \
rubygem(ruby:3.2.0:descendants_tracker:0) \
rubygem(ruby:3.2.0:descendants_tracker:0.0) \
rubygem(ruby:3.2.0:descendants_tracker:0.0.4)"
