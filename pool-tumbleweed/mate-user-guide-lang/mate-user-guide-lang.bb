...
locale(mate-user-guide:en_AU) \
locale(mate-user-guide:en_CA) \
locale(mate-user-guide:en_GB) \
locale(mate-user-guide:eo) \
locale(mate-user-guide:es) \
locale(mate-user-guide:es_AR) \
locale(mate-user-guide:es_CL) \
locale(mate-user-guide:es_CO) \
locale(mate-user-guide:es_ES) \
locale(mate-user-guide:es_MX) \
locale(mate-user-guide:es_PR) \
...
locale(mate-user-guide:zh_CN) \
locale(mate-user-guide:zh_HK) \
