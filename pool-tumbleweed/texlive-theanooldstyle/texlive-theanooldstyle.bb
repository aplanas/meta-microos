...
tex(thost_alkcdl.enc) \
tex(thost_ertqq3.enc) \
tex(thost_f66p55.enc) \
tex(thost_izaajv.enc) \
tex(thost_ogssaz.enc) \
tex(thost_oiucyb.enc) \
tex(thost_whuz6y.enc) \
tex(thost_xf32t5.enc) \
