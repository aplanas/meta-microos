...
RPROVIDES:${PN} += "ruby3.2-rubygem-simplecov-json-formatter \
rubygem-ruby-3.2.0-simplecov-json-formatter \
rubygem-ruby-3.2.0-simplecov-json-formatter-0 \
rubygem-ruby-3.2.0-simplecov-json-formatter-0.1 \
rubygem-ruby-3.2.0-simplecov-json-formatter-0.1.4 \
