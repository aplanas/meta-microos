...
RPROVIDES:${PN} += "ruby3.2-rubygem-terminal-table \
rubygem-ruby-3.2.0-terminal-table \
rubygem-ruby-3.2.0-terminal-table-3 \
rubygem-ruby-3.2.0-terminal-table-3.0 \
rubygem-ruby-3.2.0-terminal-table-3.0.2 \
