...
RPROVIDES:${PN} += "ruby3.2-rubygem-prawn-core \
ruby3.2-rubygem-prawn-core(aarch-64) \
rubygem(prawn-core) \
rubygem(ruby:3.2.0:prawn-core) \
rubygem(ruby:3.2.0:prawn-core:0) \
rubygem(ruby:3.2.0:prawn-core:0.8) \
rubygem(ruby:3.2.0:prawn-core:0.8.4)"
