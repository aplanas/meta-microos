...
firmware(ipw-2.2-bss_ucode.fw) \
firmware(ipw-2.2-ibss.fw) \
firmware(ipw-2.2-ibss_ucode.fw) \
firmware(ipw-2.3-boot.fw) \
firmware(ipw-2.3-bss.fw) \
firmware(ipw-2.3-bss_ucode.fw) \
firmware(ipw-2.3-ibss.fw) \
firmware(ipw-2.3-ibss_ucode.fw) \
firmware(ipw-2.3-sniffer.fw) \
firmware(ipw-2.3-sniffer_ucode.fw) \
firmware(ipw-2.4-boot.fw) \
firmware(ipw-2.4-bss.fw) \
firmware(ipw-2.4-bss_ucode.fw) \
firmware(ipw-2.4-ibss.fw) \
firmware(ipw-2.4-ibss_ucode.fw) \
firmware(ipw-2.4-sniffer.fw) \
firmware(ipw-2.4-sniffer_ucode.fw) \
