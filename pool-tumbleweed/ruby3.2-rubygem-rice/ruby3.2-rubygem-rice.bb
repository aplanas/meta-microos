...
RPROVIDES:${PN} += "ruby3.2-rubygem-rice \
ruby3.2-rubygem-rice(aarch-64) \
rubygem(rice) \
rubygem(ruby:3.2.0:rice) \
rubygem(ruby:3.2.0:rice:4) \
rubygem(ruby:3.2.0:rice:4.0) \
rubygem(ruby:3.2.0:rice:4.0.4)"
