...
RPROVIDES:${PN} += "ruby3.2-rubygem-delayed-job-active-record \
rubygem-delayed-job-active-record \
rubygem-ruby-3.2.0-delayed-job-active-record \
rubygem-ruby-3.2.0-delayed-job-active-record-4 \
rubygem-ruby-3.2.0-delayed-job-active-record-4.1 \
rubygem-ruby-3.2.0-delayed-job-active-record-4.1.7"

RDEPENDS:${PN} += "ruby-abi \
rubygem-ruby-3.2.0-activerecord \
rubygem-ruby-3.2.0-delayed-job"
