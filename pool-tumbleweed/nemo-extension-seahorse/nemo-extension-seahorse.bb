...
application(nemo-seahorse-pgp-encrypted.desktop) \
application(nemo-seahorse-pgp-keys.desktop) \
application(nemo-seahorse-pgp-signature.desktop) \
libnemo-image-converter.so()(64bit) \
libnemo-seahorse.so()(64bit) \
