...
sundials-openmpi2-devel(aarch-64)"

RDEPENDS:${PN} += "libsundials_arkode5-openmpi2 \
libsundials_cvode6-openmpi2 \
libsundials_cvodes6-openmpi2 \
libsundials_generic6-openmpi2 \
libsundials_ida6-openmpi2 \
libsundials_idas5-openmpi2 \
libsundials_kinsol6-openmpi2 \
libsundials_nvec6-openmpi2 \
libsundials_sunlinsol4_3_0-openmpi2 \
libsundials_sunmatrix4-openmpi2 \
libsundials_sunnonlin3_3_0-openmpi2"
