...
locale(system-config-printer-common:bn_IN) \
...
locale(system-config-printer-common:en_GB) \
...
locale(system-config-printer-common:pt_BR) \
...
locale(system-config-printer-common:zh_CN) \
