...
locale(mate-system-monitor:bn_IN) \
...
locale(mate-system-monitor:en_AU) \
locale(mate-system-monitor:en_CA) \
locale(mate-system-monitor:en_GB) \
locale(mate-system-monitor:eo) \
locale(mate-system-monitor:es) \
locale(mate-system-monitor:es_AR) \
locale(mate-system-monitor:es_CL) \
locale(mate-system-monitor:es_CO) \
locale(mate-system-monitor:es_CR) \
locale(mate-system-monitor:es_DO) \
locale(mate-system-monitor:es_EC) \
locale(mate-system-monitor:es_ES) \
locale(mate-system-monitor:es_MX) \
locale(mate-system-monitor:es_NI) \
locale(mate-system-monitor:es_PA) \
locale(mate-system-monitor:es_PE) \
locale(mate-system-monitor:es_PR) \
locale(mate-system-monitor:es_SV) \
locale(mate-system-monitor:es_UY) \
locale(mate-system-monitor:es_VE) \
...
locale(mate-system-monitor:pt_BR) \
...
locale(mate-system-monitor:zh_CN) \
locale(mate-system-monitor:zh_HK) \
