...
locale(budgie-control-center:bn_IN) \
...
locale(budgie-control-center:en_GB) \
locale(budgie-control-center:en_US) \
...
locale(budgie-control-center:pt_BR) \
locale(budgie-control-center:pt_PT) \
