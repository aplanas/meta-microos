...
RPROVIDES:${PN} += "ruby3.2-rubygem-get-process-mem \
rubygem-get-process-mem \
rubygem-ruby-3.2.0-get-process-mem \
rubygem-ruby-3.2.0-get-process-mem-0 \
rubygem-ruby-3.2.0-get-process-mem-0.2 \
rubygem-ruby-3.2.0-get-process-mem-0.2.7"
