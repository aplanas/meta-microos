...
RPROVIDES:${PN} += "rpm_macro(_set_dir_vendored_source_global) \
rpm_macro(_set_dir_vendored_sources) \
rpm_macro(_set_dir_vendored_target) \
rpm_macro(_set_dir_vendored_target_global) \
rpm_macro(_set_global_vendor_source_dir) \
rpm_macro(_set_global_vendor_target_dir) \
rpm_macro(_set_tmp_licenses_vendored_dir) \
rpm_macro(_tmp_licenses_dir) \
rpm_macro(set_dir_vendored_source) \
rpm_macro(set_dir_vendored_target) \
rpm_macro(vendored_licenses_packager_files) \
rpm_macro(vendored_licenses_packager_files_with_higher_dirs) \
