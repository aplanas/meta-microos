...
application(gramps.desktop) \
gramps \
metainfo() \
metainfo(gramps.appdata.xml) \
mimehandler(application/x-gedcom) \
mimehandler(application/x-gramps) \
mimehandler(application/x-gramps-package) \
