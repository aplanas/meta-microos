...
NetworkManager-fortisslvpn-gnome(aarch-64) \
libnm-gtk4-vpn-plugin-fortisslvpn-editor.so()(64bit) \
libnm-vpn-plugin-fortisslvpn-editor.so()(64bit) \
metainfo() \
metainfo(network-manager-fortisslvpn.metainfo.xml)"
