...
RPROVIDES:${PN} += "firmware(mrvl/pcie8897_uapsta.bin) \
firmware(mrvl/pcie8997_wlan_v4.bin) \
firmware(mrvl/pcieuart8997_combo_v4.bin) \
firmware(mrvl/pcieusb8997_combo_v4.bin) \
firmware(mrvl/sd8787_uapsta.bin) \
firmware(mrvl/sd8797_uapsta.bin) \
firmware(mrvl/sd8801_uapsta.bin) \
