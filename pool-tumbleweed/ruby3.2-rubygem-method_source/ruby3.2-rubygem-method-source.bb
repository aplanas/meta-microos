...
RPROVIDES:${PN} += "ruby3.2-rubygem-method_source \
ruby3.2-rubygem-method_source(aarch-64) \
rubygem(method_source) \
rubygem(ruby:3.2.0:method_source) \
rubygem(ruby:3.2.0:method_source:1) \
rubygem(ruby:3.2.0:method_source:1.0) \
rubygem(ruby:3.2.0:method_source:1.0.0)"
