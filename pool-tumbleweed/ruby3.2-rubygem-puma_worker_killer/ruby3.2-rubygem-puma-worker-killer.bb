...
RPROVIDES:${PN} += "ruby3.2-rubygem-puma-worker-killer \
rubygem-puma-worker-killer \
rubygem-ruby-3.2.0-puma-worker-killer \
rubygem-ruby-3.2.0-puma-worker-killer-0 \
rubygem-ruby-3.2.0-puma-worker-killer-0.3 \
rubygem-ruby-3.2.0-puma-worker-killer-0.3.1"

RDEPENDS:${PN} += "ruby-abi \
rubygem-ruby-3.2.0-get-process-mem-0 \
