...
application(kcm_access.desktop) \
application(kcm_activities.desktop) \
application(kcm_baloofile.desktop) \
application(kcm_clock.desktop) \
application(kcm_componentchooser.desktop) \
application(kcm_desktoppaths.desktop) \
application(kcm_joystick.desktop) \
application(kcm_kded.desktop) \
application(kcm_keyboard.desktop) \
application(kcm_keys.desktop) \
application(kcm_krunnersettings.desktop) \
application(kcm_landingpage.desktop) \
application(kcm_mouse.desktop) \
application(kcm_plasmasearch.desktop) \
application(kcm_qtquicksettings.desktop) \
application(kcm_recentFiles.desktop) \
application(kcm_smserver.desktop) \
application(kcm_solid_actions.desktop) \
application(kcm_splashscreen.desktop) \
application(kcm_tablet.desktop) \
application(kcm_touchpad.desktop) \
application(kcm_touchscreen.desktop) \
application(kcm_workspace.desktop) \
application(kcmspellchecking.desktop) \
application(org.kde.knetattach.desktop) \
kcm-touchpad \
kcm-touchpad5 \
kdebase4-workspace \
kdebase4-workspace-plasma-calendar \
kdebase4-workspace-plasma-engine-akonadi \
libEmojierDeclarativePlugin.so()(64bit) \
libactivityswitcherextensionplugin.so()(64bit) \
libdesktopplugin.so()(64bit) \
libfolderplugin.so()(64bit) \
libkactivitiessettingsplugin.so()(64bit) \
libkimpanelplugin.so()(64bit) \
libpagerplugin.so()(64bit) \
libshowdesktopplugin.so()(64bit) \
libtaskmanagerplugin.so()(64bit) \
libtrashplugin.so()(64bit) \
metainfo() \
metainfo(org.kde.desktopcontainment.appdata.xml) \
metainfo(org.kde.desktoptoolbox.appdata.xml) \
metainfo(org.kde.paneltoolbox.appdata.xml) \
metainfo(org.kde.plasma.activitypager.appdata.xml) \
metainfo(org.kde.plasma.desktop.appdata.xml) \
metainfo(org.kde.plasma.desktop.appmenubar.appdata.xml) \
metainfo(org.kde.plasma.desktop.defaultPanel.appdata.xml) \
metainfo(org.kde.plasma.desktop.emptyPanel.appdata.xml) \
metainfo(org.kde.plasma.folder.appdata.xml) \
metainfo(org.kde.plasma.icontasks.appdata.xml) \
metainfo(org.kde.plasma.keyboardlayout.appdata.xml) \
metainfo(org.kde.plasma.kicker.appdata.xml) \
metainfo(org.kde.plasma.kickoff.appdata.xml) \
metainfo(org.kde.plasma.kimpanel.appdata.xml) \
metainfo(org.kde.plasma.marginsseparator.appdata.xml) \
metainfo(org.kde.plasma.minimizeall.appdata.xml) \
metainfo(org.kde.plasma.pager.appdata.xml) \
metainfo(org.kde.plasma.showActivityManager.appdata.xml) \
metainfo(org.kde.plasma.showdesktop.appdata.xml) \
metainfo(org.kde.plasma.taskmanager.appdata.xml) \
metainfo(org.kde.plasma.trash.appdata.xml) \
metainfo(org.kde.plasma.windowlist.appdata.xml) \
metainfo(org.kde.plasmashell.metainfo.xml) \
plasma5-addons-kimpanel \
plasma5-desktop \
plasma5-desktop(aarch-64) \
