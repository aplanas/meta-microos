...
application(cdemu-client.desktop) \
cdemu-client \
mimehandler(application/x-apple-diskimage) \
mimehandler(application/x-b6t) \
mimehandler(application/x-c2d) \
mimehandler(application/x-ccd) \
mimehandler(application/x-cd-image) \
mimehandler(application/x-cdi) \
mimehandler(application/x-cdrdao-toc) \
mimehandler(application/x-cif) \
mimehandler(application/x-cso) \
mimehandler(application/x-cue) \
mimehandler(application/x-daa) \
mimehandler(application/x-ecm) \
mimehandler(application/x-gamecube-iso-image) \
mimehandler(application/x-gbi) \
mimehandler(application/x-isz) \
mimehandler(application/x-macbinary) \
mimehandler(application/x-mds) \
mimehandler(application/x-mdx) \
mimehandler(application/x-nrg) \
