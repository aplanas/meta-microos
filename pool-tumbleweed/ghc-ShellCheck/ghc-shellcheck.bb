...
RPM_NAME = "ghc-ShellCheck-0.9.0-2.11.aarch64.rpm"
RPM_HASH = "ddb1188801b535cc8ea490520dc85c7ca3e53ea902541311e87df6fdffbc221dc347306015505f86a2d8b32cdc020e7c1f3d7a9155f10b7d5052106c67af45d2"

RPROVIDES:${PN} += "ghc-ShellCheck \
libHSShellCheck-0.9.0-TBi9P689024G2PjJ0tZqq-ghc9.4.6.so"

RDEPENDS:${PN} += "libHSDiff-0.4.1-LhFtxwvuVVqGkTz0Ph6iJg-ghc9.4.6.so \
