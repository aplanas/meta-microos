...
locale(xfce4-eyes-plugin:en_AU) \
locale(xfce4-eyes-plugin:en_CA) \
locale(xfce4-eyes-plugin:en_GB) \
...
locale(xfce4-eyes-plugin:pt_BR) \
...
locale(xfce4-eyes-plugin:zh_CN) \
locale(xfce4-eyes-plugin:zh_TW) \
