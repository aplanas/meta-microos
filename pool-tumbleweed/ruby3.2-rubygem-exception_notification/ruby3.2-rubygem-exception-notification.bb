...
RPROVIDES:${PN} += "ruby3.2-rubygem-exception-notification \
rubygem-exception-notification \
rubygem-ruby-3.2.0-exception-notification \
rubygem-ruby-3.2.0-exception-notification-4 \
rubygem-ruby-3.2.0-exception-notification-4.5 \
rubygem-ruby-3.2.0-exception-notification-4.5.0"
