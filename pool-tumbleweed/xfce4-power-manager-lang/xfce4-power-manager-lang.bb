...
locale(xfce4-power-manager:en_AU) \
locale(xfce4-power-manager:en_CA) \
locale(xfce4-power-manager:en_GB) \
...
locale(xfce4-power-manager:pt_BR) \
...
locale(xfce4-power-manager:zh_CN) \
locale(xfce4-power-manager:zh_HK) \
