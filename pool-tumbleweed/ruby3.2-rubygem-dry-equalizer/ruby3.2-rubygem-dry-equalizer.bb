...
RPROVIDES:${PN} += "ruby3.2-rubygem-dry-equalizer \
ruby3.2-rubygem-dry-equalizer(aarch-64) \
rubygem(dry-equalizer) \
rubygem(ruby:3.2.0:dry-equalizer) \
rubygem(ruby:3.2.0:dry-equalizer:0) \
rubygem(ruby:3.2.0:dry-equalizer:0.3) \
rubygem(ruby:3.2.0:dry-equalizer:0.3.0)"
