...
sundials-openmpi3-devel(aarch-64)"

RDEPENDS:${PN} += "libsundials_arkode5-openmpi3 \
libsundials_cvode6-openmpi3 \
libsundials_cvodes6-openmpi3 \
libsundials_generic6-openmpi3 \
libsundials_ida6-openmpi3 \
libsundials_idas5-openmpi3 \
libsundials_kinsol6-openmpi3 \
libsundials_nvec6-openmpi3 \
libsundials_sunlinsol4_3_0-openmpi3 \
libsundials_sunmatrix4-openmpi3 \
libsundials_sunnonlin3_3_0-openmpi3"
