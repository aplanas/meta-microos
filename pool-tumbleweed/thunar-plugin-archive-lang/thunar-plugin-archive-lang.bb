...
locale(thunar-plugin-archive:en_AU) \
locale(thunar-plugin-archive:en_CA) \
locale(thunar-plugin-archive:en_GB) \
...
locale(thunar-plugin-archive:pt_BR) \
...
locale(thunar-plugin-archive:zh_CN) \
