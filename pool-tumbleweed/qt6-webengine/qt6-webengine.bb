...
RPROVIDES:${PN} += "libqwebengineview.so()(64bit) \
libqwebengineview.so(Qt_6)(64bit) \
libqwebengineview.so(Qt_6.0)(64bit) \
libqwebengineview.so(Qt_6.1)(64bit) \
libqwebengineview.so(Qt_6.2)(64bit) \
libqwebengineview.so(Qt_6.3)(64bit) \
libqwebengineview.so(Qt_6.4)(64bit) \
libqwebengineview.so(Qt_6.5)(64bit) \
libqwebengineview.so(Qt_6.5.1_PRIVATE_API)(64bit) \
qt6-webengine \
qt6-webengine(aarch-64)"
