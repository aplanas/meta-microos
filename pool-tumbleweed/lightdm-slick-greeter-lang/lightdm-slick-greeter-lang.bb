...
locale(lightdm-slick-greeter:en_AU) \
locale(lightdm-slick-greeter:en_CA) \
locale(lightdm-slick-greeter:en_GB) \
...
locale(lightdm-slick-greeter:fr_CA) \
...
locale(lightdm-slick-greeter:pt_BR) \
