...
tex(thedid_alkcdl.enc) \
tex(thedid_ertqq3.enc) \
tex(thedid_f66p55.enc) \
tex(thedid_izaajv.enc) \
tex(thedid_k6ngqv.enc) \
tex(thedid_lqxlns.enc) \
tex(thedid_oiucyb.enc) \
tex(thedid_whuz6y.enc) \
