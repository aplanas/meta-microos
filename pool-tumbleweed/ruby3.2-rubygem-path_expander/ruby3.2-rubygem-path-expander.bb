...
RPROVIDES:${PN} += "ruby3.2-rubygem-path-expander \
rubygem-path-expander \
rubygem-ruby-3.2.0-path-expander \
rubygem-ruby-3.2.0-path-expander-1 \
rubygem-ruby-3.2.0-path-expander-1.1 \
rubygem-ruby-3.2.0-path-expander-1.1.1"
