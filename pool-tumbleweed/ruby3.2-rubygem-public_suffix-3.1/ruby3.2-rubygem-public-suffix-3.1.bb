...
RPROVIDES:${PN} += "ruby3.2-rubygem-public-suffix-3.1 \
rubygem-public-suffix \
rubygem-ruby-3.2.0-public-suffix \
rubygem-ruby-3.2.0-public-suffix-3 \
rubygem-ruby-3.2.0-public-suffix-3.1 \
rubygem-ruby-3.2.0-public-suffix-3.1.1"
