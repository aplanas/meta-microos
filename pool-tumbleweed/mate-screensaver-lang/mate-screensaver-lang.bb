...
locale(mate-screensaver:en_AU) \
locale(mate-screensaver:en_CA) \
locale(mate-screensaver:en_GB) \
locale(mate-screensaver:en_US) \
locale(mate-screensaver:eo) \
locale(mate-screensaver:es) \
locale(mate-screensaver:es_AR) \
locale(mate-screensaver:es_CO) \
locale(mate-screensaver:es_MX) \
...
locale(mate-screensaver:zh_CN) \
locale(mate-screensaver:zh_HK) \
