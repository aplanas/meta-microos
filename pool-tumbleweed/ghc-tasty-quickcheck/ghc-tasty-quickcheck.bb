...
RPM_NAME = "ghc-tasty-quickcheck-0.10.2-2.3.aarch64.rpm"
RPM_HASH = "d522bac8c79b2a94b8406273ba5f75e14705c077b428b88f52c57a043465a049385061e490dd41f32358a3e2af4ef800b4db74db74a620a6176797c3cc343fde"

RPROVIDES:${PN} += "ghc-tasty-quickcheck \
libHStasty-quickcheck-0.10.2-9BXtwYsGN94LXf5I8sMsq-ghc9.4.5.so"

RDEPENDS:${PN} += "libHSQuickCheck-2.14.3-6dq2izV8oSq1BobaDA598X-ghc9.4.5.so \
