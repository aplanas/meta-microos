...
ocaml(CalendarLib__Calendar) \
ocaml(CalendarLib__Calendar_builder) \
ocaml(CalendarLib__Calendar_sig) \
ocaml(CalendarLib__Date) \
ocaml(CalendarLib__Date_sig) \
ocaml(CalendarLib__Fcalendar) \
ocaml(CalendarLib__Ftime) \
ocaml(CalendarLib__Period) \
ocaml(CalendarLib__Printer) \
ocaml(CalendarLib__Time) \
ocaml(CalendarLib__Time_Zone) \
ocaml(CalendarLib__Time_sig) \
ocaml(CalendarLib__Utils) \
ocaml(CalendarLib__Version) \
ocaml-calendar-devel \
ocaml-calendar-devel(aarch-64) \
ocamlfind(calendar) \
ocamlx(CalendarLib) \
ocamlx(CalendarLib__Calendar) \
ocamlx(CalendarLib__Calendar_builder) \
ocamlx(CalendarLib__Date) \
ocamlx(CalendarLib__Fcalendar) \
ocamlx(CalendarLib__Ftime) \
ocamlx(CalendarLib__Printer) \
ocamlx(CalendarLib__Time) \
