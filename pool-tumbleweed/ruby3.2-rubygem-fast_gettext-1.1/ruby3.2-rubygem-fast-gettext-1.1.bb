...
RPROVIDES:${PN} += "ruby3.2-rubygem-fast-gettext-1.1 \
rubygem-fast-gettext \
rubygem-ruby-3.2.0-fast-gettext \
rubygem-ruby-3.2.0-fast-gettext-1 \
rubygem-ruby-3.2.0-fast-gettext-1.1 \
rubygem-ruby-3.2.0-fast-gettext-1.1.2"
