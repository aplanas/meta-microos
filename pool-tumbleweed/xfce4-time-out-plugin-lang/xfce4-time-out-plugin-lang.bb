...
locale(xfce4-time-out-plugin:en_AU) \
locale(xfce4-time-out-plugin:en_CA) \
locale(xfce4-time-out-plugin:en_GB) \
...
locale(xfce4-time-out-plugin:pt_BR) \
...
locale(xfce4-time-out-plugin:zh_CN) \
locale(xfce4-time-out-plugin:zh_TW) \
