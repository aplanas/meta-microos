...
RPROVIDES:${PN} += "ruby3.2-rubygem-rubocop \
rubygem-rubocop \
rubygem-ruby-3.2.0-rubocop \
rubygem-ruby-3.2.0-rubocop-1 \
rubygem-ruby-3.2.0-rubocop-1.39 \
rubygem-ruby-3.2.0-rubocop-1.39.0"
...
rubygem-ruby-3.2.0-regexp-parser \
