...
RPROVIDES:${PN} += "ruby3.2-rubygem-websocket-driver \
ruby3.2-rubygem-websocket-driver(aarch-64) \
rubygem(ruby:3.2.0:websocket-driver) \
rubygem(ruby:3.2.0:websocket-driver:0) \
rubygem(ruby:3.2.0:websocket-driver:0.7) \
