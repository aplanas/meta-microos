...
RPROVIDES:${PN} += "ruby3.2-rubygem-fake-ftp-0-1 \
rubygem-fake-ftp \
rubygem-ruby-3.2.0-fake-ftp \
rubygem-ruby-3.2.0-fake-ftp-0 \
rubygem-ruby-3.2.0-fake-ftp-0.1 \
rubygem-ruby-3.2.0-fake-ftp-0.1.1"
