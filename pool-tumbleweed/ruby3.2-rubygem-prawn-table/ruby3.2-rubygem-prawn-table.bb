...
RPROVIDES:${PN} += "ruby3.2-rubygem-prawn-table \
ruby3.2-rubygem-prawn-table(aarch-64) \
rubygem(prawn-table) \
rubygem(ruby:3.2.0:prawn-table) \
rubygem(ruby:3.2.0:prawn-table:0) \
rubygem(ruby:3.2.0:prawn-table:0.2) \
rubygem(ruby:3.2.0:prawn-table:0.2.2)"
