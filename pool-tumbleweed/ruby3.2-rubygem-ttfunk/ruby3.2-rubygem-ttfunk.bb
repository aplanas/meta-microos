...
RPROVIDES:${PN} += "ruby3.2-rubygem-ttfunk \
ruby3.2-rubygem-ttfunk(aarch-64) \
rubygem(ruby:3.2.0:ttfunk) \
rubygem(ruby:3.2.0:ttfunk:1) \
rubygem(ruby:3.2.0:ttfunk:1.7) \
rubygem(ruby:3.2.0:ttfunk:1.7.0) \
rubygem(ttfunk)"
