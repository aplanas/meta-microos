...
application(google-maps-geo-handler.desktop) \
application(openstreetmap-geo-handler.desktop) \
application(qwant-maps-geo-handler.desktop) \
application(wheelmap-geo-handler.desktop) \
kguiaddons \
kguiaddons(aarch-64) \
