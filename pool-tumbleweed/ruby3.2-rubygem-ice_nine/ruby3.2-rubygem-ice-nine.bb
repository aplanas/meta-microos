...
RPROVIDES:${PN} += "ruby3.2-rubygem-ice-nine \
rubygem-ice-nine \
rubygem-ruby-3.2.0-ice-nine \
rubygem-ruby-3.2.0-ice-nine-0 \
rubygem-ruby-3.2.0-ice-nine-0.11 \
rubygem-ruby-3.2.0-ice-nine-0.11.2"
