...
locale(mate-notification-daemon:bn_IN) \
...
locale(mate-notification-daemon:en_AU) \
locale(mate-notification-daemon:en_CA) \
locale(mate-notification-daemon:en_GB) \
locale(mate-notification-daemon:en_US) \
locale(mate-notification-daemon:eo) \
locale(mate-notification-daemon:es) \
locale(mate-notification-daemon:es_AR) \
locale(mate-notification-daemon:es_CL) \
locale(mate-notification-daemon:es_CO) \
locale(mate-notification-daemon:es_MX) \
...
locale(mate-notification-daemon:fr_CA) \
...
locale(mate-notification-daemon:pt_BR) \
...
locale(mate-notification-daemon:zh_CN) \
locale(mate-notification-daemon:zh_HK) \
