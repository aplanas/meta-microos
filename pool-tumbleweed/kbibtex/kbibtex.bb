...
application(org.kde.kbibtex.desktop) \
kbibtex \
kbibtex(aarch-64) \
libkbibtexconfig.so.0()(64bit) \
libkbibtexdata.so.0()(64bit) \
libkbibtexgui.so.0()(64bit) \
libkbibtexio.so.0()(64bit) \
libkbibtexnetworking.so.0()(64bit) \
libkbibtexproc.so.0()(64bit) \
metainfo() \
