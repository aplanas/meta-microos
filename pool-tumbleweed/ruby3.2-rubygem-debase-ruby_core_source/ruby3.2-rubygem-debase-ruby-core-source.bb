...
RPROVIDES:${PN} += "ruby3.2-rubygem-debase-ruby-core-source \
rubygem-debase-ruby-core-source \
rubygem-ruby-3.2.0-debase-ruby-core-source \
rubygem-ruby-3.2.0-debase-ruby-core-source-0 \
rubygem-ruby-3.2.0-debase-ruby-core-source-0.10 \
rubygem-ruby-3.2.0-debase-ruby-core-source-0.10.18"
