...
RPROVIDES:${PN} += "ruby3.2-rubygem-gettext_i18n_rails \
ruby3.2-rubygem-gettext_i18n_rails(aarch-64) \
rubygem(gettext_i18n_rails) \
rubygem(ruby:3.2.0:gettext_i18n_rails) \
rubygem(ruby:3.2.0:gettext_i18n_rails:1) \
rubygem(ruby:3.2.0:gettext_i18n_rails:1.9) \
rubygem(ruby:3.2.0:gettext_i18n_rails:1.9.0)"
