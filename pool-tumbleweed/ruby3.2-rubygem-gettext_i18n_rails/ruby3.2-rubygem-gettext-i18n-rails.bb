...
RPROVIDES:${PN} += "ruby3.2-rubygem-gettext-i18n-rails \
rubygem-gettext-i18n-rails \
rubygem-ruby-3.2.0-gettext-i18n-rails \
rubygem-ruby-3.2.0-gettext-i18n-rails-1 \
rubygem-ruby-3.2.0-gettext-i18n-rails-1.9 \
rubygem-ruby-3.2.0-gettext-i18n-rails-1.9.0"
