...
rpm_macro(mozilla_addon_install) \
rpm_macro(mozilla_addondir) \
rpm_macro(mozilla_firefox_appid) \
rpm_macro(mozilla_moduledir) \
rpm_macro(mozilla_mozillapath) \
rpm_macro(mozilla_pluginsdir) \
rpm_macro(mozilla_seamonkey_appid) \
