...
application(org.kde.kasts.desktop) \
kasts \
kasts(aarch-64) \
libKMediaSession.so()(64bit) \
libKastsSolidExtras.so()(64bit) \
libkasts-solidextrasqmlplugin.so()(64bit) \
libkmediasession-qmlplugin.so()(64bit) \
metainfo() \
