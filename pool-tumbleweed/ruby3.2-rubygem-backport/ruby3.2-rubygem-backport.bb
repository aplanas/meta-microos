...
RPROVIDES:${PN} += "ruby3.2-rubygem-backport \
ruby3.2-rubygem-backport(aarch-64) \
rubygem(backport) \
rubygem(ruby:3.2.0:backport) \
rubygem(ruby:3.2.0:backport:1) \
rubygem(ruby:3.2.0:backport:1.2) \
rubygem(ruby:3.2.0:backport:1.2.0)"
